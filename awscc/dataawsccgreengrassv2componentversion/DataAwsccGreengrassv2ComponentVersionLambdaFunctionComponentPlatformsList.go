...
func (d *jsiiProxy_DataAwsccGreengrassv2ComponentVersionLambdaFunctionComponentPlatformsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
