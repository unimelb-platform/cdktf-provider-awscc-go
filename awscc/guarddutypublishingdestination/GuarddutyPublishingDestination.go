...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/guardduty_publishing_destination awscc_guardduty_publishing_destination}.
type GuarddutyPublishingDestination interface {
	...
	DestinationProperties() GuarddutyPublishingDestinationDestinationPropertiesOutputReference
	DestinationPropertiesInput() interface{}
	...
	PutDestinationProperties(value *GuarddutyPublishingDestinationDestinationProperties)
...
func (j *jsiiProxy_GuarddutyPublishingDestination) DestinationProperties() GuarddutyPublishingDestinationDestinationPropertiesOutputReference {
	var returns GuarddutyPublishingDestinationDestinationPropertiesOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GuarddutyPublishingDestination) DestinationPropertiesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"destinationPropertiesInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_GuarddutyPublishingDestination) PublishingDestinationId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GuarddutyPublishingDestination) PublishingFailureStartTimestamp() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GuarddutyPublishingDestination) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_GuarddutyPublishingDestination) Tags() GuarddutyPublishingDestinationTagsList {
	var returns GuarddutyPublishingDestinationTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_GuarddutyPublishingDestination) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/guardduty_publishing_destination awscc_guardduty_publishing_destination} Resource.
...
func (g *jsiiProxy_GuarddutyPublishingDestination) PutDestinationProperties(value *GuarddutyPublishingDestinationDestinationProperties) {
	if err := g.validatePutDestinationPropertiesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		g,
		"putDestinationProperties",
		[]interface{}{value},
	)
}

func (g *jsiiProxy_GuarddutyPublishingDestination) PutTags(value interface{}) {
...
func (g *jsiiProxy_GuarddutyPublishingDestination) ResetTags() {
	_jsii_.InvokeVoid(
		g,
		"resetTags",
		nil, // no parameters
