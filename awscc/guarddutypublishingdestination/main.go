...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "destinationPropertiesInput", GoGetter: "DestinationPropertiesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putDestinationProperties", GoMethod: "PutDestinationProperties"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GuarddutyPublishingDestinationDestinationProperties)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.guarddutyPublishingDestination.GuarddutyPublishingDestinationDestinationPropertiesOutputReference",
		reflect.TypeOf((*GuarddutyPublishingDestinationDestinationPropertiesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GuarddutyPublishingDestinationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.guarddutyPublishingDestination.GuarddutyPublishingDestinationTagsList",
		reflect.TypeOf((*GuarddutyPublishingDestinationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GuarddutyPublishingDestinationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
