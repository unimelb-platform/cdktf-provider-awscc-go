...
func init() {
	_jsii_.RegisterClass(
		"awscc.transferAgreement.TransferAgreement",
	...
	_jsii_.RegisterStruct(
		"awscc.transferAgreement.TransferAgreementTags",
		reflect.TypeOf((*TransferAgreementTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.transferAgreement.TransferAgreementTagsList",
		reflect.TypeOf((*TransferAgreementTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*TransferAgreementTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
