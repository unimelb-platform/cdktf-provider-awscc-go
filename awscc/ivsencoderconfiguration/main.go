...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IvsEncoderConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_IvsEncoderConfiguration{}
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*IvsEncoderConfigurationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.ivsEncoderConfiguration.IvsEncoderConfigurationTags",
		reflect.TypeOf((*IvsEncoderConfigurationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ivsEncoderConfiguration.IvsEncoderConfigurationTagsList",
		reflect.TypeOf((*IvsEncoderConfigurationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IvsEncoderConfigurationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.ivsEncoderConfiguration.IvsEncoderConfigurationVideo",
		reflect.TypeOf((*IvsEncoderConfigurationVideo)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ivsEncoderConfiguration.IvsEncoderConfigurationVideoOutputReference",
		reflect.TypeOf((*IvsEncoderConfigurationVideoOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_IvsEncoderConfigurationVideoOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
