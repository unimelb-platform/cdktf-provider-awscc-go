...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCodegurureviewerRepositoryAssociation)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccCodegurureviewerRepositoryAssociationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccCodegurureviewerRepositoryAssociation.DataAwsccCodegurureviewerRepositoryAssociationTags",
		reflect.TypeOf((*DataAwsccCodegurureviewerRepositoryAssociationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccCodegurureviewerRepositoryAssociation.DataAwsccCodegurureviewerRepositoryAssociationTagsList",
		reflect.TypeOf((*DataAwsccCodegurureviewerRepositoryAssociationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCodegurureviewerRepositoryAssociationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
