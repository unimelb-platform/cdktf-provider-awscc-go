...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.networkmanagerSite.NetworkmanagerSiteConfig",
		reflect.TypeOf((*NetworkmanagerSiteConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.networkmanagerSite.NetworkmanagerSiteLocation",
		reflect.TypeOf((*NetworkmanagerSiteLocation)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.networkmanagerSite.NetworkmanagerSiteLocationOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.networkmanagerSite.NetworkmanagerSiteTags",
		reflect.TypeOf((*NetworkmanagerSiteTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.networkmanagerSite.NetworkmanagerSiteTagsList",
		reflect.TypeOf((*NetworkmanagerSiteTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkmanagerSiteTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
