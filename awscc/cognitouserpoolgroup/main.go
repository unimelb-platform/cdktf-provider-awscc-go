...
func init() {
	_jsii_.RegisterClass(
		"awscc.cognitoUserPoolGroup.CognitoUserPoolGroup",
		reflect.TypeOf((*CognitoUserPoolGroup)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_CognitoUserPoolGroup{}
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CognitoUserPoolGroupConfig)(nil)).Elem(),
	)
}
