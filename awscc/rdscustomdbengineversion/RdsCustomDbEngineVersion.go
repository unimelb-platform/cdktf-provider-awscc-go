...
func (j *jsiiProxy_RdsCustomDbEngineVersion) DbEngineVersionArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dbEngineVersionArn",
...
func (j *jsiiProxy_RdsCustomDbEngineVersion) Tags() RdsCustomDbEngineVersionTagsList {
	var returns RdsCustomDbEngineVersionTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_RdsCustomDbEngineVersion) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (r *jsiiProxy_RdsCustomDbEngineVersion) PutTags(value interface{}) {
