...
type CleanroomsMembershipDefaultJobResultConfiguration struct {
	...
	OutputConfiguration *CleanroomsMembershipDefaultJobResultConfigurationOutputConfiguration `field:"optional" json:"outputConfiguration" yaml:"outputConfiguration"`
