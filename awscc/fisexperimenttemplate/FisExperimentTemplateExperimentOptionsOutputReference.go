...
func (j *jsiiProxy_FisExperimentTemplateExperimentOptionsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_FisExperimentTemplateExperimentOptionsOutputReference)SetInternalValue(val interface{}) {
...
func (f *jsiiProxy_FisExperimentTemplateExperimentOptionsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FisExperimentTemplateExperimentOptionsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
