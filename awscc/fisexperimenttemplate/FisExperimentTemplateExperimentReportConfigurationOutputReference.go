...
func (j *jsiiProxy_FisExperimentTemplateExperimentReportConfigurationOutputReference) DataSourcesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"dataSourcesInput",
...
func (j *jsiiProxy_FisExperimentTemplateExperimentReportConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_FisExperimentTemplateExperimentReportConfigurationOutputReference) OutputsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"outputsInput",
...
func (j *jsiiProxy_FisExperimentTemplateExperimentReportConfigurationOutputReference)SetInternalValue(val interface{}) {
...
func (f *jsiiProxy_FisExperimentTemplateExperimentReportConfigurationOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FisExperimentTemplateExperimentReportConfigurationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
