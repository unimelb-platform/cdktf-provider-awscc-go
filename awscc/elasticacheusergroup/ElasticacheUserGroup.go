...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/elasticache_user_group awscc_elasticache_user_group}.
...
func (j *jsiiProxy_ElasticacheUserGroup) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_ElasticacheUserGroup) Tags() ElasticacheUserGroupTagsList {
	var returns ElasticacheUserGroupTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/elasticache_user_group awscc_elasticache_user_group} Resource.
func NewElasticacheUserGroup(scope constructs.Construct, id *string, config *ElasticacheUserGroupConfig) ElasticacheUserGroup {
	...
	_jsii_.Create(
		"awscc.elasticacheUserGroup.ElasticacheUserGroup",
...
func (e *jsiiProxy_ElasticacheUserGroup) PutTags(value interface{}) {
