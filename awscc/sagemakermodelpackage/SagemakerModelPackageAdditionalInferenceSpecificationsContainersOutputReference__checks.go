...
func (s *jsiiProxy_SagemakerModelPackageAdditionalInferenceSpecificationsContainersOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (s *jsiiProxy_SagemakerModelPackageAdditionalInferenceSpecificationsContainersOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_SagemakerModelPackageAdditionalInferenceSpecificationsContainersOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewSagemakerModelPackageAdditionalInferenceSpecificationsContainersOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
