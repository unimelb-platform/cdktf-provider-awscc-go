...
type SagemakerModelPackageValidationSpecificationValidationProfilesTransformJobDefinitionTransformInput struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/sagemaker_model_package#data_source SagemakerModelPackage#data_source}
	DataSource *SagemakerModelPackageValidationSpecificationValidationProfilesTransformJobDefinitionTransformInputDataSource `field:"optional" json:"dataSource" yaml:"dataSource"`
	// The method to use to split the transform job's data files into smaller batches.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/sagemaker_model_package#split_type SagemakerModelPackage#split_type}
