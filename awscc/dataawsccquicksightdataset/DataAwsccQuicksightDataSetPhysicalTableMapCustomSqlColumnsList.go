...
func (d *jsiiProxy_DataAwsccQuicksightDataSetPhysicalTableMapCustomSqlColumnsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
