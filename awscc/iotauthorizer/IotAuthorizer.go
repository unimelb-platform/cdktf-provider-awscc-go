...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/iot_authorizer awscc_iot_authorizer}.
...
func (j *jsiiProxy_IotAuthorizer) AuthorizerName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"authorizerName",
...
func (j *jsiiProxy_IotAuthorizer) AuthorizerNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"authorizerNameInput",
...
func (j *jsiiProxy_IotAuthorizer) Tags() IotAuthorizerTagsList {
	var returns IotAuthorizerTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_IotAuthorizer) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/iot_authorizer awscc_iot_authorizer} Resource.
func NewIotAuthorizer(scope constructs.Construct, id *string, config *IotAuthorizerConfig) IotAuthorizer {
	...
	_jsii_.Create(
		"awscc.iotAuthorizer.IotAuthorizer",
...
func (j *jsiiProxy_IotAuthorizer)SetAuthorizerName(val *string) {
	if err := j.validateSetAuthorizerNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (i *jsiiProxy_IotAuthorizer) PutTags(value interface{}) {
...
func (i *jsiiProxy_IotAuthorizer) ResetAuthorizerName() {
	_jsii_.InvokeVoid(
		i,
		"resetAuthorizerName",
		nil, // no parameters
