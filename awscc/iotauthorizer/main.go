...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "authorizerNameInput", GoGetter: "AuthorizerNameInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAuthorizerName", GoMethod: "ResetAuthorizerName"},
	...
	_jsii_.RegisterStruct(
		"awscc.iotAuthorizer.IotAuthorizerConfig",
		reflect.TypeOf((*IotAuthorizerConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.iotAuthorizer.IotAuthorizerTags",
		reflect.TypeOf((*IotAuthorizerTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.iotAuthorizer.IotAuthorizerTagsList",
		reflect.TypeOf((*IotAuthorizerTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IotAuthorizerTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
