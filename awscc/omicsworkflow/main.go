...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OmicsWorkflow)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.omicsWorkflow.OmicsWorkflowConfig",
		reflect.TypeOf((*OmicsWorkflowConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.omicsWorkflow.OmicsWorkflowParameterTemplate",
		reflect.TypeOf((*OmicsWorkflowParameterTemplate)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.omicsWorkflow.OmicsWorkflowParameterTemplateMap",
		reflect.TypeOf((*OmicsWorkflowParameterTemplateMap)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OmicsWorkflowParameterTemplateOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
