...
func (j *jsiiProxy_S3AccessPointVpcConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewS3AccessPointVpcConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) S3AccessPointVpcConfigurationOutputReference {
	...
	_jsii_.Create(
		"awscc.s3AccessPoint.S3AccessPointVpcConfigurationOutputReference",
...
func (j *jsiiProxy_S3AccessPointVpcConfigurationOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_S3AccessPointVpcConfigurationOutputReference) ResetVpcId() {
	_jsii_.InvokeVoid(
		s,
		"resetVpcId",
		nil, // no parameters
