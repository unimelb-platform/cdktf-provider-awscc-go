...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/s3accesspoint/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/s3_access_point awscc_s3_access_point}.
...
func (j *jsiiProxy_S3AccessPoint) PublicAccessBlockConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3AccessPoint) VpcConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/s3_access_point awscc_s3_access_point} Resource.
func NewS3AccessPoint(scope constructs.Construct, id *string, config *S3AccessPointConfig) S3AccessPoint {
	...
	_jsii_.Create(
		"awscc.s3AccessPoint.S3AccessPoint",
...
func (s *jsiiProxy_S3AccessPoint) ResetName() {
	_jsii_.InvokeVoid(
		s,
		"resetName",
		nil, // no parameters
