...
func (j *jsiiProxy_S3AccessPointPublicAccessBlockConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_S3AccessPointPublicAccessBlockConfigurationOutputReference)SetInternalValue(val interface{}) {
