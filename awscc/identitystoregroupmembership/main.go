...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putMemberId", GoMethod: "PutMemberId"},
	...
	_jsii_.RegisterStruct(
		"awscc.identitystoreGroupMembership.IdentitystoreGroupMembershipMemberId",
		reflect.TypeOf((*IdentitystoreGroupMembershipMemberId)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.identitystoreGroupMembership.IdentitystoreGroupMembershipMemberIdOutputReference",
		reflect.TypeOf((*IdentitystoreGroupMembershipMemberIdOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_IdentitystoreGroupMembershipMemberIdOutputReference{}
