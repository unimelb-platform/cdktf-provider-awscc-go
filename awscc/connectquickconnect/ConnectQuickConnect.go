...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/connect_quick_connect awscc_connect_quick_connect}.
type ConnectQuickConnect interface {
	...
	QuickConnectConfigInput() interface{}
...
func (j *jsiiProxy_ConnectQuickConnect) InstanceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceArn",
...
func (j *jsiiProxy_ConnectQuickConnect) InstanceArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceArnInput",
...
func (j *jsiiProxy_ConnectQuickConnect) QuickConnectArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"quickConnectArn",
...
func (j *jsiiProxy_ConnectQuickConnect) QuickConnectConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ConnectQuickConnect) QuickConnectType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"quickConnectType",
...
func (j *jsiiProxy_ConnectQuickConnect) Tags() ConnectQuickConnectTagsList {
	var returns ConnectQuickConnectTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_ConnectQuickConnect) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/connect_quick_connect awscc_connect_quick_connect} Resource.
...
func (j *jsiiProxy_ConnectQuickConnect)SetInstanceArn(val *string) {
...
func (c *jsiiProxy_ConnectQuickConnect) PutTags(value interface{}) {
