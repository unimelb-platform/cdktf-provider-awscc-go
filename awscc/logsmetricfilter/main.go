...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "metricTransformationsInput", GoGetter: "MetricTransformationsInput"},
			_jsii_.MemberMethod{JsiiMethod: "moveTo", GoMethod: "MoveTo"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
			_jsii_.MemberMethod{JsiiMethod: "overrideLogicalId", GoMethod: "OverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putMetricTransformations", GoMethod: "PutMetricTransformations"},
	...
	_jsii_.RegisterStruct(
		"awscc.logsMetricFilter.LogsMetricFilterConfig",
		reflect.TypeOf((*LogsMetricFilterConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.logsMetricFilter.LogsMetricFilterMetricTransformations",
		reflect.TypeOf((*LogsMetricFilterMetricTransformations)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.logsMetricFilter.LogsMetricFilterMetricTransformationsDimensions",
		reflect.TypeOf((*LogsMetricFilterMetricTransformationsDimensions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.logsMetricFilter.LogsMetricFilterMetricTransformationsDimensionsList",
		reflect.TypeOf((*LogsMetricFilterMetricTransformationsDimensionsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LogsMetricFilterMetricTransformationsDimensionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LogsMetricFilterMetricTransformationsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LogsMetricFilterMetricTransformationsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
