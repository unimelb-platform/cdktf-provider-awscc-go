...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/stepfunctions_state_machine awscc_stepfunctions_state_machine}.
...
func (j *jsiiProxy_StepfunctionsStateMachine) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_StepfunctionsStateMachine) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_StepfunctionsStateMachine) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StepfunctionsStateMachine) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_StepfunctionsStateMachine) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/stepfunctions_state_machine awscc_stepfunctions_state_machine} Resource.
...
func (j *jsiiProxy_StepfunctionsStateMachine)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StepfunctionsStateMachine)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StepfunctionsStateMachine)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTF code for importing a StepfunctionsStateMachine resource upon running "cdktf plan <stack-name>".
func StepfunctionsStateMachine_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StepfunctionsStateMachine) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StepfunctionsStateMachine) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_StepfunctionsStateMachine) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
