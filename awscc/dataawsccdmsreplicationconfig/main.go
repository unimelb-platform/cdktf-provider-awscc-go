...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDmsReplicationConfig)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccDmsReplicationConfig.DataAwsccDmsReplicationConfigComputeConfig",
		reflect.TypeOf((*DataAwsccDmsReplicationConfigComputeConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccDmsReplicationConfig.DataAwsccDmsReplicationConfigComputeConfigOutputReference",
		reflect.TypeOf((*DataAwsccDmsReplicationConfigComputeConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccDmsReplicationConfig.DataAwsccDmsReplicationConfigConfig",
		reflect.TypeOf((*DataAwsccDmsReplicationConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccDmsReplicationConfig.DataAwsccDmsReplicationConfigTags",
		reflect.TypeOf((*DataAwsccDmsReplicationConfigTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccDmsReplicationConfig.DataAwsccDmsReplicationConfigTagsList",
		reflect.TypeOf((*DataAwsccDmsReplicationConfigTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDmsReplicationConfigTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
