...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/efs_access_point awscc_efs_access_point}.
type EfsAccessPoint interface {
	cdktf.TerraformResource
	AccessPointId() *string
	AccessPointTags() EfsAccessPointAccessPointTagsList
	AccessPointTagsInput() interface{}
	Arn() *string
	// Experimental.
	...
	PutAccessPointTags(value interface{})
...
func (j *jsiiProxy_EfsAccessPoint) AccessPointId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accessPointId",
...
func (j *jsiiProxy_EfsAccessPoint) AccessPointTags() EfsAccessPointAccessPointTagsList {
	var returns EfsAccessPointAccessPointTagsList
	_jsii_.Get(
		j,
		"accessPointTags",
		&returns,
...
func (j *jsiiProxy_EfsAccessPoint) AccessPointTagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"accessPointTagsInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_EfsAccessPoint) ClientToken() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clientToken",
...
func (j *jsiiProxy_EfsAccessPoint) ClientTokenInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clientTokenInput",
...
func (j *jsiiProxy_EfsAccessPoint) PosixUserInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"posixUserInput",
...
func (j *jsiiProxy_EfsAccessPoint) RootDirectoryInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rootDirectoryInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/efs_access_point awscc_efs_access_point} Resource.
...
func (j *jsiiProxy_EfsAccessPoint)SetClientToken(val *string) {
...
func (e *jsiiProxy_EfsAccessPoint) PutAccessPointTags(value interface{}) {
	if err := e.validatePutAccessPointTagsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		e,
...
func (e *jsiiProxy_EfsAccessPoint) ResetAccessPointTags() {
	_jsii_.InvokeVoid(
		e,
		"resetAccessPointTags",
		nil, // no parameters
...
func (e *jsiiProxy_EfsAccessPoint) ResetClientToken() {
	_jsii_.InvokeVoid(
		e,
		"resetClientToken",
		nil, // no parameters
