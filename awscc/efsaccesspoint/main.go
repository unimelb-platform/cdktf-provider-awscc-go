...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "accessPointTagsInput", GoGetter: "AccessPointTagsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putAccessPointTags", GoMethod: "PutAccessPointTags"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAccessPointTags", GoMethod: "ResetAccessPointTags"},
	...
	_jsii_.RegisterStruct(
		"awscc.efsAccessPoint.EfsAccessPointAccessPointTags",
		reflect.TypeOf((*EfsAccessPointAccessPointTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.efsAccessPoint.EfsAccessPointAccessPointTagsList",
		reflect.TypeOf((*EfsAccessPointAccessPointTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EfsAccessPointAccessPointTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.efsAccessPoint.EfsAccessPointConfig",
		reflect.TypeOf((*EfsAccessPointConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.efsAccessPoint.EfsAccessPointPosixUser",
		reflect.TypeOf((*EfsAccessPointPosixUser)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.efsAccessPoint.EfsAccessPointPosixUserOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.efsAccessPoint.EfsAccessPointRootDirectory",
	...
	_jsii_.RegisterClass(
		"awscc.efsAccessPoint.EfsAccessPointRootDirectoryCreationInfoOutputReference",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetOwnerGid", GoMethod: "ResetOwnerGid"},
			_jsii_.MemberMethod{JsiiMethod: "resetOwnerUid", GoMethod: "ResetOwnerUid"},
	...
	_jsii_.RegisterClass(
		"awscc.efsAccessPoint.EfsAccessPointRootDirectoryOutputReference",
