...
func (j *jsiiProxy_EfsAccessPointRootDirectoryOutputReference) CreationInfoInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"creationInfoInput",
...
func (j *jsiiProxy_EfsAccessPointRootDirectoryOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EfsAccessPointRootDirectoryOutputReference)SetInternalValue(val interface{}) {
