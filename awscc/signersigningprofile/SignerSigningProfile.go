...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/signer_signing_profile awscc_signer_signing_profile}.
type SignerSigningProfile interface {
	...
	SignatureValidityPeriodInput() interface{}
...
func (j *jsiiProxy_SignerSigningProfile) ProfileName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"profileName",
...
func (j *jsiiProxy_SignerSigningProfile) ProfileVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"profileVersion",
...
func (j *jsiiProxy_SignerSigningProfile) ProfileVersionArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"profileVersionArn",
...
func (j *jsiiProxy_SignerSigningProfile) SignatureValidityPeriodInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SignerSigningProfile) Tags() SignerSigningProfileTagsList {
	var returns SignerSigningProfileTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/signer_signing_profile awscc_signer_signing_profile} Resource.
func NewSignerSigningProfile(scope constructs.Construct, id *string, config *SignerSigningProfileConfig) SignerSigningProfile {
	...
	_jsii_.Create(
		"awscc.signerSigningProfile.SignerSigningProfile",
...
func (s *jsiiProxy_SignerSigningProfile) PutTags(value interface{}) {
