...
func (j *jsiiProxy_SignerSigningProfileSignatureValidityPeriodOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SignerSigningProfileSignatureValidityPeriodOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_SignerSigningProfileSignatureValidityPeriodOutputReference) ResetType() {
	_jsii_.InvokeVoid(
		s,
		"resetType",
		nil, // no parameters
...
func (s *jsiiProxy_SignerSigningProfileSignatureValidityPeriodOutputReference) ResetValue() {
	_jsii_.InvokeVoid(
		s,
		"resetValue",
		nil, // no parameters
