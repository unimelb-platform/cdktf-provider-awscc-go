...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/apigatewayv2_route_response awscc_apigatewayv2_route_response}.
type Apigatewayv2RouteResponse interface {
	...
	SetResponseModels(val *string)
	ResponseModelsInput() *string
	ResponseParameters() Apigatewayv2RouteResponseResponseParametersMap
...
func (j *jsiiProxy_Apigatewayv2RouteResponse) ResponseModels() *string {
	var returns *string
	_jsii_.Get(
		j,
		"responseModels",
...
func (j *jsiiProxy_Apigatewayv2RouteResponse) ResponseModelsInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"responseModelsInput",
...
func (j *jsiiProxy_Apigatewayv2RouteResponse) ResponseParameters() Apigatewayv2RouteResponseResponseParametersMap {
	var returns Apigatewayv2RouteResponseResponseParametersMap
	_jsii_.Get(
		j,
		"responseParameters",
		&returns,
...
func (j *jsiiProxy_Apigatewayv2RouteResponse) ResponseParametersInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Apigatewayv2RouteResponse) RouteResponseId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"routeResponseId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/apigatewayv2_route_response awscc_apigatewayv2_route_response} Resource.
func NewApigatewayv2RouteResponse(scope constructs.Construct, id *string, config *Apigatewayv2RouteResponseConfig) Apigatewayv2RouteResponse {
	...
	_jsii_.Create(
		"awscc.apigatewayv2RouteResponse.Apigatewayv2RouteResponse",
...
func (j *jsiiProxy_Apigatewayv2RouteResponse)SetResponseModels(val *string) {
...
func (a *jsiiProxy_Apigatewayv2RouteResponse) PutResponseParameters(value interface{}) {
...
func (a *jsiiProxy_Apigatewayv2RouteResponse) ResetResponseParameters() {
	_jsii_.InvokeVoid(
		a,
		"resetResponseParameters",
		nil, // no parameters
