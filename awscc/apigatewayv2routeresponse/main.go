...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "routeResponseId", GoGetter: "RouteResponseId"},
	...
	_jsii_.RegisterStruct(
		"awscc.apigatewayv2RouteResponse.Apigatewayv2RouteResponseConfig",
		reflect.TypeOf((*Apigatewayv2RouteResponseConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.apigatewayv2RouteResponse.Apigatewayv2RouteResponseResponseParameters",
		reflect.TypeOf((*Apigatewayv2RouteResponseResponseParameters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.apigatewayv2RouteResponse.Apigatewayv2RouteResponseResponseParametersMap",
		reflect.TypeOf((*Apigatewayv2RouteResponseResponseParametersMap)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		"awscc.apigatewayv2RouteResponse.Apigatewayv2RouteResponseResponseParametersOutputReference",
		reflect.TypeOf((*Apigatewayv2RouteResponseResponseParametersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_Apigatewayv2RouteResponseResponseParametersOutputReference{}
