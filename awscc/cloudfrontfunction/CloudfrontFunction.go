...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/cloudfront_function awscc_cloudfront_function}.
type CloudfrontFunction interface {
	cdktf.TerraformResource
	AutoPublish() interface{}
	SetAutoPublish(val interface{})
	AutoPublishInput() interface{}
	// Experimental.
	...
	FunctionCodeInput() *string
	FunctionConfig() CloudfrontFunctionFunctionConfigOutputReference
	FunctionConfigInput() interface{}
	FunctionMetadata() CloudfrontFunctionFunctionMetadataOutputReference
	FunctionMetadataInput() interface{}
	Id() *string
	// Experimental.
	...
	PutFunctionConfig(value *CloudfrontFunctionFunctionConfig)
	PutFunctionMetadata(value *CloudfrontFunctionFunctionMetadata)
	ResetAutoPublish()
...
func (j *jsiiProxy_CloudfrontFunction) AutoPublish() interface{} {
...
func (j *jsiiProxy_CloudfrontFunction) AutoPublishInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"autoPublishInput",
...
func (j *jsiiProxy_CloudfrontFunction) FunctionArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"functionArn",
...
func (j *jsiiProxy_CloudfrontFunction) FunctionCode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"functionCode",
...
func (j *jsiiProxy_CloudfrontFunction) FunctionCodeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"functionCodeInput",
...
func (j *jsiiProxy_CloudfrontFunction) FunctionConfig() CloudfrontFunctionFunctionConfigOutputReference {
	var returns CloudfrontFunctionFunctionConfigOutputReference
	_jsii_.Get(
		j,
		"functionConfig",
		&returns,
...
func (j *jsiiProxy_CloudfrontFunction) FunctionConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"functionConfigInput",
...
func (j *jsiiProxy_CloudfrontFunction) FunctionMetadata() CloudfrontFunctionFunctionMetadataOutputReference {
	var returns CloudfrontFunctionFunctionMetadataOutputReference
	_jsii_.Get(
		j,
		"functionMetadata",
		&returns,
...
func (j *jsiiProxy_CloudfrontFunction) FunctionMetadataInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"functionMetadataInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_CloudfrontFunction) Stage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stage",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/cloudfront_function awscc_cloudfront_function} Resource.
...
func (j *jsiiProxy_CloudfrontFunction)SetAutoPublish(val interface{}) {
...
func (j *jsiiProxy_CloudfrontFunction)SetFunctionCode(val *string) {
...
func (c *jsiiProxy_CloudfrontFunction) PutFunctionConfig(value *CloudfrontFunctionFunctionConfig) {
	if err := c.validatePutFunctionConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_CloudfrontFunction) PutFunctionMetadata(value *CloudfrontFunctionFunctionMetadata) {
	if err := c.validatePutFunctionMetadataParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_CloudfrontFunction) ResetAutoPublish() {
	_jsii_.InvokeVoid(
		c,
		"resetAutoPublish",
		nil, // no parameters
...
func (c *jsiiProxy_CloudfrontFunction) ResetFunctionMetadata() {
	_jsii_.InvokeVoid(
		c,
		"resetFunctionMetadata",
		nil, // no parameters
