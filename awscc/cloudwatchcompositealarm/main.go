...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CloudwatchCompositeAlarmTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.cloudwatchCompositeAlarm.CloudwatchCompositeAlarmTagsList",
		reflect.TypeOf((*CloudwatchCompositeAlarmTagsList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_CloudwatchCompositeAlarmTagsList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudwatchCompositeAlarmTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
