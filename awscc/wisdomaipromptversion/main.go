...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WisdomAiPromptVersion)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "aiPromptIdInput", GoGetter: "AiPromptIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "aiPromptVersionId", GoGetter: "AiPromptVersionId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*WisdomAiPromptVersionConfig)(nil)).Elem(),
	)
}
