...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/iaminstanceprofile/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/iam_instance_profile awscc_iam_instance_profile}.
...
func (j *jsiiProxy_IamInstanceProfile) InstanceProfileName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceProfileName",
...
func (j *jsiiProxy_IamInstanceProfile) InstanceProfileNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IamInstanceProfile) Roles() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"roles",
...
func (j *jsiiProxy_IamInstanceProfile) RolesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"rolesInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/iam_instance_profile awscc_iam_instance_profile} Resource.
func NewIamInstanceProfile(scope constructs.Construct, id *string, config *IamInstanceProfileConfig) IamInstanceProfile {
	...
	_jsii_.Create(
		"awscc.iamInstanceProfile.IamInstanceProfile",
...
func (j *jsiiProxy_IamInstanceProfile)SetInstanceProfileName(val *string) {
...
func (j *jsiiProxy_IamInstanceProfile)SetRoles(val *[]*string) {
...
func (i *jsiiProxy_IamInstanceProfile) ResetInstanceProfileName() {
	_jsii_.InvokeVoid(
		i,
		"resetInstanceProfileName",
		nil, // no parameters
