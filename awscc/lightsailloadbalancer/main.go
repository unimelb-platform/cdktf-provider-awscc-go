...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LightsailLoadBalancer)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "attachedInstances", GoGetter: "AttachedInstances"},
			_jsii_.MemberProperty{JsiiProperty: "attachedInstancesInput", GoGetter: "AttachedInstancesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAttachedInstances", GoMethod: "ResetAttachedInstances"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSessionStickinessEnabled", GoMethod: "ResetSessionStickinessEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetSessionStickinessLbCookieDurationSeconds", GoMethod: "ResetSessionStickinessLbCookieDurationSeconds"},
			_jsii_.MemberMethod{JsiiMethod: "resetTags", GoMethod: "ResetTags"},
			_jsii_.MemberMethod{JsiiMethod: "resetTlsPolicyName", GoMethod: "ResetTlsPolicyName"},
			_jsii_.MemberProperty{JsiiProperty: "sessionStickinessEnabled", GoGetter: "SessionStickinessEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "sessionStickinessEnabledInput", GoGetter: "SessionStickinessEnabledInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sessionStickinessLbCookieDurationSecondsInput", GoGetter: "SessionStickinessLbCookieDurationSecondsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tlsPolicyNameInput", GoGetter: "TlsPolicyNameInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LightsailLoadBalancerConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.lightsailLoadBalancer.LightsailLoadBalancerTags",
		reflect.TypeOf((*LightsailLoadBalancerTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.lightsailLoadBalancer.LightsailLoadBalancerTagsList",
		reflect.TypeOf((*LightsailLoadBalancerTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LightsailLoadBalancerTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
