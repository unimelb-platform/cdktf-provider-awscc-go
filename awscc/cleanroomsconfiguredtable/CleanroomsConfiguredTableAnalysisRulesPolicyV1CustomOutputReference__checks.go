...
func (c *jsiiProxy_CleanroomsConfiguredTableAnalysisRulesPolicyV1CustomOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (j *jsiiProxy_CleanroomsConfiguredTableAnalysisRulesPolicyV1CustomOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *CleanroomsConfiguredTableAnalysisRulesPolicyV1Custom:
		val := val.(*CleanroomsConfiguredTableAnalysisRulesPolicyV1Custom)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CleanroomsConfiguredTableAnalysisRulesPolicyV1Custom:
		val_ := val.(CleanroomsConfiguredTableAnalysisRulesPolicyV1Custom)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *CleanroomsConfiguredTableAnalysisRulesPolicyV1Custom; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CleanroomsConfiguredTableAnalysisRulesPolicyV1CustomOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewCleanroomsConfiguredTableAnalysisRulesPolicyV1CustomOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
