...
func (c *jsiiProxy_CleanroomsConfiguredTableAnalysisRulesPolicyV1AggregationOutputConstraintsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
