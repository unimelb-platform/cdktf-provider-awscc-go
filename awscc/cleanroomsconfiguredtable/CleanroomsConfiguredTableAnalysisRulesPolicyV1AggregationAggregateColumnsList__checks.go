...
func (c *jsiiProxy_CleanroomsConfiguredTableAnalysisRulesPolicyV1AggregationAggregateColumnsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
