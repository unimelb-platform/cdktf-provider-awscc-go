...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IotScheduledAudit)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetScheduledAuditName", GoMethod: "ResetScheduledAuditName"},
			...
			_jsii_.MemberProperty{JsiiProperty: "scheduledAuditNameInput", GoGetter: "ScheduledAuditNameInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "targetCheckNamesInput", GoGetter: "TargetCheckNamesInput"},
	...
	_jsii_.RegisterStruct(
		"awscc.iotScheduledAudit.IotScheduledAuditConfig",
		reflect.TypeOf((*IotScheduledAuditConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.iotScheduledAudit.IotScheduledAuditTags",
		reflect.TypeOf((*IotScheduledAuditTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.iotScheduledAudit.IotScheduledAuditTagsList",
		reflect.TypeOf((*IotScheduledAuditTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IotScheduledAuditTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
