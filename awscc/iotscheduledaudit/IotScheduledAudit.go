...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/iot_scheduled_audit awscc_iot_scheduled_audit}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/iot_scheduled_audit awscc_iot_scheduled_audit} Resource.
...
func (i *jsiiProxy_IotScheduledAudit) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IotScheduledAudit) MoveFromId(id *string) {
...
func (i *jsiiProxy_IotScheduledAudit) MoveToId(id *string) {
...
func (i *jsiiProxy_IotScheduledAudit) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IotScheduledAudit) ToHclTerraform() interface{} {
	var returns interface{}
