...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SesDedicatedIpPool)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPoolName", GoMethod: "ResetPoolName"},
	...
	_jsii_.RegisterStruct(
		"awscc.sesDedicatedIpPool.SesDedicatedIpPoolConfig",
		reflect.TypeOf((*SesDedicatedIpPoolConfig)(nil)).Elem(),
	)
}
