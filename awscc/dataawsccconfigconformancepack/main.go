...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccConfigConformancePack)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccConfigConformancePack.DataAwsccConfigConformancePackConfig",
		reflect.TypeOf((*DataAwsccConfigConformancePackConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccConfigConformancePack.DataAwsccConfigConformancePackConformancePackInputParameters",
		reflect.TypeOf((*DataAwsccConfigConformancePackConformancePackInputParameters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccConfigConformancePack.DataAwsccConfigConformancePackConformancePackInputParametersList",
		reflect.TypeOf((*DataAwsccConfigConformancePackConformancePackInputParametersList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccConfigConformancePackConformancePackInputParametersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccConfigConformancePack.DataAwsccConfigConformancePackTemplateSsmDocumentDetails",
		reflect.TypeOf((*DataAwsccConfigConformancePackTemplateSsmDocumentDetails)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccConfigConformancePack.DataAwsccConfigConformancePackTemplateSsmDocumentDetailsOutputReference",
		reflect.TypeOf((*DataAwsccConfigConformancePackTemplateSsmDocumentDetailsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
