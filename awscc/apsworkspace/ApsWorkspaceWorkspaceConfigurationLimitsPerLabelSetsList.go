...
func (j *jsiiProxy_ApsWorkspaceWorkspaceConfigurationLimitsPerLabelSetsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewApsWorkspaceWorkspaceConfigurationLimitsPerLabelSetsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApsWorkspaceWorkspaceConfigurationLimitsPerLabelSetsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"awscc.apsWorkspace.ApsWorkspaceWorkspaceConfigurationLimitsPerLabelSetsList",
...
func NewApsWorkspaceWorkspaceConfigurationLimitsPerLabelSetsList_Override(a ApsWorkspaceWorkspaceConfigurationLimitsPerLabelSetsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApsWorkspaceWorkspaceConfigurationLimitsPerLabelSetsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (a *jsiiProxy_ApsWorkspaceWorkspaceConfigurationLimitsPerLabelSetsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApsWorkspaceWorkspaceConfigurationLimitsPerLabelSetsList) Resolve(_context cdktf.IResolveContext) interface{} {
