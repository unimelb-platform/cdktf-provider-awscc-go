...
type CleanroomsCollaboration interface {
	...
	DataEncryptionMetadataInput() interface{}
	// Experimental.
	DependsOn() *[]*string
	// Experimental.
...
func (j *jsiiProxy_CleanroomsCollaboration) CollaborationIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CleanroomsCollaboration) CreatorPaymentConfiguration() CleanroomsCollaborationCreatorPaymentConfigurationOutputReference {
	var returns CleanroomsCollaborationCreatorPaymentConfigurationOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CleanroomsCollaboration) CreatorPaymentConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"creatorPaymentConfigurationInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_CleanroomsCollaboration) DataEncryptionMetadataInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CleanroomsCollaboration) Members() CleanroomsCollaborationMembersList {
	var returns CleanroomsCollaborationMembersList
	_jsii_.Get(
		j,
		"members",
		&returns,
...
func (j *jsiiProxy_CleanroomsCollaboration) MembersInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"membersInput",
...
func (j *jsiiProxy_CleanroomsCollaboration) Tags() CleanroomsCollaborationTagsList {
	var returns CleanroomsCollaborationTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_CleanroomsCollaboration) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (c *jsiiProxy_CleanroomsCollaboration) PutCreatorPaymentConfiguration(value *CleanroomsCollaborationCreatorPaymentConfiguration) {
	if err := c.validatePutCreatorPaymentConfigurationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
		"putCreatorPaymentConfiguration",
		[]interface{}{value},
	)
}
...
func (c *jsiiProxy_CleanroomsCollaboration) PutMembers(value interface{}) {
...
func (c *jsiiProxy_CleanroomsCollaboration) PutTags(value interface{}) {
