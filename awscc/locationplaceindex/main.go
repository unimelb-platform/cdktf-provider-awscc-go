...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.locationPlaceIndex.LocationPlaceIndexConfig",
		reflect.TypeOf((*LocationPlaceIndexConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.locationPlaceIndex.LocationPlaceIndexDataSourceConfiguration",
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LocationPlaceIndexTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.locationPlaceIndex.LocationPlaceIndexTagsList",
		reflect.TypeOf((*LocationPlaceIndexTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LocationPlaceIndexTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
