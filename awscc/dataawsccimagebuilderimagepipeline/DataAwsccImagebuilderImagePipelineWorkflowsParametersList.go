...
func (d *jsiiProxy_DataAwsccImagebuilderImagePipelineWorkflowsParametersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
