...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccOmicsWorkflow)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccOmicsWorkflow.DataAwsccOmicsWorkflowConfig",
		reflect.TypeOf((*DataAwsccOmicsWorkflowConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccOmicsWorkflow.DataAwsccOmicsWorkflowParameterTemplate",
		reflect.TypeOf((*DataAwsccOmicsWorkflowParameterTemplate)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccOmicsWorkflow.DataAwsccOmicsWorkflowParameterTemplateMap",
		reflect.TypeOf((*DataAwsccOmicsWorkflowParameterTemplateMap)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccOmicsWorkflowParameterTemplateOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
