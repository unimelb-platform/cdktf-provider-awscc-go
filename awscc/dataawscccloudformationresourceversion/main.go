...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCloudformationResourceVersion)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccCloudformationResourceVersion.DataAwsccCloudformationResourceVersionConfig",
		reflect.TypeOf((*DataAwsccCloudformationResourceVersionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccCloudformationResourceVersion.DataAwsccCloudformationResourceVersionLoggingConfig",
		reflect.TypeOf((*DataAwsccCloudformationResourceVersionLoggingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccCloudformationResourceVersion.DataAwsccCloudformationResourceVersionLoggingConfigOutputReference",
		reflect.TypeOf((*DataAwsccCloudformationResourceVersionLoggingConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
