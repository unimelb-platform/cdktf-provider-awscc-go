...
func NewQbusinessApplicationEncryptionConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) QbusinessApplicationEncryptionConfigurationOutputReference {
	_init_.Initialize()

	if err := validateNewQbusinessApplicationEncryptionConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewQbusinessApplicationEncryptionConfigurationOutputReference_Override(q QbusinessApplicationEncryptionConfigurationOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (q *jsiiProxy_QbusinessApplicationEncryptionConfigurationOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QbusinessApplicationEncryptionConfigurationOutputReference) ResetKmsKeyId() {
	_jsii_.InvokeVoid(
		q,
		"resetKmsKeyId",
		nil, // no parameters
...
func (q *jsiiProxy_QbusinessApplicationEncryptionConfigurationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
