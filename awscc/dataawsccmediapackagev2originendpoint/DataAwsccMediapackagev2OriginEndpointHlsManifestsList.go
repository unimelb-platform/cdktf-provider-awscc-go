...
func (j *jsiiProxy_DataAwsccMediapackagev2OriginEndpointHlsManifestsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsccMediapackagev2OriginEndpointHlsManifestsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccMediapackagev2OriginEndpointHlsManifestsList {
	_init_.Initialize()
...
func NewDataAwsccMediapackagev2OriginEndpointHlsManifestsList_Override(d DataAwsccMediapackagev2OriginEndpointHlsManifestsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccMediapackagev2OriginEndpointHlsManifestsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccMediapackagev2OriginEndpointHlsManifestsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccMediapackagev2OriginEndpointHlsManifestsList) Resolve(_context cdktf.IResolveContext) interface{} {
