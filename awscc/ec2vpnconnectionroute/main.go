...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2VpnConnectionRoute)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.ec2VpnConnectionRoute.Ec2VpnConnectionRouteConfig",
		reflect.TypeOf((*Ec2VpnConnectionRouteConfig)(nil)).Elem(),
	)
}
