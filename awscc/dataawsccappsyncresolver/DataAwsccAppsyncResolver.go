...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/data-sources/appsync_resolver awscc_appsync_resolver}.
...
func (j *jsiiProxy_DataAwsccAppsyncResolver) MetricsConfig() *string {
	var returns *string
	_jsii_.Get(
		j,
		"metricsConfig",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/data-sources/appsync_resolver awscc_appsync_resolver} Data Source.
...
func (d *jsiiProxy_DataAwsccAppsyncResolver) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsccAppsyncResolver) ToHclTerraform() interface{} {
	var returns interface{}
