...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2TransitGatewayMulticastGroupSource)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccEc2TransitGatewayMulticastGroupSource.DataAwsccEc2TransitGatewayMulticastGroupSourceConfig",
		reflect.TypeOf((*DataAwsccEc2TransitGatewayMulticastGroupSourceConfig)(nil)).Elem(),
	)
}
