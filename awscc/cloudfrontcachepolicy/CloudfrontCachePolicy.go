...
type CloudfrontCachePolicy interface {
	...
	PutCachePolicyConfig(value *CloudfrontCachePolicyCachePolicyConfig)
...
func (j *jsiiProxy_CloudfrontCachePolicy) CachePolicyConfig() CloudfrontCachePolicyCachePolicyConfigOutputReference {
	var returns CloudfrontCachePolicyCachePolicyConfigOutputReference
	_jsii_.Get(
		j,
		"cachePolicyConfig",
		&returns,
...
func (j *jsiiProxy_CloudfrontCachePolicy) CachePolicyConfigInput() interface{} {
...
func (j *jsiiProxy_CloudfrontCachePolicy) LastModifiedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lastModifiedTime",
...
func (c *jsiiProxy_CloudfrontCachePolicy) PutCachePolicyConfig(value *CloudfrontCachePolicyCachePolicyConfig) {
	if err := c.validatePutCachePolicyConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
		"putCachePolicyConfig",
		[]interface{}{value},
	)
}
