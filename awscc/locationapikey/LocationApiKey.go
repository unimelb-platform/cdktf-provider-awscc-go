...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/location_api_key awscc_location_api_key}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/location_api_key awscc_location_api_key} Resource.
...
func (l *jsiiProxy_LocationApiKey) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LocationApiKey) MoveFromId(id *string) {
...
func (l *jsiiProxy_LocationApiKey) MoveToId(id *string) {
...
func (l *jsiiProxy_LocationApiKey) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LocationApiKey) ToHclTerraform() interface{} {
	var returns interface{}
