...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LocationApiKey)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LocationApiKeyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.locationApiKey.LocationApiKeyRestrictions",
		reflect.TypeOf((*LocationApiKeyRestrictions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.locationApiKey.LocationApiKeyRestrictionsOutputReference",
		reflect.TypeOf((*LocationApiKeyRestrictionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "allowActions", GoGetter: "AllowActions"},
			_jsii_.MemberProperty{JsiiProperty: "allowActionsInput", GoGetter: "AllowActionsInput"},
			_jsii_.MemberProperty{JsiiProperty: "allowReferers", GoGetter: "AllowReferers"},
			_jsii_.MemberProperty{JsiiProperty: "allowReferersInput", GoGetter: "AllowReferersInput"},
			_jsii_.MemberProperty{JsiiProperty: "allowResources", GoGetter: "AllowResources"},
			_jsii_.MemberProperty{JsiiProperty: "allowResourcesInput", GoGetter: "AllowResourcesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetAllowReferers", GoMethod: "ResetAllowReferers"},
	...
	_jsii_.RegisterStruct(
		"awscc.locationApiKey.LocationApiKeyTags",
		reflect.TypeOf((*LocationApiKeyTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.locationApiKey.LocationApiKeyTagsList",
		reflect.TypeOf((*LocationApiKeyTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LocationApiKeyTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
