...
func (e *jsiiProxy_EvidentlyLaunchScheduledSplitsConfigOutputReference) validatePutGroupWeightsParameters(value interface{}) error {
	...
	case *[]*EvidentlyLaunchScheduledSplitsConfigGroupWeights:
		value := value.(*[]*EvidentlyLaunchScheduledSplitsConfigGroupWeights)
	...
	case []*EvidentlyLaunchScheduledSplitsConfigGroupWeights:
		value_ := value.([]*EvidentlyLaunchScheduledSplitsConfigGroupWeights)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*EvidentlyLaunchScheduledSplitsConfigGroupWeights; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_EvidentlyLaunchScheduledSplitsConfigOutputReference) validatePutSegmentOverridesParameters(value interface{}) error {
	...
	case *[]*EvidentlyLaunchScheduledSplitsConfigSegmentOverrides:
		value := value.(*[]*EvidentlyLaunchScheduledSplitsConfigSegmentOverrides)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*EvidentlyLaunchScheduledSplitsConfigSegmentOverrides:
		value_ := value.([]*EvidentlyLaunchScheduledSplitsConfigSegmentOverrides)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*EvidentlyLaunchScheduledSplitsConfigSegmentOverrides; received %#v (a %T)", value, value)
		}
	}
...
func validateNewEvidentlyLaunchScheduledSplitsConfigOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
