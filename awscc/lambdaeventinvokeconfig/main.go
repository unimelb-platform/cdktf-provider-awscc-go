...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LambdaEventInvokeConfig)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.lambdaEventInvokeConfig.LambdaEventInvokeConfigConfig",
		reflect.TypeOf((*LambdaEventInvokeConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.lambdaEventInvokeConfig.LambdaEventInvokeConfigDestinationConfig",
		reflect.TypeOf((*LambdaEventInvokeConfigDestinationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.lambdaEventInvokeConfig.LambdaEventInvokeConfigDestinationConfigOnFailure",
		reflect.TypeOf((*LambdaEventInvokeConfigDestinationConfigOnFailure)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.lambdaEventInvokeConfig.LambdaEventInvokeConfigDestinationConfigOnFailureOutputReference",
		reflect.TypeOf((*LambdaEventInvokeConfigDestinationConfigOnFailureOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.lambdaEventInvokeConfig.LambdaEventInvokeConfigDestinationConfigOnSuccess",
		reflect.TypeOf((*LambdaEventInvokeConfigDestinationConfigOnSuccess)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.lambdaEventInvokeConfig.LambdaEventInvokeConfigDestinationConfigOnSuccessOutputReference",
		reflect.TypeOf((*LambdaEventInvokeConfigDestinationConfigOnSuccessOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LambdaEventInvokeConfigDestinationConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
