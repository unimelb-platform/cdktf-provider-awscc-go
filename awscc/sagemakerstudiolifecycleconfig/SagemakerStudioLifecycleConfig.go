...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/sagemaker_studio_lifecycle_config awscc_sagemaker_studio_lifecycle_config}.
...
func (j *jsiiProxy_SagemakerStudioLifecycleConfig) StudioLifecycleConfigArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerStudioLifecycleConfig) Tags() SagemakerStudioLifecycleConfigTagsList {
	var returns SagemakerStudioLifecycleConfigTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/sagemaker_studio_lifecycle_config awscc_sagemaker_studio_lifecycle_config} Resource.
func NewSagemakerStudioLifecycleConfig(scope constructs.Construct, id *string, config *SagemakerStudioLifecycleConfigConfig) SagemakerStudioLifecycleConfig {
	...
	_jsii_.Create(
		"awscc.sagemakerStudioLifecycleConfig.SagemakerStudioLifecycleConfig",
...
func (s *jsiiProxy_SagemakerStudioLifecycleConfig) PutTags(value interface{}) {
