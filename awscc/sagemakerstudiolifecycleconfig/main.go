...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.sagemakerStudioLifecycleConfig.SagemakerStudioLifecycleConfigConfig",
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SagemakerStudioLifecycleConfigTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.sagemakerStudioLifecycleConfig.SagemakerStudioLifecycleConfigTagsList",
		reflect.TypeOf((*SagemakerStudioLifecycleConfigTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SagemakerStudioLifecycleConfigTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
