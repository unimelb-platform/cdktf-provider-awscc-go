...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccWisdomAiPrompt)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccWisdomAiPrompt.DataAwsccWisdomAiPromptConfig",
		reflect.TypeOf((*DataAwsccWisdomAiPromptConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccWisdomAiPrompt.DataAwsccWisdomAiPromptTemplateConfiguration",
		reflect.TypeOf((*DataAwsccWisdomAiPromptTemplateConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccWisdomAiPrompt.DataAwsccWisdomAiPromptTemplateConfigurationOutputReference",
		reflect.TypeOf((*DataAwsccWisdomAiPromptTemplateConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccWisdomAiPromptTemplateConfigurationTextFullAiPromptEditTemplateConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccWisdomAiPromptTemplateConfigurationTextFullAiPromptEditTemplateConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
