...
func (j *jsiiProxy_DmsReplicationConfigComputeConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_DmsReplicationConfigComputeConfigOutputReference)SetInternalValue(val interface{}) {
...
func (d *jsiiProxy_DmsReplicationConfigComputeConfigOutputReference) ResetReplicationSubnetGroupId() {
	_jsii_.InvokeVoid(
		d,
		"resetReplicationSubnetGroupId",
		nil, // no parameters
