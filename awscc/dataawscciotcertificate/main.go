...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccIotCertificate)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccIotCertificate.DataAwsccIotCertificateConfig",
		reflect.TypeOf((*DataAwsccIotCertificateConfig)(nil)).Elem(),
	)
}
