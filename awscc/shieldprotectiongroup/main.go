...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.shieldProtectionGroup.ShieldProtectionGroupConfig",
		reflect.TypeOf((*ShieldProtectionGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.shieldProtectionGroup.ShieldProtectionGroupTags",
		reflect.TypeOf((*ShieldProtectionGroupTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.shieldProtectionGroup.ShieldProtectionGroupTagsList",
		reflect.TypeOf((*ShieldProtectionGroupTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ShieldProtectionGroupTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
