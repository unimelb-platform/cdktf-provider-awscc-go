...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/shield_protection_group awscc_shield_protection_group}.
...
func (j *jsiiProxy_ShieldProtectionGroup) Tags() ShieldProtectionGroupTagsList {
	var returns ShieldProtectionGroupTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/shield_protection_group awscc_shield_protection_group} Resource.
func NewShieldProtectionGroup(scope constructs.Construct, id *string, config *ShieldProtectionGroupConfig) ShieldProtectionGroup {
	...
	_jsii_.Create(
		"awscc.shieldProtectionGroup.ShieldProtectionGroup",
...
func (s *jsiiProxy_ShieldProtectionGroup) PutTags(value interface{}) {
