...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAdditionalSchemaElements", GoMethod: "ResetAdditionalSchemaElements"},
	...
	_jsii_.RegisterStruct(
		"awscc.curReportDefinition.CurReportDefinitionConfig",
