...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/nimblestudio_launch_profile awscc_nimblestudio_launch_profile}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/nimblestudio_launch_profile awscc_nimblestudio_launch_profile} Resource.
...
func (n *jsiiProxy_NimblestudioLaunchProfile) HasResourceMove() interface{} {
	var returns interface{}
...
func (n *jsiiProxy_NimblestudioLaunchProfile) MoveFromId(id *string) {
...
func (n *jsiiProxy_NimblestudioLaunchProfile) MoveToId(id *string) {
...
func (n *jsiiProxy_NimblestudioLaunchProfile) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (n *jsiiProxy_NimblestudioLaunchProfile) ToHclTerraform() interface{} {
	var returns interface{}
