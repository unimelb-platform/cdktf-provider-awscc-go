...
type ConnectSecurityProfile interface {
	...
	TagRestrictedResourcesInput() *[]*string
...
func (j *jsiiProxy_ConnectSecurityProfile) AllowedAccessControlTags() ConnectSecurityProfileAllowedAccessControlTagsList {
	var returns ConnectSecurityProfileAllowedAccessControlTagsList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ConnectSecurityProfile) AllowedAccessControlTagsInput() interface{} {
...
func (j *jsiiProxy_ConnectSecurityProfile) InstanceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceArn",
...
func (j *jsiiProxy_ConnectSecurityProfile) InstanceArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceArnInput",
...
func (j *jsiiProxy_ConnectSecurityProfile) SecurityProfileArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"securityProfileArn",
...
func (j *jsiiProxy_ConnectSecurityProfile) SecurityProfileName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"securityProfileName",
...
func (j *jsiiProxy_ConnectSecurityProfile) SecurityProfileNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ConnectSecurityProfile) TagRestrictedResources() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ConnectSecurityProfile) TagRestrictedResourcesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"tagRestrictedResourcesInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_ConnectSecurityProfile) Tags() ConnectSecurityProfileTagsList {
	var returns ConnectSecurityProfileTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_ConnectSecurityProfile) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_ConnectSecurityProfile)SetInstanceArn(val *string) {
...
func (j *jsiiProxy_ConnectSecurityProfile)SetSecurityProfileName(val *string) {
...
func (j *jsiiProxy_ConnectSecurityProfile)SetTagRestrictedResources(val *[]*string) {
	if err := j.validateSetTagRestrictedResourcesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (c *jsiiProxy_ConnectSecurityProfile) PutAllowedAccessControlTags(value interface{}) {
	if err := c.validatePutAllowedAccessControlTagsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
		"putAllowedAccessControlTags",
		[]interface{}{value},
	)
}
...
func (c *jsiiProxy_ConnectSecurityProfile) ResetTagRestrictedResources() {
	_jsii_.InvokeVoid(
		c,
		"resetTagRestrictedResources",
		nil, // no parameters
