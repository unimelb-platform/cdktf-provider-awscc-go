...
func (c *jsiiProxy_ConnectSecurityProfile) validatePutAllowedAccessControlTagsParameters(value interface{}) error {
	...
	case *[]*ConnectSecurityProfileAllowedAccessControlTags:
		value := value.(*[]*ConnectSecurityProfileAllowedAccessControlTags)
	...
	case []*ConnectSecurityProfileAllowedAccessControlTags:
		value_ := value.([]*ConnectSecurityProfileAllowedAccessControlTags)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ConnectSecurityProfileAllowedAccessControlTags; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_ConnectSecurityProfile) validatePutApplicationsParameters(value interface{}) error {
	...
	case *[]*ConnectSecurityProfileApplications:
		value := value.(*[]*ConnectSecurityProfileApplications)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*ConnectSecurityProfileApplications:
		value_ := value.([]*ConnectSecurityProfileApplications)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ConnectSecurityProfileApplications; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_ConnectSecurityProfile) validatePutTagsParameters(value interface{}) error {
	...
	case *[]*ConnectSecurityProfileTags:
		value := value.(*[]*ConnectSecurityProfileTags)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*ConnectSecurityProfileTags:
		value_ := value.([]*ConnectSecurityProfileTags)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ConnectSecurityProfileTags; received %#v (a %T)", value, value)
		}
	}
