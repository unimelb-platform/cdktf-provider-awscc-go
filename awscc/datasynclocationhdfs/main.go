...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "nameNodesInput", GoGetter: "NameNodesInput"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
			_jsii_.MemberMethod{JsiiMethod: "overrideLogicalId", GoMethod: "OverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putNameNodes", GoMethod: "PutNameNodes"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DatasyncLocationHdfsNameNodes)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.datasyncLocationHdfs.DatasyncLocationHdfsNameNodesList",
		reflect.TypeOf((*DatasyncLocationHdfsNameNodesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DatasyncLocationHdfsNameNodesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.datasyncLocationHdfs.DatasyncLocationHdfsQopConfiguration",
		reflect.TypeOf((*DatasyncLocationHdfsQopConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.datasyncLocationHdfs.DatasyncLocationHdfsQopConfigurationOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.datasyncLocationHdfs.DatasyncLocationHdfsTags",
		reflect.TypeOf((*DatasyncLocationHdfsTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.datasyncLocationHdfs.DatasyncLocationHdfsTagsList",
		reflect.TypeOf((*DatasyncLocationHdfsTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DatasyncLocationHdfsTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
