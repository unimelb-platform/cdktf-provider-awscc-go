...
func (j *jsiiProxy_CodedeployDeploymentConfigMinimumHealthyHostsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_CodedeployDeploymentConfigMinimumHealthyHostsOutputReference)SetInternalValue(val interface{}) {
