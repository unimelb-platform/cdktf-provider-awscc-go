...
type CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedCanaryOutputReference interface {
	...
	SetCanaryInterval(val *float64)
	CanaryIntervalInput() *float64
	CanaryPercentage() *float64
	SetCanaryPercentage(val *float64)
	CanaryPercentageInput() *float64
...
func (j *jsiiProxy_CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedCanaryOutputReference) CanaryInterval() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"canaryInterval",
...
func (j *jsiiProxy_CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedCanaryOutputReference) CanaryIntervalInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"canaryIntervalInput",
...
func (j *jsiiProxy_CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedCanaryOutputReference) CanaryPercentage() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"canaryPercentage",
...
func (j *jsiiProxy_CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedCanaryOutputReference) CanaryPercentageInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"canaryPercentageInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedCanaryOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedCanaryOutputReference)SetCanaryInterval(val *float64) {
	if err := j.validateSetCanaryIntervalParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedCanaryOutputReference)SetCanaryPercentage(val *float64) {
	if err := j.validateSetCanaryPercentageParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedCanaryOutputReference)SetInternalValue(val interface{}) {
