...
func (j *jsiiProxy_CodedeployDeploymentConfigTrafficRoutingConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_CodedeployDeploymentConfigTrafficRoutingConfigOutputReference) TimeBasedCanaryInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CodedeployDeploymentConfigTrafficRoutingConfigOutputReference) TimeBasedLinearInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CodedeployDeploymentConfigTrafficRoutingConfigOutputReference)SetInternalValue(val interface{}) {
