...
type CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedLinearOutputReference interface {
	...
	SetLinearInterval(val *float64)
	LinearIntervalInput() *float64
	LinearPercentage() *float64
	SetLinearPercentage(val *float64)
	LinearPercentageInput() *float64
	// Experimental.
...
func (j *jsiiProxy_CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedLinearOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedLinearOutputReference) LinearInterval() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"linearInterval",
...
func (j *jsiiProxy_CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedLinearOutputReference) LinearIntervalInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"linearIntervalInput",
...
func (j *jsiiProxy_CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedLinearOutputReference) LinearPercentage() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"linearPercentage",
...
func (j *jsiiProxy_CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedLinearOutputReference) LinearPercentageInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"linearPercentageInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedLinearOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedLinearOutputReference)SetLinearInterval(val *float64) {
	if err := j.validateSetLinearIntervalParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedLinearOutputReference)SetLinearPercentage(val *float64) {
	if err := j.validateSetLinearPercentageParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
