...
func (b *jsiiProxy_BackupBackupPlanBackupPlanOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (b *jsiiProxy_BackupBackupPlanBackupPlanOutputReference) validatePutAdvancedBackupSettingsParameters(value interface{}) error {
	...
	case *[]*BackupBackupPlanBackupPlanAdvancedBackupSettings:
		value := value.(*[]*BackupBackupPlanBackupPlanAdvancedBackupSettings)
	...
	case []*BackupBackupPlanBackupPlanAdvancedBackupSettings:
		value_ := value.([]*BackupBackupPlanBackupPlanAdvancedBackupSettings)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*BackupBackupPlanBackupPlanAdvancedBackupSettings; received %#v (a %T)", value, value)
		}
	}
...
func (b *jsiiProxy_BackupBackupPlanBackupPlanOutputReference) validatePutBackupPlanRuleParameters(value interface{}) error {
	...
	case *[]*BackupBackupPlanBackupPlanBackupPlanRule:
		value := value.(*[]*BackupBackupPlanBackupPlanBackupPlanRule)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*BackupBackupPlanBackupPlanBackupPlanRule:
		value_ := value.([]*BackupBackupPlanBackupPlanBackupPlanRule)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*BackupBackupPlanBackupPlanBackupPlanRule; received %#v (a %T)", value, value)
		}
	}
...
func (b *jsiiProxy_BackupBackupPlanBackupPlanOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_BackupBackupPlanBackupPlanOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *BackupBackupPlanBackupPlan:
		val := val.(*BackupBackupPlanBackupPlan)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case BackupBackupPlanBackupPlan:
		val_ := val.(BackupBackupPlanBackupPlan)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *BackupBackupPlanBackupPlan; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_BackupBackupPlanBackupPlanOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewBackupBackupPlanBackupPlanOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
