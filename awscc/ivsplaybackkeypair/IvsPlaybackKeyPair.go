...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/ivs_playback_key_pair awscc_ivs_playback_key_pair}.
type IvsPlaybackKeyPair interface {
	...
	PublicKeyMaterialInput() *string
	// Experimental.
	RawOverrides() interface{}
	Tags() IvsPlaybackKeyPairTagsList
	TagsInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_IvsPlaybackKeyPair) PublicKeyMaterial() *string {
	var returns *string
	_jsii_.Get(
		j,
		"publicKeyMaterial",
...
func (j *jsiiProxy_IvsPlaybackKeyPair) PublicKeyMaterialInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"publicKeyMaterialInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_IvsPlaybackKeyPair) Tags() IvsPlaybackKeyPairTagsList {
	var returns IvsPlaybackKeyPairTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_IvsPlaybackKeyPair) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/ivs_playback_key_pair awscc_ivs_playback_key_pair} Resource.
func NewIvsPlaybackKeyPair(scope constructs.Construct, id *string, config *IvsPlaybackKeyPairConfig) IvsPlaybackKeyPair {
	...
	_jsii_.Create(
		"awscc.ivsPlaybackKeyPair.IvsPlaybackKeyPair",
...
func (j *jsiiProxy_IvsPlaybackKeyPair)SetPublicKeyMaterial(val *string) {
...
func (i *jsiiProxy_IvsPlaybackKeyPair) PutTags(value interface{}) {
...
func (i *jsiiProxy_IvsPlaybackKeyPair) ResetPublicKeyMaterial() {
	_jsii_.InvokeVoid(
		i,
		"resetPublicKeyMaterial",
		nil, // no parameters
