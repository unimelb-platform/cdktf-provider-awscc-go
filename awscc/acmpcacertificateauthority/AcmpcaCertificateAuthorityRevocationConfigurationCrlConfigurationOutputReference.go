...
func (j *jsiiProxy_AcmpcaCertificateAuthorityRevocationConfigurationCrlConfigurationOutputReference) CrlDistributionPointExtensionConfiguration() AcmpcaCertificateAuthorityRevocationConfigurationCrlConfigurationCrlDistributionPointExtensionConfigurationOutputReference {
	var returns AcmpcaCertificateAuthorityRevocationConfigurationCrlConfigurationCrlDistributionPointExtensionConfigurationOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AcmpcaCertificateAuthorityRevocationConfigurationCrlConfigurationOutputReference) CrlDistributionPointExtensionConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"crlDistributionPointExtensionConfigurationInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_AcmpcaCertificateAuthorityRevocationConfigurationCrlConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_AcmpcaCertificateAuthorityRevocationConfigurationCrlConfigurationOutputReference)SetInternalValue(val interface{}) {
...
func (a *jsiiProxy_AcmpcaCertificateAuthorityRevocationConfigurationCrlConfigurationOutputReference) PutCrlDistributionPointExtensionConfiguration(value *AcmpcaCertificateAuthorityRevocationConfigurationCrlConfigurationCrlDistributionPointExtensionConfiguration) {
	if err := a.validatePutCrlDistributionPointExtensionConfigurationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
		"putCrlDistributionPointExtensionConfiguration",
		[]interface{}{value},
	)
}

func (a *jsiiProxy_AcmpcaCertificateAuthorityRevocationConfigurationCrlConfigurationOutputReference) ResetCrlDistributionPointExtensionConfiguration() {
	_jsii_.InvokeVoid(
		a,
		"resetCrlDistributionPointExtensionConfiguration",
		nil, // no parameters
