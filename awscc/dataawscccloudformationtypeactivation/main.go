...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCloudformationTypeActivation)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccCloudformationTypeActivation.DataAwsccCloudformationTypeActivationConfig",
		reflect.TypeOf((*DataAwsccCloudformationTypeActivationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccCloudformationTypeActivation.DataAwsccCloudformationTypeActivationLoggingConfig",
		reflect.TypeOf((*DataAwsccCloudformationTypeActivationLoggingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccCloudformationTypeActivation.DataAwsccCloudformationTypeActivationLoggingConfigOutputReference",
		reflect.TypeOf((*DataAwsccCloudformationTypeActivationLoggingConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
