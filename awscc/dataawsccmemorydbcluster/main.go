...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccMemorydbCluster)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccMemorydbClusterClusterEndpoint)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccMemorydbCluster.DataAwsccMemorydbClusterClusterEndpointOutputReference",
		reflect.TypeOf((*DataAwsccMemorydbClusterClusterEndpointOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccMemorydbCluster.DataAwsccMemorydbClusterConfig",
		reflect.TypeOf((*DataAwsccMemorydbClusterConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccMemorydbCluster.DataAwsccMemorydbClusterTags",
		reflect.TypeOf((*DataAwsccMemorydbClusterTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccMemorydbCluster.DataAwsccMemorydbClusterTagsList",
		reflect.TypeOf((*DataAwsccMemorydbClusterTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		"awscc.dataAwsccMemorydbCluster.DataAwsccMemorydbClusterTagsOutputReference",
		reflect.TypeOf((*DataAwsccMemorydbClusterTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccMemorydbClusterTagsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
