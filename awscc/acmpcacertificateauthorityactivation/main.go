...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AcmpcaCertificateAuthorityActivation)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.acmpcaCertificateAuthorityActivation.AcmpcaCertificateAuthorityActivationConfig",
		reflect.TypeOf((*AcmpcaCertificateAuthorityActivationConfig)(nil)).Elem(),
	)
}
