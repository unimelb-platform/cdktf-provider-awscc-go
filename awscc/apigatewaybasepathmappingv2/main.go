...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ApigatewayBasePathMappingV2)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.apigatewayBasePathMappingV2.ApigatewayBasePathMappingV2Config",
		reflect.TypeOf((*ApigatewayBasePathMappingV2Config)(nil)).Elem(),
	)
}
