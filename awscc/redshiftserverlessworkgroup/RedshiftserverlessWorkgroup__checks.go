...
func (r *jsiiProxy_RedshiftserverlessWorkgroup) validatePutConfigParametersParameters(value interface{}) error {
	...
	case *[]*RedshiftserverlessWorkgroupConfigParameters:
		value := value.(*[]*RedshiftserverlessWorkgroupConfigParameters)
	...
	case []*RedshiftserverlessWorkgroupConfigParameters:
		value_ := value.([]*RedshiftserverlessWorkgroupConfigParameters)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*RedshiftserverlessWorkgroupConfigParameters; received %#v (a %T)", value, value)
		}
	}
...
func (r *jsiiProxy_RedshiftserverlessWorkgroup) validatePutTagsParameters(value interface{}) error {
	...
	case *[]*RedshiftserverlessWorkgroupTags:
		value := value.(*[]*RedshiftserverlessWorkgroupTags)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*RedshiftserverlessWorkgroupTags:
		value_ := value.([]*RedshiftserverlessWorkgroupTags)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
