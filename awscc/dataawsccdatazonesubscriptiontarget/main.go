...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDatazoneSubscriptionTarget)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "subscriptionTargetId", GoGetter: "SubscriptionTargetId"},
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccDatazoneSubscriptionTarget.DataAwsccDatazoneSubscriptionTargetConfig",
		reflect.TypeOf((*DataAwsccDatazoneSubscriptionTargetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccDatazoneSubscriptionTarget.DataAwsccDatazoneSubscriptionTargetSubscriptionTargetConfig",
		reflect.TypeOf((*DataAwsccDatazoneSubscriptionTargetSubscriptionTargetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccDatazoneSubscriptionTarget.DataAwsccDatazoneSubscriptionTargetSubscriptionTargetConfigList",
		reflect.TypeOf((*DataAwsccDatazoneSubscriptionTargetSubscriptionTargetConfigList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDatazoneSubscriptionTargetSubscriptionTargetConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
