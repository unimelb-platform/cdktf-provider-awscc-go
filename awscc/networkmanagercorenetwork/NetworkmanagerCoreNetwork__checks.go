...
func (n *jsiiProxy_NetworkmanagerCoreNetwork) validatePutTagsParameters(value interface{}) error {
	...
	case *[]*NetworkmanagerCoreNetworkTags:
		value := value.(*[]*NetworkmanagerCoreNetworkTags)
	...
	case []*NetworkmanagerCoreNetworkTags:
		value_ := value.([]*NetworkmanagerCoreNetworkTags)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*NetworkmanagerCoreNetworkTags; received %#v (a %T)", value, value)
		}
	}
