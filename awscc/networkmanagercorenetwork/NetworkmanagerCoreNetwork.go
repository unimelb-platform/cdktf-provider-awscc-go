...
func (j *jsiiProxy_NetworkmanagerCoreNetwork) CoreNetworkArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"coreNetworkArn",
...
func (j *jsiiProxy_NetworkmanagerCoreNetwork) CoreNetworkId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"coreNetworkId",
...
func (j *jsiiProxy_NetworkmanagerCoreNetwork) OwnerAccount() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ownerAccount",
...
func (j *jsiiProxy_NetworkmanagerCoreNetwork) Tags() NetworkmanagerCoreNetworkTagsList {
	var returns NetworkmanagerCoreNetworkTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_NetworkmanagerCoreNetwork) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (n *jsiiProxy_NetworkmanagerCoreNetwork) PutTags(value interface{}) {
