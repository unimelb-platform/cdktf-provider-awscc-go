...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccAppconfigDeploymentStrategy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccAppconfigDeploymentStrategy.DataAwsccAppconfigDeploymentStrategyConfig",
		reflect.TypeOf((*DataAwsccAppconfigDeploymentStrategyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccAppconfigDeploymentStrategy.DataAwsccAppconfigDeploymentStrategyTags",
		reflect.TypeOf((*DataAwsccAppconfigDeploymentStrategyTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccAppconfigDeploymentStrategy.DataAwsccAppconfigDeploymentStrategyTagsList",
		reflect.TypeOf((*DataAwsccAppconfigDeploymentStrategyTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccAppconfigDeploymentStrategyTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
