...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDatazoneDomainUnit)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccDatazoneDomainUnit.DataAwsccDatazoneDomainUnitConfig",
		reflect.TypeOf((*DataAwsccDatazoneDomainUnitConfig)(nil)).Elem(),
	)
}
