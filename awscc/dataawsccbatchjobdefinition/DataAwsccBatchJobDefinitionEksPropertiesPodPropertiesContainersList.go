...
func (d *jsiiProxy_DataAwsccBatchJobDefinitionEksPropertiesPodPropertiesContainersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
