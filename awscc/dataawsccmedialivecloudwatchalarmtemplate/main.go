...
func init() {
	_jsii_.RegisterClass(
		"awscc.dataAwsccMedialiveCloudwatchAlarmTemplate.DataAwsccMedialiveCloudwatchAlarmTemplate",
		reflect.TypeOf((*DataAwsccMedialiveCloudwatchAlarmTemplate)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccMedialiveCloudwatchAlarmTemplate{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformDataSource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccMedialiveCloudwatchAlarmTemplate.DataAwsccMedialiveCloudwatchAlarmTemplateConfig",
		reflect.TypeOf((*DataAwsccMedialiveCloudwatchAlarmTemplateConfig)(nil)).Elem(),
	)
}
