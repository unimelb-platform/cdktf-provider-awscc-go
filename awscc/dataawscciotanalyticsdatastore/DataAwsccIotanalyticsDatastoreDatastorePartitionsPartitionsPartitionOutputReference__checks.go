...
func (d *jsiiProxy_DataAwsccIotanalyticsDatastoreDatastorePartitionsPartitionsPartitionOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (d *jsiiProxy_DataAwsccIotanalyticsDatastoreDatastorePartitionsPartitionsPartitionOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_DataAwsccIotanalyticsDatastoreDatastorePartitionsPartitionsPartitionOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewDataAwsccIotanalyticsDatastoreDatastorePartitionsPartitionsPartitionOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
