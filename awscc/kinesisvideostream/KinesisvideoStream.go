...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/kinesisvideo_stream awscc_kinesisvideo_stream}.
...
func (j *jsiiProxy_KinesisvideoStream) Tags() KinesisvideoStreamTagsList {
	var returns KinesisvideoStreamTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_KinesisvideoStream) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/kinesisvideo_stream awscc_kinesisvideo_stream} Resource.
...
func (k *jsiiProxy_KinesisvideoStream) PutTags(value interface{}) {
...
func (k *jsiiProxy_KinesisvideoStream) ResetName() {
	_jsii_.InvokeVoid(
		k,
		"resetName",
		nil, // no parameters
