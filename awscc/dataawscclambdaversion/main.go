...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccLambdaVersion)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccLambdaVersion.DataAwsccLambdaVersionConfig",
		reflect.TypeOf((*DataAwsccLambdaVersionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccLambdaVersion.DataAwsccLambdaVersionProvisionedConcurrencyConfig",
		reflect.TypeOf((*DataAwsccLambdaVersionProvisionedConcurrencyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccLambdaVersion.DataAwsccLambdaVersionProvisionedConcurrencyConfigOutputReference",
		reflect.TypeOf((*DataAwsccLambdaVersionProvisionedConcurrencyConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccLambdaVersionProvisionedConcurrencyConfigOutputReference{}
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccLambdaVersionRuntimePolicy)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccLambdaVersion.DataAwsccLambdaVersionRuntimePolicyOutputReference",
		reflect.TypeOf((*DataAwsccLambdaVersionRuntimePolicyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccLambdaVersionRuntimePolicyOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
