...
func (j *jsiiProxy_RumAppMonitor) AppMonitorConfigurationInput() interface{} {
...
func (j *jsiiProxy_RumAppMonitor) CustomEventsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"customEventsInput",
...
func (j *jsiiProxy_RumAppMonitor) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (r *jsiiProxy_RumAppMonitor) PutTags(value interface{}) {
