...
type RumAppMonitorAppMonitorConfigurationOutputReference interface {
	...
	MetricDestinations() RumAppMonitorAppMonitorConfigurationMetricDestinationsList
	MetricDestinationsInput() interface{}
	...
	PutMetricDestinations(value interface{})
	ResetAllowCookies()
	ResetEnableXRay()
	ResetExcludedPages()
	ResetFavoritePages()
...
func (j *jsiiProxy_RumAppMonitorAppMonitorConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_RumAppMonitorAppMonitorConfigurationOutputReference) MetricDestinations() RumAppMonitorAppMonitorConfigurationMetricDestinationsList {
	var returns RumAppMonitorAppMonitorConfigurationMetricDestinationsList
	_jsii_.Get(
		j,
		"metricDestinations",
		&returns,
...
func (j *jsiiProxy_RumAppMonitorAppMonitorConfigurationOutputReference) MetricDestinationsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"metricDestinationsInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_RumAppMonitorAppMonitorConfigurationOutputReference)SetInternalValue(val interface{}) {
...
func (r *jsiiProxy_RumAppMonitorAppMonitorConfigurationOutputReference) PutMetricDestinations(value interface{}) {
	if err := r.validatePutMetricDestinationsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		r,
		"putMetricDestinations",
		[]interface{}{value},
	)
}
...
func (r *jsiiProxy_RumAppMonitorAppMonitorConfigurationOutputReference) ResetMetricDestinations() {
	_jsii_.InvokeVoid(
		r,
		"resetMetricDestinations",
		nil, // no parameters
