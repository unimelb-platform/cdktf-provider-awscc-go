...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/datasync_location_s3 awscc_datasync_location_s3}.
...
func (j *jsiiProxy_DatasyncLocationS3) LocationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationArn",
...
func (j *jsiiProxy_DatasyncLocationS3) LocationUri() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationUri",
...
func (j *jsiiProxy_DatasyncLocationS3) S3ConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"s3ConfigInput",
...
func (j *jsiiProxy_DatasyncLocationS3) Tags() DatasyncLocationS3TagsList {
	var returns DatasyncLocationS3TagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/datasync_location_s3 awscc_datasync_location_s3} Resource.
func NewDatasyncLocationS3(scope constructs.Construct, id *string, config *DatasyncLocationS3Config) DatasyncLocationS3 {
	...
	_jsii_.Create(
		"awscc.datasyncLocationS3.DatasyncLocationS3",
...
func (d *jsiiProxy_DatasyncLocationS3) PutTags(value interface{}) {
...
func (d *jsiiProxy_DatasyncLocationS3) ResetS3BucketArn() {
	_jsii_.InvokeVoid(
		d,
		"resetS3BucketArn",
		nil, // no parameters
...
func (d *jsiiProxy_DatasyncLocationS3) ResetSubdirectory() {
	_jsii_.InvokeVoid(
		d,
		"resetSubdirectory",
		nil, // no parameters
