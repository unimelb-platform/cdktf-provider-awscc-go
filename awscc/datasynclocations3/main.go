...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.datasyncLocationS3.DatasyncLocationS3Config",
		reflect.TypeOf((*DatasyncLocationS3Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.datasyncLocationS3.DatasyncLocationS3S3Config",
		reflect.TypeOf((*DatasyncLocationS3S3Config)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.datasyncLocationS3.DatasyncLocationS3S3ConfigOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.datasyncLocationS3.DatasyncLocationS3Tags",
		reflect.TypeOf((*DatasyncLocationS3Tags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.datasyncLocationS3.DatasyncLocationS3TagsList",
		reflect.TypeOf((*DatasyncLocationS3TagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DatasyncLocationS3TagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
