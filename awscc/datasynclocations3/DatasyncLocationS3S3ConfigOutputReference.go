...
func (j *jsiiProxy_DatasyncLocationS3S3ConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_DatasyncLocationS3S3ConfigOutputReference)SetInternalValue(val interface{}) {
