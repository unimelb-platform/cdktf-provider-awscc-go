...
func (j *jsiiProxy_AthenaDataCatalog) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (a *jsiiProxy_AthenaDataCatalog) PutTags(value interface{}) {
...
func (a *jsiiProxy_AthenaDataCatalog) ResetParameters() {
	_jsii_.InvokeVoid(
		a,
		"resetParameters",
		nil, // no parameters
