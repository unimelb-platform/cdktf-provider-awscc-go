...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/securityhuborganizationconfiguration/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/securityhub_organization_configuration awscc_securityhub_organization_configuration}.
type SecurityhubOrganizationConfiguration interface {
	...
	MemberAccountLimitReached() cdktf.IResolvable
	// The tree node.
...
func (j *jsiiProxy_SecurityhubOrganizationConfiguration) ConfigurationType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"configurationType",
...
func (j *jsiiProxy_SecurityhubOrganizationConfiguration) ConfigurationTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecurityhubOrganizationConfiguration) MemberAccountLimitReached() cdktf.IResolvable {
...
func (j *jsiiProxy_SecurityhubOrganizationConfiguration) OrganizationConfigurationIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecurityhubOrganizationConfiguration) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_SecurityhubOrganizationConfiguration) StatusMessage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"statusMessage",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/securityhub_organization_configuration awscc_securityhub_organization_configuration} Resource.
func NewSecurityhubOrganizationConfiguration(scope constructs.Construct, id *string, config *SecurityhubOrganizationConfigurationConfig) SecurityhubOrganizationConfiguration {
	...
	_jsii_.Create(
		"awscc.securityhubOrganizationConfiguration.SecurityhubOrganizationConfiguration",
...
func (j *jsiiProxy_SecurityhubOrganizationConfiguration)SetConfigurationType(val *string) {
...
func (s *jsiiProxy_SecurityhubOrganizationConfiguration) ResetConfigurationType() {
	_jsii_.InvokeVoid(
		s,
		"resetConfigurationType",
		nil, // no parameters
