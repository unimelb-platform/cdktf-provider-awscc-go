...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/opensearchserverless_collection awscc_opensearchserverless_collection}.
...
func (j *jsiiProxy_OpensearchserverlessCollection) CollectionId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"collectionId",
...
func (j *jsiiProxy_OpensearchserverlessCollection) Tags() OpensearchserverlessCollectionTagsList {
	var returns OpensearchserverlessCollectionTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_OpensearchserverlessCollection) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/opensearchserverless_collection awscc_opensearchserverless_collection} Resource.
func NewOpensearchserverlessCollection(scope constructs.Construct, id *string, config *OpensearchserverlessCollectionConfig) OpensearchserverlessCollection {
	...
	_jsii_.Create(
		"awscc.opensearchserverlessCollection.OpensearchserverlessCollection",
...
func (o *jsiiProxy_OpensearchserverlessCollection) PutTags(value interface{}) {
