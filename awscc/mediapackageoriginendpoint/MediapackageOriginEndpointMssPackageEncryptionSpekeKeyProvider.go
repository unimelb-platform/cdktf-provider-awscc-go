...
type MediapackageOriginEndpointMssPackageEncryptionSpekeKeyProvider struct {
	...
	EncryptionContractConfiguration *MediapackageOriginEndpointMssPackageEncryptionSpekeKeyProviderEncryptionContractConfiguration `field:"optional" json:"encryptionContractConfiguration" yaml:"encryptionContractConfiguration"`
}
