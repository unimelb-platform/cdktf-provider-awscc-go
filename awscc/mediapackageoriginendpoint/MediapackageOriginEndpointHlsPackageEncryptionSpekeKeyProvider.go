...
type MediapackageOriginEndpointHlsPackageEncryptionSpekeKeyProvider struct {
	...
	EncryptionContractConfiguration *MediapackageOriginEndpointHlsPackageEncryptionSpekeKeyProviderEncryptionContractConfiguration `field:"optional" json:"encryptionContractConfiguration" yaml:"encryptionContractConfiguration"`
}
