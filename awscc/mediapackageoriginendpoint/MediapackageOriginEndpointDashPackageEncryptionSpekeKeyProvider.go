...
type MediapackageOriginEndpointDashPackageEncryptionSpekeKeyProvider struct {
	...
	EncryptionContractConfiguration *MediapackageOriginEndpointDashPackageEncryptionSpekeKeyProviderEncryptionContractConfiguration `field:"optional" json:"encryptionContractConfiguration" yaml:"encryptionContractConfiguration"`
}
