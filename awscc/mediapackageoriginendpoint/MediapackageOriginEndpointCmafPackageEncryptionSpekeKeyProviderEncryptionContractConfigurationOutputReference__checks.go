...
func (j *jsiiProxy_MediapackageOriginEndpointCmafPackageEncryptionSpekeKeyProviderEncryptionContractConfigurationOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *MediapackageOriginEndpointCmafPackageEncryptionSpekeKeyProviderEncryptionContractConfiguration:
		val := val.(*MediapackageOriginEndpointCmafPackageEncryptionSpekeKeyProviderEncryptionContractConfiguration)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case MediapackageOriginEndpointCmafPackageEncryptionSpekeKeyProviderEncryptionContractConfiguration:
		val_ := val.(MediapackageOriginEndpointCmafPackageEncryptionSpekeKeyProviderEncryptionContractConfiguration)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *MediapackageOriginEndpointCmafPackageEncryptionSpekeKeyProviderEncryptionContractConfiguration; received %#v (a %T)", val, val)
		}
	}
