...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2LocalGatewayRoute)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccEc2LocalGatewayRoute.DataAwsccEc2LocalGatewayRouteConfig",
		reflect.TypeOf((*DataAwsccEc2LocalGatewayRouteConfig)(nil)).Elem(),
	)
}
