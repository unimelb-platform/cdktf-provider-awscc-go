...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EventschemasSchema)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.eventschemasSchema.EventschemasSchemaConfig",
		reflect.TypeOf((*EventschemasSchemaConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.eventschemasSchema.EventschemasSchemaTags",
		reflect.TypeOf((*EventschemasSchemaTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.eventschemasSchema.EventschemasSchemaTagsList",
		reflect.TypeOf((*EventschemasSchemaTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EventschemasSchemaTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
