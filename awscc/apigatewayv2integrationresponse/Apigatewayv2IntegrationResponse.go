...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/apigatewayv2integrationresponse/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigatewayv2_integration_response awscc_apigatewayv2_integration_response}.
type Apigatewayv2IntegrationResponse interface {
	...
	SetResponseParameters(val *string)
	ResponseParametersInput() *string
	ResponseTemplates() *string
	SetResponseTemplates(val *string)
	ResponseTemplatesInput() *string
...
func (j *jsiiProxy_Apigatewayv2IntegrationResponse) IntegrationResponseId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Apigatewayv2IntegrationResponse) ResponseParameters() *string {
	var returns *string
	_jsii_.Get(
		j,
		"responseParameters",
...
func (j *jsiiProxy_Apigatewayv2IntegrationResponse) ResponseParametersInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Apigatewayv2IntegrationResponse) ResponseTemplates() *string {
	var returns *string
	_jsii_.Get(
		j,
		"responseTemplates",
...
func (j *jsiiProxy_Apigatewayv2IntegrationResponse) ResponseTemplatesInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigatewayv2_integration_response awscc_apigatewayv2_integration_response} Resource.
func NewApigatewayv2IntegrationResponse(scope constructs.Construct, id *string, config *Apigatewayv2IntegrationResponseConfig) Apigatewayv2IntegrationResponse {
	...
	_jsii_.Create(
		"awscc.apigatewayv2IntegrationResponse.Apigatewayv2IntegrationResponse",
...
func (j *jsiiProxy_Apigatewayv2IntegrationResponse)SetResponseParameters(val *string) {
...
func (j *jsiiProxy_Apigatewayv2IntegrationResponse)SetResponseTemplates(val *string) {
...
func (a *jsiiProxy_Apigatewayv2IntegrationResponse) ResetResponseParameters() {
	_jsii_.InvokeVoid(
		a,
		"resetResponseParameters",
		nil, // no parameters
