...
type AppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationOutputReference interface {
	...
	LambdaConfig() AppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationLambdaConfigOutputReference
	...
	PutLambdaConfig(value *AppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationLambdaConfig)
	ResetDataSourceName()
	ResetLambdaConfig()
...
func (j *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationOutputReference) LambdaConfig() AppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationLambdaConfigOutputReference {
	var returns AppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationLambdaConfigOutputReference
	_jsii_.Get(
		j,
		"lambdaConfig",
		&returns,
...
func NewAppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) AppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationOutputReference {
	_init_.Initialize()

	if err := validateNewAppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationOutputReference_Override(a AppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (a *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationOutputReference) PutLambdaConfig(value *AppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationLambdaConfig) {
...
func (a *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationOutputReference) ResetDataSourceName() {
	_jsii_.InvokeVoid(
		a,
		"resetDataSourceName",
		nil, // no parameters
...
func (a *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
