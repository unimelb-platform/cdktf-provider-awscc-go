...
func NewAppsyncChannelNamespaceHandlerConfigsOnPublishIntegrationLambdaConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) AppsyncChannelNamespaceHandlerConfigsOnPublishIntegrationLambdaConfigOutputReference {
	_init_.Initialize()

	if err := validateNewAppsyncChannelNamespaceHandlerConfigsOnPublishIntegrationLambdaConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOnPublishIntegrationLambdaConfigOutputReference{}

	_jsii_.Create(
		"awscc.appsyncChannelNamespace.AppsyncChannelNamespaceHandlerConfigsOnPublishIntegrationLambdaConfigOutputReference",
...
func NewAppsyncChannelNamespaceHandlerConfigsOnPublishIntegrationLambdaConfigOutputReference_Override(a AppsyncChannelNamespaceHandlerConfigsOnPublishIntegrationLambdaConfigOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
