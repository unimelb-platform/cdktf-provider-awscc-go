...
type AppsyncChannelNamespaceHandlerConfigsOnSubscribeOutputReference interface {
	...
	PutIntegration(value *AppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegration)
	ResetBehavior()
	ResetIntegration()
...
func (j *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOnSubscribeOutputReference) Integration() AppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationOutputReference {
...
func NewAppsyncChannelNamespaceHandlerConfigsOnSubscribeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) AppsyncChannelNamespaceHandlerConfigsOnSubscribeOutputReference {
	_init_.Initialize()

	if err := validateNewAppsyncChannelNamespaceHandlerConfigsOnSubscribeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAppsyncChannelNamespaceHandlerConfigsOnSubscribeOutputReference_Override(a AppsyncChannelNamespaceHandlerConfigsOnSubscribeOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (a *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOnSubscribeOutputReference) PutIntegration(value *AppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegration) {
...
func (a *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOnSubscribeOutputReference) ResetBehavior() {
	_jsii_.InvokeVoid(
		a,
		"resetBehavior",
		nil, // no parameters
