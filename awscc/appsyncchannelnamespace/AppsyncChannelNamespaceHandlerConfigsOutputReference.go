...
type AppsyncChannelNamespaceHandlerConfigsOutputReference interface {
	...
	OnPublish() AppsyncChannelNamespaceHandlerConfigsOnPublishOutputReference
	OnPublishInput() interface{}
	OnSubscribe() AppsyncChannelNamespaceHandlerConfigsOnSubscribeOutputReference
	...
	PutOnPublish(value *AppsyncChannelNamespaceHandlerConfigsOnPublish)
	PutOnSubscribe(value *AppsyncChannelNamespaceHandlerConfigsOnSubscribe)
	ResetOnPublish()
	ResetOnSubscribe()
...
func (j *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOutputReference) OnPublish() AppsyncChannelNamespaceHandlerConfigsOnPublishOutputReference {
	var returns AppsyncChannelNamespaceHandlerConfigsOnPublishOutputReference
	_jsii_.Get(
		j,
		"onPublish",
		&returns,
...
func (j *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOutputReference) OnSubscribe() AppsyncChannelNamespaceHandlerConfigsOnSubscribeOutputReference {
...
func NewAppsyncChannelNamespaceHandlerConfigsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) AppsyncChannelNamespaceHandlerConfigsOutputReference {
	_init_.Initialize()

	if err := validateNewAppsyncChannelNamespaceHandlerConfigsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAppsyncChannelNamespaceHandlerConfigsOutputReference_Override(a AppsyncChannelNamespaceHandlerConfigsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (a *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOutputReference) PutOnPublish(value *AppsyncChannelNamespaceHandlerConfigsOnPublish) {
...
func (a *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOutputReference) PutOnSubscribe(value *AppsyncChannelNamespaceHandlerConfigsOnSubscribe) {
