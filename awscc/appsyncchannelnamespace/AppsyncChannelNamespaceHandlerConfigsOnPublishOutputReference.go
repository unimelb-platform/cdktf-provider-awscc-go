...
type AppsyncChannelNamespaceHandlerConfigsOnPublishOutputReference interface {
	...
	PutIntegration(value *AppsyncChannelNamespaceHandlerConfigsOnPublishIntegration)
	ResetBehavior()
	ResetIntegration()
...
func (j *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOnPublishOutputReference) Integration() AppsyncChannelNamespaceHandlerConfigsOnPublishIntegrationOutputReference {
...
func NewAppsyncChannelNamespaceHandlerConfigsOnPublishOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) AppsyncChannelNamespaceHandlerConfigsOnPublishOutputReference {
	_init_.Initialize()

	if err := validateNewAppsyncChannelNamespaceHandlerConfigsOnPublishOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOnPublishOutputReference{}

	_jsii_.Create(
		"awscc.appsyncChannelNamespace.AppsyncChannelNamespaceHandlerConfigsOnPublishOutputReference",
...
func NewAppsyncChannelNamespaceHandlerConfigsOnPublishOutputReference_Override(a AppsyncChannelNamespaceHandlerConfigsOnPublishOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (a *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOnPublishOutputReference) PutIntegration(value *AppsyncChannelNamespaceHandlerConfigsOnPublishIntegration) {
...
func (a *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOnPublishOutputReference) ResetBehavior() {
	_jsii_.InvokeVoid(
		a,
		"resetBehavior",
		nil, // no parameters
