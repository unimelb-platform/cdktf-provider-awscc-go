...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccLogsLogAnomalyDetector)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccLogsLogAnomalyDetector.DataAwsccLogsLogAnomalyDetectorConfig",
		reflect.TypeOf((*DataAwsccLogsLogAnomalyDetectorConfig)(nil)).Elem(),
	)
}
