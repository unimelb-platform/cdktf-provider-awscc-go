...
type SagemakerMonitoringScheduleMonitoringScheduleConfigOutputReference interface {
	...
	MonitoringJobDefinitionInput() interface{}
...
func (j *jsiiProxy_SagemakerMonitoringScheduleMonitoringScheduleConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerMonitoringScheduleMonitoringScheduleConfigOutputReference) MonitoringJobDefinitionInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerMonitoringScheduleMonitoringScheduleConfigOutputReference) ScheduleConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"scheduleConfigInput",
...
func (j *jsiiProxy_SagemakerMonitoringScheduleMonitoringScheduleConfigOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_SagemakerMonitoringScheduleMonitoringScheduleConfigOutputReference) ResetMonitoringType() {
	_jsii_.InvokeVoid(
		s,
		"resetMonitoringType",
		nil, // no parameters
