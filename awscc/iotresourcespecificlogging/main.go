...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IotResourceSpecificLogging)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.iotResourceSpecificLogging.IotResourceSpecificLoggingConfig",
		reflect.TypeOf((*IotResourceSpecificLoggingConfig)(nil)).Elem(),
	)
}
