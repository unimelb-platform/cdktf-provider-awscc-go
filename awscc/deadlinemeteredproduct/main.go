...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DeadlineMeteredProduct)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "licenseEndpointIdInput", GoGetter: "LicenseEndpointIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLicenseEndpointId", GoMethod: "ResetLicenseEndpointId"},
	...
	_jsii_.RegisterStruct(
		"awscc.deadlineMeteredProduct.DeadlineMeteredProductConfig",
		reflect.TypeOf((*DeadlineMeteredProductConfig)(nil)).Elem(),
	)
}
