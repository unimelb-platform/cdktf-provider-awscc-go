...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/iotcoredeviceadvisor_suite_definition awscc_iotcoredeviceadvisor_suite_definition}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/iotcoredeviceadvisor_suite_definition awscc_iotcoredeviceadvisor_suite_definition} Resource.
...
func (i *jsiiProxy_IotcoredeviceadvisorSuiteDefinition) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IotcoredeviceadvisorSuiteDefinition) MoveFromId(id *string) {
...
func (i *jsiiProxy_IotcoredeviceadvisorSuiteDefinition) MoveToId(id *string) {
...
func (i *jsiiProxy_IotcoredeviceadvisorSuiteDefinition) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IotcoredeviceadvisorSuiteDefinition) ToHclTerraform() interface{} {
	var returns interface{}
