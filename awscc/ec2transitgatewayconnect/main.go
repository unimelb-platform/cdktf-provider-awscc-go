...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.ec2TransitGatewayConnect.Ec2TransitGatewayConnectConfig",
		reflect.TypeOf((*Ec2TransitGatewayConnectConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.ec2TransitGatewayConnect.Ec2TransitGatewayConnectOptions",
		reflect.TypeOf((*Ec2TransitGatewayConnectOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2TransitGatewayConnect.Ec2TransitGatewayConnectOptionsOutputReference",
		reflect.TypeOf((*Ec2TransitGatewayConnectOptionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.ec2TransitGatewayConnect.Ec2TransitGatewayConnectTags",
		reflect.TypeOf((*Ec2TransitGatewayConnectTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2TransitGatewayConnect.Ec2TransitGatewayConnectTagsList",
		reflect.TypeOf((*Ec2TransitGatewayConnectTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2TransitGatewayConnectTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
