...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccRdsDbProxyTargetGroup)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccRdsDbProxyTargetGroup.DataAwsccRdsDbProxyTargetGroupConfig",
		reflect.TypeOf((*DataAwsccRdsDbProxyTargetGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccRdsDbProxyTargetGroup.DataAwsccRdsDbProxyTargetGroupConnectionPoolConfigurationInfo",
		reflect.TypeOf((*DataAwsccRdsDbProxyTargetGroupConnectionPoolConfigurationInfo)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccRdsDbProxyTargetGroup.DataAwsccRdsDbProxyTargetGroupConnectionPoolConfigurationInfoOutputReference",
		reflect.TypeOf((*DataAwsccRdsDbProxyTargetGroupConnectionPoolConfigurationInfoOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccRdsDbProxyTargetGroupConnectionPoolConfigurationInfoOutputReference{}
