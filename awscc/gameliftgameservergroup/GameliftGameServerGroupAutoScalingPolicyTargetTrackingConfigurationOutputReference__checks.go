...
func (j *jsiiProxy_GameliftGameServerGroupAutoScalingPolicyTargetTrackingConfigurationOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *GameliftGameServerGroupAutoScalingPolicyTargetTrackingConfiguration:
		val := val.(*GameliftGameServerGroupAutoScalingPolicyTargetTrackingConfiguration)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case GameliftGameServerGroupAutoScalingPolicyTargetTrackingConfiguration:
		val_ := val.(GameliftGameServerGroupAutoScalingPolicyTargetTrackingConfiguration)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *GameliftGameServerGroupAutoScalingPolicyTargetTrackingConfiguration; received %#v (a %T)", val, val)
		}
	}
