...
func (j *jsiiProxy_SesConfigurationSetTrackingOptionsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SesConfigurationSetTrackingOptionsOutputReference)SetInternalValue(val interface{}) {
