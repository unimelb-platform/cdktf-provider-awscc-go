...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.iotPolicy.IotPolicyConfig",
		reflect.TypeOf((*IotPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.iotPolicy.IotPolicyTags",
		reflect.TypeOf((*IotPolicyTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.iotPolicy.IotPolicyTagsList",
		reflect.TypeOf((*IotPolicyTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IotPolicyTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
