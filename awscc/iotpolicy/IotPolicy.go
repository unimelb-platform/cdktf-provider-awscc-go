...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/iot_policy awscc_iot_policy}.
...
func (j *jsiiProxy_IotPolicy) PolicyDocument() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyDocument",
...
func (j *jsiiProxy_IotPolicy) PolicyDocumentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyDocumentInput",
...
func (j *jsiiProxy_IotPolicy) PolicyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyId",
...
func (j *jsiiProxy_IotPolicy) PolicyName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyName",
...
func (j *jsiiProxy_IotPolicy) PolicyNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyNameInput",
...
func (j *jsiiProxy_IotPolicy) Tags() IotPolicyTagsList {
	var returns IotPolicyTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_IotPolicy) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/iot_policy awscc_iot_policy} Resource.
...
func (j *jsiiProxy_IotPolicy)SetPolicyDocument(val *string) {
...
func (j *jsiiProxy_IotPolicy)SetPolicyName(val *string) {
...
func (i *jsiiProxy_IotPolicy) PutTags(value interface{}) {
...
func (i *jsiiProxy_IotPolicy) ResetPolicyName() {
	_jsii_.InvokeVoid(
		i,
		"resetPolicyName",
		nil, // no parameters
