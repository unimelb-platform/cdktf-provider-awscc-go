...
func (j *jsiiProxy_DataAwsccQbusinessWebExperienceTagsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsccQbusinessWebExperienceTagsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccQbusinessWebExperienceTagsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"awscc.dataAwsccQbusinessWebExperience.DataAwsccQbusinessWebExperienceTagsList",
...
func NewDataAwsccQbusinessWebExperienceTagsList_Override(d DataAwsccQbusinessWebExperienceTagsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccQbusinessWebExperienceTagsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccQbusinessWebExperienceTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccQbusinessWebExperienceTagsList) Resolve(_context cdktf.IResolveContext) interface{} {
