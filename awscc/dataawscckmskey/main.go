...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccKmsKey)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccKmsKey.DataAwsccKmsKeyConfig",
		reflect.TypeOf((*DataAwsccKmsKeyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccKmsKey.DataAwsccKmsKeyTags",
		reflect.TypeOf((*DataAwsccKmsKeyTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccKmsKey.DataAwsccKmsKeyTagsList",
		reflect.TypeOf((*DataAwsccKmsKeyTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		"awscc.dataAwsccKmsKey.DataAwsccKmsKeyTagsOutputReference",
		reflect.TypeOf((*DataAwsccKmsKeyTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccKmsKeyTagsOutputReference{}
