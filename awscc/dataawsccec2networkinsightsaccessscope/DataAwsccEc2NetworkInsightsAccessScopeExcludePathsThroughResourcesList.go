...
func (d *jsiiProxy_DataAwsccEc2NetworkInsightsAccessScopeExcludePathsThroughResourcesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
