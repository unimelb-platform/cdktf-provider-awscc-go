...
func (j *jsiiProxy_SagemakerSpaceSpaceSettingsCustomFileSystemsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewSagemakerSpaceSpaceSettingsCustomFileSystemsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SagemakerSpaceSpaceSettingsCustomFileSystemsOutputReference {
	_init_.Initialize()
...
func NewSagemakerSpaceSpaceSettingsCustomFileSystemsOutputReference_Override(s SagemakerSpaceSpaceSettingsCustomFileSystemsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SagemakerSpaceSpaceSettingsCustomFileSystemsOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (s *jsiiProxy_SagemakerSpaceSpaceSettingsCustomFileSystemsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerSpaceSpaceSettingsCustomFileSystemsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (s *jsiiProxy_SagemakerSpaceSpaceSettingsCustomFileSystemsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerSpaceSpaceSettingsCustomFileSystemsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
