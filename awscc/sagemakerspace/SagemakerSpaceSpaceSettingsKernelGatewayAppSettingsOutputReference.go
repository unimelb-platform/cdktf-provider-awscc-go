...
type SagemakerSpaceSpaceSettingsKernelGatewayAppSettingsOutputReference interface {
	...
	CustomImages() SagemakerSpaceSpaceSettingsKernelGatewayAppSettingsCustomImagesList
...
func (j *jsiiProxy_SagemakerSpaceSpaceSettingsKernelGatewayAppSettingsOutputReference) CustomImages() SagemakerSpaceSpaceSettingsKernelGatewayAppSettingsCustomImagesList {
	var returns SagemakerSpaceSpaceSettingsKernelGatewayAppSettingsCustomImagesList
	_jsii_.Get(
		j,
		"customImages",
		&returns,
...
func (j *jsiiProxy_SagemakerSpaceSpaceSettingsKernelGatewayAppSettingsOutputReference) CustomImagesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"customImagesInput",
...
func (j *jsiiProxy_SagemakerSpaceSpaceSettingsKernelGatewayAppSettingsOutputReference) DefaultResourceSpecInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerSpaceSpaceSettingsKernelGatewayAppSettingsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerSpaceSpaceSettingsKernelGatewayAppSettingsOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_SagemakerSpaceSpaceSettingsKernelGatewayAppSettingsOutputReference) PutCustomImages(value interface{}) {
...
func (s *jsiiProxy_SagemakerSpaceSpaceSettingsKernelGatewayAppSettingsOutputReference) ResetCustomImages() {
	_jsii_.InvokeVoid(
		s,
		"resetCustomImages",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerSpaceSpaceSettingsKernelGatewayAppSettingsOutputReference) ResetDefaultResourceSpec() {
	_jsii_.InvokeVoid(
		s,
		"resetDefaultResourceSpec",
		nil, // no parameters
