...
func (s *jsiiProxy_SagemakerSpaceSpaceSettingsKernelGatewayAppSettingsCustomImagesOutputReference) ResetAppImageConfigName() {
	_jsii_.InvokeVoid(
		s,
		"resetAppImageConfigName",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerSpaceSpaceSettingsKernelGatewayAppSettingsCustomImagesOutputReference) ResetImageName() {
	_jsii_.InvokeVoid(
		s,
		"resetImageName",
		nil, // no parameters
