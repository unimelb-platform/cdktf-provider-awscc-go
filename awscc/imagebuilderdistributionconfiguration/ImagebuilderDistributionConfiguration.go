...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/imagebuilder_distribution_configuration awscc_imagebuilder_distribution_configuration}.
type ImagebuilderDistributionConfiguration interface {
	...
	PutDistributions(value interface{})
	ResetDescription()
...
func (j *jsiiProxy_ImagebuilderDistributionConfiguration) Distributions() ImagebuilderDistributionConfigurationDistributionsList {
	var returns ImagebuilderDistributionConfigurationDistributionsList
	_jsii_.Get(
		j,
		"distributions",
		&returns,
...
func (j *jsiiProxy_ImagebuilderDistributionConfiguration) DistributionsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"distributionsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/imagebuilder_distribution_configuration awscc_imagebuilder_distribution_configuration} Resource.
...
func (i *jsiiProxy_ImagebuilderDistributionConfiguration) PutDistributions(value interface{}) {
	if err := i.validatePutDistributionsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		i,
