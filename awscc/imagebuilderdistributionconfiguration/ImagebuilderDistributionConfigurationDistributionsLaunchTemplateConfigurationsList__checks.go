...
func (i *jsiiProxy_ImagebuilderDistributionConfigurationDistributionsLaunchTemplateConfigurationsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
