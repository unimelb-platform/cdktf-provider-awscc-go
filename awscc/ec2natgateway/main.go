...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2NatGateway)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "maxDrainDurationSecondsInput", GoGetter: "MaxDrainDurationSecondsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMaxDrainDurationSeconds", GoMethod: "ResetMaxDrainDurationSeconds"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*Ec2NatGatewayConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.ec2NatGateway.Ec2NatGatewayTags",
		reflect.TypeOf((*Ec2NatGatewayTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2NatGateway.Ec2NatGatewayTagsList",
		reflect.TypeOf((*Ec2NatGatewayTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2NatGatewayTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
