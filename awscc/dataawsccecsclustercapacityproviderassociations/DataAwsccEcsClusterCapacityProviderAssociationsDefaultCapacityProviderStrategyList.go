...
func (d *jsiiProxy_DataAwsccEcsClusterCapacityProviderAssociationsDefaultCapacityProviderStrategyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
