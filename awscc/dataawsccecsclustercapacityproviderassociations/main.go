...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEcsClusterCapacityProviderAssociations)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccEcsClusterCapacityProviderAssociationsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccEcsClusterCapacityProviderAssociationsDefaultCapacityProviderStrategy)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEcsClusterCapacityProviderAssociationsDefaultCapacityProviderStrategyList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEcsClusterCapacityProviderAssociationsDefaultCapacityProviderStrategyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
