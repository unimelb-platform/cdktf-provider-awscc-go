...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/sagemaker_image awscc_sagemaker_image}.
...
func (j *jsiiProxy_SagemakerImage) ImageArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"imageArn",
...
func (j *jsiiProxy_SagemakerImage) ImageDescription() *string {
	var returns *string
	_jsii_.Get(
		j,
		"imageDescription",
...
func (j *jsiiProxy_SagemakerImage) ImageDescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerImage) ImageDisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"imageDisplayName",
...
func (j *jsiiProxy_SagemakerImage) ImageDisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"imageDisplayNameInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_SagemakerImage) ImageRoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"imageRoleArn",
...
func (j *jsiiProxy_SagemakerImage) ImageRoleArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"imageRoleArnInput",
...
func (j *jsiiProxy_SagemakerImage) Tags() SagemakerImageTagsList {
	var returns SagemakerImageTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/sagemaker_image awscc_sagemaker_image} Resource.
func NewSagemakerImage(scope constructs.Construct, id *string, config *SagemakerImageConfig) SagemakerImage {
	...
	_jsii_.Create(
		"awscc.sagemakerImage.SagemakerImage",
...
func (j *jsiiProxy_SagemakerImage)SetImageDescription(val *string) {
	if err := j.validateSetImageDescriptionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_SagemakerImage)SetImageDisplayName(val *string) {
	if err := j.validateSetImageDisplayNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_SagemakerImage)SetImageRoleArn(val *string) {
...
func (s *jsiiProxy_SagemakerImage) PutTags(value interface{}) {
...
func (s *jsiiProxy_SagemakerImage) ResetImageDescription() {
	_jsii_.InvokeVoid(
		s,
		"resetImageDescription",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerImage) ResetImageDisplayName() {
	_jsii_.InvokeVoid(
		s,
		"resetImageDisplayName",
		nil, // no parameters
