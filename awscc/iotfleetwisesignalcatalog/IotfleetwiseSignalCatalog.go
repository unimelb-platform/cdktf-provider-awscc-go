...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/iotfleetwise_signal_catalog awscc_iotfleetwise_signal_catalog}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/iotfleetwise_signal_catalog awscc_iotfleetwise_signal_catalog} Resource.
...
func (i *jsiiProxy_IotfleetwiseSignalCatalog) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IotfleetwiseSignalCatalog) MoveFromId(id *string) {
...
func (i *jsiiProxy_IotfleetwiseSignalCatalog) MoveToId(id *string) {
...
func (i *jsiiProxy_IotfleetwiseSignalCatalog) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IotfleetwiseSignalCatalog) ToHclTerraform() interface{} {
	var returns interface{}
