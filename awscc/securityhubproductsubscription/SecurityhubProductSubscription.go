...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/securityhubproductsubscription/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/securityhub_product_subscription awscc_securityhub_product_subscription}.
...
func (j *jsiiProxy_SecurityhubProductSubscription) ProductSubscriptionArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/securityhub_product_subscription awscc_securityhub_product_subscription} Resource.
func NewSecurityhubProductSubscription(scope constructs.Construct, id *string, config *SecurityhubProductSubscriptionConfig) SecurityhubProductSubscription {
	...
	_jsii_.Create(
		"awscc.securityhubProductSubscription.SecurityhubProductSubscription",
