...
type QbusinessDataSourceDocumentEnrichmentConfigurationPreExtractionHookConfiguration struct {
	...
	InvocationCondition *QbusinessDataSourceDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationCondition `field:"optional" json:"invocationCondition" yaml:"invocationCondition"`
