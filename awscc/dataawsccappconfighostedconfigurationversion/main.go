...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccAppconfigHostedConfigurationVersion)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccAppconfigHostedConfigurationVersion.DataAwsccAppconfigHostedConfigurationVersionConfig",
		reflect.TypeOf((*DataAwsccAppconfigHostedConfigurationVersionConfig)(nil)).Elem(),
	)
}
