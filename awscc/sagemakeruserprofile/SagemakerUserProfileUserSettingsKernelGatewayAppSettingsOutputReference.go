...
type SagemakerUserProfileUserSettingsKernelGatewayAppSettingsOutputReference interface {
	...
	CustomImages() SagemakerUserProfileUserSettingsKernelGatewayAppSettingsCustomImagesList
...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsKernelGatewayAppSettingsOutputReference) CustomImages() SagemakerUserProfileUserSettingsKernelGatewayAppSettingsCustomImagesList {
	var returns SagemakerUserProfileUserSettingsKernelGatewayAppSettingsCustomImagesList
	_jsii_.Get(
		j,
		"customImages",
		&returns,
...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsKernelGatewayAppSettingsOutputReference) CustomImagesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"customImagesInput",
...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsKernelGatewayAppSettingsOutputReference) DefaultResourceSpecInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsKernelGatewayAppSettingsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsKernelGatewayAppSettingsOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsKernelGatewayAppSettingsOutputReference) PutCustomImages(value interface{}) {
...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsKernelGatewayAppSettingsOutputReference) ResetCustomImages() {
	_jsii_.InvokeVoid(
		s,
		"resetCustomImages",
		nil, // no parameters
