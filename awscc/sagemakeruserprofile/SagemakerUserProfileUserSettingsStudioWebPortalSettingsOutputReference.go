...
type SagemakerUserProfileUserSettingsStudioWebPortalSettingsOutputReference interface {
	...
	HiddenSageMakerImageVersionAliases() SagemakerUserProfileUserSettingsStudioWebPortalSettingsHiddenSageMakerImageVersionAliasesList
...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsStudioWebPortalSettingsOutputReference) HiddenSageMakerImageVersionAliases() SagemakerUserProfileUserSettingsStudioWebPortalSettingsHiddenSageMakerImageVersionAliasesList {
	var returns SagemakerUserProfileUserSettingsStudioWebPortalSettingsHiddenSageMakerImageVersionAliasesList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsStudioWebPortalSettingsOutputReference) HiddenSageMakerImageVersionAliasesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsStudioWebPortalSettingsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsStudioWebPortalSettingsOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsStudioWebPortalSettingsOutputReference) PutHiddenSageMakerImageVersionAliases(value interface{}) {
...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsStudioWebPortalSettingsOutputReference) ResetHiddenSageMakerImageVersionAliases() {
	_jsii_.InvokeVoid(
		s,
		"resetHiddenSageMakerImageVersionAliases",
		nil, // no parameters
