...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsCodeEditorAppSettingsDefaultResourceSpecOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *SagemakerUserProfileUserSettingsCodeEditorAppSettingsDefaultResourceSpec:
		val := val.(*SagemakerUserProfileUserSettingsCodeEditorAppSettingsDefaultResourceSpec)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case SagemakerUserProfileUserSettingsCodeEditorAppSettingsDefaultResourceSpec:
		val_ := val.(SagemakerUserProfileUserSettingsCodeEditorAppSettingsDefaultResourceSpec)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *SagemakerUserProfileUserSettingsCodeEditorAppSettingsDefaultResourceSpec; received %#v (a %T)", val, val)
		}
	}
