...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsOutputReference) validatePutCustomFileSystemConfigsParameters(value interface{}) error {
	...
	case *[]*SagemakerUserProfileUserSettingsCustomFileSystemConfigs:
		value := value.(*[]*SagemakerUserProfileUserSettingsCustomFileSystemConfigs)
	...
	case []*SagemakerUserProfileUserSettingsCustomFileSystemConfigs:
		value_ := value.([]*SagemakerUserProfileUserSettingsCustomFileSystemConfigs)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*SagemakerUserProfileUserSettingsCustomFileSystemConfigs; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *SagemakerUserProfileUserSettings:
		val := val.(*SagemakerUserProfileUserSettings)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case SagemakerUserProfileUserSettings:
		val_ := val.(SagemakerUserProfileUserSettings)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *SagemakerUserProfileUserSettings; received %#v (a %T)", val, val)
		}
	}
