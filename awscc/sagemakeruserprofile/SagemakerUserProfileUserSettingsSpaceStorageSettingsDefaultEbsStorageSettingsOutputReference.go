...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsSpaceStorageSettingsDefaultEbsStorageSettingsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsSpaceStorageSettingsDefaultEbsStorageSettingsOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsSpaceStorageSettingsDefaultEbsStorageSettingsOutputReference) ResetDefaultEbsVolumeSizeInGb() {
	_jsii_.InvokeVoid(
		s,
		"resetDefaultEbsVolumeSizeInGb",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsSpaceStorageSettingsDefaultEbsStorageSettingsOutputReference) ResetMaximumEbsVolumeSizeInGb() {
	_jsii_.InvokeVoid(
		s,
		"resetMaximumEbsVolumeSizeInGb",
		nil, // no parameters
