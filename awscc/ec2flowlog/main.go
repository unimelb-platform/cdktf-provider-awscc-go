...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2FlowLog)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "deliverLogsPermissionArnInput", GoGetter: "DeliverLogsPermissionArnInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDeliverLogsPermissionArn", GoMethod: "ResetDeliverLogsPermissionArn"},
	...
	_jsii_.RegisterStruct(
		"awscc.ec2FlowLog.Ec2FlowLogConfig",
		reflect.TypeOf((*Ec2FlowLogConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.ec2FlowLog.Ec2FlowLogDestinationOptions",
		reflect.TypeOf((*Ec2FlowLogDestinationOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2FlowLog.Ec2FlowLogDestinationOptionsOutputReference",
		reflect.TypeOf((*Ec2FlowLogDestinationOptionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.ec2FlowLog.Ec2FlowLogTags",
		reflect.TypeOf((*Ec2FlowLogTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2FlowLog.Ec2FlowLogTagsList",
		reflect.TypeOf((*Ec2FlowLogTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2FlowLogTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
