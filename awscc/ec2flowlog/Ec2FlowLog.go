...
func (j *jsiiProxy_Ec2FlowLog) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_Ec2FlowLog) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Ec2FlowLog) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2FlowLog) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_Ec2FlowLog) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Ec2FlowLog)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Ec2FlowLog)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Ec2FlowLog)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTF code for importing a Ec2FlowLog resource upon running "cdktf plan <stack-name>".
func Ec2FlowLog_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Ec2FlowLog) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_Ec2FlowLog) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
