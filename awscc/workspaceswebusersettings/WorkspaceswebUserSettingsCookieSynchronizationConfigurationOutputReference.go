...
func NewWorkspaceswebUserSettingsCookieSynchronizationConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) WorkspaceswebUserSettingsCookieSynchronizationConfigurationOutputReference {
	_init_.Initialize()
...
func NewWorkspaceswebUserSettingsCookieSynchronizationConfigurationOutputReference_Override(w WorkspaceswebUserSettingsCookieSynchronizationConfigurationOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
