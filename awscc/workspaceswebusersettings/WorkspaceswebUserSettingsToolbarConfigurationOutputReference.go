...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/workspaceswebusersettings/internal"
)
...
func NewWorkspaceswebUserSettingsToolbarConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) WorkspaceswebUserSettingsToolbarConfigurationOutputReference {
	_init_.Initialize()

	if err := validateNewWorkspaceswebUserSettingsToolbarConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewWorkspaceswebUserSettingsToolbarConfigurationOutputReference_Override(w WorkspaceswebUserSettingsToolbarConfigurationOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
