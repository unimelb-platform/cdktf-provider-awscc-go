...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "provisionedConcurrencyConfigInput", GoGetter: "ProvisionedConcurrencyConfigInput"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putProvisionedConcurrencyConfig", GoMethod: "PutProvisionedConcurrencyConfig"},
			_jsii_.MemberMethod{JsiiMethod: "putRoutingConfig", GoMethod: "PutRoutingConfig"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetDescription", GoMethod: "ResetDescription"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetProvisionedConcurrencyConfig", GoMethod: "ResetProvisionedConcurrencyConfig"},
	...
	_jsii_.RegisterStruct(
		"awscc.lambdaAlias.LambdaAliasConfig",
		reflect.TypeOf((*LambdaAliasConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.lambdaAlias.LambdaAliasProvisionedConcurrencyConfig",
		reflect.TypeOf((*LambdaAliasProvisionedConcurrencyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.lambdaAlias.LambdaAliasProvisionedConcurrencyConfigOutputReference",
		reflect.TypeOf((*LambdaAliasProvisionedConcurrencyConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetProvisionedConcurrentExecutions", GoMethod: "ResetProvisionedConcurrentExecutions"},
	...
	_jsii_.RegisterStruct(
		"awscc.lambdaAlias.LambdaAliasRoutingConfig",
		reflect.TypeOf((*LambdaAliasRoutingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.lambdaAlias.LambdaAliasRoutingConfigAdditionalVersionWeights",
		reflect.TypeOf((*LambdaAliasRoutingConfigAdditionalVersionWeights)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.lambdaAlias.LambdaAliasRoutingConfigAdditionalVersionWeightsList",
		reflect.TypeOf((*LambdaAliasRoutingConfigAdditionalVersionWeightsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LambdaAliasRoutingConfigAdditionalVersionWeightsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "functionVersion", GoGetter: "FunctionVersion"},
			_jsii_.MemberProperty{JsiiProperty: "functionVersionInput", GoGetter: "FunctionVersionInput"},
			_jsii_.MemberProperty{JsiiProperty: "functionWeight", GoGetter: "FunctionWeight"},
			_jsii_.MemberProperty{JsiiProperty: "functionWeightInput", GoGetter: "FunctionWeightInput"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getListAttribute", GoMethod: "GetListAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFunctionWeight", GoMethod: "ResetFunctionWeight"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putAdditionalVersionWeights", GoMethod: "PutAdditionalVersionWeights"},
