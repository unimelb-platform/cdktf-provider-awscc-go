...
type LambdaAliasRoutingConfigOutputReference interface {
	cdktf.ComplexObject
	AdditionalVersionWeights() LambdaAliasRoutingConfigAdditionalVersionWeightsList
	...
	PutAdditionalVersionWeights(value interface{})
...
func (j *jsiiProxy_LambdaAliasRoutingConfigOutputReference) AdditionalVersionWeights() LambdaAliasRoutingConfigAdditionalVersionWeightsList {
	var returns LambdaAliasRoutingConfigAdditionalVersionWeightsList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LambdaAliasRoutingConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_LambdaAliasRoutingConfigOutputReference)SetInternalValue(val interface{}) {
...
func (l *jsiiProxy_LambdaAliasRoutingConfigOutputReference) PutAdditionalVersionWeights(value interface{}) {
	if err := l.validatePutAdditionalVersionWeightsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		l,
		"putAdditionalVersionWeights",
		[]interface{}{value},
	)
}
