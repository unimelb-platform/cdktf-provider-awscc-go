...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lambda_alias awscc_lambda_alias}.
type LambdaAlias interface {
	...
	ProvisionedConcurrencyConfig() LambdaAliasProvisionedConcurrencyConfigOutputReference
	...
	PutProvisionedConcurrencyConfig(value *LambdaAliasProvisionedConcurrencyConfig)
...
func (j *jsiiProxy_LambdaAlias) AliasArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"aliasArn",
...
func (j *jsiiProxy_LambdaAlias) ProvisionedConcurrencyConfig() LambdaAliasProvisionedConcurrencyConfigOutputReference {
	var returns LambdaAliasProvisionedConcurrencyConfigOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LambdaAlias) ProvisionedConcurrencyConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LambdaAlias) RoutingConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"routingConfigInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lambda_alias awscc_lambda_alias} Resource.
...
func (l *jsiiProxy_LambdaAlias) PutProvisionedConcurrencyConfig(value *LambdaAliasProvisionedConcurrencyConfig) {
...
func (l *jsiiProxy_LambdaAlias) ResetProvisionedConcurrencyConfig() {
	_jsii_.InvokeVoid(
		l,
		"resetProvisionedConcurrencyConfig",
		nil, // no parameters
