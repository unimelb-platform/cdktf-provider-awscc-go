...
func init() {
	_jsii_.RegisterClass(
		"awscc.gameliftBuild.GameliftBuild",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetServerSdkVersion", GoMethod: "ResetServerSdkVersion"},
			...
			_jsii_.MemberProperty{JsiiProperty: "serverSdkVersionInput", GoGetter: "ServerSdkVersionInput"},
	...
	_jsii_.RegisterStruct(
		"awscc.gameliftBuild.GameliftBuildConfig",
		reflect.TypeOf((*GameliftBuildConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.gameliftBuild.GameliftBuildStorageLocation",
		reflect.TypeOf((*GameliftBuildStorageLocation)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.gameliftBuild.GameliftBuildStorageLocationOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.gameliftBuild.GameliftBuildTags",
		reflect.TypeOf((*GameliftBuildTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.gameliftBuild.GameliftBuildTagsList",
		reflect.TypeOf((*GameliftBuildTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GameliftBuildTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
