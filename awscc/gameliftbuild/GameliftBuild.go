...
func (j *jsiiProxy_GameliftBuild) ServerSdkVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serverSdkVersion",
...
func (j *jsiiProxy_GameliftBuild) ServerSdkVersionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GameliftBuild) StorageLocationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GameliftBuild)SetServerSdkVersion(val *string) {
...
func (g *jsiiProxy_GameliftBuild) ResetName() {
	_jsii_.InvokeVoid(
		g,
		"resetName",
		nil, // no parameters
...
func (g *jsiiProxy_GameliftBuild) ResetOperatingSystem() {
	_jsii_.InvokeVoid(
		g,
		"resetOperatingSystem",
		nil, // no parameters
...
func (g *jsiiProxy_GameliftBuild) ResetServerSdkVersion() {
	_jsii_.InvokeVoid(
		g,
		"resetServerSdkVersion",
		nil, // no parameters
...
func (g *jsiiProxy_GameliftBuild) ResetStorageLocation() {
	_jsii_.InvokeVoid(
		g,
		"resetStorageLocation",
		nil, // no parameters
