...
type NetworkfirewallFirewallPolicyFirewallPolicyPolicyVariablesOutputReference interface {
	...
	RuleVariables() NetworkfirewallFirewallPolicyFirewallPolicyPolicyVariablesRuleVariablesMap
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicyFirewallPolicyPolicyVariablesOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicyFirewallPolicyPolicyVariablesOutputReference) RuleVariables() NetworkfirewallFirewallPolicyFirewallPolicyPolicyVariablesRuleVariablesMap {
	var returns NetworkfirewallFirewallPolicyFirewallPolicyPolicyVariablesRuleVariablesMap
	_jsii_.Get(
		j,
		"ruleVariables",
		&returns,
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicyFirewallPolicyPolicyVariablesOutputReference)SetInternalValue(val interface{}) {
