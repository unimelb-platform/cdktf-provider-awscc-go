...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/networkfirewall_firewall_policy awscc_networkfirewall_firewall_policy}.
type NetworkfirewallFirewallPolicy interface {
	...
	FirewallPolicyInput() interface{}
	FirewallPolicyName() *string
	SetFirewallPolicyName(val *string)
	FirewallPolicyNameInput() *string
	// Experimental.
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicy) FirewallPolicyArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"firewallPolicyArn",
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicy) FirewallPolicyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"firewallPolicyId",
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicy) FirewallPolicyInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"firewallPolicyInput",
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicy) FirewallPolicyName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"firewallPolicyName",
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicy) FirewallPolicyNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"firewallPolicyNameInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicy) Tags() NetworkfirewallFirewallPolicyTagsList {
	var returns NetworkfirewallFirewallPolicyTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/networkfirewall_firewall_policy awscc_networkfirewall_firewall_policy} Resource.
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicy)SetFirewallPolicyName(val *string) {
	if err := j.validateSetFirewallPolicyNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (n *jsiiProxy_NetworkfirewallFirewallPolicy) PutTags(value interface{}) {
