...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/ecr_registry_scanning_configuration awscc_ecr_registry_scanning_configuration}.
...
func (j *jsiiProxy_EcrRegistryScanningConfiguration) Rules() EcrRegistryScanningConfigurationRulesList {
	var returns EcrRegistryScanningConfigurationRulesList
	_jsii_.Get(
		j,
		"rules",
		&returns,
...
func (j *jsiiProxy_EcrRegistryScanningConfiguration) RulesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rulesInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/ecr_registry_scanning_configuration awscc_ecr_registry_scanning_configuration} Resource.
...
func (e *jsiiProxy_EcrRegistryScanningConfiguration) PutRules(value interface{}) {
