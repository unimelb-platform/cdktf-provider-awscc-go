...
func (j *jsiiProxy_LightsailDistributionCacheBehaviorSettingsOutputReference) ForwardedCookiesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LightsailDistributionCacheBehaviorSettingsOutputReference) ForwardedHeadersInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LightsailDistributionCacheBehaviorSettingsOutputReference) ForwardedQueryStringsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LightsailDistributionCacheBehaviorSettingsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_LightsailDistributionCacheBehaviorSettingsOutputReference)SetInternalValue(val interface{}) {
