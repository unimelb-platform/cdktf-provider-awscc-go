...
func (j *jsiiProxy_LightsailDistributionCacheBehaviorSettingsForwardedQueryStringsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *LightsailDistributionCacheBehaviorSettingsForwardedQueryStrings:
		val := val.(*LightsailDistributionCacheBehaviorSettingsForwardedQueryStrings)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case LightsailDistributionCacheBehaviorSettingsForwardedQueryStrings:
		val_ := val.(LightsailDistributionCacheBehaviorSettingsForwardedQueryStrings)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *LightsailDistributionCacheBehaviorSettingsForwardedQueryStrings; received %#v (a %T)", val, val)
		}
	}
