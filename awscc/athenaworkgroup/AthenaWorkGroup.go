...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/athena_work_group awscc_athena_work_group}.
type AthenaWorkGroup interface {
	...
	RecursiveDeleteOptionInput() interface{}
	State() *string
	SetState(val *string)
	StateInput() *string
	...
	WorkGroupConfiguration() AthenaWorkGroupWorkGroupConfigurationOutputReference
	WorkGroupConfigurationInput() interface{}
	WorkGroupConfigurationUpdates() AthenaWorkGroupWorkGroupConfigurationUpdatesOutputReference
	WorkGroupConfigurationUpdatesInput() interface{}
	...
	PutWorkGroupConfiguration(value *AthenaWorkGroupWorkGroupConfiguration)
	PutWorkGroupConfigurationUpdates(value *AthenaWorkGroupWorkGroupConfigurationUpdates)
	ResetDescription()
...
func (j *jsiiProxy_AthenaWorkGroup) CreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creationTime",
...
func (j *jsiiProxy_AthenaWorkGroup) RecursiveDeleteOption() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AthenaWorkGroup) RecursiveDeleteOptionInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"recursiveDeleteOptionInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_AthenaWorkGroup) Tags() AthenaWorkGroupTagsList {
	var returns AthenaWorkGroupTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_AthenaWorkGroup) WorkGroupConfiguration() AthenaWorkGroupWorkGroupConfigurationOutputReference {
	var returns AthenaWorkGroupWorkGroupConfigurationOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AthenaWorkGroup) WorkGroupConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AthenaWorkGroup) WorkGroupConfigurationUpdates() AthenaWorkGroupWorkGroupConfigurationUpdatesOutputReference {
	var returns AthenaWorkGroupWorkGroupConfigurationUpdatesOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AthenaWorkGroup) WorkGroupConfigurationUpdatesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"workGroupConfigurationUpdatesInput",
		&returns,
	)
	return returns
}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/athena_work_group awscc_athena_work_group} Resource.
...
func (j *jsiiProxy_AthenaWorkGroup)SetRecursiveDeleteOption(val interface{}) {
	if err := j.validateSetRecursiveDeleteOptionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (a *jsiiProxy_AthenaWorkGroup) PutTags(value interface{}) {
...
func (a *jsiiProxy_AthenaWorkGroup) PutWorkGroupConfiguration(value *AthenaWorkGroupWorkGroupConfiguration) {
	if err := a.validatePutWorkGroupConfigurationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
		"putWorkGroupConfiguration",
		[]interface{}{value},
	)
}

func (a *jsiiProxy_AthenaWorkGroup) PutWorkGroupConfigurationUpdates(value *AthenaWorkGroupWorkGroupConfigurationUpdates) {
	if err := a.validatePutWorkGroupConfigurationUpdatesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
		"putWorkGroupConfigurationUpdates",
		[]interface{}{value},
	)
}
...
func (a *jsiiProxy_AthenaWorkGroup) ResetRecursiveDeleteOption() {
	_jsii_.InvokeVoid(
		a,
		"resetRecursiveDeleteOption",
		nil, // no parameters
...
func (a *jsiiProxy_AthenaWorkGroup) ResetWorkGroupConfiguration() {
	_jsii_.InvokeVoid(
		a,
		"resetWorkGroupConfiguration",
		nil, // no parameters
...
func (a *jsiiProxy_AthenaWorkGroup) ResetWorkGroupConfigurationUpdates() {
	_jsii_.InvokeVoid(
		a,
		"resetWorkGroupConfigurationUpdates",
		nil, // no parameters
