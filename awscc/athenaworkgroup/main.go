...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.athenaWorkGroup.AthenaWorkGroupWorkGroupConfigurationManagedQueryResultsConfiguration",
		reflect.TypeOf((*AthenaWorkGroupWorkGroupConfigurationManagedQueryResultsConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.athenaWorkGroup.AthenaWorkGroupWorkGroupConfigurationManagedQueryResultsConfigurationEncryptionConfiguration",
	...
	_jsii_.RegisterStruct(
		"awscc.athenaWorkGroup.AthenaWorkGroupWorkGroupConfigurationUpdatesManagedQueryResultsConfiguration",
