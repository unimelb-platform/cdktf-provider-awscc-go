...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "environmentAccountIdentifierInput", GoGetter: "EnvironmentAccountIdentifierInput"},
			_jsii_.MemberProperty{JsiiProperty: "environmentAccountRegion", GoGetter: "EnvironmentAccountRegion"},
			_jsii_.MemberProperty{JsiiProperty: "environmentAccountRegionInput", GoGetter: "EnvironmentAccountRegionInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "environmentProfileId", GoGetter: "EnvironmentProfileId"},
			_jsii_.MemberProperty{JsiiProperty: "environmentProfileIdentifier", GoGetter: "EnvironmentProfileIdentifier"},
			_jsii_.MemberProperty{JsiiProperty: "environmentProfileIdentifierInput", GoGetter: "EnvironmentProfileIdentifierInput"},
			_jsii_.MemberProperty{JsiiProperty: "environmentRoleArn", GoGetter: "EnvironmentRoleArn"},
			_jsii_.MemberProperty{JsiiProperty: "environmentRoleArnInput", GoGetter: "EnvironmentRoleArnInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEnvironmentAccountIdentifier", GoMethod: "ResetEnvironmentAccountIdentifier"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnvironmentAccountRegion", GoMethod: "ResetEnvironmentAccountRegion"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnvironmentProfileIdentifier", GoMethod: "ResetEnvironmentProfileIdentifier"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnvironmentRoleArn", GoMethod: "ResetEnvironmentRoleArn"},
	...
	_jsii_.RegisterStruct(
		"awscc.datazoneEnvironment.DatazoneEnvironmentUserParameters",
		reflect.TypeOf((*DatazoneEnvironmentUserParameters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.datazoneEnvironment.DatazoneEnvironmentUserParametersList",
