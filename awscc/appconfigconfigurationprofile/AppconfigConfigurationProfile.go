...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/appconfig_configuration_profile awscc_appconfig_configuration_profile}.
...
func (j *jsiiProxy_AppconfigConfigurationProfile) DeletionProtectionCheck() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AppconfigConfigurationProfile) DeletionProtectionCheckInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AppconfigConfigurationProfile) KmsKeyArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyArn",
...
func (j *jsiiProxy_AppconfigConfigurationProfile) Tags() AppconfigConfigurationProfileTagsList {
	var returns AppconfigConfigurationProfileTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_AppconfigConfigurationProfile) Validators() AppconfigConfigurationProfileValidatorsList {
	var returns AppconfigConfigurationProfileValidatorsList
	_jsii_.Get(
		j,
		"validators",
		&returns,
...
func (j *jsiiProxy_AppconfigConfigurationProfile) ValidatorsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"validatorsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/appconfig_configuration_profile awscc_appconfig_configuration_profile} Resource.
...
func (j *jsiiProxy_AppconfigConfigurationProfile)SetDeletionProtectionCheck(val *string) {
...
func (a *jsiiProxy_AppconfigConfigurationProfile) PutTags(value interface{}) {
...
func (a *jsiiProxy_AppconfigConfigurationProfile) PutValidators(value interface{}) {
	if err := a.validatePutValidatorsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
...
func (a *jsiiProxy_AppconfigConfigurationProfile) ResetDeletionProtectionCheck() {
	_jsii_.InvokeVoid(
		a,
		"resetDeletionProtectionCheck",
		nil, // no parameters
...
func (a *jsiiProxy_AppconfigConfigurationProfile) ResetValidators() {
	_jsii_.InvokeVoid(
		a,
		"resetValidators",
		nil, // no parameters
