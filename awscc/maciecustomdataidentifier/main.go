...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MacieCustomDataIdentifier)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.macieCustomDataIdentifier.MacieCustomDataIdentifierConfig",
		reflect.TypeOf((*MacieCustomDataIdentifierConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.macieCustomDataIdentifier.MacieCustomDataIdentifierTags",
		reflect.TypeOf((*MacieCustomDataIdentifierTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.macieCustomDataIdentifier.MacieCustomDataIdentifierTagsList",
		reflect.TypeOf((*MacieCustomDataIdentifierTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MacieCustomDataIdentifierTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
