...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccCognitoUserPoolClient.DataAwsccCognitoUserPoolClientRefreshTokenRotation",
		reflect.TypeOf((*DataAwsccCognitoUserPoolClientRefreshTokenRotation)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccCognitoUserPoolClient.DataAwsccCognitoUserPoolClientRefreshTokenRotationOutputReference",
		reflect.TypeOf((*DataAwsccCognitoUserPoolClientRefreshTokenRotationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
