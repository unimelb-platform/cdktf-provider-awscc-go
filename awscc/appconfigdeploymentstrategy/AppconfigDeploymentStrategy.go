...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/appconfig_deployment_strategy awscc_appconfig_deployment_strategy}.
...
func (j *jsiiProxy_AppconfigDeploymentStrategy) DeploymentStrategyId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AppconfigDeploymentStrategy) Tags() AppconfigDeploymentStrategyTagsList {
	var returns AppconfigDeploymentStrategyTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/appconfig_deployment_strategy awscc_appconfig_deployment_strategy} Resource.
func NewAppconfigDeploymentStrategy(scope constructs.Construct, id *string, config *AppconfigDeploymentStrategyConfig) AppconfigDeploymentStrategy {
	...
	_jsii_.Create(
		"awscc.appconfigDeploymentStrategy.AppconfigDeploymentStrategy",
...
func (a *jsiiProxy_AppconfigDeploymentStrategy) PutTags(value interface{}) {
