...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudformationResourceVersion)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.cloudformationResourceVersion.CloudformationResourceVersionConfig",
		reflect.TypeOf((*CloudformationResourceVersionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.cloudformationResourceVersion.CloudformationResourceVersionLoggingConfig",
		reflect.TypeOf((*CloudformationResourceVersionLoggingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.cloudformationResourceVersion.CloudformationResourceVersionLoggingConfigOutputReference",
		reflect.TypeOf((*CloudformationResourceVersionLoggingConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
