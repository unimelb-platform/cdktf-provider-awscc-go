...
func (j *jsiiProxy_AppsyncGraphQlApiOpenIdConnectConfigOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *AppsyncGraphQlApiOpenIdConnectConfig:
		val := val.(*AppsyncGraphQlApiOpenIdConnectConfig)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case AppsyncGraphQlApiOpenIdConnectConfig:
		val_ := val.(AppsyncGraphQlApiOpenIdConnectConfig)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *AppsyncGraphQlApiOpenIdConnectConfig; received %#v (a %T)", val, val)
		}
	}
