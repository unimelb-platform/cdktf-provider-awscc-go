...
func (j *jsiiProxy_AppsyncGraphQlApiLogConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_AppsyncGraphQlApiLogConfigOutputReference)SetInternalValue(val interface{}) {
...
func (a *jsiiProxy_AppsyncGraphQlApiLogConfigOutputReference) ResetCloudwatchLogsRoleArn() {
	_jsii_.InvokeVoid(
		a,
		"resetCloudwatchLogsRoleArn",
		nil, // no parameters
...
func (a *jsiiProxy_AppsyncGraphQlApiLogConfigOutputReference) ResetFieldLogLevel() {
	_jsii_.InvokeVoid(
		a,
		"resetFieldLogLevel",
		nil, // no parameters
