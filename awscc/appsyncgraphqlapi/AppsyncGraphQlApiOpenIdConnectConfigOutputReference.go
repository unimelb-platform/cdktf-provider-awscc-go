...
func (j *jsiiProxy_AppsyncGraphQlApiOpenIdConnectConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_AppsyncGraphQlApiOpenIdConnectConfigOutputReference)SetInternalValue(val interface{}) {
...
func (a *jsiiProxy_AppsyncGraphQlApiOpenIdConnectConfigOutputReference) ResetIssuer() {
	_jsii_.InvokeVoid(
		a,
		"resetIssuer",
		nil, // no parameters
