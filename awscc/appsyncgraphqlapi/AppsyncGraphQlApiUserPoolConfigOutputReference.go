...
func (j *jsiiProxy_AppsyncGraphQlApiUserPoolConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_AppsyncGraphQlApiUserPoolConfigOutputReference)SetInternalValue(val interface{}) {
...
func (a *jsiiProxy_AppsyncGraphQlApiUserPoolConfigOutputReference) ResetDefaultAction() {
	_jsii_.InvokeVoid(
		a,
		"resetDefaultAction",
		nil, // no parameters
...
func (a *jsiiProxy_AppsyncGraphQlApiUserPoolConfigOutputReference) ResetUserPoolId() {
	_jsii_.InvokeVoid(
		a,
		"resetUserPoolId",
		nil, // no parameters
