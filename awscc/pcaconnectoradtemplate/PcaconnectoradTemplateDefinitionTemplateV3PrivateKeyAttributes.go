...
type PcaconnectoradTemplateDefinitionTemplateV3PrivateKeyAttributes struct {
	...
	KeyUsageProperty *PcaconnectoradTemplateDefinitionTemplateV3PrivateKeyAttributesKeyUsageProperty `field:"optional" json:"keyUsageProperty" yaml:"keyUsageProperty"`
