...
func (p *jsiiProxy_PcaconnectoradTemplateDefinitionTemplateV4CertificateValidityValidityPeriodOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (p *jsiiProxy_PcaconnectoradTemplateDefinitionTemplateV4CertificateValidityValidityPeriodOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_PcaconnectoradTemplateDefinitionTemplateV4CertificateValidityValidityPeriodOutputReference) validateSetInternalValueParameters(val *PcaconnectoradTemplateDefinitionTemplateV4CertificateValidityValidityPeriod) error {
...
func (j *jsiiProxy_PcaconnectoradTemplateDefinitionTemplateV4CertificateValidityValidityPeriodOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewPcaconnectoradTemplateDefinitionTemplateV4CertificateValidityValidityPeriodOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
