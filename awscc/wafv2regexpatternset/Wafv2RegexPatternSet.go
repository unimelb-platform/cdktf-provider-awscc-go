...
func (j *jsiiProxy_Wafv2RegexPatternSet) RegularExpressionListInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"regularExpressionListInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_Wafv2RegexPatternSet) Tags() Wafv2RegexPatternSetTagsList {
	var returns Wafv2RegexPatternSetTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_Wafv2RegexPatternSet) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_Wafv2RegexPatternSet)SetRegularExpressionList(val *[]*string) {
...
func (w *jsiiProxy_Wafv2RegexPatternSet) PutTags(value interface{}) {
