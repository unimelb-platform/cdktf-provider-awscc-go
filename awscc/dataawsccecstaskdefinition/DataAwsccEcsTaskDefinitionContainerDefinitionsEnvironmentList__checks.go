...
func (d *jsiiProxy_DataAwsccEcsTaskDefinitionContainerDefinitionsEnvironmentList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_DataAwsccEcsTaskDefinitionContainerDefinitionsEnvironmentList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewDataAwsccEcsTaskDefinitionContainerDefinitionsEnvironmentListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
