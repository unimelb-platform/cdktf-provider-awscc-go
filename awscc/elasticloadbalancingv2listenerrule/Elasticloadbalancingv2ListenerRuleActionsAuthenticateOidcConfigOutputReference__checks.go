...
func (e *jsiiProxy_Elasticloadbalancingv2ListenerRuleActionsAuthenticateOidcConfigOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (e *jsiiProxy_Elasticloadbalancingv2ListenerRuleActionsAuthenticateOidcConfigOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_Elasticloadbalancingv2ListenerRuleActionsAuthenticateOidcConfigOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *Elasticloadbalancingv2ListenerRuleActionsAuthenticateOidcConfig; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_Elasticloadbalancingv2ListenerRuleActionsAuthenticateOidcConfigOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewElasticloadbalancingv2ListenerRuleActionsAuthenticateOidcConfigOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
