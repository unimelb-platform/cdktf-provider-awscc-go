...
func (j *jsiiProxy_KendraIndexDocumentMetadataConfigurationsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewKendraIndexDocumentMetadataConfigurationsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) KendraIndexDocumentMetadataConfigurationsList {
	_init_.Initialize()
...
func NewKendraIndexDocumentMetadataConfigurationsList_Override(k KendraIndexDocumentMetadataConfigurationsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KendraIndexDocumentMetadataConfigurationsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (k *jsiiProxy_KendraIndexDocumentMetadataConfigurationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KendraIndexDocumentMetadataConfigurationsList) Resolve(_context cdktf.IResolveContext) interface{} {
