...
func (j *jsiiProxy_KendraIndexUserTokenConfigurationsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_KendraIndexUserTokenConfigurationsOutputReference) JsonTokenTypeConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_KendraIndexUserTokenConfigurationsOutputReference) JwtTokenTypeConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func NewKendraIndexUserTokenConfigurationsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) KendraIndexUserTokenConfigurationsOutputReference {
	_init_.Initialize()

	if err := validateNewKendraIndexUserTokenConfigurationsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewKendraIndexUserTokenConfigurationsOutputReference_Override(k KendraIndexUserTokenConfigurationsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KendraIndexUserTokenConfigurationsOutputReference)SetInternalValue(val interface{}) {
