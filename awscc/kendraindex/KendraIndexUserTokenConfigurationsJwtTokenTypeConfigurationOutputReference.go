...
func (j *jsiiProxy_KendraIndexUserTokenConfigurationsJwtTokenTypeConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_KendraIndexUserTokenConfigurationsJwtTokenTypeConfigurationOutputReference) SecretManagerArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"secretManagerArn",
...
func (j *jsiiProxy_KendraIndexUserTokenConfigurationsJwtTokenTypeConfigurationOutputReference) SecretManagerArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_KendraIndexUserTokenConfigurationsJwtTokenTypeConfigurationOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_KendraIndexUserTokenConfigurationsJwtTokenTypeConfigurationOutputReference)SetSecretManagerArn(val *string) {
...
func (k *jsiiProxy_KendraIndexUserTokenConfigurationsJwtTokenTypeConfigurationOutputReference) ResetSecretManagerArn() {
	_jsii_.InvokeVoid(
		k,
		"resetSecretManagerArn",
		nil, // no parameters
