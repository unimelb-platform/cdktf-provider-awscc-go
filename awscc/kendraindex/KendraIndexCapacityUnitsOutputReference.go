...
func (j *jsiiProxy_KendraIndexCapacityUnitsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_KendraIndexCapacityUnitsOutputReference)SetInternalValue(val interface{}) {
