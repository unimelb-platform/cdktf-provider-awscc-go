...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRuleVariablesIpSetsOutputReference) Definition() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"definition",
...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRuleVariablesIpSetsOutputReference) DefinitionInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"definitionInput",
...
func NewNetworkfirewallRuleGroupRuleGroupRuleVariablesIpSetsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectKey *string) NetworkfirewallRuleGroupRuleGroupRuleVariablesIpSetsOutputReference {
	_init_.Initialize()

	if err := validateNewNetworkfirewallRuleGroupRuleGroupRuleVariablesIpSetsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectKey); err != nil {
		panic(err)
	}
...
func NewNetworkfirewallRuleGroupRuleGroupRuleVariablesIpSetsOutputReference_Override(n NetworkfirewallRuleGroupRuleGroupRuleVariablesIpSetsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectKey *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRuleVariablesIpSetsOutputReference)SetDefinition(val *[]*string) {
...
func (n *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRuleVariablesIpSetsOutputReference) ResetDefinition() {
	_jsii_.InvokeVoid(
		n,
		"resetDefinition",
		nil, // no parameters
