...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRulesSourceStatefulRulesRuleOptionsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewNetworkfirewallRuleGroupRuleGroupRulesSourceStatefulRulesRuleOptionsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkfirewallRuleGroupRuleGroupRulesSourceStatefulRulesRuleOptionsList {
	_init_.Initialize()
...
func NewNetworkfirewallRuleGroupRuleGroupRulesSourceStatefulRulesRuleOptionsList_Override(n NetworkfirewallRuleGroupRuleGroupRulesSourceStatefulRulesRuleOptionsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRulesSourceStatefulRulesRuleOptionsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRulesSourceStatefulRulesRuleOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRulesSourceStatefulRulesRuleOptionsList) Resolve(_context cdktf.IResolveContext) interface{} {
