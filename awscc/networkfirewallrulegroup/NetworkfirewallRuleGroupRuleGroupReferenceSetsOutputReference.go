...
type NetworkfirewallRuleGroupRuleGroupReferenceSetsOutputReference interface {
	...
	IpSetReferences() NetworkfirewallRuleGroupRuleGroupReferenceSetsIpSetReferencesMap
...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupReferenceSetsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupReferenceSetsOutputReference) IpSetReferences() NetworkfirewallRuleGroupRuleGroupReferenceSetsIpSetReferencesMap {
	var returns NetworkfirewallRuleGroupRuleGroupReferenceSetsIpSetReferencesMap
	_jsii_.Get(
		j,
		"ipSetReferences",
		&returns,
...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupReferenceSetsOutputReference)SetInternalValue(val interface{}) {
