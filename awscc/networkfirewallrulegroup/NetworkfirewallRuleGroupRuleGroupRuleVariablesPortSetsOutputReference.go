...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRuleVariablesPortSetsOutputReference) Definition() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"definition",
...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRuleVariablesPortSetsOutputReference) DefinitionInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"definitionInput",
...
func NewNetworkfirewallRuleGroupRuleGroupRuleVariablesPortSetsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectKey *string) NetworkfirewallRuleGroupRuleGroupRuleVariablesPortSetsOutputReference {
	_init_.Initialize()

	if err := validateNewNetworkfirewallRuleGroupRuleGroupRuleVariablesPortSetsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectKey); err != nil {
		panic(err)
	}
...
func NewNetworkfirewallRuleGroupRuleGroupRuleVariablesPortSetsOutputReference_Override(n NetworkfirewallRuleGroupRuleGroupRuleVariablesPortSetsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectKey *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRuleVariablesPortSetsOutputReference)SetDefinition(val *[]*string) {
...
func (n *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRuleVariablesPortSetsOutputReference) ResetDefinition() {
	_jsii_.InvokeVoid(
		n,
		"resetDefinition",
		nil, // no parameters
