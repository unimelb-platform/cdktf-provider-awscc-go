...
type NetworkfirewallRuleGroupRuleGroupRulesSourceOutputReference interface {
	...
	StatefulRules() NetworkfirewallRuleGroupRuleGroupRulesSourceStatefulRulesList
	StatefulRulesInput() interface{}
	StatelessRulesAndCustomActions() NetworkfirewallRuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsOutputReference
	StatelessRulesAndCustomActionsInput() interface{}
	// Experimental.
	...
	PutStatefulRules(value interface{})
...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRulesSourceOutputReference) RulesSourceListInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRulesSourceOutputReference) StatefulRules() NetworkfirewallRuleGroupRuleGroupRulesSourceStatefulRulesList {
	var returns NetworkfirewallRuleGroupRuleGroupRulesSourceStatefulRulesList
	_jsii_.Get(
		j,
		"statefulRules",
		&returns,
...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRulesSourceOutputReference) StatefulRulesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"statefulRulesInput",
...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRulesSourceOutputReference) StatelessRulesAndCustomActionsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (n *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRulesSourceOutputReference) PutStatefulRules(value interface{}) {
	if err := n.validatePutStatefulRulesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		n,
...
func (n *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRulesSourceOutputReference) ResetStatefulRules() {
	_jsii_.InvokeVoid(
		n,
		"resetStatefulRules",
		nil, // no parameters
