...
func (j *jsiiProxy_LambdaEventSourceMappingDestinationConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_LambdaEventSourceMappingDestinationConfigOutputReference) OnFailureInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"onFailureInput",
...
func (j *jsiiProxy_LambdaEventSourceMappingDestinationConfigOutputReference)SetInternalValue(val interface{}) {
