...
type LambdaEventSourceMappingSelfManagedEventSourceOutputReference interface {
	...
	PutEndpoints(value *LambdaEventSourceMappingSelfManagedEventSourceEndpoints)
	ResetEndpoints()
...
func (j *jsiiProxy_LambdaEventSourceMappingSelfManagedEventSourceOutputReference) Endpoints() LambdaEventSourceMappingSelfManagedEventSourceEndpointsOutputReference {
	var returns LambdaEventSourceMappingSelfManagedEventSourceEndpointsOutputReference
	_jsii_.Get(
		j,
		"endpoints",
		&returns,
...
func (j *jsiiProxy_LambdaEventSourceMappingSelfManagedEventSourceOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_LambdaEventSourceMappingSelfManagedEventSourceOutputReference)SetInternalValue(val interface{}) {
...
func (l *jsiiProxy_LambdaEventSourceMappingSelfManagedEventSourceOutputReference) PutEndpoints(value *LambdaEventSourceMappingSelfManagedEventSourceEndpoints) {
	if err := l.validatePutEndpointsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		l,
...
func (l *jsiiProxy_LambdaEventSourceMappingSelfManagedEventSourceOutputReference) ResetEndpoints() {
	_jsii_.InvokeVoid(
		l,
		"resetEndpoints",
		nil, // no parameters
