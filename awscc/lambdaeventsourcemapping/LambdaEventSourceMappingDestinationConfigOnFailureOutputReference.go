...
func (j *jsiiProxy_LambdaEventSourceMappingDestinationConfigOnFailureOutputReference) Destination() *string {
	var returns *string
	_jsii_.Get(
		j,
		"destination",
...
func (j *jsiiProxy_LambdaEventSourceMappingDestinationConfigOnFailureOutputReference) DestinationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"destinationInput",
...
func (j *jsiiProxy_LambdaEventSourceMappingDestinationConfigOnFailureOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_LambdaEventSourceMappingDestinationConfigOnFailureOutputReference)SetDestination(val *string) {
...
func (j *jsiiProxy_LambdaEventSourceMappingDestinationConfigOnFailureOutputReference)SetInternalValue(val interface{}) {
...
func (l *jsiiProxy_LambdaEventSourceMappingDestinationConfigOnFailureOutputReference) ResetDestination() {
	_jsii_.InvokeVoid(
		l,
		"resetDestination",
		nil, // no parameters
