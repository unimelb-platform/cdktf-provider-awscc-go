...
type LambdaEventSourceMapping interface {
	...
	AmazonManagedKafkaEventSourceConfigInput() interface{}
	BatchSize() *float64
	...
	DocumentDbEventSourceConfigInput() interface{}
	Enabled() interface{}
	...
	SelfManagedEventSourceInput() interface{}
	SelfManagedKafkaEventSourceConfig() LambdaEventSourceMappingSelfManagedKafkaEventSourceConfigOutputReference
	SelfManagedKafkaEventSourceConfigInput() interface{}
	SourceAccessConfigurations() LambdaEventSourceMappingSourceAccessConfigurationsList
	SourceAccessConfigurationsInput() interface{}
...
func (j *jsiiProxy_LambdaEventSourceMapping) AmazonManagedKafkaEventSourceConfigInput() interface{} {
...
func (j *jsiiProxy_LambdaEventSourceMapping) DestinationConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LambdaEventSourceMapping) DocumentDbEventSourceConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LambdaEventSourceMapping) FilterCriteriaInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"filterCriteriaInput",
...
func (j *jsiiProxy_LambdaEventSourceMapping) ScalingConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"scalingConfigInput",
...
func (j *jsiiProxy_LambdaEventSourceMapping) SelfManagedEventSourceInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LambdaEventSourceMapping) SelfManagedKafkaEventSourceConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LambdaEventSourceMapping) SourceAccessConfigurations() LambdaEventSourceMappingSourceAccessConfigurationsList {
	var returns LambdaEventSourceMappingSourceAccessConfigurationsList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LambdaEventSourceMapping) SourceAccessConfigurationsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LambdaEventSourceMapping) StartingPositionTimestamp() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LambdaEventSourceMapping) StartingPositionTimestampInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LambdaEventSourceMapping)SetStartingPositionTimestamp(val *float64) {
...
func (l *jsiiProxy_LambdaEventSourceMapping) PutSourceAccessConfigurations(value interface{}) {
	if err := l.validatePutSourceAccessConfigurationsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		l,
...
func (l *jsiiProxy_LambdaEventSourceMapping) ResetSourceAccessConfigurations() {
	_jsii_.InvokeVoid(
		l,
		"resetSourceAccessConfigurations",
		nil, // no parameters
