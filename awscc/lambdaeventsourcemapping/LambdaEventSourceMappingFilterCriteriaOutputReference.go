...
func (j *jsiiProxy_LambdaEventSourceMappingFilterCriteriaOutputReference) Filters() LambdaEventSourceMappingFilterCriteriaFiltersList {
	var returns LambdaEventSourceMappingFilterCriteriaFiltersList
	_jsii_.Get(
		j,
		"filters",
		&returns,
...
func (j *jsiiProxy_LambdaEventSourceMappingFilterCriteriaOutputReference) FiltersInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"filtersInput",
...
func (j *jsiiProxy_LambdaEventSourceMappingFilterCriteriaOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_LambdaEventSourceMappingFilterCriteriaOutputReference)SetInternalValue(val interface{}) {
...
func (l *jsiiProxy_LambdaEventSourceMappingFilterCriteriaOutputReference) PutFilters(value interface{}) {
	if err := l.validatePutFiltersParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		l,
...
func (l *jsiiProxy_LambdaEventSourceMappingFilterCriteriaOutputReference) ResetFilters() {
	_jsii_.InvokeVoid(
		l,
		"resetFilters",
		nil, // no parameters
