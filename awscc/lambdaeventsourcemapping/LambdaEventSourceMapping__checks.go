...
func (l *jsiiProxy_LambdaEventSourceMapping) validatePutSourceAccessConfigurationsParameters(value interface{}) error {
	...
	case *[]*LambdaEventSourceMappingSourceAccessConfigurations:
		value := value.(*[]*LambdaEventSourceMappingSourceAccessConfigurations)
	...
	case []*LambdaEventSourceMappingSourceAccessConfigurations:
		value_ := value.([]*LambdaEventSourceMappingSourceAccessConfigurations)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (j *jsiiProxy_LambdaEventSourceMapping) validateSetStartingPositionTimestampParameters(val *float64) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
