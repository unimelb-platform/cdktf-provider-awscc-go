...
func (l *jsiiProxy_LambdaEventSourceMappingProvisionedPollerConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LambdaEventSourceMappingProvisionedPollerConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
