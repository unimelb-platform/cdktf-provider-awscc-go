...
func (d *jsiiProxy_DataAwsccEc2LocalGatewayRouteTableVirtualInterfaceGroupAssociationTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
