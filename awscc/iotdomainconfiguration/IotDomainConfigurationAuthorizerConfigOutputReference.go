...
func (j *jsiiProxy_IotDomainConfigurationAuthorizerConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_IotDomainConfigurationAuthorizerConfigOutputReference)SetInternalValue(val interface{}) {
