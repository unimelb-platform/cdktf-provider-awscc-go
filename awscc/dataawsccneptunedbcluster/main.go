...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccNeptuneDbCluster)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccNeptuneDbCluster.DataAwsccNeptuneDbClusterAssociatedRoles",
		reflect.TypeOf((*DataAwsccNeptuneDbClusterAssociatedRoles)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccNeptuneDbCluster.DataAwsccNeptuneDbClusterAssociatedRolesList",
		reflect.TypeOf((*DataAwsccNeptuneDbClusterAssociatedRolesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccNeptuneDbClusterAssociatedRolesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccNeptuneDbCluster.DataAwsccNeptuneDbClusterConfig",
		reflect.TypeOf((*DataAwsccNeptuneDbClusterConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccNeptuneDbCluster.DataAwsccNeptuneDbClusterServerlessScalingConfiguration",
		reflect.TypeOf((*DataAwsccNeptuneDbClusterServerlessScalingConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccNeptuneDbCluster.DataAwsccNeptuneDbClusterServerlessScalingConfigurationOutputReference",
		reflect.TypeOf((*DataAwsccNeptuneDbClusterServerlessScalingConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccNeptuneDbClusterServerlessScalingConfigurationOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccNeptuneDbCluster.DataAwsccNeptuneDbClusterTags",
		reflect.TypeOf((*DataAwsccNeptuneDbClusterTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccNeptuneDbCluster.DataAwsccNeptuneDbClusterTagsList",
		reflect.TypeOf((*DataAwsccNeptuneDbClusterTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccNeptuneDbClusterTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
