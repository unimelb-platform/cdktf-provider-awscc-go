...
type SsmAssociationOutputLocationOutputReference interface {
	...
	S3Location() SsmAssociationOutputLocationS3LocationOutputReference
	...
	PutS3Location(value *SsmAssociationOutputLocationS3Location)
	ResetS3Location()
...
func (j *jsiiProxy_SsmAssociationOutputLocationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SsmAssociationOutputLocationOutputReference) S3Location() SsmAssociationOutputLocationS3LocationOutputReference {
	var returns SsmAssociationOutputLocationS3LocationOutputReference
	_jsii_.Get(
		j,
		"s3Location",
		&returns,
...
func (j *jsiiProxy_SsmAssociationOutputLocationOutputReference) S3LocationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"s3LocationInput",
...
func (j *jsiiProxy_SsmAssociationOutputLocationOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_SsmAssociationOutputLocationOutputReference) PutS3Location(value *SsmAssociationOutputLocationS3Location) {
	if err := s.validatePutS3LocationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_SsmAssociationOutputLocationOutputReference) ResetS3Location() {
	_jsii_.InvokeVoid(
		s,
		"resetS3Location",
		nil, // no parameters
