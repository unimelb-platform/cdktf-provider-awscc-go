...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAgentName", GoMethod: "ResetAgentName"},
	...
	_jsii_.RegisterStruct(
		"awscc.datasyncAgent.DatasyncAgentConfig",
		reflect.TypeOf((*DatasyncAgentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.datasyncAgent.DatasyncAgentTags",
		reflect.TypeOf((*DatasyncAgentTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.datasyncAgent.DatasyncAgentTagsList",
		reflect.TypeOf((*DatasyncAgentTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DatasyncAgentTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
