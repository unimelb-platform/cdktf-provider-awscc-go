...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/datasync_agent awscc_datasync_agent}.
...
func (j *jsiiProxy_DatasyncAgent) AgentArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"agentArn",
...
func (j *jsiiProxy_DatasyncAgent) AgentName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"agentName",
...
func (j *jsiiProxy_DatasyncAgent) AgentNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"agentNameInput",
...
func (j *jsiiProxy_DatasyncAgent) EndpointType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"endpointType",
...
func (j *jsiiProxy_DatasyncAgent) Tags() DatasyncAgentTagsList {
	var returns DatasyncAgentTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/datasync_agent awscc_datasync_agent} Resource.
func NewDatasyncAgent(scope constructs.Construct, id *string, config *DatasyncAgentConfig) DatasyncAgent {
	...
	_jsii_.Create(
		"awscc.datasyncAgent.DatasyncAgent",
...
func (j *jsiiProxy_DatasyncAgent)SetAgentName(val *string) {
...
func (d *jsiiProxy_DatasyncAgent) PutTags(value interface{}) {
...
func (d *jsiiProxy_DatasyncAgent) ResetAgentName() {
	_jsii_.InvokeVoid(
		d,
		"resetAgentName",
		nil, // no parameters
