...
func NewBackupRestoreTestingPlanRecoveryPointSelectionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) BackupRestoreTestingPlanRecoveryPointSelectionOutputReference {
	_init_.Initialize()

	if err := validateNewBackupRestoreTestingPlanRecoveryPointSelectionOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewBackupRestoreTestingPlanRecoveryPointSelectionOutputReference_Override(b BackupRestoreTestingPlanRecoveryPointSelectionOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
