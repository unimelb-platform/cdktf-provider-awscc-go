...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEventsArchive)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccEventsArchive.DataAwsccEventsArchiveConfig",
		reflect.TypeOf((*DataAwsccEventsArchiveConfig)(nil)).Elem(),
	)
}
