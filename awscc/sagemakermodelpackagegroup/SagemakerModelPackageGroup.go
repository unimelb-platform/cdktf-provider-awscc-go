...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/sagemaker_model_package_group awscc_sagemaker_model_package_group}.
type SagemakerModelPackageGroup interface {
	...
	SetModelPackageGroupPolicy(val *string)
	ModelPackageGroupPolicyInput() *string
...
func (j *jsiiProxy_SagemakerModelPackageGroup) CreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creationTime",
...
func (j *jsiiProxy_SagemakerModelPackageGroup) ModelPackageGroupArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerModelPackageGroup) ModelPackageGroupPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerModelPackageGroup) ModelPackageGroupPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"modelPackageGroupPolicyInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_SagemakerModelPackageGroup) ModelPackageGroupStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerModelPackageGroup) Tags() SagemakerModelPackageGroupTagsList {
	var returns SagemakerModelPackageGroupTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/sagemaker_model_package_group awscc_sagemaker_model_package_group} Resource.
...
func (j *jsiiProxy_SagemakerModelPackageGroup)SetModelPackageGroupPolicy(val *string) {
...
func (s *jsiiProxy_SagemakerModelPackageGroup) PutTags(value interface{}) {
...
func (s *jsiiProxy_SagemakerModelPackageGroup) ResetModelPackageGroupPolicy() {
	_jsii_.InvokeVoid(
		s,
		"resetModelPackageGroupPolicy",
		nil, // no parameters
