...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "modelPackageGroupPolicyInput", GoGetter: "ModelPackageGroupPolicyInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetModelPackageGroupPolicy", GoMethod: "ResetModelPackageGroupPolicy"},
	...
	_jsii_.RegisterStruct(
		"awscc.sagemakerModelPackageGroup.SagemakerModelPackageGroupConfig",
		reflect.TypeOf((*SagemakerModelPackageGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.sagemakerModelPackageGroup.SagemakerModelPackageGroupTags",
		reflect.TypeOf((*SagemakerModelPackageGroupTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.sagemakerModelPackageGroup.SagemakerModelPackageGroupTagsList",
		reflect.TypeOf((*SagemakerModelPackageGroupTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SagemakerModelPackageGroupTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
