...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.rdsIntegration.RdsIntegrationConfig",
		reflect.TypeOf((*RdsIntegrationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.rdsIntegration.RdsIntegrationTags",
		reflect.TypeOf((*RdsIntegrationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.rdsIntegration.RdsIntegrationTagsList",
		reflect.TypeOf((*RdsIntegrationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RdsIntegrationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
