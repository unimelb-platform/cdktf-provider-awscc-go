...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCodestarconnectionsConnection)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccCodestarconnectionsConnectionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccCodestarconnectionsConnection.DataAwsccCodestarconnectionsConnectionTags",
		reflect.TypeOf((*DataAwsccCodestarconnectionsConnectionTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccCodestarconnectionsConnection.DataAwsccCodestarconnectionsConnectionTagsList",
		reflect.TypeOf((*DataAwsccCodestarconnectionsConnectionTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCodestarconnectionsConnectionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
