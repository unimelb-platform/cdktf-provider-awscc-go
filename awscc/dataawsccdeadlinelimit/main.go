...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDeadlineLimit)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccDeadlineLimit.DataAwsccDeadlineLimitConfig",
		reflect.TypeOf((*DataAwsccDeadlineLimitConfig)(nil)).Elem(),
	)
}
