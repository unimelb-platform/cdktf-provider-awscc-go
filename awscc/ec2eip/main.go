...
func init() {
	_jsii_.RegisterClass(
		"awscc.ec2Eip.Ec2Eip",
		reflect.TypeOf((*Ec2Eip)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTransferAddress", GoMethod: "ResetTransferAddress"},
			...
			_jsii_.MemberProperty{JsiiProperty: "transferAddressInput", GoGetter: "TransferAddressInput"},
		},
		func() interface{} {
			j := jsiiProxy_Ec2Eip{}
	...
	_jsii_.RegisterStruct(
		"awscc.ec2Eip.Ec2EipConfig",
		reflect.TypeOf((*Ec2EipConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.ec2Eip.Ec2EipTags",
		reflect.TypeOf((*Ec2EipTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2Eip.Ec2EipTagsList",
		reflect.TypeOf((*Ec2EipTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2EipTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
