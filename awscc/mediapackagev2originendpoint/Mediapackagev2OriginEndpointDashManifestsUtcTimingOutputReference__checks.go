...
func (m *jsiiProxy_Mediapackagev2OriginEndpointDashManifestsUtcTimingOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (m *jsiiProxy_Mediapackagev2OriginEndpointDashManifestsUtcTimingOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_Mediapackagev2OriginEndpointDashManifestsUtcTimingOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *Mediapackagev2OriginEndpointDashManifestsUtcTiming; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_Mediapackagev2OriginEndpointDashManifestsUtcTimingOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewMediapackagev2OriginEndpointDashManifestsUtcTimingOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
