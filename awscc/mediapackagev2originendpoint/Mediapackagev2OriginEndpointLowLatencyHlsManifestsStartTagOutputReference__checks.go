...
func (m *jsiiProxy_Mediapackagev2OriginEndpointLowLatencyHlsManifestsStartTagOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (m *jsiiProxy_Mediapackagev2OriginEndpointLowLatencyHlsManifestsStartTagOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_Mediapackagev2OriginEndpointLowLatencyHlsManifestsStartTagOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *Mediapackagev2OriginEndpointLowLatencyHlsManifestsStartTag; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_Mediapackagev2OriginEndpointLowLatencyHlsManifestsStartTagOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewMediapackagev2OriginEndpointLowLatencyHlsManifestsStartTagOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
