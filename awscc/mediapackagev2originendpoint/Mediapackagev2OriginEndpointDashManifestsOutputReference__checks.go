...
func (m *jsiiProxy_Mediapackagev2OriginEndpointDashManifestsOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (m *jsiiProxy_Mediapackagev2OriginEndpointDashManifestsOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_Mediapackagev2OriginEndpointDashManifestsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *Mediapackagev2OriginEndpointDashManifests; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_Mediapackagev2OriginEndpointDashManifestsOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewMediapackagev2OriginEndpointDashManifestsOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
