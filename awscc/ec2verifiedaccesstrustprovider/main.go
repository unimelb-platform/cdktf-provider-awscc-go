...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2VerifiedAccessTrustProvider)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.ec2VerifiedAccessTrustProvider.Ec2VerifiedAccessTrustProviderConfig",
		reflect.TypeOf((*Ec2VerifiedAccessTrustProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.ec2VerifiedAccessTrustProvider.Ec2VerifiedAccessTrustProviderDeviceOptions",
		reflect.TypeOf((*Ec2VerifiedAccessTrustProviderDeviceOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2VerifiedAccessTrustProvider.Ec2VerifiedAccessTrustProviderDeviceOptionsOutputReference",
		reflect.TypeOf((*Ec2VerifiedAccessTrustProviderDeviceOptionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "publicSigningKeyUrlInput", GoGetter: "PublicSigningKeyUrlInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetPublicSigningKeyUrl", GoMethod: "ResetPublicSigningKeyUrl"},
	...
	_jsii_.RegisterStruct(
		"awscc.ec2VerifiedAccessTrustProvider.Ec2VerifiedAccessTrustProviderOidcOptions",
		reflect.TypeOf((*Ec2VerifiedAccessTrustProviderOidcOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2VerifiedAccessTrustProvider.Ec2VerifiedAccessTrustProviderOidcOptionsOutputReference",
		reflect.TypeOf((*Ec2VerifiedAccessTrustProviderOidcOptionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.ec2VerifiedAccessTrustProvider.Ec2VerifiedAccessTrustProviderSseSpecification",
		reflect.TypeOf((*Ec2VerifiedAccessTrustProviderSseSpecification)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2VerifiedAccessTrustProvider.Ec2VerifiedAccessTrustProviderSseSpecificationOutputReference",
		reflect.TypeOf((*Ec2VerifiedAccessTrustProviderSseSpecificationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
		...
		func() interface{} {
			j := jsiiProxy_Ec2VerifiedAccessTrustProviderSseSpecificationOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.ec2VerifiedAccessTrustProvider.Ec2VerifiedAccessTrustProviderTags",
		reflect.TypeOf((*Ec2VerifiedAccessTrustProviderTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2VerifiedAccessTrustProvider.Ec2VerifiedAccessTrustProviderTagsList",
		reflect.TypeOf((*Ec2VerifiedAccessTrustProviderTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2VerifiedAccessTrustProviderTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
