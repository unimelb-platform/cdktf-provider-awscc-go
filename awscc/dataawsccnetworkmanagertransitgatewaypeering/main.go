...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccNetworkmanagerTransitGatewayPeering)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccNetworkmanagerTransitGatewayPeering.DataAwsccNetworkmanagerTransitGatewayPeeringConfig",
		reflect.TypeOf((*DataAwsccNetworkmanagerTransitGatewayPeeringConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccNetworkmanagerTransitGatewayPeering.DataAwsccNetworkmanagerTransitGatewayPeeringTags",
		reflect.TypeOf((*DataAwsccNetworkmanagerTransitGatewayPeeringTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccNetworkmanagerTransitGatewayPeering.DataAwsccNetworkmanagerTransitGatewayPeeringTagsList",
		reflect.TypeOf((*DataAwsccNetworkmanagerTransitGatewayPeeringTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccNetworkmanagerTransitGatewayPeeringTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
