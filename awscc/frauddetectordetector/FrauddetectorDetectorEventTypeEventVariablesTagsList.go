...
func (j *jsiiProxy_FrauddetectorDetectorEventTypeEventVariablesTagsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewFrauddetectorDetectorEventTypeEventVariablesTagsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FrauddetectorDetectorEventTypeEventVariablesTagsList {
	_init_.Initialize()
...
func NewFrauddetectorDetectorEventTypeEventVariablesTagsList_Override(f FrauddetectorDetectorEventTypeEventVariablesTagsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrauddetectorDetectorEventTypeEventVariablesTagsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (f *jsiiProxy_FrauddetectorDetectorEventTypeEventVariablesTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FrauddetectorDetectorEventTypeEventVariablesTagsList) Resolve(_context cdktf.IResolveContext) interface{} {
