...
func (j *jsiiProxy_AppsyncResolverSyncConfigLambdaConflictHandlerConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_AppsyncResolverSyncConfigLambdaConflictHandlerConfigOutputReference)SetInternalValue(val interface{}) {
