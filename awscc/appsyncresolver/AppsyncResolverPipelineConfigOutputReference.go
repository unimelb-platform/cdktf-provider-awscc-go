...
func (j *jsiiProxy_AppsyncResolverPipelineConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_AppsyncResolverPipelineConfigOutputReference)SetInternalValue(val interface{}) {
