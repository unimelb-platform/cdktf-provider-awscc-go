...
func (j *jsiiProxy_AppsyncResolverSyncConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_AppsyncResolverSyncConfigOutputReference) LambdaConflictHandlerConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AppsyncResolverSyncConfigOutputReference)SetInternalValue(val interface{}) {
