...
func (j *jsiiProxy_AppsyncResolverSyncConfigLambdaConflictHandlerConfigOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *AppsyncResolverSyncConfigLambdaConflictHandlerConfig:
		val := val.(*AppsyncResolverSyncConfigLambdaConflictHandlerConfig)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case AppsyncResolverSyncConfigLambdaConflictHandlerConfig:
		val_ := val.(AppsyncResolverSyncConfigLambdaConflictHandlerConfig)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *AppsyncResolverSyncConfigLambdaConflictHandlerConfig; received %#v (a %T)", val, val)
		}
	}
