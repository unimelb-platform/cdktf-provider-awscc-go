...
func (j *jsiiProxy_AppsyncResolverCachingConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_AppsyncResolverCachingConfigOutputReference)SetInternalValue(val interface{}) {
