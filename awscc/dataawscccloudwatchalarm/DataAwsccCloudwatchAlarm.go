...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/data-sources/cloudwatch_alarm awscc_cloudwatch_alarm}.
...
func (j *jsiiProxy_DataAwsccCloudwatchAlarm) Tags() DataAwsccCloudwatchAlarmTagsList {
	var returns DataAwsccCloudwatchAlarmTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/data-sources/cloudwatch_alarm awscc_cloudwatch_alarm} Data Source.
...
func (d *jsiiProxy_DataAwsccCloudwatchAlarm) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsccCloudwatchAlarm) ToHclTerraform() interface{} {
	var returns interface{}
