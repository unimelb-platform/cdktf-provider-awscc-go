...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudtrailResourcePolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.cloudtrailResourcePolicy.CloudtrailResourcePolicyConfig",
		reflect.TypeOf((*CloudtrailResourcePolicyConfig)(nil)).Elem(),
	)
}
