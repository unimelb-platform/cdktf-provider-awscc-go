...
func (s *jsiiProxy_SesConfigurationSetEventDestinationEventDestinationEventBridgeDestinationOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (s *jsiiProxy_SesConfigurationSetEventDestinationEventDestinationEventBridgeDestinationOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_SesConfigurationSetEventDestinationEventDestinationEventBridgeDestinationOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *SesConfigurationSetEventDestinationEventDestinationEventBridgeDestination:
		val := val.(*SesConfigurationSetEventDestinationEventDestinationEventBridgeDestination)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case SesConfigurationSetEventDestinationEventDestinationEventBridgeDestination:
		val_ := val.(SesConfigurationSetEventDestinationEventDestinationEventBridgeDestination)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *SesConfigurationSetEventDestinationEventDestinationEventBridgeDestination; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_SesConfigurationSetEventDestinationEventDestinationEventBridgeDestinationOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewSesConfigurationSetEventDestinationEventDestinationEventBridgeDestinationOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
