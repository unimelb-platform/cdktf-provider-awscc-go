...
func (j *jsiiProxy_MedialiveMultiplexMultiplexSettingsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_MedialiveMultiplexMultiplexSettingsOutputReference)SetInternalValue(val interface{}) {
