...
type AppflowConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSapoDataOutputReference interface {
	...
	OAuthPropertiesInput() interface{}
	PortNumber() *float64
	...
	ResetApplicationHostUrl()
	ResetApplicationServicePath()
	ResetClientNumber()
	ResetLogonLanguage()
...
func (j *jsiiProxy_AppflowConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSapoDataOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_AppflowConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSapoDataOutputReference) OAuthPropertiesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func NewAppflowConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSapoDataOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) AppflowConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSapoDataOutputReference {
	...
	_jsii_.Create(
		"awscc.appflowConnectorProfile.AppflowConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSapoDataOutputReference",
...
func (j *jsiiProxy_AppflowConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSapoDataOutputReference)SetInternalValue(val interface{}) {
...
func (a *jsiiProxy_AppflowConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSapoDataOutputReference) ResetApplicationHostUrl() {
	_jsii_.InvokeVoid(
		a,
		"resetApplicationHostUrl",
		nil, // no parameters
...
func (a *jsiiProxy_AppflowConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSapoDataOutputReference) ResetApplicationServicePath() {
	_jsii_.InvokeVoid(
		a,
		"resetApplicationServicePath",
		nil, // no parameters
...
func (a *jsiiProxy_AppflowConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSapoDataOutputReference) ResetClientNumber() {
	_jsii_.InvokeVoid(
		a,
		"resetClientNumber",
		nil, // no parameters
...
func (a *jsiiProxy_AppflowConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSapoDataOutputReference) ResetPortNumber() {
	_jsii_.InvokeVoid(
		a,
		"resetPortNumber",
		nil, // no parameters
