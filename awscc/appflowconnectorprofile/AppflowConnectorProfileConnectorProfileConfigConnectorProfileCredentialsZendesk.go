...
type AppflowConnectorProfileConnectorProfileConfigConnectorProfileCredentialsZendesk struct {
	...
	ConnectorOAuthRequest *AppflowConnectorProfileConnectorProfileConfigConnectorProfileCredentialsZendeskConnectorOAuthRequest `field:"optional" json:"connectorOAuthRequest" yaml:"connectorOAuthRequest"`
}
