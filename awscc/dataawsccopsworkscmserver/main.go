...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccOpsworkscmServer)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccOpsworkscmServer.DataAwsccOpsworkscmServerConfig",
		reflect.TypeOf((*DataAwsccOpsworkscmServerConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccOpsworkscmServer.DataAwsccOpsworkscmServerEngineAttributes",
		reflect.TypeOf((*DataAwsccOpsworkscmServerEngineAttributes)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccOpsworkscmServer.DataAwsccOpsworkscmServerEngineAttributesList",
		reflect.TypeOf((*DataAwsccOpsworkscmServerEngineAttributesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccOpsworkscmServerEngineAttributesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccOpsworkscmServer.DataAwsccOpsworkscmServerTags",
		reflect.TypeOf((*DataAwsccOpsworkscmServerTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccOpsworkscmServer.DataAwsccOpsworkscmServerTagsList",
		reflect.TypeOf((*DataAwsccOpsworkscmServerTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccOpsworkscmServerTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
