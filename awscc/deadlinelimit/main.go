...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DeadlineLimit)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "amountRequirementName", GoGetter: "AmountRequirementName"},
			_jsii_.MemberProperty{JsiiProperty: "amountRequirementNameInput", GoGetter: "AmountRequirementNameInput"},
	...
	_jsii_.RegisterStruct(
		"awscc.deadlineLimit.DeadlineLimitConfig",
		reflect.TypeOf((*DeadlineLimitConfig)(nil)).Elem(),
	)
}
