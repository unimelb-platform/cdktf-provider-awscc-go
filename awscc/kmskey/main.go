...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetKeyPolicy", GoMethod: "ResetKeyPolicy"},
	...
	_jsii_.RegisterStruct(
		"awscc.kmsKey.KmsKeyConfig",
		reflect.TypeOf((*KmsKeyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.kmsKey.KmsKeyTags",
		reflect.TypeOf((*KmsKeyTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.kmsKey.KmsKeyTagsList",
		reflect.TypeOf((*KmsKeyTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*KmsKeyTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
