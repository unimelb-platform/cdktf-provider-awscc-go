...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/networkmanager_transit_gateway_peering awscc_networkmanager_transit_gateway_peering}.
...
func (j *jsiiProxy_NetworkmanagerTransitGatewayPeering) CreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdAt",
...
func (j *jsiiProxy_NetworkmanagerTransitGatewayPeering) PeeringId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"peeringId",
...
func (j *jsiiProxy_NetworkmanagerTransitGatewayPeering) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_NetworkmanagerTransitGatewayPeering) Tags() NetworkmanagerTransitGatewayPeeringTagsList {
	var returns NetworkmanagerTransitGatewayPeeringTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_NetworkmanagerTransitGatewayPeering) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/networkmanager_transit_gateway_peering awscc_networkmanager_transit_gateway_peering} Resource.
func NewNetworkmanagerTransitGatewayPeering(scope constructs.Construct, id *string, config *NetworkmanagerTransitGatewayPeeringConfig) NetworkmanagerTransitGatewayPeering {
	...
	_jsii_.Create(
		"awscc.networkmanagerTransitGatewayPeering.NetworkmanagerTransitGatewayPeering",
...
func (n *jsiiProxy_NetworkmanagerTransitGatewayPeering) PutTags(value interface{}) {
