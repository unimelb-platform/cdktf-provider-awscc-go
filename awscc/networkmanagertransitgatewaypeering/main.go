...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.networkmanagerTransitGatewayPeering.NetworkmanagerTransitGatewayPeeringConfig",
		reflect.TypeOf((*NetworkmanagerTransitGatewayPeeringConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.networkmanagerTransitGatewayPeering.NetworkmanagerTransitGatewayPeeringTags",
		reflect.TypeOf((*NetworkmanagerTransitGatewayPeeringTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.networkmanagerTransitGatewayPeering.NetworkmanagerTransitGatewayPeeringTagsList",
		reflect.TypeOf((*NetworkmanagerTransitGatewayPeeringTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkmanagerTransitGatewayPeeringTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
