...
func (c *jsiiProxy_CeAnomalySubscription) validatePutResourceTagsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*CeAnomalySubscriptionResourceTags:
		value := value.(*[]*CeAnomalySubscriptionResourceTags)
	...
	case []*CeAnomalySubscriptionResourceTags:
		value_ := value.([]*CeAnomalySubscriptionResourceTags)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*CeAnomalySubscriptionResourceTags; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_CeAnomalySubscription) validatePutSubscribersParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*CeAnomalySubscriptionSubscribers:
		value := value.(*[]*CeAnomalySubscriptionSubscribers)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*CeAnomalySubscriptionSubscribers:
		value_ := value.([]*CeAnomalySubscriptionSubscribers)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*CeAnomalySubscriptionSubscribers; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_CeAnomalySubscription) validateSetSubscriptionNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CeAnomalySubscription) validateSetThresholdExpressionParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
