...
func (d *jsiiProxy_DatabrewDatasetInputDataCatalogInputDefinitionTempDirectoryOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (d *jsiiProxy_DatabrewDatasetInputDataCatalogInputDefinitionTempDirectoryOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_DatabrewDatasetInputDataCatalogInputDefinitionTempDirectoryOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *DatabrewDatasetInputDataCatalogInputDefinitionTempDirectory:
		val := val.(*DatabrewDatasetInputDataCatalogInputDefinitionTempDirectory)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case DatabrewDatasetInputDataCatalogInputDefinitionTempDirectory:
		val_ := val.(DatabrewDatasetInputDataCatalogInputDefinitionTempDirectory)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *DatabrewDatasetInputDataCatalogInputDefinitionTempDirectory; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_DatabrewDatasetInputDataCatalogInputDefinitionTempDirectoryOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewDatabrewDatasetInputDataCatalogInputDefinitionTempDirectoryOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
