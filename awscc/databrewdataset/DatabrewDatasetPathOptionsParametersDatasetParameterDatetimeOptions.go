...
type DatabrewDatasetPathOptionsParametersDatasetParameterDatetimeOptions struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/databrew_dataset#locale_code DatabrewDataset#locale_code}
	LocaleCode *string `field:"optional" json:"localeCode" yaml:"localeCode"`
	// Timezone offset.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/databrew_dataset#timezone_offset DatabrewDataset#timezone_offset}
