...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.apigatewayDomainName.ApigatewayDomainNameConfig",
		reflect.TypeOf((*ApigatewayDomainNameConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.apigatewayDomainName.ApigatewayDomainNameEndpointConfiguration",
		reflect.TypeOf((*ApigatewayDomainNameEndpointConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.apigatewayDomainName.ApigatewayDomainNameEndpointConfigurationOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.apigatewayDomainName.ApigatewayDomainNameMutualTlsAuthentication",
	...
	_jsii_.RegisterStruct(
		"awscc.apigatewayDomainName.ApigatewayDomainNameTags",
		reflect.TypeOf((*ApigatewayDomainNameTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.apigatewayDomainName.ApigatewayDomainNameTagsList",
		reflect.TypeOf((*ApigatewayDomainNameTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ApigatewayDomainNameTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
