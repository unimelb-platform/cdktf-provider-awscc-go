...
func (j *jsiiProxy_ApigatewayDomainNameEndpointConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ApigatewayDomainNameEndpointConfigurationOutputReference)SetInternalValue(val interface{}) {
...
func (a *jsiiProxy_ApigatewayDomainNameEndpointConfigurationOutputReference) ResetTypes() {
	_jsii_.InvokeVoid(
		a,
		"resetTypes",
		nil, // no parameters
