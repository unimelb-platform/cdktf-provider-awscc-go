...
func (j *jsiiProxy_FsxDataRepositoryAssociationS3AutoExportPolicyOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_FsxDataRepositoryAssociationS3AutoExportPolicyOutputReference)SetInternalValue(val interface{}) {
