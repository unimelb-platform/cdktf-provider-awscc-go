...
func (j *jsiiProxy_FsxDataRepositoryAssociationS3AutoImportPolicyOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_FsxDataRepositoryAssociationS3AutoImportPolicyOutputReference)SetInternalValue(val interface{}) {
