...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.fsxDataRepositoryAssociation.FsxDataRepositoryAssociationConfig",
	...
	_jsii_.RegisterStruct(
		"awscc.fsxDataRepositoryAssociation.FsxDataRepositoryAssociationS3AutoExportPolicy",
		reflect.TypeOf((*FsxDataRepositoryAssociationS3AutoExportPolicy)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.fsxDataRepositoryAssociation.FsxDataRepositoryAssociationS3AutoExportPolicyOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.fsxDataRepositoryAssociation.FsxDataRepositoryAssociationS3AutoImportPolicy",
		reflect.TypeOf((*FsxDataRepositoryAssociationS3AutoImportPolicy)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.fsxDataRepositoryAssociation.FsxDataRepositoryAssociationS3AutoImportPolicyOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.fsxDataRepositoryAssociation.FsxDataRepositoryAssociationTags",
		reflect.TypeOf((*FsxDataRepositoryAssociationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.fsxDataRepositoryAssociation.FsxDataRepositoryAssociationTagsList",
		reflect.TypeOf((*FsxDataRepositoryAssociationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FsxDataRepositoryAssociationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
