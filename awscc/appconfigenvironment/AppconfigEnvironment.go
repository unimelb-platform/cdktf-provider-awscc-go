...
type AppconfigEnvironment interface {
	...
	Monitors() AppconfigEnvironmentMonitorsList
	...
	Tags() AppconfigEnvironmentTagsList
	TagsInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_AppconfigEnvironment) Monitors() AppconfigEnvironmentMonitorsList {
	var returns AppconfigEnvironmentMonitorsList
	_jsii_.Get(
		j,
		"monitors",
		&returns,
...
func (j *jsiiProxy_AppconfigEnvironment) MonitorsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"monitorsInput",
...
func (j *jsiiProxy_AppconfigEnvironment) Tags() AppconfigEnvironmentTagsList {
	var returns AppconfigEnvironmentTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (a *jsiiProxy_AppconfigEnvironment) PutMonitors(value interface{}) {
	if err := a.validatePutMonitorsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
...
func (a *jsiiProxy_AppconfigEnvironment) PutTags(value interface{}) {
...
func (a *jsiiProxy_AppconfigEnvironment) ResetMonitors() {
	_jsii_.InvokeVoid(
		a,
		"resetMonitors",
		nil, // no parameters
