...
func (d *jsiiProxy_DataAwsccSagemakerAppImageConfigKernelGatewayImageConfigKernelSpecsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
