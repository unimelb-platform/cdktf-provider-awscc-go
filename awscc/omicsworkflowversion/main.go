...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OmicsWorkflowVersion)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "definitionUriInput", GoGetter: "DefinitionUriInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "mainInput", GoGetter: "MainInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "parameterTemplateInput", GoGetter: "ParameterTemplateInput"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putParameterTemplate", GoMethod: "PutParameterTemplate"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetAccelerators", GoMethod: "ResetAccelerators"},
			_jsii_.MemberMethod{JsiiMethod: "resetDefinitionUri", GoMethod: "ResetDefinitionUri"},
			_jsii_.MemberMethod{JsiiMethod: "resetDescription", GoMethod: "ResetDescription"},
			_jsii_.MemberMethod{JsiiMethod: "resetEngine", GoMethod: "ResetEngine"},
			_jsii_.MemberMethod{JsiiMethod: "resetMain", GoMethod: "ResetMain"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetParameterTemplate", GoMethod: "ResetParameterTemplate"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetWorkflowBucketOwnerId", GoMethod: "ResetWorkflowBucketOwnerId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "workflowBucketOwnerIdInput", GoGetter: "WorkflowBucketOwnerIdInput"},
	...
	_jsii_.RegisterStruct(
		"awscc.omicsWorkflowVersion.OmicsWorkflowVersionConfig",
		reflect.TypeOf((*OmicsWorkflowVersionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.omicsWorkflowVersion.OmicsWorkflowVersionParameterTemplate",
		reflect.TypeOf((*OmicsWorkflowVersionParameterTemplate)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.omicsWorkflowVersion.OmicsWorkflowVersionParameterTemplateMap",
		reflect.TypeOf((*OmicsWorkflowVersionParameterTemplateMap)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OmicsWorkflowVersionParameterTemplateOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
