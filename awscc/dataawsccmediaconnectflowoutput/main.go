...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccMediaconnectFlowOutput)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccMediaconnectFlowOutput.DataAwsccMediaconnectFlowOutputConfig",
		reflect.TypeOf((*DataAwsccMediaconnectFlowOutputConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccMediaconnectFlowOutput.DataAwsccMediaconnectFlowOutputEncryption",
		reflect.TypeOf((*DataAwsccMediaconnectFlowOutputEncryption)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccMediaconnectFlowOutput.DataAwsccMediaconnectFlowOutputEncryptionOutputReference",
		reflect.TypeOf((*DataAwsccMediaconnectFlowOutputEncryptionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccMediaconnectFlowOutput.DataAwsccMediaconnectFlowOutputVpcInterfaceAttachment",
		reflect.TypeOf((*DataAwsccMediaconnectFlowOutputVpcInterfaceAttachment)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccMediaconnectFlowOutput.DataAwsccMediaconnectFlowOutputVpcInterfaceAttachmentOutputReference",
		reflect.TypeOf((*DataAwsccMediaconnectFlowOutputVpcInterfaceAttachmentOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
