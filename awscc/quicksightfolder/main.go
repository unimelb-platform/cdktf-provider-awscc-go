...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSharingModel", GoMethod: "ResetSharingModel"},
			_jsii_.MemberMethod{JsiiMethod: "resetTags", GoMethod: "ResetTags"},
			_jsii_.MemberProperty{JsiiProperty: "sharingModel", GoGetter: "SharingModel"},
			_jsii_.MemberProperty{JsiiProperty: "sharingModelInput", GoGetter: "SharingModelInput"},
	...
	_jsii_.RegisterStruct(
		"awscc.quicksightFolder.QuicksightFolderPermissions",
		reflect.TypeOf((*QuicksightFolderPermissions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.quicksightFolder.QuicksightFolderPermissionsList",
	...
	_jsii_.RegisterClass(
		"awscc.quicksightFolder.QuicksightFolderPermissionsOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.quicksightFolder.QuicksightFolderTags",
		reflect.TypeOf((*QuicksightFolderTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.quicksightFolder.QuicksightFolderTagsList",
		reflect.TypeOf((*QuicksightFolderTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*QuicksightFolderTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
