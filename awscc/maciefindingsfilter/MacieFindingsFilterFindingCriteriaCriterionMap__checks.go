...
func (m *jsiiProxy_MacieFindingsFilterFindingCriteriaCriterionMap) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_MacieFindingsFilterFindingCriteriaCriterionMap) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *map[string]*MacieFindingsFilterFindingCriteriaCriterion; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_MacieFindingsFilterFindingCriteriaCriterionMap) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewMacieFindingsFilterFindingCriteriaCriterionMapParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
