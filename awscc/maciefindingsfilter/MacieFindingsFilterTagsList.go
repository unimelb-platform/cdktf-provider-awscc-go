...
func (j *jsiiProxy_MacieFindingsFilterTagsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewMacieFindingsFilterTagsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MacieFindingsFilterTagsList {
	_init_.Initialize()
...
func NewMacieFindingsFilterTagsList_Override(m MacieFindingsFilterTagsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MacieFindingsFilterTagsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (m *jsiiProxy_MacieFindingsFilterTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MacieFindingsFilterTagsList) Resolve(_context cdktf.IResolveContext) interface{} {
