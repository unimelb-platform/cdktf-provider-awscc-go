...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MacieFindingsFilter)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*MacieFindingsFilterConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.macieFindingsFilter.MacieFindingsFilterFindingCriteria",
		reflect.TypeOf((*MacieFindingsFilterFindingCriteria)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.macieFindingsFilter.MacieFindingsFilterFindingCriteriaCriterion",
		reflect.TypeOf((*MacieFindingsFilterFindingCriteriaCriterion)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.macieFindingsFilter.MacieFindingsFilterFindingCriteriaCriterionMap",
		reflect.TypeOf((*MacieFindingsFilterFindingCriteriaCriterionMap)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MacieFindingsFilterFindingCriteriaCriterionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MacieFindingsFilterFindingCriteriaOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"awscc.macieFindingsFilter.MacieFindingsFilterTags",
		reflect.TypeOf((*MacieFindingsFilterTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.macieFindingsFilter.MacieFindingsFilterTagsList",
		reflect.TypeOf((*MacieFindingsFilterTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MacieFindingsFilterTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
