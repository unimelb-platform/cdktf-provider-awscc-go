...
func init() {
	_jsii_.RegisterClass(
		"awscc.ssoApplicationAssignment.SsoApplicationAssignment",
		reflect.TypeOf((*SsoApplicationAssignment)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_SsoApplicationAssignment{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.ssoApplicationAssignment.SsoApplicationAssignmentConfig",
		reflect.TypeOf((*SsoApplicationAssignmentConfig)(nil)).Elem(),
	)
}
