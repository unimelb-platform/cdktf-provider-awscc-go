...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/redshiftendpointauthorization/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/redshift_endpoint_authorization awscc_redshift_endpoint_authorization}.
...
func (j *jsiiProxy_RedshiftEndpointAuthorization) AllowedVpCs() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"allowedVpCs",
...
func (j *jsiiProxy_RedshiftEndpointAuthorization) AuthorizeTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"authorizeTime",
...
func (j *jsiiProxy_RedshiftEndpointAuthorization) ClusterStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterStatus",
...
func (j *jsiiProxy_RedshiftEndpointAuthorization) Force() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"force",
...
func (j *jsiiProxy_RedshiftEndpointAuthorization) ForceInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"forceInput",
...
func (j *jsiiProxy_RedshiftEndpointAuthorization) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/redshift_endpoint_authorization awscc_redshift_endpoint_authorization} Resource.
func NewRedshiftEndpointAuthorization(scope constructs.Construct, id *string, config *RedshiftEndpointAuthorizationConfig) RedshiftEndpointAuthorization {
	...
	_jsii_.Create(
		"awscc.redshiftEndpointAuthorization.RedshiftEndpointAuthorization",
...
func (j *jsiiProxy_RedshiftEndpointAuthorization)SetForce(val interface{}) {
...
func (r *jsiiProxy_RedshiftEndpointAuthorization) ResetForce() {
	_jsii_.InvokeVoid(
		r,
		"resetForce",
		nil, // no parameters
