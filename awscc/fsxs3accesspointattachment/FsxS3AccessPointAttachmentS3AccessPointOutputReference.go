...
type FsxS3AccessPointAttachmentS3AccessPointOutputReference interface {
	...
	VpcConfiguration() FsxS3AccessPointAttachmentS3AccessPointVpcConfigurationOutputReference
	...
	PutVpcConfiguration(value *FsxS3AccessPointAttachmentS3AccessPointVpcConfiguration)
	ResetPolicy()
...
func (j *jsiiProxy_FsxS3AccessPointAttachmentS3AccessPointOutputReference) Alias() *string {
	var returns *string
	_jsii_.Get(
		j,
		"alias",
...
func (j *jsiiProxy_FsxS3AccessPointAttachmentS3AccessPointOutputReference) ResourceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceArn",
...
func (j *jsiiProxy_FsxS3AccessPointAttachmentS3AccessPointOutputReference) VpcConfiguration() FsxS3AccessPointAttachmentS3AccessPointVpcConfigurationOutputReference {
...
func NewFsxS3AccessPointAttachmentS3AccessPointOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) FsxS3AccessPointAttachmentS3AccessPointOutputReference {
	_init_.Initialize()

	if err := validateNewFsxS3AccessPointAttachmentS3AccessPointOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_FsxS3AccessPointAttachmentS3AccessPointOutputReference{}

	_jsii_.Create(
		"awscc.fsxS3AccessPointAttachment.FsxS3AccessPointAttachmentS3AccessPointOutputReference",
...
func NewFsxS3AccessPointAttachmentS3AccessPointOutputReference_Override(f FsxS3AccessPointAttachmentS3AccessPointOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (f *jsiiProxy_FsxS3AccessPointAttachmentS3AccessPointOutputReference) PutVpcConfiguration(value *FsxS3AccessPointAttachmentS3AccessPointVpcConfiguration) {
