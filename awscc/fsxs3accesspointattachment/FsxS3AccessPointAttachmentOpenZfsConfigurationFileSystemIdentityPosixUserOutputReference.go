...
type FsxS3AccessPointAttachmentOpenZfsConfigurationFileSystemIdentityPosixUserOutputReference interface {
	...
	SecondaryGids() FsxS3AccessPointAttachmentOpenZfsConfigurationFileSystemIdentityPosixUserSecondaryGidsList
	SecondaryGidsInput() interface{}
	// Experimental.
	...
	PutSecondaryGids(value interface{})
	ResetSecondaryGids()
...
func (j *jsiiProxy_FsxS3AccessPointAttachmentOpenZfsConfigurationFileSystemIdentityPosixUserOutputReference) SecondaryGids() FsxS3AccessPointAttachmentOpenZfsConfigurationFileSystemIdentityPosixUserSecondaryGidsList {
	var returns FsxS3AccessPointAttachmentOpenZfsConfigurationFileSystemIdentityPosixUserSecondaryGidsList
	_jsii_.Get(
		j,
		"secondaryGids",
		&returns,
...
func (j *jsiiProxy_FsxS3AccessPointAttachmentOpenZfsConfigurationFileSystemIdentityPosixUserOutputReference) SecondaryGidsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"secondaryGidsInput",
...
func NewFsxS3AccessPointAttachmentOpenZfsConfigurationFileSystemIdentityPosixUserOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) FsxS3AccessPointAttachmentOpenZfsConfigurationFileSystemIdentityPosixUserOutputReference {
	_init_.Initialize()

	if err := validateNewFsxS3AccessPointAttachmentOpenZfsConfigurationFileSystemIdentityPosixUserOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewFsxS3AccessPointAttachmentOpenZfsConfigurationFileSystemIdentityPosixUserOutputReference_Override(f FsxS3AccessPointAttachmentOpenZfsConfigurationFileSystemIdentityPosixUserOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (f *jsiiProxy_FsxS3AccessPointAttachmentOpenZfsConfigurationFileSystemIdentityPosixUserOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FsxS3AccessPointAttachmentOpenZfsConfigurationFileSystemIdentityPosixUserOutputReference) PutSecondaryGids(value interface{}) {
	if err := f.validatePutSecondaryGidsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		f,
...
func (f *jsiiProxy_FsxS3AccessPointAttachmentOpenZfsConfigurationFileSystemIdentityPosixUserOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
