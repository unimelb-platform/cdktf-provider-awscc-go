...
func init() {
	_jsii_.RegisterClass(
		"awscc.docdbelasticCluster.DocdbelasticCluster",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetShardInstanceCount", GoMethod: "ResetShardInstanceCount"},
			...
			_jsii_.MemberProperty{JsiiProperty: "shardInstanceCountInput", GoGetter: "ShardInstanceCountInput"},
	...
	_jsii_.RegisterStruct(
		"awscc.docdbelasticCluster.DocdbelasticClusterConfig",
		reflect.TypeOf((*DocdbelasticClusterConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.docdbelasticCluster.DocdbelasticClusterTags",
		reflect.TypeOf((*DocdbelasticClusterTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.docdbelasticCluster.DocdbelasticClusterTagsList",
		reflect.TypeOf((*DocdbelasticClusterTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DocdbelasticClusterTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
