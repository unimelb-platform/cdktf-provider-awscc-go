...
func (j *jsiiProxy_DocdbelasticCluster) ClusterArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterArn",
...
func (j *jsiiProxy_DocdbelasticCluster) ClusterEndpoint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterEndpoint",
...
func (j *jsiiProxy_DocdbelasticCluster) ClusterName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterName",
...
func (j *jsiiProxy_DocdbelasticCluster) ClusterNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterNameInput",
...
func (j *jsiiProxy_DocdbelasticCluster) Tags() DocdbelasticClusterTagsList {
	var returns DocdbelasticClusterTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_DocdbelasticCluster) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_DocdbelasticCluster)SetClusterName(val *string) {
...
func (d *jsiiProxy_DocdbelasticCluster) PutTags(value interface{}) {
...
func (d *jsiiProxy_DocdbelasticCluster) ResetAdminUserPassword() {
	_jsii_.InvokeVoid(
		d,
		"resetAdminUserPassword",
		nil, // no parameters
