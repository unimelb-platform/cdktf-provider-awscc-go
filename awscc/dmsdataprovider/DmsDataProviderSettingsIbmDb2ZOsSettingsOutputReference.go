...
func (j *jsiiProxy_DmsDataProviderSettingsIbmDb2ZOsSettingsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDmsDataProviderSettingsIbmDb2ZOsSettingsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DmsDataProviderSettingsIbmDb2ZOsSettingsOutputReference {
	_init_.Initialize()

	if err := validateNewDmsDataProviderSettingsIbmDb2ZOsSettingsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DmsDataProviderSettingsIbmDb2ZOsSettingsOutputReference{}

	_jsii_.Create(
		"awscc.dmsDataProvider.DmsDataProviderSettingsIbmDb2ZOsSettingsOutputReference",
...
func NewDmsDataProviderSettingsIbmDb2ZOsSettingsOutputReference_Override(d DmsDataProviderSettingsIbmDb2ZOsSettingsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DmsDataProviderSettingsIbmDb2ZOsSettingsOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DmsDataProviderSettingsIbmDb2ZOsSettingsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DmsDataProviderSettingsIbmDb2ZOsSettingsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (d *jsiiProxy_DmsDataProviderSettingsIbmDb2ZOsSettingsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DmsDataProviderSettingsIbmDb2ZOsSettingsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
