...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.gameliftScript.GameliftScriptConfig",
		reflect.TypeOf((*GameliftScriptConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.gameliftScript.GameliftScriptStorageLocation",
		reflect.TypeOf((*GameliftScriptStorageLocation)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.gameliftScript.GameliftScriptStorageLocationOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.gameliftScript.GameliftScriptTags",
		reflect.TypeOf((*GameliftScriptTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.gameliftScript.GameliftScriptTagsList",
		reflect.TypeOf((*GameliftScriptTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GameliftScriptTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
