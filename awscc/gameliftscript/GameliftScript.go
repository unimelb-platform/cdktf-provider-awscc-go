...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/gamelift_script awscc_gamelift_script}.
...
func (j *jsiiProxy_GameliftScript) CreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creationTime",
...
func (j *jsiiProxy_GameliftScript) ScriptId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scriptId",
...
func (j *jsiiProxy_GameliftScript) SizeOnDisk() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"sizeOnDisk",
...
func (j *jsiiProxy_GameliftScript) StorageLocationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GameliftScript) Tags() GameliftScriptTagsList {
	var returns GameliftScriptTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_GameliftScript) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/gamelift_script awscc_gamelift_script} Resource.
func NewGameliftScript(scope constructs.Construct, id *string, config *GameliftScriptConfig) GameliftScript {
	...
	_jsii_.Create(
		"awscc.gameliftScript.GameliftScript",
...
func (g *jsiiProxy_GameliftScript) PutTags(value interface{}) {
...
func (g *jsiiProxy_GameliftScript) ResetName() {
	_jsii_.InvokeVoid(
		g,
		"resetName",
		nil, // no parameters
