...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.apigatewayDocumentationPart.ApigatewayDocumentationPartConfig",
		reflect.TypeOf((*ApigatewayDocumentationPartConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.apigatewayDocumentationPart.ApigatewayDocumentationPartLocation",
		reflect.TypeOf((*ApigatewayDocumentationPartLocation)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.apigatewayDocumentationPart.ApigatewayDocumentationPartLocationOutputReference",
