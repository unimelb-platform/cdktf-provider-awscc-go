...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/apigatewaydocumentationpart/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigateway_documentation_part awscc_apigateway_documentation_part}.
...
func (j *jsiiProxy_ApigatewayDocumentationPart) LocationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"locationInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigateway_documentation_part awscc_apigateway_documentation_part} Resource.
func NewApigatewayDocumentationPart(scope constructs.Construct, id *string, config *ApigatewayDocumentationPartConfig) ApigatewayDocumentationPart {
	...
	_jsii_.Create(
		"awscc.apigatewayDocumentationPart.ApigatewayDocumentationPart",
