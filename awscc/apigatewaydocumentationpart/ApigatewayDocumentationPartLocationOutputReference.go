...
func (j *jsiiProxy_ApigatewayDocumentationPartLocationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ApigatewayDocumentationPartLocationOutputReference)SetInternalValue(val interface{}) {
...
func (a *jsiiProxy_ApigatewayDocumentationPartLocationOutputReference) ResetType() {
	_jsii_.InvokeVoid(
		a,
		"resetType",
		nil, // no parameters
