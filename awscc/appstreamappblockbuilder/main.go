...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AppstreamAppBlockBuilder)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "appBlockArnsInput", GoGetter: "AppBlockArnsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAppBlockArns", GoMethod: "ResetAppBlockArns"},
	...
	_jsii_.RegisterStruct(
		"awscc.appstreamAppBlockBuilder.AppstreamAppBlockBuilderAccessEndpoints",
		reflect.TypeOf((*AppstreamAppBlockBuilderAccessEndpoints)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.appstreamAppBlockBuilder.AppstreamAppBlockBuilderAccessEndpointsList",
		reflect.TypeOf((*AppstreamAppBlockBuilderAccessEndpointsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AppstreamAppBlockBuilderAccessEndpointsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*AppstreamAppBlockBuilderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.appstreamAppBlockBuilder.AppstreamAppBlockBuilderTags",
		reflect.TypeOf((*AppstreamAppBlockBuilderTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.appstreamAppBlockBuilder.AppstreamAppBlockBuilderTagsList",
		reflect.TypeOf((*AppstreamAppBlockBuilderTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AppstreamAppBlockBuilderTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"awscc.appstreamAppBlockBuilder.AppstreamAppBlockBuilderVpcConfig",
		reflect.TypeOf((*AppstreamAppBlockBuilderVpcConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.appstreamAppBlockBuilder.AppstreamAppBlockBuilderVpcConfigOutputReference",
		reflect.TypeOf((*AppstreamAppBlockBuilderVpcConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
