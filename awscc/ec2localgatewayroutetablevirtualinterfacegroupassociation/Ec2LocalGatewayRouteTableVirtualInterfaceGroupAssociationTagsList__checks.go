...
func (e *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociationTagsList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociationTagsList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociationTags; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociationTagsList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewEc2LocalGatewayRouteTableVirtualInterfaceGroupAssociationTagsListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
