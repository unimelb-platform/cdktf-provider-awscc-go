...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/ecrregistrypolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/ecr_registry_policy awscc_ecr_registry_policy}.
...
func (j *jsiiProxy_EcrRegistryPolicy) PolicyText() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyText",
...
func (j *jsiiProxy_EcrRegistryPolicy) PolicyTextInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyTextInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/ecr_registry_policy awscc_ecr_registry_policy} Resource.
func NewEcrRegistryPolicy(scope constructs.Construct, id *string, config *EcrRegistryPolicyConfig) EcrRegistryPolicy {
	...
	_jsii_.Create(
		"awscc.ecrRegistryPolicy.EcrRegistryPolicy",
...
func (j *jsiiProxy_EcrRegistryPolicy)SetPolicyText(val *string) {
