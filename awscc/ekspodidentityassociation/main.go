...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.eksPodIdentityAssociation.EksPodIdentityAssociationConfig",
		reflect.TypeOf((*EksPodIdentityAssociationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.eksPodIdentityAssociation.EksPodIdentityAssociationTags",
		reflect.TypeOf((*EksPodIdentityAssociationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.eksPodIdentityAssociation.EksPodIdentityAssociationTagsList",
		reflect.TypeOf((*EksPodIdentityAssociationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EksPodIdentityAssociationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
