...
type VerifiedpermissionsPolicyStore interface {
	...
	ValidationSettings() VerifiedpermissionsPolicyStoreValidationSettingsOutputReference
...
func (j *jsiiProxy_VerifiedpermissionsPolicyStore) Schema() VerifiedpermissionsPolicyStoreSchemaOutputReference {
	var returns VerifiedpermissionsPolicyStoreSchemaOutputReference
	_jsii_.Get(
		j,
		"schema",
		&returns,
...
func (j *jsiiProxy_VerifiedpermissionsPolicyStore) SchemaInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"schemaInput",
...
func (j *jsiiProxy_VerifiedpermissionsPolicyStore) ValidationSettings() VerifiedpermissionsPolicyStoreValidationSettingsOutputReference {
...
func (v *jsiiProxy_VerifiedpermissionsPolicyStore) PutValidationSettings(value *VerifiedpermissionsPolicyStoreValidationSettings) {
...
func (v *jsiiProxy_VerifiedpermissionsPolicyStore) ResetSchema() {
	_jsii_.InvokeVoid(
		v,
		"resetSchema",
		nil, // no parameters
