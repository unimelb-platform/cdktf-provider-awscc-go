...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LogsQueryDefinition)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "queryLanguageInput", GoGetter: "QueryLanguageInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetQueryLanguage", GoMethod: "ResetQueryLanguage"},
	...
	_jsii_.RegisterStruct(
		"awscc.logsQueryDefinition.LogsQueryDefinitionConfig",
		reflect.TypeOf((*LogsQueryDefinitionConfig)(nil)).Elem(),
	)
}
