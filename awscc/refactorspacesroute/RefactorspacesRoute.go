...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/refactorspaces_route awscc_refactorspaces_route}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/refactorspaces_route awscc_refactorspaces_route} Resource.
...
func (r *jsiiProxy_RefactorspacesRoute) HasResourceMove() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_RefactorspacesRoute) MoveFromId(id *string) {
...
func (r *jsiiProxy_RefactorspacesRoute) MoveToId(id *string) {
...
func (r *jsiiProxy_RefactorspacesRoute) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_RefactorspacesRoute) ToHclTerraform() interface{} {
	var returns interface{}
