...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudformationTypeActivation)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "publicTypeArnInput", GoGetter: "PublicTypeArnInput"},
			_jsii_.MemberProperty{JsiiProperty: "publisherId", GoGetter: "PublisherId"},
			_jsii_.MemberProperty{JsiiProperty: "publisherIdInput", GoGetter: "PublisherIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMajorVersion", GoMethod: "ResetMajorVersion"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetPublicTypeArn", GoMethod: "ResetPublicTypeArn"},
			_jsii_.MemberMethod{JsiiMethod: "resetPublisherId", GoMethod: "ResetPublisherId"},
			_jsii_.MemberMethod{JsiiMethod: "resetType", GoMethod: "ResetType"},
			_jsii_.MemberMethod{JsiiMethod: "resetTypeName", GoMethod: "ResetTypeName"},
			_jsii_.MemberMethod{JsiiMethod: "resetTypeNameAlias", GoMethod: "ResetTypeNameAlias"},
			_jsii_.MemberMethod{JsiiMethod: "resetVersionBump", GoMethod: "ResetVersionBump"},
			...
			_jsii_.MemberProperty{JsiiProperty: "typeNameAliasInput", GoGetter: "TypeNameAliasInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "versionBumpInput", GoGetter: "VersionBumpInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		"awscc.cloudformationTypeActivation.CloudformationTypeActivationConfig",
		reflect.TypeOf((*CloudformationTypeActivationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.cloudformationTypeActivation.CloudformationTypeActivationLoggingConfig",
		reflect.TypeOf((*CloudformationTypeActivationLoggingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.cloudformationTypeActivation.CloudformationTypeActivationLoggingConfigOutputReference",
		reflect.TypeOf((*CloudformationTypeActivationLoggingConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
