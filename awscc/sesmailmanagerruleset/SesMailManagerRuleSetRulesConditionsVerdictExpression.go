...
type SesMailManagerRuleSetRulesConditionsVerdictExpression struct {
	...
	Evaluate *SesMailManagerRuleSetRulesConditionsVerdictExpressionEvaluate `field:"optional" json:"evaluate" yaml:"evaluate"`
