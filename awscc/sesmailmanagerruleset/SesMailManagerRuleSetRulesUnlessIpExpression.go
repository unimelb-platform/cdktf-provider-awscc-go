...
type SesMailManagerRuleSetRulesUnlessIpExpression struct {
	...
	Evaluate *SesMailManagerRuleSetRulesUnlessIpExpressionEvaluate `field:"optional" json:"evaluate" yaml:"evaluate"`
