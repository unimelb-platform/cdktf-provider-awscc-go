...
type SesMailManagerRuleSetRulesUnlessStringExpression struct {
	...
	Evaluate *SesMailManagerRuleSetRulesUnlessStringExpressionEvaluate `field:"optional" json:"evaluate" yaml:"evaluate"`
