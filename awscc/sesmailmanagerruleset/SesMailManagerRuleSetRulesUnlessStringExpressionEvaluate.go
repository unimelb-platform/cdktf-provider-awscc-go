...
type SesMailManagerRuleSetRulesUnlessStringExpressionEvaluate struct {
	...
	Analysis *SesMailManagerRuleSetRulesUnlessStringExpressionEvaluateAnalysis `field:"optional" json:"analysis" yaml:"analysis"`
