...
type SesMailManagerRuleSetRulesUnlessVerdictExpression struct {
	...
	Evaluate *SesMailManagerRuleSetRulesUnlessVerdictExpressionEvaluate `field:"optional" json:"evaluate" yaml:"evaluate"`
