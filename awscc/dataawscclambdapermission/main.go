...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccLambdaPermission)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "permissionId", GoGetter: "PermissionId"},
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccLambdaPermission.DataAwsccLambdaPermissionConfig",
		reflect.TypeOf((*DataAwsccLambdaPermissionConfig)(nil)).Elem(),
	)
}
