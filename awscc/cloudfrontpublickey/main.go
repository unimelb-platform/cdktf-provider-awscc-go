...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "publicKeyConfigInput", GoGetter: "PublicKeyConfigInput"},
			_jsii_.MemberMethod{JsiiMethod: "putPublicKeyConfig", GoMethod: "PutPublicKeyConfig"},
	...
	_jsii_.RegisterStruct(
		"awscc.cloudfrontPublicKey.CloudfrontPublicKeyConfig",
		reflect.TypeOf((*CloudfrontPublicKeyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.cloudfrontPublicKey.CloudfrontPublicKeyPublicKeyConfig",
		reflect.TypeOf((*CloudfrontPublicKeyPublicKeyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.cloudfrontPublicKey.CloudfrontPublicKeyPublicKeyConfigOutputReference",
		reflect.TypeOf((*CloudfrontPublicKeyPublicKeyConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "callerReference", GoGetter: "CallerReference"},
			_jsii_.MemberProperty{JsiiProperty: "callerReferenceInput", GoGetter: "CallerReferenceInput"},
		...
		func() interface{} {
			j := jsiiProxy_CloudfrontPublicKeyPublicKeyConfigOutputReference{}
