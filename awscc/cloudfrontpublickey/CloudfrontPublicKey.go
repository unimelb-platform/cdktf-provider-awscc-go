...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/cloudfrontpublickey/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/cloudfront_public_key awscc_cloudfront_public_key}.
type CloudfrontPublicKey interface {
	...
	PublicKeyConfig() CloudfrontPublicKeyPublicKeyConfigOutputReference
	PublicKeyConfigInput() interface{}
	PublicKeyId() *string
	// Experimental.
	...
	PutPublicKeyConfig(value *CloudfrontPublicKeyPublicKeyConfig)
...
func (j *jsiiProxy_CloudfrontPublicKey) CreatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdTime",
...
func (j *jsiiProxy_CloudfrontPublicKey) PublicKeyConfig() CloudfrontPublicKeyPublicKeyConfigOutputReference {
	var returns CloudfrontPublicKeyPublicKeyConfigOutputReference
	_jsii_.Get(
		j,
		"publicKeyConfig",
		&returns,
...
func (j *jsiiProxy_CloudfrontPublicKey) PublicKeyConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"publicKeyConfigInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CloudfrontPublicKey) PublicKeyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"publicKeyId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/cloudfront_public_key awscc_cloudfront_public_key} Resource.
func NewCloudfrontPublicKey(scope constructs.Construct, id *string, config *CloudfrontPublicKeyConfig) CloudfrontPublicKey {
	...
	_jsii_.Create(
		"awscc.cloudfrontPublicKey.CloudfrontPublicKey",
...
func (c *jsiiProxy_CloudfrontPublicKey) PutPublicKeyConfig(value *CloudfrontPublicKeyPublicKeyConfig) {
	if err := c.validatePutPublicKeyConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
