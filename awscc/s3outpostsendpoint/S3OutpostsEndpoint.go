...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/s3outposts_endpoint awscc_s3outposts_endpoint}.
type S3OutpostsEndpoint interface {
	...
	EndpointId() *string
	FailedReason() S3OutpostsEndpointFailedReasonOutputReference
	FailedReasonInput() interface{}
	// Experimental.
	...
	PutFailedReason(value *S3OutpostsEndpointFailedReason)
	ResetAccessType()
...
func (j *jsiiProxy_S3OutpostsEndpoint) EndpointId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"endpointId",
...
func (j *jsiiProxy_S3OutpostsEndpoint) FailedReason() S3OutpostsEndpointFailedReasonOutputReference {
	var returns S3OutpostsEndpointFailedReasonOutputReference
	_jsii_.Get(
		j,
		"failedReason",
		&returns,
...
func (j *jsiiProxy_S3OutpostsEndpoint) FailedReasonInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"failedReasonInput",
...
func (j *jsiiProxy_S3OutpostsEndpoint) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/s3outposts_endpoint awscc_s3outposts_endpoint} Resource.
func NewS3OutpostsEndpoint(scope constructs.Construct, id *string, config *S3OutpostsEndpointConfig) S3OutpostsEndpoint {
	...
	_jsii_.Create(
		"awscc.s3OutpostsEndpoint.S3OutpostsEndpoint",
...
func (s *jsiiProxy_S3OutpostsEndpoint) PutFailedReason(value *S3OutpostsEndpointFailedReason) {
	if err := s.validatePutFailedReasonParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_S3OutpostsEndpoint) ResetFailedReason() {
	_jsii_.InvokeVoid(
		s,
		"resetFailedReason",
		nil, // no parameters
