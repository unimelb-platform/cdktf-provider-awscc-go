...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/organizations_policy awscc_organizations_policy}.
...
func (j *jsiiProxy_OrganizationsPolicy) AwsManaged() cdktf.IResolvable {
...
func (j *jsiiProxy_OrganizationsPolicy) PolicyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyId",
...
func (j *jsiiProxy_OrganizationsPolicy) Tags() OrganizationsPolicyTagsList {
	var returns OrganizationsPolicyTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_OrganizationsPolicy) TargetIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"targetIds",
...
func (j *jsiiProxy_OrganizationsPolicy) TargetIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"targetIdsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/organizations_policy awscc_organizations_policy} Resource.
func NewOrganizationsPolicy(scope constructs.Construct, id *string, config *OrganizationsPolicyConfig) OrganizationsPolicy {
	...
	_jsii_.Create(
		"awscc.organizationsPolicy.OrganizationsPolicy",
...
func (j *jsiiProxy_OrganizationsPolicy)SetTargetIds(val *[]*string) {
...
func (o *jsiiProxy_OrganizationsPolicy) PutTags(value interface{}) {
...
func (o *jsiiProxy_OrganizationsPolicy) ResetTargetIds() {
	_jsii_.InvokeVoid(
		o,
		"resetTargetIds",
		nil, // no parameters
