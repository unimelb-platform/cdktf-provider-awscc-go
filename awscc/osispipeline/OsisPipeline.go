...
type OsisPipeline interface {
	...
	EncryptionAtRestOptions() OsisPipelineEncryptionAtRestOptionsOutputReference
	...
	LogPublishingOptions() OsisPipelineLogPublishingOptionsOutputReference
	...
	PutBufferOptions(value *OsisPipelineBufferOptions)
	PutEncryptionAtRestOptions(value *OsisPipelineEncryptionAtRestOptions)
	PutLogPublishingOptions(value *OsisPipelineLogPublishingOptions)
	PutTags(value interface{})
	PutVpcOptions(value *OsisPipelineVpcOptions)
	ResetBufferOptions()
...
func (j *jsiiProxy_OsisPipeline) BufferOptions() OsisPipelineBufferOptionsOutputReference {
...
func (j *jsiiProxy_OsisPipeline) EncryptionAtRestOptions() OsisPipelineEncryptionAtRestOptionsOutputReference {
...
func (j *jsiiProxy_OsisPipeline) LogPublishingOptions() OsisPipelineLogPublishingOptionsOutputReference {
...
func (j *jsiiProxy_OsisPipeline) Tags() OsisPipelineTagsList {
	var returns OsisPipelineTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_OsisPipeline) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_OsisPipeline) VpcEndpoints() OsisPipelineVpcEndpointsList {
	var returns OsisPipelineVpcEndpointsList
	_jsii_.Get(
		j,
		"vpcEndpoints",
		&returns,
...
func (o *jsiiProxy_OsisPipeline) PutBufferOptions(value *OsisPipelineBufferOptions) {
...
func (o *jsiiProxy_OsisPipeline) PutEncryptionAtRestOptions(value *OsisPipelineEncryptionAtRestOptions) {
...
func (o *jsiiProxy_OsisPipeline) PutLogPublishingOptions(value *OsisPipelineLogPublishingOptions) {
...
func (o *jsiiProxy_OsisPipeline) PutTags(value interface{}) {
...
func (o *jsiiProxy_OsisPipeline) PutVpcOptions(value *OsisPipelineVpcOptions) {
