...
type OsisPipelineLogPublishingOptionsOutputReference interface {
	cdktf.ComplexObject
	CloudwatchLogDestination() OsisPipelineLogPublishingOptionsCloudwatchLogDestinationOutputReference
	...
	PutCloudwatchLogDestination(value *OsisPipelineLogPublishingOptionsCloudwatchLogDestination)
...
func (j *jsiiProxy_OsisPipelineLogPublishingOptionsOutputReference) CloudwatchLogDestination() OsisPipelineLogPublishingOptionsCloudwatchLogDestinationOutputReference {
...
func NewOsisPipelineLogPublishingOptionsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) OsisPipelineLogPublishingOptionsOutputReference {
	_init_.Initialize()

	if err := validateNewOsisPipelineLogPublishingOptionsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewOsisPipelineLogPublishingOptionsOutputReference_Override(o OsisPipelineLogPublishingOptionsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (o *jsiiProxy_OsisPipelineLogPublishingOptionsOutputReference) PutCloudwatchLogDestination(value *OsisPipelineLogPublishingOptionsCloudwatchLogDestination) {
