...
func (j *jsiiProxy_ImagebuilderContainerRecipeTargetRepositoryOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *ImagebuilderContainerRecipeTargetRepository:
		val := val.(*ImagebuilderContainerRecipeTargetRepository)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case ImagebuilderContainerRecipeTargetRepository:
		val_ := val.(ImagebuilderContainerRecipeTargetRepository)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *ImagebuilderContainerRecipeTargetRepository; received %#v (a %T)", val, val)
		}
	}
