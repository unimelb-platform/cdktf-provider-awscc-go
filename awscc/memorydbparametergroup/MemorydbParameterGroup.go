...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/memorydb_parameter_group awscc_memorydb_parameter_group}.
...
func (j *jsiiProxy_MemorydbParameterGroup) ParameterGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parameterGroupName",
...
func (j *jsiiProxy_MemorydbParameterGroup) ParameterGroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MemorydbParameterGroup) Parameters() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parameters",
...
func (j *jsiiProxy_MemorydbParameterGroup) ParametersInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parametersInput",
...
func (j *jsiiProxy_MemorydbParameterGroup) Tags() MemorydbParameterGroupTagsList {
	var returns MemorydbParameterGroupTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_MemorydbParameterGroup) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/memorydb_parameter_group awscc_memorydb_parameter_group} Resource.
func NewMemorydbParameterGroup(scope constructs.Construct, id *string, config *MemorydbParameterGroupConfig) MemorydbParameterGroup {
	...
	_jsii_.Create(
		"awscc.memorydbParameterGroup.MemorydbParameterGroup",
...
func (j *jsiiProxy_MemorydbParameterGroup)SetParameterGroupName(val *string) {
...
func (j *jsiiProxy_MemorydbParameterGroup)SetParameters(val *string) {
...
func (m *jsiiProxy_MemorydbParameterGroup) PutTags(value interface{}) {
...
func (m *jsiiProxy_MemorydbParameterGroup) ResetParameters() {
	_jsii_.InvokeVoid(
		m,
		"resetParameters",
		nil, // no parameters
