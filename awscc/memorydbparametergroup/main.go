...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.memorydbParameterGroup.MemorydbParameterGroupConfig",
		reflect.TypeOf((*MemorydbParameterGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.memorydbParameterGroup.MemorydbParameterGroupTags",
		reflect.TypeOf((*MemorydbParameterGroupTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.memorydbParameterGroup.MemorydbParameterGroupTagsList",
		reflect.TypeOf((*MemorydbParameterGroupTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MemorydbParameterGroupTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
