...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LambdaUrl)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "targetFunctionArnInput", GoGetter: "TargetFunctionArnInput"},
	...
	_jsii_.RegisterStruct(
		"awscc.lambdaUrl.LambdaUrlConfig",
		reflect.TypeOf((*LambdaUrlConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.lambdaUrl.LambdaUrlCors",
		reflect.TypeOf((*LambdaUrlCors)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.lambdaUrl.LambdaUrlCorsOutputReference",
		reflect.TypeOf((*LambdaUrlCorsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
