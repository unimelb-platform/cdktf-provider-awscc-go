...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SupportappSlackWorkspaceConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.supportappSlackWorkspaceConfiguration.SupportappSlackWorkspaceConfigurationConfig",
		reflect.TypeOf((*SupportappSlackWorkspaceConfigurationConfig)(nil)).Elem(),
	)
}
