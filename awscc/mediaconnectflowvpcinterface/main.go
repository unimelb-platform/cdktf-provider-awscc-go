...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MediaconnectFlowVpcInterface)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.mediaconnectFlowVpcInterface.MediaconnectFlowVpcInterfaceConfig",
		reflect.TypeOf((*MediaconnectFlowVpcInterfaceConfig)(nil)).Elem(),
	)
}
