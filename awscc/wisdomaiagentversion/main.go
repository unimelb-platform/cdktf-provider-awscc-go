...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WisdomAiAgentVersion)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "aiAgentIdInput", GoGetter: "AiAgentIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "aiAgentVersionId", GoGetter: "AiAgentVersionId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*WisdomAiAgentVersionConfig)(nil)).Elem(),
	)
}
