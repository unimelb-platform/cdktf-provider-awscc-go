...
func (j *jsiiProxy_CeCostCategory) Rules() *string {
	var returns *string
	_jsii_.Get(
		j,
		"rules",
...
func (j *jsiiProxy_CeCostCategory) RulesInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"rulesInput",
...
func (j *jsiiProxy_CeCostCategory) SplitChargeRules() *string {
	var returns *string
	_jsii_.Get(
		j,
		"splitChargeRules",
...
func (j *jsiiProxy_CeCostCategory) SplitChargeRulesInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"splitChargeRulesInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_CeCostCategory)SetRules(val *string) {
...
func (j *jsiiProxy_CeCostCategory)SetSplitChargeRules(val *string) {
	if err := j.validateSetSplitChargeRulesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (c *jsiiProxy_CeCostCategory) ResetSplitChargeRules() {
	_jsii_.InvokeVoid(
		c,
		"resetSplitChargeRules",
		nil, // no parameters
