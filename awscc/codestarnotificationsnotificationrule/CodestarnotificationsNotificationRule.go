...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/codestarnotifications_notification_rule awscc_codestarnotifications_notification_rule}.
...
func (j *jsiiProxy_CodestarnotificationsNotificationRule) CreatedBy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdBy",
...
func (j *jsiiProxy_CodestarnotificationsNotificationRule) CreatedByInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdByInput",
...
func (j *jsiiProxy_CodestarnotificationsNotificationRule) EventTypeId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"eventTypeId",
...
func (j *jsiiProxy_CodestarnotificationsNotificationRule) EventTypeIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"eventTypeIdInput",
...
func (j *jsiiProxy_CodestarnotificationsNotificationRule) TargetAddress() *string {
	var returns *string
	_jsii_.Get(
		j,
		"targetAddress",
...
func (j *jsiiProxy_CodestarnotificationsNotificationRule) TargetAddressInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"targetAddressInput",
...
func (j *jsiiProxy_CodestarnotificationsNotificationRule) Targets() CodestarnotificationsNotificationRuleTargetsList {
	var returns CodestarnotificationsNotificationRuleTargetsList
	_jsii_.Get(
		j,
		"targets",
		&returns,
...
func (j *jsiiProxy_CodestarnotificationsNotificationRule) TargetsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"targetsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/codestarnotifications_notification_rule awscc_codestarnotifications_notification_rule} Resource.
func NewCodestarnotificationsNotificationRule(scope constructs.Construct, id *string, config *CodestarnotificationsNotificationRuleConfig) CodestarnotificationsNotificationRule {
	...
	_jsii_.Create(
		"awscc.codestarnotificationsNotificationRule.CodestarnotificationsNotificationRule",
...
func (j *jsiiProxy_CodestarnotificationsNotificationRule)SetCreatedBy(val *string) {
...
func (j *jsiiProxy_CodestarnotificationsNotificationRule)SetEventTypeId(val *string) {
	if err := j.validateSetEventTypeIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CodestarnotificationsNotificationRule)SetTargetAddress(val *string) {
	if err := j.validateSetTargetAddressParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (c *jsiiProxy_CodestarnotificationsNotificationRule) PutTargets(value interface{}) {
...
func (c *jsiiProxy_CodestarnotificationsNotificationRule) ResetCreatedBy() {
	_jsii_.InvokeVoid(
		c,
		"resetCreatedBy",
		nil, // no parameters
...
func (c *jsiiProxy_CodestarnotificationsNotificationRule) ResetEventTypeId() {
	_jsii_.InvokeVoid(
		c,
		"resetEventTypeId",
		nil, // no parameters
...
func (c *jsiiProxy_CodestarnotificationsNotificationRule) ResetTargetAddress() {
	_jsii_.InvokeVoid(
		c,
		"resetTargetAddress",
		nil, // no parameters
