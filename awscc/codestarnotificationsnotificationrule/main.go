...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "eventTypeIdInput", GoGetter: "EventTypeIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEventTypeId", GoMethod: "ResetEventTypeId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetStatus", GoMethod: "ResetStatus"},
			_jsii_.MemberMethod{JsiiMethod: "resetTags", GoMethod: "ResetTags"},
			_jsii_.MemberMethod{JsiiMethod: "resetTargetAddress", GoMethod: "ResetTargetAddress"},
			...
			_jsii_.MemberProperty{JsiiProperty: "targetAddressInput", GoGetter: "TargetAddressInput"},
	...
	_jsii_.RegisterStruct(
		"awscc.codestarnotificationsNotificationRule.CodestarnotificationsNotificationRuleConfig",
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CodestarnotificationsNotificationRuleTargets)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.codestarnotificationsNotificationRule.CodestarnotificationsNotificationRuleTargetsList",
		reflect.TypeOf((*CodestarnotificationsNotificationRuleTargetsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CodestarnotificationsNotificationRuleTargetsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_CodestarnotificationsNotificationRuleTargetsOutputReference{}
