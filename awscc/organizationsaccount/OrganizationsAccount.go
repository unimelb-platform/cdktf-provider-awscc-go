...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/organizations_account awscc_organizations_account}.
...
func (j *jsiiProxy_OrganizationsAccount) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_OrganizationsAccount) AccountName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountName",
...
func (j *jsiiProxy_OrganizationsAccount) AccountNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountNameInput",
...
func (j *jsiiProxy_OrganizationsAccount) ParentIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"parentIds",
...
func (j *jsiiProxy_OrganizationsAccount) ParentIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"parentIdsInput",
...
func (j *jsiiProxy_OrganizationsAccount) Tags() OrganizationsAccountTagsList {
	var returns OrganizationsAccountTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/organizations_account awscc_organizations_account} Resource.
func NewOrganizationsAccount(scope constructs.Construct, id *string, config *OrganizationsAccountConfig) OrganizationsAccount {
	...
	_jsii_.Create(
		"awscc.organizationsAccount.OrganizationsAccount",
...
func (j *jsiiProxy_OrganizationsAccount)SetAccountName(val *string) {
...
func (j *jsiiProxy_OrganizationsAccount)SetParentIds(val *[]*string) {
	if err := j.validateSetParentIdsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (o *jsiiProxy_OrganizationsAccount) PutTags(value interface{}) {
...
func (o *jsiiProxy_OrganizationsAccount) ResetParentIds() {
	_jsii_.InvokeVoid(
		o,
		"resetParentIds",
		nil, // no parameters
