...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/config_organization_conformance_pack awscc_config_organization_conformance_pack}.
type ConfigOrganizationConformancePack interface {
	cdktf.TerraformResource
	// Experimental.
	CdktfStack() cdktf.TerraformStack
	ConformancePackInputParameters() ConfigOrganizationConformancePackConformancePackInputParametersList
	...
	OrganizationConformancePackNameInput() *string
	// Experimental.
...
func (j *jsiiProxy_ConfigOrganizationConformancePack) ConformancePackInputParameters() ConfigOrganizationConformancePackConformancePackInputParametersList {
	var returns ConfigOrganizationConformancePackConformancePackInputParametersList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ConfigOrganizationConformancePack) ConformancePackInputParametersInput() interface{} {
...
func (j *jsiiProxy_ConfigOrganizationConformancePack) OrganizationConformancePackName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ConfigOrganizationConformancePack) OrganizationConformancePackNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organizationConformancePackNameInput",
		&returns,
	)
	return returns
}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/config_organization_conformance_pack awscc_config_organization_conformance_pack} Resource.
...
func (j *jsiiProxy_ConfigOrganizationConformancePack)SetOrganizationConformancePackName(val *string) {
...
func (c *jsiiProxy_ConfigOrganizationConformancePack) PutConformancePackInputParameters(value interface{}) {
...
func (c *jsiiProxy_ConfigOrganizationConformancePack) ResetConformancePackInputParameters() {
	_jsii_.InvokeVoid(
		c,
		"resetConformancePackInputParameters",
		nil, // no parameters
