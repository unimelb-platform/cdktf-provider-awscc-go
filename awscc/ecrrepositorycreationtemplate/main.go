...
func init() {
	_jsii_.RegisterClass(
		"awscc.ecrRepositoryCreationTemplate.EcrRepositoryCreationTemplate",
		reflect.TypeOf((*EcrRepositoryCreationTemplate)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.ecrRepositoryCreationTemplate.EcrRepositoryCreationTemplateConfig",
		reflect.TypeOf((*EcrRepositoryCreationTemplateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.ecrRepositoryCreationTemplate.EcrRepositoryCreationTemplateEncryptionConfiguration",
		reflect.TypeOf((*EcrRepositoryCreationTemplateEncryptionConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ecrRepositoryCreationTemplate.EcrRepositoryCreationTemplateEncryptionConfigurationOutputReference",
		reflect.TypeOf((*EcrRepositoryCreationTemplateEncryptionConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*EcrRepositoryCreationTemplateResourceTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ecrRepositoryCreationTemplate.EcrRepositoryCreationTemplateResourceTagsList",
		reflect.TypeOf((*EcrRepositoryCreationTemplateResourceTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EcrRepositoryCreationTemplateResourceTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
