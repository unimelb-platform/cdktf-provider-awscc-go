...
type BillingconductorPricingRuleTiering struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/billingconductor_pricing_rule#free_tier BillingconductorPricingRule#free_tier}
