...
func (j *jsiiProxy_IamGroupPolicy) GroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupName",
...
func (j *jsiiProxy_IamGroupPolicy) GroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupNameInput",
...
func (j *jsiiProxy_IamGroupPolicy) PolicyDocument() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyDocument",
...
func (j *jsiiProxy_IamGroupPolicy) PolicyDocumentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyDocumentInput",
...
func (j *jsiiProxy_IamGroupPolicy) PolicyName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyName",
...
func (j *jsiiProxy_IamGroupPolicy) PolicyNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyNameInput",
...
func NewIamGroupPolicy(scope constructs.Construct, id *string, config *IamGroupPolicyConfig) IamGroupPolicy {
	...
	_jsii_.Create(
		"awscc.iamGroupPolicy.IamGroupPolicy",
...
func (j *jsiiProxy_IamGroupPolicy)SetGroupName(val *string) {
...
func (j *jsiiProxy_IamGroupPolicy)SetPolicyDocument(val *string) {
...
func (j *jsiiProxy_IamGroupPolicy)SetPolicyName(val *string) {
...
func (i *jsiiProxy_IamGroupPolicy) ResetPolicyDocument() {
	_jsii_.InvokeVoid(
		i,
		"resetPolicyDocument",
		nil, // no parameters
