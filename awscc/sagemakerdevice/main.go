...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.sagemakerDevice.SagemakerDeviceConfig",
		reflect.TypeOf((*SagemakerDeviceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.sagemakerDevice.SagemakerDeviceDevice",
		reflect.TypeOf((*SagemakerDeviceDevice)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.sagemakerDevice.SagemakerDeviceDeviceOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.sagemakerDevice.SagemakerDeviceTags",
		reflect.TypeOf((*SagemakerDeviceTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.sagemakerDevice.SagemakerDeviceTagsList",
		reflect.TypeOf((*SagemakerDeviceTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SagemakerDeviceTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
