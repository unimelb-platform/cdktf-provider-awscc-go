...
func (j *jsiiProxy_SagemakerDeviceDeviceOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerDeviceDeviceOutputReference)SetInternalValue(val interface{}) {
