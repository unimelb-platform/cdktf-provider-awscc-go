...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/sagemaker_device awscc_sagemaker_device}.
...
func (j *jsiiProxy_SagemakerDevice) DeviceInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"deviceInput",
...
func (j *jsiiProxy_SagemakerDevice) Tags() SagemakerDeviceTagsList {
	var returns SagemakerDeviceTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_SagemakerDevice) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/sagemaker_device awscc_sagemaker_device} Resource.
func NewSagemakerDevice(scope constructs.Construct, id *string, config *SagemakerDeviceConfig) SagemakerDevice {
	...
	_jsii_.Create(
		"awscc.sagemakerDevice.SagemakerDevice",
...
func (s *jsiiProxy_SagemakerDevice) PutTags(value interface{}) {
...
func (s *jsiiProxy_SagemakerDevice) ResetDevice() {
	_jsii_.InvokeVoid(
		s,
		"resetDevice",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerDevice) ResetTags() {
	_jsii_.InvokeVoid(
		s,
		"resetTags",
		nil, // no parameters
