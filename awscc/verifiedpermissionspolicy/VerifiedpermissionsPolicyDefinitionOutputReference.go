...
type VerifiedpermissionsPolicyDefinitionOutputReference interface {
	...
	TemplateLinked() VerifiedpermissionsPolicyDefinitionTemplateLinkedOutputReference
	...
	PutStatic(value *VerifiedpermissionsPolicyDefinitionStatic)
	PutTemplateLinked(value *VerifiedpermissionsPolicyDefinitionTemplateLinked)
	ResetStatic()
	ResetTemplateLinked()
...
func (j *jsiiProxy_VerifiedpermissionsPolicyDefinitionOutputReference) Static() VerifiedpermissionsPolicyDefinitionStaticOutputReference {
	var returns VerifiedpermissionsPolicyDefinitionStaticOutputReference
	_jsii_.Get(
		j,
		"static",
		&returns,
...
func (j *jsiiProxy_VerifiedpermissionsPolicyDefinitionOutputReference) TemplateLinked() VerifiedpermissionsPolicyDefinitionTemplateLinkedOutputReference {
...
func NewVerifiedpermissionsPolicyDefinitionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) VerifiedpermissionsPolicyDefinitionOutputReference {
	_init_.Initialize()

	if err := validateNewVerifiedpermissionsPolicyDefinitionOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewVerifiedpermissionsPolicyDefinitionOutputReference_Override(v VerifiedpermissionsPolicyDefinitionOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (v *jsiiProxy_VerifiedpermissionsPolicyDefinitionOutputReference) PutStatic(value *VerifiedpermissionsPolicyDefinitionStatic) {
...
func (v *jsiiProxy_VerifiedpermissionsPolicyDefinitionOutputReference) PutTemplateLinked(value *VerifiedpermissionsPolicyDefinitionTemplateLinked) {
