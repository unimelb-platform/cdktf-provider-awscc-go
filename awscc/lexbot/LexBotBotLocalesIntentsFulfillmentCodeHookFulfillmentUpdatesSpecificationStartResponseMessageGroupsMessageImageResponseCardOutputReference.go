...
func (l *jsiiProxy_LexBotBotLocalesIntentsFulfillmentCodeHookFulfillmentUpdatesSpecificationStartResponseMessageGroupsMessageImageResponseCardOutputReference) ResetTitle() {
	_jsii_.InvokeVoid(
		l,
		"resetTitle",
		nil, // no parameters
