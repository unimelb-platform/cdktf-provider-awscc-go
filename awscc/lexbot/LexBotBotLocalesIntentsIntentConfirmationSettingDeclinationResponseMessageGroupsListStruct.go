...
type LexBotBotLocalesIntentsIntentConfirmationSettingDeclinationResponseMessageGroupsListStruct struct {
	...
	Message *LexBotBotLocalesIntentsIntentConfirmationSettingDeclinationResponseMessageGroupsListMessage `field:"required" json:"message" yaml:"message"`
