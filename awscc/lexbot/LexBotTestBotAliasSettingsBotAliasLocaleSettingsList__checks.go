...
func (l *jsiiProxy_LexBotTestBotAliasSettingsBotAliasLocaleSettingsList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_LexBotTestBotAliasSettingsBotAliasLocaleSettingsList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*LexBotTestBotAliasSettingsBotAliasLocaleSettings; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_LexBotTestBotAliasSettingsBotAliasLocaleSettingsList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewLexBotTestBotAliasSettingsBotAliasLocaleSettingsListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
