...
type LexBotBotLocalesSlotTypesExternalSourceSetting struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lex_bot#grammar_slot_type_setting LexBot#grammar_slot_type_setting}
