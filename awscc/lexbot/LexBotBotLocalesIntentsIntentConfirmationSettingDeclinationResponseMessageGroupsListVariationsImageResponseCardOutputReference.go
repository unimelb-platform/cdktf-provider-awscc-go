...
func (l *jsiiProxy_LexBotBotLocalesIntentsIntentConfirmationSettingDeclinationResponseMessageGroupsListVariationsImageResponseCardOutputReference) ResetTitle() {
	_jsii_.InvokeVoid(
		l,
		"resetTitle",
		nil, // no parameters
