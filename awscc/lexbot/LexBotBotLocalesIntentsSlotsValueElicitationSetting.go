...
type LexBotBotLocalesIntentsSlotsValueElicitationSetting struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lex_bot#default_value_specification LexBot#default_value_specification}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lex_bot#slot_constraint LexBot#slot_constraint}
	SlotConstraint *string `field:"optional" json:"slotConstraint" yaml:"slotConstraint"`
	// Specifies the prompts that Amazon Lex uses while a bot is waiting for customer input.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lex_bot#wait_and_continue_specification LexBot#wait_and_continue_specification}
