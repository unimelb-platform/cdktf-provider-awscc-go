...
type LexBotBotLocalesSlotTypesValueSelectionSettingAdvancedRecognitionSetting struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lex_bot#audio_recognition_strategy LexBot#audio_recognition_strategy}
