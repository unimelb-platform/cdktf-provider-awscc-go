...
func (l *jsiiProxy_LexBotTestBotAliasSettingsConversationLogSettingsTextLogSettingsDestinationOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (l *jsiiProxy_LexBotTestBotAliasSettingsConversationLogSettingsTextLogSettingsDestinationOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_LexBotTestBotAliasSettingsConversationLogSettingsTextLogSettingsDestinationOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *LexBotTestBotAliasSettingsConversationLogSettingsTextLogSettingsDestination:
		val := val.(*LexBotTestBotAliasSettingsConversationLogSettingsTextLogSettingsDestination)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case LexBotTestBotAliasSettingsConversationLogSettingsTextLogSettingsDestination:
		val_ := val.(LexBotTestBotAliasSettingsConversationLogSettingsTextLogSettingsDestination)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *LexBotTestBotAliasSettingsConversationLogSettingsTextLogSettingsDestination; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_LexBotTestBotAliasSettingsConversationLogSettingsTextLogSettingsDestinationOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewLexBotTestBotAliasSettingsConversationLogSettingsTextLogSettingsDestinationOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
