...
type LexBotBotLocalesIntentsFulfillmentCodeHookFulfillmentUpdatesSpecification struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lex_bot#active LexBot#active}
	Active interface{} `field:"optional" json:"active" yaml:"active"`
	// Provides settings for a message that is sent to the user when a fulfillment Lambda function starts running.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lex_bot#start_response LexBot#start_response}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lex_bot#update_response LexBot#update_response}
