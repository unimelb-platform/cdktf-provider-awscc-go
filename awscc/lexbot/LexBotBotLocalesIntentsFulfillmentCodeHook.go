...
type LexBotBotLocalesIntentsFulfillmentCodeHook struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lex_bot#fulfillment_updates_specification LexBot#fulfillment_updates_specification}
	...
	// Provides information for updating the user on the progress of fulfilling an intent.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lex_bot#post_fulfillment_status_specification LexBot#post_fulfillment_status_specification}
