...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.sagemakerInferenceComponent.SagemakerInferenceComponentDeploymentConfig",
		reflect.TypeOf((*SagemakerInferenceComponentDeploymentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.sagemakerInferenceComponent.SagemakerInferenceComponentDeploymentConfigAutoRollbackConfiguration",
		reflect.TypeOf((*SagemakerInferenceComponentDeploymentConfigAutoRollbackConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.sagemakerInferenceComponent.SagemakerInferenceComponentDeploymentConfigAutoRollbackConfigurationAlarms",
