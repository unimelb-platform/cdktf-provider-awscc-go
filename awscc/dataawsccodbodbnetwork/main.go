...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccOdbOdbNetwork)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccOdbOdbNetwork.DataAwsccOdbOdbNetworkConfig",
		reflect.TypeOf((*DataAwsccOdbOdbNetworkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccOdbOdbNetwork.DataAwsccOdbOdbNetworkTags",
		reflect.TypeOf((*DataAwsccOdbOdbNetworkTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccOdbOdbNetwork.DataAwsccOdbOdbNetworkTagsList",
		reflect.TypeOf((*DataAwsccOdbOdbNetworkTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccOdbOdbNetworkTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
