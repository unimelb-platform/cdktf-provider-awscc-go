...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.rdsGlobalCluster.RdsGlobalClusterGlobalEndpoint",
		reflect.TypeOf((*RdsGlobalClusterGlobalEndpoint)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.rdsGlobalCluster.RdsGlobalClusterGlobalEndpointOutputReference",
		reflect.TypeOf((*RdsGlobalClusterGlobalEndpointOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.rdsGlobalCluster.RdsGlobalClusterTags",
		reflect.TypeOf((*RdsGlobalClusterTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.rdsGlobalCluster.RdsGlobalClusterTagsList",
		reflect.TypeOf((*RdsGlobalClusterTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RdsGlobalClusterTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
