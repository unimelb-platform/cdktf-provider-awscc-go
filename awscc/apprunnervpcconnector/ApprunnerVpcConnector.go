...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apprunner_vpc_connector awscc_apprunner_vpc_connector}.
...
func (j *jsiiProxy_ApprunnerVpcConnector) Tags() ApprunnerVpcConnectorTagsList {
	var returns ApprunnerVpcConnectorTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_ApprunnerVpcConnector) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_ApprunnerVpcConnector) VpcConnectorArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpcConnectorArn",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apprunner_vpc_connector awscc_apprunner_vpc_connector} Resource.
func NewApprunnerVpcConnector(scope constructs.Construct, id *string, config *ApprunnerVpcConnectorConfig) ApprunnerVpcConnector {
	...
	_jsii_.Create(
		"awscc.apprunnerVpcConnector.ApprunnerVpcConnector",
...
func (a *jsiiProxy_ApprunnerVpcConnector) PutTags(value interface{}) {
...
func (a *jsiiProxy_ApprunnerVpcConnector) ResetSecurityGroups() {
	_jsii_.InvokeVoid(
		a,
		"resetSecurityGroups",
		nil, // no parameters
...
func (a *jsiiProxy_ApprunnerVpcConnector) ResetVpcConnectorName() {
	_jsii_.InvokeVoid(
		a,
		"resetVpcConnectorName",
		nil, // no parameters
