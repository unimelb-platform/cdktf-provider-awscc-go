...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/cloudfront_distribution awscc_cloudfront_distribution}.
type CloudfrontDistribution interface {
	...
	DistributionConfig() CloudfrontDistributionDistributionConfigOutputReference
	DistributionConfigInput() interface{}
	DomainName() *string
	// Experimental.
	...
	Tags() CloudfrontDistributionTagsList
	TagsInput() interface{}
	// Experimental.
	...
	PutDistributionConfig(value *CloudfrontDistributionDistributionConfig)
...
func (j *jsiiProxy_CloudfrontDistribution) DistributionConfig() CloudfrontDistributionDistributionConfigOutputReference {
	var returns CloudfrontDistributionDistributionConfigOutputReference
	_jsii_.Get(
		j,
		"distributionConfig",
		&returns,
...
func (j *jsiiProxy_CloudfrontDistribution) DistributionConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudfrontDistribution) Tags() CloudfrontDistributionTagsList {
	var returns CloudfrontDistributionTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/cloudfront_distribution awscc_cloudfront_distribution} Resource.
...
func (c *jsiiProxy_CloudfrontDistribution) PutDistributionConfig(value *CloudfrontDistributionDistributionConfig) {
	if err := c.validatePutDistributionConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_CloudfrontDistribution) PutTags(value interface{}) {
