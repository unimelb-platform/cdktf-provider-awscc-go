...
type CloudfrontDistributionDistributionConfigCacheBehaviorsForwardedValues struct {
	...
	Cookies *CloudfrontDistributionDistributionConfigCacheBehaviorsForwardedValuesCookies `field:"optional" json:"cookies" yaml:"cookies"`
