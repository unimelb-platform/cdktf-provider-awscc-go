...
func (a *jsiiProxy_ApprunnerVpcIngressConnection) validatePutTagsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*ApprunnerVpcIngressConnectionTags:
		value := value.(*[]*ApprunnerVpcIngressConnectionTags)
	...
	case []*ApprunnerVpcIngressConnectionTags:
		value_ := value.([]*ApprunnerVpcIngressConnectionTags)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ApprunnerVpcIngressConnectionTags; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_ApprunnerVpcIngressConnection) validateSetVpcIngressConnectionNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
