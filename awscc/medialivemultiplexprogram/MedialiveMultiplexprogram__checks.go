...
func (m *jsiiProxy_MedialiveMultiplexprogram) validatePutPacketIdentifiersMapParameters(value *MedialiveMultiplexprogramPacketIdentifiersMap) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (m *jsiiProxy_MedialiveMultiplexprogram) validatePutPipelineDetailsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*MedialiveMultiplexprogramPipelineDetails:
		value := value.(*[]*MedialiveMultiplexprogramPipelineDetails)
	...
	case []*MedialiveMultiplexprogramPipelineDetails:
		value_ := value.([]*MedialiveMultiplexprogramPipelineDetails)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*MedialiveMultiplexprogramPipelineDetails; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_MedialiveMultiplexprogram) validateSetPreferredChannelPipelineParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
