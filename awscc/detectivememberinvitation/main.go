...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DetectiveMemberInvitation)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "memberEmailAddressInput", GoGetter: "MemberEmailAddressInput"},
	...
	_jsii_.RegisterStruct(
		"awscc.detectiveMemberInvitation.DetectiveMemberInvitationConfig",
		reflect.TypeOf((*DetectiveMemberInvitationConfig)(nil)).Elem(),
	)
}
