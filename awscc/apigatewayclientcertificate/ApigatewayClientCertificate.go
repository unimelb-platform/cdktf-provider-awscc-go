...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigateway_client_certificate awscc_apigateway_client_certificate}.
type ApigatewayClientCertificate interface {
	...
	Tags() ApigatewayClientCertificateTagsList
	TagsInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_ApigatewayClientCertificate) ClientCertificateId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clientCertificateId",
...
func (j *jsiiProxy_ApigatewayClientCertificate) Tags() ApigatewayClientCertificateTagsList {
	var returns ApigatewayClientCertificateTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigateway_client_certificate awscc_apigateway_client_certificate} Resource.
func NewApigatewayClientCertificate(scope constructs.Construct, id *string, config *ApigatewayClientCertificateConfig) ApigatewayClientCertificate {
	...
	_jsii_.Create(
		"awscc.apigatewayClientCertificate.ApigatewayClientCertificate",
...
func (a *jsiiProxy_ApigatewayClientCertificate) PutTags(value interface{}) {
