...
func init() {
	_jsii_.RegisterClass(
		"awscc.datazoneGroupProfile.DatazoneGroupProfile",
		reflect.TypeOf((*DatazoneGroupProfile)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DatazoneGroupProfile{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.datazoneGroupProfile.DatazoneGroupProfileConfig",
		reflect.TypeOf((*DatazoneGroupProfileConfig)(nil)).Elem(),
	)
}
