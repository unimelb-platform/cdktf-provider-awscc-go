...
func (j *jsiiProxy_DataAwsccOpensearchserviceDomainLogPublishingOptionsMap) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsccOpensearchserviceDomainLogPublishingOptionsMap(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataAwsccOpensearchserviceDomainLogPublishingOptionsMap {
	_init_.Initialize()
	...
	_jsii_.Create(
		"awscc.dataAwsccOpensearchserviceDomain.DataAwsccOpensearchserviceDomainLogPublishingOptionsMap",
...
func NewDataAwsccOpensearchserviceDomainLogPublishingOptionsMap_Override(d DataAwsccOpensearchserviceDomainLogPublishingOptionsMap, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccOpensearchserviceDomainLogPublishingOptionsMap)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccOpensearchserviceDomainLogPublishingOptionsMap) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsccOpensearchserviceDomainLogPublishingOptionsMap) Resolve(_context cdktf.IResolveContext) interface{} {
