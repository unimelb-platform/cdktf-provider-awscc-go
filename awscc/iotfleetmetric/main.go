...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IotFleetMetric)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "aggregationField", GoGetter: "AggregationField"},
			_jsii_.MemberProperty{JsiiProperty: "aggregationFieldInput", GoGetter: "AggregationFieldInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "metricArn", GoGetter: "MetricArn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putAggregationType", GoMethod: "PutAggregationType"},
			...
			_jsii_.MemberProperty{JsiiProperty: "queryVersionInput", GoGetter: "QueryVersionInput"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetAggregationField", GoMethod: "ResetAggregationField"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetQueryVersion", GoMethod: "ResetQueryVersion"},
	...
	_jsii_.RegisterStruct(
		"awscc.iotFleetMetric.IotFleetMetricAggregationType",
		reflect.TypeOf((*IotFleetMetricAggregationType)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.iotFleetMetric.IotFleetMetricAggregationTypeOutputReference",
		reflect.TypeOf((*IotFleetMetricAggregationTypeOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.iotFleetMetric.IotFleetMetricConfig",
		reflect.TypeOf((*IotFleetMetricConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.iotFleetMetric.IotFleetMetricTags",
		reflect.TypeOf((*IotFleetMetricTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.iotFleetMetric.IotFleetMetricTagsList",
		reflect.TypeOf((*IotFleetMetricTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IotFleetMetricTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
