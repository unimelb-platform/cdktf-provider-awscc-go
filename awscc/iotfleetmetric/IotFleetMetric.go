...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/iot_fleet_metric awscc_iot_fleet_metric}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/iot_fleet_metric awscc_iot_fleet_metric} Resource.
...
func (i *jsiiProxy_IotFleetMetric) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IotFleetMetric) MoveFromId(id *string) {
...
func (i *jsiiProxy_IotFleetMetric) MoveToId(id *string) {
...
func (i *jsiiProxy_IotFleetMetric) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IotFleetMetric) ToHclTerraform() interface{} {
	var returns interface{}
