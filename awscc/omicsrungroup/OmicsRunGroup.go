...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/omics_run_group awscc_omics_run_group}.
...
func (j *jsiiProxy_OmicsRunGroup) RunGroupId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"runGroupId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/omics_run_group awscc_omics_run_group} Resource.
...
func (o *jsiiProxy_OmicsRunGroup) HasResourceMove() interface{} {
	var returns interface{}
...
func (o *jsiiProxy_OmicsRunGroup) MoveFromId(id *string) {
...
func (o *jsiiProxy_OmicsRunGroup) MoveToId(id *string) {
...
func (o *jsiiProxy_OmicsRunGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (o *jsiiProxy_OmicsRunGroup) ToHclTerraform() interface{} {
	var returns interface{}
