...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSupportappSlackChannelConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccSupportappSlackChannelConfiguration.DataAwsccSupportappSlackChannelConfigurationConfig",
		reflect.TypeOf((*DataAwsccSupportappSlackChannelConfigurationConfig)(nil)).Elem(),
	)
}
