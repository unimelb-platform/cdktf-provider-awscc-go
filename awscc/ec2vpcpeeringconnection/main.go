...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2VpcPeeringConnection)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "peerRoleArnInput", GoGetter: "PeerRoleArnInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPeerRoleArn", GoMethod: "ResetPeerRoleArn"},
	...
	_jsii_.RegisterStruct(
		"awscc.ec2VpcPeeringConnection.Ec2VpcPeeringConnectionConfig",
		reflect.TypeOf((*Ec2VpcPeeringConnectionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.ec2VpcPeeringConnection.Ec2VpcPeeringConnectionTags",
		reflect.TypeOf((*Ec2VpcPeeringConnectionTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2VpcPeeringConnection.Ec2VpcPeeringConnectionTagsList",
		reflect.TypeOf((*Ec2VpcPeeringConnectionTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2VpcPeeringConnectionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
