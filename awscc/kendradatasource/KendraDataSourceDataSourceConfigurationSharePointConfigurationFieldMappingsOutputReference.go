...
func (k *jsiiProxy_KendraDataSourceDataSourceConfigurationSharePointConfigurationFieldMappingsOutputReference) ResetDataSourceFieldName() {
	_jsii_.InvokeVoid(
		k,
		"resetDataSourceFieldName",
		nil, // no parameters
...
func (k *jsiiProxy_KendraDataSourceDataSourceConfigurationSharePointConfigurationFieldMappingsOutputReference) ResetIndexFieldName() {
	_jsii_.InvokeVoid(
		k,
		"resetIndexFieldName",
		nil, // no parameters
