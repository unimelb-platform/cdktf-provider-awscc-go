...
func (k *jsiiProxy_KendraDataSourceDataSourceConfigurationServiceNowConfigurationKnowledgeArticleConfigurationFieldMappingsOutputReference) ResetDataSourceFieldName() {
	_jsii_.InvokeVoid(
		k,
		"resetDataSourceFieldName",
		nil, // no parameters
...
func (k *jsiiProxy_KendraDataSourceDataSourceConfigurationServiceNowConfigurationKnowledgeArticleConfigurationFieldMappingsOutputReference) ResetIndexFieldName() {
	_jsii_.InvokeVoid(
		k,
		"resetIndexFieldName",
		nil, // no parameters
