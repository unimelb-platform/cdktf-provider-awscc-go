...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IotfleethubApplication)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.iotfleethubApplication.IotfleethubApplicationConfig",
		reflect.TypeOf((*IotfleethubApplicationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.iotfleethubApplication.IotfleethubApplicationTags",
		reflect.TypeOf((*IotfleethubApplicationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.iotfleethubApplication.IotfleethubApplicationTagsList",
		reflect.TypeOf((*IotfleethubApplicationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IotfleethubApplicationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
