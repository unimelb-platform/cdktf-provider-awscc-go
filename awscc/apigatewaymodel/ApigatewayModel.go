...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/apigatewaymodel/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigateway_model awscc_apigateway_model}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigateway_model awscc_apigateway_model} Resource.
func NewApigatewayModel(scope constructs.Construct, id *string, config *ApigatewayModelConfig) ApigatewayModel {
	...
	_jsii_.Create(
		"awscc.apigatewayModel.ApigatewayModel",
...
func (a *jsiiProxy_ApigatewayModel) ResetContentType() {
	_jsii_.InvokeVoid(
		a,
		"resetContentType",
		nil, // no parameters
...
func (a *jsiiProxy_ApigatewayModel) ResetName() {
	_jsii_.InvokeVoid(
		a,
		"resetName",
		nil, // no parameters
