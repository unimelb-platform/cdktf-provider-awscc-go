...
func (j *jsiiProxy_DataAwsccEvidentlyExperimentTreatmentsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsccEvidentlyExperimentTreatmentsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccEvidentlyExperimentTreatmentsList {
	_init_.Initialize()
...
func NewDataAwsccEvidentlyExperimentTreatmentsList_Override(d DataAwsccEvidentlyExperimentTreatmentsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccEvidentlyExperimentTreatmentsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccEvidentlyExperimentTreatmentsList) Resolve(_context cdktf.IResolveContext) interface{} {
