...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/networkfirewall_tls_inspection_configuration awscc_networkfirewall_tls_inspection_configuration}.
type NetworkfirewallTlsInspectionConfiguration interface {
	...
	TlsInspectionConfiguration() NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationOutputReference
	TlsInspectionConfigurationArn() *string
	TlsInspectionConfigurationId() *string
	TlsInspectionConfigurationInput() interface{}
	TlsInspectionConfigurationName() *string
	SetTlsInspectionConfigurationName(val *string)
	TlsInspectionConfigurationNameInput() *string
	...
	PutTlsInspectionConfiguration(value *NetworkfirewallTlsInspectionConfigurationTlsInspectionConfiguration)
	ResetDescription()
...
func (j *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) Tags() NetworkfirewallTlsInspectionConfigurationTagsList {
	var returns NetworkfirewallTlsInspectionConfigurationTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) TlsInspectionConfiguration() NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationOutputReference {
...
func (j *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) TlsInspectionConfigurationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) TlsInspectionConfigurationName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) TlsInspectionConfigurationNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tlsInspectionConfigurationNameInput",
		&returns,
	)
	return returns
}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/networkfirewall_tls_inspection_configuration awscc_networkfirewall_tls_inspection_configuration} Resource.
...
func (j *jsiiProxy_NetworkfirewallTlsInspectionConfiguration)SetTlsInspectionConfigurationName(val *string) {
	if err := j.validateSetTlsInspectionConfigurationNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (n *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) PutTags(value interface{}) {
...
func (n *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) PutTlsInspectionConfiguration(value *NetworkfirewallTlsInspectionConfigurationTlsInspectionConfiguration) {
