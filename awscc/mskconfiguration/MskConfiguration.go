...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/msk_configuration awscc_msk_configuration}.
type MskConfiguration interface {
	...
	KafkaVersionsListInput() *[]*string
	LatestRevision() MskConfigurationLatestRevisionOutputReference
	...
	PutLatestRevision(value *MskConfigurationLatestRevision)
	ResetDescription()
	ResetKafkaVersionsList()
	ResetLatestRevision()
...
func (j *jsiiProxy_MskConfiguration) KafkaVersionsList() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"kafkaVersionsList",
...
func (j *jsiiProxy_MskConfiguration) KafkaVersionsListInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"kafkaVersionsListInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_MskConfiguration) LatestRevision() MskConfigurationLatestRevisionOutputReference {
	var returns MskConfigurationLatestRevisionOutputReference
	_jsii_.Get(
		j,
		"latestRevision",
		&returns,
...
func (j *jsiiProxy_MskConfiguration) LatestRevisionInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"latestRevisionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/msk_configuration awscc_msk_configuration} Resource.
func NewMskConfiguration(scope constructs.Construct, id *string, config *MskConfigurationConfig) MskConfiguration {
	...
	_jsii_.Create(
		"awscc.mskConfiguration.MskConfiguration",
...
func (j *jsiiProxy_MskConfiguration)SetKafkaVersionsList(val *[]*string) {
	if err := j.validateSetKafkaVersionsListParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (m *jsiiProxy_MskConfiguration) PutLatestRevision(value *MskConfigurationLatestRevision) {
	if err := m.validatePutLatestRevisionParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		m,
...
func (m *jsiiProxy_MskConfiguration) ResetKafkaVersionsList() {
	_jsii_.InvokeVoid(
		m,
		"resetKafkaVersionsList",
		nil, // no parameters
...
func (m *jsiiProxy_MskConfiguration) ResetLatestRevision() {
	_jsii_.InvokeVoid(
		m,
		"resetLatestRevision",
		nil, // no parameters
