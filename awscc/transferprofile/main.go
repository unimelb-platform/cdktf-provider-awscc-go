...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.transferProfile.TransferProfileConfig",
		reflect.TypeOf((*TransferProfileConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.transferProfile.TransferProfileTags",
		reflect.TypeOf((*TransferProfileTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.transferProfile.TransferProfileTagsList",
		reflect.TypeOf((*TransferProfileTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*TransferProfileTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
