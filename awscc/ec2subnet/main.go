...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.ec2Subnet.Ec2SubnetBlockPublicAccessStates",
		reflect.TypeOf((*Ec2SubnetBlockPublicAccessStates)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2Subnet.Ec2SubnetBlockPublicAccessStatesOutputReference",
		reflect.TypeOf((*Ec2SubnetBlockPublicAccessStatesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
