...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccApigatewayv2Authorizer)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccApigatewayv2Authorizer.DataAwsccApigatewayv2AuthorizerConfig",
		reflect.TypeOf((*DataAwsccApigatewayv2AuthorizerConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccApigatewayv2Authorizer.DataAwsccApigatewayv2AuthorizerJwtConfiguration",
		reflect.TypeOf((*DataAwsccApigatewayv2AuthorizerJwtConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccApigatewayv2Authorizer.DataAwsccApigatewayv2AuthorizerJwtConfigurationOutputReference",
		reflect.TypeOf((*DataAwsccApigatewayv2AuthorizerJwtConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
