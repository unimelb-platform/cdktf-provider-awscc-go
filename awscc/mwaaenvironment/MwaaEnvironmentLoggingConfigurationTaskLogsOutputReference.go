...
func (j *jsiiProxy_MwaaEnvironmentLoggingConfigurationTaskLogsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewMwaaEnvironmentLoggingConfigurationTaskLogsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MwaaEnvironmentLoggingConfigurationTaskLogsOutputReference {
	...
	_jsii_.Create(
		"awscc.mwaaEnvironment.MwaaEnvironmentLoggingConfigurationTaskLogsOutputReference",
...
func (j *jsiiProxy_MwaaEnvironmentLoggingConfigurationTaskLogsOutputReference)SetInternalValue(val interface{}) {
