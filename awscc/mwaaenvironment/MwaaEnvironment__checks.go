...
func (j *jsiiProxy_MwaaEnvironment) validateSetAirflowConfigurationOptionsParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_MwaaEnvironment) validateSetTagsParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
