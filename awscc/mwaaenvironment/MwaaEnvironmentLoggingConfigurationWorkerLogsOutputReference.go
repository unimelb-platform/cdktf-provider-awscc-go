...
func (j *jsiiProxy_MwaaEnvironmentLoggingConfigurationWorkerLogsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewMwaaEnvironmentLoggingConfigurationWorkerLogsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MwaaEnvironmentLoggingConfigurationWorkerLogsOutputReference {
	...
	_jsii_.Create(
		"awscc.mwaaEnvironment.MwaaEnvironmentLoggingConfigurationWorkerLogsOutputReference",
...
func (j *jsiiProxy_MwaaEnvironmentLoggingConfigurationWorkerLogsOutputReference)SetInternalValue(val interface{}) {
