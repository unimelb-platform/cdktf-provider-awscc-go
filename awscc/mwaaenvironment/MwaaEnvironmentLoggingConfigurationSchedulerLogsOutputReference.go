...
func (j *jsiiProxy_MwaaEnvironmentLoggingConfigurationSchedulerLogsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewMwaaEnvironmentLoggingConfigurationSchedulerLogsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MwaaEnvironmentLoggingConfigurationSchedulerLogsOutputReference {
	...
	_jsii_.Create(
		"awscc.mwaaEnvironment.MwaaEnvironmentLoggingConfigurationSchedulerLogsOutputReference",
...
func (j *jsiiProxy_MwaaEnvironmentLoggingConfigurationSchedulerLogsOutputReference)SetInternalValue(val interface{}) {
