...
func (j *jsiiProxy_MwaaEnvironmentLoggingConfigurationWebserverLogsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewMwaaEnvironmentLoggingConfigurationWebserverLogsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MwaaEnvironmentLoggingConfigurationWebserverLogsOutputReference {
	...
	_jsii_.Create(
		"awscc.mwaaEnvironment.MwaaEnvironmentLoggingConfigurationWebserverLogsOutputReference",
...
func (j *jsiiProxy_MwaaEnvironmentLoggingConfigurationWebserverLogsOutputReference)SetInternalValue(val interface{}) {
