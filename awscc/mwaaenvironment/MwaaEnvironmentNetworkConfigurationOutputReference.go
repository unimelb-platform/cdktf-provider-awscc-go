...
func (j *jsiiProxy_MwaaEnvironmentNetworkConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewMwaaEnvironmentNetworkConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MwaaEnvironmentNetworkConfigurationOutputReference {
	...
	_jsii_.Create(
		"awscc.mwaaEnvironment.MwaaEnvironmentNetworkConfigurationOutputReference",
...
func (j *jsiiProxy_MwaaEnvironmentNetworkConfigurationOutputReference)SetInternalValue(val interface{}) {
...
func (m *jsiiProxy_MwaaEnvironmentNetworkConfigurationOutputReference) ResetSecurityGroupIds() {
	_jsii_.InvokeVoid(
		m,
		"resetSecurityGroupIds",
		nil, // no parameters
...
func (m *jsiiProxy_MwaaEnvironmentNetworkConfigurationOutputReference) ResetSubnetIds() {
	_jsii_.InvokeVoid(
		m,
		"resetSubnetIds",
		nil, // no parameters
