...
func init() {
	_jsii_.RegisterClass(
		"awscc.dataAwsccNeptuneDbInstance.DataAwsccNeptuneDbInstance",
		reflect.TypeOf((*DataAwsccNeptuneDbInstance)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccNeptuneDbInstance{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformDataSource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccNeptuneDbInstance.DataAwsccNeptuneDbInstanceConfig",
		reflect.TypeOf((*DataAwsccNeptuneDbInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccNeptuneDbInstance.DataAwsccNeptuneDbInstanceTags",
		reflect.TypeOf((*DataAwsccNeptuneDbInstanceTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccNeptuneDbInstance.DataAwsccNeptuneDbInstanceTagsList",
		reflect.TypeOf((*DataAwsccNeptuneDbInstanceTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccNeptuneDbInstanceTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
