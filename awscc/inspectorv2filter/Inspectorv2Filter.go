...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/inspectorv2_filter awscc_inspectorv2_filter}.
...
func (j *jsiiProxy_Inspectorv2Filter) Tags() *map[string]*string {
...
func (j *jsiiProxy_Inspectorv2Filter) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/inspectorv2_filter awscc_inspectorv2_filter} Resource.
...
func (j *jsiiProxy_Inspectorv2Filter)SetTags(val *map[string]*string) {
...
func (i *jsiiProxy_Inspectorv2Filter) ResetTags() {
	_jsii_.InvokeVoid(
		i,
		"resetTags",
		nil, // no parameters
