...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/connect_instance awscc_connect_instance}.
type ConnectInstance interface {
	...
	PutAttributes(value *ConnectInstanceAttributes)
...
func (j *jsiiProxy_ConnectInstance) Attributes() ConnectInstanceAttributesOutputReference {
	var returns ConnectInstanceAttributesOutputReference
	_jsii_.Get(
		j,
		"attributes",
		&returns,
...
func (j *jsiiProxy_ConnectInstance) AttributesInput() interface{} {
...
func (j *jsiiProxy_ConnectInstance) InstanceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceId",
...
func (j *jsiiProxy_ConnectInstance) InstanceStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceStatus",
...
func (j *jsiiProxy_ConnectInstance) Tags() ConnectInstanceTagsList {
	var returns ConnectInstanceTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_ConnectInstance) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/connect_instance awscc_connect_instance} Resource.
func NewConnectInstance(scope constructs.Construct, id *string, config *ConnectInstanceConfig) ConnectInstance {
	...
	_jsii_.Create(
		"awscc.connectInstance.ConnectInstance",
...
func (c *jsiiProxy_ConnectInstance) PutAttributes(value *ConnectInstanceAttributes) {
...
func (c *jsiiProxy_ConnectInstance) PutTags(value interface{}) {
