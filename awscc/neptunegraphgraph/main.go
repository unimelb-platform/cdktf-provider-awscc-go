...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.neptunegraphGraph.NeptunegraphGraphConfig",
		reflect.TypeOf((*NeptunegraphGraphConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.neptunegraphGraph.NeptunegraphGraphTags",
	...
	_jsii_.RegisterStruct(
		"awscc.neptunegraphGraph.NeptunegraphGraphVectorSearchConfiguration",
