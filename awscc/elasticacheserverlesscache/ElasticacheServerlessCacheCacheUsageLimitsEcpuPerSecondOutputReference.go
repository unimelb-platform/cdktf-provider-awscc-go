...
func NewElasticacheServerlessCacheCacheUsageLimitsEcpuPerSecondOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ElasticacheServerlessCacheCacheUsageLimitsEcpuPerSecondOutputReference {
	_init_.Initialize()
...
func NewElasticacheServerlessCacheCacheUsageLimitsEcpuPerSecondOutputReference_Override(e ElasticacheServerlessCacheCacheUsageLimitsEcpuPerSecondOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
