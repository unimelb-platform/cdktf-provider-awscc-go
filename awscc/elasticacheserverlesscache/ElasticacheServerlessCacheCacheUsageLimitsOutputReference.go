...
func NewElasticacheServerlessCacheCacheUsageLimitsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ElasticacheServerlessCacheCacheUsageLimitsOutputReference {
	_init_.Initialize()
...
func NewElasticacheServerlessCacheCacheUsageLimitsOutputReference_Override(e ElasticacheServerlessCacheCacheUsageLimitsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
