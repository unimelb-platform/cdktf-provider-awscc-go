...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NeptuneDbInstance)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.neptuneDbInstance.NeptuneDbInstanceConfig",
		reflect.TypeOf((*NeptuneDbInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.neptuneDbInstance.NeptuneDbInstanceTags",
		reflect.TypeOf((*NeptuneDbInstanceTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.neptuneDbInstance.NeptuneDbInstanceTagsList",
		reflect.TypeOf((*NeptuneDbInstanceTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NeptuneDbInstanceTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
