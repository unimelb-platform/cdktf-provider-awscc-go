...
func (d *jsiiProxy_DataAwsccEc2CapacityReservationFleetInstanceTypeSpecificationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
