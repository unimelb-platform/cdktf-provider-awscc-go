...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/kmsalias/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/kms_alias awscc_kms_alias}.
...
func (j *jsiiProxy_KmsAlias) AliasName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"aliasName",
...
func (j *jsiiProxy_KmsAlias) AliasNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"aliasNameInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/kms_alias awscc_kms_alias} Resource.
...
func (j *jsiiProxy_KmsAlias)SetAliasName(val *string) {
