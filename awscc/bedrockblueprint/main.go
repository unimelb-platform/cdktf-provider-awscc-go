...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BedrockBlueprint)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.bedrockBlueprint.BedrockBlueprintConfig",
		reflect.TypeOf((*BedrockBlueprintConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.bedrockBlueprint.BedrockBlueprintTags",
		reflect.TypeOf((*BedrockBlueprintTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.bedrockBlueprint.BedrockBlueprintTagsList",
		reflect.TypeOf((*BedrockBlueprintTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BedrockBlueprintTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
