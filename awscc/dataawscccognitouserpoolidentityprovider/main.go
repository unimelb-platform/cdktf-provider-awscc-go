...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCognitoUserPoolIdentityProvider)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccCognitoUserPoolIdentityProvider.DataAwsccCognitoUserPoolIdentityProviderConfig",
		reflect.TypeOf((*DataAwsccCognitoUserPoolIdentityProviderConfig)(nil)).Elem(),
	)
}
