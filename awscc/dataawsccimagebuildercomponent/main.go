...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccImagebuilderComponent)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccImagebuilderComponent.DataAwsccImagebuilderComponentConfig",
		reflect.TypeOf((*DataAwsccImagebuilderComponentConfig)(nil)).Elem(),
	)
}
