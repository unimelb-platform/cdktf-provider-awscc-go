...
func (j *jsiiProxy_ConfigConfigurationAggregatorOrganizationAggregationSourceOutputReference) AllAwsRegions() interface{} {
...
func (j *jsiiProxy_ConfigConfigurationAggregatorOrganizationAggregationSourceOutputReference) AllAwsRegionsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"allAwsRegionsInput",
...
func (j *jsiiProxy_ConfigConfigurationAggregatorOrganizationAggregationSourceOutputReference) AwsRegions() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"awsRegions",
...
func (j *jsiiProxy_ConfigConfigurationAggregatorOrganizationAggregationSourceOutputReference) AwsRegionsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"awsRegionsInput",
...
func (j *jsiiProxy_ConfigConfigurationAggregatorOrganizationAggregationSourceOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ConfigConfigurationAggregatorOrganizationAggregationSourceOutputReference)SetAllAwsRegions(val interface{}) {
...
func (j *jsiiProxy_ConfigConfigurationAggregatorOrganizationAggregationSourceOutputReference)SetAwsRegions(val *[]*string) {
...
func (j *jsiiProxy_ConfigConfigurationAggregatorOrganizationAggregationSourceOutputReference)SetInternalValue(val interface{}) {
...
func (c *jsiiProxy_ConfigConfigurationAggregatorOrganizationAggregationSourceOutputReference) ResetAllAwsRegions() {
	_jsii_.InvokeVoid(
		c,
		"resetAllAwsRegions",
		nil, // no parameters
...
func (c *jsiiProxy_ConfigConfigurationAggregatorOrganizationAggregationSourceOutputReference) ResetAwsRegions() {
	_jsii_.InvokeVoid(
		c,
		"resetAwsRegions",
		nil, // no parameters
