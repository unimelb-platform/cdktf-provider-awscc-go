...
type EcsTaskDefinitionProxyConfigurationOutputReference interface {
	...
	ProxyConfigurationProperties() EcsTaskDefinitionProxyConfigurationProxyConfigurationPropertiesList
	ProxyConfigurationPropertiesInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_EcsTaskDefinitionProxyConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EcsTaskDefinitionProxyConfigurationOutputReference) ProxyConfigurationProperties() EcsTaskDefinitionProxyConfigurationProxyConfigurationPropertiesList {
	var returns EcsTaskDefinitionProxyConfigurationProxyConfigurationPropertiesList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EcsTaskDefinitionProxyConfigurationOutputReference) ProxyConfigurationPropertiesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"proxyConfigurationPropertiesInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_EcsTaskDefinitionProxyConfigurationOutputReference)SetInternalValue(val interface{}) {
...
func (e *jsiiProxy_EcsTaskDefinitionProxyConfigurationOutputReference) PutProxyConfigurationProperties(value interface{}) {
	if err := e.validatePutProxyConfigurationPropertiesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		e,
...
func (e *jsiiProxy_EcsTaskDefinitionProxyConfigurationOutputReference) ResetProxyConfigurationProperties() {
	_jsii_.InvokeVoid(
		e,
		"resetProxyConfigurationProperties",
		nil, // no parameters
