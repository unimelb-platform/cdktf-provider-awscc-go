...
func (j *jsiiProxy_EcsTaskDefinitionRuntimePlatformOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EcsTaskDefinitionRuntimePlatformOutputReference)SetInternalValue(val interface{}) {
