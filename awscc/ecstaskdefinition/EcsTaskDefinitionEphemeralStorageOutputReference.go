...
func (j *jsiiProxy_EcsTaskDefinitionEphemeralStorageOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EcsTaskDefinitionEphemeralStorageOutputReference)SetInternalValue(val interface{}) {
...
func (e *jsiiProxy_EcsTaskDefinitionEphemeralStorageOutputReference) ResetSizeInGiB() {
	_jsii_.InvokeVoid(
		e,
		"resetSizeInGiB",
		nil, // no parameters
