...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.iotThing.IotThingAttributePayload",
		reflect.TypeOf((*IotThingAttributePayload)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.iotThing.IotThingAttributePayloadOutputReference",
		reflect.TypeOf((*IotThingAttributePayloadOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
