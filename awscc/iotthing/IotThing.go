...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/iot_thing awscc_iot_thing}.
type IotThing interface {
	cdktf.TerraformResource
	Arn() *string
	AttributePayload() IotThingAttributePayloadOutputReference
	...
	PutAttributePayload(value *IotThingAttributePayload)
...
func (j *jsiiProxy_IotThing) AttributePayload() IotThingAttributePayloadOutputReference {
	var returns IotThingAttributePayloadOutputReference
	_jsii_.Get(
		j,
		"attributePayload",
		&returns,
...
func (j *jsiiProxy_IotThing) AttributePayloadInput() interface{} {
...
func (j *jsiiProxy_IotThing) ThingId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"thingId",
...
func (j *jsiiProxy_IotThing) ThingName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"thingName",
...
func (j *jsiiProxy_IotThing) ThingNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"thingNameInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/iot_thing awscc_iot_thing} Resource.
...
func (j *jsiiProxy_IotThing)SetThingName(val *string) {
...
func (i *jsiiProxy_IotThing) PutAttributePayload(value *IotThingAttributePayload) {
...
func (i *jsiiProxy_IotThing) ResetAttributePayload() {
	_jsii_.InvokeVoid(
		i,
		"resetAttributePayload",
		nil, // no parameters
...
func (i *jsiiProxy_IotThing) ResetThingName() {
	_jsii_.InvokeVoid(
		i,
		"resetThingName",
		nil, // no parameters
