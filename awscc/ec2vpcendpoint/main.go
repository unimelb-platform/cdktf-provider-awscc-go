...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.ec2VpcEndpoint.Ec2VpcEndpointDnsOptions",
		reflect.TypeOf((*Ec2VpcEndpointDnsOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2VpcEndpoint.Ec2VpcEndpointDnsOptionsOutputReference",
		reflect.TypeOf((*Ec2VpcEndpointDnsOptionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.ec2VpcEndpoint.Ec2VpcEndpointTags",
		reflect.TypeOf((*Ec2VpcEndpointTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2VpcEndpoint.Ec2VpcEndpointTagsList",
		reflect.TypeOf((*Ec2VpcEndpointTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2VpcEndpointTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
