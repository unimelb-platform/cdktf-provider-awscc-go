...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/apigatewayv2apimapping/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigatewayv2_api_mapping awscc_apigatewayv2_api_mapping}.
...
func (j *jsiiProxy_Apigatewayv2ApiMapping) ApiMappingId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiMappingId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigatewayv2_api_mapping awscc_apigatewayv2_api_mapping} Resource.
func NewApigatewayv2ApiMapping(scope constructs.Construct, id *string, config *Apigatewayv2ApiMappingConfig) Apigatewayv2ApiMapping {
	...
	_jsii_.Create(
		"awscc.apigatewayv2ApiMapping.Apigatewayv2ApiMapping",
