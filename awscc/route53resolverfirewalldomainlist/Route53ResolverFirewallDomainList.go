...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/route53resolver_firewall_domain_list awscc_route53resolver_firewall_domain_list}.
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList) CreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creationTime",
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList) CreatorRequestId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creatorRequestId",
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList) DomainCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"domainCount",
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList) DomainFileUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainFileUrl",
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList) DomainFileUrlInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainFileUrlInput",
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList) FirewallDomainListId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList) ManagedOwnerName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"managedOwnerName",
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList) ModificationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"modificationTime",
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList) StatusMessage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"statusMessage",
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList) Tags() Route53ResolverFirewallDomainListTagsList {
	var returns Route53ResolverFirewallDomainListTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/route53resolver_firewall_domain_list awscc_route53resolver_firewall_domain_list} Resource.
func NewRoute53ResolverFirewallDomainList(scope constructs.Construct, id *string, config *Route53ResolverFirewallDomainListConfig) Route53ResolverFirewallDomainList {
	...
	_jsii_.Create(
		"awscc.route53ResolverFirewallDomainList.Route53ResolverFirewallDomainList",
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList)SetDomainFileUrl(val *string) {
	if err := j.validateSetDomainFileUrlParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (r *jsiiProxy_Route53ResolverFirewallDomainList) PutTags(value interface{}) {
...
func (r *jsiiProxy_Route53ResolverFirewallDomainList) ResetDomainFileUrl() {
	_jsii_.InvokeVoid(
		r,
		"resetDomainFileUrl",
		nil, // no parameters
...
func (r *jsiiProxy_Route53ResolverFirewallDomainList) ResetName() {
	_jsii_.InvokeVoid(
		r,
		"resetName",
		nil, // no parameters
