...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2SecurityGroupIngress)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccEc2SecurityGroupIngress.DataAwsccEc2SecurityGroupIngressConfig",
		reflect.TypeOf((*DataAwsccEc2SecurityGroupIngressConfig)(nil)).Elem(),
	)
}
