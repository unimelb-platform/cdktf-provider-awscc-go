...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccApigatewayv2IntegrationResponse)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccApigatewayv2IntegrationResponse.DataAwsccApigatewayv2IntegrationResponseConfig",
		reflect.TypeOf((*DataAwsccApigatewayv2IntegrationResponseConfig)(nil)).Elem(),
	)
}
