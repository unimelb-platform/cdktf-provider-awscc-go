...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AppstreamApplication)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "appBlockArn", GoGetter: "AppBlockArn"},
			_jsii_.MemberProperty{JsiiProperty: "appBlockArnInput", GoGetter: "AppBlockArnInput"},
			_jsii_.MemberProperty{JsiiProperty: "arn", GoGetter: "Arn"},
			_jsii_.MemberProperty{JsiiProperty: "attributesToDelete", GoGetter: "AttributesToDelete"},
			_jsii_.MemberProperty{JsiiProperty: "attributesToDeleteInput", GoGetter: "AttributesToDeleteInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "iconS3LocationInput", GoGetter: "IconS3LocationInput"},
			_jsii_.MemberProperty{JsiiProperty: "id", GoGetter: "Id"},
			_jsii_.MemberMethod{JsiiMethod: "importFrom", GoMethod: "ImportFrom"},
			_jsii_.MemberProperty{JsiiProperty: "instanceFamilies", GoGetter: "InstanceFamilies"},
			_jsii_.MemberProperty{JsiiProperty: "instanceFamiliesInput", GoGetter: "InstanceFamiliesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putIconS3Location", GoMethod: "PutIconS3Location"},
			_jsii_.MemberMethod{JsiiMethod: "putTags", GoMethod: "PutTags"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetAttributesToDelete", GoMethod: "ResetAttributesToDelete"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*AppstreamApplicationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.appstreamApplication.AppstreamApplicationIconS3Location",
		reflect.TypeOf((*AppstreamApplicationIconS3Location)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.appstreamApplication.AppstreamApplicationIconS3LocationOutputReference",
		reflect.TypeOf((*AppstreamApplicationIconS3LocationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.appstreamApplication.AppstreamApplicationTags",
		reflect.TypeOf((*AppstreamApplicationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.appstreamApplication.AppstreamApplicationTagsList",
		reflect.TypeOf((*AppstreamApplicationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AppstreamApplicationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
