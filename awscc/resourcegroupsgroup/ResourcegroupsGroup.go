...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/resourcegroups_group awscc_resourcegroups_group}.
...
func (j *jsiiProxy_ResourcegroupsGroup) ResourceQueryInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"resourceQueryInput",
...
func (j *jsiiProxy_ResourcegroupsGroup) Resources() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"resources",
...
func (j *jsiiProxy_ResourcegroupsGroup) ResourcesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"resourcesInput",
...
func (j *jsiiProxy_ResourcegroupsGroup) Tags() ResourcegroupsGroupTagsList {
	var returns ResourcegroupsGroupTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/resourcegroups_group awscc_resourcegroups_group} Resource.
...
func (j *jsiiProxy_ResourcegroupsGroup)SetResources(val *[]*string) {
...
func (r *jsiiProxy_ResourcegroupsGroup) PutTags(value interface{}) {
...
func (r *jsiiProxy_ResourcegroupsGroup) ResetResources() {
	_jsii_.InvokeVoid(
		r,
		"resetResources",
		nil, // no parameters
