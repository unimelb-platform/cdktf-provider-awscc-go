...
type ResourcegroupsGroupResourceQueryOutputReference interface {
	...
	PutQuery(value *ResourcegroupsGroupResourceQueryQuery)
	ResetQuery()
	ResetType()
...
func (j *jsiiProxy_ResourcegroupsGroupResourceQueryOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ResourcegroupsGroupResourceQueryOutputReference) Query() ResourcegroupsGroupResourceQueryQueryOutputReference {
	var returns ResourcegroupsGroupResourceQueryQueryOutputReference
	_jsii_.Get(
		j,
		"query",
		&returns,
...
func (j *jsiiProxy_ResourcegroupsGroupResourceQueryOutputReference) QueryInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"queryInput",
...
func (j *jsiiProxy_ResourcegroupsGroupResourceQueryOutputReference)SetInternalValue(val interface{}) {
...
func (r *jsiiProxy_ResourcegroupsGroupResourceQueryOutputReference) PutQuery(value *ResourcegroupsGroupResourceQueryQuery) {
...
func (r *jsiiProxy_ResourcegroupsGroupResourceQueryOutputReference) ResetQuery() {
	_jsii_.InvokeVoid(
		r,
		"resetQuery",
		nil, // no parameters
