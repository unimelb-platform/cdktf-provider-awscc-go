...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/memorydb_subnet_group awscc_memorydb_subnet_group}.
...
func (j *jsiiProxy_MemorydbSubnetGroup) SubnetGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"subnetGroupName",
...
func (j *jsiiProxy_MemorydbSubnetGroup) SubnetGroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MemorydbSubnetGroup) SupportedNetworkTypes() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MemorydbSubnetGroup) Tags() MemorydbSubnetGroupTagsList {
	var returns MemorydbSubnetGroupTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_MemorydbSubnetGroup) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/memorydb_subnet_group awscc_memorydb_subnet_group} Resource.
func NewMemorydbSubnetGroup(scope constructs.Construct, id *string, config *MemorydbSubnetGroupConfig) MemorydbSubnetGroup {
	...
	_jsii_.Create(
		"awscc.memorydbSubnetGroup.MemorydbSubnetGroup",
...
func (j *jsiiProxy_MemorydbSubnetGroup)SetSubnetGroupName(val *string) {
...
func (m *jsiiProxy_MemorydbSubnetGroup) PutTags(value interface{}) {
