...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/cognito_managed_login_branding awscc_cognito_managed_login_branding}.
type CognitoManagedLoginBranding interface {
	...
	ReturnMergedResourcesInput() interface{}
	Settings() *string
...
func (j *jsiiProxy_CognitoManagedLoginBranding) Assets() CognitoManagedLoginBrandingAssetsList {
	var returns CognitoManagedLoginBrandingAssetsList
	_jsii_.Get(
		j,
		"assets",
		&returns,
...
func (j *jsiiProxy_CognitoManagedLoginBranding) AssetsInput() interface{} {
...
func (j *jsiiProxy_CognitoManagedLoginBranding) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_CognitoManagedLoginBranding) ReturnMergedResources() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CognitoManagedLoginBranding) ReturnMergedResourcesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"returnMergedResourcesInput",
		&returns,
	)
	return returns
}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/cognito_managed_login_branding awscc_cognito_managed_login_branding} Resource.
...
func (j *jsiiProxy_CognitoManagedLoginBranding)SetReturnMergedResources(val interface{}) {
...
func (c *jsiiProxy_CognitoManagedLoginBranding) PutAssets(value interface{}) {
	if err := c.validatePutAssetsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_CognitoManagedLoginBranding) ResetAssets() {
	_jsii_.InvokeVoid(
		c,
		"resetAssets",
		nil, // no parameters
...
func (c *jsiiProxy_CognitoManagedLoginBranding) ResetClientId() {
	_jsii_.InvokeVoid(
		c,
		"resetClientId",
		nil, // no parameters
...
func (c *jsiiProxy_CognitoManagedLoginBranding) ResetReturnMergedResources() {
	_jsii_.InvokeVoid(
		c,
		"resetReturnMergedResources",
		nil, // no parameters
