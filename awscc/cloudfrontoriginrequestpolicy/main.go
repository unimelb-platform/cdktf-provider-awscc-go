...
func init() {
	_jsii_.RegisterClass(
		"awscc.cloudfrontOriginRequestPolicy.CloudfrontOriginRequestPolicy",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "originRequestPolicyConfigInput", GoGetter: "OriginRequestPolicyConfigInput"},
			_jsii_.MemberMethod{JsiiMethod: "overrideLogicalId", GoMethod: "OverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putOriginRequestPolicyConfig", GoMethod: "PutOriginRequestPolicyConfig"},
	...
	_jsii_.RegisterStruct(
		"awscc.cloudfrontOriginRequestPolicy.CloudfrontOriginRequestPolicyConfig",
		reflect.TypeOf((*CloudfrontOriginRequestPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.cloudfrontOriginRequestPolicy.CloudfrontOriginRequestPolicyOriginRequestPolicyConfig",
		reflect.TypeOf((*CloudfrontOriginRequestPolicyOriginRequestPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.cloudfrontOriginRequestPolicy.CloudfrontOriginRequestPolicyOriginRequestPolicyConfigCookiesConfig",
		reflect.TypeOf((*CloudfrontOriginRequestPolicyOriginRequestPolicyConfigCookiesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.cloudfrontOriginRequestPolicy.CloudfrontOriginRequestPolicyOriginRequestPolicyConfigCookiesConfigOutputReference",
		reflect.TypeOf((*CloudfrontOriginRequestPolicyOriginRequestPolicyConfigCookiesConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.cloudfrontOriginRequestPolicy.CloudfrontOriginRequestPolicyOriginRequestPolicyConfigHeadersConfig",
		reflect.TypeOf((*CloudfrontOriginRequestPolicyOriginRequestPolicyConfigHeadersConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.cloudfrontOriginRequestPolicy.CloudfrontOriginRequestPolicyOriginRequestPolicyConfigHeadersConfigOutputReference",
		reflect.TypeOf((*CloudfrontOriginRequestPolicyOriginRequestPolicyConfigHeadersConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudfrontOriginRequestPolicyOriginRequestPolicyConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.cloudfrontOriginRequestPolicy.CloudfrontOriginRequestPolicyOriginRequestPolicyConfigQueryStringsConfig",
		reflect.TypeOf((*CloudfrontOriginRequestPolicyOriginRequestPolicyConfigQueryStringsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.cloudfrontOriginRequestPolicy.CloudfrontOriginRequestPolicyOriginRequestPolicyConfigQueryStringsConfigOutputReference",
		reflect.TypeOf((*CloudfrontOriginRequestPolicyOriginRequestPolicyConfigQueryStringsConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
		...
		func() interface{} {
			j := jsiiProxy_CloudfrontOriginRequestPolicyOriginRequestPolicyConfigQueryStringsConfigOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
