...
type CloudfrontOriginRequestPolicy interface {
	...
	PutOriginRequestPolicyConfig(value *CloudfrontOriginRequestPolicyOriginRequestPolicyConfig)
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicy) LastModifiedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lastModifiedTime",
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicy) OriginRequestPolicyConfig() CloudfrontOriginRequestPolicyOriginRequestPolicyConfigOutputReference {
	var returns CloudfrontOriginRequestPolicyOriginRequestPolicyConfigOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicy) OriginRequestPolicyConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"originRequestPolicyConfigInput",
		&returns,
	)
	return returns
}
...
func (c *jsiiProxy_CloudfrontOriginRequestPolicy) PutOriginRequestPolicyConfig(value *CloudfrontOriginRequestPolicyOriginRequestPolicyConfig) {
	if err := c.validatePutOriginRequestPolicyConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
		"putOriginRequestPolicyConfig",
		[]interface{}{value},
	)
}
