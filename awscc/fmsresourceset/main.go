...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.fmsResourceSet.FmsResourceSetConfig",
		reflect.TypeOf((*FmsResourceSetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.fmsResourceSet.FmsResourceSetTags",
		reflect.TypeOf((*FmsResourceSetTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.fmsResourceSet.FmsResourceSetTagsList",
		reflect.TypeOf((*FmsResourceSetTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FmsResourceSetTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
