...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSsmAssociation)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccSsmAssociation.DataAwsccSsmAssociationConfig",
		reflect.TypeOf((*DataAwsccSsmAssociationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccSsmAssociation.DataAwsccSsmAssociationOutputLocation",
		reflect.TypeOf((*DataAwsccSsmAssociationOutputLocation)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccSsmAssociation.DataAwsccSsmAssociationOutputLocationOutputReference",
		reflect.TypeOf((*DataAwsccSsmAssociationOutputLocationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccSsmAssociation.DataAwsccSsmAssociationOutputLocationS3Location",
		reflect.TypeOf((*DataAwsccSsmAssociationOutputLocationS3Location)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccSsmAssociation.DataAwsccSsmAssociationOutputLocationS3LocationOutputReference",
		reflect.TypeOf((*DataAwsccSsmAssociationOutputLocationS3LocationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccSsmAssociation.DataAwsccSsmAssociationTargets",
		reflect.TypeOf((*DataAwsccSsmAssociationTargets)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccSsmAssociation.DataAwsccSsmAssociationTargetsList",
		reflect.TypeOf((*DataAwsccSsmAssociationTargetsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSsmAssociationTargetsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
