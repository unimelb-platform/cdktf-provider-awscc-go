...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/athenanamedquery/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/athena_named_query awscc_athena_named_query}.
...
func (j *jsiiProxy_AthenaNamedQuery) NamedQueryId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namedQueryId",
...
func (j *jsiiProxy_AthenaNamedQuery) QueryString() *string {
	var returns *string
	_jsii_.Get(
		j,
		"queryString",
...
func (j *jsiiProxy_AthenaNamedQuery) QueryStringInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"queryStringInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/athena_named_query awscc_athena_named_query} Resource.
func NewAthenaNamedQuery(scope constructs.Construct, id *string, config *AthenaNamedQueryConfig) AthenaNamedQuery {
	...
	_jsii_.Create(
		"awscc.athenaNamedQuery.AthenaNamedQuery",
...
func (j *jsiiProxy_AthenaNamedQuery)SetQueryString(val *string) {
...
func (a *jsiiProxy_AthenaNamedQuery) ResetName() {
	_jsii_.InvokeVoid(
		a,
		"resetName",
		nil, // no parameters
