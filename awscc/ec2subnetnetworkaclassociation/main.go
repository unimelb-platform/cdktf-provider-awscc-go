...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2SubnetNetworkAclAssociation)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.ec2SubnetNetworkAclAssociation.Ec2SubnetNetworkAclAssociationConfig",
		reflect.TypeOf((*Ec2SubnetNetworkAclAssociationConfig)(nil)).Elem(),
	)
}
