...
func init() {
	_jsii_.RegisterClass(
		"awscc.appsyncDomainName.AppsyncDomainName",
	...
	_jsii_.RegisterStruct(
		"awscc.appsyncDomainName.AppsyncDomainNameConfig",
		reflect.TypeOf((*AppsyncDomainNameConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.appsyncDomainName.AppsyncDomainNameTags",
		reflect.TypeOf((*AppsyncDomainNameTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.appsyncDomainName.AppsyncDomainNameTagsList",
		reflect.TypeOf((*AppsyncDomainNameTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AppsyncDomainNameTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
