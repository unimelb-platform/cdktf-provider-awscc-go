...
func (d *jsiiProxy_DataAwsccSagemakerDomainDefaultUserSettingsJupyterLabAppSettingsCustomImagesList) validateResolveParameters(_context cdktf.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsccSagemakerDomainDefaultUserSettingsJupyterLabAppSettingsCustomImagesList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	return nil
}
...
func validateNewDataAwsccSagemakerDomainDefaultUserSettingsJupyterLabAppSettingsCustomImagesListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
	return nil
}
