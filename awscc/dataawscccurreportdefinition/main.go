...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCurReportDefinition)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccCurReportDefinition.DataAwsccCurReportDefinitionConfig",
		reflect.TypeOf((*DataAwsccCurReportDefinitionConfig)(nil)).Elem(),
	)
}
