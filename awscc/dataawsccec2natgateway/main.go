...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2NatGateway)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccEc2NatGateway.DataAwsccEc2NatGatewayConfig",
		reflect.TypeOf((*DataAwsccEc2NatGatewayConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccEc2NatGateway.DataAwsccEc2NatGatewayTags",
		reflect.TypeOf((*DataAwsccEc2NatGatewayTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccEc2NatGateway.DataAwsccEc2NatGatewayTagsList",
		reflect.TypeOf((*DataAwsccEc2NatGatewayTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2NatGatewayTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
