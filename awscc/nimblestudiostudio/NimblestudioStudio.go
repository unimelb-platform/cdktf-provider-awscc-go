...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/nimblestudio_studio awscc_nimblestudio_studio}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/nimblestudio_studio awscc_nimblestudio_studio} Resource.
...
func (n *jsiiProxy_NimblestudioStudio) HasResourceMove() interface{} {
	var returns interface{}
...
func (n *jsiiProxy_NimblestudioStudio) MoveFromId(id *string) {
...
func (n *jsiiProxy_NimblestudioStudio) MoveToId(id *string) {
...
func (n *jsiiProxy_NimblestudioStudio) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (n *jsiiProxy_NimblestudioStudio) ToHclTerraform() interface{} {
	var returns interface{}
