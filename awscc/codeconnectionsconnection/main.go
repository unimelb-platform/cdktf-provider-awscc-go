...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CodeconnectionsConnection)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CodeconnectionsConnectionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.codeconnectionsConnection.CodeconnectionsConnectionTags",
		reflect.TypeOf((*CodeconnectionsConnectionTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.codeconnectionsConnection.CodeconnectionsConnectionTagsList",
		reflect.TypeOf((*CodeconnectionsConnectionTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CodeconnectionsConnectionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
