...
func (d *jsiiProxy_DataAwsccEc2LaunchTemplateLaunchTemplateDataElasticGpuSpecificationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
