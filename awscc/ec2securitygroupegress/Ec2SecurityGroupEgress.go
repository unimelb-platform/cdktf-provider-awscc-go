...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/ec2_security_group_egress awscc_ec2_security_group_egress}.
...
func (j *jsiiProxy_Ec2SecurityGroupEgress) SecurityGroupEgressId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/ec2_security_group_egress awscc_ec2_security_group_egress} Resource.
