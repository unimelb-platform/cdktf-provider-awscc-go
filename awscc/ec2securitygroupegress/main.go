...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2SecurityGroupEgress)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.ec2SecurityGroupEgress.Ec2SecurityGroupEgressConfig",
		reflect.TypeOf((*Ec2SecurityGroupEgressConfig)(nil)).Elem(),
	)
}
