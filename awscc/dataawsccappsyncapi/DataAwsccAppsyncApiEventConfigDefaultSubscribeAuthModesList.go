...
func (j *jsiiProxy_DataAwsccAppsyncApiEventConfigDefaultSubscribeAuthModesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsccAppsyncApiEventConfigDefaultSubscribeAuthModesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccAppsyncApiEventConfigDefaultSubscribeAuthModesList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"awscc.dataAwsccAppsyncApi.DataAwsccAppsyncApiEventConfigDefaultSubscribeAuthModesList",
...
func NewDataAwsccAppsyncApiEventConfigDefaultSubscribeAuthModesList_Override(d DataAwsccAppsyncApiEventConfigDefaultSubscribeAuthModesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccAppsyncApiEventConfigDefaultSubscribeAuthModesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccAppsyncApiEventConfigDefaultSubscribeAuthModesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccAppsyncApiEventConfigDefaultSubscribeAuthModesList) Resolve(_context cdktf.IResolveContext) interface{} {
