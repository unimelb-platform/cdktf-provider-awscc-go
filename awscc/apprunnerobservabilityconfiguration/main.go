...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetObservabilityConfigurationName", GoMethod: "ResetObservabilityConfigurationName"},
	...
	_jsii_.RegisterStruct(
		"awscc.apprunnerObservabilityConfiguration.ApprunnerObservabilityConfigurationConfig",
		reflect.TypeOf((*ApprunnerObservabilityConfigurationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.apprunnerObservabilityConfiguration.ApprunnerObservabilityConfigurationTags",
		reflect.TypeOf((*ApprunnerObservabilityConfigurationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.apprunnerObservabilityConfiguration.ApprunnerObservabilityConfigurationTagsList",
		reflect.TypeOf((*ApprunnerObservabilityConfigurationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ApprunnerObservabilityConfigurationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.apprunnerObservabilityConfiguration.ApprunnerObservabilityConfigurationTraceConfiguration",
