...
func (j *jsiiProxy_ApprunnerObservabilityConfigurationTraceConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ApprunnerObservabilityConfigurationTraceConfigurationOutputReference)SetInternalValue(val interface{}) {
