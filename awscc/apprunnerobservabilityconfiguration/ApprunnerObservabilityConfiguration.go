...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apprunner_observability_configuration awscc_apprunner_observability_configuration}.
type ApprunnerObservabilityConfiguration interface {
	...
	TraceConfigurationInput() interface{}
	...
	ResetObservabilityConfigurationName()
...
func (j *jsiiProxy_ApprunnerObservabilityConfiguration) ObservabilityConfigurationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApprunnerObservabilityConfiguration) Tags() ApprunnerObservabilityConfigurationTagsList {
	var returns ApprunnerObservabilityConfigurationTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_ApprunnerObservabilityConfiguration) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_ApprunnerObservabilityConfiguration) TraceConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apprunner_observability_configuration awscc_apprunner_observability_configuration} Resource.
...
func (a *jsiiProxy_ApprunnerObservabilityConfiguration) PutTags(value interface{}) {
...
func (a *jsiiProxy_ApprunnerObservabilityConfiguration) ResetObservabilityConfigurationName() {
	_jsii_.InvokeVoid(
		a,
		"resetObservabilityConfigurationName",
		nil, // no parameters
