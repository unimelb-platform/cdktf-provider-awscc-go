...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DirectoryserviceSimpleAd)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "createAliasInput", GoGetter: "CreateAliasInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCreateAlias", GoMethod: "ResetCreateAlias"},
	...
	_jsii_.RegisterStruct(
		"awscc.directoryserviceSimpleAd.DirectoryserviceSimpleAdConfig",
		reflect.TypeOf((*DirectoryserviceSimpleAdConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.directoryserviceSimpleAd.DirectoryserviceSimpleAdVpcSettings",
		reflect.TypeOf((*DirectoryserviceSimpleAdVpcSettings)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.directoryserviceSimpleAd.DirectoryserviceSimpleAdVpcSettingsOutputReference",
		reflect.TypeOf((*DirectoryserviceSimpleAdVpcSettingsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DirectoryserviceSimpleAdVpcSettingsOutputReference{}
