...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MskBatchScramSecret)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSecretArnList", GoMethod: "ResetSecretArnList"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*MskBatchScramSecretConfig)(nil)).Elem(),
	)
}
