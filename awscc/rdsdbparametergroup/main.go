...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RdsDbParameterGroup)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.rdsDbParameterGroup.RdsDbParameterGroupConfig",
		reflect.TypeOf((*RdsDbParameterGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.rdsDbParameterGroup.RdsDbParameterGroupTags",
		reflect.TypeOf((*RdsDbParameterGroupTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.rdsDbParameterGroup.RdsDbParameterGroupTagsList",
		reflect.TypeOf((*RdsDbParameterGroupTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RdsDbParameterGroupTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
