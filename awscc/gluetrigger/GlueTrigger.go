...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/gluetrigger/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/glue_trigger awscc_glue_trigger}.
type GlueTrigger interface {
	...
	EventBatchingCondition() GlueTriggerEventBatchingConditionOutputReference
	...
	PutEventBatchingCondition(value *GlueTriggerEventBatchingCondition)
...
func (j *jsiiProxy_GlueTrigger) EventBatchingCondition() GlueTriggerEventBatchingConditionOutputReference {
...
func (j *jsiiProxy_GlueTrigger) PredicateInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"predicateInput",
...
func (j *jsiiProxy_GlueTrigger) Tags() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tags",
...
func (j *jsiiProxy_GlueTrigger) TagsInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/glue_trigger awscc_glue_trigger} Resource.
...
func (j *jsiiProxy_GlueTrigger)SetTags(val *string) {
...
func (g *jsiiProxy_GlueTrigger) PutEventBatchingCondition(value *GlueTriggerEventBatchingCondition) {
...
func (g *jsiiProxy_GlueTrigger) ResetName() {
	_jsii_.InvokeVoid(
		g,
		"resetName",
		nil, // no parameters
