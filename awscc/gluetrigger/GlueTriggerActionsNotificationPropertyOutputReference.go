...
func (j *jsiiProxy_GlueTriggerActionsNotificationPropertyOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_GlueTriggerActionsNotificationPropertyOutputReference)SetInternalValue(val interface{}) {
