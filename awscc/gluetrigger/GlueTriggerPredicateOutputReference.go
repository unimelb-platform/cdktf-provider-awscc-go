...
func (j *jsiiProxy_GlueTriggerPredicateOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_GlueTriggerPredicateOutputReference)SetInternalValue(val interface{}) {
...
func (g *jsiiProxy_GlueTriggerPredicateOutputReference) ResetConditions() {
	_jsii_.InvokeVoid(
		g,
		"resetConditions",
		nil, // no parameters
