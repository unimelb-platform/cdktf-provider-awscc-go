...
func (j *jsiiProxy_GlueTriggerActionsOutputReference) Arguments() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arguments",
...
func (j *jsiiProxy_GlueTriggerActionsOutputReference) ArgumentsInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"argumentsInput",
...
func (j *jsiiProxy_GlueTriggerActionsOutputReference) NotificationPropertyInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueTriggerActionsOutputReference)SetArguments(val *string) {
