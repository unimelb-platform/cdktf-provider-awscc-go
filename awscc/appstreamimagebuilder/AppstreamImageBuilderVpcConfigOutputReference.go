...
func (j *jsiiProxy_AppstreamImageBuilderVpcConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_AppstreamImageBuilderVpcConfigOutputReference)SetInternalValue(val interface{}) {
