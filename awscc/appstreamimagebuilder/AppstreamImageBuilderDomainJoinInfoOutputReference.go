...
func (j *jsiiProxy_AppstreamImageBuilderDomainJoinInfoOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_AppstreamImageBuilderDomainJoinInfoOutputReference)SetInternalValue(val interface{}) {
