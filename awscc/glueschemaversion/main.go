...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GlueSchemaVersion)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.glueSchemaVersion.GlueSchemaVersionConfig",
		reflect.TypeOf((*GlueSchemaVersionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.glueSchemaVersion.GlueSchemaVersionSchema",
		reflect.TypeOf((*GlueSchemaVersionSchema)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.glueSchemaVersion.GlueSchemaVersionSchemaOutputReference",
		reflect.TypeOf((*GlueSchemaVersionSchemaOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_GlueSchemaVersionSchemaOutputReference{}
