...
func (l *jsiiProxy_LakeformationPrincipalPermissionsResourceLfTagPolicyExpressionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
