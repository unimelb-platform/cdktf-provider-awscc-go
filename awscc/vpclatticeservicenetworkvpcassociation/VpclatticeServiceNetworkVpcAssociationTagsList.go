...
func (j *jsiiProxy_VpclatticeServiceNetworkVpcAssociationTagsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewVpclatticeServiceNetworkVpcAssociationTagsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VpclatticeServiceNetworkVpcAssociationTagsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"awscc.vpclatticeServiceNetworkVpcAssociation.VpclatticeServiceNetworkVpcAssociationTagsList",
...
func NewVpclatticeServiceNetworkVpcAssociationTagsList_Override(v VpclatticeServiceNetworkVpcAssociationTagsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VpclatticeServiceNetworkVpcAssociationTagsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (v *jsiiProxy_VpclatticeServiceNetworkVpcAssociationTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VpclatticeServiceNetworkVpcAssociationTagsList) Resolve(_context cdktf.IResolveContext) interface{} {
