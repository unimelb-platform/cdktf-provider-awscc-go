...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/snstopicpolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/sns_topic_policy awscc_sns_topic_policy}.
...
func (j *jsiiProxy_SnsTopicPolicy) PolicyDocument() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyDocument",
...
func (j *jsiiProxy_SnsTopicPolicy) PolicyDocumentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyDocumentInput",
...
func (j *jsiiProxy_SnsTopicPolicy) Topics() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"topics",
...
func (j *jsiiProxy_SnsTopicPolicy) TopicsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"topicsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/sns_topic_policy awscc_sns_topic_policy} Resource.
func NewSnsTopicPolicy(scope constructs.Construct, id *string, config *SnsTopicPolicyConfig) SnsTopicPolicy {
	...
	_jsii_.Create(
		"awscc.snsTopicPolicy.SnsTopicPolicy",
...
func (j *jsiiProxy_SnsTopicPolicy)SetPolicyDocument(val *string) {
...
func (j *jsiiProxy_SnsTopicPolicy)SetTopics(val *[]*string) {
