...
func (j *jsiiProxy_IotSecurityProfileAlertTargetsMap) TerraformResource() cdktf.IInterpolatingParent {
...
func NewIotSecurityProfileAlertTargetsMap(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) IotSecurityProfileAlertTargetsMap {
	_init_.Initialize()
...
func NewIotSecurityProfileAlertTargetsMap_Override(i IotSecurityProfileAlertTargetsMap, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_IotSecurityProfileAlertTargetsMap)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (i *jsiiProxy_IotSecurityProfileAlertTargetsMap) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IotSecurityProfileAlertTargetsMap) Resolve(_context cdktf.IResolveContext) interface{} {
