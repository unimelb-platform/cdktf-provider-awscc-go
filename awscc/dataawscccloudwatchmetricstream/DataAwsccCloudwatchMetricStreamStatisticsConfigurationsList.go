...
func (d *jsiiProxy_DataAwsccCloudwatchMetricStreamStatisticsConfigurationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
