...
func (d *jsiiProxy_DynamodbGlobalTable) validatePutAttributeDefinitionsParameters(value interface{}) error {
	...
	case *[]*DynamodbGlobalTableAttributeDefinitions:
		value := value.(*[]*DynamodbGlobalTableAttributeDefinitions)
	...
	case []*DynamodbGlobalTableAttributeDefinitions:
		value_ := value.([]*DynamodbGlobalTableAttributeDefinitions)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*DynamodbGlobalTableAttributeDefinitions; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DynamodbGlobalTable) validatePutGlobalSecondaryIndexesParameters(value interface{}) error {
	...
	case *[]*DynamodbGlobalTableGlobalSecondaryIndexes:
		value := value.(*[]*DynamodbGlobalTableGlobalSecondaryIndexes)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*DynamodbGlobalTableGlobalSecondaryIndexes:
		value_ := value.([]*DynamodbGlobalTableGlobalSecondaryIndexes)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (d *jsiiProxy_DynamodbGlobalTable) validatePutKeySchemaParameters(value interface{}) error {
	...
	case *[]*DynamodbGlobalTableKeySchema:
		value := value.(*[]*DynamodbGlobalTableKeySchema)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*DynamodbGlobalTableKeySchema:
		value_ := value.([]*DynamodbGlobalTableKeySchema)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*DynamodbGlobalTableKeySchema; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DynamodbGlobalTable) validatePutLocalSecondaryIndexesParameters(value interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*DynamodbGlobalTableLocalSecondaryIndexes:
		value := value.(*[]*DynamodbGlobalTableLocalSecondaryIndexes)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*DynamodbGlobalTableLocalSecondaryIndexes:
		value_ := value.([]*DynamodbGlobalTableLocalSecondaryIndexes)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*DynamodbGlobalTableLocalSecondaryIndexes; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DynamodbGlobalTable) validatePutReplicasParameters(value interface{}) error {
	...
	case *[]*DynamodbGlobalTableReplicas:
		value := value.(*[]*DynamodbGlobalTableReplicas)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*DynamodbGlobalTableReplicas:
		value_ := value.([]*DynamodbGlobalTableReplicas)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*DynamodbGlobalTableReplicas; received %#v (a %T)", value, value)
		}
	}
