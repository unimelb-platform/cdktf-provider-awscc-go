...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2CustomerGateway)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.ec2CustomerGateway.Ec2CustomerGatewayConfig",
		reflect.TypeOf((*Ec2CustomerGatewayConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.ec2CustomerGateway.Ec2CustomerGatewayTags",
		reflect.TypeOf((*Ec2CustomerGatewayTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2CustomerGateway.Ec2CustomerGatewayTagsList",
		reflect.TypeOf((*Ec2CustomerGatewayTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2CustomerGatewayTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
