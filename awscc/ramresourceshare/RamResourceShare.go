...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/ram_resource_share awscc_ram_resource_share}.
...
func (j *jsiiProxy_RamResourceShare) Principals() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"principals",
...
func (j *jsiiProxy_RamResourceShare) PrincipalsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"principalsInput",
...
func (j *jsiiProxy_RamResourceShare) ResourceArns() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"resourceArns",
...
func (j *jsiiProxy_RamResourceShare) ResourceArnsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"resourceArnsInput",
...
func (j *jsiiProxy_RamResourceShare) Sources() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"sources",
...
func (j *jsiiProxy_RamResourceShare) SourcesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"sourcesInput",
...
func (j *jsiiProxy_RamResourceShare) Tags() RamResourceShareTagsList {
	var returns RamResourceShareTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/ram_resource_share awscc_ram_resource_share} Resource.
func NewRamResourceShare(scope constructs.Construct, id *string, config *RamResourceShareConfig) RamResourceShare {
	...
	_jsii_.Create(
		"awscc.ramResourceShare.RamResourceShare",
...
func (j *jsiiProxy_RamResourceShare)SetPrincipals(val *[]*string) {
...
func (j *jsiiProxy_RamResourceShare)SetResourceArns(val *[]*string) {
...
func (j *jsiiProxy_RamResourceShare)SetSources(val *[]*string) {
...
func (r *jsiiProxy_RamResourceShare) PutTags(value interface{}) {
...
func (r *jsiiProxy_RamResourceShare) ResetPrincipals() {
	_jsii_.InvokeVoid(
		r,
		"resetPrincipals",
		nil, // no parameters
...
func (r *jsiiProxy_RamResourceShare) ResetResourceArns() {
	_jsii_.InvokeVoid(
		r,
		"resetResourceArns",
		nil, // no parameters
...
func (r *jsiiProxy_RamResourceShare) ResetSources() {
	_jsii_.InvokeVoid(
		r,
		"resetSources",
		nil, // no parameters
