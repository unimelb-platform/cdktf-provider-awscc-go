...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.ramResourceShare.RamResourceShareConfig",
		reflect.TypeOf((*RamResourceShareConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.ramResourceShare.RamResourceShareTags",
		reflect.TypeOf((*RamResourceShareTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ramResourceShare.RamResourceShareTagsList",
		reflect.TypeOf((*RamResourceShareTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RamResourceShareTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
