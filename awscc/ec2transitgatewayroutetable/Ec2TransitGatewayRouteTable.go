...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/ec2_transit_gateway_route_table awscc_ec2_transit_gateway_route_table}.
...
func (j *jsiiProxy_Ec2TransitGatewayRouteTable) Tags() Ec2TransitGatewayRouteTableTagsList {
	var returns Ec2TransitGatewayRouteTableTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_Ec2TransitGatewayRouteTable) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_Ec2TransitGatewayRouteTable) TransitGatewayRouteTableId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/ec2_transit_gateway_route_table awscc_ec2_transit_gateway_route_table} Resource.
func NewEc2TransitGatewayRouteTable(scope constructs.Construct, id *string, config *Ec2TransitGatewayRouteTableConfig) Ec2TransitGatewayRouteTable {
	...
	_jsii_.Create(
		"awscc.ec2TransitGatewayRouteTable.Ec2TransitGatewayRouteTable",
...
func (e *jsiiProxy_Ec2TransitGatewayRouteTable) PutTags(value interface{}) {
