...
type SecurityhubConfigurationPolicyConfigurationPolicyOutputReference interface {
	...
	SecurityHub() SecurityhubConfigurationPolicyConfigurationPolicySecurityHubOutputReference
	SecurityHubInput() interface{}
	// Experimental.
	...
	PutSecurityHub(value *SecurityhubConfigurationPolicyConfigurationPolicySecurityHub)
	ResetSecurityHub()
...
func (j *jsiiProxy_SecurityhubConfigurationPolicyConfigurationPolicyOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SecurityhubConfigurationPolicyConfigurationPolicyOutputReference) SecurityHub() SecurityhubConfigurationPolicyConfigurationPolicySecurityHubOutputReference {
	var returns SecurityhubConfigurationPolicyConfigurationPolicySecurityHubOutputReference
	_jsii_.Get(
		j,
		"securityHub",
		&returns,
...
func (j *jsiiProxy_SecurityhubConfigurationPolicyConfigurationPolicyOutputReference) SecurityHubInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"securityHubInput",
...
func NewSecurityhubConfigurationPolicyConfigurationPolicyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SecurityhubConfigurationPolicyConfigurationPolicyOutputReference {
	...
	_jsii_.Create(
		"awscc.securityhubConfigurationPolicy.SecurityhubConfigurationPolicyConfigurationPolicyOutputReference",
...
func (j *jsiiProxy_SecurityhubConfigurationPolicyConfigurationPolicyOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_SecurityhubConfigurationPolicyConfigurationPolicyOutputReference) PutSecurityHub(value *SecurityhubConfigurationPolicyConfigurationPolicySecurityHub) {
	if err := s.validatePutSecurityHubParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_SecurityhubConfigurationPolicyConfigurationPolicyOutputReference) ResetSecurityHub() {
	_jsii_.InvokeVoid(
		s,
		"resetSecurityHub",
		nil, // no parameters
