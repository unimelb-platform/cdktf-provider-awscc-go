...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/iam_user awscc_iam_user}.
type IamUser interface {
	...
	LoginProfile() IamUserLoginProfileOutputReference
	LoginProfileInput() interface{}
	...
	PutLoginProfile(value *IamUserLoginProfile)
...
func (j *jsiiProxy_IamUser) Groups() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"groups",
...
func (j *jsiiProxy_IamUser) GroupsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"groupsInput",
...
func (j *jsiiProxy_IamUser) LoginProfile() IamUserLoginProfileOutputReference {
	var returns IamUserLoginProfileOutputReference
	_jsii_.Get(
		j,
		"loginProfile",
		&returns,
...
func (j *jsiiProxy_IamUser) LoginProfileInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"loginProfileInput",
...
func (j *jsiiProxy_IamUser) ManagedPolicyArns() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"managedPolicyArns",
...
func (j *jsiiProxy_IamUser) ManagedPolicyArnsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IamUser) Policies() IamUserPoliciesList {
	var returns IamUserPoliciesList
	_jsii_.Get(
		j,
		"policies",
		&returns,
...
func (j *jsiiProxy_IamUser) PoliciesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"policiesInput",
...
func (j *jsiiProxy_IamUser) Tags() IamUserTagsList {
	var returns IamUserTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_IamUser) UserNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"userNameInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/iam_user awscc_iam_user} Resource.
...
func (j *jsiiProxy_IamUser)SetGroups(val *[]*string) {
...
func (j *jsiiProxy_IamUser)SetManagedPolicyArns(val *[]*string) {
...
func (j *jsiiProxy_IamUser)SetUserName(val *string) {
...
func (i *jsiiProxy_IamUser) PutLoginProfile(value *IamUserLoginProfile) {
	if err := i.validatePutLoginProfileParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		i,
...
func (i *jsiiProxy_IamUser) PutPolicies(value interface{}) {
	if err := i.validatePutPoliciesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		i,
...
func (i *jsiiProxy_IamUser) PutTags(value interface{}) {
...
func (i *jsiiProxy_IamUser) ResetGroups() {
	_jsii_.InvokeVoid(
		i,
		"resetGroups",
		nil, // no parameters
...
func (i *jsiiProxy_IamUser) ResetLoginProfile() {
	_jsii_.InvokeVoid(
		i,
		"resetLoginProfile",
		nil, // no parameters
...
func (i *jsiiProxy_IamUser) ResetManagedPolicyArns() {
	_jsii_.InvokeVoid(
		i,
		"resetManagedPolicyArns",
		nil, // no parameters
...
func (i *jsiiProxy_IamUser) ResetPolicies() {
	_jsii_.InvokeVoid(
		i,
		"resetPolicies",
		nil, // no parameters
...
func (i *jsiiProxy_IamUser) ResetUserName() {
	_jsii_.InvokeVoid(
		i,
		"resetUserName",
		nil, // no parameters
