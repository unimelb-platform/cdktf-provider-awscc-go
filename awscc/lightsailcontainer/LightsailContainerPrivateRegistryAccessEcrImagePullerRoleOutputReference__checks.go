...
func (l *jsiiProxy_LightsailContainerPrivateRegistryAccessEcrImagePullerRoleOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (l *jsiiProxy_LightsailContainerPrivateRegistryAccessEcrImagePullerRoleOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_LightsailContainerPrivateRegistryAccessEcrImagePullerRoleOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *LightsailContainerPrivateRegistryAccessEcrImagePullerRole:
		val := val.(*LightsailContainerPrivateRegistryAccessEcrImagePullerRole)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case LightsailContainerPrivateRegistryAccessEcrImagePullerRole:
		val_ := val.(LightsailContainerPrivateRegistryAccessEcrImagePullerRole)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *LightsailContainerPrivateRegistryAccessEcrImagePullerRole; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_LightsailContainerPrivateRegistryAccessEcrImagePullerRoleOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewLightsailContainerPrivateRegistryAccessEcrImagePullerRoleOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
