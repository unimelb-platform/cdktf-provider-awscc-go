...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lightsail_container awscc_lightsail_container}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lightsail_container awscc_lightsail_container} Resource.
...
func (l *jsiiProxy_LightsailContainer) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LightsailContainer) MoveFromId(id *string) {
...
func (l *jsiiProxy_LightsailContainer) MoveToId(id *string) {
...
func (l *jsiiProxy_LightsailContainer) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LightsailContainer) ToHclTerraform() interface{} {
	var returns interface{}
