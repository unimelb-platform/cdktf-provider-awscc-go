...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2GatewayRouteTableAssociation)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.ec2GatewayRouteTableAssociation.Ec2GatewayRouteTableAssociationConfig",
		reflect.TypeOf((*Ec2GatewayRouteTableAssociationConfig)(nil)).Elem(),
	)
}
