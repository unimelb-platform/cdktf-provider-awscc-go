...
func (e *jsiiProxy_EksAddon) validatePutPodIdentityAssociationsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	case cdktf.IResolvable:
		// ok
	case *[]*EksAddonPodIdentityAssociations:
		value := value.(*[]*EksAddonPodIdentityAssociations)
	...
	case []*EksAddonPodIdentityAssociations:
		value_ := value.([]*EksAddonPodIdentityAssociations)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*EksAddonPodIdentityAssociations; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_EksAddon) validatePutTagsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*EksAddonTags; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_EksAddon) validateSetPreserveOnDeleteParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
