...
func (c *jsiiProxy_CassandraTableAutoScalingSpecificationsWriteCapacityAutoScalingScalingPolicyOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (c *jsiiProxy_CassandraTableAutoScalingSpecificationsWriteCapacityAutoScalingScalingPolicyOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_CassandraTableAutoScalingSpecificationsWriteCapacityAutoScalingScalingPolicyOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *CassandraTableAutoScalingSpecificationsWriteCapacityAutoScalingScalingPolicy:
		val := val.(*CassandraTableAutoScalingSpecificationsWriteCapacityAutoScalingScalingPolicy)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CassandraTableAutoScalingSpecificationsWriteCapacityAutoScalingScalingPolicy:
		val_ := val.(CassandraTableAutoScalingSpecificationsWriteCapacityAutoScalingScalingPolicy)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *CassandraTableAutoScalingSpecificationsWriteCapacityAutoScalingScalingPolicy; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CassandraTableAutoScalingSpecificationsWriteCapacityAutoScalingScalingPolicyOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewCassandraTableAutoScalingSpecificationsWriteCapacityAutoScalingScalingPolicyOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
