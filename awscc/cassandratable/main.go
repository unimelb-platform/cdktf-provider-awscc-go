...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "cdcSpecificationInput", GoGetter: "CdcSpecificationInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putCdcSpecification", GoMethod: "PutCdcSpecification"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCdcSpecification", GoMethod: "ResetCdcSpecification"},
	...
	_jsii_.RegisterStruct(
		"awscc.cassandraTable.CassandraTableCdcSpecification",
		reflect.TypeOf((*CassandraTableCdcSpecification)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.cassandraTable.CassandraTableCdcSpecificationOutputReference",
		reflect.TypeOf((*CassandraTableCdcSpecificationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetViewType", GoMethod: "ResetViewType"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			...
			_jsii_.MemberProperty{JsiiProperty: "viewTypeInput", GoGetter: "ViewTypeInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetColumnType", GoMethod: "ResetColumnType"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
