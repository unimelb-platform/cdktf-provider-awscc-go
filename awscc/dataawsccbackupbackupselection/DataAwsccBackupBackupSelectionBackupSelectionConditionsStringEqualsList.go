...
func (d *jsiiProxy_DataAwsccBackupBackupSelectionBackupSelectionConditionsStringEqualsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
