...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.gameliftAlias.GameliftAliasRoutingStrategy",
		reflect.TypeOf((*GameliftAliasRoutingStrategy)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.gameliftAlias.GameliftAliasRoutingStrategyOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.gameliftAlias.GameliftAliasTags",
		reflect.TypeOf((*GameliftAliasTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.gameliftAlias.GameliftAliasTagsList",
		reflect.TypeOf((*GameliftAliasTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GameliftAliasTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
