...
func (j *jsiiProxy_GameliftAliasRoutingStrategyOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_GameliftAliasRoutingStrategyOutputReference)SetInternalValue(val interface{}) {
