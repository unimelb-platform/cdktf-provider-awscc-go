...
func (q *jsiiProxy_QuicksightTopicDataSetsNamedEntitiesOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (q *jsiiProxy_QuicksightTopicDataSetsNamedEntitiesOutputReference) validatePutDefinitionParameters(value interface{}) error {
	...
	case *[]*QuicksightTopicDataSetsNamedEntitiesDefinition:
		value := value.(*[]*QuicksightTopicDataSetsNamedEntitiesDefinition)
	...
	case []*QuicksightTopicDataSetsNamedEntitiesDefinition:
		value_ := value.([]*QuicksightTopicDataSetsNamedEntitiesDefinition)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*QuicksightTopicDataSetsNamedEntitiesDefinition; received %#v (a %T)", value, value)
		}
	}
...
func (q *jsiiProxy_QuicksightTopicDataSetsNamedEntitiesOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_QuicksightTopicDataSetsNamedEntitiesOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *QuicksightTopicDataSetsNamedEntities:
		val := val.(*QuicksightTopicDataSetsNamedEntities)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case QuicksightTopicDataSetsNamedEntities:
		val_ := val.(QuicksightTopicDataSetsNamedEntities)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *QuicksightTopicDataSetsNamedEntities; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_QuicksightTopicDataSetsNamedEntitiesOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewQuicksightTopicDataSetsNamedEntitiesOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
