...
func (j *jsiiProxy_MediapackageChannelHlsIngestIngestEndpointsList) InternalValue() interface{} {
...
func (j *jsiiProxy_MediapackageChannelHlsIngestIngestEndpointsList)SetInternalValue(val interface{}) {
