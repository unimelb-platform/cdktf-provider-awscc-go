...
func (j *jsiiProxy_CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference) OriginSslProtocols() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"originSslProtocols",
...
func (j *jsiiProxy_CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference) OriginSslProtocolsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func NewCloudfrontVpcOriginVpcOriginEndpointConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference {
	_init_.Initialize()

	if err := validateNewCloudfrontVpcOriginVpcOriginEndpointConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference{}

	_jsii_.Create(
		"awscc.cloudfrontVpcOrigin.CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference",
...
func NewCloudfrontVpcOriginVpcOriginEndpointConfigOutputReference_Override(c CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference)SetOriginSslProtocols(val *[]*string) {
...
func (c *jsiiProxy_CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference) ResetHttpPort() {
	_jsii_.InvokeVoid(
		c,
		"resetHttpPort",
		nil, // no parameters
...
func (c *jsiiProxy_CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference) ResetHttpsPort() {
	_jsii_.InvokeVoid(
		c,
		"resetHttpsPort",
		nil, // no parameters
...
func (c *jsiiProxy_CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference) ResetOriginProtocolPolicy() {
	_jsii_.InvokeVoid(
		c,
		"resetOriginProtocolPolicy",
		nil, // no parameters
