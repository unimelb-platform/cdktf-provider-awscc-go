...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.cloudfrontVpcOrigin.CloudfrontVpcOriginTags",
		reflect.TypeOf((*CloudfrontVpcOriginTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.cloudfrontVpcOrigin.CloudfrontVpcOriginTagsList",
		reflect.TypeOf((*CloudfrontVpcOriginTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudfrontVpcOriginTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.cloudfrontVpcOrigin.CloudfrontVpcOriginVpcOriginEndpointConfig",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetOriginProtocolPolicy", GoMethod: "ResetOriginProtocolPolicy"},
