...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/route53_hosted_zone awscc_route53_hosted_zone}.
...
func (j *jsiiProxy_Route53HostedZone) HostedZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hostedZoneId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/route53_hosted_zone awscc_route53_hosted_zone} Resource.
...
func (r *jsiiProxy_Route53HostedZone) HasResourceMove() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_Route53HostedZone) MoveFromId(id *string) {
...
func (r *jsiiProxy_Route53HostedZone) MoveToId(id *string) {
...
func (r *jsiiProxy_Route53HostedZone) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_Route53HostedZone) ToHclTerraform() interface{} {
	var returns interface{}
