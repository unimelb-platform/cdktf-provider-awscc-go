...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.networkmanagerGlobalNetwork.NetworkmanagerGlobalNetworkTags",
		reflect.TypeOf((*NetworkmanagerGlobalNetworkTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.networkmanagerGlobalNetwork.NetworkmanagerGlobalNetworkTagsList",
		reflect.TypeOf((*NetworkmanagerGlobalNetworkTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkmanagerGlobalNetworkTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
