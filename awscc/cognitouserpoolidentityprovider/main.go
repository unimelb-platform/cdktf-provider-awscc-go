...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CognitoUserPoolIdentityProvider)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.cognitoUserPoolIdentityProvider.CognitoUserPoolIdentityProviderConfig",
		reflect.TypeOf((*CognitoUserPoolIdentityProviderConfig)(nil)).Elem(),
	)
}
