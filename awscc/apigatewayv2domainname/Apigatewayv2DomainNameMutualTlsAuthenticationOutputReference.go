...
func (j *jsiiProxy_Apigatewayv2DomainNameMutualTlsAuthenticationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_Apigatewayv2DomainNameMutualTlsAuthenticationOutputReference)SetInternalValue(val interface{}) {
...
func (a *jsiiProxy_Apigatewayv2DomainNameMutualTlsAuthenticationOutputReference) ResetTruststoreUri() {
	_jsii_.InvokeVoid(
		a,
		"resetTruststoreUri",
		nil, // no parameters
