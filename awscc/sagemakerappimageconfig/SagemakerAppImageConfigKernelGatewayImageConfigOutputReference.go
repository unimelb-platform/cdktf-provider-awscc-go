...
type SagemakerAppImageConfigKernelGatewayImageConfigOutputReference interface {
	...
	FileSystemConfigInput() interface{}
	// Experimental.
	Fqn() *string
	InternalValue() interface{}
	SetInternalValue(val interface{})
	KernelSpecs() SagemakerAppImageConfigKernelGatewayImageConfigKernelSpecsList
	KernelSpecsInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_SagemakerAppImageConfigKernelGatewayImageConfigOutputReference) FileSystemConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerAppImageConfigKernelGatewayImageConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerAppImageConfigKernelGatewayImageConfigOutputReference) KernelSpecs() SagemakerAppImageConfigKernelGatewayImageConfigKernelSpecsList {
	var returns SagemakerAppImageConfigKernelGatewayImageConfigKernelSpecsList
	_jsii_.Get(
		j,
		"kernelSpecs",
		&returns,
...
func (j *jsiiProxy_SagemakerAppImageConfigKernelGatewayImageConfigOutputReference) KernelSpecsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"kernelSpecsInput",
...
func (j *jsiiProxy_SagemakerAppImageConfigKernelGatewayImageConfigOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_SagemakerAppImageConfigKernelGatewayImageConfigOutputReference) PutKernelSpecs(value interface{}) {
	if err := s.validatePutKernelSpecsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
