...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDatazoneEnvironment)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccDatazoneEnvironment{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformDataSource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccDatazoneEnvironment.DataAwsccDatazoneEnvironmentConfig",
		reflect.TypeOf((*DataAwsccDatazoneEnvironmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccDatazoneEnvironment.DataAwsccDatazoneEnvironmentUserParameters",
		reflect.TypeOf((*DataAwsccDatazoneEnvironmentUserParameters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccDatazoneEnvironment.DataAwsccDatazoneEnvironmentUserParametersList",
		reflect.TypeOf((*DataAwsccDatazoneEnvironmentUserParametersList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDatazoneEnvironmentUserParametersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
