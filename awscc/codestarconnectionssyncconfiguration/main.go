...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CodestarconnectionsSyncConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "publishDeploymentStatusInput", GoGetter: "PublishDeploymentStatusInput"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberProperty{JsiiProperty: "repositoryLinkId", GoGetter: "RepositoryLinkId"},
			_jsii_.MemberProperty{JsiiProperty: "repositoryLinkIdInput", GoGetter: "RepositoryLinkIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "repositoryName", GoGetter: "RepositoryName"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetPublishDeploymentStatus", GoMethod: "ResetPublishDeploymentStatus"},
			_jsii_.MemberMethod{JsiiMethod: "resetTriggerResourceUpdateOn", GoMethod: "ResetTriggerResourceUpdateOn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "triggerResourceUpdateOnInput", GoGetter: "TriggerResourceUpdateOnInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		"awscc.codestarconnectionsSyncConfiguration.CodestarconnectionsSyncConfigurationConfig",
		reflect.TypeOf((*CodestarconnectionsSyncConfigurationConfig)(nil)).Elem(),
	)
}
