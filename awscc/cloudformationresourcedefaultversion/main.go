...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudformationResourceDefaultVersion)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.cloudformationResourceDefaultVersion.CloudformationResourceDefaultVersionConfig",
		reflect.TypeOf((*CloudformationResourceDefaultVersionConfig)(nil)).Elem(),
	)
}
