...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/servicecatalog_service_action awscc_servicecatalog_service_action}.
...
func (j *jsiiProxy_ServicecatalogServiceAction) Definition() ServicecatalogServiceActionDefinitionList {
	var returns ServicecatalogServiceActionDefinitionList
	_jsii_.Get(
		j,
		"definition",
		&returns,
...
func (j *jsiiProxy_ServicecatalogServiceAction) DefinitionInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"definitionInput",
...
func (j *jsiiProxy_ServicecatalogServiceAction) DefinitionType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"definitionType",
...
func (j *jsiiProxy_ServicecatalogServiceAction) DefinitionTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"definitionTypeInput",
...
func (j *jsiiProxy_ServicecatalogServiceAction) ServiceActionId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceActionId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/servicecatalog_service_action awscc_servicecatalog_service_action} Resource.
func NewServicecatalogServiceAction(scope constructs.Construct, id *string, config *ServicecatalogServiceActionConfig) ServicecatalogServiceAction {
	...
	_jsii_.Create(
		"awscc.servicecatalogServiceAction.ServicecatalogServiceAction",
...
func (j *jsiiProxy_ServicecatalogServiceAction)SetDefinitionType(val *string) {
...
func (s *jsiiProxy_ServicecatalogServiceAction) PutDefinition(value interface{}) {
