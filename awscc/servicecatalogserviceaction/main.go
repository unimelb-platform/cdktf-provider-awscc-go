...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "definitionTypeInput", GoGetter: "DefinitionTypeInput"},
	...
	_jsii_.RegisterStruct(
		"awscc.servicecatalogServiceAction.ServicecatalogServiceActionDefinition",
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ServicecatalogServiceActionDefinitionList)(nil)).Elem(),
		[]_jsii_.Member{
