...
func (j *jsiiProxy_ServicecatalogServiceActionDefinitionOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ServicecatalogServiceActionDefinitionOutputReference) Key() *string {
	var returns *string
	_jsii_.Get(
		j,
		"key",
...
func (j *jsiiProxy_ServicecatalogServiceActionDefinitionOutputReference) KeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyInput",
...
func (j *jsiiProxy_ServicecatalogServiceActionDefinitionOutputReference) Value() *string {
	var returns *string
	_jsii_.Get(
		j,
		"value",
...
func (j *jsiiProxy_ServicecatalogServiceActionDefinitionOutputReference) ValueInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"valueInput",
...
func NewServicecatalogServiceActionDefinitionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ServicecatalogServiceActionDefinitionOutputReference {
	_init_.Initialize()

	if err := validateNewServicecatalogServiceActionDefinitionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ServicecatalogServiceActionDefinitionOutputReference{}

	_jsii_.Create(
		"awscc.servicecatalogServiceAction.ServicecatalogServiceActionDefinitionOutputReference",
...
func NewServicecatalogServiceActionDefinitionOutputReference_Override(s ServicecatalogServiceActionDefinitionOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServicecatalogServiceActionDefinitionOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_ServicecatalogServiceActionDefinitionOutputReference)SetKey(val *string) {
...
func (j *jsiiProxy_ServicecatalogServiceActionDefinitionOutputReference)SetValue(val *string) {
