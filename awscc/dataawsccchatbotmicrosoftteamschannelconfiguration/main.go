...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccChatbotMicrosoftTeamsChannelConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccChatbotMicrosoftTeamsChannelConfiguration.DataAwsccChatbotMicrosoftTeamsChannelConfigurationConfig",
		reflect.TypeOf((*DataAwsccChatbotMicrosoftTeamsChannelConfigurationConfig)(nil)).Elem(),
	)
}
