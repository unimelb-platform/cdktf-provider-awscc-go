...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CodeartifactRepositoryTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.codeartifactRepository.CodeartifactRepositoryTagsList",
		reflect.TypeOf((*CodeartifactRepositoryTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CodeartifactRepositoryTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
