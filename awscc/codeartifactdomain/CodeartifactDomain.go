...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/codeartifact_domain awscc_codeartifact_domain}.
...
func (j *jsiiProxy_CodeartifactDomain) DomainName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainName",
...
func (j *jsiiProxy_CodeartifactDomain) DomainNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainNameInput",
...
func (j *jsiiProxy_CodeartifactDomain) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CodeartifactDomain) PermissionsPolicyDocument() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CodeartifactDomain) PermissionsPolicyDocumentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CodeartifactDomain) Tags() CodeartifactDomainTagsList {
	var returns CodeartifactDomainTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/codeartifact_domain awscc_codeartifact_domain} Resource.
func NewCodeartifactDomain(scope constructs.Construct, id *string, config *CodeartifactDomainConfig) CodeartifactDomain {
	...
	_jsii_.Create(
		"awscc.codeartifactDomain.CodeartifactDomain",
...
func (j *jsiiProxy_CodeartifactDomain)SetDomainName(val *string) {
...
func (j *jsiiProxy_CodeartifactDomain)SetPermissionsPolicyDocument(val *string) {
...
func (c *jsiiProxy_CodeartifactDomain) PutTags(value interface{}) {
...
func (c *jsiiProxy_CodeartifactDomain) ResetPermissionsPolicyDocument() {
	_jsii_.InvokeVoid(
		c,
		"resetPermissionsPolicyDocument",
		nil, // no parameters
