...
type Ec2LaunchTemplateLaunchTemplateDataHibernationOptions struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/ec2_launch_template#configured Ec2LaunchTemplate#configured}
