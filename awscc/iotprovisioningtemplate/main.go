...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTemplateType", GoMethod: "ResetTemplateType"},
	...
	_jsii_.RegisterStruct(
		"awscc.iotProvisioningTemplate.IotProvisioningTemplatePreProvisioningHook",
	...
	_jsii_.RegisterStruct(
		"awscc.iotProvisioningTemplate.IotProvisioningTemplateTags",
		reflect.TypeOf((*IotProvisioningTemplateTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.iotProvisioningTemplate.IotProvisioningTemplateTagsList",
		reflect.TypeOf((*IotProvisioningTemplateTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IotProvisioningTemplateTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
