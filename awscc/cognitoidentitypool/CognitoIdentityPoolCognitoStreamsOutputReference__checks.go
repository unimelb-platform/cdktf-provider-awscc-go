...
func (c *jsiiProxy_CognitoIdentityPoolCognitoStreamsOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (c *jsiiProxy_CognitoIdentityPoolCognitoStreamsOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_CognitoIdentityPoolCognitoStreamsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *CognitoIdentityPoolCognitoStreams:
		val := val.(*CognitoIdentityPoolCognitoStreams)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CognitoIdentityPoolCognitoStreams:
		val_ := val.(CognitoIdentityPoolCognitoStreams)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *CognitoIdentityPoolCognitoStreams; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CognitoIdentityPoolCognitoStreamsOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewCognitoIdentityPoolCognitoStreamsOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
