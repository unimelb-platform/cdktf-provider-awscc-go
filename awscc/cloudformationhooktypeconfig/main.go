...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudformationHookTypeConfig)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "configurationAliasInput", GoGetter: "ConfigurationAliasInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetConfigurationAlias", GoMethod: "ResetConfigurationAlias"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetTypeArn", GoMethod: "ResetTypeArn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "typeArnInput", GoGetter: "TypeArnInput"},
	...
	_jsii_.RegisterStruct(
		"awscc.cloudformationHookTypeConfig.CloudformationHookTypeConfigConfig",
		reflect.TypeOf((*CloudformationHookTypeConfigConfig)(nil)).Elem(),
	)
}
