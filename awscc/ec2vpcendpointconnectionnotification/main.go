...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2VpcEndpointConnectionNotification)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.ec2VpcEndpointConnectionNotification.Ec2VpcEndpointConnectionNotificationConfig",
		reflect.TypeOf((*Ec2VpcEndpointConnectionNotificationConfig)(nil)).Elem(),
	)
}
