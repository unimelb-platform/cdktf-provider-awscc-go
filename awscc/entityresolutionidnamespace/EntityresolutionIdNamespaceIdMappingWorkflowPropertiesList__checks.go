...
func (e *jsiiProxy_EntityresolutionIdNamespaceIdMappingWorkflowPropertiesList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_EntityresolutionIdNamespaceIdMappingWorkflowPropertiesList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewEntityresolutionIdNamespaceIdMappingWorkflowPropertiesListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
