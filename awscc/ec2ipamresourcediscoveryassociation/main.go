...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2IpamResourceDiscoveryAssociation)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*Ec2IpamResourceDiscoveryAssociationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.ec2IpamResourceDiscoveryAssociation.Ec2IpamResourceDiscoveryAssociationTags",
		reflect.TypeOf((*Ec2IpamResourceDiscoveryAssociationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2IpamResourceDiscoveryAssociation.Ec2IpamResourceDiscoveryAssociationTagsList",
		reflect.TypeOf((*Ec2IpamResourceDiscoveryAssociationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2IpamResourceDiscoveryAssociationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
