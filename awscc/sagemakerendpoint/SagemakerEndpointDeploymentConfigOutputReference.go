...
type SagemakerEndpointDeploymentConfigOutputReference interface {
	...
	BlueGreenUpdatePolicyInput() interface{}
...
func (j *jsiiProxy_SagemakerEndpointDeploymentConfigOutputReference) AutoRollbackConfigurationInput() interface{} {
...
func (j *jsiiProxy_SagemakerEndpointDeploymentConfigOutputReference) BlueGreenUpdatePolicyInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerEndpointDeploymentConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerEndpointDeploymentConfigOutputReference) RollingUpdatePolicyInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerEndpointDeploymentConfigOutputReference)SetInternalValue(val interface{}) {
