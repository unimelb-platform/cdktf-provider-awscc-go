...
type SagemakerEndpointDeploymentConfigBlueGreenUpdatePolicyOutputReference interface {
	...
	TrafficRoutingConfigurationInput() interface{}
	// Experimental.
	ComputeFqn() *string
	// Experimental.
	...
	ResetTrafficRoutingConfiguration()
...
func (j *jsiiProxy_SagemakerEndpointDeploymentConfigBlueGreenUpdatePolicyOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerEndpointDeploymentConfigBlueGreenUpdatePolicyOutputReference) TrafficRoutingConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerEndpointDeploymentConfigBlueGreenUpdatePolicyOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_SagemakerEndpointDeploymentConfigBlueGreenUpdatePolicyOutputReference) ResetTrafficRoutingConfiguration() {
	_jsii_.InvokeVoid(
		s,
		"resetTrafficRoutingConfiguration",
		nil, // no parameters
