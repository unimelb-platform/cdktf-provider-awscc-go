...
func (j *jsiiProxy_SagemakerEndpointDeploymentConfigRollingUpdatePolicyOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerEndpointDeploymentConfigRollingUpdatePolicyOutputReference) MaximumBatchSizeInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerEndpointDeploymentConfigRollingUpdatePolicyOutputReference) RollbackMaximumBatchSizeInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerEndpointDeploymentConfigRollingUpdatePolicyOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_SagemakerEndpointDeploymentConfigRollingUpdatePolicyOutputReference) ResetMaximumBatchSize() {
	_jsii_.InvokeVoid(
		s,
		"resetMaximumBatchSize",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerEndpointDeploymentConfigRollingUpdatePolicyOutputReference) ResetWaitIntervalInSeconds() {
	_jsii_.InvokeVoid(
		s,
		"resetWaitIntervalInSeconds",
		nil, // no parameters
