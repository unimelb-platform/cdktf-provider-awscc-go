...
func (j *jsiiProxy_QuicksightDataSetLogicalTableMapOutputReference) SourceInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"sourceInput",
...
func NewQuicksightDataSetLogicalTableMapOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectKey *string) QuicksightDataSetLogicalTableMapOutputReference {
	_init_.Initialize()

	if err := validateNewQuicksightDataSetLogicalTableMapOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectKey); err != nil {
		panic(err)
	}
...
func NewQuicksightDataSetLogicalTableMapOutputReference_Override(q QuicksightDataSetLogicalTableMapOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectKey *string) {
	_init_.Initialize()
...
func (q *jsiiProxy_QuicksightDataSetLogicalTableMapOutputReference) ResetAlias() {
	_jsii_.InvokeVoid(
		q,
		"resetAlias",
		nil, // no parameters
...
func (q *jsiiProxy_QuicksightDataSetLogicalTableMapOutputReference) ResetSource() {
	_jsii_.InvokeVoid(
		q,
		"resetSource",
		nil, // no parameters
