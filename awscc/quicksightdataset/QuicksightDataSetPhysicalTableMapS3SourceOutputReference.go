...
func (j *jsiiProxy_QuicksightDataSetPhysicalTableMapS3SourceOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_QuicksightDataSetPhysicalTableMapS3SourceOutputReference) UploadSettingsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"uploadSettingsInput",
...
func (j *jsiiProxy_QuicksightDataSetPhysicalTableMapS3SourceOutputReference)SetInternalValue(val interface{}) {
...
func (q *jsiiProxy_QuicksightDataSetPhysicalTableMapS3SourceOutputReference) ResetUploadSettings() {
	_jsii_.InvokeVoid(
		q,
		"resetUploadSettings",
		nil, // no parameters
