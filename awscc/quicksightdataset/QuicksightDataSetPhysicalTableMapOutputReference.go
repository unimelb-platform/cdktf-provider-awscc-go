...
func (j *jsiiProxy_QuicksightDataSetPhysicalTableMapOutputReference) CustomSqlInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"customSqlInput",
...
func (j *jsiiProxy_QuicksightDataSetPhysicalTableMapOutputReference) RelationalTableInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_QuicksightDataSetPhysicalTableMapOutputReference) S3SourceInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"s3SourceInput",
...
func NewQuicksightDataSetPhysicalTableMapOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectKey *string) QuicksightDataSetPhysicalTableMapOutputReference {
	_init_.Initialize()

	if err := validateNewQuicksightDataSetPhysicalTableMapOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectKey); err != nil {
		panic(err)
	}
...
func NewQuicksightDataSetPhysicalTableMapOutputReference_Override(q QuicksightDataSetPhysicalTableMapOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectKey *string) {
	_init_.Initialize()
