...
func (j *jsiiProxy_QuicksightDataSetRowLevelPermissionDataSetOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_QuicksightDataSetRowLevelPermissionDataSetOutputReference)SetInternalValue(val interface{}) {
