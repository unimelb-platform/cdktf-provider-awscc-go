...
type QuicksightDataSetLogicalTableMapSourceOutputReference interface {
	...
	JoinInstructionInput() interface{}
...
func (j *jsiiProxy_QuicksightDataSetLogicalTableMapSourceOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_QuicksightDataSetLogicalTableMapSourceOutputReference) JoinInstructionInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_QuicksightDataSetLogicalTableMapSourceOutputReference)SetInternalValue(val interface{}) {
