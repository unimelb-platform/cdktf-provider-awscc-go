...
func (j *jsiiProxy_QuicksightDataSetDataSetUsageConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_QuicksightDataSetDataSetUsageConfigurationOutputReference)SetInternalValue(val interface{}) {
