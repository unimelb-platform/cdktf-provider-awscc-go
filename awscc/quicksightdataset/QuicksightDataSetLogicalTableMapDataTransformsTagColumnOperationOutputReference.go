...
func (j *jsiiProxy_QuicksightDataSetLogicalTableMapDataTransformsTagColumnOperationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_QuicksightDataSetLogicalTableMapDataTransformsTagColumnOperationOutputReference)SetInternalValue(val interface{}) {
