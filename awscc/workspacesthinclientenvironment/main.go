...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "deviceCreationTagsInput", GoGetter: "DeviceCreationTagsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putDeviceCreationTags", GoMethod: "PutDeviceCreationTags"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDeviceCreationTags", GoMethod: "ResetDeviceCreationTags"},
	...
	_jsii_.RegisterStruct(
		"awscc.workspacesthinclientEnvironment.WorkspacesthinclientEnvironmentDeviceCreationTags",
		reflect.TypeOf((*WorkspacesthinclientEnvironmentDeviceCreationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.workspacesthinclientEnvironment.WorkspacesthinclientEnvironmentDeviceCreationTagsList",
		reflect.TypeOf((*WorkspacesthinclientEnvironmentDeviceCreationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WorkspacesthinclientEnvironmentDeviceCreationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
