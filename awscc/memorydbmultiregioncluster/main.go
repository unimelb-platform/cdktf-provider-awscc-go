...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMultiRegionClusterNameSuffix", GoMethod: "ResetMultiRegionClusterNameSuffix"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MemorydbMultiRegionClusterTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
