...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/elasticache_subnet_group awscc_elasticache_subnet_group}.
...
func (j *jsiiProxy_ElasticacheSubnetGroup) CacheSubnetGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ElasticacheSubnetGroup) CacheSubnetGroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ElasticacheSubnetGroup) Tags() ElasticacheSubnetGroupTagsList {
	var returns ElasticacheSubnetGroupTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/elasticache_subnet_group awscc_elasticache_subnet_group} Resource.
...
func (j *jsiiProxy_ElasticacheSubnetGroup)SetCacheSubnetGroupName(val *string) {
...
func (e *jsiiProxy_ElasticacheSubnetGroup) PutTags(value interface{}) {
...
func (e *jsiiProxy_ElasticacheSubnetGroup) ResetCacheSubnetGroupName() {
	_jsii_.InvokeVoid(
		e,
		"resetCacheSubnetGroupName",
		nil, // no parameters
