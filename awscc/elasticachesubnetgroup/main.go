...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.elasticacheSubnetGroup.ElasticacheSubnetGroupConfig",
		reflect.TypeOf((*ElasticacheSubnetGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.elasticacheSubnetGroup.ElasticacheSubnetGroupTags",
		reflect.TypeOf((*ElasticacheSubnetGroupTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.elasticacheSubnetGroup.ElasticacheSubnetGroupTagsList",
		reflect.TypeOf((*ElasticacheSubnetGroupTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ElasticacheSubnetGroupTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
