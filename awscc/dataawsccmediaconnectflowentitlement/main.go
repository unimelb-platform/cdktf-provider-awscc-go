...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccMediaconnectFlowEntitlement)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccMediaconnectFlowEntitlement.DataAwsccMediaconnectFlowEntitlementConfig",
		reflect.TypeOf((*DataAwsccMediaconnectFlowEntitlementConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccMediaconnectFlowEntitlement.DataAwsccMediaconnectFlowEntitlementEncryption",
		reflect.TypeOf((*DataAwsccMediaconnectFlowEntitlementEncryption)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccMediaconnectFlowEntitlement.DataAwsccMediaconnectFlowEntitlementEncryptionOutputReference",
		reflect.TypeOf((*DataAwsccMediaconnectFlowEntitlementEncryptionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
