...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.locationGeofenceCollection.LocationGeofenceCollectionConfig",
		reflect.TypeOf((*LocationGeofenceCollectionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.locationGeofenceCollection.LocationGeofenceCollectionTags",
		reflect.TypeOf((*LocationGeofenceCollectionTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.locationGeofenceCollection.LocationGeofenceCollectionTagsList",
		reflect.TypeOf((*LocationGeofenceCollectionTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LocationGeofenceCollectionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
