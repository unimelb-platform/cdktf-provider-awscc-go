...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "recoveryModeInput", GoGetter: "RecoveryModeInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetRecoveryMode", GoMethod: "ResetRecoveryMode"},
	...
	_jsii_.RegisterStruct(
		"awscc.sagemakerApp.SagemakerAppConfig",
		reflect.TypeOf((*SagemakerAppConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.sagemakerApp.SagemakerAppResourceSpec",
		reflect.TypeOf((*SagemakerAppResourceSpec)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.sagemakerApp.SagemakerAppResourceSpecOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.sagemakerApp.SagemakerAppTags",
		reflect.TypeOf((*SagemakerAppTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.sagemakerApp.SagemakerAppTagsList",
		reflect.TypeOf((*SagemakerAppTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SagemakerAppTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
