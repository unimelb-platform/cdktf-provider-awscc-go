...
func (j *jsiiProxy_SagemakerAppResourceSpecOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerAppResourceSpecOutputReference)SetInternalValue(val interface{}) {
