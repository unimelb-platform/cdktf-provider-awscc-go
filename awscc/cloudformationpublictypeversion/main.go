...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudformationPublicTypeVersion)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "logDeliveryBucketInput", GoGetter: "LogDeliveryBucketInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "publicVersionNumberInput", GoGetter: "PublicVersionNumberInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLogDeliveryBucket", GoMethod: "ResetLogDeliveryBucket"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetPublicVersionNumber", GoMethod: "ResetPublicVersionNumber"},
	...
	_jsii_.RegisterStruct(
		"awscc.cloudformationPublicTypeVersion.CloudformationPublicTypeVersionConfig",
		reflect.TypeOf((*CloudformationPublicTypeVersionConfig)(nil)).Elem(),
	)
}
