...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccApigatewayv2RouteResponse)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccApigatewayv2RouteResponseConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccApigatewayv2RouteResponse.DataAwsccApigatewayv2RouteResponseResponseParameters",
		reflect.TypeOf((*DataAwsccApigatewayv2RouteResponseResponseParameters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccApigatewayv2RouteResponse.DataAwsccApigatewayv2RouteResponseResponseParametersMap",
		reflect.TypeOf((*DataAwsccApigatewayv2RouteResponseResponseParametersMap)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccApigatewayv2RouteResponseResponseParametersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
