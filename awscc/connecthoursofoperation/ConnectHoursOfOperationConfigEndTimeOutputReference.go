...
func (j *jsiiProxy_ConnectHoursOfOperationConfigEndTimeOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ConnectHoursOfOperationConfigEndTimeOutputReference)SetInternalValue(val interface{}) {
