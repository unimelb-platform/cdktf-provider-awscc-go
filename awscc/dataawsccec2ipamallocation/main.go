...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2IpamAllocation)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccEc2IpamAllocation.DataAwsccEc2IpamAllocationConfig",
		reflect.TypeOf((*DataAwsccEc2IpamAllocationConfig)(nil)).Elem(),
	)
}
