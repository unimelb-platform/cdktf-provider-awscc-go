...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "keyGroupConfigInput", GoGetter: "KeyGroupConfigInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putKeyGroupConfig", GoMethod: "PutKeyGroupConfig"},
	...
	_jsii_.RegisterStruct(
		"awscc.cloudfrontKeyGroup.CloudfrontKeyGroupConfig",
		reflect.TypeOf((*CloudfrontKeyGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.cloudfrontKeyGroup.CloudfrontKeyGroupKeyGroupConfig",
		reflect.TypeOf((*CloudfrontKeyGroupKeyGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.cloudfrontKeyGroup.CloudfrontKeyGroupKeyGroupConfigOutputReference",
		reflect.TypeOf((*CloudfrontKeyGroupKeyGroupConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_CloudfrontKeyGroupKeyGroupConfigOutputReference{}
