...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/cloudfrontkeygroup/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/cloudfront_key_group awscc_cloudfront_key_group}.
type CloudfrontKeyGroup interface {
	...
	Id() *string
	KeyGroupConfig() CloudfrontKeyGroupKeyGroupConfigOutputReference
	KeyGroupConfigInput() interface{}
	KeyGroupId() *string
	...
	PutKeyGroupConfig(value *CloudfrontKeyGroupKeyGroupConfig)
...
func (j *jsiiProxy_CloudfrontKeyGroup) KeyGroupConfig() CloudfrontKeyGroupKeyGroupConfigOutputReference {
	var returns CloudfrontKeyGroupKeyGroupConfigOutputReference
	_jsii_.Get(
		j,
		"keyGroupConfig",
		&returns,
...
func (j *jsiiProxy_CloudfrontKeyGroup) KeyGroupConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"keyGroupConfigInput",
...
func (j *jsiiProxy_CloudfrontKeyGroup) KeyGroupId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyGroupId",
...
func (j *jsiiProxy_CloudfrontKeyGroup) LastModifiedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lastModifiedTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/cloudfront_key_group awscc_cloudfront_key_group} Resource.
func NewCloudfrontKeyGroup(scope constructs.Construct, id *string, config *CloudfrontKeyGroupConfig) CloudfrontKeyGroup {
	...
	_jsii_.Create(
		"awscc.cloudfrontKeyGroup.CloudfrontKeyGroup",
...
func (c *jsiiProxy_CloudfrontKeyGroup) PutKeyGroupConfig(value *CloudfrontKeyGroupKeyGroupConfig) {
	if err := c.validatePutKeyGroupConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
