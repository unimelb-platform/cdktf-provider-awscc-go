...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/sagemakerimageversion/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/sagemaker_image_version awscc_sagemaker_image_version}.
...
func (j *jsiiProxy_SagemakerImageVersion) Alias() *string {
	var returns *string
	_jsii_.Get(
		j,
		"alias",
...
func (j *jsiiProxy_SagemakerImageVersion) AliasInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"aliasInput",
...
func (j *jsiiProxy_SagemakerImageVersion) ImageVersionArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"imageVersionArn",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/sagemaker_image_version awscc_sagemaker_image_version} Resource.
func NewSagemakerImageVersion(scope constructs.Construct, id *string, config *SagemakerImageVersionConfig) SagemakerImageVersion {
	...
	_jsii_.Create(
		"awscc.sagemakerImageVersion.SagemakerImageVersion",
...
func (j *jsiiProxy_SagemakerImageVersion)SetAlias(val *string) {
...
func (s *jsiiProxy_SagemakerImageVersion) ResetAlias() {
	_jsii_.InvokeVoid(
		s,
		"resetAlias",
		nil, // no parameters
