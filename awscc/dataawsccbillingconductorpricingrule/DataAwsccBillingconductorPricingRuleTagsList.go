...
func (j *jsiiProxy_DataAwsccBillingconductorPricingRuleTagsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsccBillingconductorPricingRuleTagsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccBillingconductorPricingRuleTagsList {
	_init_.Initialize()
...
func NewDataAwsccBillingconductorPricingRuleTagsList_Override(d DataAwsccBillingconductorPricingRuleTagsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccBillingconductorPricingRuleTagsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccBillingconductorPricingRuleTagsList) Resolve(_context cdktf.IResolveContext) interface{} {
