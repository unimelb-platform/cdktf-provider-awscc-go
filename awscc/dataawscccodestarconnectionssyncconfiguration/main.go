...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCodestarconnectionsSyncConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccCodestarconnectionsSyncConfiguration.DataAwsccCodestarconnectionsSyncConfigurationConfig",
		reflect.TypeOf((*DataAwsccCodestarconnectionsSyncConfigurationConfig)(nil)).Elem(),
	)
}
