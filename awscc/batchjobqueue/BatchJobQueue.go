...
func (j *jsiiProxy_BatchJobQueue) JobQueueArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"jobQueueArn",
...
func (j *jsiiProxy_BatchJobQueue) JobQueueName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"jobQueueName",
...
func (j *jsiiProxy_BatchJobQueue) JobQueueNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"jobQueueNameInput",
...
func (j *jsiiProxy_BatchJobQueue)SetJobQueueName(val *string) {
	if err := j.validateSetJobQueueNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (b *jsiiProxy_BatchJobQueue) ResetState() {
	_jsii_.InvokeVoid(
		b,
		"resetState",
		nil, // no parameters
