...
func init() {
	_jsii_.RegisterClass(
		"awscc.datasyncLocationSmb.DatasyncLocationSmb",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dnsIpAddressesInput", GoGetter: "DnsIpAddressesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDnsIpAddresses", GoMethod: "ResetDnsIpAddresses"},
	...
	_jsii_.RegisterStruct(
		"awscc.datasyncLocationSmb.DatasyncLocationSmbConfig",
		reflect.TypeOf((*DatasyncLocationSmbConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.datasyncLocationSmb.DatasyncLocationSmbMountOptions",
		reflect.TypeOf((*DatasyncLocationSmbMountOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.datasyncLocationSmb.DatasyncLocationSmbMountOptionsOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.datasyncLocationSmb.DatasyncLocationSmbTags",
		reflect.TypeOf((*DatasyncLocationSmbTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.datasyncLocationSmb.DatasyncLocationSmbTagsList",
		reflect.TypeOf((*DatasyncLocationSmbTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DatasyncLocationSmbTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
