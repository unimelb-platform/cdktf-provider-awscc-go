...
func (j *jsiiProxy_DatasyncLocationSmb) LocationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationArn",
...
func (j *jsiiProxy_DatasyncLocationSmb) LocationUri() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationUri",
...
func (j *jsiiProxy_DatasyncLocationSmb) MountOptionsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"mountOptionsInput",
...
func (j *jsiiProxy_DatasyncLocationSmb) Tags() DatasyncLocationSmbTagsList {
	var returns DatasyncLocationSmbTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (d *jsiiProxy_DatasyncLocationSmb) PutTags(value interface{}) {
...
func (d *jsiiProxy_DatasyncLocationSmb) ResetPassword() {
	_jsii_.InvokeVoid(
		d,
		"resetPassword",
		nil, // no parameters
...
func (d *jsiiProxy_DatasyncLocationSmb) ResetServerHostname() {
	_jsii_.InvokeVoid(
		d,
		"resetServerHostname",
		nil, // no parameters
...
func (d *jsiiProxy_DatasyncLocationSmb) ResetSubdirectory() {
	_jsii_.InvokeVoid(
		d,
		"resetSubdirectory",
		nil, // no parameters
