...
func (j *jsiiProxy_DatasyncLocationSmbMountOptionsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_DatasyncLocationSmbMountOptionsOutputReference)SetInternalValue(val interface{}) {
