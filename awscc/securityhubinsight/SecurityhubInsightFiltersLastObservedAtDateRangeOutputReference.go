...
func (j *jsiiProxy_SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewSecurityhubInsightFiltersLastObservedAtDateRangeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference {
	...
	_jsii_.Create(
		"awscc.securityhubInsight.SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference",
...
func (j *jsiiProxy_SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference) ResetUnit() {
	_jsii_.InvokeVoid(
		s,
		"resetUnit",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference) ResetValue() {
	_jsii_.InvokeVoid(
		s,
		"resetValue",
		nil, // no parameters
