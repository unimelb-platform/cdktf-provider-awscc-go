...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/securityhub_insight awscc_securityhub_insight}.
...
func (j *jsiiProxy_SecurityhubInsight) FiltersInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"filtersInput",
...
func (j *jsiiProxy_SecurityhubInsight) InsightArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"insightArn",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/securityhub_insight awscc_securityhub_insight} Resource.
func NewSecurityhubInsight(scope constructs.Construct, id *string, config *SecurityhubInsightConfig) SecurityhubInsight {
	...
	_jsii_.Create(
		"awscc.securityhubInsight.SecurityhubInsight",
