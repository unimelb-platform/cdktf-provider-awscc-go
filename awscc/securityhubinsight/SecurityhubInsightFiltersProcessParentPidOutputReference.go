...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessParentPidOutputReference) Eq() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"eq",
...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessParentPidOutputReference) EqInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"eqInput",
...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessParentPidOutputReference) Gte() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"gte",
...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessParentPidOutputReference) GteInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"gteInput",
...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessParentPidOutputReference) Lte() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"lte",
...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessParentPidOutputReference) LteInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"lteInput",
...
func NewSecurityhubInsightFiltersProcessParentPidOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SecurityhubInsightFiltersProcessParentPidOutputReference {
	...
	_jsii_.Create(
		"awscc.securityhubInsight.SecurityhubInsightFiltersProcessParentPidOutputReference",
...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessParentPidOutputReference)SetEq(val *float64) {
...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessParentPidOutputReference)SetGte(val *float64) {
...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessParentPidOutputReference)SetLte(val *float64) {
