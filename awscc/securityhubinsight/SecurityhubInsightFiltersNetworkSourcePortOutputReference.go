...
func (j *jsiiProxy_SecurityhubInsightFiltersNetworkSourcePortOutputReference) Eq() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"eq",
...
func (j *jsiiProxy_SecurityhubInsightFiltersNetworkSourcePortOutputReference) EqInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"eqInput",
...
func (j *jsiiProxy_SecurityhubInsightFiltersNetworkSourcePortOutputReference) Gte() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"gte",
...
func (j *jsiiProxy_SecurityhubInsightFiltersNetworkSourcePortOutputReference) GteInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"gteInput",
...
func (j *jsiiProxy_SecurityhubInsightFiltersNetworkSourcePortOutputReference) Lte() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"lte",
...
func (j *jsiiProxy_SecurityhubInsightFiltersNetworkSourcePortOutputReference) LteInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"lteInput",
...
func NewSecurityhubInsightFiltersNetworkSourcePortOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SecurityhubInsightFiltersNetworkSourcePortOutputReference {
	...
	_jsii_.Create(
		"awscc.securityhubInsight.SecurityhubInsightFiltersNetworkSourcePortOutputReference",
...
func (j *jsiiProxy_SecurityhubInsightFiltersNetworkSourcePortOutputReference)SetEq(val *float64) {
...
func (j *jsiiProxy_SecurityhubInsightFiltersNetworkSourcePortOutputReference)SetGte(val *float64) {
...
func (j *jsiiProxy_SecurityhubInsightFiltersNetworkSourcePortOutputReference)SetLte(val *float64) {
