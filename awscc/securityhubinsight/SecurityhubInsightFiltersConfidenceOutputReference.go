...
func (j *jsiiProxy_SecurityhubInsightFiltersConfidenceOutputReference) Eq() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"eq",
...
func (j *jsiiProxy_SecurityhubInsightFiltersConfidenceOutputReference) EqInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"eqInput",
...
func (j *jsiiProxy_SecurityhubInsightFiltersConfidenceOutputReference) Gte() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"gte",
...
func (j *jsiiProxy_SecurityhubInsightFiltersConfidenceOutputReference) GteInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"gteInput",
...
func (j *jsiiProxy_SecurityhubInsightFiltersConfidenceOutputReference) Lte() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"lte",
...
func (j *jsiiProxy_SecurityhubInsightFiltersConfidenceOutputReference) LteInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"lteInput",
...
func NewSecurityhubInsightFiltersConfidenceOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SecurityhubInsightFiltersConfidenceOutputReference {
	...
	_jsii_.Create(
		"awscc.securityhubInsight.SecurityhubInsightFiltersConfidenceOutputReference",
...
func (j *jsiiProxy_SecurityhubInsightFiltersConfidenceOutputReference)SetEq(val *float64) {
...
func (j *jsiiProxy_SecurityhubInsightFiltersConfidenceOutputReference)SetGte(val *float64) {
...
func (j *jsiiProxy_SecurityhubInsightFiltersConfidenceOutputReference)SetLte(val *float64) {
