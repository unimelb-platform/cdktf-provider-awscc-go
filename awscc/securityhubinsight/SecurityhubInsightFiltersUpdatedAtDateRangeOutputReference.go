...
func (j *jsiiProxy_SecurityhubInsightFiltersUpdatedAtDateRangeOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewSecurityhubInsightFiltersUpdatedAtDateRangeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SecurityhubInsightFiltersUpdatedAtDateRangeOutputReference {
	...
	_jsii_.Create(
		"awscc.securityhubInsight.SecurityhubInsightFiltersUpdatedAtDateRangeOutputReference",
...
func (j *jsiiProxy_SecurityhubInsightFiltersUpdatedAtDateRangeOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_SecurityhubInsightFiltersUpdatedAtDateRangeOutputReference) ResetUnit() {
	_jsii_.InvokeVoid(
		s,
		"resetUnit",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityhubInsightFiltersUpdatedAtDateRangeOutputReference) ResetValue() {
	_jsii_.InvokeVoid(
		s,
		"resetValue",
		nil, // no parameters
