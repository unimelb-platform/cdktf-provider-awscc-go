...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/cloudfront_response_headers_policy awscc_cloudfront_response_headers_policy}.
type CloudfrontResponseHeadersPolicy interface {
	...
	ResponseHeadersPolicyConfig() CloudfrontResponseHeadersPolicyResponseHeadersPolicyConfigOutputReference
	ResponseHeadersPolicyConfigInput() interface{}
	...
	PutResponseHeadersPolicyConfig(value *CloudfrontResponseHeadersPolicyResponseHeadersPolicyConfig)
...
func (j *jsiiProxy_CloudfrontResponseHeadersPolicy) LastModifiedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lastModifiedTime",
...
func (j *jsiiProxy_CloudfrontResponseHeadersPolicy) ResponseHeadersPolicyConfig() CloudfrontResponseHeadersPolicyResponseHeadersPolicyConfigOutputReference {
	var returns CloudfrontResponseHeadersPolicyResponseHeadersPolicyConfigOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudfrontResponseHeadersPolicy) ResponseHeadersPolicyConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"responseHeadersPolicyConfigInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CloudfrontResponseHeadersPolicy) ResponseHeadersPolicyId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/cloudfront_response_headers_policy awscc_cloudfront_response_headers_policy} Resource.
...
func (c *jsiiProxy_CloudfrontResponseHeadersPolicy) PutResponseHeadersPolicyConfig(value *CloudfrontResponseHeadersPolicyResponseHeadersPolicyConfig) {
	if err := c.validatePutResponseHeadersPolicyConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
		"putResponseHeadersPolicyConfig",
		[]interface{}{value},
	)
}
