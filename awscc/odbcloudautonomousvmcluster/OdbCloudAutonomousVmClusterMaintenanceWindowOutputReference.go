...
func (j *jsiiProxy_OdbCloudAutonomousVmClusterMaintenanceWindowOutputReference) DaysOfWeek() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"daysOfWeek",
...
func (j *jsiiProxy_OdbCloudAutonomousVmClusterMaintenanceWindowOutputReference) DaysOfWeekInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"daysOfWeekInput",
...
func (j *jsiiProxy_OdbCloudAutonomousVmClusterMaintenanceWindowOutputReference) Months() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"months",
...
func (j *jsiiProxy_OdbCloudAutonomousVmClusterMaintenanceWindowOutputReference) MonthsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"monthsInput",
...
func NewOdbCloudAutonomousVmClusterMaintenanceWindowOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) OdbCloudAutonomousVmClusterMaintenanceWindowOutputReference {
	_init_.Initialize()

	if err := validateNewOdbCloudAutonomousVmClusterMaintenanceWindowOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewOdbCloudAutonomousVmClusterMaintenanceWindowOutputReference_Override(o OdbCloudAutonomousVmClusterMaintenanceWindowOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_OdbCloudAutonomousVmClusterMaintenanceWindowOutputReference)SetDaysOfWeek(val *[]*string) {
...
func (j *jsiiProxy_OdbCloudAutonomousVmClusterMaintenanceWindowOutputReference)SetMonths(val *[]*string) {
...
func (o *jsiiProxy_OdbCloudAutonomousVmClusterMaintenanceWindowOutputReference) ResetPreference() {
	_jsii_.InvokeVoid(
		o,
		"resetPreference",
		nil, // no parameters
