...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PersonalizeDataset)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "datasetImportJobInput", GoGetter: "DatasetImportJobInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putDatasetImportJob", GoMethod: "PutDatasetImportJob"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetDatasetImportJob", GoMethod: "ResetDatasetImportJob"},
	...
	_jsii_.RegisterStruct(
		"awscc.personalizeDataset.PersonalizeDatasetConfig",
		reflect.TypeOf((*PersonalizeDatasetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.personalizeDataset.PersonalizeDatasetDatasetImportJob",
		reflect.TypeOf((*PersonalizeDatasetDatasetImportJob)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.personalizeDataset.PersonalizeDatasetDatasetImportJobDataSource",
		reflect.TypeOf((*PersonalizeDatasetDatasetImportJobDataSource)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.personalizeDataset.PersonalizeDatasetDatasetImportJobDataSourceOutputReference",
		reflect.TypeOf((*PersonalizeDatasetDatasetImportJobDataSourceOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_PersonalizeDatasetDatasetImportJobDataSourceOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PersonalizeDatasetDatasetImportJobOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "datasetImportJobArn", GoGetter: "DatasetImportJobArn"},
			_jsii_.MemberProperty{JsiiProperty: "datasetImportJobArnInput", GoGetter: "DatasetImportJobArnInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDatasetImportJobArn", GoMethod: "ResetDatasetImportJobArn"},
