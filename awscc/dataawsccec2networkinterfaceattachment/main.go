...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2NetworkInterfaceAttachment)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccEc2NetworkInterfaceAttachment.DataAwsccEc2NetworkInterfaceAttachmentConfig",
		reflect.TypeOf((*DataAwsccEc2NetworkInterfaceAttachmentConfig)(nil)).Elem(),
	)
}
