...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSnsSubscription)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccSnsSubscription.DataAwsccSnsSubscriptionConfig",
		reflect.TypeOf((*DataAwsccSnsSubscriptionConfig)(nil)).Elem(),
	)
}
