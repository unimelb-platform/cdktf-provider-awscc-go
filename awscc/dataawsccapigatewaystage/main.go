...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccApigatewayStage)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccApigatewayStage.DataAwsccApigatewayStageAccessLogSetting",
		reflect.TypeOf((*DataAwsccApigatewayStageAccessLogSetting)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccApigatewayStage.DataAwsccApigatewayStageAccessLogSettingOutputReference",
		reflect.TypeOf((*DataAwsccApigatewayStageAccessLogSettingOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccApigatewayStageCanarySetting)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccApigatewayStage.DataAwsccApigatewayStageCanarySettingOutputReference",
		reflect.TypeOf((*DataAwsccApigatewayStageCanarySettingOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccApigatewayStage.DataAwsccApigatewayStageConfig",
		reflect.TypeOf((*DataAwsccApigatewayStageConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccApigatewayStage.DataAwsccApigatewayStageMethodSettings",
		reflect.TypeOf((*DataAwsccApigatewayStageMethodSettings)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccApigatewayStage.DataAwsccApigatewayStageMethodSettingsList",
		reflect.TypeOf((*DataAwsccApigatewayStageMethodSettingsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		"awscc.dataAwsccApigatewayStage.DataAwsccApigatewayStageMethodSettingsOutputReference",
		reflect.TypeOf((*DataAwsccApigatewayStageMethodSettingsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccApigatewayStageMethodSettingsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccApigatewayStage.DataAwsccApigatewayStageTags",
		reflect.TypeOf((*DataAwsccApigatewayStageTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccApigatewayStage.DataAwsccApigatewayStageTagsList",
		reflect.TypeOf((*DataAwsccApigatewayStageTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccApigatewayStageTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
