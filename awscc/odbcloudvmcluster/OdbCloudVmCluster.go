...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/odb_cloud_vm_cluster awscc_odb_cloud_vm_cluster}.
type OdbCloudVmCluster interface {
	...
	DataCollectionOptions() OdbCloudVmClusterDataCollectionOptionsOutputReference
	...
	PutDataCollectionOptions(value *OdbCloudVmClusterDataCollectionOptions)
...
func (j *jsiiProxy_OdbCloudVmCluster) CloudVmClusterArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cloudVmClusterArn",
...
func (j *jsiiProxy_OdbCloudVmCluster) CloudVmClusterId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cloudVmClusterId",
...
func (j *jsiiProxy_OdbCloudVmCluster) DataCollectionOptions() OdbCloudVmClusterDataCollectionOptionsOutputReference {
...
func (j *jsiiProxy_OdbCloudVmCluster) Hostname() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hostname",
...
func (j *jsiiProxy_OdbCloudVmCluster) HostnameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hostnameInput",
...
func (j *jsiiProxy_OdbCloudVmCluster) SystemVersionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"systemVersionInput",
...
func (j *jsiiProxy_OdbCloudVmCluster) Tags() OdbCloudVmClusterTagsList {
	var returns OdbCloudVmClusterTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_OdbCloudVmCluster) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/odb_cloud_vm_cluster awscc_odb_cloud_vm_cluster} Resource.
...
func (j *jsiiProxy_OdbCloudVmCluster)SetHostname(val *string) {
...
func (j *jsiiProxy_OdbCloudVmCluster)SetSystemVersion(val *string) {
...
func (o *jsiiProxy_OdbCloudVmCluster) PutDataCollectionOptions(value *OdbCloudVmClusterDataCollectionOptions) {
...
func (o *jsiiProxy_OdbCloudVmCluster) PutTags(value interface{}) {
...
func (o *jsiiProxy_OdbCloudVmCluster) ResetCpuCoreCount() {
	_jsii_.InvokeVoid(
		o,
		"resetCpuCoreCount",
		nil, // no parameters
...
func (o *jsiiProxy_OdbCloudVmCluster) ResetDbServers() {
	_jsii_.InvokeVoid(
		o,
		"resetDbServers",
		nil, // no parameters
...
func (o *jsiiProxy_OdbCloudVmCluster) ResetDisplayName() {
	_jsii_.InvokeVoid(
		o,
		"resetDisplayName",
		nil, // no parameters
...
func (o *jsiiProxy_OdbCloudVmCluster) ResetGiVersion() {
	_jsii_.InvokeVoid(
		o,
		"resetGiVersion",
		nil, // no parameters
...
func (o *jsiiProxy_OdbCloudVmCluster) ResetHostname() {
	_jsii_.InvokeVoid(
		o,
		"resetHostname",
		nil, // no parameters
...
func (o *jsiiProxy_OdbCloudVmCluster) ResetSshPublicKeys() {
	_jsii_.InvokeVoid(
		o,
		"resetSshPublicKeys",
		nil, // no parameters
...
func (o *jsiiProxy_OdbCloudVmCluster) ResetSystemVersion() {
	_jsii_.InvokeVoid(
		o,
		"resetSystemVersion",
		nil, // no parameters
