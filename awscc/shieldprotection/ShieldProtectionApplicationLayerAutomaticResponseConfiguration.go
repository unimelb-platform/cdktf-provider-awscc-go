...
type ShieldProtectionApplicationLayerAutomaticResponseConfiguration struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/shield_protection#action ShieldProtection#action}
	Action *ShieldProtectionApplicationLayerAutomaticResponseConfigurationAction `field:"optional" json:"action" yaml:"action"`
	// Indicates whether automatic application layer DDoS mitigation is enabled for the protection.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/shield_protection#status ShieldProtection#status}
