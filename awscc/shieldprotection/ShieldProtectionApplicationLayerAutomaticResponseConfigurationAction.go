...
type ShieldProtectionApplicationLayerAutomaticResponseConfigurationAction struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/shield_protection#block ShieldProtection#block}
	...
	// You must specify exactly one action, either `Block` or `Count`.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/shield_protection#count ShieldProtection#count}
