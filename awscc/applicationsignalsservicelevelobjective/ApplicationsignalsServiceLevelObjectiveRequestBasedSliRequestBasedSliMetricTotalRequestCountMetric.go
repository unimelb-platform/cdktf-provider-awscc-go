...
type ApplicationsignalsServiceLevelObjectiveRequestBasedSliRequestBasedSliMetricTotalRequestCountMetric struct {
	...
	MetricStat *ApplicationsignalsServiceLevelObjectiveRequestBasedSliRequestBasedSliMetricTotalRequestCountMetricMetricStat `field:"optional" json:"metricStat" yaml:"metricStat"`
