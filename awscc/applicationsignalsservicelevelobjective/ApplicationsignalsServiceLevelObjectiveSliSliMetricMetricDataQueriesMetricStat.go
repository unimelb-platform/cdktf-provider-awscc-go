...
type ApplicationsignalsServiceLevelObjectiveSliSliMetricMetricDataQueriesMetricStat struct {
	...
	Metric *ApplicationsignalsServiceLevelObjectiveSliSliMetricMetricDataQueriesMetricStatMetric `field:"optional" json:"metric" yaml:"metric"`
