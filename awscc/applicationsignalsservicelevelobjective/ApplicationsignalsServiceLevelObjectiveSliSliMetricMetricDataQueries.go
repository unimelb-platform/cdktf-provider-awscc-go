...
type ApplicationsignalsServiceLevelObjectiveSliSliMetricMetricDataQueries struct {
	...
	MetricStat *ApplicationsignalsServiceLevelObjectiveSliSliMetricMetricDataQueriesMetricStat `field:"optional" json:"metricStat" yaml:"metricStat"`
