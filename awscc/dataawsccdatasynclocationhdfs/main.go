...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDatasyncLocationHdfs)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccDatasyncLocationHdfs.DataAwsccDatasyncLocationHdfsConfig",
		reflect.TypeOf((*DataAwsccDatasyncLocationHdfsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccDatasyncLocationHdfs.DataAwsccDatasyncLocationHdfsNameNodes",
		reflect.TypeOf((*DataAwsccDatasyncLocationHdfsNameNodes)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccDatasyncLocationHdfs.DataAwsccDatasyncLocationHdfsNameNodesList",
		reflect.TypeOf((*DataAwsccDatasyncLocationHdfsNameNodesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		"awscc.dataAwsccDatasyncLocationHdfs.DataAwsccDatasyncLocationHdfsNameNodesOutputReference",
		reflect.TypeOf((*DataAwsccDatasyncLocationHdfsNameNodesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccDatasyncLocationHdfsNameNodesOutputReference{}
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccDatasyncLocationHdfsQopConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccDatasyncLocationHdfs.DataAwsccDatasyncLocationHdfsQopConfigurationOutputReference",
		reflect.TypeOf((*DataAwsccDatasyncLocationHdfsQopConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccDatasyncLocationHdfsQopConfigurationOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccDatasyncLocationHdfsTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccDatasyncLocationHdfs.DataAwsccDatasyncLocationHdfsTagsList",
		reflect.TypeOf((*DataAwsccDatasyncLocationHdfsTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDatasyncLocationHdfsTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
