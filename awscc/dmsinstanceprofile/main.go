...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DmsInstanceProfile)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "instanceProfileCreationTime", GoGetter: "InstanceProfileCreationTime"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSubnetGroupIdentifier", GoMethod: "ResetSubnetGroupIdentifier"},
			...
			_jsii_.MemberProperty{JsiiProperty: "subnetGroupIdentifierInput", GoGetter: "SubnetGroupIdentifierInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DmsInstanceProfileConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dmsInstanceProfile.DmsInstanceProfileTags",
		reflect.TypeOf((*DmsInstanceProfileTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dmsInstanceProfile.DmsInstanceProfileTagsList",
		reflect.TypeOf((*DmsInstanceProfileTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DmsInstanceProfileTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
