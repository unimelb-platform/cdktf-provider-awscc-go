...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CognitoIdentityPoolPrincipalTag)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.cognitoIdentityPoolPrincipalTag.CognitoIdentityPoolPrincipalTagConfig",
		reflect.TypeOf((*CognitoIdentityPoolPrincipalTagConfig)(nil)).Elem(),
	)
}
