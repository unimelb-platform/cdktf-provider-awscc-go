...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/cognito_identity_pool_principal_tag awscc_cognito_identity_pool_principal_tag}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/cognito_identity_pool_principal_tag awscc_cognito_identity_pool_principal_tag} Resource.
...
func (c *jsiiProxy_CognitoIdentityPoolPrincipalTag) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CognitoIdentityPoolPrincipalTag) MoveFromId(id *string) {
...
func (c *jsiiProxy_CognitoIdentityPoolPrincipalTag) MoveToId(id *string) {
...
func (c *jsiiProxy_CognitoIdentityPoolPrincipalTag) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CognitoIdentityPoolPrincipalTag) ToHclTerraform() interface{} {
	var returns interface{}
