...
type Kinesisanalyticsv2ApplicationApplicationConfigurationApplicationCodeConfigurationCodeContentOutputReference interface {
	...
	SetZipFileContent(val *string)
	ZipFileContentInput() *string
	// Experimental.
	ComputeFqn() *string
	// Experimental.
...
func (j *jsiiProxy_Kinesisanalyticsv2ApplicationApplicationConfigurationApplicationCodeConfigurationCodeContentOutputReference) S3ContentLocationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Kinesisanalyticsv2ApplicationApplicationConfigurationApplicationCodeConfigurationCodeContentOutputReference) ZipFileContent() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zipFileContent",
...
func (j *jsiiProxy_Kinesisanalyticsv2ApplicationApplicationConfigurationApplicationCodeConfigurationCodeContentOutputReference) ZipFileContentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zipFileContentInput",
...
func (j *jsiiProxy_Kinesisanalyticsv2ApplicationApplicationConfigurationApplicationCodeConfigurationCodeContentOutputReference)SetZipFileContent(val *string) {
	if err := j.validateSetZipFileContentParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (k *jsiiProxy_Kinesisanalyticsv2ApplicationApplicationConfigurationApplicationCodeConfigurationCodeContentOutputReference) ResetZipFileContent() {
	_jsii_.InvokeVoid(
		k,
		"resetZipFileContent",
		nil, // no parameters
