...
func (k *jsiiProxy_Kinesisanalyticsv2ApplicationApplicationConfigurationVpcConfigurationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
