...
func (k *jsiiProxy_Kinesisanalyticsv2ApplicationApplicationConfigurationSqlApplicationConfigurationInputsInputSchemaRecordColumnsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
