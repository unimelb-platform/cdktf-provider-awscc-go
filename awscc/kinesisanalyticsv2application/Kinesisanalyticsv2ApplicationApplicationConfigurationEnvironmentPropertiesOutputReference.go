...
type Kinesisanalyticsv2ApplicationApplicationConfigurationEnvironmentPropertiesOutputReference interface {
	...
	PropertyGroups() Kinesisanalyticsv2ApplicationApplicationConfigurationEnvironmentPropertiesPropertyGroupsList
	PropertyGroupsInput() interface{}
	// Experimental.
	...
	PutPropertyGroups(value interface{})
	ResetPropertyGroups()
...
func (j *jsiiProxy_Kinesisanalyticsv2ApplicationApplicationConfigurationEnvironmentPropertiesOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_Kinesisanalyticsv2ApplicationApplicationConfigurationEnvironmentPropertiesOutputReference) PropertyGroups() Kinesisanalyticsv2ApplicationApplicationConfigurationEnvironmentPropertiesPropertyGroupsList {
	var returns Kinesisanalyticsv2ApplicationApplicationConfigurationEnvironmentPropertiesPropertyGroupsList
	_jsii_.Get(
		j,
		"propertyGroups",
		&returns,
...
func (j *jsiiProxy_Kinesisanalyticsv2ApplicationApplicationConfigurationEnvironmentPropertiesOutputReference) PropertyGroupsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"propertyGroupsInput",
...
func (j *jsiiProxy_Kinesisanalyticsv2ApplicationApplicationConfigurationEnvironmentPropertiesOutputReference)SetInternalValue(val interface{}) {
...
func (k *jsiiProxy_Kinesisanalyticsv2ApplicationApplicationConfigurationEnvironmentPropertiesOutputReference) PutPropertyGroups(value interface{}) {
	if err := k.validatePutPropertyGroupsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		k,
...
func (k *jsiiProxy_Kinesisanalyticsv2ApplicationApplicationConfigurationEnvironmentPropertiesOutputReference) ResetPropertyGroups() {
	_jsii_.InvokeVoid(
		k,
		"resetPropertyGroups",
		nil, // no parameters
