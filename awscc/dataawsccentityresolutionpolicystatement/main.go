...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEntityresolutionPolicyStatement)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccEntityresolutionPolicyStatement.DataAwsccEntityresolutionPolicyStatementConfig",
		reflect.TypeOf((*DataAwsccEntityresolutionPolicyStatementConfig)(nil)).Elem(),
	)
}
