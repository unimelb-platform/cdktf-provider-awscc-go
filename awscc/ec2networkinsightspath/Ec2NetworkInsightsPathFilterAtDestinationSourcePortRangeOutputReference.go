...
func (j *jsiiProxy_Ec2NetworkInsightsPathFilterAtDestinationSourcePortRangeOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_Ec2NetworkInsightsPathFilterAtDestinationSourcePortRangeOutputReference)SetInternalValue(val interface{}) {
