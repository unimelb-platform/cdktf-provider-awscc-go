...
func (j *jsiiProxy_Ec2NetworkInsightsPathFilterAtSourceSourcePortRangeOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_Ec2NetworkInsightsPathFilterAtSourceSourcePortRangeOutputReference)SetInternalValue(val interface{}) {
