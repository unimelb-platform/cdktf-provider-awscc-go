...
func (j *jsiiProxy_Ec2NetworkInsightsPathFilterAtSourceOutputReference) DestinationPortRangeInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ec2NetworkInsightsPathFilterAtSourceOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_Ec2NetworkInsightsPathFilterAtSourceOutputReference) SourcePortRangeInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ec2NetworkInsightsPathFilterAtSourceOutputReference)SetInternalValue(val interface{}) {
