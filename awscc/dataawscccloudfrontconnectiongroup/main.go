...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCloudfrontConnectionGroup)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccCloudfrontConnectionGroup{}
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccCloudfrontConnectionGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccCloudfrontConnectionGroup.DataAwsccCloudfrontConnectionGroupTags",
		reflect.TypeOf((*DataAwsccCloudfrontConnectionGroupTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccCloudfrontConnectionGroup.DataAwsccCloudfrontConnectionGroupTagsList",
		reflect.TypeOf((*DataAwsccCloudfrontConnectionGroupTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCloudfrontConnectionGroupTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
