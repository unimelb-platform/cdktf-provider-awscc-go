...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lightsail_alarm awscc_lightsail_alarm}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lightsail_alarm awscc_lightsail_alarm} Resource.
...
func (l *jsiiProxy_LightsailAlarm) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LightsailAlarm) MoveFromId(id *string) {
...
func (l *jsiiProxy_LightsailAlarm) MoveToId(id *string) {
...
func (l *jsiiProxy_LightsailAlarm) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LightsailAlarm) ToHclTerraform() interface{} {
	var returns interface{}
