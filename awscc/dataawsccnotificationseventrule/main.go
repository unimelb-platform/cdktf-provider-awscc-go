...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccNotificationsEventRule)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "statusSummaryByRegion", GoGetter: "StatusSummaryByRegion"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccNotificationsEventRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccNotificationsEventRule.DataAwsccNotificationsEventRuleStatusSummaryByRegion",
		reflect.TypeOf((*DataAwsccNotificationsEventRuleStatusSummaryByRegion)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccNotificationsEventRule.DataAwsccNotificationsEventRuleStatusSummaryByRegionMap",
		reflect.TypeOf((*DataAwsccNotificationsEventRuleStatusSummaryByRegionMap)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccNotificationsEventRuleStatusSummaryByRegionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
