...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.vpclatticeService.VpclatticeServiceConfig",
		reflect.TypeOf((*VpclatticeServiceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.vpclatticeService.VpclatticeServiceDnsEntry",
		reflect.TypeOf((*VpclatticeServiceDnsEntry)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.vpclatticeService.VpclatticeServiceDnsEntryOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.vpclatticeService.VpclatticeServiceTags",
		reflect.TypeOf((*VpclatticeServiceTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.vpclatticeService.VpclatticeServiceTagsList",
		reflect.TypeOf((*VpclatticeServiceTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VpclatticeServiceTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
