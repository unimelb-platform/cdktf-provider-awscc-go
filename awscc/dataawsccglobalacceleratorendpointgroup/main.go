...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccGlobalacceleratorEndpointGroup)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccGlobalacceleratorEndpointGroup.DataAwsccGlobalacceleratorEndpointGroupConfig",
		reflect.TypeOf((*DataAwsccGlobalacceleratorEndpointGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccGlobalacceleratorEndpointGroup.DataAwsccGlobalacceleratorEndpointGroupEndpointConfigurations",
		reflect.TypeOf((*DataAwsccGlobalacceleratorEndpointGroupEndpointConfigurations)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccGlobalacceleratorEndpointGroup.DataAwsccGlobalacceleratorEndpointGroupEndpointConfigurationsList",
		reflect.TypeOf((*DataAwsccGlobalacceleratorEndpointGroupEndpointConfigurationsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccGlobalacceleratorEndpointGroupEndpointConfigurationsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccGlobalacceleratorEndpointGroupPortOverrides)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccGlobalacceleratorEndpointGroup.DataAwsccGlobalacceleratorEndpointGroupPortOverridesList",
		reflect.TypeOf((*DataAwsccGlobalacceleratorEndpointGroupPortOverridesList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccGlobalacceleratorEndpointGroupPortOverridesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
