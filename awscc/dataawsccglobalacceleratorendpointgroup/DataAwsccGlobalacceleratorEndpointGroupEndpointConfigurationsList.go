...
func (d *jsiiProxy_DataAwsccGlobalacceleratorEndpointGroupEndpointConfigurationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
