...
func NewQuicksightCustomPermissionsCapabilitiesOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) QuicksightCustomPermissionsCapabilitiesOutputReference {
	_init_.Initialize()
...
func NewQuicksightCustomPermissionsCapabilitiesOutputReference_Override(q QuicksightCustomPermissionsCapabilitiesOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
