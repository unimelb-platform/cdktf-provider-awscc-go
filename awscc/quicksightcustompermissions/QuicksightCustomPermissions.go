...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/quicksight_custom_permissions awscc_quicksight_custom_permissions}.
type QuicksightCustomPermissions interface {
	...
	PutCapabilities(value *QuicksightCustomPermissionsCapabilities)
...
func (j *jsiiProxy_QuicksightCustomPermissions) Capabilities() QuicksightCustomPermissionsCapabilitiesOutputReference {
...
func (j *jsiiProxy_QuicksightCustomPermissions) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_QuicksightCustomPermissions) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_QuicksightCustomPermissions) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_QuicksightCustomPermissions) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_QuicksightCustomPermissions) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_QuicksightCustomPermissions) Tags() QuicksightCustomPermissionsTagsList {
	var returns QuicksightCustomPermissionsTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_QuicksightCustomPermissions) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_QuicksightCustomPermissions) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/quicksight_custom_permissions awscc_quicksight_custom_permissions} Resource.
func NewQuicksightCustomPermissions(scope constructs.Construct, id *string, config *QuicksightCustomPermissionsConfig) QuicksightCustomPermissions {
	...
	_jsii_.Create(
		"awscc.quicksightCustomPermissions.QuicksightCustomPermissions",
...
func (j *jsiiProxy_QuicksightCustomPermissions)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_QuicksightCustomPermissions)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_QuicksightCustomPermissions)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func QuicksightCustomPermissions_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (q *jsiiProxy_QuicksightCustomPermissions) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightCustomPermissions) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (q *jsiiProxy_QuicksightCustomPermissions) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightCustomPermissions) PutCapabilities(value *QuicksightCustomPermissionsCapabilities) {
...
func (q *jsiiProxy_QuicksightCustomPermissions) PutTags(value interface{}) {
