...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2TransitGatewayMulticastDomainAssociation)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccEc2TransitGatewayMulticastDomainAssociationConfig)(nil)).Elem(),
	)
}
