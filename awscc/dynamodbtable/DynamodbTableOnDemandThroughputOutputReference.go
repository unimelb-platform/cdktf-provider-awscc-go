...
func (j *jsiiProxy_DynamodbTableOnDemandThroughputOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_DynamodbTableOnDemandThroughputOutputReference)SetInternalValue(val interface{}) {
...
func (d *jsiiProxy_DynamodbTableOnDemandThroughputOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DynamodbTableOnDemandThroughputOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
