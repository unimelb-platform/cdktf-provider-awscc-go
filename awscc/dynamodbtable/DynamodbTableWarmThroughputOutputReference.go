...
func (j *jsiiProxy_DynamodbTableWarmThroughputOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_DynamodbTableWarmThroughputOutputReference)SetInternalValue(val interface{}) {
