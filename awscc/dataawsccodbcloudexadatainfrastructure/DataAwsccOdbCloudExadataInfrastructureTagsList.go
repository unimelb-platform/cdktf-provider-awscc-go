...
func (j *jsiiProxy_DataAwsccOdbCloudExadataInfrastructureTagsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsccOdbCloudExadataInfrastructureTagsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccOdbCloudExadataInfrastructureTagsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"awscc.dataAwsccOdbCloudExadataInfrastructure.DataAwsccOdbCloudExadataInfrastructureTagsList",
...
func NewDataAwsccOdbCloudExadataInfrastructureTagsList_Override(d DataAwsccOdbCloudExadataInfrastructureTagsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccOdbCloudExadataInfrastructureTagsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccOdbCloudExadataInfrastructureTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccOdbCloudExadataInfrastructureTagsList) Resolve(_context cdktf.IResolveContext) interface{} {
