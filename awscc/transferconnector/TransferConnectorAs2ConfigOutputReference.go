...
type TransferConnectorAs2ConfigOutputReference interface {
	...
	SetBasicAuthSecretId(val *string)
	BasicAuthSecretIdInput() *string
...
func (j *jsiiProxy_TransferConnectorAs2ConfigOutputReference) BasicAuthSecretId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"basicAuthSecretId",
...
func (j *jsiiProxy_TransferConnectorAs2ConfigOutputReference) BasicAuthSecretIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"basicAuthSecretIdInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_TransferConnectorAs2ConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_TransferConnectorAs2ConfigOutputReference)SetBasicAuthSecretId(val *string) {
	if err := j.validateSetBasicAuthSecretIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_TransferConnectorAs2ConfigOutputReference)SetInternalValue(val interface{}) {
...
func (t *jsiiProxy_TransferConnectorAs2ConfigOutputReference) ResetBasicAuthSecretId() {
	_jsii_.InvokeVoid(
		t,
		"resetBasicAuthSecretId",
		nil, // no parameters
...
func (t *jsiiProxy_TransferConnectorAs2ConfigOutputReference) ResetCompression() {
	_jsii_.InvokeVoid(
		t,
		"resetCompression",
		nil, // no parameters
...
func (t *jsiiProxy_TransferConnectorAs2ConfigOutputReference) ResetEncryptionAlgorithm() {
	_jsii_.InvokeVoid(
		t,
		"resetEncryptionAlgorithm",
		nil, // no parameters
...
func (t *jsiiProxy_TransferConnectorAs2ConfigOutputReference) ResetLocalProfileId() {
	_jsii_.InvokeVoid(
		t,
		"resetLocalProfileId",
		nil, // no parameters
...
func (t *jsiiProxy_TransferConnectorAs2ConfigOutputReference) ResetMdnResponse() {
	_jsii_.InvokeVoid(
		t,
		"resetMdnResponse",
		nil, // no parameters
...
func (t *jsiiProxy_TransferConnectorAs2ConfigOutputReference) ResetPartnerProfileId() {
	_jsii_.InvokeVoid(
		t,
		"resetPartnerProfileId",
		nil, // no parameters
...
func (t *jsiiProxy_TransferConnectorAs2ConfigOutputReference) ResetSigningAlgorithm() {
	_jsii_.InvokeVoid(
		t,
		"resetSigningAlgorithm",
		nil, // no parameters
