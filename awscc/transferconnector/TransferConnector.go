...
func (j *jsiiProxy_TransferConnector) As2ConfigInput() interface{} {
...
func (j *jsiiProxy_TransferConnector) SftpConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"sftpConfigInput",
...
func (j *jsiiProxy_TransferConnector) Tags() TransferConnectorTagsList {
	var returns TransferConnectorTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_TransferConnector) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (t *jsiiProxy_TransferConnector) PutTags(value interface{}) {
