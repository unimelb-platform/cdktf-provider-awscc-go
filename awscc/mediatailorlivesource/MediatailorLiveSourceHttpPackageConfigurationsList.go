...
func (j *jsiiProxy_MediatailorLiveSourceHttpPackageConfigurationsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewMediatailorLiveSourceHttpPackageConfigurationsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MediatailorLiveSourceHttpPackageConfigurationsList {
	_init_.Initialize()
...
func NewMediatailorLiveSourceHttpPackageConfigurationsList_Override(m MediatailorLiveSourceHttpPackageConfigurationsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MediatailorLiveSourceHttpPackageConfigurationsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (m *jsiiProxy_MediatailorLiveSourceHttpPackageConfigurationsList) Resolve(_context cdktf.IResolveContext) interface{} {
