...
func (j *jsiiProxy_MemorydbUserAuthenticationModeOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_MemorydbUserAuthenticationModeOutputReference)SetInternalValue(val interface{}) {
...
func (m *jsiiProxy_MemorydbUserAuthenticationModeOutputReference) ResetType() {
	_jsii_.InvokeVoid(
		m,
		"resetType",
		nil, // no parameters
