...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/memorydb_user awscc_memorydb_user}.
...
func (j *jsiiProxy_MemorydbUser) AuthenticationModeInput() interface{} {
...
func (j *jsiiProxy_MemorydbUser) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_MemorydbUser) Tags() MemorydbUserTagsList {
	var returns MemorydbUserTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_MemorydbUser) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/memorydb_user awscc_memorydb_user} Resource.
func NewMemorydbUser(scope constructs.Construct, id *string, config *MemorydbUserConfig) MemorydbUser {
	...
	_jsii_.Create(
		"awscc.memorydbUser.MemorydbUser",
...
func (m *jsiiProxy_MemorydbUser) PutTags(value interface{}) {
...
func (m *jsiiProxy_MemorydbUser) ResetAccessString() {
	_jsii_.InvokeVoid(
		m,
		"resetAccessString",
		nil, // no parameters
...
func (m *jsiiProxy_MemorydbUser) ResetAuthenticationMode() {
	_jsii_.InvokeVoid(
		m,
		"resetAuthenticationMode",
		nil, // no parameters
