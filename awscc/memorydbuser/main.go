...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.memorydbUser.MemorydbUserAuthenticationMode",
		reflect.TypeOf((*MemorydbUserAuthenticationMode)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.memorydbUser.MemorydbUserAuthenticationModeOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.memorydbUser.MemorydbUserConfig",
		reflect.TypeOf((*MemorydbUserConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.memorydbUser.MemorydbUserTags",
		reflect.TypeOf((*MemorydbUserTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.memorydbUser.MemorydbUserTagsList",
		reflect.TypeOf((*MemorydbUserTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MemorydbUserTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
