...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/elasticache_parameter_group awscc_elasticache_parameter_group}.
type ElasticacheParameterGroup interface {
	cdktf.TerraformResource
	CacheParameterGroupFamily() *string
	SetCacheParameterGroupFamily(val *string)
	CacheParameterGroupFamilyInput() *string
...
func (j *jsiiProxy_ElasticacheParameterGroup) CacheParameterGroupFamily() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ElasticacheParameterGroup) CacheParameterGroupFamilyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cacheParameterGroupFamilyInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_ElasticacheParameterGroup) CacheParameterGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ElasticacheParameterGroup) Properties() *map[string]*string {
...
func (j *jsiiProxy_ElasticacheParameterGroup) PropertiesInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"propertiesInput",
...
func (j *jsiiProxy_ElasticacheParameterGroup) Tags() ElasticacheParameterGroupTagsList {
	var returns ElasticacheParameterGroupTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/elasticache_parameter_group awscc_elasticache_parameter_group} Resource.
func NewElasticacheParameterGroup(scope constructs.Construct, id *string, config *ElasticacheParameterGroupConfig) ElasticacheParameterGroup {
	...
	_jsii_.Create(
		"awscc.elasticacheParameterGroup.ElasticacheParameterGroup",
...
func (j *jsiiProxy_ElasticacheParameterGroup)SetCacheParameterGroupFamily(val *string) {
...
func (j *jsiiProxy_ElasticacheParameterGroup)SetProperties(val *map[string]*string) {
...
func (e *jsiiProxy_ElasticacheParameterGroup) PutTags(value interface{}) {
...
func (e *jsiiProxy_ElasticacheParameterGroup) ResetProperties() {
	_jsii_.InvokeVoid(
		e,
		"resetProperties",
		nil, // no parameters
