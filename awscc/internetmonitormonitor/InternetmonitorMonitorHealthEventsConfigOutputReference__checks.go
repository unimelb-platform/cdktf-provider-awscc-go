...
func (j *jsiiProxy_InternetmonitorMonitorHealthEventsConfigOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *InternetmonitorMonitorHealthEventsConfig:
		val := val.(*InternetmonitorMonitorHealthEventsConfig)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case InternetmonitorMonitorHealthEventsConfig:
		val_ := val.(InternetmonitorMonitorHealthEventsConfig)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *InternetmonitorMonitorHealthEventsConfig; received %#v (a %T)", val, val)
		}
	}
