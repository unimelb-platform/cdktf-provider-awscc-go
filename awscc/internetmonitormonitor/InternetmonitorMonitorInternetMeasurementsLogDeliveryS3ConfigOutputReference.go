...
func (j *jsiiProxy_InternetmonitorMonitorInternetMeasurementsLogDeliveryS3ConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_InternetmonitorMonitorInternetMeasurementsLogDeliveryS3ConfigOutputReference)SetInternalValue(val interface{}) {
...
func (i *jsiiProxy_InternetmonitorMonitorInternetMeasurementsLogDeliveryS3ConfigOutputReference) ResetBucketName() {
	_jsii_.InvokeVoid(
		i,
		"resetBucketName",
		nil, // no parameters
