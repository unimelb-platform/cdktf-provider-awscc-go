...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccWisdomAiAgentVersion)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccWisdomAiAgentVersion.DataAwsccWisdomAiAgentVersionConfig",
		reflect.TypeOf((*DataAwsccWisdomAiAgentVersionConfig)(nil)).Elem(),
	)
}
