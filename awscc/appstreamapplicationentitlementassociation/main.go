...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AppstreamApplicationEntitlementAssociation)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "entitlementNameInput", GoGetter: "EntitlementNameInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*AppstreamApplicationEntitlementAssociationConfig)(nil)).Elem(),
	)
}
