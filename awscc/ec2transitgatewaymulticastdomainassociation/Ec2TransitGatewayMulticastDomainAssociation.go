...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/ec2transitgatewaymulticastdomainassociation/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/ec2_transit_gateway_multicast_domain_association awscc_ec2_transit_gateway_multicast_domain_association}.
...
func (j *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation) ResourceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceId",
...
func (j *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation) ResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceType",
...
func (j *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/ec2_transit_gateway_multicast_domain_association awscc_ec2_transit_gateway_multicast_domain_association} Resource.
