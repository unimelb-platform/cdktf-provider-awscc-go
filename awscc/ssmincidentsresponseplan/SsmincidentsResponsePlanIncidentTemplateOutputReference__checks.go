...
func (s *jsiiProxy_SsmincidentsResponsePlanIncidentTemplateOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (s *jsiiProxy_SsmincidentsResponsePlanIncidentTemplateOutputReference) validatePutIncidentTagsParameters(value interface{}) error {
	...
	case *[]*SsmincidentsResponsePlanIncidentTemplateIncidentTags:
		value := value.(*[]*SsmincidentsResponsePlanIncidentTemplateIncidentTags)
	...
	case []*SsmincidentsResponsePlanIncidentTemplateIncidentTags:
		value_ := value.([]*SsmincidentsResponsePlanIncidentTemplateIncidentTags)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*SsmincidentsResponsePlanIncidentTemplateIncidentTags; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_SsmincidentsResponsePlanIncidentTemplateOutputReference) validatePutNotificationTargetsParameters(value interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*SsmincidentsResponsePlanIncidentTemplateNotificationTargets:
		value := value.(*[]*SsmincidentsResponsePlanIncidentTemplateNotificationTargets)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*SsmincidentsResponsePlanIncidentTemplateNotificationTargets:
		value_ := value.([]*SsmincidentsResponsePlanIncidentTemplateNotificationTargets)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*SsmincidentsResponsePlanIncidentTemplateNotificationTargets; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_SsmincidentsResponsePlanIncidentTemplateOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_SsmincidentsResponsePlanIncidentTemplateOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *SsmincidentsResponsePlanIncidentTemplate:
		val := val.(*SsmincidentsResponsePlanIncidentTemplate)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case SsmincidentsResponsePlanIncidentTemplate:
		val_ := val.(SsmincidentsResponsePlanIncidentTemplate)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *SsmincidentsResponsePlanIncidentTemplate; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_SsmincidentsResponsePlanIncidentTemplateOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewSsmincidentsResponsePlanIncidentTemplateOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
