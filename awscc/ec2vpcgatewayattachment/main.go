...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2VpcGatewayAttachment)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.ec2VpcGatewayAttachment.Ec2VpcGatewayAttachmentConfig",
		reflect.TypeOf((*Ec2VpcGatewayAttachmentConfig)(nil)).Elem(),
	)
}
