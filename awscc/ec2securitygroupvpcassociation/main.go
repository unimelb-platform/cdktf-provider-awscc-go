...
func init() {
	_jsii_.RegisterClass(
		"awscc.ec2SecurityGroupVpcAssociation.Ec2SecurityGroupVpcAssociation",
		reflect.TypeOf((*Ec2SecurityGroupVpcAssociation)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_Ec2SecurityGroupVpcAssociation{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.ec2SecurityGroupVpcAssociation.Ec2SecurityGroupVpcAssociationConfig",
		reflect.TypeOf((*Ec2SecurityGroupVpcAssociationConfig)(nil)).Elem(),
	)
}
