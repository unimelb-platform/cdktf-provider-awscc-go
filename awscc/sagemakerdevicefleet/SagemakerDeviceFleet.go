...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/sagemaker_device_fleet awscc_sagemaker_device_fleet}.
...
func (j *jsiiProxy_SagemakerDeviceFleet) OutputConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"outputConfigInput",
...
func (j *jsiiProxy_SagemakerDeviceFleet) Tags() SagemakerDeviceFleetTagsList {
	var returns SagemakerDeviceFleetTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/sagemaker_device_fleet awscc_sagemaker_device_fleet} Resource.
func NewSagemakerDeviceFleet(scope constructs.Construct, id *string, config *SagemakerDeviceFleetConfig) SagemakerDeviceFleet {
	...
	_jsii_.Create(
		"awscc.sagemakerDeviceFleet.SagemakerDeviceFleet",
...
func (s *jsiiProxy_SagemakerDeviceFleet) PutTags(value interface{}) {
