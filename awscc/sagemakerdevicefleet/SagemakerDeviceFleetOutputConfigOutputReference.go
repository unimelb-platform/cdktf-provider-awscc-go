...
func (j *jsiiProxy_SagemakerDeviceFleetOutputConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerDeviceFleetOutputConfigOutputReference)SetInternalValue(val interface{}) {
