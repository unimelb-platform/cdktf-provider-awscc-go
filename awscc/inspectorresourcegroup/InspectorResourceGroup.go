...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/inspector_resource_group awscc_inspector_resource_group}.
type InspectorResourceGroup interface {
	...
	ResourceGroupTags() InspectorResourceGroupResourceGroupTagsList
	ResourceGroupTagsInput() interface{}
	// Experimental.
	...
	PutResourceGroupTags(value interface{})
...
func (j *jsiiProxy_InspectorResourceGroup) ResourceGroupTags() InspectorResourceGroupResourceGroupTagsList {
	var returns InspectorResourceGroupResourceGroupTagsList
	_jsii_.Get(
		j,
		"resourceGroupTags",
		&returns,
...
func (j *jsiiProxy_InspectorResourceGroup) ResourceGroupTagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"resourceGroupTagsInput",
		&returns,
	)
	return returns
}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/inspector_resource_group awscc_inspector_resource_group} Resource.
func NewInspectorResourceGroup(scope constructs.Construct, id *string, config *InspectorResourceGroupConfig) InspectorResourceGroup {
	...
	_jsii_.Create(
		"awscc.inspectorResourceGroup.InspectorResourceGroup",
...
func (i *jsiiProxy_InspectorResourceGroup) PutResourceGroupTags(value interface{}) {
	if err := i.validatePutResourceGroupTagsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		i,
		"putResourceGroupTags",
		[]interface{}{value},
	)
}
