...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ipv6AddressPreferredLeaseTimeInput", GoGetter: "Ipv6AddressPreferredLeaseTimeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIpv6AddressPreferredLeaseTime", GoMethod: "ResetIpv6AddressPreferredLeaseTime"},
