...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFirewallName", GoMethod: "ResetFirewallName"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NetworkfirewallLoggingConfigurationLoggingConfigurationLogDestinationConfigs)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkfirewallLoggingConfigurationLoggingConfigurationLogDestinationConfigsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkfirewallLoggingConfigurationLoggingConfigurationLogDestinationConfigsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putLogDestinationConfigs", GoMethod: "PutLogDestinationConfigs"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
