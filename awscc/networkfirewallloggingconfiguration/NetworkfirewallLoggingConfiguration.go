...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/networkfirewall_logging_configuration awscc_networkfirewall_logging_configuration}.
...
func (j *jsiiProxy_NetworkfirewallLoggingConfiguration) FirewallName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"firewallName",
...
func (j *jsiiProxy_NetworkfirewallLoggingConfiguration) FirewallNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"firewallNameInput",
...
func (j *jsiiProxy_NetworkfirewallLoggingConfiguration) LoggingConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/networkfirewall_logging_configuration awscc_networkfirewall_logging_configuration} Resource.
...
func (j *jsiiProxy_NetworkfirewallLoggingConfiguration)SetFirewallName(val *string) {
...
func (n *jsiiProxy_NetworkfirewallLoggingConfiguration) ResetFirewallName() {
	_jsii_.InvokeVoid(
		n,
		"resetFirewallName",
		nil, // no parameters
