...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WorkspaceswebIpAccessSettings)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.workspaceswebIpAccessSettings.WorkspaceswebIpAccessSettingsConfig",
		reflect.TypeOf((*WorkspaceswebIpAccessSettingsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.workspaceswebIpAccessSettings.WorkspaceswebIpAccessSettingsIpRules",
		reflect.TypeOf((*WorkspaceswebIpAccessSettingsIpRules)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.workspaceswebIpAccessSettings.WorkspaceswebIpAccessSettingsIpRulesList",
		reflect.TypeOf((*WorkspaceswebIpAccessSettingsIpRulesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WorkspaceswebIpAccessSettingsIpRulesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_WorkspaceswebIpAccessSettingsIpRulesOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.workspaceswebIpAccessSettings.WorkspaceswebIpAccessSettingsTags",
		reflect.TypeOf((*WorkspaceswebIpAccessSettingsTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.workspaceswebIpAccessSettings.WorkspaceswebIpAccessSettingsTagsList",
		reflect.TypeOf((*WorkspaceswebIpAccessSettingsTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WorkspaceswebIpAccessSettingsTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
