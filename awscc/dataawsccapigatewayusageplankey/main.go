...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccApigatewayUsagePlanKey)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "usagePlanKeyId", GoGetter: "UsagePlanKeyId"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccApigatewayUsagePlanKeyConfig)(nil)).Elem(),
	)
}
