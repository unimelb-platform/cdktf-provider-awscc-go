...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/kms_replica_key awscc_kms_replica_key}.
type KmsReplicaKey interface {
	...
	KeyId() *string
	KeyPolicy() *string
	SetKeyPolicy(val *string)
	KeyPolicyInput() *string
	// Experimental.
	...
	PendingWindowInDaysInput() *float64
...
func (j *jsiiProxy_KmsReplicaKey) KeyPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyPolicy",
...
func (j *jsiiProxy_KmsReplicaKey) KeyPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyPolicyInput",
...
func (j *jsiiProxy_KmsReplicaKey) PendingWindowInDays() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"pendingWindowInDays",
...
func (j *jsiiProxy_KmsReplicaKey) PendingWindowInDaysInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"pendingWindowInDaysInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_KmsReplicaKey) Tags() KmsReplicaKeyTagsList {
	var returns KmsReplicaKeyTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/kms_replica_key awscc_kms_replica_key} Resource.
func NewKmsReplicaKey(scope constructs.Construct, id *string, config *KmsReplicaKeyConfig) KmsReplicaKey {
	...
	_jsii_.Create(
		"awscc.kmsReplicaKey.KmsReplicaKey",
...
func (j *jsiiProxy_KmsReplicaKey)SetKeyPolicy(val *string) {
...
func (j *jsiiProxy_KmsReplicaKey)SetPendingWindowInDays(val *float64) {
	if err := j.validateSetPendingWindowInDaysParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (k *jsiiProxy_KmsReplicaKey) PutTags(value interface{}) {
...
func (k *jsiiProxy_KmsReplicaKey) ResetPendingWindowInDays() {
	_jsii_.InvokeVoid(
		k,
		"resetPendingWindowInDays",
		nil, // no parameters
