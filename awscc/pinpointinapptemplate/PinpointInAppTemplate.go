...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/pinpoint_in_app_template awscc_pinpoint_in_app_template}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/pinpoint_in_app_template awscc_pinpoint_in_app_template} Resource.
...
func (p *jsiiProxy_PinpointInAppTemplate) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PinpointInAppTemplate) MoveFromId(id *string) {
...
func (p *jsiiProxy_PinpointInAppTemplate) MoveToId(id *string) {
...
func (p *jsiiProxy_PinpointInAppTemplate) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PinpointInAppTemplate) ToHclTerraform() interface{} {
	var returns interface{}
