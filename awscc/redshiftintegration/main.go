...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIntegrationName", GoMethod: "ResetIntegrationName"},
	...
	_jsii_.RegisterStruct(
		"awscc.redshiftIntegration.RedshiftIntegrationConfig",
		reflect.TypeOf((*RedshiftIntegrationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.redshiftIntegration.RedshiftIntegrationTags",
		reflect.TypeOf((*RedshiftIntegrationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.redshiftIntegration.RedshiftIntegrationTagsList",
		reflect.TypeOf((*RedshiftIntegrationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RedshiftIntegrationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
