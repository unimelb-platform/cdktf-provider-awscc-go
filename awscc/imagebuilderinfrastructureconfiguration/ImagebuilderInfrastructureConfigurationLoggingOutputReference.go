...
func (j *jsiiProxy_ImagebuilderInfrastructureConfigurationLoggingOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ImagebuilderInfrastructureConfigurationLoggingOutputReference) S3LogsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"s3LogsInput",
...
func (j *jsiiProxy_ImagebuilderInfrastructureConfigurationLoggingOutputReference)SetInternalValue(val interface{}) {
...
func (i *jsiiProxy_ImagebuilderInfrastructureConfigurationLoggingOutputReference) ResetS3Logs() {
	_jsii_.InvokeVoid(
		i,
		"resetS3Logs",
		nil, // no parameters
