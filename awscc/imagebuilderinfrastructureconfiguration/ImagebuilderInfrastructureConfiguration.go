...
type ImagebuilderInfrastructureConfiguration interface {
	...
	InstanceMetadataOptionsInput() interface{}
...
func (j *jsiiProxy_ImagebuilderInfrastructureConfiguration) InstanceMetadataOptionsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ImagebuilderInfrastructureConfiguration) LoggingInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"loggingInput",
