...
func (j *jsiiProxy_ImagebuilderInfrastructureConfigurationLoggingS3LogsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ImagebuilderInfrastructureConfigurationLoggingS3LogsOutputReference)SetInternalValue(val interface{}) {
...
func (i *jsiiProxy_ImagebuilderInfrastructureConfigurationLoggingS3LogsOutputReference) ResetS3BucketName() {
	_jsii_.InvokeVoid(
		i,
		"resetS3BucketName",
		nil, // no parameters
