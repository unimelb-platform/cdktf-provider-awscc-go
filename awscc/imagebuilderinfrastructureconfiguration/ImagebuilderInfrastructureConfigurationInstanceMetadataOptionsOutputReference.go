...
func (j *jsiiProxy_ImagebuilderInfrastructureConfigurationInstanceMetadataOptionsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ImagebuilderInfrastructureConfigurationInstanceMetadataOptionsOutputReference)SetInternalValue(val interface{}) {
