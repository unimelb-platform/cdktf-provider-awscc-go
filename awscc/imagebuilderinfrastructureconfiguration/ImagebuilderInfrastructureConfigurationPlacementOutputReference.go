...
func (j *jsiiProxy_ImagebuilderInfrastructureConfigurationPlacementOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ImagebuilderInfrastructureConfigurationPlacementOutputReference)SetInternalValue(val interface{}) {
...
func (i *jsiiProxy_ImagebuilderInfrastructureConfigurationPlacementOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (i *jsiiProxy_ImagebuilderInfrastructureConfigurationPlacementOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
