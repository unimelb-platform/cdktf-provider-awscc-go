...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2NetworkInterfaceAttachment)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.ec2NetworkInterfaceAttachment.Ec2NetworkInterfaceAttachmentConfig",
		reflect.TypeOf((*Ec2NetworkInterfaceAttachmentConfig)(nil)).Elem(),
	)
}
