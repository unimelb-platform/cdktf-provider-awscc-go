...
func (d *jsiiProxy_DataAwsccSagemakerModelPackageSourceAlgorithmSpecificationSourceAlgorithmsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
