...
type AppflowFlowMetadataCatalogConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/appflow_flow#glue_data_catalog AppflowFlow#glue_data_catalog}
