...
func (j *jsiiProxy_AppflowFlowSourceFlowConfigSourceConnectorPropertiesSapoDataOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *AppflowFlowSourceFlowConfigSourceConnectorPropertiesSapoData:
		val := val.(*AppflowFlowSourceFlowConfigSourceConnectorPropertiesSapoData)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case AppflowFlowSourceFlowConfigSourceConnectorPropertiesSapoData:
		val_ := val.(AppflowFlowSourceFlowConfigSourceConnectorPropertiesSapoData)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *AppflowFlowSourceFlowConfigSourceConnectorPropertiesSapoData; received %#v (a %T)", val, val)
		}
	}
