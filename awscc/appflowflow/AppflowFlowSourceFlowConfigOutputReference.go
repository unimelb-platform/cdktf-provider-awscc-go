...
func (j *jsiiProxy_AppflowFlowSourceFlowConfigOutputReference) IncrementalPullConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AppflowFlowSourceFlowConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_AppflowFlowSourceFlowConfigOutputReference) SourceConnectorPropertiesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AppflowFlowSourceFlowConfigOutputReference)SetInternalValue(val interface{}) {
