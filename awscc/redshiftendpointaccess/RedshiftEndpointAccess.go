...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/redshift_endpoint_access awscc_redshift_endpoint_access}.
type RedshiftEndpointAccess interface {
	...
	VpcEndpoint() RedshiftEndpointAccessVpcEndpointOutputReference
	VpcSecurityGroupIds() *[]*string
	SetVpcSecurityGroupIds(val *[]*string)
	VpcSecurityGroupIdsInput() *[]*string
	VpcSecurityGroups() RedshiftEndpointAccessVpcSecurityGroupsList
...
func (j *jsiiProxy_RedshiftEndpointAccess) EndpointCreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"endpointCreateTime",
...
func (j *jsiiProxy_RedshiftEndpointAccess) EndpointStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"endpointStatus",
...
func (j *jsiiProxy_RedshiftEndpointAccess) VpcEndpoint() RedshiftEndpointAccessVpcEndpointOutputReference {
...
func (j *jsiiProxy_RedshiftEndpointAccess) VpcSecurityGroups() RedshiftEndpointAccessVpcSecurityGroupsList {
	var returns RedshiftEndpointAccessVpcSecurityGroupsList
	_jsii_.Get(
		j,
		"vpcSecurityGroups",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/redshift_endpoint_access awscc_redshift_endpoint_access} Resource.
