...
type RedshiftEndpointAccessVpcEndpointOutputReference interface {
	...
	NetworkInterfaces() RedshiftEndpointAccessVpcEndpointNetworkInterfacesList
	// Experimental.
...
func (j *jsiiProxy_RedshiftEndpointAccessVpcEndpointOutputReference) NetworkInterfaces() RedshiftEndpointAccessVpcEndpointNetworkInterfacesList {
	var returns RedshiftEndpointAccessVpcEndpointNetworkInterfacesList
	_jsii_.Get(
		j,
		"networkInterfaces",
		&returns,
...
func NewRedshiftEndpointAccessVpcEndpointOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) RedshiftEndpointAccessVpcEndpointOutputReference {
	_init_.Initialize()

	if err := validateNewRedshiftEndpointAccessVpcEndpointOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewRedshiftEndpointAccessVpcEndpointOutputReference_Override(r RedshiftEndpointAccessVpcEndpointOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
