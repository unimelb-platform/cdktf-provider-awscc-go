...
func (j *jsiiProxy_IvsRecordingConfigurationThumbnailConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_IvsRecordingConfigurationThumbnailConfigurationOutputReference) Resolution() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resolution",
...
func (j *jsiiProxy_IvsRecordingConfigurationThumbnailConfigurationOutputReference) ResolutionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resolutionInput",
...
func (j *jsiiProxy_IvsRecordingConfigurationThumbnailConfigurationOutputReference) Storage() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"storage",
...
func (j *jsiiProxy_IvsRecordingConfigurationThumbnailConfigurationOutputReference) StorageInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"storageInput",
...
func (j *jsiiProxy_IvsRecordingConfigurationThumbnailConfigurationOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_IvsRecordingConfigurationThumbnailConfigurationOutputReference)SetResolution(val *string) {
...
func (j *jsiiProxy_IvsRecordingConfigurationThumbnailConfigurationOutputReference)SetStorage(val *[]*string) {
...
func (i *jsiiProxy_IvsRecordingConfigurationThumbnailConfigurationOutputReference) ResetResolution() {
	_jsii_.InvokeVoid(
		i,
		"resetResolution",
		nil, // no parameters
...
func (i *jsiiProxy_IvsRecordingConfigurationThumbnailConfigurationOutputReference) ResetStorage() {
	_jsii_.InvokeVoid(
		i,
		"resetStorage",
		nil, // no parameters
