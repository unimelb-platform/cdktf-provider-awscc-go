...
type IvsRecordingConfigurationDestinationConfiguration struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/ivs_recording_configuration#s3 IvsRecordingConfiguration#s3}
