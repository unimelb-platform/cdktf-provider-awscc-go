...
func (j *jsiiProxy_IvsRecordingConfigurationDestinationConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_IvsRecordingConfigurationDestinationConfigurationOutputReference) S3Input() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"s3Input",
...
func (j *jsiiProxy_IvsRecordingConfigurationDestinationConfigurationOutputReference)SetInternalValue(val interface{}) {
...
func (i *jsiiProxy_IvsRecordingConfigurationDestinationConfigurationOutputReference) ResetS3() {
	_jsii_.InvokeVoid(
		i,
		"resetS3",
		nil, // no parameters
