...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/pcaconnectorad_template_group_access_control_entry awscc_pcaconnectorad_template_group_access_control_entry}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/pcaconnectorad_template_group_access_control_entry awscc_pcaconnectorad_template_group_access_control_entry} Resource.
...
func (p *jsiiProxy_PcaconnectoradTemplateGroupAccessControlEntry) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PcaconnectoradTemplateGroupAccessControlEntry) MoveFromId(id *string) {
...
func (p *jsiiProxy_PcaconnectoradTemplateGroupAccessControlEntry) MoveToId(id *string) {
...
func (p *jsiiProxy_PcaconnectoradTemplateGroupAccessControlEntry) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PcaconnectoradTemplateGroupAccessControlEntry) ToHclTerraform() interface{} {
	var returns interface{}
