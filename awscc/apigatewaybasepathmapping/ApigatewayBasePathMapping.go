...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/apigatewaybasepathmapping/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/apigateway_base_path_mapping awscc_apigateway_base_path_mapping}.
...
func (j *jsiiProxy_ApigatewayBasePathMapping) RestApiId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"restApiId",
...
func (j *jsiiProxy_ApigatewayBasePathMapping) RestApiIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"restApiIdInput",
...
func (j *jsiiProxy_ApigatewayBasePathMapping) Stage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stage",
...
func (j *jsiiProxy_ApigatewayBasePathMapping) StageInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stageInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/apigateway_base_path_mapping awscc_apigateway_base_path_mapping} Resource.
func NewApigatewayBasePathMapping(scope constructs.Construct, id *string, config *ApigatewayBasePathMappingConfig) ApigatewayBasePathMapping {
	...
	_jsii_.Create(
		"awscc.apigatewayBasePathMapping.ApigatewayBasePathMapping",
...
func (j *jsiiProxy_ApigatewayBasePathMapping)SetRestApiId(val *string) {
...
func (j *jsiiProxy_ApigatewayBasePathMapping)SetStage(val *string) {
...
func (a *jsiiProxy_ApigatewayBasePathMapping) ResetRestApiId() {
	_jsii_.InvokeVoid(
		a,
		"resetRestApiId",
		nil, // no parameters
...
func (a *jsiiProxy_ApigatewayBasePathMapping) ResetStage() {
	_jsii_.InvokeVoid(
		a,
		"resetStage",
		nil, // no parameters
