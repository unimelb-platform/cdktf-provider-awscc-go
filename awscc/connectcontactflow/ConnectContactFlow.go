...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/connect_contact_flow awscc_connect_contact_flow}.
...
func (j *jsiiProxy_ConnectContactFlow) ContactFlowArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"contactFlowArn",
...
func (j *jsiiProxy_ConnectContactFlow) InstanceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceArn",
...
func (j *jsiiProxy_ConnectContactFlow) InstanceArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceArnInput",
...
func (j *jsiiProxy_ConnectContactFlow) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_ConnectContactFlow) StateInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stateInput",
...
func (j *jsiiProxy_ConnectContactFlow) Tags() ConnectContactFlowTagsList {
	var returns ConnectContactFlowTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/connect_contact_flow awscc_connect_contact_flow} Resource.
func NewConnectContactFlow(scope constructs.Construct, id *string, config *ConnectContactFlowConfig) ConnectContactFlow {
	...
	_jsii_.Create(
		"awscc.connectContactFlow.ConnectContactFlow",
...
func (j *jsiiProxy_ConnectContactFlow)SetInstanceArn(val *string) {
...
func (j *jsiiProxy_ConnectContactFlow)SetState(val *string) {
...
func (c *jsiiProxy_ConnectContactFlow) PutTags(value interface{}) {
...
func (c *jsiiProxy_ConnectContactFlow) ResetState() {
	_jsii_.InvokeVoid(
		c,
		"resetState",
		nil, // no parameters
