...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/redshiftscheduledaction/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/redshift_scheduled_action awscc_redshift_scheduled_action}.
type RedshiftScheduledAction interface {
	...
	ScheduledActionDescriptionInput() *string
	...
	ResetSchedule()
	ResetScheduledActionDescription()
	ResetStartTime()
	ResetTargetAction()
...
func (j *jsiiProxy_RedshiftScheduledAction) NextInvocations() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"nextInvocations",
...
func (j *jsiiProxy_RedshiftScheduledAction) ScheduledActionDescription() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RedshiftScheduledAction) ScheduledActionDescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scheduledActionDescriptionInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_RedshiftScheduledAction) ScheduledActionName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scheduledActionName",
...
func (j *jsiiProxy_RedshiftScheduledAction) ScheduledActionNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RedshiftScheduledAction) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_RedshiftScheduledAction) TargetActionInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"targetActionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/redshift_scheduled_action awscc_redshift_scheduled_action} Resource.
func NewRedshiftScheduledAction(scope constructs.Construct, id *string, config *RedshiftScheduledActionConfig) RedshiftScheduledAction {
	...
	_jsii_.Create(
		"awscc.redshiftScheduledAction.RedshiftScheduledAction",
...
func (j *jsiiProxy_RedshiftScheduledAction)SetScheduledActionDescription(val *string) {
	if err := j.validateSetScheduledActionDescriptionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RedshiftScheduledAction)SetScheduledActionName(val *string) {
...
func (r *jsiiProxy_RedshiftScheduledAction) ResetIamRole() {
	_jsii_.InvokeVoid(
		r,
		"resetIamRole",
		nil, // no parameters
...
func (r *jsiiProxy_RedshiftScheduledAction) ResetSchedule() {
	_jsii_.InvokeVoid(
		r,
		"resetSchedule",
		nil, // no parameters
...
func (r *jsiiProxy_RedshiftScheduledAction) ResetScheduledActionDescription() {
	_jsii_.InvokeVoid(
		r,
		"resetScheduledActionDescription",
		nil, // no parameters
...
func (r *jsiiProxy_RedshiftScheduledAction) ResetTargetAction() {
	_jsii_.InvokeVoid(
		r,
		"resetTargetAction",
		nil, // no parameters
