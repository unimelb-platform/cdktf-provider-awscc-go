...
func (j *jsiiProxy_RedshiftScheduledActionTargetActionResumeClusterOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_RedshiftScheduledActionTargetActionResumeClusterOutputReference)SetInternalValue(val interface{}) {
...
func (r *jsiiProxy_RedshiftScheduledActionTargetActionResumeClusterOutputReference) ResetClusterIdentifier() {
	_jsii_.InvokeVoid(
		r,
		"resetClusterIdentifier",
		nil, // no parameters
