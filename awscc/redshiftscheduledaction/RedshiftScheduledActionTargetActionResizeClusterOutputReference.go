...
func (j *jsiiProxy_RedshiftScheduledActionTargetActionResizeClusterOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_RedshiftScheduledActionTargetActionResizeClusterOutputReference)SetInternalValue(val interface{}) {
