...
func (j *jsiiProxy_RedshiftScheduledActionTargetActionPauseClusterOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_RedshiftScheduledActionTargetActionPauseClusterOutputReference)SetInternalValue(val interface{}) {
...
func (r *jsiiProxy_RedshiftScheduledActionTargetActionPauseClusterOutputReference) ResetClusterIdentifier() {
	_jsii_.InvokeVoid(
		r,
		"resetClusterIdentifier",
		nil, // no parameters
