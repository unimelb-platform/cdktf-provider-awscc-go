...
type Connectcampaignsv2CampaignCommunicationTimeConfigEmail struct {
	// Open Hours config.
	//
	...
	OpenHours *Connectcampaignsv2CampaignCommunicationTimeConfigEmailOpenHours `field:"optional" json:"openHours" yaml:"openHours"`
	...
	RestrictedPeriods *Connectcampaignsv2CampaignCommunicationTimeConfigEmailRestrictedPeriods `field:"optional" json:"restrictedPeriods" yaml:"restrictedPeriods"`
}
