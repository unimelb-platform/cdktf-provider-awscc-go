...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccRoute53HealthCheck)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccRoute53HealthCheck.DataAwsccRoute53HealthCheckConfig",
		reflect.TypeOf((*DataAwsccRoute53HealthCheckConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccRoute53HealthCheck.DataAwsccRoute53HealthCheckHealthCheckConfig",
		reflect.TypeOf((*DataAwsccRoute53HealthCheckHealthCheckConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccRoute53HealthCheck.DataAwsccRoute53HealthCheckHealthCheckConfigAlarmIdentifier",
		reflect.TypeOf((*DataAwsccRoute53HealthCheckHealthCheckConfigAlarmIdentifier)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccRoute53HealthCheck.DataAwsccRoute53HealthCheckHealthCheckConfigAlarmIdentifierOutputReference",
		reflect.TypeOf((*DataAwsccRoute53HealthCheckHealthCheckConfigAlarmIdentifierOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccRoute53HealthCheckHealthCheckConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccRoute53HealthCheckHealthCheckTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccRoute53HealthCheck.DataAwsccRoute53HealthCheckHealthCheckTagsList",
		reflect.TypeOf((*DataAwsccRoute53HealthCheckHealthCheckTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccRoute53HealthCheckHealthCheckTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
