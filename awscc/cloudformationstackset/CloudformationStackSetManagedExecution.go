...
type CloudformationStackSetManagedExecution struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/cloudformation_stack_set#active CloudformationStackSet#active}
