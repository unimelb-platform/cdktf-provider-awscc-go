...
func (j *jsiiProxy_CloudformationStackSetAutoDeploymentOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_CloudformationStackSetAutoDeploymentOutputReference)SetInternalValue(val interface{}) {
