...
func (j *jsiiProxy_GuarddutyThreatIntelSet) Tags() GuarddutyThreatIntelSetTagsList {
	var returns GuarddutyThreatIntelSetTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (g *jsiiProxy_GuarddutyThreatIntelSet) PutTags(value interface{}) {
...
func (g *jsiiProxy_GuarddutyThreatIntelSet) ResetActivate() {
	_jsii_.InvokeVoid(
		g,
		"resetActivate",
		nil, // no parameters
...
func (g *jsiiProxy_GuarddutyThreatIntelSet) ResetDetectorId() {
	_jsii_.InvokeVoid(
		g,
		"resetDetectorId",
		nil, // no parameters
...
func (g *jsiiProxy_GuarddutyThreatIntelSet) ResetName() {
	_jsii_.InvokeVoid(
		g,
		"resetName",
		nil, // no parameters
