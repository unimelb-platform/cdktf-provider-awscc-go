...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.guarddutyThreatIntelSet.GuarddutyThreatIntelSetTags",
		reflect.TypeOf((*GuarddutyThreatIntelSetTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.guarddutyThreatIntelSet.GuarddutyThreatIntelSetTagsList",
		reflect.TypeOf((*GuarddutyThreatIntelSetTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GuarddutyThreatIntelSetTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
