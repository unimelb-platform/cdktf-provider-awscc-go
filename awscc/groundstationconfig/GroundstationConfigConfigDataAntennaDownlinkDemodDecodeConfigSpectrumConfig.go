...
type GroundstationConfigConfigDataAntennaDownlinkDemodDecodeConfigSpectrumConfig struct {
	...
	Bandwidth *GroundstationConfigConfigDataAntennaDownlinkDemodDecodeConfigSpectrumConfigBandwidth `field:"optional" json:"bandwidth" yaml:"bandwidth"`
	...
	CenterFrequency *GroundstationConfigConfigDataAntennaDownlinkDemodDecodeConfigSpectrumConfigCenterFrequency `field:"optional" json:"centerFrequency" yaml:"centerFrequency"`
