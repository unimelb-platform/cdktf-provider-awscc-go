...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/sagemaker_mlflow_tracking_server awscc_sagemaker_mlflow_tracking_server}.
...
func (j *jsiiProxy_SagemakerMlflowTrackingServer) Tags() SagemakerMlflowTrackingServerTagsList {
	var returns SagemakerMlflowTrackingServerTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_SagemakerMlflowTrackingServer) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_SagemakerMlflowTrackingServer) TrackingServerArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"trackingServerArn",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/sagemaker_mlflow_tracking_server awscc_sagemaker_mlflow_tracking_server} Resource.
func NewSagemakerMlflowTrackingServer(scope constructs.Construct, id *string, config *SagemakerMlflowTrackingServerConfig) SagemakerMlflowTrackingServer {
	...
	_jsii_.Create(
		"awscc.sagemakerMlflowTrackingServer.SagemakerMlflowTrackingServer",
...
func (s *jsiiProxy_SagemakerMlflowTrackingServer) PutTags(value interface{}) {
