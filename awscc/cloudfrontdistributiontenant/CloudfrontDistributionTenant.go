...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/cloudfront_distribution_tenant awscc_cloudfront_distribution_tenant}.
type CloudfrontDistributionTenant interface {
	...
	DomainResults() CloudfrontDistributionTenantDomainResultsList
	Domains() *[]*string
	...
	ManagedCertificateRequest() CloudfrontDistributionTenantManagedCertificateRequestOutputReference
	...
	PutCustomizations(value *CloudfrontDistributionTenantCustomizations)
	PutManagedCertificateRequest(value *CloudfrontDistributionTenantManagedCertificateRequest)
...
func (j *jsiiProxy_CloudfrontDistributionTenant) CreatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdTime",
...
func (j *jsiiProxy_CloudfrontDistributionTenant) Customizations() CloudfrontDistributionTenantCustomizationsOutputReference {
...
func (j *jsiiProxy_CloudfrontDistributionTenant) DistributionTenantId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudfrontDistributionTenant) DomainResults() CloudfrontDistributionTenantDomainResultsList {
	var returns CloudfrontDistributionTenantDomainResultsList
	_jsii_.Get(
		j,
		"domainResults",
		&returns,
...
func (j *jsiiProxy_CloudfrontDistributionTenant) Domains() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"domains",
...
func (j *jsiiProxy_CloudfrontDistributionTenant) DomainsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"domainsInput",
...
func (j *jsiiProxy_CloudfrontDistributionTenant) LastModifiedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lastModifiedTime",
...
func (j *jsiiProxy_CloudfrontDistributionTenant) ManagedCertificateRequest() CloudfrontDistributionTenantManagedCertificateRequestOutputReference {
...
func (j *jsiiProxy_CloudfrontDistributionTenant) Parameters() CloudfrontDistributionTenantParametersList {
	var returns CloudfrontDistributionTenantParametersList
	_jsii_.Get(
		j,
		"parameters",
		&returns,
...
func (j *jsiiProxy_CloudfrontDistributionTenant) ParametersInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"parametersInput",
...
func (j *jsiiProxy_CloudfrontDistributionTenant) Tags() CloudfrontDistributionTenantTagsList {
	var returns CloudfrontDistributionTenantTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_CloudfrontDistributionTenant) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/cloudfront_distribution_tenant awscc_cloudfront_distribution_tenant} Resource.
func NewCloudfrontDistributionTenant(scope constructs.Construct, id *string, config *CloudfrontDistributionTenantConfig) CloudfrontDistributionTenant {
	...
	_jsii_.Create(
		"awscc.cloudfrontDistributionTenant.CloudfrontDistributionTenant",
...
func (j *jsiiProxy_CloudfrontDistributionTenant)SetDomains(val *[]*string) {
...
func (c *jsiiProxy_CloudfrontDistributionTenant) PutCustomizations(value *CloudfrontDistributionTenantCustomizations) {
...
func (c *jsiiProxy_CloudfrontDistributionTenant) PutManagedCertificateRequest(value *CloudfrontDistributionTenantManagedCertificateRequest) {
...
func (c *jsiiProxy_CloudfrontDistributionTenant) PutParameters(value interface{}) {
...
func (c *jsiiProxy_CloudfrontDistributionTenant) PutTags(value interface{}) {
...
func (c *jsiiProxy_CloudfrontDistributionTenant) ResetParameters() {
	_jsii_.InvokeVoid(
		c,
		"resetParameters",
		nil, // no parameters
