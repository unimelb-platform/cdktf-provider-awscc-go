...
func (j *jsiiProxy_SyntheticsCanaryVpcConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SyntheticsCanaryVpcConfigOutputReference) VpcIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpcIdInput",
...
func NewSyntheticsCanaryVpcConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SyntheticsCanaryVpcConfigOutputReference {
	...
	_jsii_.Create(
		"awscc.syntheticsCanary.SyntheticsCanaryVpcConfigOutputReference",
...
func (j *jsiiProxy_SyntheticsCanaryVpcConfigOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_SyntheticsCanaryVpcConfigOutputReference)SetVpcId(val *string) {
...
func (s *jsiiProxy_SyntheticsCanaryVpcConfigOutputReference) ResetVpcId() {
	_jsii_.InvokeVoid(
		s,
		"resetVpcId",
		nil, // no parameters
