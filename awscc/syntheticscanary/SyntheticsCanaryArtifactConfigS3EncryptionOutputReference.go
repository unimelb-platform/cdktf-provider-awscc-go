...
func (j *jsiiProxy_SyntheticsCanaryArtifactConfigS3EncryptionOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SyntheticsCanaryArtifactConfigS3EncryptionOutputReference)SetInternalValue(val interface{}) {
