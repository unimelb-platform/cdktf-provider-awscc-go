...
func (j *jsiiProxy_SyntheticsCanaryTagsList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*SyntheticsCanaryTags; received %#v (a %T)", val, val)
		}
	}
