...
func (j *jsiiProxy_SyntheticsCanaryArtifactConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SyntheticsCanaryArtifactConfigOutputReference) S3EncryptionInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"s3EncryptionInput",
...
func NewSyntheticsCanaryArtifactConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SyntheticsCanaryArtifactConfigOutputReference {
	...
	_jsii_.Create(
		"awscc.syntheticsCanary.SyntheticsCanaryArtifactConfigOutputReference",
...
func (j *jsiiProxy_SyntheticsCanaryArtifactConfigOutputReference)SetInternalValue(val interface{}) {
