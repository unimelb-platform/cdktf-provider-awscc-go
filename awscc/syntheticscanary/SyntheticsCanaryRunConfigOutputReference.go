...
func (j *jsiiProxy_SyntheticsCanaryRunConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewSyntheticsCanaryRunConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SyntheticsCanaryRunConfigOutputReference {
	...
	_jsii_.Create(
		"awscc.syntheticsCanary.SyntheticsCanaryRunConfigOutputReference",
...
func (j *jsiiProxy_SyntheticsCanaryRunConfigOutputReference)SetInternalValue(val interface{}) {
