...
type SyntheticsCanaryScheduleOutputReference interface {
	...
	SetDurationInSeconds(val *string)
	DurationInSecondsInput() *string
	Expression() *string
...
func (j *jsiiProxy_SyntheticsCanaryScheduleOutputReference) DurationInSeconds() *string {
	var returns *string
	_jsii_.Get(
		j,
		"durationInSeconds",
...
func (j *jsiiProxy_SyntheticsCanaryScheduleOutputReference) DurationInSecondsInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SyntheticsCanaryScheduleOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SyntheticsCanaryScheduleOutputReference) RetryConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"retryConfigInput",
...
func (j *jsiiProxy_SyntheticsCanaryScheduleOutputReference)SetDurationInSeconds(val *string) {
...
func (j *jsiiProxy_SyntheticsCanaryScheduleOutputReference)SetInternalValue(val interface{}) {
