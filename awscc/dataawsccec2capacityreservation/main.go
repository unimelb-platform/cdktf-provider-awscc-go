...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2CapacityReservation)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccEc2CapacityReservation.DataAwsccEc2CapacityReservationConfig",
		reflect.TypeOf((*DataAwsccEc2CapacityReservationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccEc2CapacityReservation.DataAwsccEc2CapacityReservationTagSpecifications",
		reflect.TypeOf((*DataAwsccEc2CapacityReservationTagSpecifications)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccEc2CapacityReservation.DataAwsccEc2CapacityReservationTagSpecificationsList",
		reflect.TypeOf((*DataAwsccEc2CapacityReservationTagSpecificationsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2CapacityReservationTagSpecificationsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccEc2CapacityReservationTagSpecificationsTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccEc2CapacityReservation.DataAwsccEc2CapacityReservationTagSpecificationsTagsList",
		reflect.TypeOf((*DataAwsccEc2CapacityReservationTagSpecificationsTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2CapacityReservationTagSpecificationsTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
