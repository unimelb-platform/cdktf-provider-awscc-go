...
func NewEc2NetworkInsightsAnalysisForwardPathComponentsInboundHeaderOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) Ec2NetworkInsightsAnalysisForwardPathComponentsInboundHeaderOutputReference {
	_init_.Initialize()

	if err := validateNewEc2NetworkInsightsAnalysisForwardPathComponentsInboundHeaderOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewEc2NetworkInsightsAnalysisForwardPathComponentsInboundHeaderOutputReference_Override(e Ec2NetworkInsightsAnalysisForwardPathComponentsInboundHeaderOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
