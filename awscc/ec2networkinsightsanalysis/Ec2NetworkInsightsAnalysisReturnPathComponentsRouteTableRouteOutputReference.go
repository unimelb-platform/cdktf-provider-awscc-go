...
func NewEc2NetworkInsightsAnalysisReturnPathComponentsRouteTableRouteOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) Ec2NetworkInsightsAnalysisReturnPathComponentsRouteTableRouteOutputReference {
	_init_.Initialize()

	if err := validateNewEc2NetworkInsightsAnalysisReturnPathComponentsRouteTableRouteOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewEc2NetworkInsightsAnalysisReturnPathComponentsRouteTableRouteOutputReference_Override(e Ec2NetworkInsightsAnalysisReturnPathComponentsRouteTableRouteOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
