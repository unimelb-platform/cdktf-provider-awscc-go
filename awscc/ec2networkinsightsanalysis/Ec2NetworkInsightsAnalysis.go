...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/ec2_network_insights_analysis awscc_ec2_network_insights_analysis}.
type Ec2NetworkInsightsAnalysis interface {
	...
	Tags() Ec2NetworkInsightsAnalysisTagsList
	TagsInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_Ec2NetworkInsightsAnalysis) NetworkInsightsAnalysisArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ec2NetworkInsightsAnalysis) NetworkInsightsAnalysisId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ec2NetworkInsightsAnalysis) NetworkPathFound() cdktf.IResolvable {
...
func (j *jsiiProxy_Ec2NetworkInsightsAnalysis) Tags() Ec2NetworkInsightsAnalysisTagsList {
	var returns Ec2NetworkInsightsAnalysisTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_Ec2NetworkInsightsAnalysis) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/ec2_network_insights_analysis awscc_ec2_network_insights_analysis} Resource.
...
func (e *jsiiProxy_Ec2NetworkInsightsAnalysis) PutTags(value interface{}) {
