...
type Ec2NetworkInsightsAnalysisForwardPathComponentsSecurityGroupRuleOutputReference interface {
	...
	PortRange() Ec2NetworkInsightsAnalysisForwardPathComponentsSecurityGroupRulePortRangeOutputReference
	PrefixListId() *string
	Protocol() *string
...
func (j *jsiiProxy_Ec2NetworkInsightsAnalysisForwardPathComponentsSecurityGroupRuleOutputReference) PortRange() Ec2NetworkInsightsAnalysisForwardPathComponentsSecurityGroupRulePortRangeOutputReference {
...
func NewEc2NetworkInsightsAnalysisForwardPathComponentsSecurityGroupRuleOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) Ec2NetworkInsightsAnalysisForwardPathComponentsSecurityGroupRuleOutputReference {
	_init_.Initialize()

	if err := validateNewEc2NetworkInsightsAnalysisForwardPathComponentsSecurityGroupRuleOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewEc2NetworkInsightsAnalysisForwardPathComponentsSecurityGroupRuleOutputReference_Override(e Ec2NetworkInsightsAnalysisForwardPathComponentsSecurityGroupRuleOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
