...
func NewEc2NetworkInsightsAnalysisForwardPathComponentsRouteTableRouteOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) Ec2NetworkInsightsAnalysisForwardPathComponentsRouteTableRouteOutputReference {
	_init_.Initialize()

	if err := validateNewEc2NetworkInsightsAnalysisForwardPathComponentsRouteTableRouteOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewEc2NetworkInsightsAnalysisForwardPathComponentsRouteTableRouteOutputReference_Override(e Ec2NetworkInsightsAnalysisForwardPathComponentsRouteTableRouteOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
