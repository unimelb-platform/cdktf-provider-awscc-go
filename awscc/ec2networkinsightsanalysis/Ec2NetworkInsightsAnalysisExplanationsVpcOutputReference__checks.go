...
func validateNewEc2NetworkInsightsAnalysisExplanationsVpcOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
