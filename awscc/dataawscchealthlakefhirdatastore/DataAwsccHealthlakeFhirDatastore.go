...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/data-sources/healthlake_fhir_datastore awscc_healthlake_fhir_datastore}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/data-sources/healthlake_fhir_datastore awscc_healthlake_fhir_datastore} Data Source.
...
func (d *jsiiProxy_DataAwsccHealthlakeFhirDatastore) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsccHealthlakeFhirDatastore) ToHclTerraform() interface{} {
	var returns interface{}
