...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2VpcEndpointServicePermissions)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.ec2VpcEndpointServicePermissions.Ec2VpcEndpointServicePermissionsConfig",
		reflect.TypeOf((*Ec2VpcEndpointServicePermissionsConfig)(nil)).Elem(),
	)
}
