...
type LambdaCodeSigningConfig interface {
	...
	AllowedPublishersInput() interface{}
	// Experimental.
	CdktfStack() cdktf.TerraformStack
	CodeSigningConfigArn() *string
	CodeSigningConfigId() *string
	CodeSigningPolicies() LambdaCodeSigningConfigCodeSigningPoliciesOutputReference
	CodeSigningPoliciesInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_LambdaCodeSigningConfig) AllowedPublishersInput() interface{} {
...
func (j *jsiiProxy_LambdaCodeSigningConfig) CodeSigningConfigArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LambdaCodeSigningConfig) CodeSigningConfigId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"codeSigningConfigId",
...
func (j *jsiiProxy_LambdaCodeSigningConfig) CodeSigningPolicies() LambdaCodeSigningConfigCodeSigningPoliciesOutputReference {
	var returns LambdaCodeSigningConfigCodeSigningPoliciesOutputReference
	_jsii_.Get(
		j,
		"codeSigningPolicies",
		&returns,
...
func (j *jsiiProxy_LambdaCodeSigningConfig) CodeSigningPoliciesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (l *jsiiProxy_LambdaCodeSigningConfig) PutCodeSigningPolicies(value *LambdaCodeSigningConfigCodeSigningPolicies) {
	if err := l.validatePutCodeSigningPoliciesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		l,
		"putCodeSigningPolicies",
		[]interface{}{value},
	)
}
