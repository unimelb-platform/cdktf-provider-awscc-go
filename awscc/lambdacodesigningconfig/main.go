...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "codeSigningPoliciesInput", GoGetter: "CodeSigningPoliciesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putCodeSigningPolicies", GoMethod: "PutCodeSigningPolicies"},
			_jsii_.MemberMethod{JsiiMethod: "putTags", GoMethod: "PutTags"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetCodeSigningPolicies", GoMethod: "ResetCodeSigningPolicies"},
	...
	_jsii_.RegisterStruct(
		"awscc.lambdaCodeSigningConfig.LambdaCodeSigningConfigAllowedPublishers",
	...
	_jsii_.RegisterStruct(
		"awscc.lambdaCodeSigningConfig.LambdaCodeSigningConfigCodeSigningPolicies",
		reflect.TypeOf((*LambdaCodeSigningConfigCodeSigningPolicies)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.lambdaCodeSigningConfig.LambdaCodeSigningConfigCodeSigningPoliciesOutputReference",
		reflect.TypeOf((*LambdaCodeSigningConfigCodeSigningPoliciesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetUntrustedArtifactOnDeployment", GoMethod: "ResetUntrustedArtifactOnDeployment"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_LambdaCodeSigningConfigTagsList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LambdaCodeSigningConfigTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
