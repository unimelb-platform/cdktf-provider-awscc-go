...
func (j *jsiiProxy_LambdaCodeSigningConfigAllowedPublishersOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_LambdaCodeSigningConfigAllowedPublishersOutputReference)SetInternalValue(val interface{}) {
