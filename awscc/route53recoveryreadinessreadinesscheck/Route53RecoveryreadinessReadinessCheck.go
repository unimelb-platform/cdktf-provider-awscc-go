...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/route53recoveryreadiness_readiness_check awscc_route53recoveryreadiness_readiness_check}.
...
func (j *jsiiProxy_Route53RecoveryreadinessReadinessCheck) ReadinessCheckArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"readinessCheckArn",
...
func (j *jsiiProxy_Route53RecoveryreadinessReadinessCheck) Tags() Route53RecoveryreadinessReadinessCheckTagsList {
	var returns Route53RecoveryreadinessReadinessCheckTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/route53recoveryreadiness_readiness_check awscc_route53recoveryreadiness_readiness_check} Resource.
func NewRoute53RecoveryreadinessReadinessCheck(scope constructs.Construct, id *string, config *Route53RecoveryreadinessReadinessCheckConfig) Route53RecoveryreadinessReadinessCheck {
	...
	_jsii_.Create(
		"awscc.route53RecoveryreadinessReadinessCheck.Route53RecoveryreadinessReadinessCheck",
...
func (r *jsiiProxy_Route53RecoveryreadinessReadinessCheck) PutTags(value interface{}) {
...
func (r *jsiiProxy_Route53RecoveryreadinessReadinessCheck) ResetReadinessCheckName() {
	_jsii_.InvokeVoid(
		r,
		"resetReadinessCheckName",
		nil, // no parameters
...
func (r *jsiiProxy_Route53RecoveryreadinessReadinessCheck) ResetResourceSetName() {
	_jsii_.InvokeVoid(
		r,
		"resetResourceSetName",
		nil, // no parameters
