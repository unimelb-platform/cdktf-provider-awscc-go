...
type MskReplicatorReplicationInfoListTopicReplicationOutputReference interface {
	...
	StartingPositionInput() interface{}
	// Experimental.
	...
	TopicNameConfigurationInput() interface{}
...
func (j *jsiiProxy_MskReplicatorReplicationInfoListTopicReplicationOutputReference) StartingPositionInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MskReplicatorReplicationInfoListTopicReplicationOutputReference) TopicNameConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func NewMskReplicatorReplicationInfoListTopicReplicationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MskReplicatorReplicationInfoListTopicReplicationOutputReference {
	_init_.Initialize()

	if err := validateNewMskReplicatorReplicationInfoListTopicReplicationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewMskReplicatorReplicationInfoListTopicReplicationOutputReference_Override(m MskReplicatorReplicationInfoListTopicReplicationOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
