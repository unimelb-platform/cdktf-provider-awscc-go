...
func (j *jsiiProxy_MskReplicatorKafkaClustersOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewMskReplicatorKafkaClustersOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MskReplicatorKafkaClustersOutputReference {
	_init_.Initialize()
...
func NewMskReplicatorKafkaClustersOutputReference_Override(m MskReplicatorKafkaClustersOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MskReplicatorKafkaClustersOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (m *jsiiProxy_MskReplicatorKafkaClustersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MskReplicatorKafkaClustersOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (m *jsiiProxy_MskReplicatorKafkaClustersOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MskReplicatorKafkaClustersOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
