...
func NewMskReplicatorReplicationInfoListStructOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MskReplicatorReplicationInfoListStructOutputReference {
	_init_.Initialize()
...
func NewMskReplicatorReplicationInfoListStructOutputReference_Override(m MskReplicatorReplicationInfoListStructOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
