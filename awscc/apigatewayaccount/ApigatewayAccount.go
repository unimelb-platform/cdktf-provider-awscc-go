...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/apigatewayaccount/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/apigateway_account awscc_apigateway_account}.
...
func (j *jsiiProxy_ApigatewayAccount) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/apigateway_account awscc_apigateway_account} Resource.
func NewApigatewayAccount(scope constructs.Construct, id *string, config *ApigatewayAccountConfig) ApigatewayAccount {
	...
	_jsii_.Create(
		"awscc.apigatewayAccount.ApigatewayAccount",
