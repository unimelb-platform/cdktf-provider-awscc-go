...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.guarddutyIpSet.GuarddutyIpSetConfig",
		reflect.TypeOf((*GuarddutyIpSetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.guarddutyIpSet.GuarddutyIpSetTags",
		reflect.TypeOf((*GuarddutyIpSetTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.guarddutyIpSet.GuarddutyIpSetTagsList",
		reflect.TypeOf((*GuarddutyIpSetTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GuarddutyIpSetTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
