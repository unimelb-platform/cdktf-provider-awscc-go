...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/guardduty_ip_set awscc_guardduty_ip_set}.
...
func (j *jsiiProxy_GuarddutyIpSet) IpSetId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipSetId",
...
func (j *jsiiProxy_GuarddutyIpSet) Tags() GuarddutyIpSetTagsList {
	var returns GuarddutyIpSetTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/guardduty_ip_set awscc_guardduty_ip_set} Resource.
func NewGuarddutyIpSet(scope constructs.Construct, id *string, config *GuarddutyIpSetConfig) GuarddutyIpSet {
	...
	_jsii_.Create(
		"awscc.guarddutyIpSet.GuarddutyIpSet",
...
func (g *jsiiProxy_GuarddutyIpSet) PutTags(value interface{}) {
...
func (g *jsiiProxy_GuarddutyIpSet) ResetActivate() {
	_jsii_.InvokeVoid(
		g,
		"resetActivate",
		nil, // no parameters
...
func (g *jsiiProxy_GuarddutyIpSet) ResetDetectorId() {
	_jsii_.InvokeVoid(
		g,
		"resetDetectorId",
		nil, // no parameters
...
func (g *jsiiProxy_GuarddutyIpSet) ResetName() {
	_jsii_.InvokeVoid(
		g,
		"resetName",
		nil, // no parameters
