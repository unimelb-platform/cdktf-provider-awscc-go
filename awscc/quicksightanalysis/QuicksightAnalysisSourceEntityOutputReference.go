...
func (j *jsiiProxy_QuicksightAnalysisSourceEntityOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_QuicksightAnalysisSourceEntityOutputReference) SourceTemplateInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"sourceTemplateInput",
...
func (j *jsiiProxy_QuicksightAnalysisSourceEntityOutputReference)SetInternalValue(val interface{}) {
