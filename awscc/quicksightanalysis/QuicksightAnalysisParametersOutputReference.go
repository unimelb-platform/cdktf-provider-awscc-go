...
func (j *jsiiProxy_QuicksightAnalysisParametersOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_QuicksightAnalysisParametersOutputReference)SetInternalValue(val interface{}) {
