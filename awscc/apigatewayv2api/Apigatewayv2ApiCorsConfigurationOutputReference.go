...
func (j *jsiiProxy_Apigatewayv2ApiCorsConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_Apigatewayv2ApiCorsConfigurationOutputReference)SetInternalValue(val interface{}) {
