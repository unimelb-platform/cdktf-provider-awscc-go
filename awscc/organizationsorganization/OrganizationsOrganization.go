...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/organizationsorganization/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/organizations_organization awscc_organizations_organization}.
...
func (j *jsiiProxy_OrganizationsOrganization) ManagementAccountArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OrganizationsOrganization) ManagementAccountEmail() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OrganizationsOrganization) ManagementAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"managementAccountId",
...
func (j *jsiiProxy_OrganizationsOrganization) OrganizationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organizationId",
...
func (j *jsiiProxy_OrganizationsOrganization) RootId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"rootId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/organizations_organization awscc_organizations_organization} Resource.
func NewOrganizationsOrganization(scope constructs.Construct, id *string, config *OrganizationsOrganizationConfig) OrganizationsOrganization {
	...
	_jsii_.Create(
		"awscc.organizationsOrganization.OrganizationsOrganization",
