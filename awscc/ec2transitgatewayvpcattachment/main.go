...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "addSubnetIdsInput", GoGetter: "AddSubnetIdsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "removeSubnetIdsInput", GoGetter: "RemoveSubnetIdsInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetAddSubnetIds", GoMethod: "ResetAddSubnetIds"},
			_jsii_.MemberMethod{JsiiMethod: "resetOptions", GoMethod: "ResetOptions"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetRemoveSubnetIds", GoMethod: "ResetRemoveSubnetIds"},
	...
	_jsii_.RegisterStruct(
		"awscc.ec2TransitGatewayVpcAttachment.Ec2TransitGatewayVpcAttachmentConfig",
		reflect.TypeOf((*Ec2TransitGatewayVpcAttachmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.ec2TransitGatewayVpcAttachment.Ec2TransitGatewayVpcAttachmentOptions",
		reflect.TypeOf((*Ec2TransitGatewayVpcAttachmentOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2TransitGatewayVpcAttachment.Ec2TransitGatewayVpcAttachmentOptionsOutputReference",
		reflect.TypeOf((*Ec2TransitGatewayVpcAttachmentOptionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.ec2TransitGatewayVpcAttachment.Ec2TransitGatewayVpcAttachmentTags",
		reflect.TypeOf((*Ec2TransitGatewayVpcAttachmentTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2TransitGatewayVpcAttachment.Ec2TransitGatewayVpcAttachmentTagsList",
		reflect.TypeOf((*Ec2TransitGatewayVpcAttachmentTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2TransitGatewayVpcAttachmentTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
