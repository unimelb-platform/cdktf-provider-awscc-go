...
func (d *jsiiProxy_DataAwsccCloudtrailEventDataStoreAdvancedEventSelectorsFieldSelectorsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
