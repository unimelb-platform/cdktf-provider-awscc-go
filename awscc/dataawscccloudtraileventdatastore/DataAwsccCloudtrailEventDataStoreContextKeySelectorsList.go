...
func (j *jsiiProxy_DataAwsccCloudtrailEventDataStoreContextKeySelectorsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsccCloudtrailEventDataStoreContextKeySelectorsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccCloudtrailEventDataStoreContextKeySelectorsList {
	_init_.Initialize()
...
func NewDataAwsccCloudtrailEventDataStoreContextKeySelectorsList_Override(d DataAwsccCloudtrailEventDataStoreContextKeySelectorsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccCloudtrailEventDataStoreContextKeySelectorsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccCloudtrailEventDataStoreContextKeySelectorsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccCloudtrailEventDataStoreContextKeySelectorsList) Resolve(_context cdktf.IResolveContext) interface{} {
