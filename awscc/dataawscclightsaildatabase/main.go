...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccLightsailDatabase)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccLightsailDatabase.DataAwsccLightsailDatabaseConfig",
		reflect.TypeOf((*DataAwsccLightsailDatabaseConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccLightsailDatabase.DataAwsccLightsailDatabaseRelationalDatabaseParameters",
		reflect.TypeOf((*DataAwsccLightsailDatabaseRelationalDatabaseParameters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccLightsailDatabase.DataAwsccLightsailDatabaseRelationalDatabaseParametersList",
		reflect.TypeOf((*DataAwsccLightsailDatabaseRelationalDatabaseParametersList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccLightsailDatabaseRelationalDatabaseParametersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccLightsailDatabase.DataAwsccLightsailDatabaseTags",
		reflect.TypeOf((*DataAwsccLightsailDatabaseTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccLightsailDatabase.DataAwsccLightsailDatabaseTagsList",
		reflect.TypeOf((*DataAwsccLightsailDatabaseTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccLightsailDatabaseTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
