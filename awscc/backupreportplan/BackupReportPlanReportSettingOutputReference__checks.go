...
func (j *jsiiProxy_BackupReportPlanReportSettingOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *BackupReportPlanReportSetting:
		val := val.(*BackupReportPlanReportSetting)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case BackupReportPlanReportSetting:
		val_ := val.(BackupReportPlanReportSetting)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *BackupReportPlanReportSetting; received %#v (a %T)", val, val)
		}
	}
