...
func (j *jsiiProxy_BackupReportPlanReportDeliveryChannelOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_BackupReportPlanReportDeliveryChannelOutputReference)SetInternalValue(val interface{}) {
