...
func (j *jsiiProxy_BackupReportPlanReportSettingOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_BackupReportPlanReportSettingOutputReference)SetInternalValue(val interface{}) {
