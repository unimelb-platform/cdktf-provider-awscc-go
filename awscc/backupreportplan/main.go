...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putReportPlanTags", GoMethod: "PutReportPlanTags"},
			...
			_jsii_.MemberProperty{JsiiProperty: "reportPlanArn", GoGetter: "ReportPlanArn"},
			_jsii_.MemberProperty{JsiiProperty: "reportPlanDescription", GoGetter: "ReportPlanDescription"},
			_jsii_.MemberProperty{JsiiProperty: "reportPlanDescriptionInput", GoGetter: "ReportPlanDescriptionInput"},
			_jsii_.MemberProperty{JsiiProperty: "reportPlanName", GoGetter: "ReportPlanName"},
			_jsii_.MemberProperty{JsiiProperty: "reportPlanNameInput", GoGetter: "ReportPlanNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "reportPlanTags", GoGetter: "ReportPlanTags"},
			_jsii_.MemberProperty{JsiiProperty: "reportPlanTagsInput", GoGetter: "ReportPlanTagsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetReportPlanDescription", GoMethod: "ResetReportPlanDescription"},
			_jsii_.MemberMethod{JsiiMethod: "resetReportPlanName", GoMethod: "ResetReportPlanName"},
			_jsii_.MemberMethod{JsiiMethod: "resetReportPlanTags", GoMethod: "ResetReportPlanTags"},
	...
	_jsii_.RegisterStruct(
		"awscc.backupReportPlan.BackupReportPlanConfig",
	...
	_jsii_.RegisterClass(
		"awscc.backupReportPlan.BackupReportPlanReportDeliveryChannelOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.backupReportPlan.BackupReportPlanReportPlanTags",
		reflect.TypeOf((*BackupReportPlanReportPlanTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.backupReportPlan.BackupReportPlanReportPlanTagsList",
		reflect.TypeOf((*BackupReportPlanReportPlanTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BackupReportPlanReportPlanTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"awscc.backupReportPlan.BackupReportPlanReportSetting",
		reflect.TypeOf((*BackupReportPlanReportSetting)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.backupReportPlan.BackupReportPlanReportSettingOutputReference",
