...
func (g *jsiiProxy_Greengrassv2DeploymentComponentsRunWithSystemResourceLimitsOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (g *jsiiProxy_Greengrassv2DeploymentComponentsRunWithSystemResourceLimitsOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_Greengrassv2DeploymentComponentsRunWithSystemResourceLimitsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *Greengrassv2DeploymentComponentsRunWithSystemResourceLimits; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_Greengrassv2DeploymentComponentsRunWithSystemResourceLimitsOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewGreengrassv2DeploymentComponentsRunWithSystemResourceLimitsOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
