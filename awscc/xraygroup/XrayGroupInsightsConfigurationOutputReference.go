...
func (j *jsiiProxy_XrayGroupInsightsConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_XrayGroupInsightsConfigurationOutputReference)SetInternalValue(val interface{}) {
...
func (x *jsiiProxy_XrayGroupInsightsConfigurationOutputReference) ResetInsightsEnabled() {
	_jsii_.InvokeVoid(
		x,
		"resetInsightsEnabled",
		nil, // no parameters
