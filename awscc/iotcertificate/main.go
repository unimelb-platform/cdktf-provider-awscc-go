...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCaCertificatePem", GoMethod: "ResetCaCertificatePem"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCertificateSigningRequest", GoMethod: "ResetCertificateSigningRequest"},
	...
	_jsii_.RegisterStruct(
		"awscc.iotCertificate.IotCertificateConfig",
