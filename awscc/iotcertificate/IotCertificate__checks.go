...
func (j *jsiiProxy_IotCertificate) validateSetCaCertificatePemParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_IotCertificate) validateSetCertificateModeParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_IotCertificate) validateSetCertificateSigningRequestParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_IotCertificate) validateSetStatusParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
