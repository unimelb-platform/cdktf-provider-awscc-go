...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putPortRanges", GoMethod: "PutPortRanges"},
	...
	_jsii_.RegisterStruct(
		"awscc.globalacceleratorListener.GlobalacceleratorListenerConfig",
		reflect.TypeOf((*GlobalacceleratorListenerConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.globalacceleratorListener.GlobalacceleratorListenerPortRanges",
		reflect.TypeOf((*GlobalacceleratorListenerPortRanges)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.globalacceleratorListener.GlobalacceleratorListenerPortRangesList",
		reflect.TypeOf((*GlobalacceleratorListenerPortRangesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GlobalacceleratorListenerPortRangesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
