...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/globalaccelerator_listener awscc_globalaccelerator_listener}.
type GlobalacceleratorListener interface {
	...
	PortRanges() GlobalacceleratorListenerPortRangesList
...
func (j *jsiiProxy_GlobalacceleratorListener) ListenerArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"listenerArn",
...
func (j *jsiiProxy_GlobalacceleratorListener) PortRanges() GlobalacceleratorListenerPortRangesList {
	var returns GlobalacceleratorListenerPortRangesList
	_jsii_.Get(
		j,
		"portRanges",
		&returns,
...
func (j *jsiiProxy_GlobalacceleratorListener) PortRangesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"portRangesInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/globalaccelerator_listener awscc_globalaccelerator_listener} Resource.
...
func (g *jsiiProxy_GlobalacceleratorListener) PutPortRanges(value interface{}) {
	if err := g.validatePutPortRangesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		g,
...
func (g *jsiiProxy_GlobalacceleratorListener) ResetProtocol() {
	_jsii_.InvokeVoid(
		g,
		"resetProtocol",
		nil, // no parameters
