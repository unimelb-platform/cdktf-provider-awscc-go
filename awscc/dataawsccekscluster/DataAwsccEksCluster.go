...
func (j *jsiiProxy_DataAwsccEksCluster) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataAwsccEksCluster) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccEksCluster) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccEksCluster) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccEksCluster)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccEksCluster)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccEksCluster)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTF code for importing a DataAwsccEksCluster resource upon running "cdktf plan <stack-name>".
func DataAwsccEksCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccEksCluster) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsccEksCluster) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
