...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccRedshiftEndpointAuthorization)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "authorizeTime", GoGetter: "AuthorizeTime"},
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccRedshiftEndpointAuthorization.DataAwsccRedshiftEndpointAuthorizationConfig",
		reflect.TypeOf((*DataAwsccRedshiftEndpointAuthorizationConfig)(nil)).Elem(),
	)
}
