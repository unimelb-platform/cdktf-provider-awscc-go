...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/redshift_event_subscription awscc_redshift_event_subscription}.
...
func (j *jsiiProxy_RedshiftEventSubscription) CustSubscriptionId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"custSubscriptionId",
...
func (j *jsiiProxy_RedshiftEventSubscription) EventCategoriesList() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"eventCategoriesList",
...
func (j *jsiiProxy_RedshiftEventSubscription) SourceIdsList() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"sourceIdsList",
...
func (j *jsiiProxy_RedshiftEventSubscription) SubscriptionCreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RedshiftEventSubscription) SubscriptionName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"subscriptionName",
...
func (j *jsiiProxy_RedshiftEventSubscription) SubscriptionNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RedshiftEventSubscription) Tags() RedshiftEventSubscriptionTagsList {
	var returns RedshiftEventSubscriptionTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/redshift_event_subscription awscc_redshift_event_subscription} Resource.
func NewRedshiftEventSubscription(scope constructs.Construct, id *string, config *RedshiftEventSubscriptionConfig) RedshiftEventSubscription {
	...
	_jsii_.Create(
		"awscc.redshiftEventSubscription.RedshiftEventSubscription",
...
func (j *jsiiProxy_RedshiftEventSubscription)SetSubscriptionName(val *string) {
...
func (r *jsiiProxy_RedshiftEventSubscription) PutTags(value interface{}) {
...
func (r *jsiiProxy_RedshiftEventSubscription) ResetSnsTopicArn() {
	_jsii_.InvokeVoid(
		r,
		"resetSnsTopicArn",
		nil, // no parameters
