...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.redshiftEventSubscription.RedshiftEventSubscriptionConfig",
		reflect.TypeOf((*RedshiftEventSubscriptionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.redshiftEventSubscription.RedshiftEventSubscriptionTags",
		reflect.TypeOf((*RedshiftEventSubscriptionTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.redshiftEventSubscription.RedshiftEventSubscriptionTagsList",
		reflect.TypeOf((*RedshiftEventSubscriptionTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RedshiftEventSubscriptionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
