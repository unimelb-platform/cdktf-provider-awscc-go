...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/iot_thing_type awscc_iot_thing_type}.
type IotThingType interface {
	...
	DeprecateThingTypeInput() interface{}
	// Experimental.
	...
	ThingTypeProperties() IotThingTypeThingTypePropertiesOutputReference
	ThingTypePropertiesInput() interface{}
	...
	PutThingTypeProperties(value *IotThingTypeThingTypeProperties)
	ResetDeprecateThingType()
	// Resets a previously passed logical Id to use the auto-generated logical id again.
	// Experimental.
	ResetOverrideLogicalId()
	ResetTags()
	ResetThingTypeName()
	ResetThingTypeProperties()
...
func (j *jsiiProxy_IotThingType) DeprecateThingType() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"deprecateThingType",
...
func (j *jsiiProxy_IotThingType) DeprecateThingTypeInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IotThingType) Tags() IotThingTypeTagsList {
	var returns IotThingTypeTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_IotThingType) ThingTypeId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"thingTypeId",
...
func (j *jsiiProxy_IotThingType) ThingTypeName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"thingTypeName",
...
func (j *jsiiProxy_IotThingType) ThingTypeNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"thingTypeNameInput",
...
func (j *jsiiProxy_IotThingType) ThingTypeProperties() IotThingTypeThingTypePropertiesOutputReference {
	var returns IotThingTypeThingTypePropertiesOutputReference
	_jsii_.Get(
		j,
		"thingTypeProperties",
		&returns,
...
func (j *jsiiProxy_IotThingType) ThingTypePropertiesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"thingTypePropertiesInput",
		&returns,
	)
	return returns
}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/iot_thing_type awscc_iot_thing_type} Resource.
...
func (j *jsiiProxy_IotThingType)SetDeprecateThingType(val interface{}) {
...
func (j *jsiiProxy_IotThingType)SetThingTypeName(val *string) {
...
func (i *jsiiProxy_IotThingType) PutTags(value interface{}) {
...
func (i *jsiiProxy_IotThingType) PutThingTypeProperties(value *IotThingTypeThingTypeProperties) {
	if err := i.validatePutThingTypePropertiesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		i,
		"putThingTypeProperties",
		[]interface{}{value},
	)
}

func (i *jsiiProxy_IotThingType) ResetDeprecateThingType() {
	_jsii_.InvokeVoid(
		i,
		"resetDeprecateThingType",
		nil, // no parameters
...
func (i *jsiiProxy_IotThingType) ResetThingTypeName() {
	_jsii_.InvokeVoid(
		i,
		"resetThingTypeName",
		nil, // no parameters
...
func (i *jsiiProxy_IotThingType) ResetThingTypeProperties() {
	_jsii_.InvokeVoid(
		i,
		"resetThingTypeProperties",
		nil, // no parameters
