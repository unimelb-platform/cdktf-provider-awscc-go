...
func (i *jsiiProxy_IotThingTypeThingTypePropertiesMqtt5ConfigurationPropagatingAttributesList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_IotThingTypeThingTypePropertiesMqtt5ConfigurationPropagatingAttributesList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewIotThingTypeThingTypePropertiesMqtt5ConfigurationPropagatingAttributesListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
