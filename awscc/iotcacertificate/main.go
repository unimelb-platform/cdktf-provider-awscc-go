...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "autoRegistrationStatusInput", GoGetter: "AutoRegistrationStatusInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "removeAutoRegistrationInput", GoGetter: "RemoveAutoRegistrationInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetAutoRegistrationStatus", GoMethod: "ResetAutoRegistrationStatus"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRemoveAutoRegistration", GoMethod: "ResetRemoveAutoRegistration"},
	...
	_jsii_.RegisterStruct(
		"awscc.iotCaCertificate.IotCaCertificateConfig",
		reflect.TypeOf((*IotCaCertificateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.iotCaCertificate.IotCaCertificateRegistrationConfig",
	...
	_jsii_.RegisterStruct(
		"awscc.iotCaCertificate.IotCaCertificateTags",
		reflect.TypeOf((*IotCaCertificateTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.iotCaCertificate.IotCaCertificateTagsList",
		reflect.TypeOf((*IotCaCertificateTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IotCaCertificateTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
