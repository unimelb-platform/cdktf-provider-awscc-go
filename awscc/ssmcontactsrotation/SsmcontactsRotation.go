...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/ssmcontacts_rotation awscc_ssmcontacts_rotation}.
type SsmcontactsRotation interface {
	...
	PutRecurrence(value *SsmcontactsRotationRecurrence)
...
func (j *jsiiProxy_SsmcontactsRotation) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_SsmcontactsRotation) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SsmcontactsRotation) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SsmcontactsRotation) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_SsmcontactsRotation) Recurrence() SsmcontactsRotationRecurrenceOutputReference {
...
func (j *jsiiProxy_SsmcontactsRotation) Tags() SsmcontactsRotationTagsList {
	var returns SsmcontactsRotationTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_SsmcontactsRotation) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_SsmcontactsRotation) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/ssmcontacts_rotation awscc_ssmcontacts_rotation} Resource.
func NewSsmcontactsRotation(scope constructs.Construct, id *string, config *SsmcontactsRotationConfig) SsmcontactsRotation {
	...
	_jsii_.Create(
		"awscc.ssmcontactsRotation.SsmcontactsRotation",
...
func (j *jsiiProxy_SsmcontactsRotation)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SsmcontactsRotation)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SsmcontactsRotation)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SsmcontactsRotation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SsmcontactsRotation) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SsmcontactsRotation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SsmcontactsRotation) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SsmcontactsRotation) PutRecurrence(value *SsmcontactsRotationRecurrence) {
...
func (s *jsiiProxy_SsmcontactsRotation) PutTags(value interface{}) {
