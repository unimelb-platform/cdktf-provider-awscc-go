...
func (j *jsiiProxy_SsmcontactsRotationRecurrenceWeeklySettingsOutputReference) HandOffTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"handOffTime",
...
func (j *jsiiProxy_SsmcontactsRotationRecurrenceWeeklySettingsOutputReference) HandOffTimeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"handOffTimeInput",
...
func (j *jsiiProxy_SsmcontactsRotationRecurrenceWeeklySettingsOutputReference)SetHandOffTime(val *string) {
