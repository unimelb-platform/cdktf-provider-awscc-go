...
type SsmcontactsRotationRecurrenceOutputReference interface {
	...
	SetDailySettings(val *[]*string)
	DailySettingsInput() *[]*string
	// Experimental.
	Fqn() *string
	...
	ResetNumberOfOnCalls()
	ResetRecurrenceMultiplier()
	ResetShiftCoverages()
	ResetWeeklySettings()
...
func (j *jsiiProxy_SsmcontactsRotationRecurrenceOutputReference) DailySettings() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dailySettings",
...
func (j *jsiiProxy_SsmcontactsRotationRecurrenceOutputReference) DailySettingsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dailySettingsInput",
...
func NewSsmcontactsRotationRecurrenceOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SsmcontactsRotationRecurrenceOutputReference {
	_init_.Initialize()

	if err := validateNewSsmcontactsRotationRecurrenceOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewSsmcontactsRotationRecurrenceOutputReference_Override(s SsmcontactsRotationRecurrenceOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SsmcontactsRotationRecurrenceOutputReference)SetDailySettings(val *[]*string) {
	if err := j.validateSetDailySettingsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (s *jsiiProxy_SsmcontactsRotationRecurrenceOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SsmcontactsRotationRecurrenceOutputReference) ResetNumberOfOnCalls() {
	_jsii_.InvokeVoid(
		s,
		"resetNumberOfOnCalls",
		nil, // no parameters
...
func (s *jsiiProxy_SsmcontactsRotationRecurrenceOutputReference) ResetRecurrenceMultiplier() {
	_jsii_.InvokeVoid(
		s,
		"resetRecurrenceMultiplier",
		nil, // no parameters
...
func (s *jsiiProxy_SsmcontactsRotationRecurrenceOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
