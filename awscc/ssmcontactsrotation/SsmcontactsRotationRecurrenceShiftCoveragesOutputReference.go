...
func (j *jsiiProxy_SsmcontactsRotationRecurrenceShiftCoveragesOutputReference) DayOfWeek() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dayOfWeek",
...
func (j *jsiiProxy_SsmcontactsRotationRecurrenceShiftCoveragesOutputReference) DayOfWeekInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dayOfWeekInput",
...
func (j *jsiiProxy_SsmcontactsRotationRecurrenceShiftCoveragesOutputReference)SetDayOfWeek(val *string) {
