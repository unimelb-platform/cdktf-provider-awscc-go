...
type LexBotAliasConversationLogSettingsAudioLogSettingsDestination struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lex_bot_alias#s3_bucket LexBotAlias#s3_bucket}
