...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigateway_api_key awscc_apigateway_api_key}.
type ApigatewayApiKey interface {
	...
	GenerateDistinctIdInput() interface{}
	Id() *string
	// Experimental.
	...
	StageKeys() ApigatewayApiKeyStageKeysList
	StageKeysInput() interface{}
...
func (j *jsiiProxy_ApigatewayApiKey) ApiKeyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiKeyId",
...
func (j *jsiiProxy_ApigatewayApiKey) GenerateDistinctId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"generateDistinctId",
...
func (j *jsiiProxy_ApigatewayApiKey) GenerateDistinctIdInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"generateDistinctIdInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_ApigatewayApiKey) StageKeys() ApigatewayApiKeyStageKeysList {
	var returns ApigatewayApiKeyStageKeysList
	_jsii_.Get(
		j,
		"stageKeys",
		&returns,
...
func (j *jsiiProxy_ApigatewayApiKey) StageKeysInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"stageKeysInput",
...
func (j *jsiiProxy_ApigatewayApiKey) Tags() ApigatewayApiKeyTagsList {
	var returns ApigatewayApiKeyTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigateway_api_key awscc_apigateway_api_key} Resource.
...
func (j *jsiiProxy_ApigatewayApiKey)SetGenerateDistinctId(val interface{}) {
...
func (a *jsiiProxy_ApigatewayApiKey) PutStageKeys(value interface{}) {
	if err := a.validatePutStageKeysParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
...
func (a *jsiiProxy_ApigatewayApiKey) PutTags(value interface{}) {
...
func (a *jsiiProxy_ApigatewayApiKey) ResetGenerateDistinctId() {
	_jsii_.InvokeVoid(
		a,
		"resetGenerateDistinctId",
		nil, // no parameters
...
func (a *jsiiProxy_ApigatewayApiKey) ResetName() {
	_jsii_.InvokeVoid(
		a,
		"resetName",
		nil, // no parameters
...
func (a *jsiiProxy_ApigatewayApiKey) ResetStageKeys() {
	_jsii_.InvokeVoid(
		a,
		"resetStageKeys",
		nil, // no parameters
