...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/cloudfront_realtime_log_config awscc_cloudfront_realtime_log_config}.
type CloudfrontRealtimeLogConfig interface {
	...
	EndPoints() CloudfrontRealtimeLogConfigEndPointsList
...
func (j *jsiiProxy_CloudfrontRealtimeLogConfig) EndPoints() CloudfrontRealtimeLogConfigEndPointsList {
	var returns CloudfrontRealtimeLogConfigEndPointsList
	_jsii_.Get(
		j,
		"endPoints",
		&returns,
...
func (j *jsiiProxy_CloudfrontRealtimeLogConfig) EndPointsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"endPointsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/cloudfront_realtime_log_config awscc_cloudfront_realtime_log_config} Resource.
...
func (c *jsiiProxy_CloudfrontRealtimeLogConfig) PutEndPoints(value interface{}) {
