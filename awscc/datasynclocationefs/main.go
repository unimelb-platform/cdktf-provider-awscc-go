...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEfsFilesystemArn", GoMethod: "ResetEfsFilesystemArn"},
	...
	_jsii_.RegisterStruct(
		"awscc.datasyncLocationEfs.DatasyncLocationEfsEc2Config",
		reflect.TypeOf((*DatasyncLocationEfsEc2Config)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.datasyncLocationEfs.DatasyncLocationEfsEc2ConfigOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.datasyncLocationEfs.DatasyncLocationEfsTags",
		reflect.TypeOf((*DatasyncLocationEfsTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.datasyncLocationEfs.DatasyncLocationEfsTagsList",
		reflect.TypeOf((*DatasyncLocationEfsTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DatasyncLocationEfsTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
