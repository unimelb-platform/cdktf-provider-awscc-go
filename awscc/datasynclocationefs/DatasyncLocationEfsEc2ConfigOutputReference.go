...
func (j *jsiiProxy_DatasyncLocationEfsEc2ConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_DatasyncLocationEfsEc2ConfigOutputReference)SetInternalValue(val interface{}) {
