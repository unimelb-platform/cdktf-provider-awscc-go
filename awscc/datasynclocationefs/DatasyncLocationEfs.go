...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/datasync_location_efs awscc_datasync_location_efs}.
...
func (j *jsiiProxy_DatasyncLocationEfs) Ec2ConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"ec2ConfigInput",
...
func (j *jsiiProxy_DatasyncLocationEfs) LocationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationArn",
...
func (j *jsiiProxy_DatasyncLocationEfs) LocationUri() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationUri",
...
func (j *jsiiProxy_DatasyncLocationEfs) Tags() DatasyncLocationEfsTagsList {
	var returns DatasyncLocationEfsTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/datasync_location_efs awscc_datasync_location_efs} Resource.
func NewDatasyncLocationEfs(scope constructs.Construct, id *string, config *DatasyncLocationEfsConfig) DatasyncLocationEfs {
	...
	_jsii_.Create(
		"awscc.datasyncLocationEfs.DatasyncLocationEfs",
...
func (d *jsiiProxy_DatasyncLocationEfs) PutTags(value interface{}) {
...
func (d *jsiiProxy_DatasyncLocationEfs) ResetEfsFilesystemArn() {
	_jsii_.InvokeVoid(
		d,
		"resetEfsFilesystemArn",
		nil, // no parameters
