...
func (j *jsiiProxy_OamLinkLinkConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_OamLinkLinkConfigurationOutputReference) LogGroupConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OamLinkLinkConfigurationOutputReference) MetricConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func NewOamLinkLinkConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) OamLinkLinkConfigurationOutputReference {
	...
	_jsii_.Create(
		"awscc.oamLink.OamLinkLinkConfigurationOutputReference",
...
func (j *jsiiProxy_OamLinkLinkConfigurationOutputReference)SetInternalValue(val interface{}) {
