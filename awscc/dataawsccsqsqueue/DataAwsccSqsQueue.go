...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/data-sources/sqs_queue awscc_sqs_queue}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/data-sources/sqs_queue awscc_sqs_queue} Data Source.
...
func (d *jsiiProxy_DataAwsccSqsQueue) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsccSqsQueue) ToHclTerraform() interface{} {
	var returns interface{}
