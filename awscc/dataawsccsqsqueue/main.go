...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSqsQueue)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccSqsQueue.DataAwsccSqsQueueConfig",
		reflect.TypeOf((*DataAwsccSqsQueueConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccSqsQueue.DataAwsccSqsQueueTags",
		reflect.TypeOf((*DataAwsccSqsQueueTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccSqsQueue.DataAwsccSqsQueueTagsList",
		reflect.TypeOf((*DataAwsccSqsQueueTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSqsQueueTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
