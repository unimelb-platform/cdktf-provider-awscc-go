...
func (j *jsiiProxy_AppsyncDataSourceHttpConfigAuthorizationConfigOutputReference) AwsIamConfigInput() interface{} {
...
func (j *jsiiProxy_AppsyncDataSourceHttpConfigAuthorizationConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewAppsyncDataSourceHttpConfigAuthorizationConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) AppsyncDataSourceHttpConfigAuthorizationConfigOutputReference {
	...
	_jsii_.Create(
		"awscc.appsyncDataSource.AppsyncDataSourceHttpConfigAuthorizationConfigOutputReference",
...
func (j *jsiiProxy_AppsyncDataSourceHttpConfigAuthorizationConfigOutputReference)SetInternalValue(val interface{}) {
