...
func (j *jsiiProxy_AppsyncDataSourceLambdaConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_AppsyncDataSourceLambdaConfigOutputReference) LambdaFunctionArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lambdaFunctionArn",
...
func (j *jsiiProxy_AppsyncDataSourceLambdaConfigOutputReference) LambdaFunctionArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AppsyncDataSourceLambdaConfigOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_AppsyncDataSourceLambdaConfigOutputReference)SetLambdaFunctionArn(val *string) {
...
func (a *jsiiProxy_AppsyncDataSourceLambdaConfigOutputReference) ResetLambdaFunctionArn() {
	_jsii_.InvokeVoid(
		a,
		"resetLambdaFunctionArn",
		nil, // no parameters
