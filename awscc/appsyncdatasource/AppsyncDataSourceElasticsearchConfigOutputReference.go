...
func (j *jsiiProxy_AppsyncDataSourceElasticsearchConfigOutputReference) AwsRegion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"awsRegion",
...
func (j *jsiiProxy_AppsyncDataSourceElasticsearchConfigOutputReference) AwsRegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"awsRegionInput",
...
func (j *jsiiProxy_AppsyncDataSourceElasticsearchConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewAppsyncDataSourceElasticsearchConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) AppsyncDataSourceElasticsearchConfigOutputReference {
	...
	_jsii_.Create(
		"awscc.appsyncDataSource.AppsyncDataSourceElasticsearchConfigOutputReference",
...
func (j *jsiiProxy_AppsyncDataSourceElasticsearchConfigOutputReference)SetAwsRegion(val *string) {
...
func (j *jsiiProxy_AppsyncDataSourceElasticsearchConfigOutputReference)SetInternalValue(val interface{}) {
...
func (a *jsiiProxy_AppsyncDataSourceElasticsearchConfigOutputReference) ResetAwsRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetAwsRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AppsyncDataSourceElasticsearchConfigOutputReference) ResetEndpoint() {
	_jsii_.InvokeVoid(
		a,
		"resetEndpoint",
		nil, // no parameters
