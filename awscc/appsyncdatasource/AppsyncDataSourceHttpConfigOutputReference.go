...
func (j *jsiiProxy_AppsyncDataSourceHttpConfigOutputReference) AuthorizationConfigInput() interface{} {
...
func (j *jsiiProxy_AppsyncDataSourceHttpConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_AppsyncDataSourceHttpConfigOutputReference)SetInternalValue(val interface{}) {
...
func (a *jsiiProxy_AppsyncDataSourceHttpConfigOutputReference) ResetEndpoint() {
	_jsii_.InvokeVoid(
		a,
		"resetEndpoint",
		nil, // no parameters
