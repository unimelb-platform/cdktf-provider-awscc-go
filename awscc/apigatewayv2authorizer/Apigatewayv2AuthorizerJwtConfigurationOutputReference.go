...
func (j *jsiiProxy_Apigatewayv2AuthorizerJwtConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewApigatewayv2AuthorizerJwtConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) Apigatewayv2AuthorizerJwtConfigurationOutputReference {
	...
	_jsii_.Create(
		"awscc.apigatewayv2Authorizer.Apigatewayv2AuthorizerJwtConfigurationOutputReference",
...
func (j *jsiiProxy_Apigatewayv2AuthorizerJwtConfigurationOutputReference)SetInternalValue(val interface{}) {
