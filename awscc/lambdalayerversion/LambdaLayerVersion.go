...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lambda_layer_version awscc_lambda_layer_version}.
type LambdaLayerVersion interface {
	...
	PutContent(value *LambdaLayerVersionContent)
...
func (j *jsiiProxy_LambdaLayerVersion) Content() LambdaLayerVersionContentOutputReference {
	var returns LambdaLayerVersionContentOutputReference
	_jsii_.Get(
		j,
		"content",
		&returns,
...
func (j *jsiiProxy_LambdaLayerVersion) ContentInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"contentInput",
...
func (j *jsiiProxy_LambdaLayerVersion) LayerVersionArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"layerVersionArn",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lambda_layer_version awscc_lambda_layer_version} Resource.
func NewLambdaLayerVersion(scope constructs.Construct, id *string, config *LambdaLayerVersionConfig) LambdaLayerVersion {
	...
	_jsii_.Create(
		"awscc.lambdaLayerVersion.LambdaLayerVersion",
...
func (l *jsiiProxy_LambdaLayerVersion) PutContent(value *LambdaLayerVersionContent) {
...
func (l *jsiiProxy_LambdaLayerVersion) ResetLayerName() {
	_jsii_.InvokeVoid(
		l,
		"resetLayerName",
		nil, // no parameters
