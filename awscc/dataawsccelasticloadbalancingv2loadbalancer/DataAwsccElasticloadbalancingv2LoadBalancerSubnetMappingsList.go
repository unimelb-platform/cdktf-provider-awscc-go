...
func (d *jsiiProxy_DataAwsccElasticloadbalancingv2LoadBalancerSubnetMappingsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
