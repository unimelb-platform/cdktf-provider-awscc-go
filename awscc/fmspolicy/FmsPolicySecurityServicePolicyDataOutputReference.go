...
func (j *jsiiProxy_FmsPolicySecurityServicePolicyDataOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_FmsPolicySecurityServicePolicyDataOutputReference) PolicyOptionInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"policyOptionInput",
...
func (j *jsiiProxy_FmsPolicySecurityServicePolicyDataOutputReference)SetInternalValue(val interface{}) {
