...
func (j *jsiiProxy_FmsPolicyIncludeMapOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_FmsPolicyIncludeMapOutputReference)SetInternalValue(val interface{}) {
