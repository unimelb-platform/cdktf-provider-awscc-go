...
type EksIdentityProviderConfigOidcOutputReference interface {
	...
	RequiredClaims() EksIdentityProviderConfigOidcRequiredClaimsList
...
func (j *jsiiProxy_EksIdentityProviderConfigOidcOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EksIdentityProviderConfigOidcOutputReference) RequiredClaims() EksIdentityProviderConfigOidcRequiredClaimsList {
	var returns EksIdentityProviderConfigOidcRequiredClaimsList
	_jsii_.Get(
		j,
		"requiredClaims",
		&returns,
...
func (j *jsiiProxy_EksIdentityProviderConfigOidcOutputReference)SetInternalValue(val interface{}) {
...
func (e *jsiiProxy_EksIdentityProviderConfigOidcOutputReference) PutRequiredClaims(value interface{}) {
	if err := e.validatePutRequiredClaimsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		e,
