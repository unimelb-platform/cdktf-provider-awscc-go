...
func (e *jsiiProxy_EksIdentityProviderConfig) validatePutTagsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*EksIdentityProviderConfigTags:
		value := value.(*[]*EksIdentityProviderConfigTags)
	...
	case []*EksIdentityProviderConfigTags:
		value_ := value.([]*EksIdentityProviderConfigTags)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*EksIdentityProviderConfigTags; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_EksIdentityProviderConfig) validateSetIdentityProviderConfigNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_EksIdentityProviderConfig) validateSetTypeParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
