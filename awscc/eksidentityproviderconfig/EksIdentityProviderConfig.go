...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/eks_identity_provider_config awscc_eks_identity_provider_config}.
type EksIdentityProviderConfig interface {
	...
	ResetIdentityProviderConfigName()
	ResetOidc()
...
func (j *jsiiProxy_EksIdentityProviderConfig) IdentityProviderConfigArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EksIdentityProviderConfig) IdentityProviderConfigNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EksIdentityProviderConfig) OidcInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"oidcInput",
...
func (j *jsiiProxy_EksIdentityProviderConfig) Tags() EksIdentityProviderConfigTagsList {
	var returns EksIdentityProviderConfigTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_EksIdentityProviderConfig) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_EksIdentityProviderConfig) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/eks_identity_provider_config awscc_eks_identity_provider_config} Resource.
...
func (j *jsiiProxy_EksIdentityProviderConfig)SetIdentityProviderConfigName(val *string) {
...
func (j *jsiiProxy_EksIdentityProviderConfig)SetType(val *string) {
...
func (e *jsiiProxy_EksIdentityProviderConfig) PutTags(value interface{}) {
...
func (e *jsiiProxy_EksIdentityProviderConfig) ResetIdentityProviderConfigName() {
	_jsii_.InvokeVoid(
		e,
		"resetIdentityProviderConfigName",
		nil, // no parameters
...
func (e *jsiiProxy_EksIdentityProviderConfig) ResetOidc() {
	_jsii_.InvokeVoid(
		e,
		"resetOidc",
		nil, // no parameters
