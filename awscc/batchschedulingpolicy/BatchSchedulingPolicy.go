...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/batch_scheduling_policy awscc_batch_scheduling_policy}.
type BatchSchedulingPolicy interface {
	...
	FairsharePolicyInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_BatchSchedulingPolicy) FairsharePolicyInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/batch_scheduling_policy awscc_batch_scheduling_policy} Resource.
...
func (b *jsiiProxy_BatchSchedulingPolicy) ResetName() {
	_jsii_.InvokeVoid(
		b,
		"resetName",
		nil, // no parameters
