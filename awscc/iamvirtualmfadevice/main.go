...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetVirtualMfaDeviceName", GoMethod: "ResetVirtualMfaDeviceName"},
	...
	_jsii_.RegisterStruct(
		"awscc.iamVirtualMfaDevice.IamVirtualMfaDeviceTags",
		reflect.TypeOf((*IamVirtualMfaDeviceTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.iamVirtualMfaDevice.IamVirtualMfaDeviceTagsList",
		reflect.TypeOf((*IamVirtualMfaDeviceTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IamVirtualMfaDeviceTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
