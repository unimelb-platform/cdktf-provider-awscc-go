...
func (d *jsiiProxy_DataAwsccEcsServiceServiceConnectConfigurationLogConfigurationSecretOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
