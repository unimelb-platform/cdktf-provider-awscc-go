...
func (j *jsiiProxy_QuicksightTemplateSourceEntityOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_QuicksightTemplateSourceEntityOutputReference) SourceAnalysisInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"sourceAnalysisInput",
...
func (j *jsiiProxy_QuicksightTemplateSourceEntityOutputReference) SourceTemplateInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"sourceTemplateInput",
...
func (j *jsiiProxy_QuicksightTemplateSourceEntityOutputReference)SetInternalValue(val interface{}) {
