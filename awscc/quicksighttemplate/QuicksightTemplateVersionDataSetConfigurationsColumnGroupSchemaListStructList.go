...
func (q *jsiiProxy_QuicksightTemplateVersionDataSetConfigurationsColumnGroupSchemaListStructList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
