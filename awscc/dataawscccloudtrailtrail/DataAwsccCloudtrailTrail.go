...
type DataAwsccCloudtrailTrail interface {
	...
	EnableLogFileValidation() cdktf.IResolvable
	...
	SetId(val *string)
	IdInput() *string
	IncludeGlobalServiceEvents() cdktf.IResolvable
	InsightSelectors() DataAwsccCloudtrailTrailInsightSelectorsList
	IsLogging() cdktf.IResolvable
	IsMultiRegionTrail() cdktf.IResolvable
	IsOrganizationTrail() cdktf.IResolvable
	KmsKeyId() *string
	// Experimental.
...
func (j *jsiiProxy_DataAwsccCloudtrailTrail) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataAwsccCloudtrailTrail) EnableLogFileValidation() cdktf.IResolvable {
...
func (j *jsiiProxy_DataAwsccCloudtrailTrail) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccCloudtrailTrail) IncludeGlobalServiceEvents() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccCloudtrailTrail) IsLogging() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"isLogging",
...
func (j *jsiiProxy_DataAwsccCloudtrailTrail) IsMultiRegionTrail() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"isMultiRegionTrail",
...
func (j *jsiiProxy_DataAwsccCloudtrailTrail) IsOrganizationTrail() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"isOrganizationTrail",
...
func (j *jsiiProxy_DataAwsccCloudtrailTrail) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccCloudtrailTrail) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccCloudtrailTrail) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccCloudtrailTrail)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccCloudtrailTrail)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccCloudtrailTrail)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTF code for importing a DataAwsccCloudtrailTrail resource upon running "cdktf plan <stack-name>".
func DataAwsccCloudtrailTrail_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccCloudtrailTrail) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsccCloudtrailTrail) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
