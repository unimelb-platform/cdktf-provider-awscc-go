...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IamManagedPolicy)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "isAttachable", GoGetter: "IsAttachable"},
			_jsii_.MemberProperty{JsiiProperty: "lifecycle", GoGetter: "Lifecycle"},
			_jsii_.MemberProperty{JsiiProperty: "managedPolicyName", GoGetter: "ManagedPolicyName"},
			_jsii_.MemberProperty{JsiiProperty: "managedPolicyNameInput", GoGetter: "ManagedPolicyNameInput"},
			_jsii_.MemberMethod{JsiiMethod: "moveTo", GoMethod: "MoveTo"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
			_jsii_.MemberMethod{JsiiMethod: "overrideLogicalId", GoMethod: "OverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "path", GoGetter: "Path"},
			_jsii_.MemberProperty{JsiiProperty: "pathInput", GoGetter: "PathInput"},
			_jsii_.MemberProperty{JsiiProperty: "permissionsBoundaryUsageCount", GoGetter: "PermissionsBoundaryUsageCount"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetManagedPolicyName", GoMethod: "ResetManagedPolicyName"},
			...
			_jsii_.MemberProperty{JsiiProperty: "updateDate", GoGetter: "UpdateDate"},
	...
	_jsii_.RegisterStruct(
		"awscc.iamManagedPolicy.IamManagedPolicyConfig",
		reflect.TypeOf((*IamManagedPolicyConfig)(nil)).Elem(),
	)
}
