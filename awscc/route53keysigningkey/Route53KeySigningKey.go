...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/route53keysigningkey/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/route53_key_signing_key awscc_route53_key_signing_key}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/route53_key_signing_key awscc_route53_key_signing_key} Resource.
func NewRoute53KeySigningKey(scope constructs.Construct, id *string, config *Route53KeySigningKeyConfig) Route53KeySigningKey {
	...
	_jsii_.Create(
		"awscc.route53KeySigningKey.Route53KeySigningKey",
