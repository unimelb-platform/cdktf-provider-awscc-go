...
func init() {
	_jsii_.RegisterClass(
		"awscc.guarddutyMaster.GuarddutyMaster",
		reflect.TypeOf((*GuarddutyMaster)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_GuarddutyMaster{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.guarddutyMaster.GuarddutyMasterConfig",
		reflect.TypeOf((*GuarddutyMasterConfig)(nil)).Elem(),
	)
}
