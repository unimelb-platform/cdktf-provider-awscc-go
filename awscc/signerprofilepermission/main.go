...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SignerProfilePermission)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.signerProfilePermission.SignerProfilePermissionConfig",
		reflect.TypeOf((*SignerProfilePermissionConfig)(nil)).Elem(),
	)
}
