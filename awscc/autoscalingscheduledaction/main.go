...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AutoscalingScheduledAction)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.autoscalingScheduledAction.AutoscalingScheduledActionConfig",
		reflect.TypeOf((*AutoscalingScheduledActionConfig)(nil)).Elem(),
	)
}
