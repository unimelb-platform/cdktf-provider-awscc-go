...
func (c *jsiiProxy_CognitoIdentityPoolRoleAttachmentRoleMappingsRulesConfigurationRulesList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_CognitoIdentityPoolRoleAttachmentRoleMappingsRulesConfigurationRulesList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*CognitoIdentityPoolRoleAttachmentRoleMappingsRulesConfigurationRules; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CognitoIdentityPoolRoleAttachmentRoleMappingsRulesConfigurationRulesList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewCognitoIdentityPoolRoleAttachmentRoleMappingsRulesConfigurationRulesListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
