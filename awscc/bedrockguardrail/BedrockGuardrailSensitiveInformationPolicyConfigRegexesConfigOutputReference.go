...
func (b *jsiiProxy_BedrockGuardrailSensitiveInformationPolicyConfigRegexesConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BedrockGuardrailSensitiveInformationPolicyConfigRegexesConfigOutputReference) ResetAction() {
	_jsii_.InvokeVoid(
		b,
		"resetAction",
		nil, // no parameters
...
func (b *jsiiProxy_BedrockGuardrailSensitiveInformationPolicyConfigRegexesConfigOutputReference) ResetName() {
	_jsii_.InvokeVoid(
		b,
		"resetName",
		nil, // no parameters
...
func (b *jsiiProxy_BedrockGuardrailSensitiveInformationPolicyConfigRegexesConfigOutputReference) ResetPattern() {
	_jsii_.InvokeVoid(
		b,
		"resetPattern",
		nil, // no parameters
...
func (b *jsiiProxy_BedrockGuardrailSensitiveInformationPolicyConfigRegexesConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
