...
func NewBedrockGuardrailContextualGroundingPolicyConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) BedrockGuardrailContextualGroundingPolicyConfigOutputReference {
	_init_.Initialize()

	if err := validateNewBedrockGuardrailContextualGroundingPolicyConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewBedrockGuardrailContextualGroundingPolicyConfigOutputReference_Override(b BedrockGuardrailContextualGroundingPolicyConfigOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
