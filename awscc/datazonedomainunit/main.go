...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DatazoneDomainUnit)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "parentDomainUnitId", GoGetter: "ParentDomainUnitId"},
			_jsii_.MemberProperty{JsiiProperty: "parentDomainUnitIdentifier", GoGetter: "ParentDomainUnitIdentifier"},
			_jsii_.MemberProperty{JsiiProperty: "parentDomainUnitIdentifierInput", GoGetter: "ParentDomainUnitIdentifierInput"},
	...
	_jsii_.RegisterStruct(
		"awscc.datazoneDomainUnit.DatazoneDomainUnitConfig",
		reflect.TypeOf((*DatazoneDomainUnitConfig)(nil)).Elem(),
	)
}
