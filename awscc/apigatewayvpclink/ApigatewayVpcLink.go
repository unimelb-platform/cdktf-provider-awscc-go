...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigateway_vpc_link awscc_apigateway_vpc_link}.
...
func (j *jsiiProxy_ApigatewayVpcLink) Tags() ApigatewayVpcLinkTagsList {
	var returns ApigatewayVpcLinkTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_ApigatewayVpcLink) VpcLinkId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpcLinkId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigateway_vpc_link awscc_apigateway_vpc_link} Resource.
func NewApigatewayVpcLink(scope constructs.Construct, id *string, config *ApigatewayVpcLinkConfig) ApigatewayVpcLink {
	...
	_jsii_.Create(
		"awscc.apigatewayVpcLink.ApigatewayVpcLink",
...
func (a *jsiiProxy_ApigatewayVpcLink) PutTags(value interface{}) {
