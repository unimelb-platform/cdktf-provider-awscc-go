...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudformationHookDefaultVersion)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTypeVersionArn", GoMethod: "ResetTypeVersionArn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "typeVersionArnInput", GoGetter: "TypeVersionArnInput"},
	...
	_jsii_.RegisterStruct(
		"awscc.cloudformationHookDefaultVersion.CloudformationHookDefaultVersionConfig",
		reflect.TypeOf((*CloudformationHookDefaultVersionConfig)(nil)).Elem(),
	)
}
