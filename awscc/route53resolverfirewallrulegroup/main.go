...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "firewallRulesInput", GoGetter: "FirewallRulesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putFirewallRules", GoMethod: "PutFirewallRules"},
			_jsii_.MemberMethod{JsiiMethod: "putTags", GoMethod: "PutTags"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetFirewallRules", GoMethod: "ResetFirewallRules"},
	...
	_jsii_.RegisterStruct(
		"awscc.route53ResolverFirewallRuleGroup.Route53ResolverFirewallRuleGroupFirewallRules",
		reflect.TypeOf((*Route53ResolverFirewallRuleGroupFirewallRules)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.route53ResolverFirewallRuleGroup.Route53ResolverFirewallRuleGroupFirewallRulesList",
		reflect.TypeOf((*Route53ResolverFirewallRuleGroupFirewallRulesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Route53ResolverFirewallRuleGroupFirewallRulesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "firewallThreatProtectionIdInput", GoGetter: "FirewallThreatProtectionIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFirewallThreatProtectionId", GoMethod: "ResetFirewallThreatProtectionId"},
	...
	_jsii_.RegisterStruct(
		"awscc.route53ResolverFirewallRuleGroup.Route53ResolverFirewallRuleGroupTags",
		reflect.TypeOf((*Route53ResolverFirewallRuleGroupTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.route53ResolverFirewallRuleGroup.Route53ResolverFirewallRuleGroupTagsList",
		reflect.TypeOf((*Route53ResolverFirewallRuleGroupTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Route53ResolverFirewallRuleGroupTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
