...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccAppstreamApplication)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccAppstreamApplication.DataAwsccAppstreamApplicationConfig",
		reflect.TypeOf((*DataAwsccAppstreamApplicationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccAppstreamApplication.DataAwsccAppstreamApplicationIconS3Location",
		reflect.TypeOf((*DataAwsccAppstreamApplicationIconS3Location)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccAppstreamApplication.DataAwsccAppstreamApplicationIconS3LocationOutputReference",
		reflect.TypeOf((*DataAwsccAppstreamApplicationIconS3LocationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccAppstreamApplication.DataAwsccAppstreamApplicationTags",
		reflect.TypeOf((*DataAwsccAppstreamApplicationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccAppstreamApplication.DataAwsccAppstreamApplicationTagsList",
		reflect.TypeOf((*DataAwsccAppstreamApplicationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccAppstreamApplicationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
