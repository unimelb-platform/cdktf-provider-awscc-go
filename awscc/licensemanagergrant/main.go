...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAllowedOperations", GoMethod: "ResetAllowedOperations"},
			_jsii_.MemberMethod{JsiiMethod: "resetGrantName", GoMethod: "ResetGrantName"},
			_jsii_.MemberMethod{JsiiMethod: "resetHomeRegion", GoMethod: "ResetHomeRegion"},
			_jsii_.MemberMethod{JsiiMethod: "resetLicenseArn", GoMethod: "ResetLicenseArn"},
	...
	_jsii_.RegisterStruct(
		"awscc.licensemanagerGrant.LicensemanagerGrantConfig",
