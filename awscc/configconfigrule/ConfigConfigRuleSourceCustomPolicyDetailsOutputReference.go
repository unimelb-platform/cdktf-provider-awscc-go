...
func (j *jsiiProxy_ConfigConfigRuleSourceCustomPolicyDetailsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ConfigConfigRuleSourceCustomPolicyDetailsOutputReference)SetInternalValue(val interface{}) {
...
func (c *jsiiProxy_ConfigConfigRuleSourceCustomPolicyDetailsOutputReference) ResetPolicyRuntime() {
	_jsii_.InvokeVoid(
		c,
		"resetPolicyRuntime",
		nil, // no parameters
...
func (c *jsiiProxy_ConfigConfigRuleSourceCustomPolicyDetailsOutputReference) ResetPolicyText() {
	_jsii_.InvokeVoid(
		c,
		"resetPolicyText",
		nil, // no parameters
