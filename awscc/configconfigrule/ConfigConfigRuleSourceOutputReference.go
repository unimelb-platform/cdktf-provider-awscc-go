...
type ConfigConfigRuleSourceOutputReference interface {
	...
	CustomPolicyDetailsInput() interface{}
	// Experimental.
	Fqn() *string
	...
	SetOwner(val *string)
	OwnerInput() *string
	SourceDetails() ConfigConfigRuleSourceSourceDetailsList
	SourceDetailsInput() interface{}
	...
	PutSourceDetails(value interface{})
...
func (j *jsiiProxy_ConfigConfigRuleSourceOutputReference) CustomPolicyDetailsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ConfigConfigRuleSourceOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ConfigConfigRuleSourceOutputReference) SourceDetails() ConfigConfigRuleSourceSourceDetailsList {
	var returns ConfigConfigRuleSourceSourceDetailsList
	_jsii_.Get(
		j,
		"sourceDetails",
		&returns,
...
func (j *jsiiProxy_ConfigConfigRuleSourceOutputReference) SourceDetailsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"sourceDetailsInput",
...
func (j *jsiiProxy_ConfigConfigRuleSourceOutputReference)SetInternalValue(val interface{}) {
...
func (c *jsiiProxy_ConfigConfigRuleSourceOutputReference) PutSourceDetails(value interface{}) {
	if err := c.validatePutSourceDetailsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_ConfigConfigRuleSourceOutputReference) ResetSourceDetails() {
	_jsii_.InvokeVoid(
		c,
		"resetSourceDetails",
		nil, // no parameters
