...
func (j *jsiiProxy_GuarddutyDetectorDataSourcesS3LogsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_GuarddutyDetectorDataSourcesS3LogsOutputReference)SetInternalValue(val interface{}) {
