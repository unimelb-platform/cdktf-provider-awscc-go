...
func (j *jsiiProxy_GuarddutyDetectorDataSourcesKubernetesOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_GuarddutyDetectorDataSourcesKubernetesOutputReference)SetInternalValue(val interface{}) {
