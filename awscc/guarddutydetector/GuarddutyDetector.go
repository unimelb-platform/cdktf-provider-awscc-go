...
func (j *jsiiProxy_GuarddutyDetector) DataSourcesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"dataSourcesInput",
...
func (j *jsiiProxy_GuarddutyDetector) Features() GuarddutyDetectorFeaturesList {
	var returns GuarddutyDetectorFeaturesList
	_jsii_.Get(
		j,
		"features",
		&returns,
...
func (j *jsiiProxy_GuarddutyDetector) FeaturesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"featuresInput",
...
func (j *jsiiProxy_GuarddutyDetector) Tags() GuarddutyDetectorTagsList {
	var returns GuarddutyDetectorTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (g *jsiiProxy_GuarddutyDetector) PutFeatures(value interface{}) {
...
func (g *jsiiProxy_GuarddutyDetector) PutTags(value interface{}) {
...
func (g *jsiiProxy_GuarddutyDetector) ResetFeatures() {
	_jsii_.InvokeVoid(
		g,
		"resetFeatures",
		nil, // no parameters
