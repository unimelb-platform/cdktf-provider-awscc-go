...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/sagemaker_feature_group awscc_sagemaker_feature_group}.
type SagemakerFeatureGroup interface {
	...
	FeatureDefinitions() SagemakerFeatureGroupFeatureDefinitionsList
	FeatureDefinitionsInput() interface{}
	...
	ThroughputConfigInput() interface{}
	...
	PutFeatureDefinitions(value interface{})
...
func (j *jsiiProxy_SagemakerFeatureGroup) CreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creationTime",
...
func (j *jsiiProxy_SagemakerFeatureGroup) FeatureDefinitions() SagemakerFeatureGroupFeatureDefinitionsList {
	var returns SagemakerFeatureGroupFeatureDefinitionsList
	_jsii_.Get(
		j,
		"featureDefinitions",
		&returns,
...
func (j *jsiiProxy_SagemakerFeatureGroup) FeatureDefinitionsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"featureDefinitionsInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_SagemakerFeatureGroup) FeatureGroupStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"featureGroupStatus",
...
func (j *jsiiProxy_SagemakerFeatureGroup) OfflineStoreConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerFeatureGroup) OnlineStoreConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerFeatureGroup) Tags() SagemakerFeatureGroupTagsList {
	var returns SagemakerFeatureGroupTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_SagemakerFeatureGroup) ThroughputConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/sagemaker_feature_group awscc_sagemaker_feature_group} Resource.
...
func (s *jsiiProxy_SagemakerFeatureGroup) PutFeatureDefinitions(value interface{}) {
	if err := s.validatePutFeatureDefinitionsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
		"putFeatureDefinitions",
		[]interface{}{value},
	)
}
...
func (s *jsiiProxy_SagemakerFeatureGroup) PutTags(value interface{}) {
...
func (s *jsiiProxy_SagemakerFeatureGroup) ResetRoleArn() {
	_jsii_.InvokeVoid(
		s,
		"resetRoleArn",
		nil, // no parameters
