...
type SagemakerFeatureGroupOfflineStoreConfigOutputReference interface {
	...
	DataCatalogConfigInput() interface{}
...
func (j *jsiiProxy_SagemakerFeatureGroupOfflineStoreConfigOutputReference) DataCatalogConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerFeatureGroupOfflineStoreConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerFeatureGroupOfflineStoreConfigOutputReference)SetInternalValue(val interface{}) {
