...
func (j *jsiiProxy_SagemakerFeatureGroupThroughputConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerFeatureGroupThroughputConfigOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_SagemakerFeatureGroupThroughputConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerFeatureGroupThroughputConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
