...
func (j *jsiiProxy_SagemakerFeatureGroupOnlineStoreConfigTtlDurationOutputReference) validateSetInternalValueParameters(val interface{}) error {
	switch val.(type) {
	case cdktf.IResolvable:
		// ok
	case *SagemakerFeatureGroupOnlineStoreConfigTtlDuration:
		val := val.(*SagemakerFeatureGroupOnlineStoreConfigTtlDuration)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case SagemakerFeatureGroupOnlineStoreConfigTtlDuration:
		val_ := val.(SagemakerFeatureGroupOnlineStoreConfigTtlDuration)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *SagemakerFeatureGroupOnlineStoreConfigTtlDuration; received %#v (a %T)", val, val)
		}
	}
