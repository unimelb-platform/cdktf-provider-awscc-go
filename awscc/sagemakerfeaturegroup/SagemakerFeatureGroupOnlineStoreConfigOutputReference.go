...
func (j *jsiiProxy_SagemakerFeatureGroupOnlineStoreConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerFeatureGroupOnlineStoreConfigOutputReference) SecurityConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"securityConfigInput",
...
func (j *jsiiProxy_SagemakerFeatureGroupOnlineStoreConfigOutputReference)SetInternalValue(val interface{}) {
