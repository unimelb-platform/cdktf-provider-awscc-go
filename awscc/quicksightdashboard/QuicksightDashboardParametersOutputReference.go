...
func (j *jsiiProxy_QuicksightDashboardParametersOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_QuicksightDashboardParametersOutputReference)SetInternalValue(val interface{}) {
