...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.ec2TrafficMirrorFilterRule.Ec2TrafficMirrorFilterRuleConfig",
		reflect.TypeOf((*Ec2TrafficMirrorFilterRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.ec2TrafficMirrorFilterRule.Ec2TrafficMirrorFilterRuleDestinationPortRange",
	...
	_jsii_.RegisterStruct(
		"awscc.ec2TrafficMirrorFilterRule.Ec2TrafficMirrorFilterRuleSourcePortRange",
		reflect.TypeOf((*Ec2TrafficMirrorFilterRuleSourcePortRange)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2TrafficMirrorFilterRule.Ec2TrafficMirrorFilterRuleSourcePortRangeOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.ec2TrafficMirrorFilterRule.Ec2TrafficMirrorFilterRuleTags",
		reflect.TypeOf((*Ec2TrafficMirrorFilterRuleTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2TrafficMirrorFilterRule.Ec2TrafficMirrorFilterRuleTagsList",
		reflect.TypeOf((*Ec2TrafficMirrorFilterRuleTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2TrafficMirrorFilterRuleTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
