...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/ec2_traffic_mirror_filter_rule awscc_ec2_traffic_mirror_filter_rule}.
type Ec2TrafficMirrorFilterRule interface {
	...
	DestinationPortRangeInput() interface{}
	// Experimental.
	...
	SourcePortRangeInput() interface{}
...
func (j *jsiiProxy_Ec2TrafficMirrorFilterRule) DestinationPortRangeInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ec2TrafficMirrorFilterRule) SourcePortRangeInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ec2TrafficMirrorFilterRule) Tags() Ec2TrafficMirrorFilterRuleTagsList {
	var returns Ec2TrafficMirrorFilterRuleTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_Ec2TrafficMirrorFilterRule) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_Ec2TrafficMirrorFilterRule) TrafficMirrorFilterRuleId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/ec2_traffic_mirror_filter_rule awscc_ec2_traffic_mirror_filter_rule} Resource.
func NewEc2TrafficMirrorFilterRule(scope constructs.Construct, id *string, config *Ec2TrafficMirrorFilterRuleConfig) Ec2TrafficMirrorFilterRule {
	...
	_jsii_.Create(
		"awscc.ec2TrafficMirrorFilterRule.Ec2TrafficMirrorFilterRule",
...
func (e *jsiiProxy_Ec2TrafficMirrorFilterRule) PutTags(value interface{}) {
...
func (e *jsiiProxy_Ec2TrafficMirrorFilterRule) ResetTags() {
	_jsii_.InvokeVoid(
		e,
		"resetTags",
		nil, // no parameters
