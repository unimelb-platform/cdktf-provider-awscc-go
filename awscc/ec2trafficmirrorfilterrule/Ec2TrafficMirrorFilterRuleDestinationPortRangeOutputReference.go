...
func (j *jsiiProxy_Ec2TrafficMirrorFilterRuleDestinationPortRangeOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_Ec2TrafficMirrorFilterRuleDestinationPortRangeOutputReference)SetInternalValue(val interface{}) {
