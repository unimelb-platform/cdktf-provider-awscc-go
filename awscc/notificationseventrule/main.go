...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NotificationsEventRule)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.notificationsEventRule.NotificationsEventRuleConfig",
		reflect.TypeOf((*NotificationsEventRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.notificationsEventRule.NotificationsEventRuleStatusSummaryByRegion",
		reflect.TypeOf((*NotificationsEventRuleStatusSummaryByRegion)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.notificationsEventRule.NotificationsEventRuleStatusSummaryByRegionMap",
		reflect.TypeOf((*NotificationsEventRuleStatusSummaryByRegionMap)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NotificationsEventRuleStatusSummaryByRegionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
