...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/iamrolepolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/iam_role_policy awscc_iam_role_policy}.
...
func (j *jsiiProxy_IamRolePolicy) PolicyDocument() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyDocument",
...
func (j *jsiiProxy_IamRolePolicy) PolicyDocumentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyDocumentInput",
...
func (j *jsiiProxy_IamRolePolicy) PolicyName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyName",
...
func (j *jsiiProxy_IamRolePolicy) PolicyNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyNameInput",
...
func (j *jsiiProxy_IamRolePolicy) RoleName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleName",
...
func (j *jsiiProxy_IamRolePolicy) RoleNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleNameInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/iam_role_policy awscc_iam_role_policy} Resource.
func NewIamRolePolicy(scope constructs.Construct, id *string, config *IamRolePolicyConfig) IamRolePolicy {
	...
	_jsii_.Create(
		"awscc.iamRolePolicy.IamRolePolicy",
...
func (j *jsiiProxy_IamRolePolicy)SetPolicyDocument(val *string) {
...
func (j *jsiiProxy_IamRolePolicy)SetPolicyName(val *string) {
...
func (j *jsiiProxy_IamRolePolicy)SetRoleName(val *string) {
...
func (i *jsiiProxy_IamRolePolicy) ResetPolicyDocument() {
	_jsii_.InvokeVoid(
		i,
		"resetPolicyDocument",
		nil, // no parameters
