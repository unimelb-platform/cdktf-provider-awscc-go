...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.m2Environment.M2EnvironmentConfig",
		reflect.TypeOf((*M2EnvironmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.m2Environment.M2EnvironmentHighAvailabilityConfig",
		reflect.TypeOf((*M2EnvironmentHighAvailabilityConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.m2Environment.M2EnvironmentHighAvailabilityConfigOutputReference",
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*M2EnvironmentStorageConfigurations)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.m2Environment.M2EnvironmentStorageConfigurationsEfs",
		reflect.TypeOf((*M2EnvironmentStorageConfigurationsEfs)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.m2Environment.M2EnvironmentStorageConfigurationsEfsOutputReference",
		reflect.TypeOf((*M2EnvironmentStorageConfigurationsEfsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*M2EnvironmentStorageConfigurationsFsx)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.m2Environment.M2EnvironmentStorageConfigurationsFsxOutputReference",
		reflect.TypeOf((*M2EnvironmentStorageConfigurationsFsxOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*M2EnvironmentStorageConfigurationsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*M2EnvironmentStorageConfigurationsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
