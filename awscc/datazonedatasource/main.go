...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "connectionIdentifierInput", GoGetter: "ConnectionIdentifierInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetConnectionIdentifier", GoMethod: "ResetConnectionIdentifier"},
			_jsii_.MemberMethod{JsiiMethod: "resetDescription", GoMethod: "ResetDescription"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnableSetting", GoMethod: "ResetEnableSetting"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnvironmentIdentifier", GoMethod: "ResetEnvironmentIdentifier"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFormName", GoMethod: "ResetFormName"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "autoImportDataQualityResultInput", GoGetter: "AutoImportDataQualityResultInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAutoImportDataQualityResult", GoMethod: "ResetAutoImportDataQualityResult"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRelationalFilterConfigurations", GoMethod: "ResetRelationalFilterConfigurations"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putSageMakerRunConfiguration", GoMethod: "PutSageMakerRunConfiguration"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSageMakerRunConfiguration", GoMethod: "ResetSageMakerRunConfiguration"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "sageMakerRunConfiguration", GoGetter: "SageMakerRunConfiguration"},
			_jsii_.MemberProperty{JsiiProperty: "sageMakerRunConfigurationInput", GoGetter: "SageMakerRunConfigurationInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "relationalFilterConfigurationsInput", GoGetter: "RelationalFilterConfigurationsInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetDataAccessRole", GoMethod: "ResetDataAccessRole"},
			_jsii_.MemberMethod{JsiiMethod: "resetRedshiftCredentialConfiguration", GoMethod: "ResetRedshiftCredentialConfiguration"},
			_jsii_.MemberMethod{JsiiMethod: "resetRedshiftStorage", GoMethod: "ResetRedshiftStorage"},
			_jsii_.MemberMethod{JsiiMethod: "resetRelationalFilterConfigurations", GoMethod: "ResetRelationalFilterConfigurations"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DatazoneDataSourceConfigurationSageMakerRunConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.datazoneDataSource.DatazoneDataSourceConfigurationSageMakerRunConfigurationOutputReference",
		reflect.TypeOf((*DatazoneDataSourceConfigurationSageMakerRunConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetTrackingAssets", GoMethod: "ResetTrackingAssets"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "trackingAssets", GoGetter: "TrackingAssets"},
			_jsii_.MemberProperty{JsiiProperty: "trackingAssetsInput", GoGetter: "TrackingAssetsInput"},
		},
		func() interface{} {
