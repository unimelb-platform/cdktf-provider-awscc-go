...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/data-sources/internetmonitor_monitor awscc_internetmonitor_monitor}.
type DataAwsccInternetmonitorMonitor interface {
	...
	SetId(val *string)
	IdInput() *string
	IncludeLinkedAccounts() cdktf.IResolvable
...
func (j *jsiiProxy_DataAwsccInternetmonitorMonitor) IncludeLinkedAccounts() cdktf.IResolvable {
...
func (j *jsiiProxy_DataAwsccInternetmonitorMonitor) LinkedAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"linkedAccountId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/data-sources/internetmonitor_monitor awscc_internetmonitor_monitor} Data Source.
...
func (d *jsiiProxy_DataAwsccInternetmonitorMonitor) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsccInternetmonitorMonitor) ToHclTerraform() interface{} {
	var returns interface{}
