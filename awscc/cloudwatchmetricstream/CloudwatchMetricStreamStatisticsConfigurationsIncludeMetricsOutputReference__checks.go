...
func (c *jsiiProxy_CloudwatchMetricStreamStatisticsConfigurationsIncludeMetricsOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (c *jsiiProxy_CloudwatchMetricStreamStatisticsConfigurationsIncludeMetricsOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_CloudwatchMetricStreamStatisticsConfigurationsIncludeMetricsOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewCloudwatchMetricStreamStatisticsConfigurationsIncludeMetricsOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
