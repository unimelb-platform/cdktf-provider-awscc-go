...
func (d *jsiiProxy_DataAwsccLambdaEventSourceMappingSourceAccessConfigurationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
