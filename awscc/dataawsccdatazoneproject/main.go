...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDatazoneProject)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccDatazoneProject.DataAwsccDatazoneProjectConfig",
		reflect.TypeOf((*DataAwsccDatazoneProjectConfig)(nil)).Elem(),
	)
}
