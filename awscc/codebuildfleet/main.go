...
func init() {
	_jsii_.RegisterClass(
		"awscc.codebuildFleet.CodebuildFleet",
	...
	_jsii_.RegisterStruct(
		"awscc.codebuildFleet.CodebuildFleetConfig",
		reflect.TypeOf((*CodebuildFleetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.codebuildFleet.CodebuildFleetTags",
		reflect.TypeOf((*CodebuildFleetTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.codebuildFleet.CodebuildFleetTagsList",
		reflect.TypeOf((*CodebuildFleetTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CodebuildFleetTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
