...
func (j *jsiiProxy_CodebuildFleetScalingConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewCodebuildFleetScalingConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CodebuildFleetScalingConfigurationOutputReference {
	...
	_jsii_.Create(
		"awscc.codebuildFleet.CodebuildFleetScalingConfigurationOutputReference",
...
func (j *jsiiProxy_CodebuildFleetScalingConfigurationOutputReference)SetInternalValue(val interface{}) {
