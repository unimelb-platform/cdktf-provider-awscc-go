...
func (j *jsiiProxy_CodebuildFleetComputeConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewCodebuildFleetComputeConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CodebuildFleetComputeConfigurationOutputReference {
	...
	_jsii_.Create(
		"awscc.codebuildFleet.CodebuildFleetComputeConfigurationOutputReference",
...
func (j *jsiiProxy_CodebuildFleetComputeConfigurationOutputReference)SetInternalValue(val interface{}) {
