...
func (j *jsiiProxy_CodebuildFleet) Tags() CodebuildFleetTagsList {
	var returns CodebuildFleetTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_CodebuildFleet) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (c *jsiiProxy_CodebuildFleet) PutTags(value interface{}) {
...
func (c *jsiiProxy_CodebuildFleet) ResetBaseCapacity() {
	_jsii_.InvokeVoid(
		c,
		"resetBaseCapacity",
		nil, // no parameters
...
func (c *jsiiProxy_CodebuildFleet) ResetEnvironmentType() {
	_jsii_.InvokeVoid(
		c,
		"resetEnvironmentType",
		nil, // no parameters
