...
type AwsccProviderConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs#access_key AwsccProvider#access_key}
	AccessKey *string `field:"optional" json:"accessKey" yaml:"accessKey"`
	// Alias name.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs#alias AwsccProvider#alias}
	Alias *string `field:"optional" json:"alias" yaml:"alias"`
	// An `assume_role` block (documented below). Only one `assume_role` block may be in the configuration.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs#assume_role AwsccProvider#assume_role}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs#assume_role_with_web_identity AwsccProvider#assume_role_with_web_identity}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs#endpoints AwsccProvider#endpoints}
	Endpoints *AwsccProviderEndpoints `field:"optional" json:"endpoints" yaml:"endpoints"`
	// URL of a proxy to use for HTTP requests when accessing the AWS API.
	//
	// Can also be set using the `HTTP_PROXY` or `http_proxy` environment variables.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs#http_proxy AwsccProvider#http_proxy}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs#https_proxy AwsccProvider#https_proxy}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs#insecure AwsccProvider#insecure}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs#max_retries AwsccProvider#max_retries}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs#no_proxy AwsccProvider#no_proxy}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs#profile AwsccProvider#profile}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs#region AwsccProvider#region}
	Region *string `field:"optional" json:"region" yaml:"region"`
	// Amazon Resource Name of the AWS CloudFormation service role that is used on your behalf to perform operations.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs#role_arn AwsccProvider#role_arn}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs#secret_key AwsccProvider#secret_key}
	SecretKey *string `field:"optional" json:"secretKey" yaml:"secretKey"`
	// List of paths to shared config files. If not set, defaults to `~/.aws/config`.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs#shared_config_files AwsccProvider#shared_config_files}
	SharedConfigFiles *[]*string `field:"optional" json:"sharedConfigFiles" yaml:"sharedConfigFiles"`
	// List of paths to shared credentials files. If not set, defaults to `~/.aws/credentials`.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs#shared_credentials_files AwsccProvider#shared_credentials_files}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs#skip_medatadata_api_check AwsccProvider#skip_medatadata_api_check}
	SkipMedatadataApiCheck interface{} `field:"optional" json:"skipMedatadataApiCheck" yaml:"skipMedatadataApiCheck"`
	// Skip the AWS Metadata API check.
	//
	// Useful for AWS API implementations that do not have a metadata API endpoint.  Setting to `true` prevents Terraform from authenticating via the Metadata API. You may need to use other authentication methods like static credentials, configuration variables, or environment variables.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs#skip_metadata_api_check AwsccProvider#skip_metadata_api_check}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs#token AwsccProvider#token}
	Token *string `field:"optional" json:"token" yaml:"token"`
	// Product details to append to User-Agent string in all AWS API calls.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs#user_agent AwsccProvider#user_agent}
