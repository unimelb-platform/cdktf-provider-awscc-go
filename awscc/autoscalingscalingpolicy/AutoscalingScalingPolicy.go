...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/autoscaling_scaling_policy awscc_autoscaling_scaling_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/autoscaling_scaling_policy awscc_autoscaling_scaling_policy} Resource.
...
func (a *jsiiProxy_AutoscalingScalingPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AutoscalingScalingPolicy) MoveFromId(id *string) {
...
func (a *jsiiProxy_AutoscalingScalingPolicy) MoveToId(id *string) {
...
func (a *jsiiProxy_AutoscalingScalingPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AutoscalingScalingPolicy) ToHclTerraform() interface{} {
	var returns interface{}
