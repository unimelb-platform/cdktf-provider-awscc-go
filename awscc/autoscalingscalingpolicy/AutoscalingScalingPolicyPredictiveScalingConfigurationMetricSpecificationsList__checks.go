...
func (a *jsiiProxy_AutoscalingScalingPolicyPredictiveScalingConfigurationMetricSpecificationsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
