...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSsoAssignment)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccSsoAssignment.DataAwsccSsoAssignmentConfig",
		reflect.TypeOf((*DataAwsccSsoAssignmentConfig)(nil)).Elem(),
	)
}
