...
func (j *jsiiProxy_DataAwsccTransferWorkflowOnExceptionStepsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsccTransferWorkflowOnExceptionStepsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccTransferWorkflowOnExceptionStepsList {
	_init_.Initialize()
...
func NewDataAwsccTransferWorkflowOnExceptionStepsList_Override(d DataAwsccTransferWorkflowOnExceptionStepsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccTransferWorkflowOnExceptionStepsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccTransferWorkflowOnExceptionStepsList) Resolve(_context cdktf.IResolveContext) interface{} {
