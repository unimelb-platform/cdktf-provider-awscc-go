...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/cloudfrontmonitoringsubscription/internal"
)
...
type CloudfrontMonitoringSubscriptionMonitoringSubscriptionOutputReference interface {
	...
	RealtimeMetricsSubscriptionConfigInput() interface{}
	// Experimental.
	...
	ResetRealtimeMetricsSubscriptionConfig()
...
func (j *jsiiProxy_CloudfrontMonitoringSubscriptionMonitoringSubscriptionOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_CloudfrontMonitoringSubscriptionMonitoringSubscriptionOutputReference) RealtimeMetricsSubscriptionConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func NewCloudfrontMonitoringSubscriptionMonitoringSubscriptionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CloudfrontMonitoringSubscriptionMonitoringSubscriptionOutputReference {
	...
	_jsii_.Create(
		"awscc.cloudfrontMonitoringSubscription.CloudfrontMonitoringSubscriptionMonitoringSubscriptionOutputReference",
...
func (j *jsiiProxy_CloudfrontMonitoringSubscriptionMonitoringSubscriptionOutputReference)SetInternalValue(val interface{}) {
...
func (c *jsiiProxy_CloudfrontMonitoringSubscriptionMonitoringSubscriptionOutputReference) ResetRealtimeMetricsSubscriptionConfig() {
	_jsii_.InvokeVoid(
		c,
		"resetRealtimeMetricsSubscriptionConfig",
		nil, // no parameters
