...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.cloudfrontMonitoringSubscription.CloudfrontMonitoringSubscriptionConfig",
		reflect.TypeOf((*CloudfrontMonitoringSubscriptionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.cloudfrontMonitoringSubscription.CloudfrontMonitoringSubscriptionMonitoringSubscription",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRealtimeMetricsSubscriptionConfig", GoMethod: "ResetRealtimeMetricsSubscriptionConfig"},
	...
	_jsii_.RegisterClass(
		"awscc.cloudfrontMonitoringSubscription.CloudfrontMonitoringSubscriptionMonitoringSubscriptionRealtimeMetricsSubscriptionConfigOutputReference",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRealtimeMetricsSubscriptionStatus", GoMethod: "ResetRealtimeMetricsSubscriptionStatus"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
