...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RdsDbProxy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.rdsDbProxy.RdsDbProxyAuth",
		reflect.TypeOf((*RdsDbProxyAuth)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.rdsDbProxy.RdsDbProxyAuthList",
		reflect.TypeOf((*RdsDbProxyAuthList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RdsDbProxyAuthOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.rdsDbProxy.RdsDbProxyConfig",
		reflect.TypeOf((*RdsDbProxyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.rdsDbProxy.RdsDbProxyTags",
		reflect.TypeOf((*RdsDbProxyTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.rdsDbProxy.RdsDbProxyTagsList",
		reflect.TypeOf((*RdsDbProxyTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RdsDbProxyTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
