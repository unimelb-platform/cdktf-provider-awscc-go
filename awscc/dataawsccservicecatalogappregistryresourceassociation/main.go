...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccServicecatalogappregistryResourceAssociation)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccServicecatalogappregistryResourceAssociationConfig)(nil)).Elem(),
	)
}
