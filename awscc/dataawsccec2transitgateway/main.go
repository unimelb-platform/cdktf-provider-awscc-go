...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2TransitGateway)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccEc2TransitGateway.DataAwsccEc2TransitGatewayConfig",
		reflect.TypeOf((*DataAwsccEc2TransitGatewayConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccEc2TransitGateway.DataAwsccEc2TransitGatewayTags",
		reflect.TypeOf((*DataAwsccEc2TransitGatewayTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccEc2TransitGateway.DataAwsccEc2TransitGatewayTagsList",
		reflect.TypeOf((*DataAwsccEc2TransitGatewayTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2TransitGatewayTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
