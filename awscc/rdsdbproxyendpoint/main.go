...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RdsDbProxyEndpoint)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*RdsDbProxyEndpointConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.rdsDbProxyEndpoint.RdsDbProxyEndpointTags",
		reflect.TypeOf((*RdsDbProxyEndpointTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.rdsDbProxyEndpoint.RdsDbProxyEndpointTagsList",
		reflect.TypeOf((*RdsDbProxyEndpointTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RdsDbProxyEndpointTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
