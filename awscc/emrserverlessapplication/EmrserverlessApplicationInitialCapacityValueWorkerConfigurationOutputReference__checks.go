...
func (e *jsiiProxy_EmrserverlessApplicationInitialCapacityValueWorkerConfigurationOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (e *jsiiProxy_EmrserverlessApplicationInitialCapacityValueWorkerConfigurationOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_EmrserverlessApplicationInitialCapacityValueWorkerConfigurationOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *EmrserverlessApplicationInitialCapacityValueWorkerConfiguration:
		val := val.(*EmrserverlessApplicationInitialCapacityValueWorkerConfiguration)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case EmrserverlessApplicationInitialCapacityValueWorkerConfiguration:
		val_ := val.(EmrserverlessApplicationInitialCapacityValueWorkerConfiguration)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *EmrserverlessApplicationInitialCapacityValueWorkerConfiguration; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_EmrserverlessApplicationInitialCapacityValueWorkerConfigurationOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewEmrserverlessApplicationInitialCapacityValueWorkerConfigurationOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
