...
func (j *jsiiProxy_EmrserverlessApplicationMaximumCapacityOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *EmrserverlessApplicationMaximumCapacity:
		val := val.(*EmrserverlessApplicationMaximumCapacity)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case EmrserverlessApplicationMaximumCapacity:
		val_ := val.(EmrserverlessApplicationMaximumCapacity)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *EmrserverlessApplicationMaximumCapacity; received %#v (a %T)", val, val)
		}
	}
