...
func (j *jsiiProxy_ImagebuilderImageImageTestsConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ImagebuilderImageImageTestsConfigurationOutputReference)SetInternalValue(val interface{}) {
