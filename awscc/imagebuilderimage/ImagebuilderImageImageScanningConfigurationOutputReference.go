...
type ImagebuilderImageImageScanningConfigurationOutputReference interface {
	...
	EcrConfigurationInput() interface{}
	// Experimental.
	Fqn() *string
...
func (j *jsiiProxy_ImagebuilderImageImageScanningConfigurationOutputReference) EcrConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ImagebuilderImageImageScanningConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ImagebuilderImageImageScanningConfigurationOutputReference)SetInternalValue(val interface{}) {
