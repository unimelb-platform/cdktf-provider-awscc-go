...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/imagebuilder_image awscc_imagebuilder_image}.
...
func (j *jsiiProxy_ImagebuilderImage) ImageId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"imageId",
...
func (j *jsiiProxy_ImagebuilderImage) ImageScanningConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ImagebuilderImage) ImageTestsConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ImagebuilderImage) ImageUri() *string {
	var returns *string
	_jsii_.Get(
		j,
		"imageUri",
...
func (j *jsiiProxy_ImagebuilderImage) Workflows() ImagebuilderImageWorkflowsList {
	var returns ImagebuilderImageWorkflowsList
	_jsii_.Get(
		j,
		"workflows",
		&returns,
...
func (j *jsiiProxy_ImagebuilderImage) WorkflowsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"workflowsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/imagebuilder_image awscc_imagebuilder_image} Resource.
...
func (i *jsiiProxy_ImagebuilderImage) PutWorkflows(value interface{}) {
...
func (i *jsiiProxy_ImagebuilderImage) ResetInfrastructureConfigurationArn() {
	_jsii_.InvokeVoid(
		i,
		"resetInfrastructureConfigurationArn",
		nil, // no parameters
...
func (i *jsiiProxy_ImagebuilderImage) ResetWorkflows() {
	_jsii_.InvokeVoid(
		i,
		"resetWorkflows",
		nil, // no parameters
