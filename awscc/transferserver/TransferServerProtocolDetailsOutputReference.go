...
func (j *jsiiProxy_TransferServerProtocolDetailsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_TransferServerProtocolDetailsOutputReference)SetInternalValue(val interface{}) {
