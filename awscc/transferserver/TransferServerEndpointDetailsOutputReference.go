...
func (j *jsiiProxy_TransferServerEndpointDetailsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_TransferServerEndpointDetailsOutputReference)SetInternalValue(val interface{}) {
