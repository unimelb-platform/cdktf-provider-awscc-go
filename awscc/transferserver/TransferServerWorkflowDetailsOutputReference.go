...
type TransferServerWorkflowDetailsOutputReference interface {
	...
	OnPartialUpload() TransferServerWorkflowDetailsOnPartialUploadList
	OnPartialUploadInput() interface{}
	OnUpload() TransferServerWorkflowDetailsOnUploadList
	OnUploadInput() interface{}
	// Experimental.
	...
	PutOnPartialUpload(value interface{})
	PutOnUpload(value interface{})
...
func (j *jsiiProxy_TransferServerWorkflowDetailsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_TransferServerWorkflowDetailsOutputReference) OnPartialUpload() TransferServerWorkflowDetailsOnPartialUploadList {
	var returns TransferServerWorkflowDetailsOnPartialUploadList
	_jsii_.Get(
		j,
		"onPartialUpload",
		&returns,
...
func (j *jsiiProxy_TransferServerWorkflowDetailsOutputReference) OnPartialUploadInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TransferServerWorkflowDetailsOutputReference) OnUpload() TransferServerWorkflowDetailsOnUploadList {
	var returns TransferServerWorkflowDetailsOnUploadList
	_jsii_.Get(
		j,
		"onUpload",
		&returns,
...
func (j *jsiiProxy_TransferServerWorkflowDetailsOutputReference) OnUploadInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"onUploadInput",
...
func (j *jsiiProxy_TransferServerWorkflowDetailsOutputReference)SetInternalValue(val interface{}) {
...
func (t *jsiiProxy_TransferServerWorkflowDetailsOutputReference) PutOnPartialUpload(value interface{}) {
...
func (t *jsiiProxy_TransferServerWorkflowDetailsOutputReference) PutOnUpload(value interface{}) {
