...
func (j *jsiiProxy_TransferServerWorkflowDetailsOnUploadOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewTransferServerWorkflowDetailsOnUploadOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) TransferServerWorkflowDetailsOnUploadOutputReference {
	_init_.Initialize()

	if err := validateNewTransferServerWorkflowDetailsOnUploadOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewTransferServerWorkflowDetailsOnUploadOutputReference_Override(t TransferServerWorkflowDetailsOnUploadOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_TransferServerWorkflowDetailsOnUploadOutputReference)SetInternalValue(val interface{}) {
...
func (t *jsiiProxy_TransferServerWorkflowDetailsOnUploadOutputReference) ResetExecutionRole() {
	_jsii_.InvokeVoid(
		t,
		"resetExecutionRole",
		nil, // no parameters
...
func (t *jsiiProxy_TransferServerWorkflowDetailsOnUploadOutputReference) ResetWorkflowId() {
	_jsii_.InvokeVoid(
		t,
		"resetWorkflowId",
		nil, // no parameters
