...
func (j *jsiiProxy_QuicksightDataSourceSslPropertiesOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_QuicksightDataSourceSslPropertiesOutputReference)SetInternalValue(val interface{}) {
...
func (q *jsiiProxy_QuicksightDataSourceSslPropertiesOutputReference) ResetDisableSsl() {
	_jsii_.InvokeVoid(
		q,
		"resetDisableSsl",
		nil, // no parameters
