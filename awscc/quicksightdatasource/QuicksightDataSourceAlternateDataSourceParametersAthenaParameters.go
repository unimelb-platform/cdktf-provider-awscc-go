...
type QuicksightDataSourceAlternateDataSourceParametersAthenaParameters struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/quicksight_data_source#work_group QuicksightDataSource#work_group}
