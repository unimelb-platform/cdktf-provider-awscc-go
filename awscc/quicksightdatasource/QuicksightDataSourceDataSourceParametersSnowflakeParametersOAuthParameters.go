...
type QuicksightDataSourceDataSourceParametersSnowflakeParametersOAuthParameters struct {
	...
	IdentityProviderVpcConnectionProperties *QuicksightDataSourceDataSourceParametersSnowflakeParametersOAuthParametersIdentityProviderVpcConnectionProperties `field:"optional" json:"identityProviderVpcConnectionProperties" yaml:"identityProviderVpcConnectionProperties"`
