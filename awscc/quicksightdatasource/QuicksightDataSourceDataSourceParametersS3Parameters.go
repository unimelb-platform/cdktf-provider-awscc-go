...
type QuicksightDataSourceDataSourceParametersS3Parameters struct {
	...
	ManifestFileLocation *QuicksightDataSourceDataSourceParametersS3ParametersManifestFileLocation `field:"required" json:"manifestFileLocation" yaml:"manifestFileLocation"`
