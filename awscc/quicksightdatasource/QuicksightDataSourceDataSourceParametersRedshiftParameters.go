...
type QuicksightDataSourceDataSourceParametersRedshiftParameters struct {
	...
	IamParameters *QuicksightDataSourceDataSourceParametersRedshiftParametersIamParameters `field:"optional" json:"iamParameters" yaml:"iamParameters"`
	...
	IdentityCenterConfiguration *QuicksightDataSourceDataSourceParametersRedshiftParametersIdentityCenterConfiguration `field:"optional" json:"identityCenterConfiguration" yaml:"identityCenterConfiguration"`
