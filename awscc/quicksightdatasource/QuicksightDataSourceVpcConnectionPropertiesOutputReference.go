...
func (j *jsiiProxy_QuicksightDataSourceVpcConnectionPropertiesOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_QuicksightDataSourceVpcConnectionPropertiesOutputReference)SetInternalValue(val interface{}) {
...
func (q *jsiiProxy_QuicksightDataSourceVpcConnectionPropertiesOutputReference) ResetVpcConnectionArn() {
	_jsii_.InvokeVoid(
		q,
		"resetVpcConnectionArn",
		nil, // no parameters
