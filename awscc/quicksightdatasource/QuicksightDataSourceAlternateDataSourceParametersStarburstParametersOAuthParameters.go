...
type QuicksightDataSourceAlternateDataSourceParametersStarburstParametersOAuthParameters struct {
	...
	IdentityProviderVpcConnectionProperties *QuicksightDataSourceAlternateDataSourceParametersStarburstParametersOAuthParametersIdentityProviderVpcConnectionProperties `field:"optional" json:"identityProviderVpcConnectionProperties" yaml:"identityProviderVpcConnectionProperties"`
