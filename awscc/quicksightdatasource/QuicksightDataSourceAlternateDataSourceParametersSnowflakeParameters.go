...
type QuicksightDataSourceAlternateDataSourceParametersSnowflakeParameters struct {
	...
	OAuthParameters *QuicksightDataSourceAlternateDataSourceParametersSnowflakeParametersOAuthParameters `field:"optional" json:"oAuthParameters" yaml:"oAuthParameters"`
	// <p>Warehouse.</p>.
	//
