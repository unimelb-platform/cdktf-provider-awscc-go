...
type QuicksightDataSourceAlternateDataSourceParametersRedshiftParameters struct {
	// <p>Cluster ID.
	//
	...
	IamParameters *QuicksightDataSourceAlternateDataSourceParametersRedshiftParametersIamParameters `field:"optional" json:"iamParameters" yaml:"iamParameters"`
	...
	IdentityCenterConfiguration *QuicksightDataSourceAlternateDataSourceParametersRedshiftParametersIdentityCenterConfiguration `field:"optional" json:"identityCenterConfiguration" yaml:"identityCenterConfiguration"`
