...
type QuicksightDataSourceDataSourceParametersStarburstParametersOAuthParameters struct {
	...
	IdentityProviderVpcConnectionProperties *QuicksightDataSourceDataSourceParametersStarburstParametersOAuthParametersIdentityProviderVpcConnectionProperties `field:"optional" json:"identityProviderVpcConnectionProperties" yaml:"identityProviderVpcConnectionProperties"`
