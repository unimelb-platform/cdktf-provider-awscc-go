...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccLocationApiKeys)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccLocationApiKeys.DataAwsccLocationApiKeysConfig",
		reflect.TypeOf((*DataAwsccLocationApiKeysConfig)(nil)).Elem(),
	)
}
