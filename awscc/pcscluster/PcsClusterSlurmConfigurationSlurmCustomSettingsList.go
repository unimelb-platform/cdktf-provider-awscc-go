...
func (j *jsiiProxy_PcsClusterSlurmConfigurationSlurmCustomSettingsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewPcsClusterSlurmConfigurationSlurmCustomSettingsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PcsClusterSlurmConfigurationSlurmCustomSettingsList {
	_init_.Initialize()
...
func NewPcsClusterSlurmConfigurationSlurmCustomSettingsList_Override(p PcsClusterSlurmConfigurationSlurmCustomSettingsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PcsClusterSlurmConfigurationSlurmCustomSettingsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (p *jsiiProxy_PcsClusterSlurmConfigurationSlurmCustomSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PcsClusterSlurmConfigurationSlurmCustomSettingsList) Resolve(_context cdktf.IResolveContext) interface{} {
