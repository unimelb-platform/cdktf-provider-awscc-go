...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/elasticbeanstalk_application awscc_elasticbeanstalk_application}.
type ElasticbeanstalkApplication interface {
	...
	ResourceLifecycleConfig() ElasticbeanstalkApplicationResourceLifecycleConfigOutputReference
	ResourceLifecycleConfigInput() interface{}
	// Experimental.
	...
	PutResourceLifecycleConfig(value *ElasticbeanstalkApplicationResourceLifecycleConfig)
	ResetApplicationName()
	ResetDescription()
	// Resets a previously passed logical Id to use the auto-generated logical id again.
	// Experimental.
	ResetOverrideLogicalId()
	ResetResourceLifecycleConfig()
...
func (j *jsiiProxy_ElasticbeanstalkApplication) ApplicationName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationName",
...
func (j *jsiiProxy_ElasticbeanstalkApplication) ApplicationNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ElasticbeanstalkApplication) ResourceLifecycleConfig() ElasticbeanstalkApplicationResourceLifecycleConfigOutputReference {
	var returns ElasticbeanstalkApplicationResourceLifecycleConfigOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ElasticbeanstalkApplication) ResourceLifecycleConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"resourceLifecycleConfigInput",
		&returns,
	)
	return returns
}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/elasticbeanstalk_application awscc_elasticbeanstalk_application} Resource.
...
func (j *jsiiProxy_ElasticbeanstalkApplication)SetApplicationName(val *string) {
...
func (e *jsiiProxy_ElasticbeanstalkApplication) PutResourceLifecycleConfig(value *ElasticbeanstalkApplicationResourceLifecycleConfig) {
	if err := e.validatePutResourceLifecycleConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		e,
		"putResourceLifecycleConfig",
		[]interface{}{value},
	)
}

func (e *jsiiProxy_ElasticbeanstalkApplication) ResetApplicationName() {
	_jsii_.InvokeVoid(
		e,
		"resetApplicationName",
		nil, // no parameters
...
func (e *jsiiProxy_ElasticbeanstalkApplication) ResetResourceLifecycleConfig() {
	_jsii_.InvokeVoid(
		e,
		"resetResourceLifecycleConfig",
		nil, // no parameters
