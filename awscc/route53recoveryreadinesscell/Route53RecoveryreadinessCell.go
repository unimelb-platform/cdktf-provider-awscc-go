...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/route53recoveryreadiness_cell awscc_route53recoveryreadiness_cell}.
...
func (j *jsiiProxy_Route53RecoveryreadinessCell) CellArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cellArn",
...
func (j *jsiiProxy_Route53RecoveryreadinessCell) Tags() Route53RecoveryreadinessCellTagsList {
	var returns Route53RecoveryreadinessCellTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/route53recoveryreadiness_cell awscc_route53recoveryreadiness_cell} Resource.
func NewRoute53RecoveryreadinessCell(scope constructs.Construct, id *string, config *Route53RecoveryreadinessCellConfig) Route53RecoveryreadinessCell {
	...
	_jsii_.Create(
		"awscc.route53RecoveryreadinessCell.Route53RecoveryreadinessCell",
...
func (r *jsiiProxy_Route53RecoveryreadinessCell) PutTags(value interface{}) {
...
func (r *jsiiProxy_Route53RecoveryreadinessCell) ResetCellName() {
	_jsii_.InvokeVoid(
		r,
		"resetCellName",
		nil, // no parameters
