...
func (d *jsiiProxy_DataAwsccApigatewayMethodIntegrationIntegrationResponsesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
