...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EventsEventBus)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.eventsEventBus.EventsEventBusConfig",
		reflect.TypeOf((*EventsEventBusConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.eventsEventBus.EventsEventBusDeadLetterConfig",
		reflect.TypeOf((*EventsEventBusDeadLetterConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.eventsEventBus.EventsEventBusDeadLetterConfigOutputReference",
		reflect.TypeOf((*EventsEventBusDeadLetterConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "arn", GoGetter: "Arn"},
	...
	_jsii_.RegisterStruct(
		"awscc.eventsEventBus.EventsEventBusTags",
		reflect.TypeOf((*EventsEventBusTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.eventsEventBus.EventsEventBusTagsList",
		reflect.TypeOf((*EventsEventBusTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EventsEventBusTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
