...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2IpamPool)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccEc2IpamPool.DataAwsccEc2IpamPoolAllocationResourceTags",
		reflect.TypeOf((*DataAwsccEc2IpamPoolAllocationResourceTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccEc2IpamPool.DataAwsccEc2IpamPoolAllocationResourceTagsList",
		reflect.TypeOf((*DataAwsccEc2IpamPoolAllocationResourceTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2IpamPoolAllocationResourceTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccEc2IpamPool.DataAwsccEc2IpamPoolConfig",
		reflect.TypeOf((*DataAwsccEc2IpamPoolConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccEc2IpamPool.DataAwsccEc2IpamPoolProvisionedCidrs",
		reflect.TypeOf((*DataAwsccEc2IpamPoolProvisionedCidrs)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccEc2IpamPool.DataAwsccEc2IpamPoolProvisionedCidrsList",
		reflect.TypeOf((*DataAwsccEc2IpamPoolProvisionedCidrsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2IpamPoolProvisionedCidrsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccEc2IpamPool.DataAwsccEc2IpamPoolSourceResource",
		reflect.TypeOf((*DataAwsccEc2IpamPoolSourceResource)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccEc2IpamPool.DataAwsccEc2IpamPoolSourceResourceOutputReference",
		reflect.TypeOf((*DataAwsccEc2IpamPoolSourceResourceOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccEc2IpamPool.DataAwsccEc2IpamPoolTags",
		reflect.TypeOf((*DataAwsccEc2IpamPoolTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccEc2IpamPool.DataAwsccEc2IpamPoolTagsList",
		reflect.TypeOf((*DataAwsccEc2IpamPoolTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccEc2IpamPoolTagsList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexList)
			return &j
		},
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2IpamPoolTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
