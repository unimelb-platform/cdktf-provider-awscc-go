...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/globalaccelerator_accelerator awscc_globalaccelerator_accelerator}.
...
func (j *jsiiProxy_GlobalacceleratorAccelerator) AcceleratorArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"acceleratorArn",
...
func (j *jsiiProxy_GlobalacceleratorAccelerator) Ipv4Addresses() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"ipv4Addresses",
...
func (j *jsiiProxy_GlobalacceleratorAccelerator) Ipv6Addresses() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"ipv6Addresses",
...
func (j *jsiiProxy_GlobalacceleratorAccelerator) Tags() GlobalacceleratorAcceleratorTagsList {
	var returns GlobalacceleratorAcceleratorTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/globalaccelerator_accelerator awscc_globalaccelerator_accelerator} Resource.
func NewGlobalacceleratorAccelerator(scope constructs.Construct, id *string, config *GlobalacceleratorAcceleratorConfig) GlobalacceleratorAccelerator {
	...
	_jsii_.Create(
		"awscc.globalacceleratorAccelerator.GlobalacceleratorAccelerator",
...
func (g *jsiiProxy_GlobalacceleratorAccelerator) PutTags(value interface{}) {
