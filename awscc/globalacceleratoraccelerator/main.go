...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.globalacceleratorAccelerator.GlobalacceleratorAcceleratorConfig",
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GlobalacceleratorAcceleratorTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.globalacceleratorAccelerator.GlobalacceleratorAcceleratorTagsList",
		reflect.TypeOf((*GlobalacceleratorAcceleratorTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GlobalacceleratorAcceleratorTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
