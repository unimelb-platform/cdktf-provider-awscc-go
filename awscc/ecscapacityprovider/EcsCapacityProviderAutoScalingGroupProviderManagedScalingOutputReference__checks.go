...
func (j *jsiiProxy_EcsCapacityProviderAutoScalingGroupProviderManagedScalingOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *EcsCapacityProviderAutoScalingGroupProviderManagedScaling:
		val := val.(*EcsCapacityProviderAutoScalingGroupProviderManagedScaling)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case EcsCapacityProviderAutoScalingGroupProviderManagedScaling:
		val_ := val.(EcsCapacityProviderAutoScalingGroupProviderManagedScaling)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *EcsCapacityProviderAutoScalingGroupProviderManagedScaling; received %#v (a %T)", val, val)
		}
	}
