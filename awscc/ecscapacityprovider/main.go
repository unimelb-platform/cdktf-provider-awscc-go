...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.ecsCapacityProvider.EcsCapacityProviderAutoScalingGroupProvider",
	...
	_jsii_.RegisterStruct(
		"awscc.ecsCapacityProvider.EcsCapacityProviderTags",
	...
	_jsii_.RegisterClass(
		"awscc.ecsCapacityProvider.EcsCapacityProviderTagsOutputReference",
