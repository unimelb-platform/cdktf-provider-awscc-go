...
func (j *jsiiProxy_EcsCapacityProviderAutoScalingGroupProviderOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EcsCapacityProviderAutoScalingGroupProviderOutputReference) ManagedScalingInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"managedScalingInput",
...
func NewEcsCapacityProviderAutoScalingGroupProviderOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) EcsCapacityProviderAutoScalingGroupProviderOutputReference {
	...
	_jsii_.Create(
		"awscc.ecsCapacityProvider.EcsCapacityProviderAutoScalingGroupProviderOutputReference",
...
func (j *jsiiProxy_EcsCapacityProviderAutoScalingGroupProviderOutputReference)SetInternalValue(val interface{}) {
