...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "apiKeySourceTypeInput", GoGetter: "ApiKeySourceTypeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetApiKeySourceType", GoMethod: "ResetApiKeySourceType"},
	...
	_jsii_.RegisterStruct(
		"awscc.apigatewayRestApi.ApigatewayRestApiBodyS3Location",
		reflect.TypeOf((*ApigatewayRestApiBodyS3Location)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.apigatewayRestApi.ApigatewayRestApiBodyS3LocationOutputReference",
		reflect.TypeOf((*ApigatewayRestApiBodyS3LocationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_ApigatewayRestApiBodyS3LocationOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.apigatewayRestApi.ApigatewayRestApiConfig",
	...
	_jsii_.RegisterStruct(
		"awscc.apigatewayRestApi.ApigatewayRestApiTags",
		reflect.TypeOf((*ApigatewayRestApiTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.apigatewayRestApi.ApigatewayRestApiTagsList",
		reflect.TypeOf((*ApigatewayRestApiTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ApigatewayRestApiTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
