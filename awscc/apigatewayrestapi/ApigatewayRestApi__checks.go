...
func (a *jsiiProxy_ApigatewayRestApi) validatePutBodyS3LocationParameters(value *ApigatewayRestApiBodyS3Location) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (a *jsiiProxy_ApigatewayRestApi) validatePutTagsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*ApigatewayRestApiTags:
		value := value.(*[]*ApigatewayRestApiTags)
	...
	case []*ApigatewayRestApiTags:
		value_ := value.([]*ApigatewayRestApiTags)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ApigatewayRestApiTags; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_ApigatewayRestApi) validateSetApiKeySourceTypeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_ApigatewayRestApi) validateSetCloneFromParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_ApigatewayRestApi) validateSetModeParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_ApigatewayRestApi) validateSetParametersParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
