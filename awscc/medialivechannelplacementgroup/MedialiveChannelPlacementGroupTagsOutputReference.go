...
func (j *jsiiProxy_MedialiveChannelPlacementGroupTagsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewMedialiveChannelPlacementGroupTagsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MedialiveChannelPlacementGroupTagsOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"awscc.medialiveChannelPlacementGroup.MedialiveChannelPlacementGroupTagsOutputReference",
...
func NewMedialiveChannelPlacementGroupTagsOutputReference_Override(m MedialiveChannelPlacementGroupTagsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MedialiveChannelPlacementGroupTagsOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (m *jsiiProxy_MedialiveChannelPlacementGroupTagsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MedialiveChannelPlacementGroupTagsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (m *jsiiProxy_MedialiveChannelPlacementGroupTagsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MedialiveChannelPlacementGroupTagsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
