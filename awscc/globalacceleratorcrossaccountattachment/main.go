...
func init() {
	_jsii_.RegisterClass(
		"awscc.globalacceleratorCrossAccountAttachment.GlobalacceleratorCrossAccountAttachment",
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GlobalacceleratorCrossAccountAttachmentResources)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.globalacceleratorCrossAccountAttachment.GlobalacceleratorCrossAccountAttachmentResourcesList",
		reflect.TypeOf((*GlobalacceleratorCrossAccountAttachmentResourcesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GlobalacceleratorCrossAccountAttachmentResourcesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GlobalacceleratorCrossAccountAttachmentTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.globalacceleratorCrossAccountAttachment.GlobalacceleratorCrossAccountAttachmentTagsList",
		reflect.TypeOf((*GlobalacceleratorCrossAccountAttachmentTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GlobalacceleratorCrossAccountAttachmentTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
