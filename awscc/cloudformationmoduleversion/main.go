...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudformationModuleVersion)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "modulePackageInput", GoGetter: "ModulePackageInput"},
	...
	_jsii_.RegisterStruct(
		"awscc.cloudformationModuleVersion.CloudformationModuleVersionConfig",
		reflect.TypeOf((*CloudformationModuleVersionConfig)(nil)).Elem(),
	)
}
