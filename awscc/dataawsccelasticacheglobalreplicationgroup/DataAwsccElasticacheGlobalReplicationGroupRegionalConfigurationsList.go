...
func (j *jsiiProxy_DataAwsccElasticacheGlobalReplicationGroupRegionalConfigurationsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsccElasticacheGlobalReplicationGroupRegionalConfigurationsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccElasticacheGlobalReplicationGroupRegionalConfigurationsList {
	_init_.Initialize()
...
func NewDataAwsccElasticacheGlobalReplicationGroupRegionalConfigurationsList_Override(d DataAwsccElasticacheGlobalReplicationGroupRegionalConfigurationsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccElasticacheGlobalReplicationGroupRegionalConfigurationsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccElasticacheGlobalReplicationGroupRegionalConfigurationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccElasticacheGlobalReplicationGroupRegionalConfigurationsList) Resolve(_context cdktf.IResolveContext) interface{} {
