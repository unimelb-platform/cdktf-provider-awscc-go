...
type EcrPublicRepository interface {
	...
	RepositoryCatalogData() EcrPublicRepositoryRepositoryCatalogDataOutputReference
	RepositoryCatalogDataInput() interface{}
	...
	PutRepositoryCatalogData(value *EcrPublicRepositoryRepositoryCatalogData)
	PutTags(value interface{})
	// Resets a previously passed logical Id to use the auto-generated logical id again.
	// Experimental.
	ResetOverrideLogicalId()
	ResetRepositoryCatalogData()
	ResetRepositoryName()
...
func (j *jsiiProxy_EcrPublicRepository) RepositoryCatalogData() EcrPublicRepositoryRepositoryCatalogDataOutputReference {
	var returns EcrPublicRepositoryRepositoryCatalogDataOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EcrPublicRepository) RepositoryCatalogDataInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EcrPublicRepository) RepositoryPolicyText() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EcrPublicRepository) RepositoryPolicyTextInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EcrPublicRepository) Tags() EcrPublicRepositoryTagsList {
	var returns EcrPublicRepositoryTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_EcrPublicRepository) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_EcrPublicRepository)SetRepositoryPolicyText(val *string) {
...
func (e *jsiiProxy_EcrPublicRepository) PutRepositoryCatalogData(value *EcrPublicRepositoryRepositoryCatalogData) {
	if err := e.validatePutRepositoryCatalogDataParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		e,
...
func (e *jsiiProxy_EcrPublicRepository) PutTags(value interface{}) {
...
func (e *jsiiProxy_EcrPublicRepository) ResetRepositoryCatalogData() {
	_jsii_.InvokeVoid(
		e,
		"resetRepositoryCatalogData",
		nil, // no parameters
...
func (e *jsiiProxy_EcrPublicRepository) ResetRepositoryName() {
	_jsii_.InvokeVoid(
		e,
		"resetRepositoryName",
		nil, // no parameters
...
func (e *jsiiProxy_EcrPublicRepository) ResetRepositoryPolicyText() {
	_jsii_.InvokeVoid(
		e,
		"resetRepositoryPolicyText",
		nil, // no parameters
