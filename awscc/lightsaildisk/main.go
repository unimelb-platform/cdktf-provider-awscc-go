...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.lightsailDisk.LightsailDiskAddOns",
		reflect.TypeOf((*LightsailDiskAddOns)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.lightsailDisk.LightsailDiskAddOnsAutoSnapshotAddOnRequest",
		reflect.TypeOf((*LightsailDiskAddOnsAutoSnapshotAddOnRequest)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.lightsailDisk.LightsailDiskAddOnsAutoSnapshotAddOnRequestOutputReference",
		reflect.TypeOf((*LightsailDiskAddOnsAutoSnapshotAddOnRequestOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LightsailDiskAddOnsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LightsailDiskAddOnsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAddOnType", GoMethod: "ResetAddOnType"},
	...
	_jsii_.RegisterStruct(
		"awscc.lightsailDisk.LightsailDiskConfig",
		reflect.TypeOf((*LightsailDiskConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.lightsailDisk.LightsailDiskLocation",
		reflect.TypeOf((*LightsailDiskLocation)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.lightsailDisk.LightsailDiskLocationOutputReference",
		reflect.TypeOf((*LightsailDiskLocationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "availabilityZone", GoGetter: "AvailabilityZone"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
		...
		func() interface{} {
			j := jsiiProxy_LightsailDiskLocationOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.lightsailDisk.LightsailDiskTags",
		reflect.TypeOf((*LightsailDiskTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.lightsailDisk.LightsailDiskTagsList",
		reflect.TypeOf((*LightsailDiskTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LightsailDiskTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
