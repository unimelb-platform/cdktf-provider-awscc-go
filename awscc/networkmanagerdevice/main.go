...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.networkmanagerDevice.NetworkmanagerDeviceAwsLocation",
		reflect.TypeOf((*NetworkmanagerDeviceAwsLocation)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.networkmanagerDevice.NetworkmanagerDeviceAwsLocationOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.networkmanagerDevice.NetworkmanagerDeviceConfig",
	...
	_jsii_.RegisterStruct(
		"awscc.networkmanagerDevice.NetworkmanagerDeviceTags",
		reflect.TypeOf((*NetworkmanagerDeviceTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.networkmanagerDevice.NetworkmanagerDeviceTagsList",
		reflect.TypeOf((*NetworkmanagerDeviceTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkmanagerDeviceTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
