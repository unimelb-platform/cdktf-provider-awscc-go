...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/networkmanager_device awscc_networkmanager_device}.
...
func (j *jsiiProxy_NetworkmanagerDevice) AwsLocationInput() interface{} {
...
func (j *jsiiProxy_NetworkmanagerDevice) CreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdAt",
...
func (j *jsiiProxy_NetworkmanagerDevice) DeviceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deviceArn",
...
func (j *jsiiProxy_NetworkmanagerDevice) DeviceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deviceId",
...
func (j *jsiiProxy_NetworkmanagerDevice) LocationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_NetworkmanagerDevice) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_NetworkmanagerDevice) Tags() NetworkmanagerDeviceTagsList {
	var returns NetworkmanagerDeviceTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_NetworkmanagerDevice) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/networkmanager_device awscc_networkmanager_device} Resource.
func NewNetworkmanagerDevice(scope constructs.Construct, id *string, config *NetworkmanagerDeviceConfig) NetworkmanagerDevice {
	...
	_jsii_.Create(
		"awscc.networkmanagerDevice.NetworkmanagerDevice",
...
func (n *jsiiProxy_NetworkmanagerDevice) PutTags(value interface{}) {
