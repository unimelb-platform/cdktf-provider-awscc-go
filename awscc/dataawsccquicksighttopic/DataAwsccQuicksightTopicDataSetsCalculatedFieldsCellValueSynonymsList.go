...
func (d *jsiiProxy_DataAwsccQuicksightTopicDataSetsCalculatedFieldsCellValueSynonymsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
