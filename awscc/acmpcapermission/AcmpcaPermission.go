...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/acmpcapermission/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/acmpca_permission awscc_acmpca_permission}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/acmpca_permission awscc_acmpca_permission} Resource.
func NewAcmpcaPermission(scope constructs.Construct, id *string, config *AcmpcaPermissionConfig) AcmpcaPermission {
	...
	_jsii_.Create(
		"awscc.acmpcaPermission.AcmpcaPermission",
