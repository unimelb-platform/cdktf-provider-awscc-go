...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.appstreamDirectoryConfig.AppstreamDirectoryConfigCertificateBasedAuthProperties",
	...
	_jsii_.RegisterStruct(
		"awscc.appstreamDirectoryConfig.AppstreamDirectoryConfigConfig",
		reflect.TypeOf((*AppstreamDirectoryConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.appstreamDirectoryConfig.AppstreamDirectoryConfigServiceAccountCredentials",
		reflect.TypeOf((*AppstreamDirectoryConfigServiceAccountCredentials)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.appstreamDirectoryConfig.AppstreamDirectoryConfigServiceAccountCredentialsOutputReference",
