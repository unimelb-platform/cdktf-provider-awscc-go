...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/appstreamdirectoryconfig/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/appstream_directory_config awscc_appstream_directory_config}.
type AppstreamDirectoryConfig interface {
	...
	CertificateBasedAuthPropertiesInput() interface{}
	// Experimental.
	...
	ServiceAccountCredentialsInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_AppstreamDirectoryConfig) CertificateBasedAuthPropertiesInput() interface{} {
...
func (j *jsiiProxy_AppstreamDirectoryConfig) ServiceAccountCredentialsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/appstream_directory_config awscc_appstream_directory_config} Resource.
func NewAppstreamDirectoryConfig(scope constructs.Construct, id *string, config *AppstreamDirectoryConfigConfig) AppstreamDirectoryConfig {
	...
	_jsii_.Create(
		"awscc.appstreamDirectoryConfig.AppstreamDirectoryConfig",
