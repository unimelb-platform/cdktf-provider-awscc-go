...
func (j *jsiiProxy_AppstreamDirectoryConfigServiceAccountCredentialsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_AppstreamDirectoryConfigServiceAccountCredentialsOutputReference)SetInternalValue(val interface{}) {
