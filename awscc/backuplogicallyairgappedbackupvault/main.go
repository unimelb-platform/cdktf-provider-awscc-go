...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BackupLogicallyAirGappedBackupVault)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.backupLogicallyAirGappedBackupVault.BackupLogicallyAirGappedBackupVaultConfig",
		reflect.TypeOf((*BackupLogicallyAirGappedBackupVaultConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.backupLogicallyAirGappedBackupVault.BackupLogicallyAirGappedBackupVaultNotifications",
		reflect.TypeOf((*BackupLogicallyAirGappedBackupVaultNotifications)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.backupLogicallyAirGappedBackupVault.BackupLogicallyAirGappedBackupVaultNotificationsOutputReference",
		reflect.TypeOf((*BackupLogicallyAirGappedBackupVaultNotificationsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetBackupVaultEvents", GoMethod: "ResetBackupVaultEvents"},
