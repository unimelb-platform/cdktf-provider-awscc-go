...
func (b *jsiiProxy_BatchJobDefinitionNodePropertiesNodeRangePropertiesContainerLinuxParametersTmpfsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
