...
func (b *jsiiProxy_BatchJobDefinition) validatePutNodePropertiesParameters(value *BatchJobDefinitionNodeProperties) error {
	return nil
}
...
func (j *jsiiProxy_BatchJobDefinition) validateSetJobDefinitionNameParameters(val *string) error {
	return nil
}
