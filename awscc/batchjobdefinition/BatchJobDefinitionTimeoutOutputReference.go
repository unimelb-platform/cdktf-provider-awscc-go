...
func (j *jsiiProxy_BatchJobDefinitionTimeoutOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_BatchJobDefinitionTimeoutOutputReference)SetInternalValue(val interface{}) {
