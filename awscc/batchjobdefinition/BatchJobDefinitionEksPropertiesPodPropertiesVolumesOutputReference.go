...
func (j *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesVolumesOutputReference) EmptyDirInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"emptyDirInput",
...
func (j *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesVolumesOutputReference) HostPathInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"hostPathInput",
...
func (j *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesVolumesOutputReference) SecretInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"secretInput",
