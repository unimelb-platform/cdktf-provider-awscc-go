...
func (j *jsiiProxy_BatchJobDefinitionRetryStrategyOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_BatchJobDefinitionRetryStrategyOutputReference)SetInternalValue(val interface{}) {
