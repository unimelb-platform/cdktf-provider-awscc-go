...
func (j *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesInitContainersOutputReference) ResourcesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"resourcesInput",
...
func (j *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesInitContainersOutputReference) SecurityContextInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (b *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesInitContainersOutputReference) ResetImage() {
	_jsii_.InvokeVoid(
		b,
		"resetImage",
		nil, // no parameters
