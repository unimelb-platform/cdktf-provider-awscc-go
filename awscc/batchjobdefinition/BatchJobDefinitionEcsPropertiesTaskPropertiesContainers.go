...
type BatchJobDefinitionEcsPropertiesTaskPropertiesContainers struct {
	...
	FirelensConfiguration *BatchJobDefinitionEcsPropertiesTaskPropertiesContainersFirelensConfiguration `field:"optional" json:"firelensConfiguration" yaml:"firelensConfiguration"`
	...
	LinuxParameters *BatchJobDefinitionEcsPropertiesTaskPropertiesContainersLinuxParameters `field:"optional" json:"linuxParameters" yaml:"linuxParameters"`
	...
	LogConfiguration *BatchJobDefinitionEcsPropertiesTaskPropertiesContainersLogConfiguration `field:"optional" json:"logConfiguration" yaml:"logConfiguration"`
	...
	RepositoryCredentials *BatchJobDefinitionEcsPropertiesTaskPropertiesContainersRepositoryCredentials `field:"optional" json:"repositoryCredentials" yaml:"repositoryCredentials"`
