...
type BatchJobDefinitionEksPropertiesPodPropertiesVolumes struct {
	...
	PersistentVolumeClaim *BatchJobDefinitionEksPropertiesPodPropertiesVolumesPersistentVolumeClaim `field:"optional" json:"persistentVolumeClaim" yaml:"persistentVolumeClaim"`
