...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/apigatewayv2vpclink/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigatewayv2_vpc_link awscc_apigatewayv2_vpc_link}.
...
func (j *jsiiProxy_Apigatewayv2VpcLink) VpcLinkId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpcLinkId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigatewayv2_vpc_link awscc_apigatewayv2_vpc_link} Resource.
func NewApigatewayv2VpcLink(scope constructs.Construct, id *string, config *Apigatewayv2VpcLinkConfig) Apigatewayv2VpcLink {
	...
	_jsii_.Create(
		"awscc.apigatewayv2VpcLink.Apigatewayv2VpcLink",
...
func (a *jsiiProxy_Apigatewayv2VpcLink) ResetSecurityGroupIds() {
	_jsii_.InvokeVoid(
		a,
		"resetSecurityGroupIds",
		nil, // no parameters
