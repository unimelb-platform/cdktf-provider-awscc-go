...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RdsEventSubscription)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*RdsEventSubscriptionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.rdsEventSubscription.RdsEventSubscriptionTags",
		reflect.TypeOf((*RdsEventSubscriptionTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.rdsEventSubscription.RdsEventSubscriptionTagsList",
		reflect.TypeOf((*RdsEventSubscriptionTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RdsEventSubscriptionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
