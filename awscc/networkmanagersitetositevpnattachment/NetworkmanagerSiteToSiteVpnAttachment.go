...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) AttachmentId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attachmentId",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) CreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdAt",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) Tags() NetworkmanagerSiteToSiteVpnAttachmentTagsList {
	var returns NetworkmanagerSiteToSiteVpnAttachmentTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) UpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updatedAt",
