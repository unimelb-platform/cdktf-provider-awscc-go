...
func (n *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) validatePutTagsParameters(value interface{}) error {
	...
	case *[]*NetworkmanagerSiteToSiteVpnAttachmentTags:
		value := value.(*[]*NetworkmanagerSiteToSiteVpnAttachmentTags)
	...
	case []*NetworkmanagerSiteToSiteVpnAttachmentTags:
		value_ := value.([]*NetworkmanagerSiteToSiteVpnAttachmentTags)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*NetworkmanagerSiteToSiteVpnAttachmentTags; received %#v (a %T)", value, value)
		}
	}
