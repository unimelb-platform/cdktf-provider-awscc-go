...
type MediaconnectBridgeIngressGatewayBridge struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/mediaconnect_bridge#max_outputs MediaconnectBridge#max_outputs}
