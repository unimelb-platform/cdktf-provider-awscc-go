...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/mediaconnect_bridge awscc_mediaconnect_bridge}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/mediaconnect_bridge awscc_mediaconnect_bridge} Resource.
...
func (m *jsiiProxy_MediaconnectBridge) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MediaconnectBridge) MoveFromId(id *string) {
...
func (m *jsiiProxy_MediaconnectBridge) MoveToId(id *string) {
...
func (m *jsiiProxy_MediaconnectBridge) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MediaconnectBridge) ToHclTerraform() interface{} {
	var returns interface{}
