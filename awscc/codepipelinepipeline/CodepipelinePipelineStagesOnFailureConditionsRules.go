...
type CodepipelinePipelineStagesOnFailureConditionsRules struct {
	...
	RuleTypeId *CodepipelinePipelineStagesOnFailureConditionsRulesRuleTypeId `field:"optional" json:"ruleTypeId" yaml:"ruleTypeId"`
}
