...
func (j *jsiiProxy_CodepipelinePipelineStagesOnFailureConditionsRulesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewCodepipelinePipelineStagesOnFailureConditionsRulesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CodepipelinePipelineStagesOnFailureConditionsRulesList {
	_init_.Initialize()
...
func NewCodepipelinePipelineStagesOnFailureConditionsRulesList_Override(c CodepipelinePipelineStagesOnFailureConditionsRulesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodepipelinePipelineStagesOnFailureConditionsRulesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (c *jsiiProxy_CodepipelinePipelineStagesOnFailureConditionsRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CodepipelinePipelineStagesOnFailureConditionsRulesList) Resolve(_context cdktf.IResolveContext) interface{} {
