...
type CodepipelinePipelineStagesBeforeEntryConditionsRules struct {
	...
	RuleTypeId *CodepipelinePipelineStagesBeforeEntryConditionsRulesRuleTypeId `field:"optional" json:"ruleTypeId" yaml:"ruleTypeId"`
}
