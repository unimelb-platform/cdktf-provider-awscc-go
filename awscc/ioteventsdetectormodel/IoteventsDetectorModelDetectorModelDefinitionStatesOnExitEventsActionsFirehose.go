...
type IoteventsDetectorModelDetectorModelDefinitionStatesOnExitEventsActionsFirehose struct {
	...
	Payload *IoteventsDetectorModelDetectorModelDefinitionStatesOnExitEventsActionsFirehosePayload `field:"optional" json:"payload" yaml:"payload"`
