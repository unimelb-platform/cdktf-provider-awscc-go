...
type IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActionsLambda struct {
	...
	Payload *IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActionsLambdaPayload `field:"optional" json:"payload" yaml:"payload"`
}
