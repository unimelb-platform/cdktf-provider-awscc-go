...
type IoteventsDetectorModelDetectorModelDefinitionStatesOnExitEventsActionsSqs struct {
	...
	Payload *IoteventsDetectorModelDetectorModelDefinitionStatesOnExitEventsActionsSqsPayload `field:"optional" json:"payload" yaml:"payload"`
