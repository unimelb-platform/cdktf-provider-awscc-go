...
func (i *jsiiProxy_IoteventsDetectorModelDetectorModelDefinitionStatesOnExitEventsActionsIotSiteWisePropertyValueTimestampOutputReference) ResetTimeInSeconds() {
	_jsii_.InvokeVoid(
		i,
		"resetTimeInSeconds",
		nil, // no parameters
