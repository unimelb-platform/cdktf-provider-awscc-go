...
type IoteventsDetectorModelDetectorModelDefinitionStatesOnInputEventsActionsIotSiteWise struct {
	...
	PropertyValue *IoteventsDetectorModelDetectorModelDefinitionStatesOnInputEventsActionsIotSiteWisePropertyValue `field:"required" json:"propertyValue" yaml:"propertyValue"`
