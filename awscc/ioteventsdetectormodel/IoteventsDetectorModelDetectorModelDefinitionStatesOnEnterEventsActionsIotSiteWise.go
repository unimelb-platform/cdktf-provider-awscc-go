...
type IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActionsIotSiteWise struct {
	...
	PropertyValue *IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActionsIotSiteWisePropertyValue `field:"optional" json:"propertyValue" yaml:"propertyValue"`
}
