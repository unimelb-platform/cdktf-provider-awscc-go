...
type IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActionsIotTopicPublish struct {
	...
	Payload *IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActionsIotTopicPublishPayload `field:"optional" json:"payload" yaml:"payload"`
}
