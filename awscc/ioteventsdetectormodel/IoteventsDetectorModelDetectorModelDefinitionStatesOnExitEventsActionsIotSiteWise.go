...
type IoteventsDetectorModelDetectorModelDefinitionStatesOnExitEventsActionsIotSiteWise struct {
	...
	PropertyValue *IoteventsDetectorModelDetectorModelDefinitionStatesOnExitEventsActionsIotSiteWisePropertyValue `field:"required" json:"propertyValue" yaml:"propertyValue"`
