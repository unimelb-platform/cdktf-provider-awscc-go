...
type IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActions struct {
	...
	ClearTimer *IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActionsClearTimer `field:"optional" json:"clearTimer" yaml:"clearTimer"`
	...
	DynamoDb *IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActionsDynamoDb `field:"optional" json:"dynamoDb" yaml:"dynamoDb"`
	...
	DynamoDBv2 *IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActionsDynamoDBv2 `field:"optional" json:"dynamoDBv2" yaml:"dynamoDBv2"`
	...
	Firehose *IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActionsFirehose `field:"optional" json:"firehose" yaml:"firehose"`
	...
	IotEvents *IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActionsIotEvents `field:"optional" json:"iotEvents" yaml:"iotEvents"`
	...
	IotSiteWise *IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActionsIotSiteWise `field:"optional" json:"iotSiteWise" yaml:"iotSiteWise"`
	...
	IotTopicPublish *IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActionsIotTopicPublish `field:"optional" json:"iotTopicPublish" yaml:"iotTopicPublish"`
	...
	Lambda *IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActionsLambda `field:"optional" json:"lambda" yaml:"lambda"`
	...
	ResetTimer *IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActionsResetTimer `field:"optional" json:"resetTimer" yaml:"resetTimer"`
	...
	SetTimer *IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActionsSetTimer `field:"optional" json:"setTimer" yaml:"setTimer"`
	...
	SetVariable *IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActionsSetVariable `field:"optional" json:"setVariable" yaml:"setVariable"`
	...
	Sns *IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActionsSns `field:"optional" json:"sns" yaml:"sns"`
	...
	Sqs *IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActionsSqs `field:"optional" json:"sqs" yaml:"sqs"`
}
