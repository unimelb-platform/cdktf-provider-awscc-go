...
type IoteventsDetectorModelDetectorModelDefinitionStatesOnInputTransitionEventsActionsIotSiteWise struct {
	...
	PropertyValue *IoteventsDetectorModelDetectorModelDefinitionStatesOnInputTransitionEventsActionsIotSiteWisePropertyValue `field:"required" json:"propertyValue" yaml:"propertyValue"`
