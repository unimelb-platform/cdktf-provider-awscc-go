...
type IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActionsSqs struct {
	...
	Payload *IoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsActionsSqsPayload `field:"optional" json:"payload" yaml:"payload"`
