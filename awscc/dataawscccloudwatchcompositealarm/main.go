...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccCloudwatchCompositeAlarm.DataAwsccCloudwatchCompositeAlarmTags",
		reflect.TypeOf((*DataAwsccCloudwatchCompositeAlarmTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccCloudwatchCompositeAlarm.DataAwsccCloudwatchCompositeAlarmTagsList",
		reflect.TypeOf((*DataAwsccCloudwatchCompositeAlarmTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCloudwatchCompositeAlarmTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
