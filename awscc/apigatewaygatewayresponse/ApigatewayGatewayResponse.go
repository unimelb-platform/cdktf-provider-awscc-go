...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/apigatewaygatewayresponse/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/apigateway_gateway_response awscc_apigateway_gateway_response}.
...
func (j *jsiiProxy_ApigatewayGatewayResponse) GatewayResponseId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"gatewayResponseId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/apigateway_gateway_response awscc_apigateway_gateway_response} Resource.
func NewApigatewayGatewayResponse(scope constructs.Construct, id *string, config *ApigatewayGatewayResponseConfig) ApigatewayGatewayResponse {
	...
	_jsii_.Create(
		"awscc.apigatewayGatewayResponse.ApigatewayGatewayResponse",
