...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccApigatewayv2Api)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccApigatewayv2Api.DataAwsccApigatewayv2ApiBodyS3Location",
		reflect.TypeOf((*DataAwsccApigatewayv2ApiBodyS3Location)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccApigatewayv2Api.DataAwsccApigatewayv2ApiBodyS3LocationOutputReference",
		reflect.TypeOf((*DataAwsccApigatewayv2ApiBodyS3LocationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccApigatewayv2Api.DataAwsccApigatewayv2ApiConfig",
		reflect.TypeOf((*DataAwsccApigatewayv2ApiConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccApigatewayv2Api.DataAwsccApigatewayv2ApiCorsConfiguration",
		reflect.TypeOf((*DataAwsccApigatewayv2ApiCorsConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccApigatewayv2Api.DataAwsccApigatewayv2ApiCorsConfigurationOutputReference",
		reflect.TypeOf((*DataAwsccApigatewayv2ApiCorsConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
