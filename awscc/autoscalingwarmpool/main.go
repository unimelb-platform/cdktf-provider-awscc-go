...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AutoscalingWarmPool)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.autoscalingWarmPool.AutoscalingWarmPoolConfig",
		reflect.TypeOf((*AutoscalingWarmPoolConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.autoscalingWarmPool.AutoscalingWarmPoolInstanceReusePolicy",
		reflect.TypeOf((*AutoscalingWarmPoolInstanceReusePolicy)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.autoscalingWarmPool.AutoscalingWarmPoolInstanceReusePolicyOutputReference",
		reflect.TypeOf((*AutoscalingWarmPoolInstanceReusePolicyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
