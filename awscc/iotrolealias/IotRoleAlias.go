...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/iot_role_alias awscc_iot_role_alias}.
type IotRoleAlias interface {
	...
	CredentialDurationSecondsInput() *float64
	// Experimental.
	DependsOn() *[]*string
	// Experimental.
	...
	RoleAliasArn() *string
	RoleAliasInput() *string
	RoleArn() *string
	SetRoleArn(val *string)
	RoleArnInput() *string
	Tags() IotRoleAliasTagsList
	TagsInput() interface{}
	// Experimental.
	...
	ResetCredentialDurationSeconds()
...
func (j *jsiiProxy_IotRoleAlias) CredentialDurationSeconds() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IotRoleAlias) CredentialDurationSecondsInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"credentialDurationSecondsInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_IotRoleAlias) RoleAlias() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleAlias",
...
func (j *jsiiProxy_IotRoleAlias) RoleAliasArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleAliasArn",
...
func (j *jsiiProxy_IotRoleAlias) RoleAliasInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleAliasInput",
...
func (j *jsiiProxy_IotRoleAlias) Tags() IotRoleAliasTagsList {
	var returns IotRoleAliasTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_IotRoleAlias) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/iot_role_alias awscc_iot_role_alias} Resource.
func NewIotRoleAlias(scope constructs.Construct, id *string, config *IotRoleAliasConfig) IotRoleAlias {
	...
	_jsii_.Create(
		"awscc.iotRoleAlias.IotRoleAlias",
...
func (j *jsiiProxy_IotRoleAlias)SetCredentialDurationSeconds(val *float64) {
	if err := j.validateSetCredentialDurationSecondsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_IotRoleAlias)SetRoleAlias(val *string) {
	if err := j.validateSetRoleAliasParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (i *jsiiProxy_IotRoleAlias) PutTags(value interface{}) {
...
func (i *jsiiProxy_IotRoleAlias) ResetCredentialDurationSeconds() {
	_jsii_.InvokeVoid(
		i,
		"resetCredentialDurationSeconds",
		nil, // no parameters
...
func (i *jsiiProxy_IotRoleAlias) ResetRoleAlias() {
	_jsii_.InvokeVoid(
		i,
		"resetRoleAlias",
		nil, // no parameters
