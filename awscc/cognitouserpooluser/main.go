...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CognitoUserPoolUser)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putValidationData", GoMethod: "PutValidationData"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUserAttributes", GoMethod: "ResetUserAttributes"},
	...
	_jsii_.RegisterStruct(
		"awscc.cognitoUserPoolUser.CognitoUserPoolUserConfig",
		reflect.TypeOf((*CognitoUserPoolUserConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.cognitoUserPoolUser.CognitoUserPoolUserUserAttributes",
		reflect.TypeOf((*CognitoUserPoolUserUserAttributes)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.cognitoUserPoolUser.CognitoUserPoolUserUserAttributesList",
		reflect.TypeOf((*CognitoUserPoolUserUserAttributesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CognitoUserPoolUserUserAttributesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_CognitoUserPoolUserUserAttributesOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.cognitoUserPoolUser.CognitoUserPoolUserValidationData",
		reflect.TypeOf((*CognitoUserPoolUserValidationData)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.cognitoUserPoolUser.CognitoUserPoolUserValidationDataList",
		reflect.TypeOf((*CognitoUserPoolUserValidationDataList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CognitoUserPoolUserValidationDataOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
