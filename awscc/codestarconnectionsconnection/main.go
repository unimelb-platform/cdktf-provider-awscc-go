...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.codestarconnectionsConnection.CodestarconnectionsConnectionConfig",
		reflect.TypeOf((*CodestarconnectionsConnectionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.codestarconnectionsConnection.CodestarconnectionsConnectionTags",
		reflect.TypeOf((*CodestarconnectionsConnectionTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.codestarconnectionsConnection.CodestarconnectionsConnectionTagsList",
		reflect.TypeOf((*CodestarconnectionsConnectionTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CodestarconnectionsConnectionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
