...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/codestarconnections_connection awscc_codestarconnections_connection}.
...
func (j *jsiiProxy_CodestarconnectionsConnection) ConnectionArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"connectionArn",
...
func (j *jsiiProxy_CodestarconnectionsConnection) ConnectionName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"connectionName",
...
func (j *jsiiProxy_CodestarconnectionsConnection) ConnectionNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"connectionNameInput",
...
func (j *jsiiProxy_CodestarconnectionsConnection) OwnerAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ownerAccountId",
...
func (j *jsiiProxy_CodestarconnectionsConnection) Tags() CodestarconnectionsConnectionTagsList {
	var returns CodestarconnectionsConnectionTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/codestarconnections_connection awscc_codestarconnections_connection} Resource.
func NewCodestarconnectionsConnection(scope constructs.Construct, id *string, config *CodestarconnectionsConnectionConfig) CodestarconnectionsConnection {
	...
	_jsii_.Create(
		"awscc.codestarconnectionsConnection.CodestarconnectionsConnection",
...
func (j *jsiiProxy_CodestarconnectionsConnection)SetConnectionName(val *string) {
...
func (c *jsiiProxy_CodestarconnectionsConnection) PutTags(value interface{}) {
