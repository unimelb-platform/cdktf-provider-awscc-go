...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/imagebuilder_image_recipe awscc_imagebuilder_image_recipe}.
type ImagebuilderImageRecipe interface {
	cdktf.TerraformResource
	AdditionalInstanceConfiguration() ImagebuilderImageRecipeAdditionalInstanceConfigurationOutputReference
	AdditionalInstanceConfigurationInput() interface{}
	Arn() *string
	BlockDeviceMappings() ImagebuilderImageRecipeBlockDeviceMappingsList
	...
	PutAdditionalInstanceConfiguration(value *ImagebuilderImageRecipeAdditionalInstanceConfiguration)
...
func (j *jsiiProxy_ImagebuilderImageRecipe) AdditionalInstanceConfiguration() ImagebuilderImageRecipeAdditionalInstanceConfigurationOutputReference {
	var returns ImagebuilderImageRecipeAdditionalInstanceConfigurationOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ImagebuilderImageRecipe) AdditionalInstanceConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"additionalInstanceConfigurationInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_ImagebuilderImageRecipe) BlockDeviceMappings() ImagebuilderImageRecipeBlockDeviceMappingsList {
	var returns ImagebuilderImageRecipeBlockDeviceMappingsList
	_jsii_.Get(
		j,
		"blockDeviceMappings",
		&returns,
...
func (j *jsiiProxy_ImagebuilderImageRecipe) BlockDeviceMappingsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ImagebuilderImageRecipe) Components() ImagebuilderImageRecipeComponentsList {
	var returns ImagebuilderImageRecipeComponentsList
	_jsii_.Get(
		j,
		"components",
		&returns,
...
func (j *jsiiProxy_ImagebuilderImageRecipe) ComponentsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"componentsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/imagebuilder_image_recipe awscc_imagebuilder_image_recipe} Resource.
...
func (i *jsiiProxy_ImagebuilderImageRecipe) PutAdditionalInstanceConfiguration(value *ImagebuilderImageRecipeAdditionalInstanceConfiguration) {
	if err := i.validatePutAdditionalInstanceConfigurationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		i,
		"putAdditionalInstanceConfiguration",
		[]interface{}{value},
	)
}

func (i *jsiiProxy_ImagebuilderImageRecipe) PutBlockDeviceMappings(value interface{}) {
	if err := i.validatePutBlockDeviceMappingsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		i,
...
func (i *jsiiProxy_ImagebuilderImageRecipe) PutComponents(value interface{}) {
...
func (i *jsiiProxy_ImagebuilderImageRecipe) ResetAdditionalInstanceConfiguration() {
	_jsii_.InvokeVoid(
		i,
		"resetAdditionalInstanceConfiguration",
		nil, // no parameters
...
func (i *jsiiProxy_ImagebuilderImageRecipe) ResetBlockDeviceMappings() {
	_jsii_.InvokeVoid(
		i,
		"resetBlockDeviceMappings",
		nil, // no parameters
