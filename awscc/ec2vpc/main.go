...
func init() {
	_jsii_.RegisterClass(
		"awscc.ec2Vpc.Ec2Vpc",
		reflect.TypeOf((*Ec2Vpc)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.ec2Vpc.Ec2VpcConfig",
		reflect.TypeOf((*Ec2VpcConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.ec2Vpc.Ec2VpcTags",
		reflect.TypeOf((*Ec2VpcTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2Vpc.Ec2VpcTagsList",
		reflect.TypeOf((*Ec2VpcTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2VpcTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
