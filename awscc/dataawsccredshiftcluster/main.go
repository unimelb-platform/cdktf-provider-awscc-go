...
func init() {
	_jsii_.RegisterClass(
		"awscc.dataAwsccRedshiftCluster.DataAwsccRedshiftCluster",
		reflect.TypeOf((*DataAwsccRedshiftCluster)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccRedshiftCluster{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformDataSource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccRedshiftCluster.DataAwsccRedshiftClusterConfig",
		reflect.TypeOf((*DataAwsccRedshiftClusterConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccRedshiftCluster.DataAwsccRedshiftClusterEndpoint",
		reflect.TypeOf((*DataAwsccRedshiftClusterEndpoint)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccRedshiftCluster.DataAwsccRedshiftClusterEndpointOutputReference",
		reflect.TypeOf((*DataAwsccRedshiftClusterEndpointOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccRedshiftClusterLoggingProperties)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccRedshiftCluster.DataAwsccRedshiftClusterLoggingPropertiesOutputReference",
		reflect.TypeOf((*DataAwsccRedshiftClusterLoggingPropertiesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccRedshiftCluster.DataAwsccRedshiftClusterTags",
		reflect.TypeOf((*DataAwsccRedshiftClusterTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccRedshiftCluster.DataAwsccRedshiftClusterTagsList",
		reflect.TypeOf((*DataAwsccRedshiftClusterTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccRedshiftClusterTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
