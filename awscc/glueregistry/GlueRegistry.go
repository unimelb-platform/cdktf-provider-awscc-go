...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/glue_registry awscc_glue_registry}.
...
func (j *jsiiProxy_GlueRegistry) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GlueRegistry) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_GlueRegistry) Tags() GlueRegistryTagsList {
	var returns GlueRegistryTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/glue_registry awscc_glue_registry} Resource.
func NewGlueRegistry(scope constructs.Construct, id *string, config *GlueRegistryConfig) GlueRegistry {
	...
	_jsii_.Create(
		"awscc.glueRegistry.GlueRegistry",
...
func (j *jsiiProxy_GlueRegistry)SetName(val *string) {
...
func (g *jsiiProxy_GlueRegistry) PutTags(value interface{}) {
