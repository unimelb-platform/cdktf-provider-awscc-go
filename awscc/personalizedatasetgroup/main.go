...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PersonalizeDatasetGroup)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.personalizeDatasetGroup.PersonalizeDatasetGroupConfig",
		reflect.TypeOf((*PersonalizeDatasetGroupConfig)(nil)).Elem(),
	)
}
