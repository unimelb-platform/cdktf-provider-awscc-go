...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DatasyncLocationFsxWindows)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.datasyncLocationFsxWindows.DatasyncLocationFsxWindowsConfig",
		reflect.TypeOf((*DatasyncLocationFsxWindowsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.datasyncLocationFsxWindows.DatasyncLocationFsxWindowsTags",
		reflect.TypeOf((*DatasyncLocationFsxWindowsTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.datasyncLocationFsxWindows.DatasyncLocationFsxWindowsTagsList",
		reflect.TypeOf((*DatasyncLocationFsxWindowsTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DatasyncLocationFsxWindowsTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
