...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/datasync_location_fsx_windows awscc_datasync_location_fsx_windows}.
...
func (j *jsiiProxy_DatasyncLocationFsxWindows) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DatasyncLocationFsxWindows) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DatasyncLocationFsxWindows) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DatasyncLocationFsxWindows) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DatasyncLocationFsxWindows) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/datasync_location_fsx_windows awscc_datasync_location_fsx_windows} Resource.
func NewDatasyncLocationFsxWindows(scope constructs.Construct, id *string, config *DatasyncLocationFsxWindowsConfig) DatasyncLocationFsxWindows {
	...
	_jsii_.Create(
		"awscc.datasyncLocationFsxWindows.DatasyncLocationFsxWindows",
...
func (j *jsiiProxy_DatasyncLocationFsxWindows)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DatasyncLocationFsxWindows)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DatasyncLocationFsxWindows)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTF code for importing a DatasyncLocationFsxWindows resource upon running "cdktf plan <stack-name>".
func DatasyncLocationFsxWindows_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DatasyncLocationFsxWindows) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DatasyncLocationFsxWindows) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DatasyncLocationFsxWindows) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
