...
func (j *jsiiProxy_SagemakerClusterInstanceGroupsInstanceStorageConfigsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewSagemakerClusterInstanceGroupsInstanceStorageConfigsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SagemakerClusterInstanceGroupsInstanceStorageConfigsOutputReference {
	_init_.Initialize()
...
func NewSagemakerClusterInstanceGroupsInstanceStorageConfigsOutputReference_Override(s SagemakerClusterInstanceGroupsInstanceStorageConfigsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SagemakerClusterInstanceGroupsInstanceStorageConfigsOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (s *jsiiProxy_SagemakerClusterInstanceGroupsInstanceStorageConfigsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerClusterInstanceGroupsInstanceStorageConfigsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (s *jsiiProxy_SagemakerClusterInstanceGroupsInstanceStorageConfigsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerClusterInstanceGroupsInstanceStorageConfigsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
