...
func (j *jsiiProxy_DataAwsccSecurityhubInsightFiltersNetworkDestinationIpV4List) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsccSecurityhubInsightFiltersNetworkDestinationIpV4List(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccSecurityhubInsightFiltersNetworkDestinationIpV4List {
	_init_.Initialize()
...
func NewDataAwsccSecurityhubInsightFiltersNetworkDestinationIpV4List_Override(d DataAwsccSecurityhubInsightFiltersNetworkDestinationIpV4List, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccSecurityhubInsightFiltersNetworkDestinationIpV4List)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccSecurityhubInsightFiltersNetworkDestinationIpV4List) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccSecurityhubInsightFiltersNetworkDestinationIpV4List) Resolve(_context cdktf.IResolveContext) interface{} {
