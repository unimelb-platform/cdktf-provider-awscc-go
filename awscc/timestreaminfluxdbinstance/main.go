...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*TimestreamInfluxDbInstance)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDbInstanceType", GoMethod: "ResetDbInstanceType"},
	...
	_jsii_.RegisterStruct(
		"awscc.timestreamInfluxDbInstance.TimestreamInfluxDbInstanceConfig",
		reflect.TypeOf((*TimestreamInfluxDbInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.timestreamInfluxDbInstance.TimestreamInfluxDbInstanceLogDeliveryConfiguration",
		reflect.TypeOf((*TimestreamInfluxDbInstanceLogDeliveryConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.timestreamInfluxDbInstance.TimestreamInfluxDbInstanceLogDeliveryConfigurationOutputReference",
		reflect.TypeOf((*TimestreamInfluxDbInstanceLogDeliveryConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.timestreamInfluxDbInstance.TimestreamInfluxDbInstanceLogDeliveryConfigurationS3Configuration",
		reflect.TypeOf((*TimestreamInfluxDbInstanceLogDeliveryConfigurationS3Configuration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.timestreamInfluxDbInstance.TimestreamInfluxDbInstanceLogDeliveryConfigurationS3ConfigurationOutputReference",
		reflect.TypeOf((*TimestreamInfluxDbInstanceLogDeliveryConfigurationS3ConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.timestreamInfluxDbInstance.TimestreamInfluxDbInstanceTags",
		reflect.TypeOf((*TimestreamInfluxDbInstanceTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.timestreamInfluxDbInstance.TimestreamInfluxDbInstanceTagsList",
		reflect.TypeOf((*TimestreamInfluxDbInstanceTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*TimestreamInfluxDbInstanceTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
