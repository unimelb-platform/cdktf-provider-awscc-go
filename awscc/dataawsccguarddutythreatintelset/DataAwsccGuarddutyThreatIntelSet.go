...
func (j *jsiiProxy_DataAwsccGuarddutyThreatIntelSet) Activate() cdktf.IResolvable {
...
func (j *jsiiProxy_DataAwsccGuarddutyThreatIntelSet) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataAwsccGuarddutyThreatIntelSet) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccGuarddutyThreatIntelSet) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccGuarddutyThreatIntelSet) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccGuarddutyThreatIntelSet) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func NewDataAwsccGuarddutyThreatIntelSet(scope constructs.Construct, id *string, config *DataAwsccGuarddutyThreatIntelSetConfig) DataAwsccGuarddutyThreatIntelSet {
	...
	_jsii_.Create(
		"awscc.dataAwsccGuarddutyThreatIntelSet.DataAwsccGuarddutyThreatIntelSet",
...
func (j *jsiiProxy_DataAwsccGuarddutyThreatIntelSet)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccGuarddutyThreatIntelSet)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccGuarddutyThreatIntelSet)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTF code for importing a DataAwsccGuarddutyThreatIntelSet resource upon running "cdktf plan <stack-name>".
func DataAwsccGuarddutyThreatIntelSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccGuarddutyThreatIntelSet) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsccGuarddutyThreatIntelSet) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
