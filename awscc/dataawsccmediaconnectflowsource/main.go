...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccMediaconnectFlowSourceA)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccMediaconnectFlowSource.DataAwsccMediaconnectFlowSourceAConfig",
		reflect.TypeOf((*DataAwsccMediaconnectFlowSourceAConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccMediaconnectFlowSource.DataAwsccMediaconnectFlowSourceDecryptionA",
		reflect.TypeOf((*DataAwsccMediaconnectFlowSourceDecryptionA)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccMediaconnectFlowSource.DataAwsccMediaconnectFlowSourceDecryptionAOutputReference",
		reflect.TypeOf((*DataAwsccMediaconnectFlowSourceDecryptionAOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccMediaconnectFlowSource.DataAwsccMediaconnectFlowSourceGatewayBridgeSourceA",
		reflect.TypeOf((*DataAwsccMediaconnectFlowSourceGatewayBridgeSourceA)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccMediaconnectFlowSource.DataAwsccMediaconnectFlowSourceGatewayBridgeSourceAOutputReference",
		reflect.TypeOf((*DataAwsccMediaconnectFlowSourceGatewayBridgeSourceAOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccMediaconnectFlowSourceGatewayBridgeSourceVpcInterfaceAttachmentA)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccMediaconnectFlowSourceGatewayBridgeSourceVpcInterfaceAttachmentAOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
