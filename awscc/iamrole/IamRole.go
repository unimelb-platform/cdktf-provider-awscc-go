...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/iam_role awscc_iam_role}.
type IamRole interface {
	cdktf.TerraformResource
	Arn() *string
	AssumeRolePolicyDocument() *string
	SetAssumeRolePolicyDocument(val *string)
	AssumeRolePolicyDocumentInput() *string
	// Experimental.
...
func (j *jsiiProxy_IamRole) AssumeRolePolicyDocument() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IamRole) AssumeRolePolicyDocumentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"assumeRolePolicyDocumentInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_IamRole) Policies() IamRolePoliciesList {
	var returns IamRolePoliciesList
	_jsii_.Get(
		j,
		"policies",
		&returns,
...
func (j *jsiiProxy_IamRole) PoliciesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"policiesInput",
...
func (j *jsiiProxy_IamRole) RoleId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleId",
...
func (j *jsiiProxy_IamRole) RoleName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleName",
...
func (j *jsiiProxy_IamRole) RoleNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleNameInput",
...
func (j *jsiiProxy_IamRole) Tags() IamRoleTagsList {
	var returns IamRoleTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/iam_role awscc_iam_role} Resource.
...
func (j *jsiiProxy_IamRole)SetAssumeRolePolicyDocument(val *string) {
...
func (j *jsiiProxy_IamRole)SetRoleName(val *string) {
...
func (i *jsiiProxy_IamRole) PutPolicies(value interface{}) {
...
func (i *jsiiProxy_IamRole) PutTags(value interface{}) {
...
func (i *jsiiProxy_IamRole) ResetPolicies() {
	_jsii_.InvokeVoid(
		i,
		"resetPolicies",
		nil, // no parameters
...
func (i *jsiiProxy_IamRole) ResetRoleName() {
	_jsii_.InvokeVoid(
		i,
		"resetRoleName",
		nil, // no parameters
