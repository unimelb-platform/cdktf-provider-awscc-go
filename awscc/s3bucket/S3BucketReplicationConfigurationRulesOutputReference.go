...
type S3BucketReplicationConfigurationRulesOutputReference interface {
	...
	SourceSelectionCriteriaInput() interface{}
	Status() *string
	...
	PutDeleteMarkerReplication(value *S3BucketReplicationConfigurationRulesDeleteMarkerReplication)
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRulesOutputReference) DeleteMarkerReplication() S3BucketReplicationConfigurationRulesDeleteMarkerReplicationOutputReference {
	var returns S3BucketReplicationConfigurationRulesDeleteMarkerReplicationOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRulesOutputReference) DeleteMarkerReplicationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRulesOutputReference) FilterInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"filterInput",
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRulesOutputReference) SourceSelectionCriteriaInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (s *jsiiProxy_S3BucketReplicationConfigurationRulesOutputReference) PutDeleteMarkerReplication(value *S3BucketReplicationConfigurationRulesDeleteMarkerReplication) {
...
func (s *jsiiProxy_S3BucketReplicationConfigurationRulesOutputReference) ResetDeleteMarkerReplication() {
	_jsii_.InvokeVoid(
		s,
		"resetDeleteMarkerReplication",
		nil, // no parameters
