...
func (s *jsiiProxy_S3BucketCorsConfigurationCorsRulesList) validateResolveParameters(_context cdktf.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_S3BucketCorsConfigurationCorsRulesList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	return nil
}
...
func validateNewS3BucketCorsConfigurationCorsRulesListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
	return nil
}
