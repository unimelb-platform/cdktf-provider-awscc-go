...
func (j *jsiiProxy_S3BucketObjectLockConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_S3BucketObjectLockConfigurationOutputReference) RuleInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"ruleInput",
...
func (j *jsiiProxy_S3BucketObjectLockConfigurationOutputReference)SetInternalValue(val interface{}) {
