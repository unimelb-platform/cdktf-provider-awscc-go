...
func (j *jsiiProxy_S3BucketReplicationConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_S3BucketReplicationConfigurationOutputReference)SetInternalValue(val interface{}) {
