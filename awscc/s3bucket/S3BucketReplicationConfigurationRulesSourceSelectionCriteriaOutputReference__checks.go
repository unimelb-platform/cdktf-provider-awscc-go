...
func (j *jsiiProxy_S3BucketReplicationConfigurationRulesSourceSelectionCriteriaOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *S3BucketReplicationConfigurationRulesSourceSelectionCriteria:
		val := val.(*S3BucketReplicationConfigurationRulesSourceSelectionCriteria)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case S3BucketReplicationConfigurationRulesSourceSelectionCriteria:
		val_ := val.(S3BucketReplicationConfigurationRulesSourceSelectionCriteria)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *S3BucketReplicationConfigurationRulesSourceSelectionCriteria; received %#v (a %T)", val, val)
		}
	}
