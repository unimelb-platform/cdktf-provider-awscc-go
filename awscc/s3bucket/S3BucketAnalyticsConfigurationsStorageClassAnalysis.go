...
type S3BucketAnalyticsConfigurationsStorageClassAnalysis struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/s3_bucket#data_export S3Bucket#data_export}
