...
type S3BucketReplicationConfigurationRulesSourceSelectionCriteriaOutputReference interface {
	...
	ReplicaModifications() S3BucketReplicationConfigurationRulesSourceSelectionCriteriaReplicaModificationsOutputReference
	ReplicaModificationsInput() interface{}
	SseKmsEncryptedObjects() S3BucketReplicationConfigurationRulesSourceSelectionCriteriaSseKmsEncryptedObjectsOutputReference
	SseKmsEncryptedObjectsInput() interface{}
	// Experimental.
	...
	PutReplicaModifications(value *S3BucketReplicationConfigurationRulesSourceSelectionCriteriaReplicaModifications)
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRulesSourceSelectionCriteriaOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRulesSourceSelectionCriteriaOutputReference) ReplicaModifications() S3BucketReplicationConfigurationRulesSourceSelectionCriteriaReplicaModificationsOutputReference {
	var returns S3BucketReplicationConfigurationRulesSourceSelectionCriteriaReplicaModificationsOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRulesSourceSelectionCriteriaOutputReference) ReplicaModificationsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRulesSourceSelectionCriteriaOutputReference) SseKmsEncryptedObjectsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRulesSourceSelectionCriteriaOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_S3BucketReplicationConfigurationRulesSourceSelectionCriteriaOutputReference) PutReplicaModifications(value *S3BucketReplicationConfigurationRulesSourceSelectionCriteriaReplicaModifications) {
...
func (s *jsiiProxy_S3BucketReplicationConfigurationRulesSourceSelectionCriteriaOutputReference) ResetReplicaModifications() {
	_jsii_.InvokeVoid(
		s,
		"resetReplicaModifications",
		nil, // no parameters
