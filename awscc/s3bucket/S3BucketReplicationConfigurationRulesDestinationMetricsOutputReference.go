...
type S3BucketReplicationConfigurationRulesDestinationMetricsOutputReference interface {
	...
	EventThreshold() S3BucketReplicationConfigurationRulesDestinationMetricsEventThresholdOutputReference
	EventThresholdInput() interface{}
	// Experimental.
	Fqn() *string
	...
	PutEventThreshold(value *S3BucketReplicationConfigurationRulesDestinationMetricsEventThreshold)
	ResetEventThreshold()
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRulesDestinationMetricsOutputReference) EventThreshold() S3BucketReplicationConfigurationRulesDestinationMetricsEventThresholdOutputReference {
	var returns S3BucketReplicationConfigurationRulesDestinationMetricsEventThresholdOutputReference
	_jsii_.Get(
		j,
		"eventThreshold",
		&returns,
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRulesDestinationMetricsOutputReference) EventThresholdInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"eventThresholdInput",
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRulesDestinationMetricsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRulesDestinationMetricsOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_S3BucketReplicationConfigurationRulesDestinationMetricsOutputReference) PutEventThreshold(value *S3BucketReplicationConfigurationRulesDestinationMetricsEventThreshold) {
...
func (s *jsiiProxy_S3BucketReplicationConfigurationRulesDestinationMetricsOutputReference) ResetEventThreshold() {
	_jsii_.InvokeVoid(
		s,
		"resetEventThreshold",
		nil, // no parameters
