...
func (j *jsiiProxy_S3BucketReplicationConfigurationRulesDestinationReplicationTimeOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRulesDestinationReplicationTimeOutputReference) Time() S3BucketReplicationConfigurationRulesDestinationReplicationTimeTimeOutputReference {
	var returns S3BucketReplicationConfigurationRulesDestinationReplicationTimeTimeOutputReference
	_jsii_.Get(
		j,
		"time",
		&returns,
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRulesDestinationReplicationTimeOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_S3BucketReplicationConfigurationRulesDestinationReplicationTimeOutputReference) PutTime(value *S3BucketReplicationConfigurationRulesDestinationReplicationTimeTime) {
