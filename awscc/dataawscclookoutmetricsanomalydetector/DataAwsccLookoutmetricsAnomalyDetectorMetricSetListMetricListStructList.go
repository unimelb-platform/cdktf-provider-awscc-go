...
func (d *jsiiProxy_DataAwsccLookoutmetricsAnomalyDetectorMetricSetListMetricListStructList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
