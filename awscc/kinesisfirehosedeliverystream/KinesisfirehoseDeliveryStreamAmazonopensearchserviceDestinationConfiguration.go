...
type KinesisfirehoseDeliveryStreamAmazonopensearchserviceDestinationConfiguration struct {
	...
	S3Configuration *KinesisfirehoseDeliveryStreamAmazonopensearchserviceDestinationConfigurationS3Configuration `field:"required" json:"s3Configuration" yaml:"s3Configuration"`
