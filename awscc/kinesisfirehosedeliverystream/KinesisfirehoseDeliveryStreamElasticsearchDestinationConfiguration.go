...
type KinesisfirehoseDeliveryStreamElasticsearchDestinationConfiguration struct {
	...
	S3Configuration *KinesisfirehoseDeliveryStreamElasticsearchDestinationConfigurationS3Configuration `field:"optional" json:"s3Configuration" yaml:"s3Configuration"`
