...
func init() {
	_jsii_.RegisterClass(
		"awscc.entityresolutionPolicyStatement.EntityresolutionPolicyStatement",
		reflect.TypeOf((*EntityresolutionPolicyStatement)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_EntityresolutionPolicyStatement{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.entityresolutionPolicyStatement.EntityresolutionPolicyStatementConfig",
		reflect.TypeOf((*EntityresolutionPolicyStatementConfig)(nil)).Elem(),
	)
}
