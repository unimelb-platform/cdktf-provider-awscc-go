...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "capacityAllocationSet", GoGetter: "CapacityAllocationSet"},
			_jsii_.MemberProperty{JsiiProperty: "capacityReservationArn", GoGetter: "CapacityReservationArn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUnusedReservationBillingOwnerId", GoMethod: "ResetUnusedReservationBillingOwnerId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "unusedReservationBillingOwnerIdInput", GoGetter: "UnusedReservationBillingOwnerIdInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*Ec2CapacityReservationCapacityAllocationSet)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2CapacityReservation.Ec2CapacityReservationCapacityAllocationSetList",
		reflect.TypeOf((*Ec2CapacityReservationCapacityAllocationSetList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2CapacityReservationCapacityAllocationSetOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "allocationType", GoGetter: "AllocationType"},
	...
	_jsii_.RegisterStruct(
		"awscc.ec2CapacityReservation.Ec2CapacityReservationCommitmentInfo",
		reflect.TypeOf((*Ec2CapacityReservationCommitmentInfo)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2CapacityReservation.Ec2CapacityReservationCommitmentInfoOutputReference",
		reflect.TypeOf((*Ec2CapacityReservationCommitmentInfoOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_Ec2CapacityReservationCommitmentInfoOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
