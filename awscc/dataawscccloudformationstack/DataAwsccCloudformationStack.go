...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/data-sources/cloudformation_stack awscc_cloudformation_stack}.
type DataAwsccCloudformationStack interface {
	...
	EnableTerminationProtection() cdktf.IResolvable
	// Experimental.
...
func (j *jsiiProxy_DataAwsccCloudformationStack) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataAwsccCloudformationStack) DisableRollback() cdktf.IResolvable {
...
func (j *jsiiProxy_DataAwsccCloudformationStack) EnableTerminationProtection() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccCloudformationStack) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccCloudformationStack) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccCloudformationStack) Parameters() cdktf.StringMap {
...
func (j *jsiiProxy_DataAwsccCloudformationStack) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccCloudformationStack) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/data-sources/cloudformation_stack awscc_cloudformation_stack} Data Source.
func NewDataAwsccCloudformationStack(scope constructs.Construct, id *string, config *DataAwsccCloudformationStackConfig) DataAwsccCloudformationStack {
	...
	_jsii_.Create(
		"awscc.dataAwsccCloudformationStack.DataAwsccCloudformationStack",
...
func (j *jsiiProxy_DataAwsccCloudformationStack)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccCloudformationStack)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccCloudformationStack)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTF code for importing a DataAwsccCloudformationStack resource upon running "cdktf plan <stack-name>".
func DataAwsccCloudformationStack_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccCloudformationStack) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsccCloudformationStack) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
