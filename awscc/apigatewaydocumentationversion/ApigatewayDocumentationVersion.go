...
func (j *jsiiProxy_ApigatewayDocumentationVersion) DocumentationVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApigatewayDocumentationVersion) DocumentationVersionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewApigatewayDocumentationVersion(scope constructs.Construct, id *string, config *ApigatewayDocumentationVersionConfig) ApigatewayDocumentationVersion {
	...
	_jsii_.Create(
		"awscc.apigatewayDocumentationVersion.ApigatewayDocumentationVersion",
...
func (j *jsiiProxy_ApigatewayDocumentationVersion)SetDocumentationVersion(val *string) {
