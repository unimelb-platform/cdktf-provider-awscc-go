...
func (j *jsiiProxy_NetworkmanagerTransitGatewayRouteTableAttachment) AttachmentId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attachmentId",
...
func (j *jsiiProxy_NetworkmanagerTransitGatewayRouteTableAttachment) CreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdAt",
...
func (j *jsiiProxy_NetworkmanagerTransitGatewayRouteTableAttachment) Tags() NetworkmanagerTransitGatewayRouteTableAttachmentTagsList {
	var returns NetworkmanagerTransitGatewayRouteTableAttachmentTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_NetworkmanagerTransitGatewayRouteTableAttachment) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_NetworkmanagerTransitGatewayRouteTableAttachment) UpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updatedAt",
