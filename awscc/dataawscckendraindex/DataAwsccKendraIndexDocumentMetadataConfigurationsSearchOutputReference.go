...
func (j *jsiiProxy_DataAwsccKendraIndexDocumentMetadataConfigurationsSearchOutputReference) Displayable() cdktf.IResolvable {
...
func (j *jsiiProxy_DataAwsccKendraIndexDocumentMetadataConfigurationsSearchOutputReference) Facetable() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"facetable",
...
func (j *jsiiProxy_DataAwsccKendraIndexDocumentMetadataConfigurationsSearchOutputReference) Searchable() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"searchable",
...
func (j *jsiiProxy_DataAwsccKendraIndexDocumentMetadataConfigurationsSearchOutputReference) Sortable() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"sortable",
...
func (j *jsiiProxy_DataAwsccKendraIndexDocumentMetadataConfigurationsSearchOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsccKendraIndexDocumentMetadataConfigurationsSearchOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataAwsccKendraIndexDocumentMetadataConfigurationsSearchOutputReference {
	_init_.Initialize()
...
func NewDataAwsccKendraIndexDocumentMetadataConfigurationsSearchOutputReference_Override(d DataAwsccKendraIndexDocumentMetadataConfigurationsSearchOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccKendraIndexDocumentMetadataConfigurationsSearchOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccKendraIndexDocumentMetadataConfigurationsSearchOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsccKendraIndexDocumentMetadataConfigurationsSearchOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (d *jsiiProxy_DataAwsccKendraIndexDocumentMetadataConfigurationsSearchOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsccKendraIndexDocumentMetadataConfigurationsSearchOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
