...
func (d *jsiiProxy_DataAwsccKendraIndexDocumentMetadataConfigurationsRelevanceValueImportanceItemsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
