...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/memorydb_acl awscc_memorydb_acl}.
...
func (j *jsiiProxy_MemorydbAcl) AclName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"aclName",
...
func (j *jsiiProxy_MemorydbAcl) AclNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"aclNameInput",
...
func (j *jsiiProxy_MemorydbAcl) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_MemorydbAcl) Tags() MemorydbAclTagsList {
	var returns MemorydbAclTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_MemorydbAcl) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/memorydb_acl awscc_memorydb_acl} Resource.
...
func (j *jsiiProxy_MemorydbAcl)SetAclName(val *string) {
...
func (m *jsiiProxy_MemorydbAcl) PutTags(value interface{}) {
