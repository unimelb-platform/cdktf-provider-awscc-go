...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/elasticache_user awscc_elasticache_user}.
...
func (j *jsiiProxy_ElasticacheUser) AuthenticationModeInput() interface{} {
...
func (j *jsiiProxy_ElasticacheUser) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_ElasticacheUser) Tags() ElasticacheUserTagsList {
	var returns ElasticacheUserTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/elasticache_user awscc_elasticache_user} Resource.
...
func (e *jsiiProxy_ElasticacheUser) PutTags(value interface{}) {
...
func (e *jsiiProxy_ElasticacheUser) ResetAccessString() {
	_jsii_.InvokeVoid(
		e,
		"resetAccessString",
		nil, // no parameters
