...
func (j *jsiiProxy_DataAwsccRedshiftserverlessWorkgroupWorkgroupConfigParametersList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsccRedshiftserverlessWorkgroupWorkgroupConfigParametersList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccRedshiftserverlessWorkgroupWorkgroupConfigParametersList {
	_init_.Initialize()
...
func NewDataAwsccRedshiftserverlessWorkgroupWorkgroupConfigParametersList_Override(d DataAwsccRedshiftserverlessWorkgroupWorkgroupConfigParametersList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccRedshiftserverlessWorkgroupWorkgroupConfigParametersList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccRedshiftserverlessWorkgroupWorkgroupConfigParametersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccRedshiftserverlessWorkgroupWorkgroupConfigParametersList) Resolve(_context cdktf.IResolveContext) interface{} {
