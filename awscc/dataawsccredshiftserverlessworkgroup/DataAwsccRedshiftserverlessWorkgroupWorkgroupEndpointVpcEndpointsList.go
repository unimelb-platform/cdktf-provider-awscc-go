...
func (j *jsiiProxy_DataAwsccRedshiftserverlessWorkgroupWorkgroupEndpointVpcEndpointsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsccRedshiftserverlessWorkgroupWorkgroupEndpointVpcEndpointsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccRedshiftserverlessWorkgroupWorkgroupEndpointVpcEndpointsList {
	_init_.Initialize()
...
func NewDataAwsccRedshiftserverlessWorkgroupWorkgroupEndpointVpcEndpointsList_Override(d DataAwsccRedshiftserverlessWorkgroupWorkgroupEndpointVpcEndpointsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccRedshiftserverlessWorkgroupWorkgroupEndpointVpcEndpointsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccRedshiftserverlessWorkgroupWorkgroupEndpointVpcEndpointsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccRedshiftserverlessWorkgroupWorkgroupEndpointVpcEndpointsList) Resolve(_context cdktf.IResolveContext) interface{} {
