...
func (m *jsiiProxy_MediaconnectFlowSourceMonitoringConfigVideoMonitoringSettingsFrozenFramesOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (m *jsiiProxy_MediaconnectFlowSourceMonitoringConfigVideoMonitoringSettingsFrozenFramesOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_MediaconnectFlowSourceMonitoringConfigVideoMonitoringSettingsFrozenFramesOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *MediaconnectFlowSourceMonitoringConfigVideoMonitoringSettingsFrozenFrames; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_MediaconnectFlowSourceMonitoringConfigVideoMonitoringSettingsFrozenFramesOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewMediaconnectFlowSourceMonitoringConfigVideoMonitoringSettingsFrozenFramesOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
