...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/imagebuilder_lifecycle_policy awscc_imagebuilder_lifecycle_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/imagebuilder_lifecycle_policy awscc_imagebuilder_lifecycle_policy} Resource.
...
func (i *jsiiProxy_ImagebuilderLifecyclePolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_ImagebuilderLifecyclePolicy) MoveFromId(id *string) {
...
func (i *jsiiProxy_ImagebuilderLifecyclePolicy) MoveToId(id *string) {
...
func (i *jsiiProxy_ImagebuilderLifecyclePolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_ImagebuilderLifecyclePolicy) ToHclTerraform() interface{} {
	var returns interface{}
