...
func init() {
	_jsii_.RegisterClass(
		"awscc.dataAwsccEc2TransitGatewayRoute.DataAwsccEc2TransitGatewayRoute",
		reflect.TypeOf((*DataAwsccEc2TransitGatewayRoute)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccEc2TransitGatewayRoute{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformDataSource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccEc2TransitGatewayRoute.DataAwsccEc2TransitGatewayRouteConfig",
		reflect.TypeOf((*DataAwsccEc2TransitGatewayRouteConfig)(nil)).Elem(),
	)
}
