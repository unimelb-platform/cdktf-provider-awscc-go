...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccBackupLogicallyAirGappedBackupVault)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccBackupLogicallyAirGappedBackupVault.DataAwsccBackupLogicallyAirGappedBackupVaultConfig",
		reflect.TypeOf((*DataAwsccBackupLogicallyAirGappedBackupVaultConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccBackupLogicallyAirGappedBackupVault.DataAwsccBackupLogicallyAirGappedBackupVaultNotifications",
		reflect.TypeOf((*DataAwsccBackupLogicallyAirGappedBackupVaultNotifications)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccBackupLogicallyAirGappedBackupVaultNotificationsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
