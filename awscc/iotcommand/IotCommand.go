...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/iot_command awscc_iot_command}.
...
func (j *jsiiProxy_IotCommand) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_IotCommand) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IotCommand) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IotCommand) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_IotCommand) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/iot_command awscc_iot_command} Resource.
...
func (j *jsiiProxy_IotCommand)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IotCommand)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IotCommand)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTF code for importing a IotCommand resource upon running "cdktf plan <stack-name>".
func IotCommand_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IotCommand) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IotCommand) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IotCommand) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
