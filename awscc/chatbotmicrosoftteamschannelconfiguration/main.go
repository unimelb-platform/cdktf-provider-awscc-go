...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ChatbotMicrosoftTeamsChannelConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customizationResourceArnsInput", GoGetter: "CustomizationResourceArnsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCustomizationResourceArns", GoMethod: "ResetCustomizationResourceArns"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTeamsChannelName", GoMethod: "ResetTeamsChannelName"},
			...
			_jsii_.MemberProperty{JsiiProperty: "teamsChannelIdInput", GoGetter: "TeamsChannelIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "teamsChannelName", GoGetter: "TeamsChannelName"},
			_jsii_.MemberProperty{JsiiProperty: "teamsChannelNameInput", GoGetter: "TeamsChannelNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "teamsTenantId", GoGetter: "TeamsTenantId"},
			_jsii_.MemberProperty{JsiiProperty: "teamsTenantIdInput", GoGetter: "TeamsTenantIdInput"},
	...
	_jsii_.RegisterStruct(
		"awscc.chatbotMicrosoftTeamsChannelConfiguration.ChatbotMicrosoftTeamsChannelConfigurationConfig",
		reflect.TypeOf((*ChatbotMicrosoftTeamsChannelConfigurationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.chatbotMicrosoftTeamsChannelConfiguration.ChatbotMicrosoftTeamsChannelConfigurationTags",
		reflect.TypeOf((*ChatbotMicrosoftTeamsChannelConfigurationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.chatbotMicrosoftTeamsChannelConfiguration.ChatbotMicrosoftTeamsChannelConfigurationTagsList",
		reflect.TypeOf((*ChatbotMicrosoftTeamsChannelConfigurationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ChatbotMicrosoftTeamsChannelConfigurationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
