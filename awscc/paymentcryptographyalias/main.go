...
func init() {
	_jsii_.RegisterClass(
		"awscc.paymentcryptographyAlias.PaymentcryptographyAlias",
		reflect.TypeOf((*PaymentcryptographyAlias)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_PaymentcryptographyAlias{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.paymentcryptographyAlias.PaymentcryptographyAliasConfig",
		reflect.TypeOf((*PaymentcryptographyAliasConfig)(nil)).Elem(),
	)
}
