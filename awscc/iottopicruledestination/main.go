...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "httpUrlPropertiesInput", GoGetter: "HttpUrlPropertiesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putHttpUrlProperties", GoMethod: "PutHttpUrlProperties"},
			_jsii_.MemberMethod{JsiiMethod: "putVpcProperties", GoMethod: "PutVpcProperties"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetHttpUrlProperties", GoMethod: "ResetHttpUrlProperties"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetStatus", GoMethod: "ResetStatus"},
			_jsii_.MemberMethod{JsiiMethod: "resetVpcProperties", GoMethod: "ResetVpcProperties"},
			...
			_jsii_.MemberProperty{JsiiProperty: "vpcPropertiesInput", GoGetter: "VpcPropertiesInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*IotTopicRuleDestinationHttpUrlProperties)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.iotTopicRuleDestination.IotTopicRuleDestinationHttpUrlPropertiesOutputReference",
		reflect.TypeOf((*IotTopicRuleDestinationHttpUrlPropertiesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.iotTopicRuleDestination.IotTopicRuleDestinationVpcProperties",
		reflect.TypeOf((*IotTopicRuleDestinationVpcProperties)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.iotTopicRuleDestination.IotTopicRuleDestinationVpcPropertiesOutputReference",
		reflect.TypeOf((*IotTopicRuleDestinationVpcPropertiesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
		...
		func() interface{} {
			j := jsiiProxy_IotTopicRuleDestinationVpcPropertiesOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
