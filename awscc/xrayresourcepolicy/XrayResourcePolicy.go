...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/xrayresourcepolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/xray_resource_policy awscc_xray_resource_policy}.
...
func (j *jsiiProxy_XrayResourcePolicy) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/xray_resource_policy awscc_xray_resource_policy} Resource.
func NewXrayResourcePolicy(scope constructs.Construct, id *string, config *XrayResourcePolicyConfig) XrayResourcePolicy {
	...
	_jsii_.Create(
		"awscc.xrayResourcePolicy.XrayResourcePolicy",
