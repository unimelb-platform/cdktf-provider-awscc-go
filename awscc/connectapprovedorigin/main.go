...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ConnectApprovedOrigin)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.connectApprovedOrigin.ConnectApprovedOriginConfig",
		reflect.TypeOf((*ConnectApprovedOriginConfig)(nil)).Elem(),
	)
}
