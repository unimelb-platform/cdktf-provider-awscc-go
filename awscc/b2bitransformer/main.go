...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.b2BiTransformer.B2BiTransformerConfig",
		reflect.TypeOf((*B2BiTransformerConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.b2BiTransformer.B2BiTransformerEdiType",
		reflect.TypeOf((*B2BiTransformerEdiType)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.b2BiTransformer.B2BiTransformerEdiTypeOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.b2BiTransformer.B2BiTransformerEdiTypeX12Details",
	...
	_jsii_.RegisterStruct(
		"awscc.b2BiTransformer.B2BiTransformerTags",
