...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSagemakerMlflowTrackingServer)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "trackingServerArn", GoGetter: "TrackingServerArn"},
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccSagemakerMlflowTrackingServer{}
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccSagemakerMlflowTrackingServerConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServerTags",
		reflect.TypeOf((*DataAwsccSagemakerMlflowTrackingServerTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServerTagsList",
		reflect.TypeOf((*DataAwsccSagemakerMlflowTrackingServerTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSagemakerMlflowTrackingServerTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
