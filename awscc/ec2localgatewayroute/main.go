...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLocalGatewayVirtualInterfaceGroupId", GoMethod: "ResetLocalGatewayVirtualInterfaceGroupId"},
	...
	_jsii_.RegisterStruct(
		"awscc.ec2LocalGatewayRoute.Ec2LocalGatewayRouteConfig",
