...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/s3bucketpolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/s3_bucket_policy awscc_s3_bucket_policy}.
...
func (j *jsiiProxy_S3BucketPolicy) PolicyDocument() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyDocument",
...
func (j *jsiiProxy_S3BucketPolicy) PolicyDocumentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyDocumentInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/s3_bucket_policy awscc_s3_bucket_policy} Resource.
func NewS3BucketPolicy(scope constructs.Construct, id *string, config *S3BucketPolicyConfig) S3BucketPolicy {
	...
	_jsii_.Create(
		"awscc.s3BucketPolicy.S3BucketPolicy",
...
func (j *jsiiProxy_S3BucketPolicy)SetPolicyDocument(val *string) {
