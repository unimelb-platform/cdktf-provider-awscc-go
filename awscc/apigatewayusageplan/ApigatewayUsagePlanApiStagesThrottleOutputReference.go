...
func NewApigatewayUsagePlanApiStagesThrottleOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectKey *string) ApigatewayUsagePlanApiStagesThrottleOutputReference {
	_init_.Initialize()

	if err := validateNewApigatewayUsagePlanApiStagesThrottleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectKey); err != nil {
		panic(err)
	}
...
func NewApigatewayUsagePlanApiStagesThrottleOutputReference_Override(a ApigatewayUsagePlanApiStagesThrottleOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectKey *string) {
	_init_.Initialize()
