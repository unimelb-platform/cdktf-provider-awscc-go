...
func (j *jsiiProxy_ApigatewayUsagePlanApiStagesOutputReference) Throttle() ApigatewayUsagePlanApiStagesThrottleMap {
	var returns ApigatewayUsagePlanApiStagesThrottleMap
	_jsii_.Get(
		j,
		"throttle",
		&returns,
...
func (a *jsiiProxy_ApigatewayUsagePlanApiStagesOutputReference) ResetApiId() {
	_jsii_.InvokeVoid(
		a,
		"resetApiId",
		nil, // no parameters
...
func (a *jsiiProxy_ApigatewayUsagePlanApiStagesOutputReference) ResetStage() {
	_jsii_.InvokeVoid(
		a,
		"resetStage",
		nil, // no parameters
