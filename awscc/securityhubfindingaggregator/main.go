...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "findingAggregationRegion", GoGetter: "FindingAggregationRegion"},
			_jsii_.MemberProperty{JsiiProperty: "findingAggregatorArn", GoGetter: "FindingAggregatorArn"},
