...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/securityhubfindingaggregator/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/securityhub_finding_aggregator awscc_securityhub_finding_aggregator}.
...
func (j *jsiiProxy_SecurityhubFindingAggregator) FindingAggregationRegion() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecurityhubFindingAggregator) FindingAggregatorArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecurityhubFindingAggregator) RegionLinkingMode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionLinkingMode",
...
func (j *jsiiProxy_SecurityhubFindingAggregator) RegionLinkingModeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecurityhubFindingAggregator) Regions() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"regions",
...
func (j *jsiiProxy_SecurityhubFindingAggregator) RegionsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"regionsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/securityhub_finding_aggregator awscc_securityhub_finding_aggregator} Resource.
...
func (j *jsiiProxy_SecurityhubFindingAggregator)SetRegionLinkingMode(val *string) {
...
func (j *jsiiProxy_SecurityhubFindingAggregator)SetRegions(val *[]*string) {
...
func (s *jsiiProxy_SecurityhubFindingAggregator) ResetRegions() {
	_jsii_.InvokeVoid(
		s,
		"resetRegions",
		nil, // no parameters
