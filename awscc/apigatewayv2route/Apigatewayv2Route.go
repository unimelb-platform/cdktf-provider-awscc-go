...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/apigatewayv2route/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigatewayv2_route awscc_apigatewayv2_route}.
type Apigatewayv2Route interface {
	...
	SetRequestModels(val *string)
	RequestModelsInput() *string
	RequestParameters() *string
	SetRequestParameters(val *string)
	RequestParametersInput() *string
	RouteId() *string
	RouteKey() *string
...
func (j *jsiiProxy_Apigatewayv2Route) RequestModels() *string {
	var returns *string
	_jsii_.Get(
		j,
		"requestModels",
...
func (j *jsiiProxy_Apigatewayv2Route) RequestModelsInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"requestModelsInput",
...
func (j *jsiiProxy_Apigatewayv2Route) RequestParameters() *string {
	var returns *string
	_jsii_.Get(
		j,
		"requestParameters",
...
func (j *jsiiProxy_Apigatewayv2Route) RequestParametersInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Apigatewayv2Route) RouteId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"routeId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigatewayv2_route awscc_apigatewayv2_route} Resource.
...
func (j *jsiiProxy_Apigatewayv2Route)SetRequestModels(val *string) {
...
func (j *jsiiProxy_Apigatewayv2Route)SetRequestParameters(val *string) {
...
func (a *jsiiProxy_Apigatewayv2Route) ResetRequestParameters() {
	_jsii_.InvokeVoid(
		a,
		"resetRequestParameters",
		nil, // no parameters
