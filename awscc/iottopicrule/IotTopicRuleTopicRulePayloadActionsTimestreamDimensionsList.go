...
func (i *jsiiProxy_IotTopicRuleTopicRulePayloadActionsTimestreamDimensionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
