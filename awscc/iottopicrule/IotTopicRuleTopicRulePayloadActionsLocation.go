...
type IotTopicRuleTopicRulePayloadActionsLocation struct {
	...
	Timestamp *IotTopicRuleTopicRulePayloadActionsLocationTimestamp `field:"optional" json:"timestamp" yaml:"timestamp"`
}
