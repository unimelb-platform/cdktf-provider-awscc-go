...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/iot_topic_rule awscc_iot_topic_rule}.
type IotTopicRule interface {
	...
	TopicRulePayload() IotTopicRuleTopicRulePayloadOutputReference
	TopicRulePayloadInput() interface{}
	...
	PutTopicRulePayload(value *IotTopicRuleTopicRulePayload)
...
func (j *jsiiProxy_IotTopicRule) RuleName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ruleName",
...
func (j *jsiiProxy_IotTopicRule) RuleNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ruleNameInput",
...
func (j *jsiiProxy_IotTopicRule) Tags() IotTopicRuleTagsList {
	var returns IotTopicRuleTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_IotTopicRule) TopicRulePayload() IotTopicRuleTopicRulePayloadOutputReference {
	var returns IotTopicRuleTopicRulePayloadOutputReference
	_jsii_.Get(
		j,
		"topicRulePayload",
		&returns,
...
func (j *jsiiProxy_IotTopicRule) TopicRulePayloadInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"topicRulePayloadInput",
		&returns,
	)
	return returns
}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/iot_topic_rule awscc_iot_topic_rule} Resource.
...
func (j *jsiiProxy_IotTopicRule)SetRuleName(val *string) {
...
func (i *jsiiProxy_IotTopicRule) PutTags(value interface{}) {
...
func (i *jsiiProxy_IotTopicRule) PutTopicRulePayload(value *IotTopicRuleTopicRulePayload) {
	if err := i.validatePutTopicRulePayloadParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		i,
...
func (i *jsiiProxy_IotTopicRule) ResetRuleName() {
	_jsii_.InvokeVoid(
		i,
		"resetRuleName",
		nil, // no parameters
