...
func (i *jsiiProxy_IotTopicRule) validatePutTagsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*IotTopicRuleTags; received %#v (a %T)", value, value)
		}
	}
...
func (i *jsiiProxy_IotTopicRule) validatePutTopicRulePayloadParameters(value *IotTopicRuleTopicRulePayload) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (j *jsiiProxy_IotTopicRule) validateSetRuleNameParameters(val *string) error {
	if val == nil {
