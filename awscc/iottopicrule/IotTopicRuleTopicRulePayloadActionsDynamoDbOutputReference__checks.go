...
func (i *jsiiProxy_IotTopicRuleTopicRulePayloadActionsDynamoDbOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (i *jsiiProxy_IotTopicRuleTopicRulePayloadActionsDynamoDbOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_IotTopicRuleTopicRulePayloadActionsDynamoDbOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *IotTopicRuleTopicRulePayloadActionsDynamoDb:
		val := val.(*IotTopicRuleTopicRulePayloadActionsDynamoDb)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case IotTopicRuleTopicRulePayloadActionsDynamoDb:
		val_ := val.(IotTopicRuleTopicRulePayloadActionsDynamoDb)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *IotTopicRuleTopicRulePayloadActionsDynamoDb; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_IotTopicRuleTopicRulePayloadActionsDynamoDbOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewIotTopicRuleTopicRulePayloadActionsDynamoDbOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
