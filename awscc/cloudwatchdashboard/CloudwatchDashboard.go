...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/cloudwatchdashboard/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/cloudwatch_dashboard awscc_cloudwatch_dashboard}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/cloudwatch_dashboard awscc_cloudwatch_dashboard} Resource.
func NewCloudwatchDashboard(scope constructs.Construct, id *string, config *CloudwatchDashboardConfig) CloudwatchDashboard {
	...
	_jsii_.Create(
		"awscc.cloudwatchDashboard.CloudwatchDashboard",
...
func (c *jsiiProxy_CloudwatchDashboard) ResetDashboardName() {
	_jsii_.InvokeVoid(
		c,
		"resetDashboardName",
		nil, // no parameters
