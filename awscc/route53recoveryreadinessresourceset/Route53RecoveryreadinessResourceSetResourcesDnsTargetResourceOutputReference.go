...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSetResourcesDnsTargetResourceOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSetResourcesDnsTargetResourceOutputReference) TargetResourceInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"targetResourceInput",
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSetResourcesDnsTargetResourceOutputReference)SetInternalValue(val interface{}) {
...
func (r *jsiiProxy_Route53RecoveryreadinessResourceSetResourcesDnsTargetResourceOutputReference) ResetDomainName() {
	_jsii_.InvokeVoid(
		r,
		"resetDomainName",
		nil, // no parameters
