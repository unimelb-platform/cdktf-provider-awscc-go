...
type Route53RecoveryreadinessResourceSetResourcesOutputReference interface {
	...
	DnsTargetResourceInput() interface{}
	// Experimental.
	Fqn() *string
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSetResourcesOutputReference) ComponentIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"componentIdInput",
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSetResourcesOutputReference) DnsTargetResourceInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSetResourcesOutputReference)SetComponentId(val *string) {
...
func (r *jsiiProxy_Route53RecoveryreadinessResourceSetResourcesOutputReference) ResetComponentId() {
	_jsii_.InvokeVoid(
		r,
		"resetComponentId",
		nil, // no parameters
