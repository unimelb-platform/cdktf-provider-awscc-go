...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSetResourcesDnsTargetResourceTargetResourceOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSetResourcesDnsTargetResourceTargetResourceOutputReference) NlbResourceInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"nlbResourceInput",
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSetResourcesDnsTargetResourceTargetResourceOutputReference) R53ResourceInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"r53ResourceInput",
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSetResourcesDnsTargetResourceTargetResourceOutputReference)SetInternalValue(val interface{}) {
