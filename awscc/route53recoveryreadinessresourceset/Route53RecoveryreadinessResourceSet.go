...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/route53recoveryreadiness_resource_set awscc_route53recoveryreadiness_resource_set}.
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSet) ResourceSetArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceSetArn",
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSet) Tags() Route53RecoveryreadinessResourceSetTagsList {
	var returns Route53RecoveryreadinessResourceSetTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/route53recoveryreadiness_resource_set awscc_route53recoveryreadiness_resource_set} Resource.
...
func (r *jsiiProxy_Route53RecoveryreadinessResourceSet) PutTags(value interface{}) {
...
func (r *jsiiProxy_Route53RecoveryreadinessResourceSet) ResetResourceSetName() {
	_jsii_.InvokeVoid(
		r,
		"resetResourceSetName",
		nil, // no parameters
