...
func (j *jsiiProxy_DataAwsccPcsClusterSlurmConfigurationSlurmCustomSettingsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsccPcsClusterSlurmConfigurationSlurmCustomSettingsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccPcsClusterSlurmConfigurationSlurmCustomSettingsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"awscc.dataAwsccPcsCluster.DataAwsccPcsClusterSlurmConfigurationSlurmCustomSettingsList",
...
func NewDataAwsccPcsClusterSlurmConfigurationSlurmCustomSettingsList_Override(d DataAwsccPcsClusterSlurmConfigurationSlurmCustomSettingsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccPcsClusterSlurmConfigurationSlurmCustomSettingsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccPcsClusterSlurmConfigurationSlurmCustomSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccPcsClusterSlurmConfigurationSlurmCustomSettingsList) Resolve(_context cdktf.IResolveContext) interface{} {
