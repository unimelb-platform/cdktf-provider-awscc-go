...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccApigatewayv2DomainName)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccApigatewayv2DomainName.DataAwsccApigatewayv2DomainNameConfig",
		reflect.TypeOf((*DataAwsccApigatewayv2DomainNameConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccApigatewayv2DomainName.DataAwsccApigatewayv2DomainNameDomainNameConfigurations",
		reflect.TypeOf((*DataAwsccApigatewayv2DomainNameDomainNameConfigurations)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccApigatewayv2DomainName.DataAwsccApigatewayv2DomainNameDomainNameConfigurationsList",
		reflect.TypeOf((*DataAwsccApigatewayv2DomainNameDomainNameConfigurationsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccApigatewayv2DomainNameDomainNameConfigurationsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccApigatewayv2DomainName.DataAwsccApigatewayv2DomainNameMutualTlsAuthentication",
		reflect.TypeOf((*DataAwsccApigatewayv2DomainNameMutualTlsAuthentication)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccApigatewayv2DomainName.DataAwsccApigatewayv2DomainNameMutualTlsAuthenticationOutputReference",
		reflect.TypeOf((*DataAwsccApigatewayv2DomainNameMutualTlsAuthenticationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
