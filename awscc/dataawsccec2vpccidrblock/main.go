...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2VpcCidrBlock)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccEc2VpcCidrBlock.DataAwsccEc2VpcCidrBlockConfig",
		reflect.TypeOf((*DataAwsccEc2VpcCidrBlockConfig)(nil)).Elem(),
	)
}
