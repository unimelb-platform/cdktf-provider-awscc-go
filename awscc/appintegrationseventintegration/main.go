...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.appintegrationsEventIntegration.AppintegrationsEventIntegrationEventFilter",
	...
	_jsii_.RegisterStruct(
		"awscc.appintegrationsEventIntegration.AppintegrationsEventIntegrationTags",
		reflect.TypeOf((*AppintegrationsEventIntegrationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.appintegrationsEventIntegration.AppintegrationsEventIntegrationTagsList",
		reflect.TypeOf((*AppintegrationsEventIntegrationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AppintegrationsEventIntegrationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
