...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccLightsailLoadBalancerTlsCertificate)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccLightsailLoadBalancerTlsCertificate.DataAwsccLightsailLoadBalancerTlsCertificateConfig",
		reflect.TypeOf((*DataAwsccLightsailLoadBalancerTlsCertificateConfig)(nil)).Elem(),
	)
}
