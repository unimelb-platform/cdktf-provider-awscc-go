...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.ec2InstanceConnectEndpoint.Ec2InstanceConnectEndpointConfig",
		reflect.TypeOf((*Ec2InstanceConnectEndpointConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.ec2InstanceConnectEndpoint.Ec2InstanceConnectEndpointTags",
		reflect.TypeOf((*Ec2InstanceConnectEndpointTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2InstanceConnectEndpoint.Ec2InstanceConnectEndpointTagsList",
		reflect.TypeOf((*Ec2InstanceConnectEndpointTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2InstanceConnectEndpointTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
