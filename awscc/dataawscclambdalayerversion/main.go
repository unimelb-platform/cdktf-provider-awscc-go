...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccLambdaLayerVersion)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccLambdaLayerVersion.DataAwsccLambdaLayerVersionConfig",
		reflect.TypeOf((*DataAwsccLambdaLayerVersionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccLambdaLayerVersion.DataAwsccLambdaLayerVersionContent",
		reflect.TypeOf((*DataAwsccLambdaLayerVersionContent)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccLambdaLayerVersion.DataAwsccLambdaLayerVersionContentOutputReference",
		reflect.TypeOf((*DataAwsccLambdaLayerVersionContentOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
