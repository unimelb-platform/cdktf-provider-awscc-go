...
func (j *jsiiProxy_MskClusterOpenMonitoringPrometheusJmxExporterOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_MskClusterOpenMonitoringPrometheusJmxExporterOutputReference)SetInternalValue(val interface{}) {
...
func (m *jsiiProxy_MskClusterOpenMonitoringPrometheusJmxExporterOutputReference) ResetEnabledInBroker() {
	_jsii_.InvokeVoid(
		m,
		"resetEnabledInBroker",
		nil, // no parameters
