...
func (j *jsiiProxy_MskClusterLoggingInfoBrokerLogsOutputReference) CloudwatchLogsInput() interface{} {
...
func (j *jsiiProxy_MskClusterLoggingInfoBrokerLogsOutputReference) FirehoseInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"firehoseInput",
...
func (j *jsiiProxy_MskClusterLoggingInfoBrokerLogsOutputReference) S3Input() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"s3Input",
