...
func (j *jsiiProxy_MskClusterLoggingInfoOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_MskClusterLoggingInfoOutputReference)SetInternalValue(val interface{}) {
