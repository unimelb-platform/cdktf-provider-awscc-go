...
func (j *jsiiProxy_MskClusterLoggingInfoBrokerLogsFirehoseOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_MskClusterLoggingInfoBrokerLogsFirehoseOutputReference)SetInternalValue(val interface{}) {
