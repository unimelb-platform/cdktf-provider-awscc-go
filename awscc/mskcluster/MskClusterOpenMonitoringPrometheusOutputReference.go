...
func (j *jsiiProxy_MskClusterOpenMonitoringPrometheusOutputReference) JmxExporterInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"jmxExporterInput",
...
func (j *jsiiProxy_MskClusterOpenMonitoringPrometheusOutputReference) NodeExporterInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"nodeExporterInput",
