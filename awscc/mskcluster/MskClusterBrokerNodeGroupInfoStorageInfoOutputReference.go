...
func (j *jsiiProxy_MskClusterBrokerNodeGroupInfoStorageInfoOutputReference) EbsStorageInfoInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"ebsStorageInfoInput",
...
func (j *jsiiProxy_MskClusterBrokerNodeGroupInfoStorageInfoOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_MskClusterBrokerNodeGroupInfoStorageInfoOutputReference)SetInternalValue(val interface{}) {
