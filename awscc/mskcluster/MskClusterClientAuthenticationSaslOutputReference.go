...
type MskClusterClientAuthenticationSaslOutputReference interface {
	...
	PutIam(value *MskClusterClientAuthenticationSaslIam)
	PutScram(value *MskClusterClientAuthenticationSaslScram)
	ResetIam()
	ResetScram()
...
func (j *jsiiProxy_MskClusterClientAuthenticationSaslOutputReference) Iam() MskClusterClientAuthenticationSaslIamOutputReference {
	var returns MskClusterClientAuthenticationSaslIamOutputReference
	_jsii_.Get(
		j,
		"iam",
		&returns,
...
func (j *jsiiProxy_MskClusterClientAuthenticationSaslOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_MskClusterClientAuthenticationSaslOutputReference) Scram() MskClusterClientAuthenticationSaslScramOutputReference {
	var returns MskClusterClientAuthenticationSaslScramOutputReference
	_jsii_.Get(
		j,
		"scram",
		&returns,
...
func (j *jsiiProxy_MskClusterClientAuthenticationSaslOutputReference)SetInternalValue(val interface{}) {
...
func (m *jsiiProxy_MskClusterClientAuthenticationSaslOutputReference) PutIam(value *MskClusterClientAuthenticationSaslIam) {
...
func (m *jsiiProxy_MskClusterClientAuthenticationSaslOutputReference) PutScram(value *MskClusterClientAuthenticationSaslScram) {
