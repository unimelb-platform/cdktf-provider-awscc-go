...
type MskClusterEncryptionInfoOutputReference interface {
	...
	EncryptionAtRest() MskClusterEncryptionInfoEncryptionAtRestOutputReference
	EncryptionAtRestInput() interface{}
	...
	PutEncryptionAtRest(value *MskClusterEncryptionInfoEncryptionAtRest)
	PutEncryptionInTransit(value *MskClusterEncryptionInfoEncryptionInTransit)
	ResetEncryptionAtRest()
...
func (j *jsiiProxy_MskClusterEncryptionInfoOutputReference) EncryptionAtRest() MskClusterEncryptionInfoEncryptionAtRestOutputReference {
	var returns MskClusterEncryptionInfoEncryptionAtRestOutputReference
	_jsii_.Get(
		j,
		"encryptionAtRest",
		&returns,
...
func (j *jsiiProxy_MskClusterEncryptionInfoOutputReference) EncryptionAtRestInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MskClusterEncryptionInfoOutputReference) EncryptionInTransitInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MskClusterEncryptionInfoOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_MskClusterEncryptionInfoOutputReference)SetInternalValue(val interface{}) {
...
func (m *jsiiProxy_MskClusterEncryptionInfoOutputReference) PutEncryptionAtRest(value *MskClusterEncryptionInfoEncryptionAtRest) {
	if err := m.validatePutEncryptionAtRestParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		m,
...
func (m *jsiiProxy_MskClusterEncryptionInfoOutputReference) ResetEncryptionAtRest() {
	_jsii_.InvokeVoid(
		m,
		"resetEncryptionAtRest",
		nil, // no parameters
