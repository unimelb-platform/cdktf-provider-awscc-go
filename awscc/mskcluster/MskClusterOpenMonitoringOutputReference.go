...
func (j *jsiiProxy_MskClusterOpenMonitoringOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_MskClusterOpenMonitoringOutputReference)SetInternalValue(val interface{}) {
