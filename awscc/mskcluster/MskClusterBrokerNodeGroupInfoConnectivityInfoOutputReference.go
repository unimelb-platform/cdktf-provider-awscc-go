...
type MskClusterBrokerNodeGroupInfoConnectivityInfoOutputReference interface {
	...
	VpcConnectivityInput() interface{}
	// Experimental.
	ComputeFqn() *string
	// Experimental.
...
func (j *jsiiProxy_MskClusterBrokerNodeGroupInfoConnectivityInfoOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_MskClusterBrokerNodeGroupInfoConnectivityInfoOutputReference) PublicAccessInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"publicAccessInput",
...
func (j *jsiiProxy_MskClusterBrokerNodeGroupInfoConnectivityInfoOutputReference) VpcConnectivityInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MskClusterBrokerNodeGroupInfoConnectivityInfoOutputReference)SetInternalValue(val interface{}) {
