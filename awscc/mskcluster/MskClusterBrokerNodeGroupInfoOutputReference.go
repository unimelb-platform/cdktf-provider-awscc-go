...
type MskClusterBrokerNodeGroupInfoOutputReference interface {
	...
	SetBrokerAzDistribution(val *string)
	BrokerAzDistributionInput() *string
...
func (j *jsiiProxy_MskClusterBrokerNodeGroupInfoOutputReference) BrokerAzDistribution() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MskClusterBrokerNodeGroupInfoOutputReference) BrokerAzDistributionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"brokerAzDistributionInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_MskClusterBrokerNodeGroupInfoOutputReference) ConnectivityInfoInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MskClusterBrokerNodeGroupInfoOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_MskClusterBrokerNodeGroupInfoOutputReference) StorageInfoInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"storageInfoInput",
...
func (j *jsiiProxy_MskClusterBrokerNodeGroupInfoOutputReference)SetBrokerAzDistribution(val *string) {
	if err := j.validateSetBrokerAzDistributionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_MskClusterBrokerNodeGroupInfoOutputReference)SetInternalValue(val interface{}) {
...
func (m *jsiiProxy_MskClusterBrokerNodeGroupInfoOutputReference) ResetBrokerAzDistribution() {
	_jsii_.InvokeVoid(
		m,
		"resetBrokerAzDistribution",
		nil, // no parameters
...
func (m *jsiiProxy_MskClusterBrokerNodeGroupInfoOutputReference) ResetSecurityGroups() {
	_jsii_.InvokeVoid(
		m,
		"resetSecurityGroups",
		nil, // no parameters
