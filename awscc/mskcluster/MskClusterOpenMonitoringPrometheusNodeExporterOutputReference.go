...
func (j *jsiiProxy_MskClusterOpenMonitoringPrometheusNodeExporterOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_MskClusterOpenMonitoringPrometheusNodeExporterOutputReference)SetInternalValue(val interface{}) {
