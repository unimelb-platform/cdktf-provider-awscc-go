...
func (j *jsiiProxy_MskClusterConfigurationInfoOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_MskClusterConfigurationInfoOutputReference)SetInternalValue(val interface{}) {
