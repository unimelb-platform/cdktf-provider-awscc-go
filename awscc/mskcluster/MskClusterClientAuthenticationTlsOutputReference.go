...
type MskClusterClientAuthenticationTlsOutputReference interface {
	...
	SetCertificateAuthorityArnList(val *[]*string)
	CertificateAuthorityArnListInput() *[]*string
	...
	ResetCertificateAuthorityArnList()
	ResetEnabled()
...
func (j *jsiiProxy_MskClusterClientAuthenticationTlsOutputReference) CertificateAuthorityArnList() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MskClusterClientAuthenticationTlsOutputReference) CertificateAuthorityArnListInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"certificateAuthorityArnListInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_MskClusterClientAuthenticationTlsOutputReference) Enabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabled",
...
func (j *jsiiProxy_MskClusterClientAuthenticationTlsOutputReference) EnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabledInput",
...
func (j *jsiiProxy_MskClusterClientAuthenticationTlsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_MskClusterClientAuthenticationTlsOutputReference)SetCertificateAuthorityArnList(val *[]*string) {
	if err := j.validateSetCertificateAuthorityArnListParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_MskClusterClientAuthenticationTlsOutputReference)SetEnabled(val interface{}) {
...
func (j *jsiiProxy_MskClusterClientAuthenticationTlsOutputReference)SetInternalValue(val interface{}) {
...
func (m *jsiiProxy_MskClusterClientAuthenticationTlsOutputReference) ResetCertificateAuthorityArnList() {
	_jsii_.InvokeVoid(
		m,
		"resetCertificateAuthorityArnList",
		nil, // no parameters
...
func (m *jsiiProxy_MskClusterClientAuthenticationTlsOutputReference) ResetEnabled() {
	_jsii_.InvokeVoid(
		m,
		"resetEnabled",
		nil, // no parameters
