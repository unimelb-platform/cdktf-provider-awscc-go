...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AmazonmqConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.amazonmqConfiguration.AmazonmqConfigurationConfig",
		reflect.TypeOf((*AmazonmqConfigurationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.amazonmqConfiguration.AmazonmqConfigurationTags",
		reflect.TypeOf((*AmazonmqConfigurationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.amazonmqConfiguration.AmazonmqConfigurationTagsList",
		reflect.TypeOf((*AmazonmqConfigurationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AmazonmqConfigurationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
