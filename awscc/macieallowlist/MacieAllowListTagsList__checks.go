...
func (m *jsiiProxy_MacieAllowListTagsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_MacieAllowListTagsList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*MacieAllowListTags; received %#v (a %T)", val, val)
		}
	}
