...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2TransitGatewayAttachment)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*Ec2TransitGatewayAttachmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.ec2TransitGatewayAttachment.Ec2TransitGatewayAttachmentOptions",
		reflect.TypeOf((*Ec2TransitGatewayAttachmentOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2TransitGatewayAttachment.Ec2TransitGatewayAttachmentOptionsOutputReference",
		reflect.TypeOf((*Ec2TransitGatewayAttachmentOptionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*Ec2TransitGatewayAttachmentTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2TransitGatewayAttachment.Ec2TransitGatewayAttachmentTagsList",
		reflect.TypeOf((*Ec2TransitGatewayAttachmentTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2TransitGatewayAttachmentTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
