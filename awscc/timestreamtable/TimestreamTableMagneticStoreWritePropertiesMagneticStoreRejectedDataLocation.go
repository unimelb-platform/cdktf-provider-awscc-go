...
type TimestreamTableMagneticStoreWritePropertiesMagneticStoreRejectedDataLocation struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/timestream_table#s3_configuration TimestreamTable#s3_configuration}
