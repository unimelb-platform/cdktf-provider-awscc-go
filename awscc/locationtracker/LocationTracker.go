...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/location_tracker awscc_location_tracker}.
type LocationTracker interface {
	...
	EventBridgeEnabledInput() interface{}
	// Experimental.
	...
	KmsKeyEnableGeospatialQueriesInput() interface{}
	KmsKeyId() *string
	...
	PricingPlanDataSourceInput() *string
	...
	ResetDescription()
	ResetEventBridgeEnabled()
	ResetKmsKeyEnableGeospatialQueries()
	ResetKmsKeyId()
...
func (j *jsiiProxy_LocationTracker) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_LocationTracker) EventBridgeEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"eventBridgeEnabled",
...
func (j *jsiiProxy_LocationTracker) EventBridgeEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"eventBridgeEnabledInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_LocationTracker) KmsKeyEnableGeospatialQueries() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LocationTracker) KmsKeyEnableGeospatialQueriesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"kmsKeyEnableGeospatialQueriesInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_LocationTracker) PricingPlan() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pricingPlan",
...
func (j *jsiiProxy_LocationTracker) PricingPlanDataSource() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LocationTracker) PricingPlanDataSourceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pricingPlanDataSourceInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_LocationTracker) PricingPlanInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pricingPlanInput",
...
func (j *jsiiProxy_LocationTracker) Tags() LocationTrackerTagsList {
	var returns LocationTrackerTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_LocationTracker) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/location_tracker awscc_location_tracker} Resource.
func NewLocationTracker(scope constructs.Construct, id *string, config *LocationTrackerConfig) LocationTracker {
	...
	_jsii_.Create(
		"awscc.locationTracker.LocationTracker",
...
func (j *jsiiProxy_LocationTracker)SetEventBridgeEnabled(val interface{}) {
...
func (j *jsiiProxy_LocationTracker)SetKmsKeyEnableGeospatialQueries(val interface{}) {
...
func (j *jsiiProxy_LocationTracker)SetPricingPlan(val *string) {
...
func (j *jsiiProxy_LocationTracker)SetPricingPlanDataSource(val *string) {
	if err := j.validateSetPricingPlanDataSourceParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (l *jsiiProxy_LocationTracker) PutTags(value interface{}) {
...
func (l *jsiiProxy_LocationTracker) ResetEventBridgeEnabled() {
	_jsii_.InvokeVoid(
		l,
		"resetEventBridgeEnabled",
		nil, // no parameters
...
func (l *jsiiProxy_LocationTracker) ResetKmsKeyEnableGeospatialQueries() {
	_jsii_.InvokeVoid(
		l,
		"resetKmsKeyEnableGeospatialQueries",
		nil, // no parameters
...
func (l *jsiiProxy_LocationTracker) ResetPricingPlan() {
	_jsii_.InvokeVoid(
		l,
		"resetPricingPlan",
		nil, // no parameters
...
func (l *jsiiProxy_LocationTracker) ResetPricingPlanDataSource() {
	_jsii_.InvokeVoid(
		l,
		"resetPricingPlanDataSource",
		nil, // no parameters
