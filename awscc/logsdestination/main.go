...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LogsDestination)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "destinationPolicyInput", GoGetter: "DestinationPolicyInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDestinationPolicy", GoMethod: "ResetDestinationPolicy"},
	...
	_jsii_.RegisterStruct(
		"awscc.logsDestination.LogsDestinationConfig",
		reflect.TypeOf((*LogsDestinationConfig)(nil)).Elem(),
	)
}
