...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.kendraFaq.KendraFaqConfig",
		reflect.TypeOf((*KendraFaqConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.kendraFaq.KendraFaqS3Path",
		reflect.TypeOf((*KendraFaqS3Path)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.kendraFaq.KendraFaqS3PathOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.kendraFaq.KendraFaqTags",
		reflect.TypeOf((*KendraFaqTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.kendraFaq.KendraFaqTagsList",
		reflect.TypeOf((*KendraFaqTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*KendraFaqTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
