...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/comprehend_flywheel awscc_comprehend_flywheel}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/comprehend_flywheel awscc_comprehend_flywheel} Resource.
...
func (c *jsiiProxy_ComprehendFlywheel) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_ComprehendFlywheel) MoveFromId(id *string) {
...
func (c *jsiiProxy_ComprehendFlywheel) MoveToId(id *string) {
...
func (c *jsiiProxy_ComprehendFlywheel) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_ComprehendFlywheel) ToHclTerraform() interface{} {
	var returns interface{}
