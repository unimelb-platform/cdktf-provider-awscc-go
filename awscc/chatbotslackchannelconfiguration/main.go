...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.chatbotSlackChannelConfiguration.ChatbotSlackChannelConfigurationTags",
		reflect.TypeOf((*ChatbotSlackChannelConfigurationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.chatbotSlackChannelConfiguration.ChatbotSlackChannelConfigurationTagsList",
		reflect.TypeOf((*ChatbotSlackChannelConfigurationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_ChatbotSlackChannelConfigurationTagsList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ChatbotSlackChannelConfigurationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
