...
func (d *jsiiProxy_DataAwsccSagemakerModelExplainabilityJobDefinitionModelExplainabilityJobOutputConfigMonitoringOutputsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
