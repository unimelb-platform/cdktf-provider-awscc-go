...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/apigatewayv2deployment/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigatewayv2_deployment awscc_apigatewayv2_deployment}.
...
func (j *jsiiProxy_Apigatewayv2Deployment) DeploymentId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deploymentId",
...
func (j *jsiiProxy_Apigatewayv2Deployment) StageName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stageName",
...
func (j *jsiiProxy_Apigatewayv2Deployment) StageNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stageNameInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigatewayv2_deployment awscc_apigatewayv2_deployment} Resource.
func NewApigatewayv2Deployment(scope constructs.Construct, id *string, config *Apigatewayv2DeploymentConfig) Apigatewayv2Deployment {
	...
	_jsii_.Create(
		"awscc.apigatewayv2Deployment.Apigatewayv2Deployment",
...
func (j *jsiiProxy_Apigatewayv2Deployment)SetStageName(val *string) {
...
func (a *jsiiProxy_Apigatewayv2Deployment) ResetStageName() {
	_jsii_.InvokeVoid(
		a,
		"resetStageName",
		nil, // no parameters
