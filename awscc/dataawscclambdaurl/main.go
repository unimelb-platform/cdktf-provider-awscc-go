...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccLambdaUrl)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccLambdaUrl.DataAwsccLambdaUrlConfig",
		reflect.TypeOf((*DataAwsccLambdaUrlConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccLambdaUrl.DataAwsccLambdaUrlCors",
		reflect.TypeOf((*DataAwsccLambdaUrlCors)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccLambdaUrl.DataAwsccLambdaUrlCorsOutputReference",
		reflect.TypeOf((*DataAwsccLambdaUrlCorsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
