...
func (i *jsiiProxy_IotsitewiseAssetModelAssetModelPropertiesTypeMetricVariablesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
