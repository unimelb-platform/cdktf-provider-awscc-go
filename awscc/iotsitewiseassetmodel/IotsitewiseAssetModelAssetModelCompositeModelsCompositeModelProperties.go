...
type IotsitewiseAssetModelAssetModelCompositeModelsCompositeModelProperties struct {
	...
	Type *IotsitewiseAssetModelAssetModelCompositeModelsCompositeModelPropertiesType `field:"required" json:"type" yaml:"type"`
