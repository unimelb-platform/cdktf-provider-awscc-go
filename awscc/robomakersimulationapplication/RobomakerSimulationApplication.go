...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/robomaker_simulation_application awscc_robomaker_simulation_application}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/robomaker_simulation_application awscc_robomaker_simulation_application} Resource.
...
func (r *jsiiProxy_RobomakerSimulationApplication) HasResourceMove() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_RobomakerSimulationApplication) MoveFromId(id *string) {
...
func (r *jsiiProxy_RobomakerSimulationApplication) MoveToId(id *string) {
...
func (r *jsiiProxy_RobomakerSimulationApplication) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_RobomakerSimulationApplication) ToHclTerraform() interface{} {
	var returns interface{}
