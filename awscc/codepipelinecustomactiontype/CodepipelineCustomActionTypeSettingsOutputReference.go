...
func (j *jsiiProxy_CodepipelineCustomActionTypeSettingsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewCodepipelineCustomActionTypeSettingsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CodepipelineCustomActionTypeSettingsOutputReference {
	...
	_jsii_.Create(
		"awscc.codepipelineCustomActionType.CodepipelineCustomActionTypeSettingsOutputReference",
...
func (j *jsiiProxy_CodepipelineCustomActionTypeSettingsOutputReference)SetInternalValue(val interface{}) {
