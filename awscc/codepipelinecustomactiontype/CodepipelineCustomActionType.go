...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/codepipeline_custom_action_type awscc_codepipeline_custom_action_type}.
type CodepipelineCustomActionType interface {
	...
	ConfigurationProperties() CodepipelineCustomActionTypeConfigurationPropertiesList
	ConfigurationPropertiesInput() interface{}
	// Experimental.
	...
	InputArtifactDetailsInput() interface{}
	// Experimental.
	...
	OutputArtifactDetailsInput() interface{}
	// Experimental.
	...
	PutConfigurationProperties(value interface{})
...
func (j *jsiiProxy_CodepipelineCustomActionType) ConfigurationProperties() CodepipelineCustomActionTypeConfigurationPropertiesList {
	var returns CodepipelineCustomActionTypeConfigurationPropertiesList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CodepipelineCustomActionType) ConfigurationPropertiesInput() interface{} {
...
func (j *jsiiProxy_CodepipelineCustomActionType) CustomActionTypeId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"customActionTypeId",
...
func (j *jsiiProxy_CodepipelineCustomActionType) InputArtifactDetailsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CodepipelineCustomActionType) OutputArtifactDetailsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CodepipelineCustomActionType) SettingsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"settingsInput",
...
func (j *jsiiProxy_CodepipelineCustomActionType) Tags() CodepipelineCustomActionTypeTagsList {
	var returns CodepipelineCustomActionTypeTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_CodepipelineCustomActionType) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/codepipeline_custom_action_type awscc_codepipeline_custom_action_type} Resource.
func NewCodepipelineCustomActionType(scope constructs.Construct, id *string, config *CodepipelineCustomActionTypeConfig) CodepipelineCustomActionType {
	...
	_jsii_.Create(
		"awscc.codepipelineCustomActionType.CodepipelineCustomActionType",
...
func (c *jsiiProxy_CodepipelineCustomActionType) PutConfigurationProperties(value interface{}) {
	if err := c.validatePutConfigurationPropertiesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
		"putConfigurationProperties",
		[]interface{}{value},
	)
}
...
func (c *jsiiProxy_CodepipelineCustomActionType) PutTags(value interface{}) {
...
func (c *jsiiProxy_CodepipelineCustomActionType) ResetConfigurationProperties() {
	_jsii_.InvokeVoid(
		c,
		"resetConfigurationProperties",
		nil, // no parameters
