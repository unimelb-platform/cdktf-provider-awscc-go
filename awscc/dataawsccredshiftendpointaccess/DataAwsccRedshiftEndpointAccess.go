...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/data-sources/redshift_endpoint_access awscc_redshift_endpoint_access}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/data-sources/redshift_endpoint_access awscc_redshift_endpoint_access} Data Source.
...
func (d *jsiiProxy_DataAwsccRedshiftEndpointAccess) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsccRedshiftEndpointAccess) ToHclTerraform() interface{} {
	var returns interface{}
