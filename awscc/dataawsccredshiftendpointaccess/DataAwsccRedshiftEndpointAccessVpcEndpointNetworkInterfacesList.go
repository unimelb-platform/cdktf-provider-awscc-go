...
func (d *jsiiProxy_DataAwsccRedshiftEndpointAccessVpcEndpointNetworkInterfacesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
