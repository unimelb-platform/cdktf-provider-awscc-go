...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/iamuserpolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/iam_user_policy awscc_iam_user_policy}.
...
func (j *jsiiProxy_IamUserPolicy) PolicyDocument() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyDocument",
...
func (j *jsiiProxy_IamUserPolicy) PolicyDocumentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyDocumentInput",
...
func (j *jsiiProxy_IamUserPolicy) PolicyName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyName",
...
func (j *jsiiProxy_IamUserPolicy) PolicyNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyNameInput",
...
func (j *jsiiProxy_IamUserPolicy) UserName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"userName",
...
func (j *jsiiProxy_IamUserPolicy) UserNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"userNameInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/iam_user_policy awscc_iam_user_policy} Resource.
func NewIamUserPolicy(scope constructs.Construct, id *string, config *IamUserPolicyConfig) IamUserPolicy {
	...
	_jsii_.Create(
		"awscc.iamUserPolicy.IamUserPolicy",
...
func (j *jsiiProxy_IamUserPolicy)SetPolicyDocument(val *string) {
...
func (j *jsiiProxy_IamUserPolicy)SetPolicyName(val *string) {
...
func (j *jsiiProxy_IamUserPolicy)SetUserName(val *string) {
...
func (i *jsiiProxy_IamUserPolicy) ResetPolicyDocument() {
	_jsii_.InvokeVoid(
		i,
		"resetPolicyDocument",
		nil, // no parameters
