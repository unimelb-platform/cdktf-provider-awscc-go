...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetVpcConnectionId", GoMethod: "ResetVpcConnectionId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*QuicksightVpcConnectionNetworkInterfaces)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.quicksightVpcConnection.QuicksightVpcConnectionNetworkInterfacesList",
		reflect.TypeOf((*QuicksightVpcConnectionNetworkInterfacesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*QuicksightVpcConnectionNetworkInterfacesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_QuicksightVpcConnectionNetworkInterfacesOutputReference{}
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*QuicksightVpcConnectionTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.quicksightVpcConnection.QuicksightVpcConnectionTagsList",
		reflect.TypeOf((*QuicksightVpcConnectionTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*QuicksightVpcConnectionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
