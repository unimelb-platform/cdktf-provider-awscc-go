...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/quicksight_vpc_connection awscc_quicksight_vpc_connection}.
type QuicksightVpcConnection interface {
	...
	SetName(val *string)
	NameInput() *string
	NetworkInterfaces() QuicksightVpcConnectionNetworkInterfacesList
	// The tree node.
...
func (j *jsiiProxy_QuicksightVpcConnection) AvailabilityStatusInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_QuicksightVpcConnection) CreatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdTime",
...
func (j *jsiiProxy_QuicksightVpcConnection) LastUpdatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lastUpdatedTime",
...
func (j *jsiiProxy_QuicksightVpcConnection) NetworkInterfaces() QuicksightVpcConnectionNetworkInterfacesList {
	var returns QuicksightVpcConnectionNetworkInterfacesList
	_jsii_.Get(
		j,
		"networkInterfaces",
		&returns,
...
func (j *jsiiProxy_QuicksightVpcConnection) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_QuicksightVpcConnection) Tags() QuicksightVpcConnectionTagsList {
	var returns QuicksightVpcConnectionTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_QuicksightVpcConnection) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_QuicksightVpcConnection) VpcId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpcId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/quicksight_vpc_connection awscc_quicksight_vpc_connection} Resource.
func NewQuicksightVpcConnection(scope constructs.Construct, id *string, config *QuicksightVpcConnectionConfig) QuicksightVpcConnection {
	...
	_jsii_.Create(
		"awscc.quicksightVpcConnection.QuicksightVpcConnection",
...
func (j *jsiiProxy_QuicksightVpcConnection)SetAvailabilityStatus(val *string) {
...
func (q *jsiiProxy_QuicksightVpcConnection) PutTags(value interface{}) {
...
func (q *jsiiProxy_QuicksightVpcConnection) ResetAvailabilityStatus() {
	_jsii_.InvokeVoid(
		q,
		"resetAvailabilityStatus",
		nil, // no parameters
...
func (q *jsiiProxy_QuicksightVpcConnection) ResetName() {
	_jsii_.InvokeVoid(
		q,
		"resetName",
		nil, // no parameters
...
func (q *jsiiProxy_QuicksightVpcConnection) ResetRoleArn() {
	_jsii_.InvokeVoid(
		q,
		"resetRoleArn",
		nil, // no parameters
...
func (q *jsiiProxy_QuicksightVpcConnection) ResetSecurityGroupIds() {
	_jsii_.InvokeVoid(
		q,
		"resetSecurityGroupIds",
		nil, // no parameters
...
func (q *jsiiProxy_QuicksightVpcConnection) ResetSubnetIds() {
	_jsii_.InvokeVoid(
		q,
		"resetSubnetIds",
		nil, // no parameters
...
func (q *jsiiProxy_QuicksightVpcConnection) ResetVpcConnectionId() {
	_jsii_.InvokeVoid(
		q,
		"resetVpcConnectionId",
		nil, // no parameters
