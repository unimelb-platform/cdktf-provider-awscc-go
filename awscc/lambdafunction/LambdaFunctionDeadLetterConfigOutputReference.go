...
func (j *jsiiProxy_LambdaFunctionDeadLetterConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_LambdaFunctionDeadLetterConfigOutputReference)SetInternalValue(val interface{}) {
...
func (l *jsiiProxy_LambdaFunctionDeadLetterConfigOutputReference) ResetTargetArn() {
	_jsii_.InvokeVoid(
		l,
		"resetTargetArn",
		nil, // no parameters
