...
func (l *jsiiProxy_LambdaFunction) validatePutCodeParameters(value *LambdaFunctionCode) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (l *jsiiProxy_LambdaFunction) validatePutFileSystemConfigsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*LambdaFunctionFileSystemConfigs:
		value := value.(*[]*LambdaFunctionFileSystemConfigs)
	...
	case []*LambdaFunctionFileSystemConfigs:
		value_ := value.([]*LambdaFunctionFileSystemConfigs)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*LambdaFunctionFileSystemConfigs; received %#v (a %T)", value, value)
		}
	}
...
func (l *jsiiProxy_LambdaFunction) validatePutRuntimeManagementConfigParameters(value *LambdaFunctionRuntimeManagementConfig) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (l *jsiiProxy_LambdaFunction) validatePutTagsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*LambdaFunctionTags:
		value := value.(*[]*LambdaFunctionTags)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*LambdaFunctionTags:
		value_ := value.([]*LambdaFunctionTags)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*LambdaFunctionTags; received %#v (a %T)", value, value)
		}
	}
