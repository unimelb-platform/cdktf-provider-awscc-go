...
func (j *jsiiProxy_LambdaFunctionEnvironmentOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_LambdaFunctionEnvironmentOutputReference)SetInternalValue(val interface{}) {
