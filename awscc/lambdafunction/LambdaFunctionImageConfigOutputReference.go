...
func (j *jsiiProxy_LambdaFunctionImageConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_LambdaFunctionImageConfigOutputReference)SetInternalValue(val interface{}) {
