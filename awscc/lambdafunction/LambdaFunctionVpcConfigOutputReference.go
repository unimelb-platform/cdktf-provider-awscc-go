...
func (j *jsiiProxy_LambdaFunctionVpcConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_LambdaFunctionVpcConfigOutputReference)SetInternalValue(val interface{}) {
...
func (l *jsiiProxy_LambdaFunctionVpcConfigOutputReference) ResetSecurityGroupIds() {
	_jsii_.InvokeVoid(
		l,
		"resetSecurityGroupIds",
		nil, // no parameters
...
func (l *jsiiProxy_LambdaFunctionVpcConfigOutputReference) ResetSubnetIds() {
	_jsii_.InvokeVoid(
		l,
		"resetSubnetIds",
		nil, // no parameters
