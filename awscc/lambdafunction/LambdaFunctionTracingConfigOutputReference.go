...
func (j *jsiiProxy_LambdaFunctionTracingConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_LambdaFunctionTracingConfigOutputReference)SetInternalValue(val interface{}) {
...
func (l *jsiiProxy_LambdaFunctionTracingConfigOutputReference) ResetMode() {
	_jsii_.InvokeVoid(
		l,
		"resetMode",
		nil, // no parameters
