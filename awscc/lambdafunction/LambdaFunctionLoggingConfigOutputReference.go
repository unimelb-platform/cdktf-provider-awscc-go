...
func (j *jsiiProxy_LambdaFunctionLoggingConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_LambdaFunctionLoggingConfigOutputReference)SetInternalValue(val interface{}) {
...
func (l *jsiiProxy_LambdaFunctionLoggingConfigOutputReference) ResetLogFormat() {
	_jsii_.InvokeVoid(
		l,
		"resetLogFormat",
		nil, // no parameters
