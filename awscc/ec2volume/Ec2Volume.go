...
func (j *jsiiProxy_Ec2Volume) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_Ec2Volume) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Ec2Volume) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2Volume) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_Ec2Volume) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Ec2Volume)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Ec2Volume)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Ec2Volume)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTF code for importing a Ec2Volume resource upon running "cdktf plan <stack-name>".
func Ec2Volume_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Ec2Volume) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_Ec2Volume) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
