...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2Volume)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "autoEnableIo", GoGetter: "AutoEnableIo"},
			_jsii_.MemberProperty{JsiiProperty: "autoEnableIoInput", GoGetter: "AutoEnableIoInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAutoEnableIo", GoMethod: "ResetAutoEnableIo"},
	...
	_jsii_.RegisterStruct(
		"awscc.ec2Volume.Ec2VolumeConfig",
		reflect.TypeOf((*Ec2VolumeConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.ec2Volume.Ec2VolumeTags",
		reflect.TypeOf((*Ec2VolumeTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2Volume.Ec2VolumeTagsList",
		reflect.TypeOf((*Ec2VolumeTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2VolumeTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
