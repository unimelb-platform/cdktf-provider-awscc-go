...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/redshiftserverless_snapshot awscc_redshiftserverless_snapshot}.
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) Snapshot() RedshiftserverlessSnapshotSnapshotOutputReference {
	var returns RedshiftserverlessSnapshotSnapshotOutputReference
	_jsii_.Get(
		j,
		"snapshot",
		&returns,
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) Tags() RedshiftserverlessSnapshotTagsList {
	var returns RedshiftserverlessSnapshotTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/redshiftserverless_snapshot awscc_redshiftserverless_snapshot} Resource.
...
func (r *jsiiProxy_RedshiftserverlessSnapshot) PutTags(value interface{}) {
...
func (r *jsiiProxy_RedshiftserverlessSnapshot) ResetNamespaceName() {
	_jsii_.InvokeVoid(
		r,
		"resetNamespaceName",
		nil, // no parameters
...
func (r *jsiiProxy_RedshiftserverlessSnapshot) ResetTags() {
	_jsii_.InvokeVoid(
		r,
		"resetTags",
		nil, // no parameters
