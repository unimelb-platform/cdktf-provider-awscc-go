...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.redshiftserverlessSnapshot.RedshiftserverlessSnapshotSnapshot",
		reflect.TypeOf((*RedshiftserverlessSnapshotSnapshot)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.redshiftserverlessSnapshot.RedshiftserverlessSnapshotSnapshotOutputReference",
		reflect.TypeOf((*RedshiftserverlessSnapshotSnapshotOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.redshiftserverlessSnapshot.RedshiftserverlessSnapshotTags",
		reflect.TypeOf((*RedshiftserverlessSnapshotTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.redshiftserverlessSnapshot.RedshiftserverlessSnapshotTagsList",
		reflect.TypeOf((*RedshiftserverlessSnapshotTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RedshiftserverlessSnapshotTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
