...
func (j *jsiiProxy_DatasyncTaskExcludesOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewDatasyncTaskExcludesOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DatasyncTaskExcludesOutputReference {
	_init_.Initialize()

	if err := validateNewDatasyncTaskExcludesOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewDatasyncTaskExcludesOutputReference_Override(d DatasyncTaskExcludesOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DatasyncTaskExcludesOutputReference)SetInternalValue(val interface{}) {
