...
func (j *jsiiProxy_DatasyncTaskOptionsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_DatasyncTaskOptionsOutputReference)SetInternalValue(val interface{}) {
