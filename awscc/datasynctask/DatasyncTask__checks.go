...
func (d *jsiiProxy_DatasyncTask) validatePutExcludesParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*DatasyncTaskExcludes:
		value := value.(*[]*DatasyncTaskExcludes)
	...
	case []*DatasyncTaskExcludes:
		value_ := value.([]*DatasyncTaskExcludes)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*DatasyncTaskExcludes; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DatasyncTask) validatePutIncludesParameters(value interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*DatasyncTaskIncludes:
		value := value.(*[]*DatasyncTaskIncludes)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*DatasyncTaskIncludes:
		value_ := value.([]*DatasyncTaskIncludes)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (d *jsiiProxy_DatasyncTask) validatePutTagsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*DatasyncTaskTags; received %#v (a %T)", value, value)
		}
	}
