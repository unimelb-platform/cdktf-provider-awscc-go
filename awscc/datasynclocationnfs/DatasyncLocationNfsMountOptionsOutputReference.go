...
func (j *jsiiProxy_DatasyncLocationNfsMountOptionsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_DatasyncLocationNfsMountOptionsOutputReference)SetInternalValue(val interface{}) {
