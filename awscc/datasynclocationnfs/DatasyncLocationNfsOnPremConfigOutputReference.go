...
func (j *jsiiProxy_DatasyncLocationNfsOnPremConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_DatasyncLocationNfsOnPremConfigOutputReference)SetInternalValue(val interface{}) {
