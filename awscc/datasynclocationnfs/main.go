...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.datasyncLocationNfs.DatasyncLocationNfsConfig",
		reflect.TypeOf((*DatasyncLocationNfsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.datasyncLocationNfs.DatasyncLocationNfsMountOptions",
		reflect.TypeOf((*DatasyncLocationNfsMountOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.datasyncLocationNfs.DatasyncLocationNfsMountOptionsOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.datasyncLocationNfs.DatasyncLocationNfsOnPremConfig",
	...
	_jsii_.RegisterStruct(
		"awscc.datasyncLocationNfs.DatasyncLocationNfsTags",
		reflect.TypeOf((*DatasyncLocationNfsTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.datasyncLocationNfs.DatasyncLocationNfsTagsList",
		reflect.TypeOf((*DatasyncLocationNfsTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DatasyncLocationNfsTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
