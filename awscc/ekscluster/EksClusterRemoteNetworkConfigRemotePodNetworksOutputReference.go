...
func (j *jsiiProxy_EksClusterRemoteNetworkConfigRemotePodNetworksOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewEksClusterRemoteNetworkConfigRemotePodNetworksOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) EksClusterRemoteNetworkConfigRemotePodNetworksOutputReference {
	_init_.Initialize()

	if err := validateNewEksClusterRemoteNetworkConfigRemotePodNetworksOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewEksClusterRemoteNetworkConfigRemotePodNetworksOutputReference_Override(e EksClusterRemoteNetworkConfigRemotePodNetworksOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EksClusterRemoteNetworkConfigRemotePodNetworksOutputReference)SetInternalValue(val interface{}) {
