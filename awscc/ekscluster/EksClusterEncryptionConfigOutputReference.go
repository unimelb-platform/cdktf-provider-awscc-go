...
func (j *jsiiProxy_EksClusterEncryptionConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EksClusterEncryptionConfigOutputReference) ProviderInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"providerInput",
...
func NewEksClusterEncryptionConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) EksClusterEncryptionConfigOutputReference {
	_init_.Initialize()

	if err := validateNewEksClusterEncryptionConfigOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewEksClusterEncryptionConfigOutputReference_Override(e EksClusterEncryptionConfigOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EksClusterEncryptionConfigOutputReference)SetInternalValue(val interface{}) {
...
func (e *jsiiProxy_EksClusterEncryptionConfigOutputReference) ResetProvider() {
	_jsii_.InvokeVoid(
		e,
		"resetProvider",
		nil, // no parameters
...
func (e *jsiiProxy_EksClusterEncryptionConfigOutputReference) ResetResources() {
	_jsii_.InvokeVoid(
		e,
		"resetResources",
		nil, // no parameters
