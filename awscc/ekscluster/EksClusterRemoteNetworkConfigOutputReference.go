...
type EksClusterRemoteNetworkConfigOutputReference interface {
	...
	RemoteNodeNetworks() EksClusterRemoteNetworkConfigRemoteNodeNetworksList
	RemoteNodeNetworksInput() interface{}
	RemotePodNetworks() EksClusterRemoteNetworkConfigRemotePodNetworksList
	RemotePodNetworksInput() interface{}
	// Experimental.
	...
	PutRemoteNodeNetworks(value interface{})
	PutRemotePodNetworks(value interface{})
...
func (j *jsiiProxy_EksClusterRemoteNetworkConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EksClusterRemoteNetworkConfigOutputReference) RemoteNodeNetworks() EksClusterRemoteNetworkConfigRemoteNodeNetworksList {
	var returns EksClusterRemoteNetworkConfigRemoteNodeNetworksList
	_jsii_.Get(
		j,
		"remoteNodeNetworks",
		&returns,
...
func (j *jsiiProxy_EksClusterRemoteNetworkConfigOutputReference) RemoteNodeNetworksInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EksClusterRemoteNetworkConfigOutputReference) RemotePodNetworks() EksClusterRemoteNetworkConfigRemotePodNetworksList {
	var returns EksClusterRemoteNetworkConfigRemotePodNetworksList
	_jsii_.Get(
		j,
		"remotePodNetworks",
		&returns,
...
func (j *jsiiProxy_EksClusterRemoteNetworkConfigOutputReference) RemotePodNetworksInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EksClusterRemoteNetworkConfigOutputReference)SetInternalValue(val interface{}) {
...
func (e *jsiiProxy_EksClusterRemoteNetworkConfigOutputReference) PutRemoteNodeNetworks(value interface{}) {
...
func (e *jsiiProxy_EksClusterRemoteNetworkConfigOutputReference) PutRemotePodNetworks(value interface{}) {
