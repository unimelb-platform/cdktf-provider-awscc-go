...
func (j *jsiiProxy_EksClusterEncryptionConfigProviderOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EksClusterEncryptionConfigProviderOutputReference)SetInternalValue(val interface{}) {
...
func (e *jsiiProxy_EksClusterEncryptionConfigProviderOutputReference) ResetKeyArn() {
	_jsii_.InvokeVoid(
		e,
		"resetKeyArn",
		nil, // no parameters
