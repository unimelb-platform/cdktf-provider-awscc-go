...
func (j *jsiiProxy_EksClusterKubernetesNetworkConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EksClusterKubernetesNetworkConfigOutputReference)SetInternalValue(val interface{}) {
