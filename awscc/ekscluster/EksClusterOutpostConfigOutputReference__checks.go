...
func (j *jsiiProxy_EksClusterOutpostConfigOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *EksClusterOutpostConfig:
		val := val.(*EksClusterOutpostConfig)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case EksClusterOutpostConfig:
		val_ := val.(EksClusterOutpostConfig)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *EksClusterOutpostConfig; received %#v (a %T)", val, val)
		}
	}
