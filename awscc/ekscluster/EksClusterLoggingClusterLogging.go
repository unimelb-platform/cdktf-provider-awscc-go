...
type EksClusterLoggingClusterLogging struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/eks_cluster#enabled_types EksCluster#enabled_types}
