...
func (j *jsiiProxy_EksClusterKubernetesNetworkConfigOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *EksClusterKubernetesNetworkConfig:
		val := val.(*EksClusterKubernetesNetworkConfig)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case EksClusterKubernetesNetworkConfig:
		val_ := val.(EksClusterKubernetesNetworkConfig)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *EksClusterKubernetesNetworkConfig; received %#v (a %T)", val, val)
		}
	}
