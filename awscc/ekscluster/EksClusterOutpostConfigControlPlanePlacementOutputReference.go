...
func (j *jsiiProxy_EksClusterOutpostConfigControlPlanePlacementOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewEksClusterOutpostConfigControlPlanePlacementOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) EksClusterOutpostConfigControlPlanePlacementOutputReference {
	...
	_jsii_.Create(
		"awscc.eksCluster.EksClusterOutpostConfigControlPlanePlacementOutputReference",
...
func (j *jsiiProxy_EksClusterOutpostConfigControlPlanePlacementOutputReference)SetInternalValue(val interface{}) {
