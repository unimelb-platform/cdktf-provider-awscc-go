...
func (e *jsiiProxy_EksCluster) validatePutEncryptionConfigParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*EksClusterEncryptionConfig:
		value := value.(*[]*EksClusterEncryptionConfig)
	...
	case []*EksClusterEncryptionConfig:
		value_ := value.([]*EksClusterEncryptionConfig)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*EksClusterEncryptionConfig; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_EksCluster) validatePutLoggingParameters(value *EksClusterLogging) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (e *jsiiProxy_EksCluster) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*EksClusterTags; received %#v (a %T)", value, value)
		}
	}
