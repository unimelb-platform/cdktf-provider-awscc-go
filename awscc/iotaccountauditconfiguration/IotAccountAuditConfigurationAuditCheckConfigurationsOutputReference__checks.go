...
func (j *jsiiProxy_IotAccountAuditConfigurationAuditCheckConfigurationsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *IotAccountAuditConfigurationAuditCheckConfigurations:
		val := val.(*IotAccountAuditConfigurationAuditCheckConfigurations)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case IotAccountAuditConfigurationAuditCheckConfigurations:
		val_ := val.(IotAccountAuditConfigurationAuditCheckConfigurations)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *IotAccountAuditConfigurationAuditCheckConfigurations; received %#v (a %T)", val, val)
		}
	}
