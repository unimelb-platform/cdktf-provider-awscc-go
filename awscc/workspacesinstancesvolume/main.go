...
func init() {
	_jsii_.RegisterClass(
		"awscc.workspacesinstancesVolume.WorkspacesinstancesVolume",
		reflect.TypeOf((*WorkspacesinstancesVolume)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_WorkspacesinstancesVolume{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.workspacesinstancesVolume.WorkspacesinstancesVolumeConfig",
		reflect.TypeOf((*WorkspacesinstancesVolumeConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.workspacesinstancesVolume.WorkspacesinstancesVolumeTagSpecifications",
		reflect.TypeOf((*WorkspacesinstancesVolumeTagSpecifications)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.workspacesinstancesVolume.WorkspacesinstancesVolumeTagSpecificationsList",
		reflect.TypeOf((*WorkspacesinstancesVolumeTagSpecificationsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WorkspacesinstancesVolumeTagSpecificationsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*WorkspacesinstancesVolumeTagSpecificationsTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.workspacesinstancesVolume.WorkspacesinstancesVolumeTagSpecificationsTagsList",
		reflect.TypeOf((*WorkspacesinstancesVolumeTagSpecificationsTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WorkspacesinstancesVolumeTagSpecificationsTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
