...
func (j *jsiiProxy_GuarddutyFilterFindingCriteriaOutputReference) Criterion() GuarddutyFilterFindingCriteriaCriterionMap {
	var returns GuarddutyFilterFindingCriteriaCriterionMap
	_jsii_.Get(
		j,
		"criterion",
		&returns,
...
func (j *jsiiProxy_GuarddutyFilterFindingCriteriaOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_GuarddutyFilterFindingCriteriaOutputReference)SetInternalValue(val interface{}) {
...
func (g *jsiiProxy_GuarddutyFilterFindingCriteriaOutputReference) ResetCriterion() {
	_jsii_.InvokeVoid(
		g,
		"resetCriterion",
		nil, // no parameters
