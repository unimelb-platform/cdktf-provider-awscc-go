...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/guardduty_filter awscc_guardduty_filter}.
...
func (j *jsiiProxy_GuarddutyFilter) FindingCriteriaInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GuarddutyFilter) Tags() GuarddutyFilterTagsList {
	var returns GuarddutyFilterTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/guardduty_filter awscc_guardduty_filter} Resource.
...
func (g *jsiiProxy_GuarddutyFilter) PutTags(value interface{}) {
...
func (g *jsiiProxy_GuarddutyFilter) ResetAction() {
	_jsii_.InvokeVoid(
		g,
		"resetAction",
		nil, // no parameters
...
func (g *jsiiProxy_GuarddutyFilter) ResetDetectorId() {
	_jsii_.InvokeVoid(
		g,
		"resetDetectorId",
		nil, // no parameters
...
func (g *jsiiProxy_GuarddutyFilter) ResetName() {
	_jsii_.InvokeVoid(
		g,
		"resetName",
		nil, // no parameters
...
func (g *jsiiProxy_GuarddutyFilter) ResetRank() {
	_jsii_.InvokeVoid(
		g,
		"resetRank",
		nil, // no parameters
