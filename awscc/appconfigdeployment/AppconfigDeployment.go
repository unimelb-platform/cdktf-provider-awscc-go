...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/appconfig_deployment awscc_appconfig_deployment}.
type AppconfigDeployment interface {
	...
	DynamicExtensionParameters() AppconfigDeploymentDynamicExtensionParametersList
	DynamicExtensionParametersInput() interface{}
	...
	PutDynamicExtensionParameters(value interface{})
	PutTags(value interface{})
	ResetDescription()
	ResetDynamicExtensionParameters()
...
func (j *jsiiProxy_AppconfigDeployment) DeploymentNumber() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deploymentNumber",
...
func (j *jsiiProxy_AppconfigDeployment) DynamicExtensionParameters() AppconfigDeploymentDynamicExtensionParametersList {
	var returns AppconfigDeploymentDynamicExtensionParametersList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AppconfigDeployment) DynamicExtensionParametersInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"dynamicExtensionParametersInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_AppconfigDeployment) Tags() AppconfigDeploymentTagsList {
	var returns AppconfigDeploymentTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/appconfig_deployment awscc_appconfig_deployment} Resource.
...
func (a *jsiiProxy_AppconfigDeployment) PutDynamicExtensionParameters(value interface{}) {
	if err := a.validatePutDynamicExtensionParametersParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
		"putDynamicExtensionParameters",
		[]interface{}{value},
	)
}

func (a *jsiiProxy_AppconfigDeployment) PutTags(value interface{}) {
...
func (a *jsiiProxy_AppconfigDeployment) ResetDynamicExtensionParameters() {
	_jsii_.InvokeVoid(
		a,
		"resetDynamicExtensionParameters",
		nil, // no parameters
