...
func (j *jsiiProxy_IvschatLoggingConfigurationDestinationConfigurationFirehoseOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_IvschatLoggingConfigurationDestinationConfigurationFirehoseOutputReference)SetInternalValue(val interface{}) {
...
func (i *jsiiProxy_IvschatLoggingConfigurationDestinationConfigurationFirehoseOutputReference) ResetDeliveryStreamName() {
	_jsii_.InvokeVoid(
		i,
		"resetDeliveryStreamName",
		nil, // no parameters
