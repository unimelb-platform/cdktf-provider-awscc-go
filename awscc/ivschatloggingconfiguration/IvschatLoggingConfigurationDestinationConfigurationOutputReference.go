...
func (j *jsiiProxy_IvschatLoggingConfigurationDestinationConfigurationOutputReference) CloudwatchLogsInput() interface{} {
...
func (j *jsiiProxy_IvschatLoggingConfigurationDestinationConfigurationOutputReference) FirehoseInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"firehoseInput",
...
func (j *jsiiProxy_IvschatLoggingConfigurationDestinationConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_IvschatLoggingConfigurationDestinationConfigurationOutputReference) S3Input() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"s3Input",
...
func NewIvschatLoggingConfigurationDestinationConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) IvschatLoggingConfigurationDestinationConfigurationOutputReference {
	...
	_jsii_.Create(
		"awscc.ivschatLoggingConfiguration.IvschatLoggingConfigurationDestinationConfigurationOutputReference",
...
func (j *jsiiProxy_IvschatLoggingConfigurationDestinationConfigurationOutputReference)SetInternalValue(val interface{}) {
