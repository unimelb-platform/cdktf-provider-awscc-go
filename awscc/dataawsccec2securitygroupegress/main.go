...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2SecurityGroupEgress)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "securityGroupEgressId", GoGetter: "SecurityGroupEgressId"},
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccEc2SecurityGroupEgress.DataAwsccEc2SecurityGroupEgressConfig",
		reflect.TypeOf((*DataAwsccEc2SecurityGroupEgressConfig)(nil)).Elem(),
	)
}
