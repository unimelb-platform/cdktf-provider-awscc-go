...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*B2BiProfile)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.b2BiProfile.B2BiProfileConfig",
		reflect.TypeOf((*B2BiProfileConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.b2BiProfile.B2BiProfileTags",
		reflect.TypeOf((*B2BiProfileTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.b2BiProfile.B2BiProfileTagsList",
		reflect.TypeOf((*B2BiProfileTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*B2BiProfileTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
