...
func (j *jsiiProxy_GameliftFleetResourceCreationLimitPolicyOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_GameliftFleetResourceCreationLimitPolicyOutputReference)SetInternalValue(val interface{}) {
