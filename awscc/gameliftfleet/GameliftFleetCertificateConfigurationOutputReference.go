...
func (j *jsiiProxy_GameliftFleetCertificateConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_GameliftFleetCertificateConfigurationOutputReference)SetInternalValue(val interface{}) {
