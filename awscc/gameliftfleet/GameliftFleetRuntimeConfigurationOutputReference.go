...
type GameliftFleetRuntimeConfigurationOutputReference interface {
	...
	ServerProcesses() GameliftFleetRuntimeConfigurationServerProcessesList
	ServerProcessesInput() interface{}
	// Experimental.
	...
	PutServerProcesses(value interface{})
...
func (j *jsiiProxy_GameliftFleetRuntimeConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_GameliftFleetRuntimeConfigurationOutputReference) ServerProcesses() GameliftFleetRuntimeConfigurationServerProcessesList {
	var returns GameliftFleetRuntimeConfigurationServerProcessesList
	_jsii_.Get(
		j,
		"serverProcesses",
		&returns,
...
func (j *jsiiProxy_GameliftFleetRuntimeConfigurationOutputReference) ServerProcessesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"serverProcessesInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_GameliftFleetRuntimeConfigurationOutputReference)SetInternalValue(val interface{}) {
...
func (g *jsiiProxy_GameliftFleetRuntimeConfigurationOutputReference) PutServerProcesses(value interface{}) {
	if err := g.validatePutServerProcessesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		g,
...
func (g *jsiiProxy_GameliftFleetRuntimeConfigurationOutputReference) ResetServerProcesses() {
	_jsii_.InvokeVoid(
		g,
		"resetServerProcesses",
		nil, // no parameters
