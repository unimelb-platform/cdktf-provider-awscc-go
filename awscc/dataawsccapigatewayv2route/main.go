...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccApigatewayv2Route)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccApigatewayv2Route.DataAwsccApigatewayv2RouteConfig",
		reflect.TypeOf((*DataAwsccApigatewayv2RouteConfig)(nil)).Elem(),
	)
}
