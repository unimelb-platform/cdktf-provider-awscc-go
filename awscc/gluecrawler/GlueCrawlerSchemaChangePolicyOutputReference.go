...
func (j *jsiiProxy_GlueCrawlerSchemaChangePolicyOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewGlueCrawlerSchemaChangePolicyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GlueCrawlerSchemaChangePolicyOutputReference {
	...
	_jsii_.Create(
		"awscc.glueCrawler.GlueCrawlerSchemaChangePolicyOutputReference",
...
func (j *jsiiProxy_GlueCrawlerSchemaChangePolicyOutputReference)SetInternalValue(val interface{}) {
