...
func (g *jsiiProxy_GlueCrawler) validatePutScheduleParameters(value *GlueCrawlerSchedule) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (g *jsiiProxy_GlueCrawler) validatePutTargetsParameters(value *GlueCrawlerTargets) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (j *jsiiProxy_GlueCrawler) validateSetCrawlerSecurityConfigurationParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_GlueCrawler) validateSetTagsParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
