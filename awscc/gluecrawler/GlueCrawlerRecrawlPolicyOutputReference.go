...
func (j *jsiiProxy_GlueCrawlerRecrawlPolicyOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewGlueCrawlerRecrawlPolicyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GlueCrawlerRecrawlPolicyOutputReference {
	...
	_jsii_.Create(
		"awscc.glueCrawler.GlueCrawlerRecrawlPolicyOutputReference",
...
func (j *jsiiProxy_GlueCrawlerRecrawlPolicyOutputReference)SetInternalValue(val interface{}) {
