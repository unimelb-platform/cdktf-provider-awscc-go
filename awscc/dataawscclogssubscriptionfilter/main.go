...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccLogsSubscriptionFilter)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccLogsSubscriptionFilter{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformDataSource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccLogsSubscriptionFilter.DataAwsccLogsSubscriptionFilterConfig",
		reflect.TypeOf((*DataAwsccLogsSubscriptionFilterConfig)(nil)).Elem(),
	)
}
