...
func (j *jsiiProxy_QuicksightThemeVersionErrorsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewQuicksightThemeVersionErrorsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) QuicksightThemeVersionErrorsList {
	_init_.Initialize()
...
func NewQuicksightThemeVersionErrorsList_Override(q QuicksightThemeVersionErrorsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightThemeVersionErrorsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightThemeVersionErrorsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (q *jsiiProxy_QuicksightThemeVersionErrorsList) Resolve(_context cdktf.IResolveContext) interface{} {
