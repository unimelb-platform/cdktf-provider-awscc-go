...
func (j *jsiiProxy_QuicksightThemeConfigurationSheetTileLayoutMarginOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_QuicksightThemeConfigurationSheetTileLayoutMarginOutputReference)SetInternalValue(val interface{}) {
