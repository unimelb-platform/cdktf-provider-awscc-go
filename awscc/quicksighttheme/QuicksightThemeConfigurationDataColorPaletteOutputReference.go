...
func (j *jsiiProxy_QuicksightThemeConfigurationDataColorPaletteOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_QuicksightThemeConfigurationDataColorPaletteOutputReference)SetInternalValue(val interface{}) {
