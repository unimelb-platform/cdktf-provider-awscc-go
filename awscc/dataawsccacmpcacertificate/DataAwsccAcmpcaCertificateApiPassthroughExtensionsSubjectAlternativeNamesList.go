...
func (d *jsiiProxy_DataAwsccAcmpcaCertificateApiPassthroughExtensionsSubjectAlternativeNamesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
