...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/panorama_package_version awscc_panorama_package_version}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/panorama_package_version awscc_panorama_package_version} Resource.
...
func (p *jsiiProxy_PanoramaPackageVersion) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PanoramaPackageVersion) MoveFromId(id *string) {
...
func (p *jsiiProxy_PanoramaPackageVersion) MoveToId(id *string) {
...
func (p *jsiiProxy_PanoramaPackageVersion) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PanoramaPackageVersion) ToHclTerraform() interface{} {
	var returns interface{}
