...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeMatchPathsThroughResourcesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
