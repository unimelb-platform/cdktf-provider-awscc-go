...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsOutputReference) validatePutDestinationParameters(value *Ec2NetworkInsightsAccessScopeExcludePathsDestination) error {
	if value == nil {
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsOutputReference) validatePutSourceParameters(value *Ec2NetworkInsightsAccessScopeExcludePathsSource) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsOutputReference) validatePutThroughResourcesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*Ec2NetworkInsightsAccessScopeExcludePathsThroughResources; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *Ec2NetworkInsightsAccessScopeExcludePaths; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewEc2NetworkInsightsAccessScopeExcludePathsOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
