...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putVpcConfigs", GoMethod: "PutVpcConfigs"},
			...
			_jsii_.MemberProperty{JsiiProperty: "vpcConfigsInput", GoGetter: "VpcConfigsInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		"awscc.mskServerlessCluster.MskServerlessClusterClientAuthentication",
	...
	_jsii_.RegisterStruct(
		"awscc.mskServerlessCluster.MskServerlessClusterClientAuthenticationSasl",
		reflect.TypeOf((*MskServerlessClusterClientAuthenticationSasl)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.mskServerlessCluster.MskServerlessClusterClientAuthenticationSaslIam",
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MskServerlessClusterVpcConfigsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
		...
		func() interface{} {
			j := jsiiProxy_MskServerlessClusterVpcConfigsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
