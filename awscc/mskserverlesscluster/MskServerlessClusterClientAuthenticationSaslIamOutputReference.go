...
func (j *jsiiProxy_MskServerlessClusterClientAuthenticationSaslIamOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_MskServerlessClusterClientAuthenticationSaslIamOutputReference)SetInternalValue(val interface{}) {
