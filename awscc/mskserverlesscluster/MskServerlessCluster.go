...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/msk_serverless_cluster awscc_msk_serverless_cluster}.
type MskServerlessCluster interface {
	...
	VpcConfigs() MskServerlessClusterVpcConfigsList
	VpcConfigsInput() interface{}
...
func (j *jsiiProxy_MskServerlessCluster) ClientAuthenticationInput() interface{} {
...
func (j *jsiiProxy_MskServerlessCluster) VpcConfigs() MskServerlessClusterVpcConfigsList {
	var returns MskServerlessClusterVpcConfigsList
	_jsii_.Get(
		j,
		"vpcConfigs",
		&returns,
...
func (j *jsiiProxy_MskServerlessCluster) VpcConfigsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"vpcConfigsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/msk_serverless_cluster awscc_msk_serverless_cluster} Resource.
func NewMskServerlessCluster(scope constructs.Construct, id *string, config *MskServerlessClusterConfig) MskServerlessCluster {
	...
	_jsii_.Create(
		"awscc.mskServerlessCluster.MskServerlessCluster",
...
func (m *jsiiProxy_MskServerlessCluster) PutVpcConfigs(value interface{}) {
	if err := m.validatePutVpcConfigsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		m,
