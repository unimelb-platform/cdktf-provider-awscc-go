...
func (j *jsiiProxy_MskServerlessClusterClientAuthenticationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_MskServerlessClusterClientAuthenticationOutputReference) SaslInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"saslInput",
...
func (j *jsiiProxy_MskServerlessClusterClientAuthenticationOutputReference)SetInternalValue(val interface{}) {
