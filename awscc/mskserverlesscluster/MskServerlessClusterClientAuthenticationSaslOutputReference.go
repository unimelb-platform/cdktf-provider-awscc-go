...
func (j *jsiiProxy_MskServerlessClusterClientAuthenticationSaslOutputReference) IamInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"iamInput",
...
func (j *jsiiProxy_MskServerlessClusterClientAuthenticationSaslOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_MskServerlessClusterClientAuthenticationSaslOutputReference)SetInternalValue(val interface{}) {
