...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.iamGroup.IamGroupConfig",
		reflect.TypeOf((*IamGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.iamGroup.IamGroupPolicies",
		reflect.TypeOf((*IamGroupPolicies)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.iamGroup.IamGroupPoliciesList",
		reflect.TypeOf((*IamGroupPoliciesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IamGroupPoliciesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
