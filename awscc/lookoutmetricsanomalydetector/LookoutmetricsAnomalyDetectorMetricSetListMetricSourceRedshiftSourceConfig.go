...
type LookoutmetricsAnomalyDetectorMetricSetListMetricSourceRedshiftSourceConfig struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/lookoutmetrics_anomaly_detector#cluster_identifier LookoutmetricsAnomalyDetector#cluster_identifier}.
	...
	VpcConfiguration *LookoutmetricsAnomalyDetectorMetricSetListMetricSourceRedshiftSourceConfigVpcConfiguration `field:"required" json:"vpcConfiguration" yaml:"vpcConfiguration"`
}
