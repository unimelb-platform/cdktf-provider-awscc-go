...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lookoutmetrics_anomaly_detector awscc_lookoutmetrics_anomaly_detector}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lookoutmetrics_anomaly_detector awscc_lookoutmetrics_anomaly_detector} Resource.
...
func (l *jsiiProxy_LookoutmetricsAnomalyDetector) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LookoutmetricsAnomalyDetector) MoveFromId(id *string) {
...
func (l *jsiiProxy_LookoutmetricsAnomalyDetector) MoveToId(id *string) {
...
func (l *jsiiProxy_LookoutmetricsAnomalyDetector) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LookoutmetricsAnomalyDetector) ToHclTerraform() interface{} {
	var returns interface{}
