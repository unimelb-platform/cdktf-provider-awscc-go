...
func (j *jsiiProxy_EksNodegroupScalingConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EksNodegroupScalingConfigOutputReference)SetInternalValue(val interface{}) {
...
func (e *jsiiProxy_EksNodegroupScalingConfigOutputReference) ResetDesiredSize() {
	_jsii_.InvokeVoid(
		e,
		"resetDesiredSize",
		nil, // no parameters
...
func (e *jsiiProxy_EksNodegroupScalingConfigOutputReference) ResetMaxSize() {
	_jsii_.InvokeVoid(
		e,
		"resetMaxSize",
		nil, // no parameters
...
func (e *jsiiProxy_EksNodegroupScalingConfigOutputReference) ResetMinSize() {
	_jsii_.InvokeVoid(
		e,
		"resetMinSize",
		nil, // no parameters
