...
type EksNodegroupRemoteAccessOutputReference interface {
	...
	SetSourceSecurityGroups(val *[]*string)
	SourceSecurityGroupsInput() *[]*string
	// Experimental.
...
func (j *jsiiProxy_EksNodegroupRemoteAccessOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EksNodegroupRemoteAccessOutputReference) SourceSecurityGroups() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EksNodegroupRemoteAccessOutputReference) SourceSecurityGroupsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"sourceSecurityGroupsInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_EksNodegroupRemoteAccessOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_EksNodegroupRemoteAccessOutputReference)SetSourceSecurityGroups(val *[]*string) {
	if err := j.validateSetSourceSecurityGroupsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (e *jsiiProxy_EksNodegroupRemoteAccessOutputReference) ResetSourceSecurityGroups() {
	_jsii_.InvokeVoid(
		e,
		"resetSourceSecurityGroups",
		nil, // no parameters
