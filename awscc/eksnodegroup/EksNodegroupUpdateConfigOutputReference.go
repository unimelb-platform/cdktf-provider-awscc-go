...
func (j *jsiiProxy_EksNodegroupUpdateConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EksNodegroupUpdateConfigOutputReference)SetInternalValue(val interface{}) {
