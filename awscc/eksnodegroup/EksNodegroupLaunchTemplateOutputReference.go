...
func (j *jsiiProxy_EksNodegroupLaunchTemplateOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EksNodegroupLaunchTemplateOutputReference)SetInternalValue(val interface{}) {
...
func (e *jsiiProxy_EksNodegroupLaunchTemplateOutputReference) ResetVersion() {
	_jsii_.InvokeVoid(
		e,
		"resetVersion",
		nil, // no parameters
