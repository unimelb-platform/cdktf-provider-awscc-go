...
func (j *jsiiProxy_ConnectRoutingProfileQueueConfigsOutputReference) QueueReference() ConnectRoutingProfileQueueConfigsQueueReferenceOutputReference {
	var returns ConnectRoutingProfileQueueConfigsQueueReferenceOutputReference
	_jsii_.Get(
		j,
		"queueReference",
		&returns,
...
func (c *jsiiProxy_ConnectRoutingProfileQueueConfigsOutputReference) PutQueueReference(value *ConnectRoutingProfileQueueConfigsQueueReference) {
	if err := c.validatePutQueueReferenceParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
