...
func init() {
	_jsii_.RegisterClass(
		"awscc.datazoneEnvironmentActions.DatazoneEnvironmentActions",
		reflect.TypeOf((*DatazoneEnvironmentActions)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DatazoneEnvironmentActions{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.datazoneEnvironmentActions.DatazoneEnvironmentActionsConfig",
		reflect.TypeOf((*DatazoneEnvironmentActionsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.datazoneEnvironmentActions.DatazoneEnvironmentActionsParameters",
		reflect.TypeOf((*DatazoneEnvironmentActionsParameters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.datazoneEnvironmentActions.DatazoneEnvironmentActionsParametersOutputReference",
		reflect.TypeOf((*DatazoneEnvironmentActionsParametersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
