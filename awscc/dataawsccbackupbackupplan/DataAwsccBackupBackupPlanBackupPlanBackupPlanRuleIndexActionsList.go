...
func (j *jsiiProxy_DataAwsccBackupBackupPlanBackupPlanBackupPlanRuleIndexActionsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsccBackupBackupPlanBackupPlanBackupPlanRuleIndexActionsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccBackupBackupPlanBackupPlanBackupPlanRuleIndexActionsList {
	_init_.Initialize()
...
func NewDataAwsccBackupBackupPlanBackupPlanBackupPlanRuleIndexActionsList_Override(d DataAwsccBackupBackupPlanBackupPlanBackupPlanRuleIndexActionsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccBackupBackupPlanBackupPlanBackupPlanRuleIndexActionsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccBackupBackupPlanBackupPlanBackupPlanRuleIndexActionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccBackupBackupPlanBackupPlanBackupPlanRuleIndexActionsList) Resolve(_context cdktf.IResolveContext) interface{} {
