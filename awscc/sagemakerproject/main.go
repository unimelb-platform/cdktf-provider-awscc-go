...
func init() {
	_jsii_.RegisterClass(
		"awscc.sagemakerProject.SagemakerProject",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putServiceCatalogProvisionedProductDetails", GoMethod: "PutServiceCatalogProvisionedProductDetails"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetServiceCatalogProvisionedProductDetails", GoMethod: "ResetServiceCatalogProvisionedProductDetails"},
			...
			_jsii_.MemberProperty{JsiiProperty: "serviceCatalogProvisionedProductDetailsInput", GoGetter: "ServiceCatalogProvisionedProductDetailsInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SagemakerProjectServiceCatalogProvisionedProductDetails)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.sagemakerProject.SagemakerProjectServiceCatalogProvisionedProductDetailsOutputReference",
		reflect.TypeOf((*SagemakerProjectServiceCatalogProvisionedProductDetailsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "provisionedProductIdInput", GoGetter: "ProvisionedProductIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "provisionedProductStatusMessage", GoGetter: "ProvisionedProductStatusMessage"},
			_jsii_.MemberProperty{JsiiProperty: "provisionedProductStatusMessageInput", GoGetter: "ProvisionedProductStatusMessageInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetProvisionedProductId", GoMethod: "ResetProvisionedProductId"},
			_jsii_.MemberMethod{JsiiMethod: "resetProvisionedProductStatusMessage", GoMethod: "ResetProvisionedProductStatusMessage"},
	...
	_jsii_.RegisterClass(
		"awscc.sagemakerProject.SagemakerProjectServiceCatalogProvisioningDetailsOutputReference",
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SagemakerProjectServiceCatalogProvisioningDetailsProvisioningParameters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.sagemakerProject.SagemakerProjectServiceCatalogProvisioningDetailsProvisioningParametersList",
		reflect.TypeOf((*SagemakerProjectServiceCatalogProvisioningDetailsProvisioningParametersList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SagemakerProjectServiceCatalogProvisioningDetailsProvisioningParametersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"awscc.sagemakerProject.SagemakerProjectTags",
		reflect.TypeOf((*SagemakerProjectTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.sagemakerProject.SagemakerProjectTagsList",
		reflect.TypeOf((*SagemakerProjectTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
		...
		func() interface{} {
			j := jsiiProxy_SagemakerProjectTagsList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexList)
			return &j
		},
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SagemakerProjectTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
