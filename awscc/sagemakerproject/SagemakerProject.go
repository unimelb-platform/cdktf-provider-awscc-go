...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/sagemaker_project awscc_sagemaker_project}.
type SagemakerProject interface {
	...
	ServiceCatalogProvisionedProductDetails() SagemakerProjectServiceCatalogProvisionedProductDetailsOutputReference
	ServiceCatalogProvisionedProductDetailsInput() interface{}
	ServiceCatalogProvisioningDetails() SagemakerProjectServiceCatalogProvisioningDetailsOutputReference
	ServiceCatalogProvisioningDetailsInput() interface{}
	...
	PutServiceCatalogProvisionedProductDetails(value *SagemakerProjectServiceCatalogProvisionedProductDetails)
...
func (j *jsiiProxy_SagemakerProject) CreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creationTime",
...
func (j *jsiiProxy_SagemakerProject) ProjectArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectArn",
...
func (j *jsiiProxy_SagemakerProject) ProjectStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectStatus",
...
func (j *jsiiProxy_SagemakerProject) ServiceCatalogProvisionedProductDetails() SagemakerProjectServiceCatalogProvisionedProductDetailsOutputReference {
	var returns SagemakerProjectServiceCatalogProvisionedProductDetailsOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerProject) ServiceCatalogProvisionedProductDetailsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"serviceCatalogProvisionedProductDetailsInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_SagemakerProject) ServiceCatalogProvisioningDetailsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerProject) Tags() SagemakerProjectTagsList {
	var returns SagemakerProjectTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_SagemakerProject) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/sagemaker_project awscc_sagemaker_project} Resource.
...
func (s *jsiiProxy_SagemakerProject) PutServiceCatalogProvisionedProductDetails(value *SagemakerProjectServiceCatalogProvisionedProductDetails) {
	if err := s.validatePutServiceCatalogProvisionedProductDetailsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
		"putServiceCatalogProvisionedProductDetails",
		[]interface{}{value},
	)
}
...
func (s *jsiiProxy_SagemakerProject) PutTags(value interface{}) {
...
func (s *jsiiProxy_SagemakerProject) ResetServiceCatalogProvisionedProductDetails() {
	_jsii_.InvokeVoid(
		s,
		"resetServiceCatalogProvisionedProductDetails",
		nil, // no parameters
