...
type VerifiedpermissionsIdentitySourceConfigurationOutputReference interface {
	cdktf.ComplexObject
	CognitoUserPoolConfiguration() VerifiedpermissionsIdentitySourceConfigurationCognitoUserPoolConfigurationOutputReference
...
func (j *jsiiProxy_VerifiedpermissionsIdentitySourceConfigurationOutputReference) CognitoUserPoolConfiguration() VerifiedpermissionsIdentitySourceConfigurationCognitoUserPoolConfigurationOutputReference {
...
func NewVerifiedpermissionsIdentitySourceConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) VerifiedpermissionsIdentitySourceConfigurationOutputReference {
	_init_.Initialize()

	if err := validateNewVerifiedpermissionsIdentitySourceConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewVerifiedpermissionsIdentitySourceConfigurationOutputReference_Override(v VerifiedpermissionsIdentitySourceConfigurationOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (v *jsiiProxy_VerifiedpermissionsIdentitySourceConfigurationOutputReference) PutCognitoUserPoolConfiguration(value *VerifiedpermissionsIdentitySourceConfigurationCognitoUserPoolConfiguration) {
