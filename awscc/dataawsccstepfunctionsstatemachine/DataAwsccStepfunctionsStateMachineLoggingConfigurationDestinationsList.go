...
func (d *jsiiProxy_DataAwsccStepfunctionsStateMachineLoggingConfigurationDestinationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
