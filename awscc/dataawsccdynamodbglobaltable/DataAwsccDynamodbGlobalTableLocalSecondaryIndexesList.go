...
func (j *jsiiProxy_DataAwsccDynamodbGlobalTableLocalSecondaryIndexesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsccDynamodbGlobalTableLocalSecondaryIndexesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccDynamodbGlobalTableLocalSecondaryIndexesList {
	_init_.Initialize()
...
func NewDataAwsccDynamodbGlobalTableLocalSecondaryIndexesList_Override(d DataAwsccDynamodbGlobalTableLocalSecondaryIndexesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccDynamodbGlobalTableLocalSecondaryIndexesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccDynamodbGlobalTableLocalSecondaryIndexesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccDynamodbGlobalTableLocalSecondaryIndexesList) Resolve(_context cdktf.IResolveContext) interface{} {
