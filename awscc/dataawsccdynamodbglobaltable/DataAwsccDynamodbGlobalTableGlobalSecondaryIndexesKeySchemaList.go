...
func (d *jsiiProxy_DataAwsccDynamodbGlobalTableGlobalSecondaryIndexesKeySchemaList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
