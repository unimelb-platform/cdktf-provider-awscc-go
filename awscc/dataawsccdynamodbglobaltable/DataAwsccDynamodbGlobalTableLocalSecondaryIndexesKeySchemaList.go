...
func (d *jsiiProxy_DataAwsccDynamodbGlobalTableLocalSecondaryIndexesKeySchemaList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
