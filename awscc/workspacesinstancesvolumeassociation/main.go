...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WorkspacesinstancesVolumeAssociation)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "disassociateModeInput", GoGetter: "DisassociateModeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDisassociateMode", GoMethod: "ResetDisassociateMode"},
			...
			_jsii_.MemberProperty{JsiiProperty: "workspaceInstanceIdInput", GoGetter: "WorkspaceInstanceIdInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*WorkspacesinstancesVolumeAssociationConfig)(nil)).Elem(),
	)
}
