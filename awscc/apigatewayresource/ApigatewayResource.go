...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/apigatewayresource/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigateway_resource awscc_apigateway_resource}.
...
func (j *jsiiProxy_ApigatewayResource) ResourceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigateway_resource awscc_apigateway_resource} Resource.
func NewApigatewayResource(scope constructs.Construct, id *string, config *ApigatewayResourceConfig) ApigatewayResource {
	...
	_jsii_.Create(
		"awscc.apigatewayResource.ApigatewayResource",
