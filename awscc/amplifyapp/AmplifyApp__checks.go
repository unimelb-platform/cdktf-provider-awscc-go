...
func (a *jsiiProxy_AmplifyApp) validatePutCustomRulesParameters(value interface{}) error {
	...
	case *[]*AmplifyAppCustomRules:
		value := value.(*[]*AmplifyAppCustomRules)
	...
	case []*AmplifyAppCustomRules:
		value_ := value.([]*AmplifyAppCustomRules)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*AmplifyAppCustomRules; received %#v (a %T)", value, value)
		}
	}
...
func (a *jsiiProxy_AmplifyApp) validatePutEnvironmentVariablesParameters(value interface{}) error {
	...
	case *[]*AmplifyAppEnvironmentVariables:
		value := value.(*[]*AmplifyAppEnvironmentVariables)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*AmplifyAppEnvironmentVariables:
		value_ := value.([]*AmplifyAppEnvironmentVariables)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (a *jsiiProxy_AmplifyApp) validatePutTagsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*AmplifyAppTags; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_AmplifyApp) validateSetIamServiceRoleParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
