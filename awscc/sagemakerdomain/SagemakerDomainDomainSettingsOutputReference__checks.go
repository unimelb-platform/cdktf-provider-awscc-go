...
func (j *jsiiProxy_SagemakerDomainDomainSettingsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *SagemakerDomainDomainSettings:
		val := val.(*SagemakerDomainDomainSettings)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case SagemakerDomainDomainSettings:
		val_ := val.(SagemakerDomainDomainSettings)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *SagemakerDomainDomainSettings; received %#v (a %T)", val, val)
		}
	}
