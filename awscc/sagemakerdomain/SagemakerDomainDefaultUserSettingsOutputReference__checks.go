...
func (s *jsiiProxy_SagemakerDomainDefaultUserSettingsOutputReference) validatePutCustomFileSystemConfigsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*SagemakerDomainDefaultUserSettingsCustomFileSystemConfigs:
		value := value.(*[]*SagemakerDomainDefaultUserSettingsCustomFileSystemConfigs)
	...
	case []*SagemakerDomainDefaultUserSettingsCustomFileSystemConfigs:
		value_ := value.([]*SagemakerDomainDefaultUserSettingsCustomFileSystemConfigs)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*SagemakerDomainDefaultUserSettingsCustomFileSystemConfigs; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_SagemakerDomainDefaultUserSettingsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	switch val.(type) {
	case cdktf.IResolvable:
		// ok
	case *SagemakerDomainDefaultUserSettings:
		val := val.(*SagemakerDomainDefaultUserSettings)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case SagemakerDomainDefaultUserSettings:
		val_ := val.(SagemakerDomainDefaultUserSettings)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *SagemakerDomainDefaultUserSettings; received %#v (a %T)", val, val)
		}
	}
