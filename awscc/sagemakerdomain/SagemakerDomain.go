...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/sagemaker_domain awscc_sagemaker_domain}.
type SagemakerDomain interface {
	...
	DefaultSpaceSettingsInput() interface{}
	DefaultUserSettings() SagemakerDomainDefaultUserSettingsOutputReference
	DefaultUserSettingsInput() interface{}
	// Experimental.
	DependsOn() *[]*string
	// Experimental.
...
func (j *jsiiProxy_SagemakerDomain) DefaultSpaceSettingsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerDomain) DefaultUserSettingsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerDomain) DomainArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainArn",
...
func (j *jsiiProxy_SagemakerDomain) DomainId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainId",
...
func (j *jsiiProxy_SagemakerDomain) DomainSettingsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"domainSettingsInput",
...
func (j *jsiiProxy_SagemakerDomain) Tags() SagemakerDomainTagsList {
	var returns SagemakerDomainTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/sagemaker_domain awscc_sagemaker_domain} Resource.
...
func (s *jsiiProxy_SagemakerDomain) PutTags(value interface{}) {
