...
type SagemakerDomainDefaultUserSettingsRSessionAppSettingsOutputReference interface {
	...
	CustomImages() SagemakerDomainDefaultUserSettingsRSessionAppSettingsCustomImagesList
...
func (j *jsiiProxy_SagemakerDomainDefaultUserSettingsRSessionAppSettingsOutputReference) CustomImages() SagemakerDomainDefaultUserSettingsRSessionAppSettingsCustomImagesList {
	var returns SagemakerDomainDefaultUserSettingsRSessionAppSettingsCustomImagesList
	_jsii_.Get(
		j,
		"customImages",
		&returns,
...
func (j *jsiiProxy_SagemakerDomainDefaultUserSettingsRSessionAppSettingsOutputReference) CustomImagesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"customImagesInput",
...
func (j *jsiiProxy_SagemakerDomainDefaultUserSettingsRSessionAppSettingsOutputReference) DefaultResourceSpecInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerDomainDefaultUserSettingsRSessionAppSettingsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerDomainDefaultUserSettingsRSessionAppSettingsOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_SagemakerDomainDefaultUserSettingsRSessionAppSettingsOutputReference) PutCustomImages(value interface{}) {
...
func (s *jsiiProxy_SagemakerDomainDefaultUserSettingsRSessionAppSettingsOutputReference) ResetCustomImages() {
	_jsii_.InvokeVoid(
		s,
		"resetCustomImages",
		nil, // no parameters
