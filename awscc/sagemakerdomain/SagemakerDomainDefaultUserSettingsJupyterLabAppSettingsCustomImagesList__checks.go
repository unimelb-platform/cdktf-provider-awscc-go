...
func (s *jsiiProxy_SagemakerDomainDefaultUserSettingsJupyterLabAppSettingsCustomImagesList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_SagemakerDomainDefaultUserSettingsJupyterLabAppSettingsCustomImagesList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewSagemakerDomainDefaultUserSettingsJupyterLabAppSettingsCustomImagesListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
