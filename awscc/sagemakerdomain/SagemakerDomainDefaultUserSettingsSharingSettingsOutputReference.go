...
func (j *jsiiProxy_SagemakerDomainDefaultUserSettingsSharingSettingsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerDomainDefaultUserSettingsSharingSettingsOutputReference)SetInternalValue(val interface{}) {
