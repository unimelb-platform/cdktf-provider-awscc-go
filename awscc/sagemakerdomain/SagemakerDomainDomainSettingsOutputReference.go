...
type SagemakerDomainDomainSettingsOutputReference interface {
	...
	RStudioServerProDomainSettingsInput() interface{}
...
func (j *jsiiProxy_SagemakerDomainDomainSettingsOutputReference) DockerSettingsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"dockerSettingsInput",
...
func (j *jsiiProxy_SagemakerDomainDomainSettingsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerDomainDomainSettingsOutputReference) RStudioServerProDomainSettingsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerDomainDomainSettingsOutputReference)SetInternalValue(val interface{}) {
