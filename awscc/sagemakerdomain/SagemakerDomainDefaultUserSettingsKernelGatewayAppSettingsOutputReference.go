...
type SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsOutputReference interface {
	...
	CustomImages() SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsCustomImagesList
...
func (j *jsiiProxy_SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsOutputReference) CustomImages() SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsCustomImagesList {
	var returns SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsCustomImagesList
	_jsii_.Get(
		j,
		"customImages",
		&returns,
...
func (j *jsiiProxy_SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsOutputReference) CustomImagesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"customImagesInput",
...
func (j *jsiiProxy_SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsOutputReference) DefaultResourceSpecInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsOutputReference) PutCustomImages(value interface{}) {
...
func (s *jsiiProxy_SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsOutputReference) ResetCustomImages() {
	_jsii_.InvokeVoid(
		s,
		"resetCustomImages",
		nil, // no parameters
