...
func (j *jsiiProxy_ConnectUserPhoneConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ConnectUserPhoneConfigOutputReference)SetInternalValue(val interface{}) {
