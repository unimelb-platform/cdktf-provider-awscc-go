...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDatazoneProjectMembership)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccDatazoneProjectMembershipConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccDatazoneProjectMembership.DataAwsccDatazoneProjectMembershipMember",
		reflect.TypeOf((*DataAwsccDatazoneProjectMembershipMember)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccDatazoneProjectMembership.DataAwsccDatazoneProjectMembershipMemberOutputReference",
		reflect.TypeOf((*DataAwsccDatazoneProjectMembershipMemberOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
