...
func (t *jsiiProxy_TransferWorkflowStepsTagStepDetailsTagsOutputReference) ResetKey() {
	_jsii_.InvokeVoid(
		t,
		"resetKey",
		nil, // no parameters
...
func (t *jsiiProxy_TransferWorkflowStepsTagStepDetailsTagsOutputReference) ResetValue() {
	_jsii_.InvokeVoid(
		t,
		"resetValue",
		nil, // no parameters
