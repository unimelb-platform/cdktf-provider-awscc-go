...
func (j *jsiiProxy_TransferWorkflowOnExceptionStepsDeleteStepDetailsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_TransferWorkflowOnExceptionStepsDeleteStepDetailsOutputReference)SetInternalValue(val interface{}) {
