...
type TransferWorkflowOnExceptionStepsDecryptStepDetailsOutputReference interface {
	...
	DestinationFileLocationInput() interface{}
	// Experimental.
	Fqn() *string
...
func (j *jsiiProxy_TransferWorkflowOnExceptionStepsDecryptStepDetailsOutputReference) DestinationFileLocationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TransferWorkflowOnExceptionStepsDecryptStepDetailsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_TransferWorkflowOnExceptionStepsDecryptStepDetailsOutputReference)SetInternalValue(val interface{}) {
...
func (t *jsiiProxy_TransferWorkflowOnExceptionStepsDecryptStepDetailsOutputReference) ResetType() {
	_jsii_.InvokeVoid(
		t,
		"resetType",
		nil, // no parameters
