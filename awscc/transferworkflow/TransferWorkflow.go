...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/transfer_workflow awscc_transfer_workflow}.
...
func (j *jsiiProxy_TransferWorkflow) Tags() TransferWorkflowTagsList {
	var returns TransferWorkflowTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_TransferWorkflow) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_TransferWorkflow) WorkflowId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"workflowId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/transfer_workflow awscc_transfer_workflow} Resource.
...
func (t *jsiiProxy_TransferWorkflow) PutTags(value interface{}) {
