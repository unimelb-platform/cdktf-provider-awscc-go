...
func (j *jsiiProxy_TransferWorkflowOnExceptionStepsTagStepDetailsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_TransferWorkflowOnExceptionStepsTagStepDetailsOutputReference)SetInternalValue(val interface{}) {
