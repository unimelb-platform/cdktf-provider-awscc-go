...
func (j *jsiiProxy_TransferWorkflowOnExceptionStepsCustomStepDetailsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_TransferWorkflowOnExceptionStepsCustomStepDetailsOutputReference)SetInternalValue(val interface{}) {
