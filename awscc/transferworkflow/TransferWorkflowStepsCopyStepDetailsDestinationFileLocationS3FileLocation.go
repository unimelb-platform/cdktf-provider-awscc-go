...
type TransferWorkflowStepsCopyStepDetailsDestinationFileLocationS3FileLocation struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/transfer_workflow#bucket TransferWorkflow#bucket}
