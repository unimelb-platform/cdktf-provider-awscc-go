...
func (j *jsiiProxy_TransferWorkflowOnExceptionStepsCopyStepDetailsOutputReference) DestinationFileLocationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TransferWorkflowOnExceptionStepsCopyStepDetailsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_TransferWorkflowOnExceptionStepsCopyStepDetailsOutputReference)SetInternalValue(val interface{}) {
