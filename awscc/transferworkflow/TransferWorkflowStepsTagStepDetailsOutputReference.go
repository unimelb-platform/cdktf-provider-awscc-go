...
func (j *jsiiProxy_TransferWorkflowStepsTagStepDetailsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_TransferWorkflowStepsTagStepDetailsOutputReference)SetInternalValue(val interface{}) {
