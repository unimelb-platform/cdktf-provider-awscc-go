...
func (j *jsiiProxy_TransferWorkflowStepsCustomStepDetailsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_TransferWorkflowStepsCustomStepDetailsOutputReference)SetInternalValue(val interface{}) {
