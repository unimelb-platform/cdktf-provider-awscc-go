...
func (j *jsiiProxy_TransferWorkflowStepsOutputReference) CopyStepDetailsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TransferWorkflowStepsOutputReference) CustomStepDetailsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TransferWorkflowStepsOutputReference) DecryptStepDetailsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TransferWorkflowStepsOutputReference) DeleteStepDetailsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TransferWorkflowStepsOutputReference) TagStepDetailsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagStepDetailsInput",
...
func (t *jsiiProxy_TransferWorkflowStepsOutputReference) ResetType() {
	_jsii_.InvokeVoid(
		t,
		"resetType",
		nil, // no parameters
