...
func (j *jsiiProxy_TransferWorkflowStepsDecryptStepDetailsOutputReference) DestinationFileLocationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TransferWorkflowStepsDecryptStepDetailsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_TransferWorkflowStepsDecryptStepDetailsOutputReference)SetInternalValue(val interface{}) {
...
func (t *jsiiProxy_TransferWorkflowStepsDecryptStepDetailsOutputReference) ResetType() {
	_jsii_.InvokeVoid(
		t,
		"resetType",
		nil, // no parameters
