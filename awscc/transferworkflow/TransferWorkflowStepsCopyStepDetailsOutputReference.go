...
func (j *jsiiProxy_TransferWorkflowStepsCopyStepDetailsOutputReference) DestinationFileLocationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TransferWorkflowStepsCopyStepDetailsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_TransferWorkflowStepsCopyStepDetailsOutputReference)SetInternalValue(val interface{}) {
