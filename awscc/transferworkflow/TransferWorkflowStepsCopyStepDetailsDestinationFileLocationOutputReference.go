...
func (j *jsiiProxy_TransferWorkflowStepsCopyStepDetailsDestinationFileLocationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_TransferWorkflowStepsCopyStepDetailsDestinationFileLocationOutputReference) S3FileLocationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"s3FileLocationInput",
...
func (j *jsiiProxy_TransferWorkflowStepsCopyStepDetailsDestinationFileLocationOutputReference)SetInternalValue(val interface{}) {
