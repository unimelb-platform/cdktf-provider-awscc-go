...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/connect_contact_flow_module awscc_connect_contact_flow_module}.
...
func (j *jsiiProxy_ConnectContactFlowModule) ContactFlowModuleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ConnectContactFlowModule) InstanceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceArn",
...
func (j *jsiiProxy_ConnectContactFlowModule) InstanceArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceArnInput",
...
func (j *jsiiProxy_ConnectContactFlowModule) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_ConnectContactFlowModule) StateInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stateInput",
...
func (j *jsiiProxy_ConnectContactFlowModule) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_ConnectContactFlowModule) Tags() ConnectContactFlowModuleTagsList {
	var returns ConnectContactFlowModuleTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_ConnectContactFlowModule) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/connect_contact_flow_module awscc_connect_contact_flow_module} Resource.
func NewConnectContactFlowModule(scope constructs.Construct, id *string, config *ConnectContactFlowModuleConfig) ConnectContactFlowModule {
	...
	_jsii_.Create(
		"awscc.connectContactFlowModule.ConnectContactFlowModule",
...
func (j *jsiiProxy_ConnectContactFlowModule)SetInstanceArn(val *string) {
...
func (j *jsiiProxy_ConnectContactFlowModule)SetState(val *string) {
...
func (c *jsiiProxy_ConnectContactFlowModule) PutTags(value interface{}) {
...
func (c *jsiiProxy_ConnectContactFlowModule) ResetState() {
	_jsii_.InvokeVoid(
		c,
		"resetState",
		nil, // no parameters
