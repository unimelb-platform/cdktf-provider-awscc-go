...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.connectContactFlowModule.ConnectContactFlowModuleConfig",
		reflect.TypeOf((*ConnectContactFlowModuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.connectContactFlowModule.ConnectContactFlowModuleTags",
		reflect.TypeOf((*ConnectContactFlowModuleTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.connectContactFlowModule.ConnectContactFlowModuleTagsList",
		reflect.TypeOf((*ConnectContactFlowModuleTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ConnectContactFlowModuleTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
