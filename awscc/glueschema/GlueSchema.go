...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/glue_schema awscc_glue_schema}.
type GlueSchema interface {
	cdktf.TerraformResource
	Arn() *string
	// Experimental.
	CdktfStack() cdktf.TerraformStack
	CheckpointVersion() GlueSchemaCheckpointVersionOutputReference
	CheckpointVersionInput() interface{}
	...
	PutCheckpointVersion(value *GlueSchemaCheckpointVersion)
	PutRegistry(value *GlueSchemaRegistry)
...
func (j *jsiiProxy_GlueSchema) CheckpointVersion() GlueSchemaCheckpointVersionOutputReference {
	var returns GlueSchemaCheckpointVersionOutputReference
	_jsii_.Get(
		j,
		"checkpointVersion",
		&returns,
...
func (j *jsiiProxy_GlueSchema) CheckpointVersionInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"checkpointVersionInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_GlueSchema) InitialSchemaVersionId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueSchema) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GlueSchema) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_GlueSchema) Registry() GlueSchemaRegistryOutputReference {
	var returns GlueSchemaRegistryOutputReference
	_jsii_.Get(
		j,
		"registry",
		&returns,
...
func (j *jsiiProxy_GlueSchema) RegistryInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"registryInput",
...
func (j *jsiiProxy_GlueSchema) Tags() GlueSchemaTagsList {
	var returns GlueSchemaTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/glue_schema awscc_glue_schema} Resource.
...
func (j *jsiiProxy_GlueSchema)SetName(val *string) {
...
func (g *jsiiProxy_GlueSchema) PutCheckpointVersion(value *GlueSchemaCheckpointVersion) {
	if err := g.validatePutCheckpointVersionParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		g,
		"putCheckpointVersion",
		[]interface{}{value},
	)
}

func (g *jsiiProxy_GlueSchema) PutRegistry(value *GlueSchemaRegistry) {
	if err := g.validatePutRegistryParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		g,
...
func (g *jsiiProxy_GlueSchema) PutTags(value interface{}) {
...
func (g *jsiiProxy_GlueSchema) ResetCheckpointVersion() {
	_jsii_.InvokeVoid(
		g,
		"resetCheckpointVersion",
		nil, // no parameters
...
func (g *jsiiProxy_GlueSchema) ResetRegistry() {
	_jsii_.InvokeVoid(
		g,
		"resetRegistry",
		nil, // no parameters
...
func (g *jsiiProxy_GlueSchema) ResetSchemaDefinition() {
	_jsii_.InvokeVoid(
		g,
		"resetSchemaDefinition",
		nil, // no parameters
