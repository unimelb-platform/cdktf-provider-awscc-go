...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSagemakerImageVersion)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "imageVersionArn", GoGetter: "ImageVersionArn"},
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccSagemakerImageVersion.DataAwsccSagemakerImageVersionConfig",
		reflect.TypeOf((*DataAwsccSagemakerImageVersionConfig)(nil)).Elem(),
	)
}
