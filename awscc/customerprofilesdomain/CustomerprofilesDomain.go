...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/customerprofiles_domain awscc_customerprofiles_domain}.
...
func (j *jsiiProxy_CustomerprofilesDomain) CreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdAt",
...
func (j *jsiiProxy_CustomerprofilesDomain) LastUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lastUpdatedAt",
...
func (j *jsiiProxy_CustomerprofilesDomain) Tags() CustomerprofilesDomainTagsList {
	var returns CustomerprofilesDomainTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_CustomerprofilesDomain) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/customerprofiles_domain awscc_customerprofiles_domain} Resource.
func NewCustomerprofilesDomain(scope constructs.Construct, id *string, config *CustomerprofilesDomainConfig) CustomerprofilesDomain {
	...
	_jsii_.Create(
		"awscc.customerprofilesDomain.CustomerprofilesDomain",
...
func (c *jsiiProxy_CustomerprofilesDomain) PutTags(value interface{}) {
...
func (c *jsiiProxy_CustomerprofilesDomain) ResetDefaultExpirationDays() {
	_jsii_.InvokeVoid(
		c,
		"resetDefaultExpirationDays",
		nil, // no parameters
