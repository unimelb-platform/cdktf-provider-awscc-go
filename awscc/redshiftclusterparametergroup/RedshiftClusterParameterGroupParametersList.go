...
func (j *jsiiProxy_RedshiftClusterParameterGroupParametersList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewRedshiftClusterParameterGroupParametersList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RedshiftClusterParameterGroupParametersList {
	_init_.Initialize()
...
func NewRedshiftClusterParameterGroupParametersList_Override(r RedshiftClusterParameterGroupParametersList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_RedshiftClusterParameterGroupParametersList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (r *jsiiProxy_RedshiftClusterParameterGroupParametersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RedshiftClusterParameterGroupParametersList) Resolve(_context cdktf.IResolveContext) interface{} {
