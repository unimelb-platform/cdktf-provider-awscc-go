...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LogsSubscriptionFilter)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.logsSubscriptionFilter.LogsSubscriptionFilterConfig",
		reflect.TypeOf((*LogsSubscriptionFilterConfig)(nil)).Elem(),
	)
}
