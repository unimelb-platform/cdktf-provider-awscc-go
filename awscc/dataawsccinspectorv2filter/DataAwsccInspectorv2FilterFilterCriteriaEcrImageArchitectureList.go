...
func (d *jsiiProxy_DataAwsccInspectorv2FilterFilterCriteriaEcrImageArchitectureList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
