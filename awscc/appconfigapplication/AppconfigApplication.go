...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/appconfig_application awscc_appconfig_application}.
...
func (j *jsiiProxy_AppconfigApplication) ApplicationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationId",
...
func (j *jsiiProxy_AppconfigApplication) Tags() AppconfigApplicationTagsList {
	var returns AppconfigApplicationTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/appconfig_application awscc_appconfig_application} Resource.
func NewAppconfigApplication(scope constructs.Construct, id *string, config *AppconfigApplicationConfig) AppconfigApplication {
	...
	_jsii_.Create(
		"awscc.appconfigApplication.AppconfigApplication",
...
func (a *jsiiProxy_AppconfigApplication) PutTags(value interface{}) {
