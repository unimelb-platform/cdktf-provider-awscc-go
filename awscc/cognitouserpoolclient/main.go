...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetClientName", GoMethod: "ResetClientName"},
	...
	_jsii_.RegisterStruct(
		"awscc.cognitoUserPoolClient.CognitoUserPoolClientConfig",
		reflect.TypeOf((*CognitoUserPoolClientConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.cognitoUserPoolClient.CognitoUserPoolClientRefreshTokenRotation",
