...
func NewCognitoUserPoolClientRefreshTokenRotationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CognitoUserPoolClientRefreshTokenRotationOutputReference {
	_init_.Initialize()

	if err := validateNewCognitoUserPoolClientRefreshTokenRotationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewCognitoUserPoolClientRefreshTokenRotationOutputReference_Override(c CognitoUserPoolClientRefreshTokenRotationOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (c *jsiiProxy_CognitoUserPoolClientRefreshTokenRotationOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolClientRefreshTokenRotationOutputReference) ResetFeature() {
	_jsii_.InvokeVoid(
		c,
		"resetFeature",
		nil, // no parameters
...
func (c *jsiiProxy_CognitoUserPoolClientRefreshTokenRotationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
