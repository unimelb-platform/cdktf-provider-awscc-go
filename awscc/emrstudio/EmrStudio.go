...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/emr_studio awscc_emr_studio}.
type EmrStudio interface {
	...
	TrustedIdentityPropagationEnabledInput() interface{}
	Url() *string
	UserRole() *string
	...
	ResetTags()
	ResetTrustedIdentityPropagationEnabled()
	ResetUserRole()
...
func (j *jsiiProxy_EmrStudio) IdcInstanceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idcInstanceArn",
...
func (j *jsiiProxy_EmrStudio) IdcInstanceArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idcInstanceArnInput",
...
func (j *jsiiProxy_EmrStudio) IdcUserAssignment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idcUserAssignment",
...
func (j *jsiiProxy_EmrStudio) IdcUserAssignmentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idcUserAssignmentInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_EmrStudio) StudioId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"studioId",
...
func (j *jsiiProxy_EmrStudio) Tags() EmrStudioTagsList {
	var returns EmrStudioTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_EmrStudio) TrustedIdentityPropagationEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EmrStudio) TrustedIdentityPropagationEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"trustedIdentityPropagationEnabledInput",
		&returns,
	)
	return returns
}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/emr_studio awscc_emr_studio} Resource.
...
func (j *jsiiProxy_EmrStudio)SetIdcInstanceArn(val *string) {
...
func (j *jsiiProxy_EmrStudio)SetIdcUserAssignment(val *string) {
	if err := j.validateSetIdcUserAssignmentParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_EmrStudio)SetTrustedIdentityPropagationEnabled(val interface{}) {
...
func (e *jsiiProxy_EmrStudio) PutTags(value interface{}) {
...
func (e *jsiiProxy_EmrStudio) ResetIdcInstanceArn() {
	_jsii_.InvokeVoid(
		e,
		"resetIdcInstanceArn",
		nil, // no parameters
...
func (e *jsiiProxy_EmrStudio) ResetIdcUserAssignment() {
	_jsii_.InvokeVoid(
		e,
		"resetIdcUserAssignment",
		nil, // no parameters
...
func (e *jsiiProxy_EmrStudio) ResetTrustedIdentityPropagationEnabled() {
	_jsii_.InvokeVoid(
		e,
		"resetTrustedIdentityPropagationEnabled",
		nil, // no parameters
