...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "idcUserAssignmentInput", GoGetter: "IdcUserAssignmentInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIdcUserAssignment", GoMethod: "ResetIdcUserAssignment"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTrustedIdentityPropagationEnabled", GoMethod: "ResetTrustedIdentityPropagationEnabled"},
			...
			_jsii_.MemberProperty{JsiiProperty: "trustedIdentityPropagationEnabledInput", GoGetter: "TrustedIdentityPropagationEnabledInput"},
	...
	_jsii_.RegisterStruct(
		"awscc.emrStudio.EmrStudioConfig",
		reflect.TypeOf((*EmrStudioConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.emrStudio.EmrStudioTags",
		reflect.TypeOf((*EmrStudioTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.emrStudio.EmrStudioTagsList",
		reflect.TypeOf((*EmrStudioTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EmrStudioTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
