...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/quicksightrefreshschedule/internal"
)
...
type QuicksightRefreshScheduleScheduleOutputReference interface {
	...
	ScheduleFrequency() QuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference
	...
	PutScheduleFrequency(value *QuicksightRefreshScheduleScheduleScheduleFrequency)
	ResetRefreshType()
...
func (j *jsiiProxy_QuicksightRefreshScheduleScheduleOutputReference) ScheduleFrequency() QuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference {
...
func (j *jsiiProxy_QuicksightRefreshScheduleScheduleOutputReference) ScheduleId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scheduleId",
...
func (j *jsiiProxy_QuicksightRefreshScheduleScheduleOutputReference) ScheduleIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scheduleIdInput",
...
func NewQuicksightRefreshScheduleScheduleOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) QuicksightRefreshScheduleScheduleOutputReference {
	_init_.Initialize()

	if err := validateNewQuicksightRefreshScheduleScheduleOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_QuicksightRefreshScheduleScheduleOutputReference{}

	_jsii_.Create(
		"awscc.quicksightRefreshSchedule.QuicksightRefreshScheduleScheduleOutputReference",
...
func NewQuicksightRefreshScheduleScheduleOutputReference_Override(q QuicksightRefreshScheduleScheduleOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightRefreshScheduleScheduleOutputReference)SetScheduleId(val *string) {
...
func (q *jsiiProxy_QuicksightRefreshScheduleScheduleOutputReference) PutScheduleFrequency(value *QuicksightRefreshScheduleScheduleScheduleFrequency) {
...
func (q *jsiiProxy_QuicksightRefreshScheduleScheduleOutputReference) ResetRefreshType() {
	_jsii_.InvokeVoid(
		q,
		"resetRefreshType",
		nil, // no parameters
...
func (q *jsiiProxy_QuicksightRefreshScheduleScheduleOutputReference) ResetScheduleId() {
	_jsii_.InvokeVoid(
		q,
		"resetScheduleId",
		nil, // no parameters
