...
type QuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference interface {
	...
	RefreshOnDay() QuicksightRefreshScheduleScheduleScheduleFrequencyRefreshOnDayOutputReference
	...
	PutRefreshOnDay(value *QuicksightRefreshScheduleScheduleScheduleFrequencyRefreshOnDay)
	ResetInterval()
	ResetRefreshOnDay()
	ResetTimeOfTheDay()
	ResetTimeZone()
...
func (j *jsiiProxy_QuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference) RefreshOnDay() QuicksightRefreshScheduleScheduleScheduleFrequencyRefreshOnDayOutputReference {
...
func NewQuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) QuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference {
	_init_.Initialize()

	if err := validateNewQuicksightRefreshScheduleScheduleScheduleFrequencyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_QuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference{}

	_jsii_.Create(
		"awscc.quicksightRefreshSchedule.QuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference",
...
func NewQuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference_Override(q QuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (q *jsiiProxy_QuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference) PutRefreshOnDay(value *QuicksightRefreshScheduleScheduleScheduleFrequencyRefreshOnDay) {
...
func (q *jsiiProxy_QuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference) ResetInterval() {
	_jsii_.InvokeVoid(
		q,
		"resetInterval",
		nil, // no parameters
