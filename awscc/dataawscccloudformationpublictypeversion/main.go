...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCloudformationPublicTypeVersion)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccCloudformationPublicTypeVersion.DataAwsccCloudformationPublicTypeVersionConfig",
		reflect.TypeOf((*DataAwsccCloudformationPublicTypeVersionConfig)(nil)).Elem(),
	)
}
