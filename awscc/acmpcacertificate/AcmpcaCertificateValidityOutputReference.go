...
func (j *jsiiProxy_AcmpcaCertificateValidityOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_AcmpcaCertificateValidityOutputReference) Value() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"value",
...
func (j *jsiiProxy_AcmpcaCertificateValidityOutputReference) ValueInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"valueInput",
...
func (j *jsiiProxy_AcmpcaCertificateValidityOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_AcmpcaCertificateValidityOutputReference)SetValue(val *float64) {
