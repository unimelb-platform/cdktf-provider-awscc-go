...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/acmpca_certificate awscc_acmpca_certificate}.
type AcmpcaCertificate interface {
	cdktf.TerraformResource
	ApiPassthrough() AcmpcaCertificateApiPassthroughOutputReference
	ApiPassthroughInput() interface{}
	Arn() *string
	// Experimental.
	...
	ValidityNotBefore() AcmpcaCertificateValidityNotBeforeOutputReference
	ValidityNotBeforeInput() interface{}
	...
	PutApiPassthrough(value *AcmpcaCertificateApiPassthrough)
	PutValidity(value *AcmpcaCertificateValidity)
	PutValidityNotBefore(value *AcmpcaCertificateValidityNotBefore)
	ResetApiPassthrough()
...
func (j *jsiiProxy_AcmpcaCertificate) ApiPassthrough() AcmpcaCertificateApiPassthroughOutputReference {
	var returns AcmpcaCertificateApiPassthroughOutputReference
	_jsii_.Get(
		j,
		"apiPassthrough",
		&returns,
...
func (j *jsiiProxy_AcmpcaCertificate) ApiPassthroughInput() interface{} {
...
func (j *jsiiProxy_AcmpcaCertificate) ValidityInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"validityInput",
...
func (j *jsiiProxy_AcmpcaCertificate) ValidityNotBefore() AcmpcaCertificateValidityNotBeforeOutputReference {
	var returns AcmpcaCertificateValidityNotBeforeOutputReference
	_jsii_.Get(
		j,
		"validityNotBefore",
		&returns,
...
func (j *jsiiProxy_AcmpcaCertificate) ValidityNotBeforeInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"validityNotBeforeInput",
		&returns,
	)
	return returns
}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/acmpca_certificate awscc_acmpca_certificate} Resource.
...
func (a *jsiiProxy_AcmpcaCertificate) PutApiPassthrough(value *AcmpcaCertificateApiPassthrough) {
	if err := a.validatePutApiPassthroughParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
...
func (a *jsiiProxy_AcmpcaCertificate) PutValidityNotBefore(value *AcmpcaCertificateValidityNotBefore) {
	if err := a.validatePutValidityNotBeforeParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
		"putValidityNotBefore",
		[]interface{}{value},
	)
}
...
func (a *jsiiProxy_AcmpcaCertificate) ResetValidityNotBefore() {
	_jsii_.InvokeVoid(
		a,
		"resetValidityNotBefore",
		nil, // no parameters
