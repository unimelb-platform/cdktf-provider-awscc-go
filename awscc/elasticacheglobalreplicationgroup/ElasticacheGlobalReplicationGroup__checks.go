...
func (e *jsiiProxy_ElasticacheGlobalReplicationGroup) validatePutMembersParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*ElasticacheGlobalReplicationGroupMembers:
		value := value.(*[]*ElasticacheGlobalReplicationGroupMembers)
	...
	case []*ElasticacheGlobalReplicationGroupMembers:
		value_ := value.([]*ElasticacheGlobalReplicationGroupMembers)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ElasticacheGlobalReplicationGroupMembers; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_ElasticacheGlobalReplicationGroup) validatePutRegionalConfigurationsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*ElasticacheGlobalReplicationGroupRegionalConfigurations:
		value := value.(*[]*ElasticacheGlobalReplicationGroupRegionalConfigurations)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*ElasticacheGlobalReplicationGroupRegionalConfigurations:
		value_ := value.([]*ElasticacheGlobalReplicationGroupRegionalConfigurations)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ElasticacheGlobalReplicationGroupRegionalConfigurations; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_ElasticacheGlobalReplicationGroup) validateSetCacheParameterGroupNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_ElasticacheGlobalReplicationGroup) validateSetGlobalNodeGroupCountParameters(val *float64) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
