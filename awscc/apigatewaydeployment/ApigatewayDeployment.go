...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigateway_deployment awscc_apigateway_deployment}.
type ApigatewayDeployment interface {
	...
	DeploymentCanarySettings() ApigatewayDeploymentDeploymentCanarySettingsOutputReference
	DeploymentCanarySettingsInput() interface{}
	DeploymentId() *string
	Description() *string
	...
	StageDescription() ApigatewayDeploymentStageDescriptionOutputReference
	StageDescriptionInput() interface{}
	StageName() *string
	...
	PutDeploymentCanarySettings(value *ApigatewayDeploymentDeploymentCanarySettings)
	PutStageDescription(value *ApigatewayDeploymentStageDescription)
	ResetDeploymentCanarySettings()
	ResetDescription()
...
func (j *jsiiProxy_ApigatewayDeployment) DeploymentCanarySettings() ApigatewayDeploymentDeploymentCanarySettingsOutputReference {
	var returns ApigatewayDeploymentDeploymentCanarySettingsOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApigatewayDeployment) DeploymentCanarySettingsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"deploymentCanarySettingsInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_ApigatewayDeployment) DeploymentId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deploymentId",
...
func (j *jsiiProxy_ApigatewayDeployment) StageDescription() ApigatewayDeploymentStageDescriptionOutputReference {
	var returns ApigatewayDeploymentStageDescriptionOutputReference
	_jsii_.Get(
		j,
		"stageDescription",
		&returns,
...
func (j *jsiiProxy_ApigatewayDeployment) StageDescriptionInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apigateway_deployment awscc_apigateway_deployment} Resource.
...
func (a *jsiiProxy_ApigatewayDeployment) PutDeploymentCanarySettings(value *ApigatewayDeploymentDeploymentCanarySettings) {
	if err := a.validatePutDeploymentCanarySettingsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
		"putDeploymentCanarySettings",
		[]interface{}{value},
	)
}

func (a *jsiiProxy_ApigatewayDeployment) PutStageDescription(value *ApigatewayDeploymentStageDescription) {
	if err := a.validatePutStageDescriptionParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
...
func (a *jsiiProxy_ApigatewayDeployment) ResetDeploymentCanarySettings() {
	_jsii_.InvokeVoid(
		a,
		"resetDeploymentCanarySettings",
		nil, // no parameters
