...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/route53recoveryreadiness_recovery_group awscc_route53recoveryreadiness_recovery_group}.
...
func (j *jsiiProxy_Route53RecoveryreadinessRecoveryGroup) RecoveryGroupArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"recoveryGroupArn",
...
func (j *jsiiProxy_Route53RecoveryreadinessRecoveryGroup) Tags() Route53RecoveryreadinessRecoveryGroupTagsList {
	var returns Route53RecoveryreadinessRecoveryGroupTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/route53recoveryreadiness_recovery_group awscc_route53recoveryreadiness_recovery_group} Resource.
func NewRoute53RecoveryreadinessRecoveryGroup(scope constructs.Construct, id *string, config *Route53RecoveryreadinessRecoveryGroupConfig) Route53RecoveryreadinessRecoveryGroup {
	...
	_jsii_.Create(
		"awscc.route53RecoveryreadinessRecoveryGroup.Route53RecoveryreadinessRecoveryGroup",
...
func (r *jsiiProxy_Route53RecoveryreadinessRecoveryGroup) PutTags(value interface{}) {
...
func (r *jsiiProxy_Route53RecoveryreadinessRecoveryGroup) ResetRecoveryGroupName() {
	_jsii_.InvokeVoid(
		r,
		"resetRecoveryGroupName",
		nil, // no parameters
