...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccLakeformationDataCellsFilters)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccLakeformationDataCellsFilters.DataAwsccLakeformationDataCellsFiltersConfig",
		reflect.TypeOf((*DataAwsccLakeformationDataCellsFiltersConfig)(nil)).Elem(),
	)
}
