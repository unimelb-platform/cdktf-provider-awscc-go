...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.qldbStream.QldbStreamConfig",
		reflect.TypeOf((*QldbStreamConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.qldbStream.QldbStreamKinesisConfiguration",
		reflect.TypeOf((*QldbStreamKinesisConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.qldbStream.QldbStreamKinesisConfigurationOutputReference",
	...
	_jsii_.RegisterStruct(
		"awscc.qldbStream.QldbStreamTags",
		reflect.TypeOf((*QldbStreamTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.qldbStream.QldbStreamTagsList",
		reflect.TypeOf((*QldbStreamTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*QldbStreamTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
