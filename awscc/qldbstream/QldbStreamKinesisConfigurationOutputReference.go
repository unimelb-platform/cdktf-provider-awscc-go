...
func (j *jsiiProxy_QldbStreamKinesisConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_QldbStreamKinesisConfigurationOutputReference)SetInternalValue(val interface{}) {
...
func (q *jsiiProxy_QldbStreamKinesisConfigurationOutputReference) ResetStreamArn() {
	_jsii_.InvokeVoid(
		q,
		"resetStreamArn",
		nil, // no parameters
