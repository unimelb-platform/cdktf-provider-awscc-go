...
type QldbStream interface {
	...
	KinesisConfigurationInput() interface{}
	LedgerName() *string
...
func (j *jsiiProxy_QldbStream) KinesisConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_QldbStream) Tags() QldbStreamTagsList {
	var returns QldbStreamTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_QldbStream) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (q *jsiiProxy_QldbStream) PutTags(value interface{}) {
