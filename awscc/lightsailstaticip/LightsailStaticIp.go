...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/lightsailstaticip/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/lightsail_static_ip awscc_lightsail_static_ip}.
...
func (j *jsiiProxy_LightsailStaticIp) AttachedTo() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attachedTo",
...
func (j *jsiiProxy_LightsailStaticIp) AttachedToInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attachedToInput",
...
func (j *jsiiProxy_LightsailStaticIp) IsAttached() cdktf.IResolvable {
...
func (j *jsiiProxy_LightsailStaticIp) StaticIpArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"staticIpArn",
...
func (j *jsiiProxy_LightsailStaticIp) StaticIpName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"staticIpName",
...
func (j *jsiiProxy_LightsailStaticIp) StaticIpNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"staticIpNameInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/lightsail_static_ip awscc_lightsail_static_ip} Resource.
func NewLightsailStaticIp(scope constructs.Construct, id *string, config *LightsailStaticIpConfig) LightsailStaticIp {
	...
	_jsii_.Create(
		"awscc.lightsailStaticIp.LightsailStaticIp",
...
func (j *jsiiProxy_LightsailStaticIp)SetAttachedTo(val *string) {
...
func (j *jsiiProxy_LightsailStaticIp)SetStaticIpName(val *string) {
...
func (l *jsiiProxy_LightsailStaticIp) ResetAttachedTo() {
	_jsii_.InvokeVoid(
		l,
		"resetAttachedTo",
		nil, // no parameters
