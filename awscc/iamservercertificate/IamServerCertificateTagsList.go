...
func (j *jsiiProxy_IamServerCertificateTagsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewIamServerCertificateTagsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) IamServerCertificateTagsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"awscc.iamServerCertificate.IamServerCertificateTagsList",
...
func NewIamServerCertificateTagsList_Override(i IamServerCertificateTagsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IamServerCertificateTagsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (i *jsiiProxy_IamServerCertificateTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IamServerCertificateTagsList) Resolve(_context cdktf.IResolveContext) interface{} {
