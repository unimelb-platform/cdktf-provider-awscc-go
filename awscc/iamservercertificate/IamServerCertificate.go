...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/iam_server_certificate awscc_iam_server_certificate}.
type IamServerCertificate interface {
	...
	ServerCertificateNameInput() *string
...
func (j *jsiiProxy_IamServerCertificate) ServerCertificateName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IamServerCertificate) ServerCertificateNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serverCertificateNameInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_IamServerCertificate) Tags() IamServerCertificateTagsList {
	var returns IamServerCertificateTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/iam_server_certificate awscc_iam_server_certificate} Resource.
func NewIamServerCertificate(scope constructs.Construct, id *string, config *IamServerCertificateConfig) IamServerCertificate {
	...
	_jsii_.Create(
		"awscc.iamServerCertificate.IamServerCertificate",
...
func (j *jsiiProxy_IamServerCertificate)SetServerCertificateName(val *string) {
	if err := j.validateSetServerCertificateNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (i *jsiiProxy_IamServerCertificate) PutTags(value interface{}) {
...
func (i *jsiiProxy_IamServerCertificate) ResetCertificateBody() {
	_jsii_.InvokeVoid(
		i,
		"resetCertificateBody",
		nil, // no parameters
...
func (i *jsiiProxy_IamServerCertificate) ResetPrivateKey() {
	_jsii_.InvokeVoid(
		i,
		"resetPrivateKey",
		nil, // no parameters
...
func (i *jsiiProxy_IamServerCertificate) ResetServerCertificateName() {
	_jsii_.InvokeVoid(
		i,
		"resetServerCertificateName",
		nil, // no parameters
