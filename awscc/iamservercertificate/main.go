...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetServerCertificateName", GoMethod: "ResetServerCertificateName"},
			_jsii_.MemberMethod{JsiiMethod: "resetTags", GoMethod: "ResetTags"},
			_jsii_.MemberProperty{JsiiProperty: "serverCertificateName", GoGetter: "ServerCertificateName"},
			_jsii_.MemberProperty{JsiiProperty: "serverCertificateNameInput", GoGetter: "ServerCertificateNameInput"},
	...
	_jsii_.RegisterStruct(
		"awscc.iamServerCertificate.IamServerCertificateConfig",
		reflect.TypeOf((*IamServerCertificateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.iamServerCertificate.IamServerCertificateTags",
		reflect.TypeOf((*IamServerCertificateTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.iamServerCertificate.IamServerCertificateTagsList",
		reflect.TypeOf((*IamServerCertificateTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IamServerCertificateTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
