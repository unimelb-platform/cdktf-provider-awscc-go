...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/personalize_solution awscc_personalize_solution}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/personalize_solution awscc_personalize_solution} Resource.
...
func (p *jsiiProxy_PersonalizeSolution) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PersonalizeSolution) MoveFromId(id *string) {
...
func (p *jsiiProxy_PersonalizeSolution) MoveToId(id *string) {
...
func (p *jsiiProxy_PersonalizeSolution) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PersonalizeSolution) ToHclTerraform() interface{} {
	var returns interface{}
