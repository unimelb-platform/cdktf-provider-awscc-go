...
func (d *jsiiProxy_DataAwsccBackupRestoreTestingSelectionProtectedResourceConditionsStringNotEqualsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
