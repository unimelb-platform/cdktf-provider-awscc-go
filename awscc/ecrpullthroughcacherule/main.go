...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEcrRepositoryPrefix", GoMethod: "ResetEcrRepositoryPrefix"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetUpstreamRegistry", GoMethod: "ResetUpstreamRegistry"},
			_jsii_.MemberMethod{JsiiMethod: "resetUpstreamRegistryUrl", GoMethod: "ResetUpstreamRegistryUrl"},
			...
			_jsii_.MemberProperty{JsiiProperty: "upstreamRegistry", GoGetter: "UpstreamRegistry"},
			_jsii_.MemberProperty{JsiiProperty: "upstreamRegistryInput", GoGetter: "UpstreamRegistryInput"},
	...
	_jsii_.RegisterStruct(
		"awscc.ecrPullThroughCacheRule.EcrPullThroughCacheRuleConfig",
