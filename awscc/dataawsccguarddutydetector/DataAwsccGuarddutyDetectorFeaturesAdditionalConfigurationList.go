...
func (d *jsiiProxy_DataAwsccGuarddutyDetectorFeaturesAdditionalConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
