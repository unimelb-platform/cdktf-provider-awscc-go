...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.lakeformationDataCellsFilter.LakeformationDataCellsFilterColumnWildcard",
		reflect.TypeOf((*LakeformationDataCellsFilterColumnWildcard)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.lakeformationDataCellsFilter.LakeformationDataCellsFilterColumnWildcardOutputReference",
		reflect.TypeOf((*LakeformationDataCellsFilterColumnWildcardOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.lakeformationDataCellsFilter.LakeformationDataCellsFilterConfig",
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LakeformationDataCellsFilterRowFilter)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.lakeformationDataCellsFilter.LakeformationDataCellsFilterRowFilterOutputReference",
		reflect.TypeOf((*LakeformationDataCellsFilterRowFilterOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
