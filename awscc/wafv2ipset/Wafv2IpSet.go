...
func (j *jsiiProxy_Wafv2IpSet) Tags() Wafv2IpSetTagsList {
	var returns Wafv2IpSetTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_Wafv2IpSet) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (w *jsiiProxy_Wafv2IpSet) PutTags(value interface{}) {
