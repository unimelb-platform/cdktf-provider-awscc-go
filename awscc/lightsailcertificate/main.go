...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.lightsailCertificate.LightsailCertificateConfig",
		reflect.TypeOf((*LightsailCertificateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.lightsailCertificate.LightsailCertificateTags",
		reflect.TypeOf((*LightsailCertificateTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.lightsailCertificate.LightsailCertificateTagsList",
		reflect.TypeOf((*LightsailCertificateTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LightsailCertificateTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
