...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.elasticbeanstalkConfigurationTemplate.ElasticbeanstalkConfigurationTemplateConfig",
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ElasticbeanstalkConfigurationTemplateOptionSettings)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.elasticbeanstalkConfigurationTemplate.ElasticbeanstalkConfigurationTemplateOptionSettingsList",
		reflect.TypeOf((*ElasticbeanstalkConfigurationTemplateOptionSettingsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ElasticbeanstalkConfigurationTemplateOptionSettingsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.elasticbeanstalkConfigurationTemplate.ElasticbeanstalkConfigurationTemplateSourceConfiguration",
		reflect.TypeOf((*ElasticbeanstalkConfigurationTemplateSourceConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.elasticbeanstalkConfigurationTemplate.ElasticbeanstalkConfigurationTemplateSourceConfigurationOutputReference",
		reflect.TypeOf((*ElasticbeanstalkConfigurationTemplateSourceConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "applicationName", GoGetter: "ApplicationName"},
			_jsii_.MemberProperty{JsiiProperty: "applicationNameInput", GoGetter: "ApplicationNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
