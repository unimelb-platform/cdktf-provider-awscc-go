...
func (j *jsiiProxy_SsmResourceDataSyncS3DestinationOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *SsmResourceDataSyncS3Destination:
		val := val.(*SsmResourceDataSyncS3Destination)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case SsmResourceDataSyncS3Destination:
		val_ := val.(SsmResourceDataSyncS3Destination)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *SsmResourceDataSyncS3Destination; received %#v (a %T)", val, val)
		}
	}
