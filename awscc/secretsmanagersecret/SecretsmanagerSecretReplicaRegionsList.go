...
func (j *jsiiProxy_SecretsmanagerSecretReplicaRegionsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewSecretsmanagerSecretReplicaRegionsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SecretsmanagerSecretReplicaRegionsList {
	_init_.Initialize()
...
func NewSecretsmanagerSecretReplicaRegionsList_Override(s SecretsmanagerSecretReplicaRegionsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecretsmanagerSecretReplicaRegionsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (s *jsiiProxy_SecretsmanagerSecretReplicaRegionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SecretsmanagerSecretReplicaRegionsList) Resolve(_context cdktf.IResolveContext) interface{} {
