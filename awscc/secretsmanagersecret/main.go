...
func init() {
	_jsii_.RegisterClass(
		"awscc.secretsmanagerSecret.SecretsmanagerSecret",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "generateSecretStringInput", GoGetter: "GenerateSecretStringInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putGenerateSecretString", GoMethod: "PutGenerateSecretString"},
			_jsii_.MemberMethod{JsiiMethod: "putReplicaRegions", GoMethod: "PutReplicaRegions"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetGenerateSecretString", GoMethod: "ResetGenerateSecretString"},
	...
	_jsii_.RegisterStruct(
		"awscc.secretsmanagerSecret.SecretsmanagerSecretConfig",
		reflect.TypeOf((*SecretsmanagerSecretConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.secretsmanagerSecret.SecretsmanagerSecretGenerateSecretString",
		reflect.TypeOf((*SecretsmanagerSecretGenerateSecretString)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.secretsmanagerSecret.SecretsmanagerSecretGenerateSecretStringOutputReference",
		reflect.TypeOf((*SecretsmanagerSecretGenerateSecretStringOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberProperty{JsiiProperty: "generateStringKey", GoGetter: "GenerateStringKey"},
			_jsii_.MemberProperty{JsiiProperty: "generateStringKeyInput", GoGetter: "GenerateStringKeyInput"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getListAttribute", GoMethod: "GetListAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetGenerateStringKey", GoMethod: "ResetGenerateStringKey"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSecretStringTemplate", GoMethod: "ResetSecretStringTemplate"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "secretStringTemplate", GoGetter: "SecretStringTemplate"},
			_jsii_.MemberProperty{JsiiProperty: "secretStringTemplateInput", GoGetter: "SecretStringTemplateInput"},
	...
	_jsii_.RegisterStruct(
		"awscc.secretsmanagerSecret.SecretsmanagerSecretReplicaRegions",
		reflect.TypeOf((*SecretsmanagerSecretReplicaRegions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.secretsmanagerSecret.SecretsmanagerSecretReplicaRegionsList",
		reflect.TypeOf((*SecretsmanagerSecretReplicaRegionsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SecretsmanagerSecretReplicaRegionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SecretsmanagerSecretTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.secretsmanagerSecret.SecretsmanagerSecretTagsList",
		reflect.TypeOf((*SecretsmanagerSecretTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
		...
		func() interface{} {
			j := jsiiProxy_SecretsmanagerSecretTagsList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexList)
			return &j
		},
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SecretsmanagerSecretTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
