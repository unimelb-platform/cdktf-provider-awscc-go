...
func (j *jsiiProxy_EcsTaskSetServiceRegistriesOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewEcsTaskSetServiceRegistriesOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) EcsTaskSetServiceRegistriesOutputReference {
	_init_.Initialize()

	if err := validateNewEcsTaskSetServiceRegistriesOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewEcsTaskSetServiceRegistriesOutputReference_Override(e EcsTaskSetServiceRegistriesOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EcsTaskSetServiceRegistriesOutputReference)SetInternalValue(val interface{}) {
...
func (e *jsiiProxy_EcsTaskSetServiceRegistriesOutputReference) ResetRegistryArn() {
	_jsii_.InvokeVoid(
		e,
		"resetRegistryArn",
		nil, // no parameters
