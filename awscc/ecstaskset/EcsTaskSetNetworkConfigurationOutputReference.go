...
type EcsTaskSetNetworkConfigurationOutputReference interface {
	cdktf.ComplexObject
	AwsVpcConfiguration() EcsTaskSetNetworkConfigurationAwsVpcConfigurationOutputReference
	...
	PutAwsVpcConfiguration(value *EcsTaskSetNetworkConfigurationAwsVpcConfiguration)
...
func (j *jsiiProxy_EcsTaskSetNetworkConfigurationOutputReference) AwsVpcConfiguration() EcsTaskSetNetworkConfigurationAwsVpcConfigurationOutputReference {
	var returns EcsTaskSetNetworkConfigurationAwsVpcConfigurationOutputReference
	_jsii_.Get(
		j,
		"awsVpcConfiguration",
		&returns,
...
func (j *jsiiProxy_EcsTaskSetNetworkConfigurationOutputReference) AwsVpcConfigurationInput() interface{} {
...
func (j *jsiiProxy_EcsTaskSetNetworkConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EcsTaskSetNetworkConfigurationOutputReference)SetInternalValue(val interface{}) {
...
func (e *jsiiProxy_EcsTaskSetNetworkConfigurationOutputReference) PutAwsVpcConfiguration(value *EcsTaskSetNetworkConfigurationAwsVpcConfiguration) {
...
func (e *jsiiProxy_EcsTaskSetNetworkConfigurationOutputReference) ResetAwsVpcConfiguration() {
	_jsii_.InvokeVoid(
		e,
		"resetAwsVpcConfiguration",
		nil, // no parameters
