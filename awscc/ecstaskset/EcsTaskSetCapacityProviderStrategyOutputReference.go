...
func (e *jsiiProxy_EcsTaskSetCapacityProviderStrategyOutputReference) ResetCapacityProvider() {
	_jsii_.InvokeVoid(
		e,
		"resetCapacityProvider",
		nil, // no parameters
...
func (e *jsiiProxy_EcsTaskSetCapacityProviderStrategyOutputReference) ResetWeight() {
	_jsii_.InvokeVoid(
		e,
		"resetWeight",
		nil, // no parameters
