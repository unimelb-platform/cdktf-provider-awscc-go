...
func (e *jsiiProxy_EcsTaskSet) validatePutLoadBalancersParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*EcsTaskSetLoadBalancers:
		value := value.(*[]*EcsTaskSetLoadBalancers)
	...
	case []*EcsTaskSetLoadBalancers:
		value_ := value.([]*EcsTaskSetLoadBalancers)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*EcsTaskSetLoadBalancers; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_EcsTaskSet) validatePutServiceRegistriesParameters(value interface{}) error {
	...
	case *[]*EcsTaskSetServiceRegistries:
		value := value.(*[]*EcsTaskSetServiceRegistries)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*EcsTaskSetServiceRegistries:
		value_ := value.([]*EcsTaskSetServiceRegistries)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
