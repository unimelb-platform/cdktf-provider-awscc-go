...
func (j *jsiiProxy_EcrRepositoryImageScanningConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EcrRepositoryImageScanningConfigurationOutputReference)SetInternalValue(val interface{}) {
...
func (e *jsiiProxy_EcrRepositoryImageScanningConfigurationOutputReference) ResetScanOnPush() {
	_jsii_.InvokeVoid(
		e,
		"resetScanOnPush",
		nil, // no parameters
