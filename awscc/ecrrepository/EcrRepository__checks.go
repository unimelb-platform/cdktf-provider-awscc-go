...
func (e *jsiiProxy_EcrRepository) validatePutEncryptionConfigurationParameters(value *EcrRepositoryEncryptionConfiguration) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (e *jsiiProxy_EcrRepository) validatePutLifecyclePolicyParameters(value *EcrRepositoryLifecyclePolicy) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (e *jsiiProxy_EcrRepository) validatePutTagsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	case cdktf.IResolvable:
		// ok
	case *[]*EcrRepositoryTags:
		value := value.(*[]*EcrRepositoryTags)
	...
	case []*EcrRepositoryTags:
		value_ := value.([]*EcrRepositoryTags)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*EcrRepositoryTags; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_EcrRepository) validateSetEmptyOnDeleteParameters(val interface{}) error {
	if val == nil {
...
func (j *jsiiProxy_EcrRepository) validateSetRepositoryNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_EcrRepository) validateSetRepositoryPolicyTextParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
