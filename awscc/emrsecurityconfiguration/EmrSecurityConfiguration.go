...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/emrsecurityconfiguration/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/emr_security_configuration awscc_emr_security_configuration}.
...
func (j *jsiiProxy_EmrSecurityConfiguration) SecurityConfiguration() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EmrSecurityConfiguration) SecurityConfigurationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/emr_security_configuration awscc_emr_security_configuration} Resource.
func NewEmrSecurityConfiguration(scope constructs.Construct, id *string, config *EmrSecurityConfigurationConfig) EmrSecurityConfiguration {
	...
	_jsii_.Create(
		"awscc.emrSecurityConfiguration.EmrSecurityConfiguration",
...
func (j *jsiiProxy_EmrSecurityConfiguration)SetSecurityConfiguration(val *string) {
