...
type ApprunnerServiceSourceConfigurationOutputReference interface {
	...
	ImageRepositoryInput() interface{}
...
func (j *jsiiProxy_ApprunnerServiceSourceConfigurationOutputReference) AuthenticationConfigurationInput() interface{} {
...
func (j *jsiiProxy_ApprunnerServiceSourceConfigurationOutputReference) CodeRepositoryInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"codeRepositoryInput",
...
func (j *jsiiProxy_ApprunnerServiceSourceConfigurationOutputReference) ImageRepositoryInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApprunnerServiceSourceConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ApprunnerServiceSourceConfigurationOutputReference)SetInternalValue(val interface{}) {
