...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apprunner_service awscc_apprunner_service}.
type ApprunnerService interface {
	...
	HealthCheckConfigurationInput() interface{}
	Id() *string
	...
	ObservabilityConfigurationInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_ApprunnerService) EncryptionConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApprunnerService) HealthCheckConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApprunnerService) InstanceConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApprunnerService) NetworkConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApprunnerService) ObservabilityConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApprunnerService) ServiceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceArn",
...
func (j *jsiiProxy_ApprunnerService) SourceConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApprunnerService) Tags() ApprunnerServiceTagsList {
	var returns ApprunnerServiceTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/apprunner_service awscc_apprunner_service} Resource.
...
func (a *jsiiProxy_ApprunnerService) PutTags(value interface{}) {
...
func (a *jsiiProxy_ApprunnerService) ResetServiceName() {
	_jsii_.InvokeVoid(
		a,
		"resetServiceName",
		nil, // no parameters
