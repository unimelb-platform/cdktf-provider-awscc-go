...
func (j *jsiiProxy_ApprunnerServiceInstanceConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ApprunnerServiceInstanceConfigurationOutputReference)SetInternalValue(val interface{}) {
