...
func (j *jsiiProxy_ApprunnerServiceSourceConfigurationImageRepositoryOutputReference) ImageConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApprunnerServiceSourceConfigurationImageRepositoryOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ApprunnerServiceSourceConfigurationImageRepositoryOutputReference)SetInternalValue(val interface{}) {
