...
func (j *jsiiProxy_ApprunnerServiceEncryptionConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ApprunnerServiceEncryptionConfigurationOutputReference)SetInternalValue(val interface{}) {
...
func (a *jsiiProxy_ApprunnerServiceEncryptionConfigurationOutputReference) ResetKmsKey() {
	_jsii_.InvokeVoid(
		a,
		"resetKmsKey",
		nil, // no parameters
