...
func (j *jsiiProxy_ApprunnerServiceNetworkConfigurationEgressConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ApprunnerServiceNetworkConfigurationEgressConfigurationOutputReference)SetInternalValue(val interface{}) {
