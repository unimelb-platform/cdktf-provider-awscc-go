...
func (j *jsiiProxy_ApprunnerServiceNetworkConfigurationOutputReference) EgressConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApprunnerServiceNetworkConfigurationOutputReference) IngressConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApprunnerServiceNetworkConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ApprunnerServiceNetworkConfigurationOutputReference)SetInternalValue(val interface{}) {
