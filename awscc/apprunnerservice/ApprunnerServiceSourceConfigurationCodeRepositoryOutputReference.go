...
func (j *jsiiProxy_ApprunnerServiceSourceConfigurationCodeRepositoryOutputReference) CodeConfigurationInput() interface{} {
...
func (j *jsiiProxy_ApprunnerServiceSourceConfigurationCodeRepositoryOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ApprunnerServiceSourceConfigurationCodeRepositoryOutputReference)SetInternalValue(val interface{}) {
