...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/eks_fargate_profile awscc_eks_fargate_profile}.
...
func (j *jsiiProxy_EksFargateProfile) Selectors() EksFargateProfileSelectorsList {
	var returns EksFargateProfileSelectorsList
	_jsii_.Get(
		j,
		"selectors",
		&returns,
...
func (j *jsiiProxy_EksFargateProfile) SelectorsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"selectorsInput",
...
func (j *jsiiProxy_EksFargateProfile) Subnets() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"subnets",
...
func (j *jsiiProxy_EksFargateProfile) SubnetsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"subnetsInput",
...
func (j *jsiiProxy_EksFargateProfile) Tags() EksFargateProfileTagsList {
	var returns EksFargateProfileTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/eks_fargate_profile awscc_eks_fargate_profile} Resource.
...
func (j *jsiiProxy_EksFargateProfile)SetSubnets(val *[]*string) {
...
func (e *jsiiProxy_EksFargateProfile) PutSelectors(value interface{}) {
	if err := e.validatePutSelectorsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		e,
...
func (e *jsiiProxy_EksFargateProfile) PutTags(value interface{}) {
...
func (e *jsiiProxy_EksFargateProfile) ResetFargateProfileName() {
	_jsii_.InvokeVoid(
		e,
		"resetFargateProfileName",
		nil, // no parameters
...
func (e *jsiiProxy_EksFargateProfile) ResetSubnets() {
	_jsii_.InvokeVoid(
		e,
		"resetSubnets",
		nil, // no parameters
