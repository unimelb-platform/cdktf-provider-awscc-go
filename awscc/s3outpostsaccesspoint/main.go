...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*S3OutpostsAccessPoint)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.s3OutpostsAccessPoint.S3OutpostsAccessPointConfig",
		reflect.TypeOf((*S3OutpostsAccessPointConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.s3OutpostsAccessPoint.S3OutpostsAccessPointVpcConfiguration",
		reflect.TypeOf((*S3OutpostsAccessPointVpcConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.s3OutpostsAccessPoint.S3OutpostsAccessPointVpcConfigurationOutputReference",
		reflect.TypeOf((*S3OutpostsAccessPointVpcConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
