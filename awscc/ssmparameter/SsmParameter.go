...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/ssmparameter/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/ssm_parameter awscc_ssm_parameter}.
...
func (j *jsiiProxy_SsmParameter) Policies() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policies",
...
func (j *jsiiProxy_SsmParameter) PoliciesInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policiesInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/ssm_parameter awscc_ssm_parameter} Resource.
func NewSsmParameter(scope constructs.Construct, id *string, config *SsmParameterConfig) SsmParameter {
	...
	_jsii_.Create(
		"awscc.ssmParameter.SsmParameter",
...
func (j *jsiiProxy_SsmParameter)SetPolicies(val *string) {
...
func (s *jsiiProxy_SsmParameter) ResetName() {
	_jsii_.InvokeVoid(
		s,
		"resetName",
		nil, // no parameters
...
func (s *jsiiProxy_SsmParameter) ResetPolicies() {
	_jsii_.InvokeVoid(
		s,
		"resetPolicies",
		nil, // no parameters
