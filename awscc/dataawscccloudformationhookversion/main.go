...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCloudformationHookVersion)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccCloudformationHookVersion.DataAwsccCloudformationHookVersionConfig",
		reflect.TypeOf((*DataAwsccCloudformationHookVersionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccCloudformationHookVersion.DataAwsccCloudformationHookVersionLoggingConfig",
		reflect.TypeOf((*DataAwsccCloudformationHookVersionLoggingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccCloudformationHookVersion.DataAwsccCloudformationHookVersionLoggingConfigOutputReference",
		reflect.TypeOf((*DataAwsccCloudformationHookVersionLoggingConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
