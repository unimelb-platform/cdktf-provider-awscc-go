...
func (j *jsiiProxy_OrganizationsOrganizationalUnit) Tags() OrganizationsOrganizationalUnitTagsList {
	var returns OrganizationsOrganizationalUnitTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (o *jsiiProxy_OrganizationsOrganizationalUnit) PutTags(value interface{}) {
