...
func (j *jsiiProxy_EcsServiceServiceRegistriesOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case *EcsServiceServiceRegistries:
		val := val.(*EcsServiceServiceRegistries)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case EcsServiceServiceRegistries:
		val_ := val.(EcsServiceServiceRegistries)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *EcsServiceServiceRegistries; received %#v (a %T)", val, val)
		}
	}
...
func validateNewEcsServiceServiceRegistriesOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
