...
type EcsServiceNetworkConfigurationOutputReference interface {
	cdktf.ComplexObject
	AwsvpcConfiguration() EcsServiceNetworkConfigurationAwsvpcConfigurationOutputReference
	...
	PutAwsvpcConfiguration(value *EcsServiceNetworkConfigurationAwsvpcConfiguration)
...
func (j *jsiiProxy_EcsServiceNetworkConfigurationOutputReference) AwsvpcConfiguration() EcsServiceNetworkConfigurationAwsvpcConfigurationOutputReference {
	var returns EcsServiceNetworkConfigurationAwsvpcConfigurationOutputReference
	_jsii_.Get(
		j,
		"awsvpcConfiguration",
		&returns,
...
func (j *jsiiProxy_EcsServiceNetworkConfigurationOutputReference) AwsvpcConfigurationInput() interface{} {
...
func (j *jsiiProxy_EcsServiceNetworkConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EcsServiceNetworkConfigurationOutputReference)SetInternalValue(val interface{}) {
...
func (e *jsiiProxy_EcsServiceNetworkConfigurationOutputReference) PutAwsvpcConfiguration(value *EcsServiceNetworkConfigurationAwsvpcConfiguration) {
...
func (e *jsiiProxy_EcsServiceNetworkConfigurationOutputReference) ResetAwsvpcConfiguration() {
	_jsii_.InvokeVoid(
		e,
		"resetAwsvpcConfiguration",
		nil, // no parameters
