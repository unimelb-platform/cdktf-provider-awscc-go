...
func (j *jsiiProxy_EcsServiceDeploymentControllerOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EcsServiceDeploymentControllerOutputReference)SetInternalValue(val interface{}) {
