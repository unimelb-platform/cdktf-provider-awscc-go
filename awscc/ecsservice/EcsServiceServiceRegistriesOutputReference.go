...
func (j *jsiiProxy_EcsServiceServiceRegistriesOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewEcsServiceServiceRegistriesOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) EcsServiceServiceRegistriesOutputReference {
	_init_.Initialize()

	if err := validateNewEcsServiceServiceRegistriesOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewEcsServiceServiceRegistriesOutputReference_Override(e EcsServiceServiceRegistriesOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EcsServiceServiceRegistriesOutputReference)SetInternalValue(val interface{}) {
...
func (e *jsiiProxy_EcsServiceServiceRegistriesOutputReference) ResetRegistryArn() {
	_jsii_.InvokeVoid(
		e,
		"resetRegistryArn",
		nil, // no parameters
