...
func init() {
	_jsii_.RegisterClass(
		"awscc.resourcegroupsTagSyncTask.ResourcegroupsTagSyncTask",
		reflect.TypeOf((*ResourcegroupsTagSyncTask)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_ResourcegroupsTagSyncTask{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"awscc.resourcegroupsTagSyncTask.ResourcegroupsTagSyncTaskConfig",
		reflect.TypeOf((*ResourcegroupsTagSyncTaskConfig)(nil)).Elem(),
	)
}
