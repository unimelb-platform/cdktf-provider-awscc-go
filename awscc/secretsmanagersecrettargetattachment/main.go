...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SecretsmanagerSecretTargetAttachment)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.secretsmanagerSecretTargetAttachment.SecretsmanagerSecretTargetAttachmentConfig",
		reflect.TypeOf((*SecretsmanagerSecretTargetAttachmentConfig)(nil)).Elem(),
	)
}
