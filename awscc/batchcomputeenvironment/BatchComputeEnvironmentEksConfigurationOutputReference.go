...
func (j *jsiiProxy_BatchComputeEnvironmentEksConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewBatchComputeEnvironmentEksConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) BatchComputeEnvironmentEksConfigurationOutputReference {
	...
	_jsii_.Create(
		"awscc.batchComputeEnvironment.BatchComputeEnvironmentEksConfigurationOutputReference",
...
func (j *jsiiProxy_BatchComputeEnvironmentEksConfigurationOutputReference)SetInternalValue(val interface{}) {
...
func (b *jsiiProxy_BatchComputeEnvironmentEksConfigurationOutputReference) ResetKubernetesNamespace() {
	_jsii_.InvokeVoid(
		b,
		"resetKubernetesNamespace",
		nil, // no parameters
