...
func (j *jsiiProxy_SagemakerDataQualityJobDefinitionDataQualityJobInputOutputReference) BatchTransformInputInput() interface{} {
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinitionDataQualityJobInputOutputReference) EndpointInputInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"endpointInputInput",
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinitionDataQualityJobInputOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinitionDataQualityJobInputOutputReference)SetInternalValue(val interface{}) {
