...
func (j *jsiiProxy_SagemakerDataQualityJobDefinitionDataQualityAppSpecificationOutputReference) ContainerArguments() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"containerArguments",
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinitionDataQualityAppSpecificationOutputReference) ContainerArgumentsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinitionDataQualityAppSpecificationOutputReference) ContainerEntrypoint() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"containerEntrypoint",
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinitionDataQualityAppSpecificationOutputReference) ContainerEntrypointInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinitionDataQualityAppSpecificationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinitionDataQualityAppSpecificationOutputReference)SetContainerArguments(val *[]*string) {
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinitionDataQualityAppSpecificationOutputReference)SetContainerEntrypoint(val *[]*string) {
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinitionDataQualityAppSpecificationOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_SagemakerDataQualityJobDefinitionDataQualityAppSpecificationOutputReference) ResetContainerArguments() {
	_jsii_.InvokeVoid(
		s,
		"resetContainerArguments",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerDataQualityJobDefinitionDataQualityAppSpecificationOutputReference) ResetContainerEntrypoint() {
	_jsii_.InvokeVoid(
		s,
		"resetContainerEntrypoint",
		nil, // no parameters
