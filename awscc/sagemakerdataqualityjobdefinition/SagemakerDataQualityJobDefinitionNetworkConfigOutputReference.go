...
func (j *jsiiProxy_SagemakerDataQualityJobDefinitionNetworkConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinitionNetworkConfigOutputReference) VpcConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"vpcConfigInput",
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinitionNetworkConfigOutputReference)SetInternalValue(val interface{}) {
