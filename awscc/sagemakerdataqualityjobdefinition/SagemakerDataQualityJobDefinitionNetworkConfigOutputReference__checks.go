...
func (s *jsiiProxy_SagemakerDataQualityJobDefinitionNetworkConfigOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (s *jsiiProxy_SagemakerDataQualityJobDefinitionNetworkConfigOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinitionNetworkConfigOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *SagemakerDataQualityJobDefinitionNetworkConfig:
		val := val.(*SagemakerDataQualityJobDefinitionNetworkConfig)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case SagemakerDataQualityJobDefinitionNetworkConfig:
		val_ := val.(SagemakerDataQualityJobDefinitionNetworkConfig)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *SagemakerDataQualityJobDefinitionNetworkConfig; received %#v (a %T)", val, val)
		}
	}
