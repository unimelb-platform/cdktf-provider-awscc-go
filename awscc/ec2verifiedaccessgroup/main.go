...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2VerifiedAccessGroup)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.ec2VerifiedAccessGroup.Ec2VerifiedAccessGroupConfig",
		reflect.TypeOf((*Ec2VerifiedAccessGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.ec2VerifiedAccessGroup.Ec2VerifiedAccessGroupSseSpecification",
		reflect.TypeOf((*Ec2VerifiedAccessGroupSseSpecification)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2VerifiedAccessGroup.Ec2VerifiedAccessGroupSseSpecificationOutputReference",
		reflect.TypeOf((*Ec2VerifiedAccessGroupSseSpecificationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.ec2VerifiedAccessGroup.Ec2VerifiedAccessGroupTags",
		reflect.TypeOf((*Ec2VerifiedAccessGroupTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.ec2VerifiedAccessGroup.Ec2VerifiedAccessGroupTagsList",
		reflect.TypeOf((*Ec2VerifiedAccessGroupTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2VerifiedAccessGroupTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
