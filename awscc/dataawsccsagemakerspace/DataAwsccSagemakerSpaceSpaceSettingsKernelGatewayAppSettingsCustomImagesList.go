...
func (d *jsiiProxy_DataAwsccSagemakerSpaceSpaceSettingsKernelGatewayAppSettingsCustomImagesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
