...
type GrafanaWorkspaceSamlConfigurationRoleValues struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/grafana_workspace#admin GrafanaWorkspace#admin}
	Admin *[]*string `field:"optional" json:"admin" yaml:"admin"`
	// List of SAML roles which will be mapped into the Grafana Editor role.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/grafana_workspace#editor GrafanaWorkspace#editor}
