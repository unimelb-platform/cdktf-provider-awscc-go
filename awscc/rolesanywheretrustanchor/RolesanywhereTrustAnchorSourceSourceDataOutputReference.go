...
func (j *jsiiProxy_RolesanywhereTrustAnchorSourceSourceDataOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_RolesanywhereTrustAnchorSourceSourceDataOutputReference)SetInternalValue(val interface{}) {
