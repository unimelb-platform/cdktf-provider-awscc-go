...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/cognito_user_pool_domain awscc_cognito_user_pool_domain}.
type CognitoUserPoolDomain interface {
	...
	CustomDomainConfig() CognitoUserPoolDomainCustomDomainConfigOutputReference
	CustomDomainConfigInput() interface{}
	// Experimental.
	DependsOn() *[]*string
	// Experimental.
	...
	PutCustomDomainConfig(value *CognitoUserPoolDomainCustomDomainConfig)
	ResetCustomDomainConfig()
...
func (j *jsiiProxy_CognitoUserPoolDomain) CustomDomainConfig() CognitoUserPoolDomainCustomDomainConfigOutputReference {
	var returns CognitoUserPoolDomainCustomDomainConfigOutputReference
	_jsii_.Get(
		j,
		"customDomainConfig",
		&returns,
...
func (j *jsiiProxy_CognitoUserPoolDomain) CustomDomainConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"customDomainConfigInput",
		&returns,
	)
	return returns
}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/cognito_user_pool_domain awscc_cognito_user_pool_domain} Resource.
func NewCognitoUserPoolDomain(scope constructs.Construct, id *string, config *CognitoUserPoolDomainConfig) CognitoUserPoolDomain {
	...
	_jsii_.Create(
		"awscc.cognitoUserPoolDomain.CognitoUserPoolDomain",
...
func (c *jsiiProxy_CognitoUserPoolDomain) PutCustomDomainConfig(value *CognitoUserPoolDomainCustomDomainConfig) {
	if err := c.validatePutCustomDomainConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
		"putCustomDomainConfig",
		[]interface{}{value},
	)
}

func (c *jsiiProxy_CognitoUserPoolDomain) ResetCustomDomainConfig() {
	_jsii_.InvokeVoid(
		c,
		"resetCustomDomainConfig",
		nil, // no parameters
