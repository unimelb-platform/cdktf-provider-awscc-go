...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customDomainConfigInput", GoGetter: "CustomDomainConfigInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putCustomDomainConfig", GoMethod: "PutCustomDomainConfig"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetCustomDomainConfig", GoMethod: "ResetCustomDomainConfig"},
	...
	_jsii_.RegisterStruct(
		"awscc.cognitoUserPoolDomain.CognitoUserPoolDomainCustomDomainConfig",
		reflect.TypeOf((*CognitoUserPoolDomainCustomDomainConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.cognitoUserPoolDomain.CognitoUserPoolDomainCustomDomainConfigOutputReference",
		reflect.TypeOf((*CognitoUserPoolDomainCustomDomainConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
