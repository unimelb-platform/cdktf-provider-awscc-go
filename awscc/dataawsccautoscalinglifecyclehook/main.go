...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccAutoscalingLifecycleHook)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccAutoscalingLifecycleHook.DataAwsccAutoscalingLifecycleHookConfig",
		reflect.TypeOf((*DataAwsccAutoscalingLifecycleHookConfig)(nil)).Elem(),
	)
}
