...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "hostMaintenanceInput", GoGetter: "HostMaintenanceInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetHostMaintenance", GoMethod: "ResetHostMaintenance"},
