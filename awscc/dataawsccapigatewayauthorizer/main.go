...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccApigatewayAuthorizer)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccApigatewayAuthorizer.DataAwsccApigatewayAuthorizerConfig",
		reflect.TypeOf((*DataAwsccApigatewayAuthorizerConfig)(nil)).Elem(),
	)
}
