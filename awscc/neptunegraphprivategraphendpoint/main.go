...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NeptunegraphPrivateGraphEndpoint)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "graphIdentifierInput", GoGetter: "GraphIdentifierInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NeptunegraphPrivateGraphEndpointConfig)(nil)).Elem(),
	)
}
