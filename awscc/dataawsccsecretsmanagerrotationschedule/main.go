...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSecretsmanagerRotationSchedule)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccSecretsmanagerRotationScheduleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccSecretsmanagerRotationSchedule.DataAwsccSecretsmanagerRotationScheduleHostedRotationLambda",
		reflect.TypeOf((*DataAwsccSecretsmanagerRotationScheduleHostedRotationLambda)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccSecretsmanagerRotationSchedule.DataAwsccSecretsmanagerRotationScheduleHostedRotationLambdaOutputReference",
		reflect.TypeOf((*DataAwsccSecretsmanagerRotationScheduleHostedRotationLambdaOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccSecretsmanagerRotationScheduleRotationRules)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccSecretsmanagerRotationSchedule.DataAwsccSecretsmanagerRotationScheduleRotationRulesOutputReference",
		reflect.TypeOf((*DataAwsccSecretsmanagerRotationScheduleRotationRulesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
