...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/appsyncdomainnameapiassociation/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/appsync_domain_name_api_association awscc_appsync_domain_name_api_association}.
...
func (j *jsiiProxy_AppsyncDomainNameApiAssociation) ApiAssociationIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/appsync_domain_name_api_association awscc_appsync_domain_name_api_association} Resource.
func NewAppsyncDomainNameApiAssociation(scope constructs.Construct, id *string, config *AppsyncDomainNameApiAssociationConfig) AppsyncDomainNameApiAssociation {
	...
	_jsii_.Create(
		"awscc.appsyncDomainNameApiAssociation.AppsyncDomainNameApiAssociation",
