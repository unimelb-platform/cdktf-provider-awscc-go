...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/detective_graph awscc_detective_graph}.
type DetectiveGraph interface {
	cdktf.TerraformResource
	Arn() *string
	AutoEnableMembers() interface{}
	SetAutoEnableMembers(val interface{})
	AutoEnableMembersInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_DetectiveGraph) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_DetectiveGraph) AutoEnableMembers() interface{} {
...
func (j *jsiiProxy_DetectiveGraph) AutoEnableMembersInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"autoEnableMembersInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_DetectiveGraph) Tags() DetectiveGraphTagsList {
	var returns DetectiveGraphTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/detective_graph awscc_detective_graph} Resource.
func NewDetectiveGraph(scope constructs.Construct, id *string, config *DetectiveGraphConfig) DetectiveGraph {
	...
	_jsii_.Create(
		"awscc.detectiveGraph.DetectiveGraph",
...
func (j *jsiiProxy_DetectiveGraph)SetAutoEnableMembers(val interface{}) {
...
func (d *jsiiProxy_DetectiveGraph) PutTags(value interface{}) {
...
func (d *jsiiProxy_DetectiveGraph) ResetAutoEnableMembers() {
	_jsii_.InvokeVoid(
		d,
		"resetAutoEnableMembers",
		nil, // no parameters
