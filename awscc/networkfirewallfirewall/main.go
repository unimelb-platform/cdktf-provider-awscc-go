...
func init() {
	_jsii_.RegisterClass(
		"awscc.networkfirewallFirewall.NetworkfirewallFirewall",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enabledAnalysisTypesInput", GoGetter: "EnabledAnalysisTypesInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "firewallNameInput", GoGetter: "FirewallNameInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEnabledAnalysisTypes", GoMethod: "ResetEnabledAnalysisTypes"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkfirewallFirewallSubnetMappingsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.networkfirewallFirewall.NetworkfirewallFirewallTags",
		reflect.TypeOf((*NetworkfirewallFirewallTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.networkfirewallFirewall.NetworkfirewallFirewallTagsList",
		reflect.TypeOf((*NetworkfirewallFirewallTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkfirewallFirewallTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
