...
func (n *jsiiProxy_NetworkfirewallFirewall) validatePutSubnetMappingsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*NetworkfirewallFirewallSubnetMappings:
		value := value.(*[]*NetworkfirewallFirewallSubnetMappings)
	...
	case []*NetworkfirewallFirewallSubnetMappings:
		value_ := value.([]*NetworkfirewallFirewallSubnetMappings)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*NetworkfirewallFirewallSubnetMappings; received %#v (a %T)", value, value)
		}
	}
...
func (n *jsiiProxy_NetworkfirewallFirewall) validatePutTagsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*NetworkfirewallFirewallTags:
		value := value.(*[]*NetworkfirewallFirewallTags)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*NetworkfirewallFirewallTags:
		value_ := value.([]*NetworkfirewallFirewallTags)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*NetworkfirewallFirewallTags; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_NetworkfirewallFirewall) validateSetFirewallNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
