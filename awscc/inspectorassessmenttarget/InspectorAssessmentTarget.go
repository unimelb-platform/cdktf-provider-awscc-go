...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/inspectorassessmenttarget/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/inspector_assessment_target awscc_inspector_assessment_target}.
type InspectorAssessmentTarget interface {
	cdktf.TerraformResource
	Arn() *string
	AssessmentTargetName() *string
	SetAssessmentTargetName(val *string)
	AssessmentTargetNameInput() *string
	// Experimental.
...
func (j *jsiiProxy_InspectorAssessmentTarget) AssessmentTargetName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_InspectorAssessmentTarget) AssessmentTargetNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"assessmentTargetNameInput",
		&returns,
	)
	return returns
}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/inspector_assessment_target awscc_inspector_assessment_target} Resource.
func NewInspectorAssessmentTarget(scope constructs.Construct, id *string, config *InspectorAssessmentTargetConfig) InspectorAssessmentTarget {
	...
	_jsii_.Create(
		"awscc.inspectorAssessmentTarget.InspectorAssessmentTarget",
...
func (j *jsiiProxy_InspectorAssessmentTarget)SetAssessmentTargetName(val *string) {
	if err := j.validateSetAssessmentTargetNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (i *jsiiProxy_InspectorAssessmentTarget) ResetAssessmentTargetName() {
	_jsii_.InvokeVoid(
		i,
		"resetAssessmentTargetName",
		nil, // no parameters
