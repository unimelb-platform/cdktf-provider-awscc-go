...
func (j *jsiiProxy_PipesPipeSourceParametersSelfManagedKafkaParametersCredentialsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *PipesPipeSourceParametersSelfManagedKafkaParametersCredentials:
		val := val.(*PipesPipeSourceParametersSelfManagedKafkaParametersCredentials)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case PipesPipeSourceParametersSelfManagedKafkaParametersCredentials:
		val_ := val.(PipesPipeSourceParametersSelfManagedKafkaParametersCredentials)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *PipesPipeSourceParametersSelfManagedKafkaParametersCredentials; received %#v (a %T)", val, val)
		}
	}
