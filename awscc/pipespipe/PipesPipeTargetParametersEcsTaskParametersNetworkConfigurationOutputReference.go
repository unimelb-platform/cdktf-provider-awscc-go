...
func (j *jsiiProxy_PipesPipeTargetParametersEcsTaskParametersNetworkConfigurationOutputReference) AwsvpcConfigurationInput() interface{} {
...
func (j *jsiiProxy_PipesPipeTargetParametersEcsTaskParametersNetworkConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_PipesPipeTargetParametersEcsTaskParametersNetworkConfigurationOutputReference)SetInternalValue(val interface{}) {
