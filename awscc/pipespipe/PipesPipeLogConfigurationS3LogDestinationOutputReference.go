...
func (j *jsiiProxy_PipesPipeLogConfigurationS3LogDestinationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_PipesPipeLogConfigurationS3LogDestinationOutputReference)SetInternalValue(val interface{}) {
...
func (p *jsiiProxy_PipesPipeLogConfigurationS3LogDestinationOutputReference) ResetBucketName() {
	_jsii_.InvokeVoid(
		p,
		"resetBucketName",
		nil, // no parameters
...
func (p *jsiiProxy_PipesPipeLogConfigurationS3LogDestinationOutputReference) ResetBucketOwner() {
	_jsii_.InvokeVoid(
		p,
		"resetBucketOwner",
		nil, // no parameters
