...
func (j *jsiiProxy_PipesPipeTargetParametersRedshiftDataParametersOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_PipesPipeTargetParametersRedshiftDataParametersOutputReference)SetInternalValue(val interface{}) {
