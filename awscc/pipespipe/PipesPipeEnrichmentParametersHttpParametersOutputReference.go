...
func (j *jsiiProxy_PipesPipeEnrichmentParametersHttpParametersOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_PipesPipeEnrichmentParametersHttpParametersOutputReference)SetInternalValue(val interface{}) {
