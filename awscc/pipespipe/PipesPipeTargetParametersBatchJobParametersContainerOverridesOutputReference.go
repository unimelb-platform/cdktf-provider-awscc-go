...
type PipesPipeTargetParametersBatchJobParametersContainerOverridesOutputReference interface {
	...
	ResourceRequirements() PipesPipeTargetParametersBatchJobParametersContainerOverridesResourceRequirementsList
...
func (j *jsiiProxy_PipesPipeTargetParametersBatchJobParametersContainerOverridesOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_PipesPipeTargetParametersBatchJobParametersContainerOverridesOutputReference) ResourceRequirements() PipesPipeTargetParametersBatchJobParametersContainerOverridesResourceRequirementsList {
	var returns PipesPipeTargetParametersBatchJobParametersContainerOverridesResourceRequirementsList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PipesPipeTargetParametersBatchJobParametersContainerOverridesOutputReference) ResourceRequirementsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PipesPipeTargetParametersBatchJobParametersContainerOverridesOutputReference)SetInternalValue(val interface{}) {
...
func (p *jsiiProxy_PipesPipeTargetParametersBatchJobParametersContainerOverridesOutputReference) PutResourceRequirements(value interface{}) {
...
func (p *jsiiProxy_PipesPipeTargetParametersBatchJobParametersContainerOverridesOutputReference) ResetResourceRequirements() {
	_jsii_.InvokeVoid(
		p,
		"resetResourceRequirements",
		nil, // no parameters
