...
func (j *jsiiProxy_PipesPipeTargetParametersHttpParametersOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_PipesPipeTargetParametersHttpParametersOutputReference)SetInternalValue(val interface{}) {
