...
func (j *jsiiProxy_PipesPipeTargetParametersBatchJobParametersOutputReference) ArrayPropertiesInput() interface{} {
...
func (j *jsiiProxy_PipesPipeTargetParametersBatchJobParametersOutputReference) ContainerOverridesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PipesPipeTargetParametersBatchJobParametersOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_PipesPipeTargetParametersBatchJobParametersOutputReference) RetryStrategyInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"retryStrategyInput",
...
func (j *jsiiProxy_PipesPipeTargetParametersBatchJobParametersOutputReference)SetInternalValue(val interface{}) {
