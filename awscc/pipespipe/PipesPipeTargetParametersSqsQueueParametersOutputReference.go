...
func (j *jsiiProxy_PipesPipeTargetParametersSqsQueueParametersOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_PipesPipeTargetParametersSqsQueueParametersOutputReference)SetInternalValue(val interface{}) {
