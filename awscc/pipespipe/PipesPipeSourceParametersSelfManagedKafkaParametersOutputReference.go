...
func (j *jsiiProxy_PipesPipeSourceParametersSelfManagedKafkaParametersOutputReference) CredentialsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"credentialsInput",
...
func (j *jsiiProxy_PipesPipeSourceParametersSelfManagedKafkaParametersOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_PipesPipeSourceParametersSelfManagedKafkaParametersOutputReference) VpcInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"vpcInput",
...
func (j *jsiiProxy_PipesPipeSourceParametersSelfManagedKafkaParametersOutputReference)SetInternalValue(val interface{}) {
