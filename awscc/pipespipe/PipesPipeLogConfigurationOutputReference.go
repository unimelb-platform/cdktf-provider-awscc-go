...
type PipesPipeLogConfigurationOutputReference interface {
	...
	CloudwatchLogsLogDestinationInput() interface{}
	...
	FirehoseLogDestinationInput() interface{}
	// Experimental.
	Fqn() *string
	...
	S3LogDestinationInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_PipesPipeLogConfigurationOutputReference) CloudwatchLogsLogDestinationInput() interface{} {
...
func (j *jsiiProxy_PipesPipeLogConfigurationOutputReference) FirehoseLogDestinationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PipesPipeLogConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_PipesPipeLogConfigurationOutputReference) S3LogDestinationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PipesPipeLogConfigurationOutputReference)SetInternalValue(val interface{}) {
...
func (p *jsiiProxy_PipesPipeLogConfigurationOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PipesPipeLogConfigurationOutputReference) ResetLevel() {
	_jsii_.InvokeVoid(
		p,
		"resetLevel",
		nil, // no parameters
...
func (p *jsiiProxy_PipesPipeLogConfigurationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
