...
func (p *jsiiProxy_PipesPipeTargetParametersEcsTaskParametersOverridesContainerOverridesEnvironmentList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
