...
func (j *jsiiProxy_PipesPipeEnrichmentParametersHttpParametersOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *PipesPipeEnrichmentParametersHttpParameters:
		val := val.(*PipesPipeEnrichmentParametersHttpParameters)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case PipesPipeEnrichmentParametersHttpParameters:
		val_ := val.(PipesPipeEnrichmentParametersHttpParameters)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *PipesPipeEnrichmentParametersHttpParameters; received %#v (a %T)", val, val)
		}
	}
