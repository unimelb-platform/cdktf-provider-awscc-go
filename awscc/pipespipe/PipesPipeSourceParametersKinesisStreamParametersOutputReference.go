...
func (j *jsiiProxy_PipesPipeSourceParametersKinesisStreamParametersOutputReference) DeadLetterConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PipesPipeSourceParametersKinesisStreamParametersOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_PipesPipeSourceParametersKinesisStreamParametersOutputReference)SetInternalValue(val interface{}) {
