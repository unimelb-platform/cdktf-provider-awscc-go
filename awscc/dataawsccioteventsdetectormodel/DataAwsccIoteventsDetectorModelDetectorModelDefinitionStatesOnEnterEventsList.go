...
func (d *jsiiProxy_DataAwsccIoteventsDetectorModelDetectorModelDefinitionStatesOnEnterEventsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
