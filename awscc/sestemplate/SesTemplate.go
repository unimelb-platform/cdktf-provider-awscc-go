...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/ses_template awscc_ses_template}.
type SesTemplate interface {
	...
	PutTemplate(value *SesTemplateTemplate)
...
func (j *jsiiProxy_SesTemplate) Template() SesTemplateTemplateOutputReference {
	var returns SesTemplateTemplateOutputReference
	_jsii_.Get(
		j,
		"template",
		&returns,
...
func (j *jsiiProxy_SesTemplate) TemplateId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"templateId",
...
func (j *jsiiProxy_SesTemplate) TemplateInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"templateInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/ses_template awscc_ses_template} Resource.
...
func (s *jsiiProxy_SesTemplate) PutTemplate(value *SesTemplateTemplate) {
...
func (s *jsiiProxy_SesTemplate) ResetTemplate() {
	_jsii_.InvokeVoid(
		s,
		"resetTemplate",
		nil, // no parameters
