...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ApigatewayDomainNameV2)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ApigatewayDomainNameV2Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.apigatewayDomainNameV2.ApigatewayDomainNameV2EndpointConfiguration",
		reflect.TypeOf((*ApigatewayDomainNameV2EndpointConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.apigatewayDomainNameV2.ApigatewayDomainNameV2EndpointConfigurationOutputReference",
		reflect.TypeOf((*ApigatewayDomainNameV2EndpointConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.apigatewayDomainNameV2.ApigatewayDomainNameV2Tags",
		reflect.TypeOf((*ApigatewayDomainNameV2Tags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.apigatewayDomainNameV2.ApigatewayDomainNameV2TagsList",
		reflect.TypeOf((*ApigatewayDomainNameV2TagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ApigatewayDomainNameV2TagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
