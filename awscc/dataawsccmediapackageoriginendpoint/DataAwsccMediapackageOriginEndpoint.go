...
func (d *jsiiProxy_DataAwsccMediapackageOriginEndpoint) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsccMediapackageOriginEndpoint) ToHclTerraform() interface{} {
	var returns interface{}
