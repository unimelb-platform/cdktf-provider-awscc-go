...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/lambdapermission/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lambda_permission awscc_lambda_permission}.
...
func (j *jsiiProxy_LambdaPermission) PermissionId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"permissionId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/lambda_permission awscc_lambda_permission} Resource.
func NewLambdaPermission(scope constructs.Construct, id *string, config *LambdaPermissionConfig) LambdaPermission {
	...
	_jsii_.Create(
		"awscc.lambdaPermission.LambdaPermission",
