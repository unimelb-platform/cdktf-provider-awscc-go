...
func (j *jsiiProxy_EcsClusterConfigurationExecuteCommandConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EcsClusterConfigurationExecuteCommandConfigurationOutputReference) LogConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EcsClusterConfigurationExecuteCommandConfigurationOutputReference)SetInternalValue(val interface{}) {
