...
func (j *jsiiProxy_EcsClusterConfigurationExecuteCommandConfigurationOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *EcsClusterConfigurationExecuteCommandConfiguration:
		val := val.(*EcsClusterConfigurationExecuteCommandConfiguration)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case EcsClusterConfigurationExecuteCommandConfiguration:
		val_ := val.(EcsClusterConfigurationExecuteCommandConfiguration)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *EcsClusterConfigurationExecuteCommandConfiguration; received %#v (a %T)", val, val)
		}
	}
