...
func (j *jsiiProxy_EcsClusterConfigurationOutputReference) ExecuteCommandConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EcsClusterConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EcsClusterConfigurationOutputReference) ManagedStorageConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EcsClusterConfigurationOutputReference)SetInternalValue(val interface{}) {
