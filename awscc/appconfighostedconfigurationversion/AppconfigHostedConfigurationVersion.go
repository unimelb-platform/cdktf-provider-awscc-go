...
import (
	...
	"github.com/unimelb-platform/cdktf-provider-awscc-go/awscc/appconfighostedconfigurationversion/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/appconfig_hosted_configuration_version awscc_appconfig_hosted_configuration_version}.
type AppconfigHostedConfigurationVersion interface {
	...
	LatestVersionNumberInput() *float64
	// Experimental.
...
func (j *jsiiProxy_AppconfigHostedConfigurationVersion) LatestVersionNumber() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"latestVersionNumber",
...
func (j *jsiiProxy_AppconfigHostedConfigurationVersion) LatestVersionNumberInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"latestVersionNumberInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_AppconfigHostedConfigurationVersion) VersionNumber() *string {
	var returns *string
	_jsii_.Get(
		j,
		"versionNumber",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/appconfig_hosted_configuration_version awscc_appconfig_hosted_configuration_version} Resource.
...
func (j *jsiiProxy_AppconfigHostedConfigurationVersion)SetLatestVersionNumber(val *float64) {
	if err := j.validateSetLatestVersionNumberParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (a *jsiiProxy_AppconfigHostedConfigurationVersion) ResetLatestVersionNumber() {
	_jsii_.InvokeVoid(
		a,
		"resetLatestVersionNumber",
		nil, // no parameters
