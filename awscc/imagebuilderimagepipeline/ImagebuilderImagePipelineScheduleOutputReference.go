...
func (j *jsiiProxy_ImagebuilderImagePipelineScheduleOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ImagebuilderImagePipelineScheduleOutputReference)SetInternalValue(val interface{}) {
...
func (i *jsiiProxy_ImagebuilderImagePipelineScheduleOutputReference) ResetScheduleExpression() {
	_jsii_.InvokeVoid(
		i,
		"resetScheduleExpression",
		nil, // no parameters
