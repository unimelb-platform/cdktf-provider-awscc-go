...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/imagebuilder_image_pipeline awscc_imagebuilder_image_pipeline}.
type ImagebuilderImagePipeline interface {
	...
	ImageTestsConfigurationInput() interface{}
...
func (j *jsiiProxy_ImagebuilderImagePipeline) ExecutionRole() *string {
	var returns *string
	_jsii_.Get(
		j,
		"executionRole",
...
func (j *jsiiProxy_ImagebuilderImagePipeline) ExecutionRoleInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"executionRoleInput",
...
func (j *jsiiProxy_ImagebuilderImagePipeline) ImageScanningConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ImagebuilderImagePipeline) ImageTestsConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ImagebuilderImagePipeline) ScheduleInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"scheduleInput",
...
func (j *jsiiProxy_ImagebuilderImagePipeline) Workflows() ImagebuilderImagePipelineWorkflowsList {
	var returns ImagebuilderImagePipelineWorkflowsList
	_jsii_.Get(
		j,
		"workflows",
		&returns,
...
func (j *jsiiProxy_ImagebuilderImagePipeline) WorkflowsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"workflowsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/0.70.0/docs/resources/imagebuilder_image_pipeline awscc_imagebuilder_image_pipeline} Resource.
...
func (j *jsiiProxy_ImagebuilderImagePipeline)SetExecutionRole(val *string) {
...
func (i *jsiiProxy_ImagebuilderImagePipeline) PutWorkflows(value interface{}) {
	if err := i.validatePutWorkflowsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		i,
...
func (i *jsiiProxy_ImagebuilderImagePipeline) ResetExecutionRole() {
	_jsii_.InvokeVoid(
		i,
		"resetExecutionRole",
		nil, // no parameters
...
func (i *jsiiProxy_ImagebuilderImagePipeline) ResetInfrastructureConfigurationArn() {
	_jsii_.InvokeVoid(
		i,
		"resetInfrastructureConfigurationArn",
		nil, // no parameters
...
func (i *jsiiProxy_ImagebuilderImagePipeline) ResetName() {
	_jsii_.InvokeVoid(
		i,
		"resetName",
		nil, // no parameters
...
func (i *jsiiProxy_ImagebuilderImagePipeline) ResetWorkflows() {
	_jsii_.InvokeVoid(
		i,
		"resetWorkflows",
		nil, // no parameters
