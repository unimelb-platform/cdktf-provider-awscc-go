...
func (j *jsiiProxy_ImagebuilderImagePipelineImageTestsConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ImagebuilderImagePipelineImageTestsConfigurationOutputReference)SetInternalValue(val interface{}) {
