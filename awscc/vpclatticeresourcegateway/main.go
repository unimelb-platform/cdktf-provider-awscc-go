...
func init() {
	...
	_jsii_.RegisterStruct(
		"awscc.vpclatticeResourceGateway.VpclatticeResourceGatewayConfig",
		reflect.TypeOf((*VpclatticeResourceGatewayConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.vpclatticeResourceGateway.VpclatticeResourceGatewayTags",
		reflect.TypeOf((*VpclatticeResourceGatewayTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.vpclatticeResourceGateway.VpclatticeResourceGatewayTagsList",
		reflect.TypeOf((*VpclatticeResourceGatewayTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VpclatticeResourceGatewayTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
