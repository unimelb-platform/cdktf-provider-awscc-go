...
func (j *jsiiProxy_GlueJobNotificationPropertyOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewGlueJobNotificationPropertyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GlueJobNotificationPropertyOutputReference {
	...
	_jsii_.Create(
		"awscc.glueJob.GlueJobNotificationPropertyOutputReference",
...
func (j *jsiiProxy_GlueJobNotificationPropertyOutputReference)SetInternalValue(val interface{}) {
