...
func (j *jsiiProxy_GlueJobExecutionPropertyOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewGlueJobExecutionPropertyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GlueJobExecutionPropertyOutputReference {
	...
	_jsii_.Create(
		"awscc.glueJob.GlueJobExecutionPropertyOutputReference",
...
func (j *jsiiProxy_GlueJobExecutionPropertyOutputReference)SetInternalValue(val interface{}) {
