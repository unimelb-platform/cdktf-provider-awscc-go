...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/glue_job awscc_glue_job}.
type GlueJob interface {
	cdktf.TerraformResource
	AllocatedCapacity() *float64
	SetAllocatedCapacity(val *float64)
	AllocatedCapacityInput() *float64
	// Experimental.
	...
	SetDefaultArguments(val *string)
	DefaultArgumentsInput() *string
	// Experimental.
	DependsOn() *[]*string
	// Experimental.
	...
	ExecutionPropertyInput() interface{}
	// Experimental.
	...
	SetNonOverridableArguments(val *string)
	NonOverridableArgumentsInput() *string
	NotificationProperty() GlueJobNotificationPropertyOutputReference
	NotificationPropertyInput() interface{}
...
func (j *jsiiProxy_GlueJob) AllocatedCapacity() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"allocatedCapacity",
...
func (j *jsiiProxy_GlueJob) AllocatedCapacityInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"allocatedCapacityInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_GlueJob) CommandInput() interface{} {
...
func (j *jsiiProxy_GlueJob) Connections() GlueJobConnectionsOutputReference {
	var returns GlueJobConnectionsOutputReference
	_jsii_.Get(
		j,
		"connections",
		&returns,
...
func (j *jsiiProxy_GlueJob) ConnectionsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"connectionsInput",
...
func (j *jsiiProxy_GlueJob) DefaultArguments() *string {
	var returns *string
	_jsii_.Get(
		j,
		"defaultArguments",
...
func (j *jsiiProxy_GlueJob) DefaultArgumentsInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueJob) ExecutionPropertyInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueJob) LogUri() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logUri",
...
func (j *jsiiProxy_GlueJob) LogUriInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logUriInput",
...
func (j *jsiiProxy_GlueJob) NonOverridableArguments() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueJob) NonOverridableArgumentsInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueJob) NotificationPropertyInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueJob) Role() *string {
	var returns *string
	_jsii_.Get(
		j,
		"role",
...
func (j *jsiiProxy_GlueJob) RoleInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleInput",
...
func (j *jsiiProxy_GlueJob) Tags() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tags",
...
func (j *jsiiProxy_GlueJob) TagsInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.49.0/docs/resources/glue_job awscc_glue_job} Resource.
...
func (j *jsiiProxy_GlueJob)SetAllocatedCapacity(val *float64) {
	if err := j.validateSetAllocatedCapacityParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_GlueJob)SetDefaultArguments(val *string) {
...
func (j *jsiiProxy_GlueJob)SetLogUri(val *string) {
...
func (j *jsiiProxy_GlueJob)SetNonOverridableArguments(val *string) {
...
func (j *jsiiProxy_GlueJob)SetRole(val *string) {
...
func (j *jsiiProxy_GlueJob)SetTags(val *string) {
...
func (g *jsiiProxy_GlueJob) PutConnections(value *GlueJobConnections) {
...
func (g *jsiiProxy_GlueJob) ResetAllocatedCapacity() {
	_jsii_.InvokeVoid(
		g,
		"resetAllocatedCapacity",
		nil, // no parameters
...
func (g *jsiiProxy_GlueJob) ResetLogUri() {
	_jsii_.InvokeVoid(
		g,
		"resetLogUri",
		nil, // no parameters
...
func (g *jsiiProxy_GlueJob) ResetName() {
	_jsii_.InvokeVoid(
		g,
		"resetName",
		nil, // no parameters
