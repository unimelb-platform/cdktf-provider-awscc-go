...
func (j *jsiiProxy_GlueJobCommandOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewGlueJobCommandOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GlueJobCommandOutputReference {
	...
	_jsii_.Create(
		"awscc.glueJob.GlueJobCommandOutputReference",
...
func (j *jsiiProxy_GlueJobCommandOutputReference)SetInternalValue(val interface{}) {
...
func (g *jsiiProxy_GlueJobCommandOutputReference) ResetScriptLocation() {
	_jsii_.InvokeVoid(
		g,
		"resetScriptLocation",
		nil, // no parameters
