...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccLightsailLoadBalancer)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"awscc.dataAwsccLightsailLoadBalancer.DataAwsccLightsailLoadBalancerConfig",
		reflect.TypeOf((*DataAwsccLightsailLoadBalancerConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"awscc.dataAwsccLightsailLoadBalancer.DataAwsccLightsailLoadBalancerTags",
		reflect.TypeOf((*DataAwsccLightsailLoadBalancerTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"awscc.dataAwsccLightsailLoadBalancer.DataAwsccLightsailLoadBalancerTagsList",
		reflect.TypeOf((*DataAwsccLightsailLoadBalancerTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccLightsailLoadBalancerTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
